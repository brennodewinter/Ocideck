...
extension DeckNotifierSlides on DeckNotifier {
  ...
  /// meerzins-bullets opknippen, meegesleepte pagina's losmaken en themakleuren
  /// minimaal naar voldoende contrast verschuiven. Nooit wordt inhoud van een
  /// dia gehaald; wat menselijk oordeel vraagt blijft staan.
  ///
  ...
  /// toegepast (een kleurcorrectieronde telt als één; 0 = niets automatisch op
  /// te lossen en het deck blijft dan gelijk).
