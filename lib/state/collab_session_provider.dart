...
class CollabSessionState {
  ...
  /// Where each co-author is looking, for the presence UI. Updated as peers
  /// move; empty outside an active session.
  final List<PeerPresence> presence;

  /// The session chat, oldest first. Grows as messages arrive and are sent;
  /// empty outside an active session.
...
/// in view at a time); toggled from the command palette.
