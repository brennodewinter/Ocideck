...
Slide _bullets(
  ...
  SlideType.bullets,
).copyWith(title: title, bullets: bullets, listStyle: listStyle);
...
Slide _table(String title, List<List<String>> rows) =>
    Slide.create(SlideType.table).copyWith(title: title, tableRows: rows);
...
List<Slide> _buildReport(String deckTitle) => [
  ...
  _bullets('Acties komende periode', [
...
'''),
  ...
  _bullets('Implementatiechecklist', [
