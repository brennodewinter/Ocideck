...
class MarpHtmlService {
  ...
  static void _cockpitInstrumentSvg(
    StringBuffer b,
  ...
  static String _headingNum(double value) => _num(value).padLeft(3, '0');

  static String _arcPath(
    double cx,
    double cy,
    double r,
    double startDeg,
