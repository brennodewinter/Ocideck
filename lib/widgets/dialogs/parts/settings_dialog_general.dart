...
extension _SettingsGeneralTab on _SettingsDialogState {
  ...
  /// keuze in de editor doet dat, byte-chirurgisch).
  List<Widget> _documentStyleSection(AppLocalizations l10n) {
    ...
    return [
      _sectionTitle(l10n.d('Documentstijl')),
      Text(
        l10n.d(
