...
const _dutchSourceStringAdditions = {
  'en': {
    ...
    'Aanmelden mislukt — controleer gebruikersnaam en wachtwoord': 'Sign-in failed — check your username and password',
    'De server staat op een privé-adres. Vink "Vertrouwde interne server" aan om verbinding toe te staan.': 'The server is on a private address. Tick "Trusted internal server" to allow the connection.',
    'Map niet gevonden op de server': 'Folder not found on the server',
    'Ongeldige server-URL': 'Invalid server URL',
    'Het antwoord van de server was te groot': 'The server response was too large',
    'Nextcloud': 'Nextcloud',
    'Nextcloud-bron (WebDAV)': 'Nextcloud source (WebDAV)',
    'Open en bewaar presentaties in een map op je Nextcloud. Het wachtwoord wordt versleuteld in de sleutelhanger bewaard, niet bij de overige instellingen.': 'Open and save presentations in a folder on your Nextcloud. The password is stored encrypted in the keychain, not alongside the other settings.',
    'Server-URL': 'Server URL',
    'Gebruikersnaam': 'Username',
    'App-wachtwoord': 'App password',
    'Maak hiervoor een app-wachtwoord aan in Nextcloud': 'Create an app password for this in Nextcloud',
    'Submap (optioneel)': 'Subfolder (optional)',
    'Vertrouwde interne server': 'Trusted internal server',
    'Nodig wanneer de server op een privé- of thuisnetwerk (LAN) draait. Sta alleen verbindingen toe naar servers die je zelf vertrouwt.': 'Needed when the server runs on a private or home network (LAN). Only allow connections to servers you trust yourself.',
    'Verbinding testen': 'Test connection',
    'Verbinding gelukt': 'Connection succeeded',
    'Wijzigingen worden bewaard wanneer je op Opslaan klikt.': 'Changes are saved when you click Save.',
    ...
    'Geen Nextcloud-server ingesteld. Stel er een in bij Instellingen → Nextcloud.': 'No Nextcloud server configured. Set one up in Settings → Nextcloud.',
    'Kon de map niet laden. Controleer je verbinding en instellingen.': 'Could not load the folder. Check your connection and settings.',
    ...
    'Stel eerst een Nextcloud-server in bij Instellingen → Nextcloud.': 'First set up a Nextcloud server in Settings → Nextcloud.',
    'Opslaan naar Nextcloud': 'Save to Nextcloud',
    'Doelpad (zonder extensie)': 'Target path (without extension)',
    'Als .ocideck-pakket (één bestand, met assets)': 'As an .ocideck package (one file, with assets)',
  ...
  'it': {
    // Nextcloud/WebDAV-bron.
    'Vul server-URL en gebruikersnaam in': 'Inserisci l’URL del server e il nome utente',
    'Verbinding mislukt': 'Connessione non riuscita',
    'Aanmelden mislukt — controleer gebruikersnaam en wachtwoord': 'Accesso non riuscito — controlla nome utente e password',
    'De server staat op een privé-adres. Vink "Vertrouwde interne server" aan om verbinding toe te staan.': 'Il server ha un indirizzo privato. Seleziona "Server interno attendibile" per consentire la connessione.',
    'Map niet gevonden op de server': 'Cartella non trovata sul server',
    'Ongeldige server-URL': 'URL del server non valido',
    'Het antwoord van de server was te groot': 'La risposta del server era troppo grande',
    'Nextcloud': 'Nextcloud',
    'Nextcloud-bron (WebDAV)': 'Origine Nextcloud (WebDAV)',
    'Open en bewaar presentaties in een map op je Nextcloud. Het wachtwoord wordt versleuteld in de sleutelhanger bewaard, niet bij de overige instellingen.': 'Apri e salva presentazioni in una cartella sul tuo Nextcloud. La password è memorizzata cifrata nel portachiavi, non insieme alle altre impostazioni.',
    'Server-URL': 'URL del server',
    'Gebruikersnaam': 'Nome utente',
    'App-wachtwoord': 'Password dell’app',
    'Maak hiervoor een app-wachtwoord aan in Nextcloud': 'Crea una password dell’app in Nextcloud a questo scopo',
    'Submap (optioneel)': 'Sottocartella (opzionale)',
    'Vertrouwde interne server': 'Server interno attendibile',
    'Nodig wanneer de server op een privé- of thuisnetwerk (LAN) draait. Sta alleen verbindingen toe naar servers die je zelf vertrouwt.': 'Necessario quando il server è su una rete privata o domestica (LAN). Consenti connessioni solo a server di cui ti fidi.',
    'Verbinding testen': 'Prova connessione',
    'Verbinding gelukt': 'Connessione riuscita',
    'Wijzigingen worden bewaard wanneer je op Opslaan klikt.': 'Le modifiche vengono salvate quando fai clic su Salva.',
    ...
    'Geen Nextcloud-server ingesteld. Stel er een in bij Instellingen → Nextcloud.': 'Nessun server Nextcloud configurato. Configuralo in Impostazioni → Nextcloud.',
    'Kon de map niet laden. Controleer je verbinding en instellingen.': 'Impossibile caricare la cartella. Controlla la connessione e le impostazioni.',
    ...
    'Stel eerst een Nextcloud-server in bij Instellingen → Nextcloud.': 'Configura prima un server Nextcloud in Impostazioni → Nextcloud.',
    'Opslaan naar Nextcloud': 'Salva su Nextcloud',
    'Doelpad (zonder extensie)': 'Percorso di destinazione (senza estensione)',
    'Als .ocideck-pakket (één bestand, met assets)': 'Come pacchetto .ocideck (un file, con le risorse)',
  ...
  'de': {
    ...
    'Aanmelden mislukt — controleer gebruikersnaam en wachtwoord': 'Anmeldung fehlgeschlagen — Benutzername und Passwort prüfen',
    'De server staat op een privé-adres. Vink "Vertrouwde interne server" aan om verbinding toe te staan.': 'Der Server hat eine private Adresse. Aktiviere „Vertrauenswürdiger interner Server“, um die Verbindung zuzulassen.',
    ...
    'Open en bewaar presentaties in een map op je Nextcloud. Het wachtwoord wordt versleuteld in de sleutelhanger bewaard, niet bij de overige instellingen.': 'Öffne und speichere Präsentationen in einem Ordner auf deiner Nextcloud. Das Passwort wird verschlüsselt im Schlüsselbund gespeichert, nicht bei den übrigen Einstellungen.',
    'Server-URL': 'Server-URL',
    'Gebruikersnaam': 'Benutzername',
    'App-wachtwoord': 'App-Passwort',
    'Maak hiervoor een app-wachtwoord aan in Nextcloud': 'Erstelle dafür in Nextcloud ein App-Passwort',
    'Submap (optioneel)': 'Unterordner (optional)',
    'Vertrouwde interne server': 'Vertrauenswürdiger interner Server',
    'Nodig wanneer de server op een privé- of thuisnetwerk (LAN) draait. Sta alleen verbindingen toe naar servers die je zelf vertrouwt.': 'Erforderlich, wenn der Server in einem privaten oder Heimnetzwerk (LAN) läuft. Erlaube nur Verbindungen zu Servern, denen du selbst vertraust.',
    'Verbinding testen': 'Verbindung testen',
    'Verbinding gelukt': 'Verbindung erfolgreich',
    'Wijzigingen worden bewaard wanneer je op Opslaan klikt.': 'Änderungen werden gespeichert, wenn du auf Speichern klickst.',
    ...
    'Geen Nextcloud-server ingesteld. Stel er een in bij Instellingen → Nextcloud.': 'Kein Nextcloud-Server eingerichtet. Richte einen unter Einstellungen → Nextcloud ein.',
    'Kon de map niet laden. Controleer je verbinding en instellingen.': 'Ordner konnte nicht geladen werden. Prüfe deine Verbindung und Einstellungen.',
    ...
    'Stel eerst een Nextcloud-server in bij Instellingen → Nextcloud.': 'Richte zuerst einen Nextcloud-Server unter Einstellungen → Nextcloud ein.',
    'Opslaan naar Nextcloud': 'Auf Nextcloud speichern',
    'Doelpad (zonder extensie)': 'Zielpfad (ohne Erweiterung)',
    'Als .ocideck-pakket (één bestand, met assets)': 'Als .ocideck-Paket (eine Datei, mit Assets)',
  ...
  'fr': {
    // Nextcloud/WebDAV-bron.
    'Vul server-URL en gebruikersnaam in': 'Saisissez l’URL du serveur et le nom d’utilisateur',
    'Verbinding mislukt': 'Échec de la connexion',
    'Aanmelden mislukt — controleer gebruikersnaam en wachtwoord': 'Échec de la connexion — vérifiez le nom d’utilisateur et le mot de passe',
    'De server staat op een privé-adres. Vink "Vertrouwde interne server" aan om verbinding toe te staan.': 'Le serveur est sur une adresse privée. Cochez « Serveur interne de confiance » pour autoriser la connexion.',
    'Map niet gevonden op de server': 'Dossier introuvable sur le serveur',
    'Ongeldige server-URL': 'URL de serveur non valide',
    'Het antwoord van de server was te groot': 'La réponse du serveur était trop volumineuse',
    'Nextcloud': 'Nextcloud',
    'Nextcloud-bron (WebDAV)': 'Source Nextcloud (WebDAV)',
    'Open en bewaar presentaties in een map op je Nextcloud. Het wachtwoord wordt versleuteld in de sleutelhanger bewaard, niet bij de overige instellingen.': 'Ouvrez et enregistrez des présentations dans un dossier de votre Nextcloud. Le mot de passe est stocké chiffré dans le trousseau, pas avec les autres réglages.',
    'Server-URL': 'URL du serveur',
    'Gebruikersnaam': 'Nom d’utilisateur',
    'App-wachtwoord': 'Mot de passe d’application',
    'Maak hiervoor een app-wachtwoord aan in Nextcloud': 'Créez un mot de passe d’application pour cela dans Nextcloud',
    'Submap (optioneel)': 'Sous-dossier (facultatif)',
    'Vertrouwde interne server': 'Serveur interne de confiance',
    'Nodig wanneer de server op een privé- of thuisnetwerk (LAN) draait. Sta alleen verbindingen toe naar servers die je zelf vertrouwt.': 'Nécessaire lorsque le serveur fonctionne sur un réseau privé ou domestique (LAN). N’autorisez que les connexions vers des serveurs auxquels vous faites confiance.',
    'Verbinding testen': 'Tester la connexion',
    'Verbinding gelukt': 'Connexion réussie',
    'Wijzigingen worden bewaard wanneer je op Opslaan klikt.': 'Les modifications sont enregistrées lorsque vous cliquez sur Enregistrer.',
    ...
    'Geen Nextcloud-server ingesteld. Stel er een in bij Instellingen → Nextcloud.': 'Aucun serveur Nextcloud configuré. Configurez-en un dans Réglages → Nextcloud.',
    'Kon de map niet laden. Controleer je verbinding en instellingen.': 'Impossible de charger le dossier. Vérifiez votre connexion et vos réglages.',
    ...
    'Stel eerst een Nextcloud-server in bij Instellingen → Nextcloud.': 'Configurez d’abord un serveur Nextcloud dans Réglages → Nextcloud.',
    'Opslaan naar Nextcloud': 'Enregistrer sur Nextcloud',
    'Doelpad (zonder extensie)': 'Chemin cible (sans extension)',
    'Als .ocideck-pakket (één bestand, met assets)': 'En paquet .ocideck (un fichier, avec les ressources)',
  ...
  'es': {
    // Nextcloud/WebDAV-bron.
    'Vul server-URL en gebruikersnaam in': 'Introduce la URL del servidor y el usuario',
    'Verbinding mislukt': 'Error de conexión',
    'Aanmelden mislukt — controleer gebruikersnaam en wachtwoord': 'Error de inicio de sesión: comprueba el usuario y la contraseña',
    'De server staat op een privé-adres. Vink "Vertrouwde interne server" aan om verbinding toe te staan.': 'El servidor está en una dirección privada. Marca «Servidor interno de confianza» para permitir la conexión.',
    'Map niet gevonden op de server': 'Carpeta no encontrada en el servidor',
    'Ongeldige server-URL': 'URL de servidor no válida',
    'Het antwoord van de server was te groot': 'La respuesta del servidor era demasiado grande',
    'Nextcloud': 'Nextcloud',
    'Nextcloud-bron (WebDAV)': 'Fuente de Nextcloud (WebDAV)',
    'Open en bewaar presentaties in een map op je Nextcloud. Het wachtwoord wordt versleuteld in de sleutelhanger bewaard, niet bij de overige instellingen.': 'Abre y guarda presentaciones en una carpeta de tu Nextcloud. La contraseña se guarda cifrada en el llavero, no junto al resto de ajustes.',
    'Server-URL': 'URL del servidor',
    'Gebruikersnaam': 'Usuario',
    'App-wachtwoord': 'Contraseña de aplicación',
    'Maak hiervoor een app-wachtwoord aan in Nextcloud': 'Crea para esto una contraseña de aplicación en Nextcloud',
    'Submap (optioneel)': 'Subcarpeta (opcional)',
    'Vertrouwde interne server': 'Servidor interno de confianza',
    'Nodig wanneer de server op een privé- of thuisnetwerk (LAN) draait. Sta alleen verbindingen toe naar servers die je zelf vertrouwt.': 'Necesario cuando el servidor está en una red privada o doméstica (LAN). Permite solo conexiones a servidores en los que confías.',
    'Verbinding testen': 'Probar conexión',
    'Verbinding gelukt': 'Conexión correcta',
    'Wijzigingen worden bewaard wanneer je op Opslaan klikt.': 'Los cambios se guardan al hacer clic en Guardar.',
    ...
    'Geen Nextcloud-server ingesteld. Stel er een in bij Instellingen → Nextcloud.': 'No hay ningún servidor de Nextcloud configurado. Configura uno en Ajustes → Nextcloud.',
    'Kon de map niet laden. Controleer je verbinding en instellingen.': 'No se pudo cargar la carpeta. Comprueba tu conexión y ajustes.',
    ...
    'Stel eerst een Nextcloud-server in bij Instellingen → Nextcloud.': 'Primero configura un servidor de Nextcloud en Ajustes → Nextcloud.',
    'Opslaan naar Nextcloud': 'Guardar en Nextcloud',
    'Doelpad (zonder extensie)': 'Ruta de destino (sin extensión)',
    'Als .ocideck-pakket (één bestand, met assets)': 'Como paquete .ocideck (un archivo, con recursos)',
  ...
  'fy': {
    // Nextcloud/WebDAV-bron.
    'Vul server-URL en gebruikersnaam in': 'Folje de server-URL en brûkersnamme yn',
    'Verbinding mislukt': 'Ferbining mislearre',
    'Aanmelden mislukt — controleer gebruikersnaam en wachtwoord': 'Oanmelden mislearre — kontrolearje brûkersnamme en wachtwurd',
    'De server staat op een privé-adres. Vink "Vertrouwde interne server" aan om verbinding toe te staan.': 'De server stiet op in privee-adres. Set "Fertroude ynterne server" oan om ferbining ta te stean.',
    'Map niet gevonden op de server': 'Map net fûn op de server',
    'Ongeldige server-URL': 'Unjildige server-URL',
    'Het antwoord van de server was te groot': 'It antwurd fan de server wie te grut',
    'Nextcloud': 'Nextcloud',
    'Nextcloud-bron (WebDAV)': 'Nextcloud-boarne (WebDAV)',
    'Open en bewaar presentaties in een map op je Nextcloud. Het wachtwoord wordt versleuteld in de sleutelhanger bewaard, niet bij de overige instellingen.': 'Iepenje en bewarje presintaasjes yn in map op dyn Nextcloud. It wachtwurd wurdt fersifere yn de kaaibosk bewarre, net by de oare ynstellings.',
    'Server-URL': 'Server-URL',
    'Gebruikersnaam': 'Brûkersnamme',
    'App-wachtwoord': 'App-wachtwurd',
    'Maak hiervoor een app-wachtwoord aan in Nextcloud': 'Meitsje hjirfoar in app-wachtwurd oan yn Nextcloud',
    'Submap (optioneel)': 'Submap (opsjoneel)',
    'Vertrouwde interne server': 'Fertroude ynterne server',
    'Nodig wanneer de server op een privé- of thuisnetwerk (LAN) draait. Sta alleen verbindingen toe naar servers die je zelf vertrouwt.': 'Nedich as de server op in privee- of thúsnetwurk (LAN) draait. Stean allinnich ferbiningen ta nei servers dêr\'tsto sels op fertrouwst.',
    'Verbinding testen': 'Ferbining teste',
    'Verbinding gelukt': 'Ferbining slagge',
    'Wijzigingen worden bewaard wanneer je op Opslaan klikt.': 'Wizigingen wurde bewarre as do op Bewarje klikst.',
    ...
    'Geen Nextcloud-server ingesteld. Stel er een in bij Instellingen → Nextcloud.': 'Gjin Nextcloud-server ynsteld. Stel der ien yn by Ynstellings → Nextcloud.',
    'Kon de map niet laden. Controleer je verbinding en instellingen.': 'Koe de map net lade. Kontrolearje dyn ferbining en ynstellings.',
    ...
    'Stel eerst een Nextcloud-server in bij Instellingen → Nextcloud.': 'Stel earst in Nextcloud-server yn by Ynstellings → Nextcloud.',
    'Opslaan naar Nextcloud': 'Bewarje nei Nextcloud',
    'Doelpad (zonder extensie)': 'Doelpaad (sûnder ekstinsje)',
    'Als .ocideck-pakket (één bestand, met assets)': 'As .ocideck-pakket (ien bestân, mei assets)',
  ...
  'pap': {
    // Nextcloud/WebDAV-bron.
    'Vul server-URL en gebruikersnaam in': 'Yena e URL di servidó i nòmber di usuario',
    'Verbinding mislukt': 'Konekshon a faya',
    'Aanmelden mislukt — controleer gebruikersnaam en wachtwoord': 'Login a faya — chèk nòmber di usuario i kontrasenja',
    'De server staat op een privé-adres. Vink "Vertrouwde interne server" aan om verbinding toe te staan.': 'E servidó ta riba un adrès privá. Marka "Servidó interno konfiabel" pa permití konekshon.',
    'Map niet gevonden op de server': 'Karpeta no a wòrdu hañá riba e servidó',
    'Ongeldige server-URL': 'URL di servidó inválido',
    'Het antwoord van de server was te groot': 'E respondi di servidó tabata muchu grandi',
    'Nextcloud': 'Nextcloud',
    'Nextcloud-bron (WebDAV)': 'Fuente Nextcloud (WebDAV)',
    'Open en bewaar presentaties in een map op je Nextcloud. Het wachtwoord wordt versleuteld in de sleutelhanger bewaard, niet bij de overige instellingen.': 'Habri i warda presentashonnan den un karpeta riba bo Nextcloud. E kontrasenja ta wòrdu wardá sífrá den e yabero, no huntu ku e otro konfigurashonnan.',
    'Server-URL': 'URL di servidó',
    'Gebruikersnaam': 'Nòmber di usuario',
    'App-wachtwoord': 'Kontrasenja di app',
    'Maak hiervoor een app-wachtwoord aan in Nextcloud': 'Krea un kontrasenja di app pa esaki den Nextcloud',
    'Submap (optioneel)': 'Sub-karpeta (opshonal)',
    'Vertrouwde interne server': 'Servidó interno konfiabel',
    'Nodig wanneer de server op een privé- of thuisnetwerk (LAN) draait. Sta alleen verbindingen toe naar servers die je zelf vertrouwt.': 'Nesesario ora e servidó ta kore riba un red privá òf di kas (LAN). Permití solamente konekshon ku servidónan ku bo ta konfia.',
    'Verbinding testen': 'Testa konekshon',
    'Verbinding gelukt': 'Konekshon a logra',
    'Wijzigingen worden bewaard wanneer je op Opslaan klikt.': 'Kambionan ta wòrdu wardá ora bo klik riba Warda.',
    ...
    'Geen Nextcloud-server ingesteld. Stel er een in bij Instellingen → Nextcloud.': 'No tin servidó Nextcloud konfigurá. Konfigurá un na Konfigurashon → Nextcloud.',
    'Kon de map niet laden. Controleer je verbinding en instellingen.': 'No por a karga e karpeta. Chèk bo konekshon i konfigurashon.',
    ...
    'Stel eerst een Nextcloud-server in bij Instellingen → Nextcloud.': 'Promé konfigurá un servidó Nextcloud na Konfigurashon → Nextcloud.',
    'Opslaan naar Nextcloud': 'Warda riba Nextcloud',
    'Doelpad (zonder extensie)': 'Kaminda destino (sin ekstenshon)',
    'Als .ocideck-pakket (één bestand, met assets)': 'Komo paket .ocideck (un solo dokumento, ku rekursonan)',
