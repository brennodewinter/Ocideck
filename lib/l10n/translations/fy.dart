...
const _dutchSourceFy = {
  ...
  'Auditdossier geëxporteerd naar:': 'Auditdossier eksportearre nei:',
  ...
  'Volledige MIAUW-rapportstructuur: documentbeheer, scope, executie, managementsamenvatting, bevindingen, checklists en ondertekening.':
      'Folsleine MIAUW-rapportstruktuer: dokumintbehear, scope, útfiering, managementgearfetting, befiningen, checklists en ûndertekening.',
  ...
  'Online openen': 'Online iepenje',
  'Dit document kon niet worden geladen.': 'Dit dokumint koe net laden wurde.',
  'Kwaliteit': 'Kwaliteit',
  ...
  'Identieke kopieën': 'Identike kopyen',
  'Zelfde titel, andere inhoud': 'Deselde titel, oare ynhâld',
  'Dubbele presentaties opruimen': 'Dûbele presintaasjes opromje',
  'Naar de prullenbak verplaatst:': 'Nei it jiskefet ferpleatst:',
  'Kon niet naar de prullenbak verplaatsen.':
      'Koe net nei it jiskefet ferpleatst wurde.',
  'Geen dubbele presentaties gevonden.': 'Gjin dûbele presintaasjes fûn.',
  'Laatste kopie blijft behouden': 'De lêste kopy bliuwt bewarre',
  'Nog geopend in een tabblad': 'Noch iepen yn in ljepblêd',
...
const _dutchSourceAddFy = {
  ...
  'Aangemaakt op': 'Oanmakke op',
  'Aanmeldprovider': 'Oanmelde provider',
  'Aanmeldsessies': 'Registraasje sesjes',
  'Aantal controles': 'Oantal kontrôles',
  ...
  'Activiteitnummer': 'Aktiviteit nûmer',
  'Afgerond op': 'Rûn nei',
  'Afgewezen': 'Ofwiisd',
  'Afspeelsessienummer': 'Playback sesje nûmer',
  'Afwezig': 'Absent',
  'Antwoordgegevens': 'Antwurd details',
  'Antwoordstatus': 'Antwurdstatus',
  'Begint op': 'Begjint oan',
  'Begrippen uitgelegd': 'Begripen útlein',
  'Beheer van de installatie': 'Behear fan de ynstallaasje',
  'Beheerpogingen': 'Management ynspannings',
  'Bekeken lessen': 'Lessen besjoen',
  'Beleidsversie': 'Belied ferzje',
  'Beoordeeld': 'Rated',
  'Beoordeeld op': 'Wurdearre troch',
  'Beperking': 'Beheining',
  'Berekend op': 'Berekkene op',
  'Bericht': 'Berjocht',
  'Bestandsnaam': 'Bestânsnamme',
  'Beveiligingsvraagnummer': 'Feiligens Fraach Number',
  'Bevestigd': 'Befêstige',
  'Bevestigd op': 'Befêstige op',
  'Bewaarregels': 'Behâld regels',
  'Bewaartermijn': 'Bewaringsperioade',
  'Bewaren wegens een juridische verplichting':
      'Behâlden fanwege in wetlike ferplichting',
  'Bewerkingnummer bij aanmeldprovider':
      'Operaasje nûmer by registraasje provider',
  'Bewijsstukken': 'Bewiis',
  'Bezwaar': 'Beswier',
  'Beëindigd op': 'Einige op',
  'Bijeenkomstnummer': 'Gearkomst nûmer',
  'Certificaatnummer': 'Sertifikaat nûmer',
  'Certificaten': 'Sertifikaten',
  'Controlecode van de PDF': 'Kontrôlekoade fan de PDF',
  'Controlecode van profielfoto': 'Ferifikaasjekoade foar profylfoto',
  'Controlecodes van bewijsstukken':
      'Kontrolearje koades fan stypjende dokuminten',
  'Correctie': 'Korreksje',
  'Cursistnummer waarop de actie gericht was':
      'Learlingnûmer dêr\'t de aksje op rjochte wie',
  'Cursusaanbodnummer': 'Kursus oanbod nûmer',
  'Cursusversienummer': 'Kursus ferzjenûmer',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Datums en tiden wurde werjûn yn jo lokale tiid. Technyske nammen bliuwe sichtber as de tsjinner in ûnbekend fjild leveret.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'De antwurden dy\'t jo joegen op testfragen.',
  'Deelnamenummer': 'Partisipaasje nûmer',
  'Deelnames': 'Partisipaasjes',
  'Details': 'Details',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Dizze kategory waard levere troch de tsjinner. De technyske nammen bliuwe sichtber foar fragen fan jo organisaasje.',
  'Door uzelf aangevraagd': 'Oanfrege troch josels',
  'E-mailadres': 'E-postadres',
  'E-mailberichten': 'E-postberjochten',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'In ID is in unyk technysk nûmer dat eLearning brûkt om gegevens mei-inoar te keppeljen. It is gjin wurdearring of status.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'In kategory groepearret gegevens oer itselde ûnderwerp. In registraasje is ien bewarre stik gegevens as ien evenemint.',
  'Eindigt op': 'Einiget yn',
  'Geaccepteerd op': 'Akseptearre op',
  'Geannuleerd': 'Annulearre',
  'Gecontroleerd': 'Kontrolearre',
  'Gecontroleerd op': 'Kontrolearre op',
  'Geen gegevens gevonden': 'Gjin gegevens fûn',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Ynformaasje oer behâldperioaden en it wiskjen fan jo gegevens.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Ynformaasje oer stypjende dokuminten, berikke resultaten en sertifikaten.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Ynformaasje oer privacyoanfragen en wa\'t jo ynformaasje besjoen of feroare hat.',
  'Gegevens over uw accountbewerking': 'Ynformaasje oer jo akkount operaasje',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Ynformaasje oer jo registraasje, dielname en foarútgong yn lessen.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Ynformaasje oer jo profyl, akkount en posysje binnen de organisaasje.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Ynformaasje oer jo testmominten en de presintearre fragen.',
  'Gegevens over willekeurige volgorde': 'Random oarder data',
  'Gegevenscategorie': 'Data kategory',
  'Gekoppeld accountnummer': 'Keppele akkount nûmer',
  'Gekozen antwoorden': 'Selektearre antwurden',
  'Gelukt': 'Sukses',
  'Geprobeerd op': 'Besocht op',
  'Gerechtvaardigd belang': 'Legitime belang',
  'Gereserveerd': 'Reservearre',
  'Gereserveerd op': 'Reservearre op',
  'Geslaagd': 'Passearre',
  'Gestart op': 'Begûn op',
  'Getoonde tijd per dia in milliseconden':
      'Tiid werjûn per dia yn millisekonden',
  'Herkomst van inschrijving': 'Oarsprong fan registraasje',
  'Hoogst haalbare score': 'Heechste mooglike skoare',
  'Identificatienummer bij aanmeldprovider':
      'Identifikaasjenûmer foar registraasjeprovider',
  'Identiteitsbewerkingnummer': 'Identiteit operaasje nûmer',
  'In afwachting': 'Yn ôfwachting',
  'In behandeling': 'Yn útfiering',
  'In behandeling genomen op': 'Ferwurke op',
  'In quarantaine': 'Yn quarantaine',
  'Ingeleverd': 'Yntsjinne',
  'Ingeleverd op': 'Yntsjinne op',
  'Ingericht op': 'Fersierd op',
  'Ingeschreven op': 'Registrearre op',
  'Ingetrokken': 'Ynlutsen',
  'Ingetrokken op': 'Ynlutsen op',
  'Inschrijvingen': 'Registraasjes',
  'Inschrijvingsnummer': 'Registraasje nûmer',
  'Installatiebeveiligingslogboek': 'Ynstallaasje feiligens log',
  'Installatienummer': 'Ynstallaasje nûmer',
  'Installatieverzoeken': 'Ynstallaasje fersiken',
  'Inzage': 'Ynspeksje',
  'Ja': 'Ja',
  'Kwalificatienummer': 'Kwalifikaasje nûmer',
  'Kwalificaties': 'Kwalifikaasjes',
  'Laatst actief op': 'Lêste aktyf op',
  'Laatst bekeken dia': 'Lêst besjoen slide',
  'Laatst gewijzigd op': 'Lêst wizige op',
  'Laatste fout': 'Lêste flater',
  'Lesnummer': 'Les nûmer',
  'Lesreserveringen': 'Les reservearrings',
  'Lesvoortgang': 'Les foarútgong',
  'Lidmaatschappen': 'Lidmaatskippen',
  'Locatie': 'Lokaasje',
  'Manier van afronden': 'Manier fan rûning',
  'Maximaal aantal controles': 'Maksimum oantal kontrôles',
  'Maximaal aantal pogingen': 'Maksimum oantal besykjen',
  'Maximale leeftijd van de aanmelding': 'Maksimum leeftyd fan registraasje',
  'Mislukt': 'Mislearre',
  'Naam van de activiteit': 'Namme fan de aktiviteit',
  'Naam van de bijeenkomst': 'Namme fan de gearkomste',
  'Nee': 'Nee',
  'Netwerkadres': 'Netwurk adres',
  'Niet actief': 'Net aktyf',
  'Niet geregistreerd': 'Net registrearre',
  'Niet ingevuld': 'Net ynfolle',
  'Niet verschenen': 'Net publisearre',
  'Niveau van extra aanmeldcontrole': 'Nivo fan ekstra registraasje kontrôle',
  'Nummer van de toetsopzet': 'Nûmer fan it testplan',
  'Nummer van het brongegeven': 'Oantal fan de boarne gegevens',
  'Nummer van uw verwijderde gegeven': 'Nûmer fan jo wiske gegevens',
  'Onderdeel {nummer}': 'Diel {nummer}',
  'Onderwerp van de actie': 'Underwerp fan \'e aksje',
  'Ontvanger': 'Untfanger',
  'Opgegeven bestandsgrootte': 'Oantsjutte triemgrutte',
  'Opgegeven bestandstype': 'Oantsjutte triemtype',
  'Opgegeven controlecode': 'Oantsjutte kontrôle koade',
  'Opgeslagen bestandsgrootte': 'Bewarre triemgrutte',
  'Opgeslagen controlecode': 'Opslein kontrôle koade',
  'Organisatienummer': 'Organisaasjenûmer',
  'Overdraagbaarheid': 'Oerdraachberens',
  'PE-toekenningnummer': 'PE priis nûmer',
  'Poging': 'Poging',
  'Positie': 'Posysje',
  'Privacyverzoeken': 'Privacy fersiken',
  'Probeer een andere zoekterm.': 'Besykje in oare sykterm.',
  'Reden': 'Reden',
  'Reden of grondslag': 'Reden of basis',
  'Reden van afwijzing': 'Reden foar ôfwizing',
  'Reden van bevestiging': 'Reden foar befêstiging',
  'Reden van intrekking': 'Reden foar weromlûken',
  'Reden voor langer bewaren': 'Reden foar langere opslach',
  'Regels voor de cursusversie': 'Regels foar de kursus ferzje',
  'Resultaat bij de aanmeldprovider': 'Resultaat by de registraasje provider',
  'Rol': 'Roll',
  'Score': 'Skoare',
  'Soort aanwezigheid': 'Soarte oanwêzigens',
  'Soort accountbewerking': 'Soart account operaasje',
  'Soort gebeurtenis': 'Soart evenemint',
  'Soort privacyverzoek': 'Soart privacyfersyk',
  'Status van de bijeenkomst': 'Status fan \'e gearkomste',
  'Strenge beveiligingsmodus': 'Hege feiligens modus',
  'Technisch toegangslogboek': 'Technyske tagong log',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Technyske gegevens nedich foar registraasje, feiligens en betroubere ferwurking.',
  'Technische naam: {naam}': 'Technyske namme: {naam}',
  'Technische opslagcategorie': 'Technyske opslach kategory',
  'Technische opslaglocatie van de PDF':
      'Technyske opslachlokaasje fan \'e PDF',
  'Tijdstip van aanmelding': 'Tiid fan registraasje',
  'Tijdzone': 'Tiidsône',
  'Toestand': 'Betingst',
  'Toetspogingen': 'Test besykjen',
  'Toetspogingnummer': 'Test besykjen nûmer',
  'Uiterste inlevermoment': 'Deadline foar yntsjinjen',
  'Uitgegeven op': 'Publisearre op',
  'Uitgenodigd e-mailadres': 'E-postadres útnoege',
  'Uitnodigingen': 'Utnoegings',
  'Uniek nummer (ID)': 'Unike nûmer (ID)',
  'Uniek verwerkingskenmerk': 'Unike ferwurkingsfunksje',
  'Uw accountnummer': 'Jo akkount nûmer',
  'Uw accountnummer als uitvoerder': 'Jo akkountnûmer as eksekuteur',
  'Uzelf als uploader': 'Josels as uploader',
  'Vaardigheidsversienummer': 'Skill ferzje nûmer',
  'Vast internetadres van de installatie':
      'Fêst ynternetadres fan \'e ynstallaasje',
  'Vastgelegde beslisgegevens': 'Opnommen beslút gegevens',
  'Vastgelegde gegevens': 'Opnommen gegevens',
  'Vereist niveau van aanmeldzekerheid':
      'Fereaske nivo fan registraasje wissichheid',
  'Vereiste aanmeldmethoden': 'Required login metoaden',
  'Verloopt bij inactiviteit op': 'Ferrint as ynaktyf',
  'Verloopt definitief op': 'Ferrint permanint',
  'Verloopt op': 'Ferrint',
  'Versienummer van de PE-regel': 'Ferzjenûmer fan \'e PE-regel',
  'Verwerkte verzoeken': 'Ferwurke oanfragen',
  'Verwijderd op': 'Fuortsmite op',
  'Verwijdering': 'Ferwidering',
  'Verwijderingsregister': 'Ferwideringsregister',
  'Verwijzing naar het antwoord': 'Ferwizing nei it antwurd',
  'Verzoeknummer': 'Fersyk nûmer',
  'Verzoeknummer van de app': 'App fersyk nûmer',
  'Verzonden op': 'Trochstjoerd',
  'Volgende controle op': 'Folgjende check up',
  'Volgnummer': 'Folchnûmer',
  'Volgorde van antwoordopties': 'Folder fan antwurd opsjes',
  'Vraagnummer binnen de toetspoging': 'Fraachnûmer binnen de testpoging',
  'Vraagversienummer': 'Ferzjenûmer fan fraach',
  'Vragen in toetspogingen': 'Fragen yn test besykjen',
  'Vrijgegeven': 'Released',
  'Vrijgegeven op': 'Utjûn op',
  'Wat gebeurt na de bewaartermijn': 'Wat bart der nei de behâld perioade',
  'Wettelijke verplichting': 'Juridyske ferplichting',
  'Wijzigingen aan PE-punten': 'Feroarings oan PE punten',
  'Wijzigingen aan kwalificaties': 'Feroarings oan kwalifikaasjes',
  'Wijzigingen in aanmeldbeveiliging': 'Feroarings oan login feiligens',
  'Zekerheid': 'Wisichheid',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Sykje bygelyks op kursus, datum of status',
  'Zoeken in uw gegevens': 'Sykje jo gegevens',
  '{aantal} categorieën gevonden': '{aantal} kategoryen fûn',
  'Aanwezigheid': 'Oanwêzigens',
  'Lidmaatschap': 'Lidmaatskip',
  'Inzage en wijzigingen': 'Tagong en feroarings',
  'Beschikbaarheid van het inzagespoor': 'Beskikberens fan it tagongslogboek',
  'Beschikbaar vanaf': 'Beskikber fan',
  'Historie vóór deze datum': 'Skiednis foar dizze datum',
  'Tijdstip': 'Datum en tiid',
  'Handeling': 'Aksje',
  'Gegevensonderdeel': 'Data kategory',
  'Handelde als': 'Aktearre as',
  'Organisatorische rol': 'Organisatoaryske rol',
  'Bekeken': 'Besjoen',
  'Gewijzigd': 'Feroare',
  'Uzelf': 'Jo',
  'Medewerker': 'Meiwurker',
  'Systeem': 'System',
  'Onbekend': 'Unbekend',
  'Docent': 'Ynstrukteur',
  'Beoordelaar': 'Assessor',
  'Organisatiebeheerder': 'Organisaasje administrator',
  'Niet beschikbaar': 'Net beskikber',
  'Uitoefening van privacyrechten': 'Oefenjen fan privacyrjochten',
  'Beoordeling en certificering': 'Beoardieling en sertifisearring',
  'Uitvoering van het leertraject': 'Levering fan it learprogramma',
  'Cursistenadministratie': 'Learner administraasje',
  'Cursistprofiel': 'Learner profyl',
  'Leerstatistieken': 'Learning statistiken',
  'Inschrijving': 'Ynskriuwing',
  'Toetspoging': 'Beoardieling besykjen',
  'Beoordeling': 'Assessment',
  'Bewijsstuk': 'Bewiis',
  'Kwalificatie': 'Kwalifikaasje',
  'Deelname': 'Partisipaasje',
  'PE-punten': 'Fuortset ûnderwiis punten',
  'Certificaat': 'Sertifikaat',
  'Privacyverzoek': 'Privacy fersyk',
  'Bewaard tot': 'Behâlden oant',
  'Bekijk mijn gegevens': 'Besjoch myn gegevens',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Besjoch hokker gegevens eLearning oer jo registrearre hat.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Dit oersjoch is op {datum} streekrjocht by eLearning ophelle en wurdt net troch OciDeck bewarre.',
  'Geen gegevens geregistreerd': 'Gjin gegevens registrearre',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'It befettet alle kategoryen dy\'t de server foar dizze organisaasje oanlevere hat. Foar ynformaasje oer doelen, ûntfangers, herkomst, bewaarterminen of jo oare privacyrjochten kinne jo terjochte by {organisatie}.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Jo gegevens koene net laden wurde. Besykje it opnij.',
  'Meer tonen ({aantal} resterend)': 'Mear sjen litte ({aantal} oer)',
  'Mijn gegevens': 'Myn gegevens',
  'Privacy-inzage': 'Ynslach yn persoansgegevens',
  'Uw geregistreerde gegevens': 'Jo registrearre gegevens',
  'uw organisatie': 'jo organisaasje',
  '{aantal} registraties': '{aantal} registraasjes',
  ...
  'Deze organisatie bevat te veel lessen om veilig te tonen.':
      'Dizze organisaasje befettet te folle lessen om feilich te toanen.',
  'Er wacht nog voortgang op synchronisatie.':
      'Der wachtet noch fuortgong op syngronisaasje.',
  'Met deze keuze wordt het vernieuwtoken in de sleutelbos bewaard. Een versleutelde wachtrij voor nog niet verstuurde voortgang wordt daar los van bewaard.':
      'Mei dizze kar wurdt it fernijingstoken yn de kaairing bewarre. In fersifere wachtrige foar noch net ferstjoerde fuortgong wurdt dêrfan apart bewarre.',
  'Nog niet verstuurde voortgang is op dit apparaat bewaard.':
      'Noch net ferstjoerde fuortgong is op dit apparaat bewarre.',
  'Cursist': 'Kursist',
  'Les afgerond': 'Les ôfmakke',
  'Cursussen voor u': 'Kursussen foar jo',
  'Ga verder waar u gebleven was, of kies een andere cursus die voor u klaarstaat.':
      'Gean fierder dêr\'t jo bleaun wiene, of kies in oare kursus dy\'t foar jo klearstiet.',
  'Klaar om te beginnen': 'Klear om te begjinnen',
  'Mijn cursussen': 'Myn kursussen',
  'Mijn leeromgeving': 'Myn learomjouwing',
  'Mooi gedaan! Uw voortgang is bewaard.':
      'Moai dien! Jo fuortgong is bewarre.',
  'Nu bezig': 'No dwaande',
  'Opnieuw starten': 'Opnij begjinne',
  'Terug naar mijn cursussen': 'Werom nei myn kursussen',
  'U kunt deze cursus opnieuw bekijken.': 'Jo kinne dizze kursus opnij besjen.',
  'Volgende: {les}': 'Folgjende: {les}',
  'Welkom, {naam}': 'Wolkom, {naam}',
  ...
  '{afgerond} van {totaal} lessen afgerond':
      '{afgerond} fan {totaal} lessen ôfrûne',
  'Uitloggen': 'Ofmelde',
  ...
  '{n} tabellen passen niet op de bladbreedte, ook niet op de kleinste letter.':
      '{n} tabellen passe net op de bledbreedte, ek net by de lytste letter.',
  'Lange woorden en waarden zoals hashes of IP-adressen zijn daardoor middenin afgebroken.':
      'Lange wurden en wearden lykas hashes of IP-adressen binne dêrtroch midden trochbrutsen.',
  ...
  'Thema documentband': 'Tema-kop-/foettekstbalke',
  ...
  'Basislettergrootte: {pt} pt': 'Basisletterjitte: {pt} pt',
  ...
  'Categorie opheffen (blokken blijven behouden)':
      'Kategory opheffe (blokken bliuwe bewarre)',
  'Uitleg': 'Útlis',
  ...
  'Met afloop wordt de pagina rondom groter dan het gekozen formaat, zodat inkt die tot de rand loopt dóór de snijlijn heen gaat. De afloop geldt voor élke export tot je hem weer op 0 zet. Laat dit op 0 voor gewoon afdrukken.':
      'Mei ôfrin wurdt de side rûnom grutter as it keazen formaat, sadat inket dat oant de râne rint troch de snijline hinne giet. De ôfrin jildt foar eltse eksport oant do him wer op 0 setst. Lit dit op 0 foar gewoan printsjen.',
  'Pagina\'s': 'Siden',
  'Maat': 'Grutte',
  'Staand': 'Steand',
  'Liggend': 'Lizzend',
  ...
  'Dit bestand is {grootte} groot. Dat is meer dan de aanbevolen limiet van {limiet}. Importeren kan traag zijn en veel geheugen vragen — op een kleiner apparaat kan de app vastlopen.':
      'Dit bestân is {grootte} grut. Dat is mear as de oanrikkemandearre limyt fan {limiet}. Ymportearje kin stadich wêze en in soad ûnthâld freegje — op in lytser apparaat kin de app fêstrinne.',
  'Toch importeren': 'Dochs ymportearje',
  'Koptekst': 'Koptekst',
  ...
  'Sluit één of meer OpenKAT-omgevingen aan (bijvoorbeeld productie en acceptatie). OciDeck toont beschikbare rapportages; de inhoud haalt u binnen via een JSON-export uit OpenKAT.':
      'Slút ien of mear OpenKAT-omjouwingen oan (bygelyks produksje en akseptaasje). OciDeck toant beskikbere rapportaazjes; de ynhâld helje jo op fia in JSON-eksport út OpenKAT.',
  'Server toevoegen…': 'Server tafoegje…',
  'Rapportage van server…': 'Rapportaazje fan server…',
  'Nog geen OpenKAT-server aangesloten.': 'Noch gjin OpenKAT-server oansluten.',
  'Bezig…': 'Dwaande…',
  'OpenKAT-server bewerken': 'OpenKAT-server bewurkje',
  'OpenKAT-server toevoegen': 'OpenKAT-server tafoegje',
  'OpenKAT-server toevoegen…': 'OpenKAT-server tafoegje…',
  'OpenKAT-server verwijderen?': 'OpenKAT-server fuortsmite?',
  'Dit verwijdert “{name}” en het bijbehorende toegangstoken van dit apparaat. Dat kunt u niet ongedaan maken.':
      'Dit ferwideret “{name}” en it bybehorende tagongstoken fan dit apparaat. Dat kin net ûngedien makke wurde.',
  'Weergavenaam': 'Werjeftenamme',
  'Bijvoorbeeld Productie of Acceptatie': 'Bygelyks Produksje of Akseptaasje',
  'Adres van OpenKAT': 'Adres fan OpenKAT',
  'Verbinding met: {host}': 'Ferbining mei: {host}',
  'Eigen netwerk (LAN)': 'Eigen netwurk (LAN)',
  'Alleen voor OpenKAT op het eigen netwerk. Staat HTTP toe en laat privé-adressen toe. Uitgeschakeld: alleen HTTPS.':
      'Allinnich foar OpenKAT op it eigen netwurk. Stiet HTTP ta en lit privee-adressen ta. Ut: allinnich HTTPS.',
  'Toegangstoken': 'Tagongstoken',
  'Laat leeg om het opgeslagen token te behouden':
      'Lit leech om it bewarre token te behâlden',
  'Plak het token hier': 'Plak it token hjir',
  'Vraag uw OpenKAT-beheerder om een API-token in het beheerdersscherm. Het token blijft op dit apparaat, in de sleutelhanger van uw besturingssysteem — niet in het deck.':
      'Freeg jo OpenKAT-behearder om in API-token yn it beheardersskerm. It token bliuwt op dit apparaat, yn de kaaihanger fan jo bestjoeringssysteem — net yn it deck.',
  'Verbinding wordt getest…': 'Ferbining wurdt test…',
  'Test de verbinding voordat u opslaat, zodat u weet dat naam, adres en token kloppen.':
      'Test de ferbining foardat jo opslaan, sadat jo witte dat namme, adres en token klopje.',
  'De OpenKAT-koppeling is alleen beschikbaar in de desktopversie.':
      'De OpenKAT-koppeling is allinnich beskikber yn de desktopferzje.',
  'Lees OpenKAT-rapportages in als één managementoverzicht — vanuit een map of vanaf een server.':
      'Lês OpenKAT-rapportaazjes yn as ien managementoersicht — fan in map of fan in server.',
  'Er staat al een OpenKAT-bron ingesteld; de koppeling blijft daarom bereikbaar, zodat een bestaand OpenKAT-deck bij te werken blijft.':
      'Der stiet al in OpenKAT-bron yn; de koppeling bliuwt beskikber om in bestean OpenKAT-deck by te wurkjen.',
  'Rapportage van OpenKAT-server': 'Rapportaazje fan OpenKAT-server',
  'Rapportage van OpenKAT-server…': 'Rapportaazje fan OpenKAT-server…',
  'Server: {name}': 'Server: {name}',
  'Organisaties worden opgehaald…': 'Organisaasjes wurde ophelle…',
  'Rapportages worden opgehaald…': 'Rapportaazjes wurde ophelle…',
  'Er zijn geen organisaties zichtbaar voor dit token. Vraag uw beheerder om toegang, of kies een andere server.':
      'Der binne gjin organisaasjes sichtber foar dit token. Freeg jo behearder om tagong, of kies in oare server.',
  'Er staan geen organisatierapportages klaar op deze server. Maak in OpenKAT eerst een aggregaat-organisatierapport, of kies een andere organisatie.':
      'Der steane gjin organisaasjerapportaazjes klear op dizze server. Meitsje yn OpenKAT earst in aggregaat-organisaasjerapport, of kies in oare organisaasje.',
  'JSON-export uit OpenKAT': 'JSON-eksport út OpenKAT',
  'OpenKAT levert de rapportage-inhoud als JSON-bestand. Exporteer in OpenKAT het gekozen rapport als JSON, en wijs dat bestand of de map hieraan.':
      'OpenKAT leveret de rapportaazje-ynhâld as JSON-bestân. Eksportearje yn OpenKAT it keazen rapport as JSON, en wiis dat bestân of de map hjir op oan.',
  'Gekozen: {reportName} · {orgName} · {serverName}':
      'Keazen: {reportName} · {orgName} · {serverName}',
  'JSON-bestand kiezen…': 'JSON-bestân kieze…',
  'Map met exports kiezen…': 'Map mei eksport kieze…',
  'Vul een weergavenaam in, bijvoorbeeld Productie.':
      'Fol in in werjeftenamme, bygelyks Produksje.',
  'Vul een weergavenaam en een adres in.':
      'Fol in in werjeftenamme en in adres.',
  'Plak een toegangstoken om verder te gaan.':
      'Plak in tagongstoken om troch te gean.',
  'Vul een adres in, bijvoorbeeld https://openkat.voorbeeld.nl':
      'Fol in in adres, bygelyks https://openkat.voorbeeld.nl',
  'Dit adres is niet geldig. Controleer of u een volledige URL heeft ingevuld.':
      'Dit adres is net jildich. Kontrolearje oft jo in folsleine URL ynfolle hawwe.',
  'Het adres moet met https:// beginnen, of zet Eigen netwerk aan voor HTTP op het eigen netwerk.':
      'It adres moat begjinne mei https://, of set Eigen netwurk oan foar HTTP op it eigen netwurk.',
  'Verbonden met {host}. Er zijn nog geen organisaties zichtbaar voor dit token.':
      'Ferbûn mei {host}. Der binne noch gjin organisaasjes sichtber foar dit token.',
  'Verbonden met {host}. {n} organisatie(s) bereikbaar.':
      'Ferbûn mei {host}. {n} organisaasje(s) berikber.',
  'De verbinding met OpenKAT is mislukt. Controleer het adres en uw netwerk, en probeer opnieuw.':
      'De ferbining mei OpenKAT is mislearre. Kontrolearje it adres en jo netwurk, en probearje opnij.',
  'Er is geen toegangstoken. Plak het token van uw beheerder en probeer opnieuw.':
      'Der is gjin tagongstoken. Plak it token fan jo behearder en probearje opnij.',
  'Alleen HTTPS is toegestaan, tenzij Eigen netwerk aan staat.':
      'Allinnich HTTPS is tastien, útsein as Eigen netwurk oan stiet.',
  'OpenKAT weigerde het token. Vraag uw beheerder om een geldig API-token en plak het opnieuw.':
      'OpenKAT weigerde it token. Freeg jo behearder om in jildich API-token en plak it opnij.',
  'OpenKAT reageerde niet op tijd. Controleer of de server bereikbaar is en probeer opnieuw.':
      'OpenKAT regearrearde net op tiid. Kontrolearje oft de server berikber is en probearje opnij.',
  'Dit adres is niet bereikbaar. Controleer de spelling van de hostnaam en of u op het juiste netwerk zit.':
      'Dit adres is net berikber. Kontrolearje de stavering fan de hostnamme en oft jo op it goede netwurk sitte.',
  'OpenKAT gaf een onverwacht groot antwoord. Probeer later opnieuw of vraag uw beheerder om hulp.':
      'OpenKAT joe in ûnferwacht grut antwurd. Probearje letter opnij of freeg jo behearder om help.',
  'Verbonden': 'Ferbûn',
  'Token ontbreekt': 'Token ûntbrekt',
  'Laatst gecontroleerd mislukt': 'Lêst kontrolearre mislearre',
  'Nog niet gecontroleerd': 'Noch net kontrolearre',
  ...
  'De privacyscan vond mogelijk persoonsgegevens in de sessie-data. De export redigeert deze automatisch; klik op een bevinding voor de details.':
      'De privacyscan hat mooglik persoansgegevens fûn yn de sesjedata. De eksportearret se automatysk; klik op in befinding foar de details.',
  'Tijdens het presenteren heb je checklists ingevuld en tabellen bijgewerkt op {aantal} dia’s.':
      'Wylst it presintearjen hawwe jo checklisten ynfolle en tabellen bywurke op {aantal} dia\'s.',
  'en nog {aantal} dia’s.': 'en noch {aantal} dia\'s.',
  'Sessie-wijzigingen bewaren?': 'Sesjewizigingen bewarje?',
  'In deck behouden': 'Yn deck behâlde',
  'Downloaden als losse bestanden': 'Delhelje as losse bestannen',
  'Map voor sessie-bestanden kiezen': 'Map foar sesje-bestannen kieze',
  ...
  'Eénsteeks t-toets': 'Ienstekproef-t-toets',
  ...
  'Chirurgische veiligheidscheck (WHO)': 'Sjirurgyske feiligenskontrôle (WHO)',
  'Verpleegkundige dienstoverdracht': 'Ferpleechkundige tsjinstoerdracht',
  'Inwerkplan (30-60-90 dagen)': 'Ynwurkplan (30-60-90 dagen)',
  'Eerste dag / introductie': 'Earste dei / yntroduksje',
  'Buddy- / mentorafspraak': 'Buddy- / mentorôfspraak',
  'Uitdiensttreding / offboarding': 'Utstjinsttreding / offboarding',
  'IMSAFE fit-to-fly-check': 'IMSAFE fit-to-fly-kontrôle',
  'Crew- / departurebriefing': 'Bemanning- / fertrekbriefing',
  'Voorvalmelding (just culture)': 'Foarfalmelding (just culture)',
  'Toolbox / LMRA veiligheidscheck': 'Toolbox / LMRA-feiligenskontrôle',
  'Evenement- en crowd-safetybriefing': 'Evenemint- en crowd-safetybriefing',
  'Ontruimings- en BHV-oefening': 'Ûntromings- en BHV-oefening',
  'Werkvergunning (permit to work)': 'Wurkfergunning (permit to work)',
  'METHANE grootschalig-incidentmelding': 'METHANE grutskalich-ynsidintmelding',
  'GRIP-opschaling': 'GRIP-opskaling',
  'Maritieme passage-/brugbriefing': 'Maritime passaazje-/brêgebriefing',
  'Draag een patiënt of situatie gestructureerd over: Situatie, Achtergrond, Beoordeling en Aanbeveling.':
      'Draach in pasjint of situaasje strukturearre oer: Situaasje, Eftergrûn, Beoardieling en Oanrikkemandaasje.',
  'Prehospitale overdracht naar de SEH met leeftijd, mechanisme, letsels, symptomen en behandeling.':
      'Prehospitale oerdracht nei de spoedhelp mei leeftyd, meganisme, ferwûnings, symptomen en behanneling.',
  'Bespreek een casus met alle disciplines: beeld, behandeldoel, besluiten en afspraken.':
      'Besprek in kasus mei alle dissiplines: byld, behannieldoel, besluten en ôfspraken.',
  'Sign in, time-out en sign out rond een ingreep volgens de WHO-checklist.':
      'Sign in, time-out en sign out om in yngreep hinne folgjens de WHO-checklist.',
  'Draag de zorg per patiënt over: toestand, aandachtspunten en openstaande taken.':
      'Draach de soarch per pasjint oer: tastân, oandachtspunten en iepensteande taken.',
  'Zet verwachtingen, mijlpalen en begeleiding uit over de eerste 30, 60 en 90 dagen.':
      'Set ferwachtings, mylpeallen en begelieding út oer de earste 30, 60 en 90 dagen.',
  'Mensen, systemen, huisregels en de veiligheids- en privacybasis voor een nieuwe medewerker.':
      'Minsken, systemen, hûsregels en de feiligens- en privacybasis foar in nije meiwurker.',
  'Doelen, ritme en checkpoints tussen nieuwkomer en buddy of mentor.':
      'Doelen, ritme en checkpoints tusken nijkommer en buddy of mentor.',
  'Kennisoverdracht, intrekken van toegang en een net exitgesprek bij vertrek.':
      'Kennisoerdracht, ynlûken fan tagong en in kreas eksitpetear by fertrek.',
  'Persoonlijke go/no-go: ziekte, medicatie, stress, alcohol, vermoeidheid en gemoed.':
      'Persoanlik go/no-go: sykte, medikaasje, stress, alkohol, wurgens en gemoed.',
  'Taakverdeling, bedreigingen en fouten (TEM) en afwijkingen vóór vertrek met de bemanning.':
      'Taakferdieling, bedrigings en flaters (TEM) en ôfwikings foar it fertrek mei de bemanning.',
  'Meld een voorval feitelijk en zonder schuldvraag: wat, factoren, risico en verbetering.':
      'Meld in foarfal feitlik en sûnder skuldfraach: wat, faktoaren, risiko en ferbettering.',
  'Taak, gevaren, maatregelen en akkoord vlak voordat het werk begint.':
      'Taak, gefaren, maatregels en akkoord flak foardat it wurk begjint.',
  'Capaciteit, risico\'s, in- en uitstroom en incidentrollen voor een evenement.':
      'Kapasiteit, risiko\'s, yn- en útstream en ynsidintrollen foar in evenemint.',
  'Scenario, taken, verzamelplaats, waarnemingen en evaluatie van een ontruiming.':
      'Senario, taken, sammelplak, waarnimmings en evaluaasje fan in ûntromming.',
  'Werk, isolaties, controles en vrijgave voor risicovol werk vastleggen.':
      'Wurk, isolaasjes, kontrôles en frijjefte foar risikofol wurk fêstlizze.',
  'Eerste melding bij een groot incident: melding, locatie, type, gevaren, toegang, aantal en diensten.':
      'Earste melding by in grut ynsidint: grut ynsidint, krekte lokaasje, type, gefaren, tagong, oantal en tsjinsten.',
  ...
  'De browser blokkeert media van een externe bron. Open deze presentatie in de app om online media te tonen.':
      'De browser blokkearret media fan in eksterne boarne. Iepenje dizze presintaasje yn de app om online media te toanen.',
  ...
  'Presentaties openen uit en opslaan naar WebDAV, S3 en git-repository’s, met versiebeheer en samenwerken via een forge. Een deel van deze paden is tot nu toe vooral tegen testomgevingen beproefd; kies dit bewust. Zonder de module werkt alles lokaal gewoon: mappen, bestanden en pakketten.':
      'Presintaasjes iepenje út en opslaan nei WebDAV, S3 en git-repositories, mei ferzjebehear en gearwurking fia in forge. In part fan dizze paden is oant no ta benammen tsjin testomjouwingen beproefd; kies dit bewust. Sûnder de module wurket alles lokaal gewoan: mappen, bestannen en pakketten.',
  'Er staan al online verbindingen ingesteld; die blijven werken, net als wachtend werk in de wachtrij. Uit betekent alleen: geen nieuwe online verbindingen toevoegen.':
      'Der steane al online ferbiningen ynsteld; dy bliuwe wurkjen, krekt as wachtsjend wurk yn \'e wachtrige. Út betsjut allinne: gjin nije online ferbiningen tafoegje.',
  ...
  'OciDeck zelf staat onder de EUPL-1.2. Daarnaast bundelt het software van derden: de Dart- en Flutter-pakketten, twee gevendorde pakketten, vijf lettertypefamilies, het gezichtsmodel voor de privacycontrole en de JavaScript die in een HTML-export meegaat. Elk daarvan houdt zijn eigen licentie.':
      'OciDeck sels stiet ûnder de EUPL-1.2. Dêrneist bondelet it software fan tredden: de Dart- en Flutter-pakketten, twa meilevere pakketten, fjouwer lettertypefamyljes, it gesichtsmodel foar de privacykontrôle en it JavaScript dat yn in HTML-eksport meireizget. Elk dêrfan hâldt syn eigen lisinsje.',
  ...
  'TOTP-seed (tweede factor)': 'TOTP-sied (twadde faktor)',
  'mogelijk een sleutel of wachtwoord': 'mooglik in kaai of wachtwurd',
  ...
  'werkgeversnummer (EIN)': 'wurkjouwersnûmer (EIN)',
  'laatste vier cijfers van een SSN': 'lêste fjouwer sifers fan in SSN',
  ...
  'Vingerafdruk (SHA-256)': 'Fingerôfdruk (SHA-256)',
  ...
  'IMSI van een abonnee': 'IMSI fan in abonnee',
  'sociale-mediaprofiel': 'sosjale-mediaprofyl',
  'advertentie- of apparaat-ID': 'advertinsje- of apparaat-ID',
  'IP-adres': 'IP-adres',
  ...
  'Deze slide hoort bij de lijst van de vorige slide en deelt daarmee één lettergrootte: die van de volste pagina.':
      'Dizze slide heart by de list fan de foarige slide en dielt dêrmei ien lettergrutte: dy fan de folste side.',
  ...
  'waarde(n) uit de CSV zijn niet als getal gelezen en staan nu op 0:':
      'wearde(n) út de CSV binne net as getal lêzen en steane no op 0:',
  ...
  'Native git: niet gevonden — het REST-pad wordt gebruikt':
      'Native git: net fûn — it REST-paad wurdt brûkt',
  'echte offline-historie mogelijk': 'echte offline-skiednis mooglik',
  ...
  'Alle scope-objecten hebben al een checklist':
      'Alle scope-objekten hawwe al in checklist',
  'Maakt per scope-object een checklist (WSTG voor web/API); bestaande blijven staan.':
      'Makket per scope-objekt in checklist (WSTG foar web/API); besteande bliuwe stean.',
  ...
  'OciDeck verzamelt geen statistieken en stuurt uit zichzelf niets naar buiten. Standaard blijft alles op dit apparaat. Gegevens verlaten dit apparaat alleen als jij dat kiest:\n\n•  Nextcloud/WebDAV: verbind je met een server, dan worden je inlognaam en wachtwoord bewaard (het wachtwoord veilig in de sleutelbos van je systeem) en worden de presentaties die je opent of opslaat naar die server verstuurd.\n•  Openen via URL: OciDeck haalt het bestand op van het adres dat je invoert.\n•  Online media (staat standaard uit): indien ingeschakeld laadt OciDeck afbeeldingen en video\'s van de adressen in je dia\'s.\n•  Externe links (zoals de online licentie) openen in je browser.':
      'OciDeck sammelet gjin statistiken en stjoert út himsels neat nei bûten. Standert bliuwt alles op dit apparaat. Gegevens ferlitte dit apparaat allinnich ast dat kiest:\n\n•  Nextcloud/WebDAV: ferbynst mei in server, dan wurde dyn ynlognamme en wachtwurd bewarre (it wachtwurd feilich yn de kaaibosk fan dyn systeem) en wurde de presintaasjes datst iepenst of bewarrest nei dy server stjoerd.\n•  Iepenje fia URL: OciDeck hellet it bestân op fan it adres datst ynfierst.\n•  Online media (stiet standert út): as ynskeakele laadt OciDeck ôfbyldings en fideo\'s fan de adressen yn dyn dia\'s.\n•  Eksterne keppelings (lykas de online lisinsje) iepenje yn dyn browser.',
  'OciDeck wordt geleverd onder de European Union Public Licence v1.2. Door akkoord te gaan aanvaard je deze licentie. Je mag OciDeck gebruiken, kopiëren, aanpassen en verspreiden onder de voorwaarden van de EUPL 1.2.':
      'OciDeck wurdt levere ûnder de European Union Public Licence v1.2. Troch akkoard te gean akseptearrest dizze lisinsje. Do meist OciDeck brûke, kopiearje, oanpasse en ferspriede ûnder de betingsten fan de EUPL 1.2.',
  'Om te werken en je werk niet te verliezen, bewaart OciDeck gegevens lokaal op dit apparaat:\n\n•  Je instellingen en voorkeuren (taal, mappen, stijl- en weergaveprofielen, recente bestanden).\n•  Je presentatiematerialen: de presentaties die je opslaat, automatische herstelkopieën en bijlagen zoals afbeeldingsbeschrijvingen.\n•  Deze toestemmingskeuze.\n\nJe kunt dit verwijderen door de bestanden te wissen of de instellingen te resetten.':
      'Om te wurkjen en dyn wurk net te ferliezen, bewarret OciDeck gegevens lokaal op dit apparaat:\n\n•  Dyn ynstellings en foarkarren (taal, mappen, styl- en werjefteprofilen, resinte bestannen).\n•  Dyn presintaasjematerialen: de presintaasjes datst bewarrest, automatyske werstelkopyen en bylagen lykas ôfbyldingsbeskriuwingen.\n•  Dizze tastimmingskar.\n\nDo kinst dit fuortsmite troch de bestannen te wiskjen of de ynstellings te resetten.',
  'Volledige licentie online (23 officiële taalversies)':
      'Folsleine lisinsje online (23 offisjele taalferzjes)',
  'Wat OciDeck op dit apparaat bewaart': 'Wat OciDeck op dit apparaat bewarret',
  'Wat je apparaat verlaat': 'Wat dyn apparaat ferlit',
  ...
  'Veel bullets op deze slide': 'In protte bullets op dizze dia',
  'bullets': 'bullets',
  'Overweeg de inhoud te splitsen.': 'Oerweech de ynhâld op te splitsen.',
  'Erg veel bullets op deze slide': 'Te folle bullets op dizze dia',
  'Splits deze inhoud over meerdere slides.':
      'Split dizze ynhâld oer meardere dia\'s.',
  'Veel woorden in bullets': 'In protte wurden yn bullets',
  'woorden': 'wurden',
  ...
  'Bullet met meerdere zinnen gevonden. Maak bullets kernachtiger of splits de inhoud.':
      'Bullet mei meardere sinnen fûn. Meitsje bullets bondiger of split de ynhâld op.',
  'Diepe bulletniveaus gevonden': 'Djippe bulletnivo\'s fûn',
  'niveau': 'nivo',
  'Beperk nesting voor betere leesbaarheid.':
      'Behein nesting foar bettere lêsberens.',
  'Twee kolommen zijn sterk uit balans': 'Twa kolommen binne sterk út balâns',
  'tegenover': 'tsjinoer',
  'Verdeel of splits de inhoud.': 'Ferdiel of split de ynhâld op.',
  ...
  'Begin de nummering waar de vorige slide ophield.':
      'Begjin de nûmering wêr\'t de foarige slide ophâlde.',
  ...
  'Takenplan informatieveiligheid': 'Takenplan ynformaasjefeiligens',
  ...
  'LibrePlan-connector': 'LibrePlan-keppeling',
  'De LibrePlan-connector is alleen beschikbaar in de desktopversie.':
      'De LibrePlan-keppeling is allinne beskikber yn de desktopferzje.',
  'LibrePlan-connector is optioneel en staat standaard uit. Er wordt niets opgehaald totdat u dit inschakelt en zelf een server configureert. Alleen-lezen: de connector schrijft niets terug naar LibrePlan. Het wachtwoord wordt in de sleutelhanger van uw besturingssysteem opgeslagen, niet in het deck.':
      'De LibrePlan-keppeling is opsjoneel en stiet standert út. Der wurdt neat ophelle oant jo dit ynskeakelje en sels in server ynstelle. Allinne-lêze: de keppeling skriuwt neat werom nei LibrePlan. It wachtwurd wurdt bewarre yn de kaaihanger fan jo bestjoeringssysteem, net yn it deck.',
  'Opgeslagen in de sleutelhanger': 'Bewarre yn de kaaihanger',
  'Alleen voor servers op het eigen netwerk (LAN). Staat plain-HTTP toe en staat privé-adressen door de NetGuard. Uitgeschakeld: HTTPS verplicht.':
      'Allinne foar servers op it eigen netwurk (LAN). Lit gewoan HTTP ta en lit privee-adressen troch de NetGuard. Út: HTTPS ferplicht.',
  'Verbinding succesvol.': 'Ferbining slagge.',
  'Onverwachte fout.': 'Unferwachte flater.',
  'Importeren uit LibrePlan': 'Ymportearje út LibrePlan',
  'LibrePlan importeren': 'Ut LibrePlan ymportearje',
  'Kies welke slides u uit het LibrePlan-project wilt halen. De import is alleen-lezen en schrijft niets terug.':
      'Kies hokker dia\'s jo út it LibrePlan-projekt helje wolle. De ymport is allinne-lêze en skriuwt neat werom.',
  'Gantt-planning': 'Gantt-planning',
  'WBS (hiërarchie)': 'WBS (hiërargy)',
  'Projectstatus (cockpit)': 'Projektstatus (cockpit)',
  'Milestones (tijdlijn)': 'Mylpeallen (tiidline)',
  'Kritieke pad (flow)': 'Kritysk paad (flow)',
  'Resources (tabel)': 'Boarnen (tabel)',
  'Timesheet (tabel)': 'Oerestaat (tabel)',
  'Resourcebelasting (grafiek)': 'Boarnebelesting (grafyk)',
  'Ophalen uit LibrePlan…': 'Ophelje út LibrePlan…',
  ...
  'Vul server-URL en gebruikersnaam in.':
      'Folje server-URL en brûkersnamme yn.',
