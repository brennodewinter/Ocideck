...
const _dutchSourceAddLv = <String, String>{
  ...
  'Dit document verwijst naar afbeeldingen of grafiekdata in losse bestanden. Een kale .md- of .tex-download bevat alleen de tekst — bij de ontvanger zijn de verwijzingen dood. Kies HTML, PDF of DOCX om alles in één bestand te leveren, of ga door als alleen de tekst telt.':
      'Šis dokuments atsaucas uz attēliem vai diagrammu datiem atsevišķos failos. Tīra .md vai .tex lejupielāde satur tikai tekstu — atsauces saņēmējam ir mirušas. Izvēlieties HTML, PDF vai DOCX, lai visu piegādātu vienā failā, vai turpiniet, ja svarīgs ir tikai teksts.',
  'Datum en tijd kiezen': 'Izvēlieties datumu un laiku',
  'Deze lokale tijd bestaat niet door de overgang naar zomertijd. Kies een andere tijd.':
      'Šis vietējais laiks nepastāv, jo notiek pāreja uz vasaras laiku. Izvēlieties citu laiku.',
  'Deze lokale tijd komt twee keer voor. Kies de juiste UTC-offset.':
      'Šis vietējais laiks iestājas divreiz. Izvēlieties pareizo UTC nobīdi.',
  'Een datum blijft een datum. Kies je ook een tijd, dan slaat OciDeck het tijdstip op in UTC en toont het met de lokale UTC-offset.':
      'Datums paliek datums. Ja izvēlaties arī laiku, OciDeck saglabā laika momentu UTC formātā un parāda to ar vietējo UTC nobīdi.',
  ...
  'Aangemaakt op': 'Izveidots',
  'Aanmeldprovider': 'Pieteikšanās nodrošinātājs',
  'Aanmeldsessies': 'Reģistrācijas sesijas',
  'Aantal controles': 'Pārbaužu skaits',
  ...
  'Activiteitnummer': 'Aktivitātes numurs',
  'Afgerond op': 'Noapaļots līdz',
  'Afgewezen': 'Noraidīts',
  'Afspeelsessienummer': 'Atskaņošanas sesijas numurs',
  'Afwezig': 'Nav klāt',
  'Antwoordgegevens': 'Atbildes detaļas',
  'Antwoordstatus': 'Atbildes statuss',
  'Begint op': 'Sākas',
  'Begrippen uitgelegd': 'Jēdzieni izskaidroti',
  'Beheer van de installatie': 'Instalācijas vadība',
  'Beheerpogingen': 'Pārvaldības centieni',
  'Bekeken lessen': 'Nodarbības skatītas',
  'Beleidsversie': 'Politikas versija',
  'Beoordeeld': 'Novērtēts',
  'Beoordeeld op': 'Vērtēja',
  'Beperking': 'Ierobežojums',
  'Berekend op': 'Aprēķināts uz',
  'Bericht': 'Ziņa',
  'Bestandsnaam': 'Faila nosaukums',
  'Beveiligingsvraagnummer': 'Drošības jautājuma numurs',
  'Bevestigd': 'Apstiprināts',
  'Bevestigd op': 'Apstiprināts',
  'Bewaarregels': 'Saglabāšanas noteikumi',
  'Bewaartermijn': 'Uzglabāšanas periods',
  'Bewaren wegens een juridische verplichting':
      'Saglabāts juridiska pienākuma dēļ',
  'Bewerkingnummer bij aanmeldprovider':
      'Operācijas numurs pie reģistrācijas nodrošinātāja',
  'Bewijsstukken': 'Pierādījumi',
  'Bezwaar': 'Iebildums',
  'Beëindigd op': 'Beigās',
  'Bijeenkomstnummer': 'Sapulces numurs',
  'Certificaatnummer': 'Sertifikāta numurs',
  'Certificaten': 'Sertifikāti',
  'Controlecode van de PDF': 'PDF kontroles kods',
  'Controlecode van profielfoto': 'Profila fotoattēla verifikācijas kods',
  'Controlecodes van bewijsstukken': 'Apliecinošo dokumentu kontroles kodi',
  'Correctie': 'Labojums',
  'Cursistnummer waarop de actie gericht was':
      'Studenta numurs, uz kuru darbība bija vērsta',
  'Cursusaanbodnummer': 'Kursu piedāvājuma numurs',
  'Cursusversienummer': 'Kursa versijas numurs',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Datumi un laiki tiek rādīti pēc jūsu vietējā laika. Tehniskie nosaukumi paliek redzami, ja serveris nodrošina nezināmu lauku.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'Jūsu sniegtās atbildes uz testa jautājumiem.',
  'Deelnamenummer': 'Dalības numurs',
  'Deelnames': 'Līdzdalības',
  'Details': 'Sīkāka informācija',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Šo kategoriju nodrošināja serveris. Tehniskie nosaukumi paliek redzami jūsu organizācijas pieprasījumiem.',
  'Door uzelf aangevraagd': 'Pats pieprasījis',
  'E-mailadres': 'E-pasta adrese',
  'E-mailberichten': 'E-pasta ziņas',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'ID ir unikāls tehniskais numurs, ko eLearning izmanto datu saistīšanai. Tas nav vērtējums vai statuss.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'Kategorijā tiek apkopoti dati par vienu un to pašu tēmu. Reģistrācija ir viena saglabāta datu daļa vai viens notikums.',
  'Eindigt op': 'Beidzas',
  'Geaccepteerd op': 'Pieņemts',
  'Geannuleerd': 'Atcelts',
  'Gecontroleerd': 'Pārbaudīts',
  'Gecontroleerd op': 'Pārbaudīts',
  'Geen gegevens gevonden': 'Dati nav atrasti',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Informācija par jūsu datu saglabāšanas periodiem un dzēšanu.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Informācija par apliecinošiem dokumentiem, sasniegtajiem rezultātiem un sertifikātiem.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Informācija par privātuma pieprasījumiem un to, kas skatīja vai mainīja jūsu informāciju.',
  'Gegevens over uw accountbewerking': 'Informācija par jūsu konta darbību',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Informācija par tavu reģistrāciju, dalību un gaitu nodarbībās.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Informācija par jūsu profilu, kontu un amatu organizācijā.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Informācija par jūsu pārbaudes brīžiem un uzdotajiem jautājumiem.',
  'Gegevens over willekeurige volgorde': 'Nejauši pasūtījuma dati',
  'Gegevenscategorie': 'Datu kategorija',
  'Gekoppeld accountnummer': 'Saistītā konta numurs',
  'Gekozen antwoorden': 'Atlasītās atbildes',
  'Gelukt': 'Panākumi',
  'Geprobeerd op': 'Izmēģināts',
  'Gerechtvaardigd belang': 'Likumīga interese',
  'Gereserveerd': 'Rezervēts',
  'Gereserveerd op': 'Rezervēts uz',
  'Geslaagd': 'Nokārtots',
  'Gestart op': 'Sākās',
  'Getoonde tijd per dia in milliseconden':
      'Katram slaidam rādītais laiks milisekundēs',
  'Herkomst van inschrijving': 'Reģistrācijas izcelsme',
  'Hoogst haalbare score': 'Augstākais iespējamais rezultāts',
  'Identificatienummer bij aanmeldprovider':
      'Reģistrācijas nodrošinātāja identifikācijas numurs',
  'Identiteitsbewerkingnummer': 'Identitātes operācijas numurs',
  'In afwachting': 'Gaida',
  'In behandeling': 'Notiek',
  'In behandeling genomen op': 'Apstrādāts tālāk',
  'In quarantaine': 'Karantīnā',
  'Ingeleverd': 'Iesniegts',
  'Ingeleverd op': 'Iesniegts',
  'Ingericht op': 'Dekorēts uz',
  'Ingeschreven op': 'Reģistrēts',
  'Ingetrokken': 'Izņemts',
  'Ingetrokken op': 'Atsaukts tālāk',
  'Inschrijvingen': 'Reģistrācijas',
  'Inschrijvingsnummer': 'Reģistrācijas numurs',
  'Installatiebeveiligingslogboek': 'Uzstādīšanas drošības žurnāls',
  'Installatienummer': 'Instalācijas numurs',
  'Installatieverzoeken': 'Uzstādīšanas pieprasījumi',
  'Inzage': 'Pārbaude',
  'Ja': 'Jā',
  'Kwalificatienummer': 'Kvalifikācijas numurs',
  'Kwalificaties': 'Kvalifikācijas',
  'Laatst actief op': 'Pēdējo reizi aktīvais',
  'Laatst bekeken dia': 'Pēdējais skatītais slaids',
  'Laatst gewijzigd op': 'Pēdējoreiz modificēts',
  'Laatste fout': 'Pēdējā kļūda',
  'Lesnummer': 'Nodarbības numurs',
  'Lesreserveringen': 'Nodarbību rezervācijas',
  'Lesvoortgang': 'Nodarbības progress',
  'Lidmaatschappen': 'Dalība',
  'Locatie': 'Atrašanās vieta',
  'Manier van afronden': 'Noapaļošanas veids',
  'Maximaal aantal controles': 'Maksimālais pārbaužu skaits',
  'Maximaal aantal pogingen': 'Maksimālais mēģinājumu skaits',
  'Maximale leeftijd van de aanmelding': 'Maksimālais reģistrācijas vecums',
  'Mislukt': 'Neizdevās',
  'Naam van de activiteit': 'Aktivitātes nosaukums',
  'Naam van de bijeenkomst': 'Sanāksmes nosaukums',
  'Nee': 'Nē',
  'Netwerkadres': 'Tīkla adrese',
  'Niet actief': 'Nav aktīvs',
  'Niet geregistreerd': 'Nav reģistrēts',
  'Niet ingevuld': 'Nav aizpildīts',
  'Niet verschenen': 'Nav publicēts',
  'Niveau van extra aanmeldcontrole': 'Papildu reģistrācijas kontroles līmenis',
  'Nummer van de toetsopzet': 'Pārbaudes plāna numurs',
  'Nummer van het brongegeven': 'Avota datu numurs',
  'Nummer van uw verwijderde gegeven': 'Jūsu dzēsto datu skaits',
  'Onderdeel {nummer}': 'Daļa {nummer}',
  'Onderwerp van de actie': 'Darbības priekšmets',
  'Ontvanger': 'Saņēmējs',
  'Opgegeven bestandsgrootte': 'Norādītais faila lielums',
  'Opgegeven bestandstype': 'Norādītais faila tips',
  'Opgegeven controlecode': 'Norādīts kontroles kods',
  'Opgeslagen bestandsgrootte': 'Saglabātā faila lielums',
  'Opgeslagen controlecode': 'Saglabāts kontroles kods',
  'Organisatienummer': 'Organizācijas numurs',
  'Overdraagbaarheid': 'Pārnesamība',
  'PE-toekenningnummer': 'PE balvas numurs',
  'Poging': 'Mēģinājums',
  'Positie': 'Pozīcija',
  'Privacyverzoeken': 'Privātuma pieprasījumi',
  'Probeer een andere zoekterm.': 'Izmēģiniet citu meklēšanas vienumu.',
  'Reden': 'Iemesls',
  'Reden of grondslag': 'Iemesls vai pamats',
  'Reden van afwijzing': 'Atteikuma iemesls',
  'Reden van bevestiging': 'Apstiprinājuma iemesls',
  'Reden van intrekking': 'Izstāšanās iemesls',
  'Reden voor langer bewaren': 'Iemesls ilgākai uzglabāšanai',
  'Regels voor de cursusversie': 'Kursa versijas noteikumi',
  'Resultaat bij de aanmeldprovider':
      'Rezultāts pie reģistrācijas nodrošinātāja',
  'Rol': 'Roll',
  'Score': 'Rezultāts',
  'Soort aanwezigheid': 'Sava veida klātbūtne',
  'Soort accountbewerking': 'Konta darbības veids',
  'Soort gebeurtenis': 'Pasākuma veids',
  'Soort privacyverzoek': 'Privātuma pieprasījuma veids',
  'Status van de bijeenkomst': 'Sanāksmes statuss',
  'Strenge beveiligingsmodus': 'Augstas drošības režīms',
  'Technisch toegangslogboek': 'Tehniskās piekļuves žurnāls',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Reģistrācijai, drošībai un uzticamai apstrādei nepieciešamie tehniskie dati.',
  'Technische naam: {naam}': 'Tehniskais nosaukums: {naam}',
  'Technische opslagcategorie': 'Tehniskās uzglabāšanas kategorija',
  'Technische opslaglocatie van de PDF': 'PDF tehniskās uzglabāšanas vieta',
  'Tijdstip van aanmelding': 'Reģistrācijas laiks',
  'Tijdzone': 'Laika josla',
  'Toestand': 'Stāvoklis',
  'Toetspogingen': 'Pārbaudes mēģinājumi',
  'Toetspogingnummer': 'Pārbaudes mēģinājuma numurs',
  'Uiterste inlevermoment': 'Iesniegšanas termiņš',
  'Uitgegeven op': 'Publicēts',
  'Uitgenodigd e-mailadres': 'Uzaicinātā e-pasta adrese',
  'Uitnodigingen': 'Ielūgumi',
  'Uniek nummer (ID)': 'Unikāls numurs (ID)',
  'Uniek verwerkingskenmerk': 'Unikāla apstrādes funkcija',
  'Uw accountnummer': 'Jūsu konta numurs',
  'Uw accountnummer als uitvoerder': 'Jūsu konta numurs kā izpildītājs',
  'Uzelf als uploader': 'Jūs kā augšupielādētājs',
  'Vaardigheidsversienummer': 'Prasmes versijas numurs',
  'Vast internetadres van de installatie':
      'Fiksēta instalācijas interneta adrese',
  'Vastgelegde beslisgegevens': 'Reģistrētie lēmumu dati',
  'Vastgelegde gegevens': 'Ierakstītie dati',
  'Vereist niveau van aanmeldzekerheid':
      'Nepieciešamais reģistrācijas noteiktības līmenis',
  'Vereiste aanmeldmethoden': 'Nepieciešamās pieteikšanās metodes',
  'Verloopt bij inactiviteit op':
      'Derīguma termiņš beidzas, kad tas nav aktīvs',
  'Verloopt definitief op': 'Beidzas neatgriezeniski',
  'Verloopt op': 'Beidzas',
  'Versienummer van de PE-regel': 'PE kārtulas versijas numurs',
  'Verwerkte verzoeken': 'Apstrādātie pieprasījumi',
  'Verwijderd op': 'Noņemts',
  'Verwijdering': 'Noņemšana',
  'Verwijderingsregister': 'Izņemšanas reģistrs',
  'Verwijzing naar het antwoord': 'Atsauce uz atbildi',
  'Verzoeknummer': 'Pieprasīt numuru',
  'Verzoeknummer van de app': 'Lietotnes pieprasījuma numurs',
  'Verzonden op': 'Nosūtīts tālāk',
  'Volgende controle op': 'Nākamā pārbaude',
  'Volgnummer': 'Secības numurs',
  'Volgorde van antwoordopties': 'Atbilžu variantu secība',
  'Vraagnummer binnen de toetspoging':
      'Jautājuma numurs testa mēģinājuma laikā',
  'Vraagversienummer': 'Jautājuma versijas numurs',
  'Vragen in toetspogingen': 'Jautājumi testa mēģinājumos',
  'Vrijgegeven': 'Atbrīvots',
  'Vrijgegeven op': 'Izlaists',
  'Wat gebeurt na de bewaartermijn': 'Kas notiek pēc saglabāšanas perioda',
  'Wettelijke verplichting': 'Juridiskais pienākums',
  'Wijzigingen aan PE-punten': 'Izmaiņas PE punktos',
  'Wijzigingen aan kwalificaties': 'Izmaiņas kvalifikācijā',
  'Wijzigingen in aanmeldbeveiliging': 'Izmaiņas pieteikšanās drošībā',
  'Zekerheid': 'Noteiktība',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Piemēram, meklējiet pēc kursa, datuma vai statusa',
  'Zoeken in uw gegevens': 'Meklējiet savus datus',
  '{aantal} categorieën gevonden': 'Atrastas kategorijas {aantal}',
  'Aanwezigheid': 'Apmeklējums',
  'Lidmaatschap': 'Dalība',
  'Inzage en wijzigingen': 'Piekļuve un izmaiņas',
  'Beschikbaarheid van het inzagespoor': 'Piekļuves žurnāla pieejamība',
  'Beschikbaar vanaf': 'Pieejams no',
  'Historie vóór deze datum': 'Vēsture pirms šī datuma',
  'Tijdstip': 'Datums un laiks',
  'Handeling': 'Darbība',
  'Gegevensonderdeel': 'Datu kategorija',
  'Handelde als': 'Darbojās kā',
  'Organisatorische rol': 'Organizatoriskā loma',
  'Bekeken': 'Skatīts',
  'Gewijzigd': 'Mainīts',
  'Uzelf': 'Tu',
  'Medewerker': 'Darbinieks',
  'Systeem': 'Sistēma',
  'Onbekend': 'Nezināms',
  'Docent': 'Instruktors',
  'Beoordelaar': 'Vērtētājs',
  'Organisatiebeheerder': 'Organizācijas administrators',
  'Niet beschikbaar': 'Nav pieejams',
  'Uitoefening van privacyrechten': 'Privātuma tiesību izmantošana',
  'Beoordeling en certificering': 'Novērtēšana un sertifikācija',
  'Uitvoering van het leertraject': 'Mācību programmas piegāde',
  'Cursistenadministratie': 'Izglītojamo administrēšana',
  'Cursistprofiel': 'Izglītojamā profils',
  'Leerstatistieken': 'Statistikas apgūšana',
  'Inschrijving': 'Reģistrācija',
  'Toetspoging': 'Novērtēšanas mēģinājums',
  'Beoordeling': 'Novērtējums',
  'Bewijsstuk': 'Pierādījumi',
  'Kwalificatie': 'Kvalifikācija',
  'Deelname': 'Līdzdalība',
  'PE-punten': 'Tālākizglītības punkti',
  'Certificaat': 'Sertifikāts',
  'Privacyverzoek': 'Privātuma pieprasījums',
  'Bewaard tot': 'Saglabāts līdz',
  'Bekijk mijn gegevens': 'Skatīt manus datus',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Skatiet, kādus datus eLearning ir reģistrējis par jums.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Šis pārskats tika iegūts tieši no eLearning {datum}, un OciDeck to nesaglabā.',
  'Geen gegevens geregistreerd': 'Nav reģistrētu datu',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'Tas ietver visas kategorijas, ko serveris ir sniedzis šai organizācijai. Lai iegūtu informāciju par nolūkiem, saņēmējiem, izcelsmi, glabāšanas termiņiem vai citām savām privātuma tiesībām, sazinieties ar {organisatie}.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Neizdevās ielādēt jūsu datus. Mēģiniet vēlreiz.',
  'Meer tonen ({aantal} resterend)': 'Rādīt vairāk (atlikuši {aantal})',
  'Mijn gegevens': 'Mani dati',
  'Privacy-inzage': 'Piekļuve personas datiem',
  'Uw geregistreerde gegevens': 'Jūsu reģistrētie dati',
  'uw organisatie': 'jūsu organizācija',
  '{aantal} registraties': 'Ierakstu skaits: {aantal}',
  ...
  'Klik met Ctrl/Cmd of Shift om meerdere bestanden te kiezen.':
      'Noklikšķiniet ar Ctrl/Cmd vai Shift, lai izvēlētos vairākus failus.',
  'Presentaties openen': 'Atvērt prezentācijas',
  ...
  'Het bestand is gewijzigd door een ander programma.':
      'Failu ir mainījusi cita programma.',
  'Herladen': 'Pārlādēt',
  ...
  'Thema documentband': 'Tēmas galvene/kājene',
  ...
  'Basislettergrootte: {pt} pt': 'Pamata fonta lielums: {pt} pt',
  ...
  'Met afloop wordt de pagina rondom groter dan het gekozen formaat, zodat inkt die tot de rand loopt dóór de snijlijn heen gaat. De afloop geldt voor élke export tot je hem weer op 0 zet. Laat dit op 0 voor gewoon afdrukken.':
      'Ar apgriešanas rezervi lappuse no visām pusēm kļūst lielāka par izvēlēto formātu, lai tinte, kas sniedzas līdz malai, turpinātos pāri griešanas līnijai. Apgriešanas rezerve attiecas uz katru eksportu, līdz to atkal iestatāt uz 0. Parastai drukāšanai atstājiet 0.',
  'Pagina\'s': 'Lappuses',
  'Maat': 'Izmērs',
  'Staand': 'Vertikāli',
  'Liggend': 'Horizontāli',
  'documenten': 'dokumenti',
  'posters en boeken': 'plakāti un grāmatas',
  ...
  'Doorgaan met bewerken': 'Turpināt rediģēt',
  'Geen opdrachten gevonden': 'Nav atrasts neviens uzdevums',
  'Genummerde lijst': 'Numurēts saraksts',
  'Huidig concept': 'Pašreizējā koncepcija',
  'Invoegen of opmaken': 'Ievietojiet vai formatējiet',
  'Invoegen of opmaken (Ctrl/Cmd+Spatie)':
      'Ievietošana vai formatēšana (Ctrl/Cmd+Space)',
  'Je wijzigingen zijn nog niet toegepast. Wil je ze verwerpen?':
      'Jūsu izmaiņas vēl nav piemērotas. Vai vēlaties tos noraidīt?',
  'Kop 1': '1. virsraksts',
  'Kop 2': '2. virsraksts',
  'Kop 3': '3. virsraksts',
  'Markdown-broneditor': 'Markdown avota redaktors',
  'Niet toegepast': 'Nav piemērots',
  'Niet-toegepaste wijzigingen': 'Nepielietotās izmaiņas',
  'Pas de huidige wijzigingen eerst toe of verwerp ze voordat je van bereik wisselt.':
      'Pirms tvēruma maiņas lietojiet vai noraidiet pašreizējās izmaiņas.',
  'Problemen gevonden': 'Problēmas atrastas',
  'Schrijftips': 'Rakstīšanas padomi',
  'Snel herstellen': 'Ātri atgūties',
  'Taak': 'Uzdevums',
  'Toegepaste versie': 'Lietišķā versija',
  'Visuele bewerking is uitgeschakeld omdat deze Markdown niet verliesvrij kan worden omgezet.':
      'Vizuālā rediģēšana ir atspējota, jo šo Markdown nevar konvertēt bez zudumiem.',
  'Wijzigingen vergelijken': 'Salīdziniet izmaiņas',
  'Wijzigingen verwerpen': 'Noraidīt izmaiņas',
  'Zoek een opdracht…': 'Atrast uzdevumu…',
  'kolom': 'kolonnu',
  'schrijftips': 'rakstīšanas padomi',
  'tekens': 'rakstzīmes',
  ...
  'Bijvoorbeeld CVE-2026-12345': 'Piemēram, CVE-2026-12345',
  ...
  'Komma-gescheiden, bijv. OWASP WSTG@4.2':
      'Ar komatu atdalīti, piem., OWASP WSTG@4.2',
  'Titel van de presentatie': 'Prezentācijas virsraksts',
  ...
  'Het token heeft de repo-scope nodig (of fijnmazig: Contents lezen en schrijven).':
      'Pilnvarai nepieciešams repo tvērums (vai detalizēti: Contents lasīšanai un rakstīšanai).',
  ...
  'Afbeeldingen, video en audio die je in dit tabblad koos, leven alleen in het geheugen. Een los .md-bestand bewaart ze niet — bij heropenen zijn ze weg. Exporteer als .ocideck-pakket om het beeld mee te nemen.':
      'Attēli, video un audio, ko izvēlējāties šajā cilnē, pastāv tikai atmiņā. Vienkāršs .md fails tos nesaglabā — atverot no jauna, tie būs zuduši. Eksportējiet kā .ocideck pakotni, lai paņemtu multividi līdzi.',
  ...
  'Soort': 'Veids',
  'Dagen onopgemerkt': 'Dienas nepamanīts',
  'Ontdekking toevoegen': 'Pievienot atklājumu',
  'Ontdekking verwijderen': 'Noņemt atklājumu',
  'Kop van de slide': 'Slaida virsraksts',
  'dagen onopgemerkt': 'dienas nepamanīts',
  'Nog geen blootstelling ingevuld — de slide toont dan geen kop, alleen de lijst.':
      'Ekspozīcija vēl nav ievadīta — slaids tad nerāda virsrakstu, tikai sarakstu.',
  'Zes ontdekkingen is het maximum; wie er meer noemt maakt een bijlage in plaats van een slide.':
      'Seši atklājumi ir maksimums; kas nosauc vairāk, veido pielikumu, nevis slaidu.',
  'Laat de dagen leeg als de eerste blootstelling onbekend is; de slide zegt dan "onbekend" in plaats van nul. Een lege eigenaar leest als "geen eigenaar" en valt rood op.':
      'Atstājiet dienas tukšas, ja pirmā ekspozīcija nav zināma; slaids tad saka "nezināms" nevis nulle. Tukšs atbildīgais lasās kā "bez atbildīgā" un izceļas sarkanā krāsā.',
  ...
  'langst onopgemerkt bereikbaar': 'visilgāk sasniedzams nepamanīts',
  'onbekend': 'nezināms',
  'onopgemerkt': 'nepamanīts',
  'ontdekking': 'atklājums',
  'ontdekkingen': 'atklājumi',
  ...
  'Open bevindingen': 'Atvērtie konstatējumi',
  'dagen': 'dienas',
  'was': 'bija',
  'Cijfers': 'Skaitļi',
  'Cijfer': 'Skaitlis',
  ...
  'mogelijk een sleutel of wachtwoord': 'iespējams, atslēga vai parole',
  ...
  'werkgeversnummer (EIN)': 'darba devēja numurs (EIN)',
  'laatste vier cijfers van een SSN': 'SSN pēdējie četri cipari',
  ...
  'Je token is geldig, maar mag dit niet. Geef het meer rechten, of wacht als de forge een limiet oplegt.':
      'Tava pilnvara ir derīga, bet to nedrīkst. Piešķir tai vairāk tiesību vai pagaidi, ja forge uzliek ierobežojumu.',
  ...
  'Gepusht': 'Nosūtīts',
  'Nog niet gepusht': 'Vēl nav nosūtīts',
  'Gesynchroniseerd met git.': 'Sinhronizēts ar git.',
  'Nog geen verbinding — het gaat later mee.':
      'Vēl nav savienojuma — tiks nosūtīts vēlāk.',
  'De branch is verzet; je commits staan lokaal klaar.':
      'Zars ir pārvietots; tavi commit ir gatavi lokāli.',
  'Synchroniseren mislukt.': 'Sinhronizācija neizdevās.',
  ...
  'Bijzonder persoonsgegeven (AVG art. 9/10)':
      'Īpaša personas datu kategorija (VDAR 9./10. pants)',
  'gezondheidsgegeven': 'veselības dati',
  'strafrechtelijk gegeven': 'krimināltiesību dati',
  'religie of levensovertuiging': 'reliģija vai pārliecība',
  'vakbondslidmaatschap': 'dalība arodbiedrībā',
  'biometrisch gegeven': 'biometriskie dati',
  ...
  'Je zoekterm gaat naar de ingestelde CVE-mirror, en als die niets vindt ook naar ENISA en MITRE. Wie die servers beheert, kan daaruit afleiden naar welk specifiek lek je zoekt — en dus welk lek je onderzoekt.':
      'Jūsu meklēšanas vārds tiek nosūtīts uz konfigurēto CVE spoguli, un, ja tas neko neatrod, arī uz ENISA un MITRE. Tie, kas pārvalda šos serverus, var secināt, kuru konkrēto ievainojamību meklējat — un tātad kuru ievainojamību pētāt.',
  'Accepteren': 'Pieņemt',
  ...
  'LibrePlan importeren': 'Importēt no LibrePlan',
  ...
  'Gantt-planning': 'Ganta plāns',
  'WBS (hiërarchie)': 'WBS (hierarhija)',
  'Projectstatus (cockpit)': 'Projekta statuss (kokpits)',
  'Milestones (tijdlijn)': 'Atskaites punkti (laika josla)',
  'Kritieke pad (flow)': 'Kritiskais ceļš (plūsma)',
  'Resources (tabel)': 'Resursi (tabula)',
  'Timesheet (tabel)': 'Darba laika uzskaite (tabula)',
