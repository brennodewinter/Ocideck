...
const _stringsHu = {
  ...
  'exportNeedsSave': 'Az exportáláshoz először mentse a bemutatót',
  'exportNeedsClean': 'Az exportáláshoz először mentse a módosításokat',
  'saved': 'Mentve',
  'unsaved': 'Nincs mentve',
  'unsavedChanges': 'Módosítások mentése (Ctrl/Cmd+S)',
  'noUnsavedChanges': 'Nincs mentetlen módosítás',
  'notSavedYet': 'Még nincs mentve',
  'noFileYet': 'Ehhez a bemutatóhoz még nincs fájl',
  'slides': 'diák',
  'skipped': 'kihagyva',
  'allSlidesIncluded': 'Minden dia megjelenik és exportálásra kerül',
  'skippedSlidesExcluded': 'dia nem jelenik meg és nem kerül exportálásra',
  'styleProfile': 'Stílusprofil',
  'classification': 'Besorolás',
  'exportNextToDeck': 'Export a diasor mellett',
  'exportsNextToDeck': 'Az exportok a diasor mellé mentődnek',
  'exportFolder': 'Export',
  'newPresentationTab': 'Új bemutató (lap)',
  'exportPackage': 'Csomag exportálása…',
  'importPackage': 'Csomag importálása…',
...
const _dutchSourceHu = {
  ...
  'Twee Bulletkolommen': 'Két felsorolási oszlop',
  'Bullets + Afbeelding': 'Felsorolás + kép',
  ...
  'Dupliceren': 'Duplikálás',
  'Niet meer overslaan': 'Ne hagyja ki',
  'Overslaan': 'Kihagyás',
  'Titel': 'Cím',
  'Titel (optioneel)': 'Cím (opcionális)',
  'Slide titel': 'Dia címe',
  'Ondertitel': 'Alcím',
  'Subtitel': 'Alcím',
  'Optionele subtitel': 'Opcionális alcím',
  'Bullets': 'Felsorolás',
  'Bullet toevoegen': 'Felsorolás hozzáadása',
  'Verwijder': 'Eltávolítás',
  'Citaat': 'Idézet',
  'Citaat tekst...': 'Idézet szövege...',
  'Auteur': 'Szerző',
  ...
  'Breedte afbeeldingspaneel (rechts)': 'Képpanel szélessége (jobbra)',
  'Linker afbeelding': 'Bal oldali kép',
  'Rechter afbeelding': 'Jobb oldali kép',
  'Verdeling (links / rechts)': 'Felosztás (bal / jobb)',
  ...
  'Afbeelding plakken uit klembord': 'Kép beillesztése vágólapról',
  'Kopieer afbeelding naar klembord': 'Kép másolása vágólapra',
  'Afbeelding gekopieerd naar klembord.': 'A kép a vágólapra másolva.',
  ...
  'Link': 'Hivatkozás',
  'Kop': 'Címsor',
  'Hoofdlettergevoelig': 'Kis- és nagybetű megkülönböztetése',
  'Vervang alles': 'Összes cseréje',
  'Niets vervangen': 'Nincs csere',
  'vervangen': 'cserélve',
  'Geen resultaten': 'Nincs találat',
  'resultaat': 'találat',
  'resultaten': 'találat',
  'Nieuwe presentatie': 'Új prezentáció',
  'Bijv. Kwartaalupdate Q4': 'Pl. Negyedéves frissítés Q4',
  'Vul een titel in': 'Adjon meg egy címet',
  'Aanmaken': 'Létrehozás',
  'Slide type kiezen': 'Diatípus kiválasztása',
  'Presentatie-eigenschappen': 'Prezentáció tulajdonságai',
  'Versie': 'Verzió',
  'Bijv. Jan Jansen': 'Pl. Kovács János',
  'Bijv. Vigilis': 'Pl. Vigilis',
  'Bijv. 2026-05-30': 'Pl. 2026-05-30',
  'Beschrijving': 'Leírás',
  ...
  'Kaarten en dialogen': 'Kártyák és párbeszédablakok',
  'Gedempte tekst': 'Halványított szöveg',
  'Zijpanelen': 'Oldalsó panelek',
  ...
  'Standaardprofiel laden': 'Alapértelmezett profil betöltése',
  ...
  'Tabel koptekst': 'Táblázat fejlécszövege',
  'Titelachtergrond': 'Címháttér',
  'Titeltekst': 'Címszöveg',
  'Sectieachtergrond': 'Szakaszháttér',
  'Geselecteerd': 'Kijelölve',
  'Logo': 'Logó',
  'Geen logo ingesteld': 'Nincs beállított logó',
  'Verwijder logo': 'Logó eltávolítása',
  'Logo positie': 'Logó helyzete',
  ...
  'Vorige slide': 'Előző dia',
  'Volgende slide': 'Következő dia',
  'paginering aan': 'lapozás be',
  'Thema': 'Téma',
  'volledig deck': 'teljes prezentáció',
  'Slide': 'Dia',
  'TYPE': 'TÍPUS',
  'STIJL': 'STÍLUS',
  ...
  'fout(en),': 'hiba,',
  'waarschuwing(en)': 'figyelmeztetés',
  'Afbeelding kiezen': 'Kép kiválasztása',
  'Afbeeldingen laden…': 'Képek betöltése…',
  'Sluiten (Esc)': 'Bezárás (Esc)',
  'Zoek op naam of beschrijving…': 'Keresés név vagy leírás alapján…',
  'Raster': 'Rács',
  'Coverflow': 'Coverflow',
  ...
  'Slide-overzicht (pijltjes + Enter)': 'Diaáttekintés (nyilak + Enter)',
  ...
  'VOLGENDE': 'KÖVETKEZŐ',
  'NOTITIES': 'JEGYZETEK',
  'Einde van de presentatie': 'A prezentáció vége',
  'Verstreken': 'Eltelt',
  'Klok': 'Óra',
  ...
  '1 slide geïmporteerd.': '1 dia importálva.',
  'slides geïmporteerd.': 'dia importálva.',
  'Export wordt voorbereid…': 'Exportálás előkészítése…',
  'tip(s)': 'tipp(ek)',
  'fout(en)': 'hiba/hibák',
  'Kwaliteitsoverzicht': 'Minőségi áttekintés',
  'Bekijk meldingen…': 'Jelzések megtekintése…',
  'Bekijk alle meldingen…': 'Összes jelzés megtekintése…',
  'Tips': 'Tippek',
  ...
  'SLIDES': 'DIÁK',
  'Geen afbeelding op het klembord gevonden.': 'Nem található kép a vágólapon.',
  'Afbeelding plakken': 'Kép beillesztése',
  'Slide toevoegen': 'Dia hozzáadása',
  'Slide plakken': 'Dia beillesztése',
  '1 slide overgeslagen': '1 dia kihagyva',
  'slides overgeslagen': 'dia kihagyva',
  'Alles tonen': 'Összes megjelenítése',
  'geselecteerd': 'kiválasztva',
  ...
  'Ingesloten inhoud': 'Beágyazott tartalom',
  'Onveilige URL': 'Nem biztonságos URL',
  'Zoekopdracht wissen': 'Keresés törlése',
  'Bullet verwijderen': 'Felsoroláspont eltávolítása',
  'Kolom verwijderen': 'Oszlop eltávolítása',
  'Rij omhoog': 'Sor felfelé',
  'Rij omlaag': 'Sor lefelé',
  'Optie verwijderen': 'Opció eltávolítása',
  'Optie toevoegen': 'Opció hozzáadása',
  'Duur verkorten': 'Időtartam csökkentése',
  'Duur verlengen': 'Időtartam növelése',
  'Afspelen': 'Lejátszás',
  'Pauzeren': 'Szünet',
  'Opsommingsteken': 'Felsoroláspont',
  'Stip': 'Pont',
  'Pootje': 'Mancs',
  ...
  'Markering': 'Jelölés',
  'bijv. 2024': 'pl. 2024',
  'Titel van gebeurtenis': 'Esemény címe',
  'Omschrijving (optioneel)': 'Leírás (opcionális)',
  'Soort vraag': 'Kérdés típusa',
  'Meerkeuze': 'Feleletválasztós',
  'Vraag': 'Kérdés',
  ...
  'Goed!': 'Helyes!',
  'Helaas, fout': 'Sajnos hibás',
  'van': '/',
  'opties worden willekeurig getoond': 'opció jelenik meg véletlenszerűen',
  'antwoordtijd': 'válaszidő',
  'bij fout: opnieuw proberen': 'hibánál: újrapróbálkozás',
  'bij fout: door, niet opnieuw': 'hibánál: tovább, nincs újrapróbálkozás',
  'Beantwoord eerst de vraag.': 'Előbb válaszolj a kérdésre.',
  'Klik om opnieuw te proberen': 'Kattints az újrapróbálkozáshoz',
  ...
  'Slidetitel': 'Diacím',
  'Cockpitmeters': 'Pilótafülke-műszerek',
  'Meter toevoegen': 'Műszer hozzáadása',
  'Animeren bij binnenkomst': 'Animálás belépéskor',
  ...
  'Werkelijk': 'Tényleges',
  'Doel': 'Cél',
  'Markeringslabel': 'Jelölő címkéje',
  'Min': 'Min',
  'Max': 'Max',
  'Neutraal van': 'Semleges innen',
  'Neutraal tot': 'Semleges idáig',
  'Groen van': 'Zöld innen',
  'Groen tot': 'Zöld idáig',
  'Rood van': 'Piros innen',
  'Snelheidsmeter': 'Sebességmérő',
  'Voltmeter': 'Voltmérő',
  'Thermometer': 'Hőmérő',
  'Hoogtemeter': 'Magasságmérő',
  'Stijgen/dalen': 'Emelkedés/süllyedés',
  'Kunstmatige horizon': 'Műhorizont',
  'Koers': 'Irány',
  ...
  'Volgende slide of pagina': 'Következő dia vagy oldal',
  'Vorige pagina': 'Előző oldal',
  'Vorige slide of pagina': 'Előző dia vagy oldal',
  'Toegankelijkheid': 'Akadálymentesség',
  'Presentatie': 'Prezentáció',
  'Tabel kopachtergrond': 'Táblázat fejlécének háttere',
  'Doeltijd': 'Célidő',
  ...
  'Binnen de tijd': 'Időn belül',
  'Deze slide': 'Ez a dia',
  'Oefenrun': 'Próbafutás',
  'Totaal': 'Összesen',
  'Totale tijd': 'Teljes idő',
  ...
  'Nummering': 'Számozás',
  'Varianten': 'Változatok',
  'Grafiekvarianten maken': 'Diagramváltozatok létrehozása',
  'Slides toevoegen': 'Diák hozzáadása',
  'Omhoog': 'Felfelé',
  'Omlaag': 'Lefelé',
  ...
  'Stoppen (Esc)': 'Leállítás (Esc)',
  'Pen · markeerstift · gum': 'Toll · szövegkiemelő · radír',
  'Laser · annotaties wissen': 'Lézer · jegyzetek törlése',
  'Grafiek': 'Diagram',
  'Type grafiek': 'Diagramtípus',
  'Staaf': 'Oszlop',
  'Lijn': 'Vonal',
  'Cirkel': 'Kör',
  'Spider': 'Pók',
  ...
  'Rij': 'Sor',
  'Reeks': 'Adatsor',
  'Kleur van reeks': 'Adatsor színe',
  'Kleur van rij': 'Sor színe',
  'Hexkleur': 'Hexadecimális szín',
  'Sorteren': 'Rendezés',
  ...
  'Schaalmaximum (optioneel)': 'Skálamaximum (opcionális)',
  'geen': 'nincs',
  ...
  'Contrast': 'Kontraszt',
  'heeft geen bijschrift/alt-tekst.': 'nincs felirata/alt-szövege.',
  'contrastverhouding': 'kontrasztarány',
  '(minimaal ': '(legalább ',
  ...
  'Thema tabelkop': 'Téma táblázatfejléce',
  'Thema code': 'Téma kódja',
  'Thema accent': 'Téma kiemelőszíne',
  'Eerste afbeelding': 'Első kép',
...
const _dutchSourceAddHu = <String, String>{
  ...
  'Aangemaakt op': 'Létrehozva:',
  'Aanmeldprovider': 'Bejelentkezési szolgáltató',
  'Aanmeldsessies': 'Regisztrációs foglalkozások',
  'Aantal controles': 'Az ellenőrzések száma',
  ...
  'Activiteitnummer': 'Tevékenység száma',
  'Afgerond op': 'Lekerekítve',
  'Afgewezen': 'Elutasítva',
  'Afspeelsessienummer': 'Lejátszási munkamenet száma',
  'Afwezig': 'Hiányzik',
  'Antwoordgegevens': 'A válasz részletei',
  'Antwoordstatus': 'Válasz állapota',
  'Begint op': 'Kezdődik',
  'Begrippen uitgelegd': 'A fogalmak magyarázata',
  'Beheer van de installatie': 'A telepítés kezelése',
  'Beheerpogingen': 'Menedzsment erőfeszítések',
  'Bekeken lessen': 'Leckék megtekintve',
  'Beleidsversie': 'Házirend verziója',
  'Beoordeeld': 'Értékelt',
  'Beoordeeld op': 'által értékelt',
  'Beperking': 'Korlátozás',
  'Berekend op': 'Kiszámítva',
  'Bericht': 'Üzenet',
  'Bestandsnaam': 'Fájlnév',
  'Beveiligingsvraagnummer': 'Biztonsági kérdés száma',
  'Bevestigd': 'Megerősítve',
  'Bevestigd op': 'Megerősítve',
  'Bewaarregels': 'Megtartási szabályok',
  'Bewaartermijn': 'Megtartási időszak',
  'Bewaren wegens een juridische verplichting':
      'Törvényi kötelezettség miatt megtartva',
  'Bewerkingnummer bij aanmeldprovider':
      'Műveleti szám a regisztrációs szolgáltatónál',
  'Bewijsstukken': 'Bizonyíték',
  'Bezwaar': 'Kifogás',
  'Beëindigd op': '-án véget ért',
  'Bijeenkomstnummer': 'Találkozó száma',
  'Certificaatnummer': 'Tanúsítvány száma',
  'Certificaten': 'Tanúsítványok',
  'Controlecode van de PDF': 'A PDF vezérlőkódja',
  'Controlecode van profielfoto': 'A profilfotó ellenőrző kódja',
  'Controlecodes van bewijsstukken':
      'Az igazoló dokumentumok ellenőrzési kódjai',
  'Correctie': 'Helyesbítés',
  'Cursistnummer waarop de actie gericht was':
      'Tanulószám, amelyre az akció irányult',
  'Cursusaanbodnummer': 'Tanfolyami ajánlat száma',
  'Cursusversienummer': 'A tanfolyam verziószáma',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'A dátumok és időpontok a helyi idő szerint jelennek meg. A technikai nevek láthatóak maradnak, ha a szerver ismeretlen mezőt ad meg.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'A tesztkérdésekre adott válaszok.',
  'Deelnamenummer': 'Részvételi szám',
  'Deelnames': 'Részvételek',
  'Details': 'Részletek',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Ezt a kategóriát a szerver biztosította. A műszaki nevek továbbra is láthatók maradnak a szervezettől érkező kérdések számára.',
  'Door uzelf aangevraagd': 'Ön kérte',
  'E-mailadres': 'E-mail cím',
  'E-mailberichten': 'E-mail üzenetek',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'Az azonosító egy egyedi technikai szám, amelyet az eLearning az adatok összekapcsolására használ. Ez nem minősítés vagy állapot.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'Egy kategória ugyanarra a témára vonatkozó adatokat csoportosítja. A regisztráció egy elmentett adat vagy egy esemény.',
  'Eindigt op': '-ben végződik',
  'Geaccepteerd op': 'Elfogadva',
  'Geannuleerd': 'Törölve',
  'Gecontroleerd': 'Ellenőrizve',
  'Gecontroleerd op': 'Bejelölve',
  'Geen gegevens gevonden': 'Nem található adat',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Tájékoztatás a megőrzési időszakokról és az adatok törléséről.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Tájékoztatás az igazoló dokumentumokról, az elért eredményekről és a tanúsítványokról.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Adatvédelmi kérésekről és arról, hogy kik tekintették meg vagy módosították az Ön adatait.',
  'Gegevens over uw accountbewerking': 'Információk a fiók működéséről',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Információ a regisztrációról, a részvételről és az órákon való előrehaladásról.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Profiljával, fiókjával és a szervezeten belüli pozíciójával kapcsolatos információk.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Információk a teszt pillanatairól és a feltett kérdésekről.',
  'Gegevens over willekeurige volgorde': 'Véletlenszerű rendelési adatok',
  'Gegevenscategorie': 'Adatkategória',
  'Gekoppeld accountnummer': 'Kapcsolt számlaszám',
  'Gekozen antwoorden': 'Válogatott válaszok',
  'Gelukt': 'Siker',
  'Geprobeerd op': 'Felpróbálva',
  'Gerechtvaardigd belang': 'Jogos érdek',
  'Gereserveerd': 'Fenntartva',
  'Gereserveerd op': 'Lefoglalva:',
  'Geslaagd': 'Átment',
  'Gestart op': 'Elkezdődött',
  'Getoonde tijd per dia in milliseconden':
      'Diánkénti megjelenítési idő ezredmásodpercben',
  'Herkomst van inschrijving': 'A regisztráció eredete',
  'Hoogst haalbare score': 'A lehető legmagasabb pontszám',
  'Identificatienummer bij aanmeldprovider':
      'A regisztrációs szolgáltató azonosító száma',
  'Identiteitsbewerkingnummer': 'Azonosító műveleti szám',
  'In afwachting': 'Függőben',
  'In behandeling': 'Folyamatban',
  'In behandeling genomen op': 'Feldolgozva',
  'In quarantaine': 'Karanténban',
  'Ingeleverd': 'Beküldve',
  'Ingeleverd op': 'Beküldve',
  'Ingericht op': 'Díszítve',
  'Ingeschreven op': 'Regisztrálva:',
  'Ingetrokken': 'Visszavonva',
  'Ingetrokken op': 'Visszavonva',
  'Inschrijvingen': 'Regisztrációk',
  'Inschrijvingsnummer': 'Regisztrációs szám',
  'Installatiebeveiligingslogboek': 'Telepítési biztonsági napló',
  'Installatienummer': 'Telepítési szám',
  'Installatieverzoeken': 'Telepítési kérések',
  'Inzage': 'Ellenőrzés',
  'Ja': 'Igen',
  'Kwalificatienummer': 'Képesítési szám',
  'Kwalificaties': 'Képesítések',
  'Laatst actief op': 'Utoljára aktív',
  'Laatst bekeken dia': 'Utoljára megtekintett dia',
  'Laatst gewijzigd op': 'Utolsó módosítás dátuma:',
  'Laatste fout': 'Utolsó hiba',
  'Lesnummer': 'Óraszám',
  'Lesreserveringen': 'Órafoglalás',
  'Lesvoortgang': 'Az óra előrehaladása',
  'Lidmaatschappen': 'Tagságok',
  'Locatie': 'Helyszín',
  'Manier van afronden': 'A kerekítés módja',
  'Maximaal aantal controles': 'Az ellenőrzések maximális száma',
  'Maximaal aantal pogingen': 'A kísérletek maximális száma',
  'Maximale leeftijd van de aanmelding': 'A regisztráció maximális korhatára',
  'Mislukt': 'Sikertelen',
  'Naam van de activiteit': 'A tevékenység neve',
  'Naam van de bijeenkomst': 'A találkozó neve',
  'Nee': 'Nem',
  'Netwerkadres': 'Hálózati cím',
  'Niet actief': 'Nem aktív',
  'Niet geregistreerd': 'Nem regisztrált',
  'Niet ingevuld': 'Nincs kitöltve',
  'Niet verschenen': 'Nem tették közzé',
  'Niveau van extra aanmeldcontrole':
      'További regisztrációs ellenőrzés szintje',
  'Nummer van de toetsopzet': 'A vizsgálati terv száma',
  'Nummer van het brongegeven': 'A forrásadatok száma',
  'Nummer van uw verwijderde gegeven': 'A törölt adatok száma',
  'Onderdeel {nummer}': '{nummer} alkatrész',
  'Onderwerp van de actie': 'Az akció tárgya',
  'Ontvanger': 'Címzett',
  'Opgegeven bestandsgrootte': 'Megadott fájlméret',
  'Opgegeven bestandstype': 'Megadott fájltípus',
  'Opgegeven controlecode': 'Megadott vezérlőkód',
  'Opgeslagen bestandsgrootte': 'Mentett fájlméret',
  'Opgeslagen controlecode': 'Tárolt vezérlőkód',
  'Organisatienummer': 'Szervezet száma',
  'Overdraagbaarheid': 'Az átruházhatóság',
  'PE-toekenningnummer': 'PE-díj száma',
  'Poging': 'Kísérlet',
  'Positie': 'Pozíció',
  'Privacyverzoeken': 'Adatvédelmi kérések',
  'Probeer een andere zoekterm.': 'Próbálkozzon másik keresési kifejezéssel.',
  'Reden': 'Ok',
  'Reden of grondslag': 'Ok vagy alap',
  'Reden van afwijzing': 'Elutasítás oka',
  'Reden van bevestiging': 'A megerősítés oka',
  'Reden van intrekking': 'A visszavonás oka',
  'Reden voor langer bewaren': 'Hosszabb tárolás oka',
  'Regels voor de cursusversie': 'A tanfolyam verziójának szabályai',
  'Resultaat bij de aanmeldprovider': 'Eredmény a regisztrációs szolgáltatónál',
  'Rol': 'Roll',
  'Score': 'Pontszám',
  'Soort aanwezigheid': 'Egyfajta jelenlét',
  'Soort accountbewerking': 'Számlaművelet típusa',
  'Soort gebeurtenis': 'Az esemény típusa',
  'Soort privacyverzoek': 'Adatvédelmi kérés típusa',
  'Status van de bijeenkomst': 'A találkozó állapota',
  'Strenge beveiligingsmodus': 'Magas biztonsági mód',
  'Technisch toegangslogboek': 'Műszaki hozzáférési napló',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'A regisztrációhoz, a biztonsághoz és a megbízható feldolgozáshoz szükséges műszaki adatok.',
  'Technische naam: {naam}': 'Műszaki név: {naam}',
  'Technische opslagcategorie': 'Műszaki tárolási kategória',
  'Technische opslaglocatie van de PDF': 'A PDF technikai tárolási helye',
  'Tijdstip van aanmelding': 'Regisztráció ideje',
  'Tijdzone': 'Időzóna',
  'Toestand': 'Állapot',
  'Toetspogingen': 'Tesztkísérletek',
  'Toetspogingnummer': 'Tesztkísérlet száma',
  'Uiterste inlevermoment': 'Beküldési határidő',
  'Uitgegeven op': 'Közzétéve:',
  'Uitgenodigd e-mailadres': 'Meghívott e-mail cím',
  'Uitnodigingen': 'Meghívók',
  'Uniek nummer (ID)': 'Egyedi szám (ID)',
  'Uniek verwerkingskenmerk': 'Egyedülálló feldolgozási funkció',
  'Uw accountnummer': 'Az Ön számlaszáma',
  'Uw accountnummer als uitvoerder': 'Az Ön számlaszáma mint végrehajtó',
  'Uzelf als uploader': 'Ön mint feltöltő',
  'Vaardigheidsversienummer': 'Skill verziószám',
  'Vast internetadres van de installatie': 'A telepítés fix internetcíme',
  'Vastgelegde beslisgegevens': 'Rögzített döntési adatok',
  'Vastgelegde gegevens': 'Rögzített adatok',
  'Vereist niveau van aanmeldzekerheid':
      'A regisztrációs biztonság megkövetelt szintje',
  'Vereiste aanmeldmethoden': 'Kötelező bejelentkezési módszerek',
  'Verloopt bij inactiviteit op': 'Inaktív állapotban lejár',
  'Verloopt definitief op': 'Véglegesen lejár',
  'Verloopt op': 'Lejár',
  'Versienummer van de PE-regel': 'A PE-szabály verziószáma',
  'Verwerkte verzoeken': 'Feldolgozott kérések',
  'Verwijderd op': 'Eltávolítva',
  'Verwijdering': 'Eltávolítás',
  'Verwijderingsregister': 'Eltávolítási nyilvántartás',
  'Verwijzing naar het antwoord': 'Hivatkozás a válaszra',
  'Verzoeknummer': 'Kérjen számot',
  'Verzoeknummer van de app': 'Alkalmazáskérelem száma',
  'Verzonden op': 'Továbbküldve',
  'Volgende controle op': 'Következő ellenőrzés',
  'Volgnummer': 'Sorozatszám',
  'Volgorde van antwoordopties': 'A válaszlehetőségek sorrendje',
  'Vraagnummer binnen de toetspoging': 'Kérdés száma a tesztkísérletben',
  'Vraagversienummer': 'Kérdés verziószám',
  'Vragen in toetspogingen': 'Kérdések a tesztkísérletekben',
  'Vrijgegeven': 'Megjelent',
  'Vrijgegeven op': 'Megjelent',
  'Wat gebeurt na de bewaartermijn': 'Mi történik a megőrzési időszak után',
  'Wettelijke verplichting': 'Jogi kötelezettség',
  'Wijzigingen aan PE-punten': 'Változások a PE-pontokban',
  'Wijzigingen aan kwalificaties': 'Változások a képesítésekben',
  'Wijzigingen in aanmeldbeveiliging':
      'Változások a bejelentkezés biztonságában',
  'Zekerheid': 'A bizonyosság',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Például keressen tanfolyam, dátum vagy állapot szerint',
  'Zoeken in uw gegevens': 'Keresés az adatok között',
  '{aantal} categorieën gevonden': '{aantal} kategóriák találhatók',
  'Aanwezigheid': 'Jelenlét',
  'Lidmaatschap': 'Tagság',
  'Inzage en wijzigingen': 'Hozzáférés és változtatások',
  'Beschikbaarheid van het inzagespoor': 'A hozzáférési napló elérhetősége',
  'Beschikbaar vanaf': 'Elérhető től',
  'Historie vóór deze datum': 'Előzmények e dátum előtt',
  'Tijdstip': 'Dátum és idő',
  'Handeling': 'Akció',
  'Gegevensonderdeel': 'Adatkategória',
  'Handelde als': 'úgy járt el, mint',
  'Organisatorische rol': 'Szervezeti szerep',
  'Bekeken': 'Megtekintve',
  'Gewijzigd': 'Megváltozott',
  'Uzelf': 'Te',
  'Medewerker': 'A személyzet tagja',
  'Systeem': 'Rendszer',
  'Onbekend': 'Ismeretlen',
  'Docent': 'oktató',
  'Beoordelaar': 'Értékelő',
  'Organisatiebeheerder': 'Szervezeti rendszergazda',
  'Niet beschikbaar': 'Nem elérhető',
  'Uitoefening van privacyrechten': 'A személyiségi jogok gyakorlása',
  'Beoordeling en certificering': 'Értékelés és tanúsítás',
  'Uitvoering van het leertraject': 'A tanulási program átadása',
  'Cursistenadministratie': 'Tanulói adminisztráció',
  'Cursistprofiel': 'Tanulói profil',
  'Leerstatistieken': 'Statisztikák tanulása',
  'Inschrijving': 'Beiratkozás',
  'Toetspoging': 'Értékelési kísérlet',
  'Beoordeling': 'Értékelés',
  'Bewijsstuk': 'Bizonyíték',
  'Kwalificatie': 'Képesítés',
  'Deelname': 'Részvétel',
  'PE-punten': 'Továbbképzési pontok',
  'Certificaat': 'Tanúsítvány',
  'Privacyverzoek': 'Adatvédelmi kérés',
  'Bewaard tot': 'Addig megőrizve',
  'Bekijk mijn gegevens': 'Adataim megtekintése',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Tekintse meg, milyen adatokat rögzített Önről az eLearning.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Ez az áttekintés {datum} napján közvetlenül az eLearning rendszerből érkezett, és az OciDeck nem tárolja.',
  'Geen gegevens geregistreerd': 'Nincsenek rögzített adatok',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'Az összes olyan kategóriát tartalmazza, amelyet a kiszolgáló ehhez a szervezethez biztosított. A célokra, címzettekre, eredetre, megőrzési időkre vagy egyéb adatvédelmi jogaira vonatkozó információkért forduljon ehhez: {organisatie}.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Nem sikerült betölteni az adatait. Próbálja újra.',
  'Meer tonen ({aantal} resterend)':
      'Továbbiak megjelenítése ({aantal} maradt)',
  'Mijn gegevens': 'Adataim',
  'Privacy-inzage': 'Hozzáférés a személyes adatokhoz',
  'Uw geregistreerde gegevens': 'Az Önről rögzített adatok',
  'uw organisatie': 'az Ön szervezete',
  '{aantal} registraties': '{aantal} bejegyzés',
  ...
  'Deze organisatie bevat te veel lessen om veilig te tonen.':
      'Ez a szervezet túl sok leckét tartalmaz ahhoz, hogy biztonságosan megjeleníthető legyen.',
  'Er wacht nog voortgang op synchronisatie.':
      'A haladás még szinkronizálásra vár.',
  'Met deze keuze wordt het vernieuwtoken in de sleutelbos bewaard. Een versleutelde wachtrij voor nog niet verstuurde voortgang wordt daar los van bewaard.':
      'Ezzel a választással a frissítési jogkivonat a kulcstartóban tárolódik. A még el nem küldött haladás titkosított várólistája ettől külön tárolódik.',
  'Nog niet verstuurde voortgang is op dit apparaat bewaard.':
      'A még el nem küldött haladás ezen az eszközön van elmentve.',
  'Cursist': 'Kurzus résztvevője',
  'Les afgerond': 'A lecke befejeződött',
  'Cursussen voor u': 'Önnek szóló kurzusok',
  'Ga verder waar u gebleven was, of kies een andere cursus die voor u klaarstaat.':
      'Folytassa ott, ahol abbahagyta, vagy válasszon egy másik, Önnek kész kurzust.',
  'Klaar om te beginnen': 'Készen áll a kezdésre',
  'Mijn cursussen': 'Kurzusaim',
  'Mijn leeromgeving': 'Tanulási környezetem',
  'Mooi gedaan! Uw voortgang is bewaard.':
      'Szép munka! Az előrehaladása el lett mentve.',
  'Nu bezig': 'Folyamatban',
  'Opnieuw starten': 'Kezdje újra',
  'Terug naar mijn cursussen': 'Vissza a kurzusaimhoz',
  'U kunt deze cursus opnieuw bekijken.': 'Ezt a kurzust újra áttekintheti.',
  'Volgende: {les}': 'Következő: {les}',
  'Welkom, {naam}': 'Üdvözöljük, {naam}',
  ...
  '{afgerond} van {totaal} lessen afgerond':
      '{afgerond} / {totaal} lecke befejezve',
  'Uitloggen': 'Kijelentkezés',
  ...
  'Sleep op de afbeelding om een gebied te markeren.':
      'Húzzon a képen egy terület megjelöléséhez.',
  'Geldt voor de hele dia — bepaalt hoe verwijzingen tijdens de presentatie worden getekend, niet hoe je ze bewerkt.':
      'A teljes diára vonatkozik — meghatározza, hogyan rajzolódnak a hivatkozások a prezentáció során, nem pedig, hogyan szerkeszted őket.',
  ...
  'Elk hoofdstuk begon al op een nieuwe pagina':
      'Minden fejezet már új oldalon kezdődött',
  ...
  'Met afloop wordt de pagina rondom groter dan het gekozen formaat, zodat inkt die tot de rand loopt dóór de snijlijn heen gaat. De afloop geldt voor élke export tot je hem weer op 0 zet. Laat dit op 0 voor gewoon afdrukken.':
      'Kifutóval az oldal körben nagyobb lesz a választott méretnél, így a szélig futó festék túlnyúlik a vágásvonalon. A kifutó minden exportra érvényes, amíg vissza nem állítod 0 értékre. Szokásos nyomtatáshoz hagyd 0 értéken.',
  'Pagina\'s': 'Oldalak',
  'Maat': 'Méret',
  'Staand': 'Álló',
  'Liggend': 'Fekvő',
  'documenten': 'dokumentumok',
  'posters en boeken': 'plakátok és könyvek',
  ...
  'De browser blokkeert media van een externe bron. Open deze presentatie in de app om online media te tonen.':
      'A böngésző blokkolja a külső forrásból származó médiát. Nyissa meg ezt a bemutatót az alkalmazásban az online média megjelenítéséhez.',
  ...
  'Komma-gescheiden, bijv. OWASP WSTG@4.2':
      'Vesszővel elválasztva, pl. OWASP WSTG@4.2',
  'Titel van de presentatie': 'A prezentáció címe',
  ...
  'Je token is geldig, maar mag dit niet. Geef het meer rechten, of wacht als de forge een limiet oplegt.':
      'A tokened érvényes, de ehhez nincs joga. Adj neki több jogosultságot, vagy várj, ha a forge korlátot alkalmaz.',
  ...
  'deellink met ingebakken toegang':
      'megosztási hivatkozás beépített hozzáféréssel',
  'e-mailadres in een link': 'e-mail-cím egy hivatkozásban',
  ...
  'Je zoekterm gaat naar de ingestelde CVE-mirror, en als die niets vindt ook naar ENISA en MITRE. Wie die servers beheert, kan daaruit afleiden naar welk specifiek lek je zoekt — en dus welk lek je onderzoekt.':
      'A keresőkifejezésed a beállított CVE-tükörre kerül, és ha az nem talál semmit, az ENISA-hoz és a MITRE-hez is. Aki ezeket a kiszolgálókat üzemelteti, kikövetkeztetheti, melyik konkrét sérülékenységet keresed — és így melyiket vizsgálod.',
  ...
  'LibrePlan importeren': 'Importálás a LibrePlanből',
  ...
  'Gantt-planning': 'Gantt-ütemterv',
  'WBS (hiërarchie)': 'WBS (hierarchia)',
  'Projectstatus (cockpit)': 'Projektállapot (vezérlőpult)',
  'Milestones (tijdlijn)': 'Mérföldkövek (idővonal)',
  'Kritieke pad (flow)': 'Kritikus út (folyamat)',
  'Resources (tabel)': 'Erőforrások (táblázat)',
  'Timesheet (tabel)': 'Munkaidő-nyilvántartás (táblázat)',
  ...
  'Scoring, feedback en metadata': 'Pontozás, visszajelzés és metaadatok',
  'Punten, scoringstrategie, feedback, hints, pogingen en leerdoelkoppelingen.':
      'Pontok, pontozási stratégia, visszajelzés, tippek, próbálkozások és tanulási cél hivatkozások.',
  'Scoringstrategie': 'Pontozási stratégia',
  'Alles of niets': 'Minden vagy semmi',
  'Deels': 'Részleges',
  'Per paar': 'Páronként',
  'Per item': 'Elemenként',
  'Puntenaftrek per fout': 'Pontlevonás hibás válaszonként',
  'Maximum pogingen (0 = onbeperkt)': 'Maximális próbálkozások (0 = korlátlan)',
  'Feedback per uitkomst': 'Visszajelzés eredményenként',
  'Bij goed antwoord': 'Helyes válasznál',
  'Bij fout antwoord': 'Hibás válasznál',
  'Bij deels goed': 'Részben helyesnél',
  'Bij timeout': 'Időtúllépésnél',
  'Hints (één per regel, progressief)': 'Tippek (soronként egy, progresszív)',
  'Eerste hint\nTweede hint': 'Első tipp\\nMásodik tipp',
  'Remediation — slide-anchor naar feedback-slide':
      'Remediation — slide-horgony a visszajelző slide-hoz',
  'bijv. slide:3': 'pl. slide:3',
  'Leerdoelverwijzingen (slide-anchors, één per regel)':
      'Tanulási cél hivatkozások (slide-horgonyok, soronként egy)',
  'slide:0\nslide:5': 'slide:0\nslide:5',
  'Metadata': 'Metaadatok',
  'Vak/onderwerp': 'Tantárgy/téma',
  'Moeilijkheid': 'Nehézség',
  '— geen —': '— nincs —',
  'Makkelijk': 'Könnyű',
  'Gemiddeld': 'Közepes',
  'Moeilijk': 'Nehéz',
  'Geschatte duur in seconden': 'Becsült időtartam másodpercben',
  'Tags (komma-gescheiden)': 'Címkék (vesszővel elválasztva)',
};
