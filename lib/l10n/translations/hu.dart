...
const _dutchSourceAddHu = <String, String>{
  'OciDeck mag uw microfoon of camera niet gebruiken. Geef toestemming in uw browser of systeeminstellingen en probeer het opnieuw.':
      'Az OciDeck nem használhatja az Ön mikrofonját vagy kameráját. Adja meg az engedélyt a böngészőben vagy a rendszerbeállításokban, majd próbálja meg újra.',
  'Er is geen werkende microfoon gevonden. Sluit er een aan of kies een ander apparaat.':
      'Nem található működő mikrofon. Csatlakoztasson egyet, vagy válasszon másik eszközt.',
  'Er is geen werkende camera gevonden. U kunt zonder beeld meedoen.':
      'Nem található működő kamera. Kép nélkül is csatlakozhat.',
  'De dienst die het toegangsbewijs afgeeft is onbereikbaar. Probeer het later opnieuw; uw presentatie blijft ondertussen gewoon open.':
      'A hozzáférési igazolást kiállító szolgáltatás nem érhető el. Próbálja meg később újra; az előadása közben egyszerűen nyitva marad.',
  'De dienst die het toegangsbewijs afgeeft heeft zijn grens voor nu bereikt. Probeer het later opnieuw.':
      'A hozzáférési igazolást kiállító szolgáltatás egyelőre elérte a korlátját. Próbálja meg később újra.',
  'Het toegangsbewijs voor deze vergadering is verlopen. Doe opnieuw mee met dezelfde link.':
      'Az értekezlethez tartozó hozzáférési igazolás lejárt. Csatlakozzon újra ugyanazzal a hivatkozással.',
  'Het netwerk laat deze vergadering niet door. Op een bedrijfsnetwerk blokkeert een firewall of proxy dit soort verkeer vaak; een andere verbinding lukt meestal wel.':
      'A hálózat nem engedi át ezt az értekezletet. Vállalati hálózaton egy tűzfal vagy proxy gyakran blokkolja az ilyen forgalmat; egy másik kapcsolattal általában sikerül.',
  'Deze vergadering is voorbij.': 'Ez az értekezlet már véget ért.',
  'De vergaderdienst is zelf niet beschikbaar. Dit ligt niet aan uw verbinding; probeer het later opnieuw.':
      'Maga az értekezlet-szolgáltatás nem elérhető. Ez nem az Ön kapcsolatán múlik; próbálja meg később újra.',
  'Meedoen is niet gelukt, en de dienst zegt niet waarom. De technische code staat bij de details — probeer het opnieuw, en geef die code door als het blijft misgaan.':
      'A csatlakozás nem sikerült, és a szolgáltatás nem mondja meg, miért. A technikai kód a részletek között áll — próbálja meg újra, és adja tovább ezt a kódot, ha továbbra sem sikerül.',
  'Dit is geen bruikbare vergaderlink. Kopieer hem opnieuw uit de uitnodiging — een link die door een chatprogramma is afgekapt of aangepast, doet het vaak niet meer.':
      'Ez nem használható értekezlet-hivatkozás. Másolja ki újra a meghívóból — az olyan hivatkozás, amelyet egy csevegőprogram levágott vagy módosított, gyakran már nem működik.',
  'Deze dienst kennen we, maar dit soort vergadering niet. Webinars, uitzendingen en persoonlijke vergaderkamers werken anders dan een gewone vergadering; open deze link in de browser.':
      'Ezt a szolgáltatást ismerjük, de ezt az értekezlettípust nem. A webináriumok, az adások és a személyes tárgyalószobák másképp működnek, mint egy hétköznapi értekezlet; nyissa meg ezt a hivatkozást a böngészőben.',
  'Deze vergaderdienst kennen we niet. OciDeck weet dus ook niet wat er achter deze link zit; u kunt hem in uw browser openen als u de afzender vertrouwt.':
      'Ezt az értekezlet-szolgáltatást nem ismerjük. Az OciDeck így azt sem tudja, mi van e hivatkozás mögött; megnyithatja a böngészőjében, ha megbízik a feladóban.',
  'Meedoen kan op deze uitvoering van OciDeck niet. Gebruik de webversie in uw browser.':
      'Az OciDeck ezen kiadásában nem lehet csatlakozni. Használja a böngészőben a webes változatot.',
  'Deze browser mist iets wat voor meedoen nodig is. Een recente Chrome, Edge, Firefox of Safari lukt doorgaans wel.':
      'Ebből a böngészőből hiányzik valami, ami a csatlakozáshoz szükséges. Egy friss Chrome, Edge, Firefox vagy Safari általában működik.',
  'De organisatie van deze vergadering laat geen gasten zonder account toe. Vraag de organisator om u uit te nodigen op een manier die gasten toestaat.':
      'Ennek az értekezletnek a szervezete nem engedélyez fiók nélküli vendégeket. Kérje meg a szervezőt, hogy olyan módon hívja meg Önt, amely megengedi a vendégeket.',
  'Meedoen aan deze vergadering vereist een account bij de aanbieder. Open de link in uw browser en meld u daar aan.':
      'Az értekezlethez való csatlakozáshoz fiók kell a szolgáltatónál. Nyissa meg a hivatkozást a böngészőjében, és jelentkezzen be ott.',
  'Deze aanbieder laat alleen goedgekeurde programma\'s meedoen, en die goedkeuring is er voor OciDeck nog niet. Open de vergadering in uw browser.':
      'Ez a szolgáltató csak jóváhagyott programokat engedélyez, és ez a jóváhagyás az OciDeck esetében még nincs meg. Nyissa meg az értekezletet a böngészőjében.',
  'De organisator heeft u niet toegelaten. Vraag of hij u binnenlaat en probeer het daarna opnieuw.':
      'A szervező nem engedte be Önt. Kérje, hogy engedjék be, majd próbálja meg újra.',
  'Deze vergadering is op slot; er komt niemand meer bij. Vraag de organisator om het slot eraf te halen.':
      'Ez az értekezlet le van zárva; többé senki nem csatlakozhat. Kérje meg a szervezőt, hogy oldja fel a zárat.',
  'Deze vergadering is eind-tot-eind versleuteld en laat daarom geen externe deelnemers toe. Dat is een keuze van de organisator; vraag hem om een gewone vergadering als u erbij moet zijn.':
      'Ez az értekezlet végpontok között titkosított, ezért nem engedélyez külső résztvevőket. Ez a szervező döntése; kérjen tőle hétköznapi értekezletet, ha ott kell lennie.',
  '{plek} krijgt contact zodra u meedoet.':
      'Amint csatlakozik, kapcsolat jön létre a következővel: {plek}.',
  'U doet mee met alleen de naam die u zelf opgeeft; u bent niet aangemeld als die persoon.':
      'Csak azzal a névvel vesz részt, amelyet Ön ad meg; nincs bejelentkezve az adott személyként.',
  'De dienst maakt een tijdelijke gastidentiteit voor u, die na de vergadering verdwijnt.':
      'A szolgáltatás ideiglenes vendégazonosságot hoz létre Önnek, amely az értekezlet után megszűnik.',
  'U doet mee als gast onder een dienstaccount van een organisatie.':
      'Vendégként vesz részt egy szervezet szolgáltatásfiókján keresztül.',
  'De organisator heeft een identiteit voor u klaargezet.':
      'A szervező azonosságot készített elő Önnek.',
  'Meedoen gaat met uw eigen account bij deze aanbieder.':
      'A csatlakozás az Ön saját fiókjával történik ennél a szolgáltatónál.',
  'De aanbieder ziet uw netwerkgegevens en het beeld en geluid dat u verstuurt. Wat u deelt, deelt u met alle deelnemers.':
      'A szolgáltató látja a hálózati adatait, valamint az Ön által küldött képet és hangot. Amit megoszt, azt minden résztvevővel megosztja.',
  'Het verkeer is versleuteld naar de dienst toe; de dienst zelf kan meekijken.':
      'A forgalom a szolgáltatásig titkosított; maga a szolgáltatás betekinthet.',
  'De aanbieder beheert de versleuteling en dus ook de sleutels.':
      'A szolgáltató kezeli a titkosítást, és így a kulcsokat is.',
  'De aanbieder beschrijft dit als eind-tot-eind versleuteld.':
      'A szolgáltató ezt végpontok közötti titkosításként írja le.',
  'Over de versleuteling is niets vastgesteld. OciDeck belooft daar dus niets over.':
      'A titkosításról semmit nem állapítottak meg. Az OciDeck ezért semmit sem ígér róla.',
  'U komt eerst in een wachtruimte: een organisator moet u toelaten. Uw presentatie blijft ondertussen gewoon te bewerken.':
      'Először egy várószobába kerül: egy szervezőnek be kell engednie Önt. Az előadása közben továbbra is szerkeszthető marad.',
  'Deze vergadering vraagt om een wachtwoord.': 'Ez az értekezlet jelszót kér.',
  'Deze vergadering vraagt om aanmelding vooraf.':
      'Ez az értekezlet előzetes regisztrációt kér.',
  'Vergadering wordt voorbereid': 'Az értekezlet előkészítése',
  'Verbinden met de vergadering': 'Kapcsolódás az értekezlethez',
  'Wachten op toelating door de organisator':
      'Várakozás a szervező beengedésére',
  'U doet mee aan de vergadering': 'Részt vesz az értekezleten',
  'De verbinding is weggevallen — opnieuw verbinden':
      'A kapcsolat megszakadt — újrakapcsolódás',
  'De vergadering wordt verlaten': 'Kilépés az értekezletről',
  'De vergadering is beëindigd': 'Az értekezlet befejeződött',
  'Meedoen is niet gelukt': 'A csatlakozás nem sikerült',
  'Deze vergadering wordt opgenomen.': 'Ezt az értekezletet rögzítik.',
  'Deze vergadering wordt uitgeschreven.': 'Ezt az értekezletet leiratozzák.',
  'Deze vergadering wordt opgenomen en uitgeschreven.':
      'Ezt az értekezletet rögzítik és leiratozzák.',
  'De vergadering vraagt uw uitdrukkelijke toestemming om mee te blijven doen.':
      'Az értekezlet az Ön kifejezett hozzájárulását kéri a további részvételhez.',
  'Een organisator moet u nog toelaten. U kunt gewoon doorwerken; zodra u binnen bent, opent het gespreksvenster zich.':
      'Egy szervezőnek még be kell engednie Önt. Nyugodtan dolgozhat tovább; amint bent van, megnyílik a beszélgetés ablaka.',
  'Herkend als een vergadering bij {plek}.':
      'Felismerve mint értekezlet a következőnél: {plek}.',
  '{uitleg} De link wijst naar {plek}.':
      '{uitleg} A hivatkozás a következőre mutat: {plek}.',
  'Deze naam kiest u zelf; niemand controleert hem. De anderen zien u als gast.':
      'Ezt a nevet Ön választja; senki nem ellenőrzi. A többiek vendégként látják Önt.',
  'Afsluiten': 'Befejezés',
  'Camera aanzetten': 'Kamera bekapcsolása',
  'Camera uitzetten': 'Kamera kikapcsolása',
  'Microfoon aanzetten': 'Mikrofon bekapcsolása',
  'Microfoon dempen': 'Mikrofon némítása',
  'Presentatie delen': 'Előadás megosztása',
  'Delen stoppen': 'Megosztás leállítása',
  'Gespreksvenster': 'Beszélgetés ablaka',
  'Venster sluiten': 'Ablak bezárása',
  'Meedoen': 'Csatlakozás',
  'Meedoen aan een onlinevergadering': 'Csatlakozás online értekezlethez',
  'Onlinevergadering': 'Online értekezlet',
  'Onlinevergadering…': 'Online értekezlet…',
  'Vergaderlink': 'Értekezlet hivatkozása',
  'Plak hier de link uit de uitnodiging':
      'Illessze be ide a meghívóban szereplő hivatkozást',
  'Uw naam, zoals de anderen die zien': 'Az Ön neve, ahogyan a többiek látják',
  'Wat er gebeurt als u meedoet': 'Mi történik, ha csatlakozik',
  'Verlaten': 'Kilépés',
  'Weigeren en verlaten': 'Elutasítás és kilépés',
  'Toestemming geven': 'Hozzájárulás megadása',
  'Technische code: {code}': 'Technikai kód: {code}',
  'Deelnemers ({aantal})': 'Résztvevők ({aantal})',
  'Nog geen deelnemers.': 'Még nincsenek résztvevők.',
  'Deze vergadering geeft geen deelnemerslijst.':
      'Ez az értekezlet nem ad résztvevőlistát.',
  'gast': 'vendég',
  'deelnemer': 'résztvevő',
  'presentator': 'előadó',
  'moderator': 'moderátor',
  'organisator': 'szervező',
  'rol onbekend': 'ismeretlen szerep',
