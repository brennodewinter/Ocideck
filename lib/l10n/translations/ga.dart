...
const _dutchSourceGa = {
  ...
  'Laatste reeks als lijn op een tweede as; de rest als staven.':
      'An tsraith dheireanach mar líne ar dhara ais; an chuid eile mar bharraí.',
  'Eerste reeks: elke waarde is een op- of neerwaartse stap op het vorige totaal.':
      'An chéad tsraith: is céim suas nó síos gach luach ar an tsuim reatha.',
  'Reeks = rij, kolom = label, celkleur volgt de waarde. Label de assen kans en impact voor een risicomatrix.':
      'Sraith = ró, colún = lipéad, leanann dath na cille an luach. Cuir lipéad ar na haiseanna mar dhóchúlacht agus tionchar le haghaidh maitrís riosca.',
...
const _dutchSourceAddGa = <String, String>{
  ...
  'OciDeck vraagt dan maximaal eenmaal per dag aan pawprint.vigilis.online of er een nieuwere versie is.':
      'Fiafraíonn OciDeck de pawprint.vigilis.online uair sa lá ar a mhéid ansin an bhfuil leagan níos nuaí ann.',
  'Controleer nu': 'Seiceáil anois',
  'De controle is mislukt — probeer het later opnieuw.':
      'Theip ar an seiceáil — bain triail eile as níos déanaí.',
  'Er is geen nieuwere versie.': 'Níl aon leagan níos nuaí ann.',
  'OciDeck {versie} is beschikbaar.': 'Tá OciDeck {versie} ar fáil.',
  'Download': 'Íoslódáil',
  'OciDeck {versie} is beschikbaar — tik om de releasepagina te openen.':
      'Tá OciDeck {versie} ar fáil — tapáil chun an leathanach eisiúna a oscailt.',
  ...
  '1 registratie': '|\n1 chlárú',
  'Aangemaakt op': '|\nCruthaithe ar',
  'Aanmeldprovider': '|\nSoláthraí logáil isteach',
  'Aanmeldsessies': '|\nSeisiúin chlárúcháin',
  'Aantal controles': '|\nLíon seiceálacha',
  'Aantal minuten': '|\nLíon nóiméad',
  'Aantal pogingen': '|\nLíon iarrachtaí',
  'Accountbewerkingen': '|\nOibríochtaí cuntais',
  ...
  'Activiteitnummer': '|\nUimhir ghníomhaíochta',
  'Afgerond op': '|\nSlánaithe go',
  'Afgewezen': '|\nDiúltaithe',
  'Afspeelsessienummer': '|\nUimhir seisiúin athsheinm',
  'Afwezig': '|\nAs láthair',
  'Antwoordgegevens': '|\nFreagra sonraí',
  'Antwoordstatus': '|\nStádas freagartha',
  'Begint op': '|\nTosaíonn ar',
  'Begrippen uitgelegd': '|\nCoincheapa mínithe',
  'Beheer van de installatie': '|\nBainistíocht na suiteála',
  'Beheerpogingen': '|\nIarrachtaí bainistíochta',
  'Bekeken lessen': '|\nCeachtanna a breathnaíodh',
  'Beleidsversie': '|\nLeagan polasaí',
  'Beoordeeld': '|\nRátáilte',
  'Beoordeeld op': '|\nRátáilte ag',
  'Beperking': '|\nSrian',
  ...
  'Bericht': '|\nTeachtaireacht',
  'Bestandsnaam': '|\nAinm comhaid',
  'Beveiligingsvraagnummer': '|\nUimhir Cheist Slándála',
  'Bevestigd': '|\nDeimhnithe',
  'Bevestigd op': '|\nDeimhnithe ar',
  'Bewaarregels': '|\nRialacha coinneála',
  'Bewaartermijn': '|\nTréimhse choinneála',
  'Bewaren wegens een juridische verplichting':
      '|\nCoinnithe mar gheall ar oibleagáid dhlíthiúil',
  'Bewerkingnummer bij aanmeldprovider':
      '|\nUimhir oibríochta ag an soláthraí clárúcháin',
  'Bewijsstukken': '|\nFianaise',
  'Bezwaar': '|\nAgóid',
  'Beëindigd op': '|\nDar críoch ar',
  'Bijeenkomstnummer': '|\nUimhir an chruinnithe',
  'Certificaatnummer': '|\nUimhir deimhnithe',
  'Certificaten': '|\nDeimhnithe',
  'Controlecode van de PDF': '|\nRialú cód pdf',
  'Controlecode van profielfoto': '|\nCód fíoraithe grianghraf próifíl',
  'Controlecodes van bewijsstukken':
      '|\nCóid rialaithe na ndoiciméad tacaíochta',
  'Correctie': '|\nCeartúchán',
  'Cursistnummer waarop de actie gericht was':
      '|\nUimhir an dalta ar a raibh an gníomh dírithe',
  'Cursusaanbodnummer': '|\nUimhir tairiscint an chúrsa',
  'Cursusversienummer': '|\nUimhir leagan an chúrsa',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      '|\nTaispeántar dátaí agus amanna i d’am áitiúil. Fanann ainmneacha teicniúla le feiceáil nuair a sholáthraíonn an freastalaí réimse anaithnid.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      '|\nNa freagraí a thug tú ar cheisteanna tástála.',
  'Deelnamenummer': '|\nUimhir rannpháirtíochta',
  'Deelnames': '|\nRannpháirtithe',
  'Details': '|\nSonraí',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      '|\nChuir an freastalaí an chatagóir seo ar fáil. Fanann na hainmneacha teicniúla le feiceáil le haghaidh fiosrúcháin ó d’eagraíocht.',
  'Door uzelf aangevraagd': '|\nD\'iarr tú féin',
  'E-mailadres': '|\nSeoladh ríomhphoist',
  ...
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      '|\nUimhir theicniúil uathúil is ea ID a úsáideann ríomhfhoghlaim chun sonraí a nascadh le chéile. Ní rátáil nó stádas é.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      '|\nDéanann catagóir grúpa sonraí ar an ábhar céanna. Is éard is clárú ann ná píosa amháin sonraí a shábháiltear nó imeacht amháin.',
  'Eindigt op': '|\nCríochnaíonn i',
  'Geaccepteerd op': '|\nGlactar leis ar',
  'Geannuleerd': '|\nAr ceal',
  'Gecontroleerd': '|\nSeiceáilte',
  'Gecontroleerd op': '|\nSeiceáilte ar',
  'Geen gegevens gevonden': '|\nNíor aimsíodh aon sonraí',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      '|\nEolas faoi thréimhsí coinneála agus scriosadh do shonraí.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      '|\nEolas faoi dhoiciméid tacaíochta, na torthaí a baineadh amach agus deimhnithe.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      '|\nFaisnéis faoi iarratais phríobháideachais agus cé a d’fhéach nó a d’athraigh do chuid faisnéise.',
  'Gegevens over uw accountbewerking': '|\nEolas faoi d\'oibríocht chuntais',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      '|\nEolas faoi do chlárú, rannpháirtíocht agus dul chun cinn sna ceachtanna.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      '|\nEolas faoi do phróifíl, cuntas agus seasamh laistigh den eagraíocht.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      '|\nEolas faoi do chuimhneacháin tástála agus na ceisteanna a chuirtear i láthair.',
  'Gegevens over willekeurige volgorde': '|\nSonraí ordú randamach',
  'Gegevenscategorie': '|\nCatagóir sonraí',
  'Gekoppeld accountnummer': '|\nUimhir chuntais nasctha',
  'Gekozen antwoorden': '|\nFreagraí roghnaithe',
  'Gelukt': '|\nRath',
  'Geprobeerd op': '|\nIarracht ar',
  'Gerechtvaardigd belang': '|\nLeas dlisteanach',
  'Gereserveerd': '|\nCurtha in áirithe',
  'Gereserveerd op': '|\nCurtha in áirithe ar',
  'Geslaagd': '|\nRith',
  'Gestart op': '|\nThosaigh ar',
  'Getoonde tijd per dia in milliseconden':
      '|\nAm léirithe in aghaidh an tsleamhnáin i milleasoicindí',
  'Herkomst van inschrijving': '|\nBunús an chlárúcháin',
  'Hoogst haalbare score': '|\nAn scór is airde is féidir',
  'Identificatienummer bij aanmeldprovider':
      '|\nUimhir aitheantais don soláthraí clárúcháin',
  'Identiteitsbewerkingnummer': '|\nUimhir oibríochta aitheantais',
  'In afwachting': '|\nAr feitheamh',
  'In behandeling': '|\nAr siúl',
  ...
  'Inschrijvingen': '|\nClárúcháin',
  'Inschrijvingsnummer': '|\nUimhir chláraithe',
  'Installatiebeveiligingslogboek': '|\nClár slándála suiteála',
  'Installatienummer': '|\nUimhir suiteála',
  'Installatieverzoeken': '|\nIarratais suiteála',
  'Inzage': '|\nCigireacht',
  'Ja': '|\nTá',
  'Kwalificatienummer': '|\nUimhir cháilíochta',
  'Kwalificaties': '|\nCáilíochtaí',
  'Laatst actief op': '|\nGníomhach deireanach ar',
  'Laatst bekeken dia': '|\nSleamhnán a breathnaíodh air seo caite',
  'Laatst gewijzigd op': '|\nAthraithe go deireanach ar',
  'Laatste fout': '|\nBotún deireanach',
  'Lesnummer': '|\nUimhir an cheachta',
  'Lesreserveringen': '|\nÁirithintí ceachta',
  'Lesvoortgang': '|\nDul chun cinn ceachta',
  'Lidmaatschappen': '|\nBallraíochtaí',
  'Locatie': '|\nSuíomh',
  'Manier van afronden': '|\nBealach slánúcháin',
  'Maximaal aantal controles': '|\nUaslíon seiceálacha',
  'Maximaal aantal pogingen': '|\nUaslíon iarrachtaí',
  'Maximale leeftijd van de aanmelding': '|\nAois uasta clárúcháin',
  'Mislukt': '|\nTheip',
  'Naam van de activiteit': '|\nAinm na gníomhaíochta',
  'Naam van de bijeenkomst': '|\nAinm an chruinnithe',
  'Nee': '|\nNíl',
  'Netwerkadres': '|\nSeoladh líonra',
  'Niet actief': '|\nGan gníomhach',
  'Niet geregistreerd': '|\nGan chlárú',
  'Niet ingevuld': '|\nGan líonadh isteach',
  'Niet verschenen': '|\nGan foilsiú',
  'Niveau van extra aanmeldcontrole': '|\nLeibhéal rialaithe clárúcháin breise',
  'Nummer van de toetsopzet': '|\nUimhir an phlean tástála',
  'Nummer van het brongegeven': '|\nLíon na sonraí foinse',
  'Nummer van uw verwijderde gegeven': '|\nLíon do shonraí scriosta',
  'Onderdeel {nummer}': '|\nCuid {nummer}',
  'Onderwerp van de actie': '|\nÁbhar an ghnímh',
  'Ontvanger': '|\nFaighteoir',
  'Opgegeven bestandsgrootte': '|\nMéid comhaid sonraithe',
  'Opgegeven bestandstype': '|\nCineál comhaid sonraithe',
  'Opgegeven controlecode': '|\nCód rialaithe sonraithe',
  'Opgeslagen bestandsgrootte': '|\nSábháilte méid comhaid',
  'Opgeslagen controlecode': '|\nCód rialaithe stóráilte',
  'Organisatienummer': '|\nUimhir eagraíochta',
  'Overdraagbaarheid': '|\nInaistritheacht',
  'PE-toekenningnummer': '|\nUimhir dámhachtana PE',
  'Poging': '|\nIarracht',
  'Positie': '|\nSeasamh',
  'Privacyverzoeken': '|\nIarratais phríobháideachais',
  'Probeer een andere zoekterm.': '|\nBain triail as téarma cuardaigh eile.',
  'Reden': '|\nCúis',
  'Reden of grondslag': '|\nCúis nó bunús',
  'Reden van afwijzing': '|\nAn chúis leis an diúltú',
  'Reden van bevestiging': '|\nCúis le daingniú',
  'Reden van intrekking': '|\nCúis le tarraingt siar',
  'Reden voor langer bewaren': '|\nCúis stórála níos faide',
  'Regels voor de cursusversie': '|\nRialacha leagan an chúrsa',
  'Resultaat bij de aanmeldprovider': '|\nToradh ag an soláthraí clárúcháin',
  'Rol': '|\nRollaigh',
  'Score': '|\nScór',
  'Soort aanwezigheid': '|\nCineál láithreacht',
  'Soort accountbewerking': '|\nCineál oibríocht cuntais',
  'Soort gebeurtenis': '|\nCineál imeachta',
  'Soort privacyverzoek': '|\nCineál iarratais príobháideachais',
  'Status van de bijeenkomst': '|\nStádas an chruinnithe',
  'Strenge beveiligingsmodus': '|\nMód slándála ard',
  'Technisch toegangslogboek': '|\nLogchomhad rochtana teicniúil',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      '|\nSonraí teicniúla a theastaíonn le haghaidh clárúcháin, slándála agus próiseála iontaofa.',
  'Technische naam: {naam}': '|\nAinm teicniúil: {naam}',
  'Technische opslagcategorie': '|\nCatagóir stórála teicniúil',
  'Technische opslaglocatie van de PDF': '|\nSuíomh stórála teicniúil an pdf',
  'Tijdstip van aanmelding': '|\nAm clárúcháin',
  'Tijdzone': '|\nCrios ama',
  'Toestand': '|\nCoinníoll',
  'Toetspogingen': '|\nIarrachtaí tástála',
  'Toetspogingnummer': '|\nUimhir iarrachta tástála',
  'Uiterste inlevermoment': '|\nSpriocdháta le cur isteach',
  'Uitgegeven op': '|\nFoilsithe ar',
  'Uitgenodigd e-mailadres': '|\nSeoladh ríomhphoist ar tugadh cuireadh dó',
  'Uitnodigingen': '|\ncuirí',
  'Uniek nummer (ID)': '|\nUimhir uathúil (ID)',
  'Uniek verwerkingskenmerk': '|\nGné próiseála uathúil',
  'Uw accountnummer': '|\nUimhir do chuntais',
  'Uw accountnummer als uitvoerder': '|\nUimhir do chuntais mar sheiceadóir',
  'Uzelf als uploader': '|\nTú féin mar uaslódálaí',
  'Vaardigheidsversienummer': '|\nUimhir leagan scile',
  'Vast internetadres van de installatie':
      '|\nSeoladh idirlín seasta na suiteála',
  'Vastgelegde beslisgegevens': '|\nSonraí taifeadta taifeadta',
  'Vastgelegde gegevens': '|\nSonraí taifeadta',
  'Vereist niveau van aanmeldzekerheid':
      '|\nLeibhéal cinnteachta clárúcháin riachtanach',
  'Vereiste aanmeldmethoden': '|\nModhanna logáil isteach riachtanach',
  'Verloopt bij inactiviteit op':
      '|\nTéann sé in éag nuair a bhíonn sé neamhghníomhach',
  'Verloopt definitief op': '|\nIn éag go buan',
  'Verloopt op': '|\nIn éag',
  'Versienummer van de PE-regel': '|\nUimhir leagan den riail PE',
  'Verwerkte verzoeken': '|\nIarratais próiseáilte',
  'Verwijderd op': '|\nBainte ar',
  'Verwijdering': '|\nBaint',
  'Verwijderingsregister': '|\nClár do Bhaint',
  'Verwijzing naar het antwoord': '|\nTagairt don fhreagra',
  'Verzoeknummer': '|\nUimhir iarratais',
  'Verzoeknummer van de app': '|\nUimhir iarratais aip',
  'Verzonden op': '|\nSeolta ar',
  'Volgende controle op': '|\nAr Aghaidh seiceáil suas',
  'Volgnummer': '|\nUimhir seicheamh',
  'Volgorde van antwoordopties': '|\nOrd roghanna freagraí',
  'Vraagnummer binnen de toetspoging':
      '|\nUimhir na ceiste laistigh den iarracht tástála',
  'Vraagversienummer': '|\nUimhir leagan ceiste',
  'Vragen in toetspogingen': '|\nCeisteanna in iarrachtaí tástála',
  'Vrijgegeven': '|\nScaoilte',
  'Vrijgegeven op': '|\nScaoilte ar',
  'Wat gebeurt na de bewaartermijn':
      '|\nCad a tharlaíonn tar éis na tréimhse coinneála',
  'Wettelijke verplichting': '|\nOibleagáid dhlíthiúil',
  'Wijzigingen aan PE-punten': '|\nAthruithe ar phointí Corpoideachais',
  'Wijzigingen aan kwalificaties': '|\nAthruithe ar cháilíochtaí',
  'Wijzigingen in aanmeldbeveiliging':
      '|\nAthruithe ar shlándáil logáil isteach',
  'Zekerheid': '|\nCinnteacht',
  'Zoek bijvoorbeeld op cursus, datum of status':
      '|\nMar shampla, cuardaigh de réir cúrsa, dáta nó stádais',
  'Zoeken in uw gegevens': '|\nCuardaigh do shonraí',
  '{aantal} categorieën gevonden': '|\nFuarthas catagóirí {aantal}',
  'Aanwezigheid': 'Tinreamh',
  'Lidmaatschap': 'Ballraíocht',
  'Inzage en wijzigingen': 'Rochtain agus athruithe',
  'Beschikbaarheid van het inzagespoor': 'Infhaighteacht an loga rochtana',
  'Beschikbaar vanaf': 'Ar fáil ó',
  'Historie vóór deze datum': 'Stair roimh an dáta seo',
  'Tijdstip': 'Dáta agus am',
  'Handeling': 'Gníomh',
  'Gegevensonderdeel': 'Catagóir sonraí',
  'Handelde als': 'D\'fheidhmigh mar',
  'Organisatorische rol': 'Ról eagraíochtúil',
  'Bekeken': 'Bhreathnaigh',
  'Gewijzigd': 'Athraithe',
  'Uzelf': 'tu',
  'Medewerker': 'Ball foirne',
  'Systeem': 'Córas',
  'Onbekend': 'Anaithnid',
  'Docent': 'Teagascóir',
  'Beoordelaar': 'Measúnóir',
  'Organisatiebeheerder': 'Riarthóir eagraíochta',
  'Niet beschikbaar': 'Níl sé ar fáil',
  'Uitoefening van privacyrechten': 'Cearta príobháideachais a fheidhmiú',
  'Beoordeling en certificering': 'Measúnú agus deimhniú',
  'Uitvoering van het leertraject': 'Seachadadh an chláir foghlama',
  'Cursistenadministratie': 'Riarachán foghlaimeora',
  'Cursistprofiel': 'Próifíl foghlaimeora',
  'Leerstatistieken': 'Staitisticí foghlama',
  'Inschrijving': 'Rollú',
  'Toetspoging': 'Iarracht measúnaithe',
  'Beoordeling': 'Measúnú',
  'Bewijsstuk': 'Fianaise',
  'Kwalificatie': 'Cáilíocht',
  'Deelname': 'Rannpháirtíocht',
  'PE-punten': 'Pointí oideachais leanúnaigh',
  'Certificaat': 'Teastas',
  'Privacyverzoek': 'Iarratas príobháideachta',
  'Bewaard tot': 'Coinnithe go dtí',
  'Bekijk mijn gegevens': 'Féach ar mo chuid sonraí',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Féach cé na sonraí atá taifeadta ag eLearning fút.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Fuarthas an forbhreathnú seo go díreach ó eLearning ar {datum} agus ní stórálann OciDeck é.',
  'Geen gegevens geregistreerd': 'Níl aon sonraí taifeadta',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'Tá gach catagóir ann a chuir an freastalaí ar fáil don eagraíocht seo. Le haghaidh eolais faoi chuspóirí, faighteoirí, bunús, tréimhsí coinneála nó do chearta príobháideachais eile, déan teagmháil le {organisatie}.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Níorbh fhéidir do chuid sonraí a lódáil. Bain triail eile as.',
  'Meer tonen ({aantal} resterend)': 'Taispeáin tuilleadh ({aantal} fágtha)',
  'Mijn gegevens': 'Mo chuid sonraí',
  'Privacy-inzage': 'Rochtain ar shonraí pearsanta',
  'Uw geregistreerde gegevens': 'Do chuid sonraí taifeadta',
  'uw organisatie': 'd\'eagraíocht',
  '{aantal} registraties': '{aantal} taifead',
  'Volg opleidingen uit uw eLearning-omgeving. Cursusbestanden openen alleen in afspeelmodus; voortgang wordt alleen na aanmelden gesynchroniseerd.':
      'Déan cúrsaí ó do thimpeallacht eLearning. Ní osclaítear comhaid chúrsa ach i mód athsheinm; ní shioncronaítear dul chun cinn ach tar éis sínithe isteach.',
  'eLearning-aanmelding is alleen beschikbaar in de desktop-app, omdat de webversie geen veilige sleutelbos heeft.':
      'Níl síniú isteach eLearning ar fáil ach san aip deisce, toisc nach bhfuil fáinne eochracha slán ag an leagan gréasáin.',
  'eLearning-server': 'Freastalaí eLearning',
  'Bij het volgen van een cursus stuurt OciDeck uw laatste dia, voltooiing en getoonde tijd per dia naar de gekozen eLearning-organisatie. Antwoorden, notities en cursusinhoud worden niet als voortgang verstuurd.':
      'Agus cúrsa á leanúint, seolann OciDeck do shleamhnán deireanach, críochnú agus an t-am taispeánta in aghaidh an tsleamhnáin chuig an eagraíocht eLearning roghnaithe. Ní sheoltar freagraí, nótaí ná ábhar an chúrsa mar dhul chun cinn.',
  'Ingelogd bij eLearning': 'Sínithe isteach in eLearning',
  'Deze eLearning-server gebruikt {host} voor het aanmelden. Er worden pas gegevens met die identiteitsprovider uitgewisseld nadat u dit toestaat.':
      'Úsáideann an freastalaí eLearning seo {host} le síniú isteach. Ní mhalartaítear sonraí leis an soláthraí aitheantais sin go dtí go gceadaíonn tú é.',
  'Gebruik een HTTPS-adres voor eLearning.':
      'Bain úsáid as seoladh HTTPS le haghaidh eLearning.',
  'Vul een geldig eLearning-adres in.': 'Iontráil seoladh bailí eLearning.',
  ...
  'Met afloop wordt de pagina rondom groter dan het gekozen formaat, zodat inkt die tot de rand loopt dóór de snijlijn heen gaat. De afloop geldt voor élke export tot je hem weer op 0 zet. Laat dit op 0 voor gewoon afdrukken.':
      'Le fuiliú bíonn an leathanach níos mó ná an mhéid roghnaithe ar gach taobh, sa chaoi is go leanann dúch a shroicheann an t-imeall thar líne an bhearrtha. Baineann an fuiliú le gach easpórtáil go dtí go gcuireann tú ar ais go 0 é. Fág ar 0 é le haghaidh gnáthphriontála.',
  'Pagina\'s': 'Leathanaigh',
  'Maat': 'Méid',
  'Staand': 'Portráid',
  'Liggend': 'Tírdhreach',
  'documenten': 'cáipéisí',
  'posters en boeken': 'póstaeir agus leabhair',
  ...
  'Het token heeft de repo-scope nodig (of fijnmazig: Contents lezen en schrijven).':
      'Teastaíonn an scóip repo ón gcomhartha (nó mionsonraithe: Contents léamh agus scríobh).',
  ...
  'zorgverzekeringsnummer (OHIP) — een zorggegeven':
      'uimhir árachais sláinte (OHIP) — sonra sláinte',
  'bedrijfsnummer (BN)': 'uimhir ghnó (BN)',
  'zorgverlenersnummer (NPI)': 'uimhir sholáthraí cúraim sláinte (NPI)',
  'Medicare-nummer (MBI) — een zorggegeven':
      'uimhir Medicare (MBI) — sonra sláinte',
  ...
  'De branch is verzet; je commits staan lokaal klaar.':
      'Bhog an bhrainse; tá do commits réidh go logánta.',
  'Synchroniseren mislukt.': 'Theip ar an sioncronú.',
  ...
  'LibrePlan importeren': 'Iompórtáil ó LibrePlan',
  ...
  'Gantt-planning': 'Sceideal Gantt',
  'WBS (hiërarchie)': 'WBS (ordlathas)',
  'Projectstatus (cockpit)': 'Stádas an tionscadail (cockpit)',
  'Milestones (tijdlijn)': 'Garspriocanna (amlíne)',
  'Kritieke pad (flow)': 'Cosán criticiúil (sreabhadh)',
  'Resources (tabel)': 'Acmhainní (tábla)',
  'Timesheet (tabel)': 'Bileog ama (tábla)',
  'Resourcebelasting (grafiek)': 'Ualach acmhainní (cairt)',
