...
const _dutchSourceAddGa = <String, String>{
  ...
  'Met afloop wordt de pagina rondom groter dan het gekozen formaat, zodat inkt die tot de rand loopt dóór de snijlijn heen gaat. Laat dit op 0 voor gewoon afdrukken.':
      'Le fuiliú bíonn an leathanach níos mó ná an mhéid roghnaithe ar gach taobh, sa chaoi is go leanann dúch a shroicheann an t-imeall thar líne an bhearrtha. Fág ar 0 é le haghaidh gnáthphriontála.',
