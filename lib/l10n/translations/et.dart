...
const _dutchSourceAddEt = <String, String>{
  'OciDeck mag uw microfoon of camera niet gebruiken. Geef toestemming in uw browser of systeeminstellingen en probeer het opnieuw.':
      'OciDeckil ei ole lubatud kasutada teie mikrofoni ega kaamerat. Andke luba brauseris või süsteemi seadetes ja proovige uuesti.',
  'Er is geen werkende microfoon gevonden. Sluit er een aan of kies een ander apparaat.':
      'Töötavat mikrofoni ei leitud. Ühendage mikrofon või valige mõni muu seade.',
  'Er is geen werkende camera gevonden. U kunt zonder beeld meedoen.':
      'Töötavat kaamerat ei leitud. Võite liituda ilma pildita.',
  'De dienst die het toegangsbewijs afgeeft is onbereikbaar. Probeer het later opnieuw; uw presentatie blijft ondertussen gewoon open.':
      'Juurdepääsutõendit väljastav teenus ei ole kättesaadav. Proovige hiljem uuesti; teie esitlus jääb vahepeal lihtsalt avatuks.',
  'De dienst die het toegangsbewijs afgeeft heeft zijn grens voor nu bereikt. Probeer het later opnieuw.':
      'Juurdepääsutõendit väljastav teenus on praeguseks oma piiri saavutanud. Proovige hiljem uuesti.',
  'Het toegangsbewijs voor deze vergadering is verlopen. Doe opnieuw mee met dezelfde link.':
      'Selle koosoleku juurdepääsutõend on aegunud. Liituge uuesti sama lingiga.',
  'Het netwerk laat deze vergadering niet door. Op een bedrijfsnetwerk blokkeert een firewall of proxy dit soort verkeer vaak; een andere verbinding lukt meestal wel.':
      'Võrk ei lase seda koosolekut läbi. Ettevõtte võrgus blokeerib tulemüür või vaheserver sellist liiklust sageli; teine ühendus tavaliselt õnnestub.',
  'Deze vergadering is voorbij.': 'See koosolek on läbi.',
  'De vergaderdienst is zelf niet beschikbaar. Dit ligt niet aan uw verbinding; probeer het later opnieuw.':
      'Koosolekuteenus ise ei ole saadaval. See ei olene teie ühendusest; proovige hiljem uuesti.',
  'Meedoen is niet gelukt, en de dienst zegt niet waarom. De technische code staat bij de details — probeer het opnieuw, en geef die code door als het blijft misgaan.':
      'Liitumine ebaõnnestus ja teenus ei ütle, miks. Tehniline kood on üksikasjade juures — proovige uuesti ja andke see kood edasi, kui viga kordub.',
  'Dit is geen bruikbare vergaderlink. Kopieer hem opnieuw uit de uitnodiging — een link die door een chatprogramma is afgekapt of aangepast, doet het vaak niet meer.':
      'See ei ole kasutatav koosoleku link. Kopeerige see kutsest uuesti — link, mida vestlusprogramm on lühendanud või muutnud, sageli enam ei tööta.',
  'Deze dienst kennen we, maar dit soort vergadering niet. Webinars, uitzendingen en persoonlijke vergaderkamers werken anders dan een gewone vergadering; open deze link in de browser.':
      'Seda teenust me tunneme, kuid seda koosolekutüüpi mitte. Veebiseminarid, ülekanded ja isiklikud koosolekuruumid toimivad teisiti kui tavaline koosolek; avage see link brauseris.',
  'Deze vergaderdienst kennen we niet. OciDeck weet dus ook niet wat er achter deze link zit; u kunt hem in uw browser openen als u de afzender vertrouwt.':
      'Me ei tunne seda koosolekuteenust. Seega ei tea ka OciDeck, mis selle lingi taga on; võite selle oma brauseris avada, kui usaldate saatjat.',
  'Meedoen kan op deze uitvoering van OciDeck niet. Gebruik de webversie in uw browser.':
      'Selles OciDecki versioonis ei saa liituda. Kasutage brauseris veebiversiooni.',
  'Deze browser mist iets wat voor meedoen nodig is. Een recente Chrome, Edge, Firefox of Safari lukt doorgaans wel.':
      'Sellel brauseril on puudu midagi, mida liitumiseks vaja on. Värske Chrome, Edge, Firefox või Safari toimib tavaliselt.',
  'De organisatie van deze vergadering laat geen gasten zonder account toe. Vraag de organisator om u uit te nodigen op een manier die gasten toestaat.':
      'Selle koosoleku korraldav organisatsioon ei luba kontota külalisi. Paluge korraldajal kutsuda teid viisil, mis külalisi lubab.',
  'Meedoen aan deze vergadering vereist een account bij de aanbieder. Open de link in uw browser en meld u daar aan.':
      'Selle koosolekuga liitumiseks on vaja teenusepakkuja kontot. Avage link brauseris ja logige seal sisse.',
  'Deze aanbieder laat alleen goedgekeurde programma\'s meedoen, en die goedkeuring is er voor OciDeck nog niet. Open de vergadering in uw browser.':
      'See teenusepakkuja lubab liituda ainult heakskiidetud programmidel ja OciDeckil sellist heakskiitu veel ei ole. Avage koosolek brauseris.',
  'De organisator heeft u niet toegelaten. Vraag of hij u binnenlaat en probeer het daarna opnieuw.':
      'Korraldaja ei lasknud teid sisse. Paluge, et teid sisse lastaks, ja proovige seejärel uuesti.',
  'Deze vergadering is op slot; er komt niemand meer bij. Vraag de organisator om het slot eraf te halen.':
      'See koosolek on lukus; keegi enam sisse ei pääse. Paluge korraldajal lukk eemaldada.',
  'Deze vergadering is eind-tot-eind versleuteld en laat daarom geen externe deelnemers toe. Dat is een keuze van de organisator; vraag hem om een gewone vergadering als u erbij moet zijn.':
      'See koosolek on otspunktist otspunktini krüpteeritud ja seetõttu ei luba väliseid osalejaid. See on korraldaja valik; paluge temalt tavalist koosolekut, kui peate kohal olema.',
  '{plek} krijgt contact zodra u meedoet.':
      'Teenusega {plek} võetakse ühendust niipea, kui liitute.',
  'U doet mee met alleen de naam die u zelf opgeeft; u bent niet aangemeld als die persoon.':
      'Osalete ainult selle nimega, mille ise sisestate; te ei ole sisse logitud selle isikuna.',
  'De dienst maakt een tijdelijke gastidentiteit voor u, die na de vergadering verdwijnt.':
      'Teenus loob teile ajutise külalisidentiteedi, mis pärast koosolekut kaob.',
  'U doet mee als gast onder een dienstaccount van een organisatie.':
      'Osalete külalisena organisatsiooni teenusekonto alt.',
  'De organisator heeft een identiteit voor u klaargezet.':
      'Korraldaja on teile identiteedi ette valmistanud.',
  'Meedoen gaat met uw eigen account bij deze aanbieder.':
      'Liitute oma kontoga selle teenusepakkuja juures.',
  'De aanbieder ziet uw netwerkgegevens en het beeld en geluid dat u verstuurt. Wat u deelt, deelt u met alle deelnemers.':
      'Teenusepakkuja näeb teie võrguandmeid ning pilti ja heli, mida saadate. Mida jagate, seda jagate kõigi osalejatega.',
  'Het verkeer is versleuteld naar de dienst toe; de dienst zelf kan meekijken.':
      'Liiklus on teenuseni krüpteeritud; teenus ise saab seda näha.',
  'De aanbieder beheert de versleuteling en dus ook de sleutels.':
      'Teenusepakkuja haldab krüpteerimist ja seega ka võtmeid.',
  'De aanbieder beschrijft dit als eind-tot-eind versleuteld.':
      'Teenusepakkuja kirjeldab seda kui otspunktist otspunktini krüpteeritut.',
  'Over de versleuteling is niets vastgesteld. OciDeck belooft daar dus niets over.':
      'Krüpteerimise kohta pole midagi kindlaks tehtud. Seetõttu ei luba OciDeck selle kohta midagi.',
  'U komt eerst in een wachtruimte: een organisator moet u toelaten. Uw presentatie blijft ondertussen gewoon te bewerken.':
      'Kõigepealt satute ooteruumi: korraldaja peab teid sisse laskma. Vahepeal saate oma esitlust edasi muuta.',
  'Deze vergadering vraagt om een wachtwoord.': 'See koosolek küsib parooli.',
  'Deze vergadering vraagt om aanmelding vooraf.':
      'See koosolek nõuab eelnevat registreerimist.',
  'Vergadering wordt voorbereid': 'Koosolekut valmistatakse ette',
  'Verbinden met de vergadering': 'Ühendumine koosolekuga',
  'Wachten op toelating door de organisator':
      'Oodatakse korraldaja luba siseneda',
  'U doet mee aan de vergadering': 'Osalete koosolekul',
  'De verbinding is weggevallen — opnieuw verbinden':
      'Ühendus katkes — ühendutakse uuesti',
  'De vergadering wordt verlaten': 'Koosolekult lahkumine',
  'De vergadering is beëindigd': 'Koosolek on lõppenud',
  'Meedoen is niet gelukt': 'Liitumine ebaõnnestus',
  'Deze vergadering wordt opgenomen.': 'Seda koosolekut salvestatakse.',
  'Deze vergadering wordt uitgeschreven.':
      'Seda koosolekut transkribeeritakse.',
  'Deze vergadering wordt opgenomen en uitgeschreven.':
      'Seda koosolekut salvestatakse ja transkribeeritakse.',
  'De vergadering vraagt uw uitdrukkelijke toestemming om mee te blijven doen.':
      'Koosolek palub teie selget nõusolekut, et saaksite osalemist jätkata.',
  'Een organisator moet u nog toelaten. U kunt gewoon doorwerken; zodra u binnen bent, opent het gespreksvenster zich.':
      'Korraldaja peab teid veel sisse laskma. Võite rahulikult tööd jätkata; niipea kui olete sees, avaneb kõneaken.',
  'Herkend als een vergadering bij {plek}.':
      'Tuvastatud kui koosolek teenuses {plek}.',
  '{uitleg} De link wijst naar {plek}.':
      '{uitleg} Link viitab aadressile {plek}.',
  'Deze naam kiest u zelf; niemand controleert hem. De anderen zien u als gast.':
      'Selle nime valite ise; keegi seda ei kontrolli. Teised näevad teid külalisena.',
  'Afsluiten': 'Lõpeta',
  'Camera aanzetten': 'Lülita kaamera sisse',
  'Camera uitzetten': 'Lülita kaamera välja',
  'Microfoon aanzetten': 'Lülita mikrofon sisse',
  'Microfoon dempen': 'Vaigista mikrofon',
  'Presentatie delen': 'Jaga esitlust',
  'Delen stoppen': 'Lõpeta jagamine',
  'Gespreksvenster': 'Kõneaken',
  'Venster sluiten': 'Sulge aken',
  'Meedoen': 'Liitu',
  'Meedoen aan een onlinevergadering': 'Veebikoosolekuga liitumine',
  'Onlinevergadering': 'Veebikoosolek',
  'Onlinevergadering…': 'Veebikoosolek…',
  'Vergaderlink': 'Koosoleku link',
  'Plak hier de link uit de uitnodiging': 'Kleepige siia kutses olev link',
  'Uw naam, zoals de anderen die zien': 'Teie nimi, nagu teised seda näevad',
  'Wat er gebeurt als u meedoet': 'Mis juhtub, kui liitute',
  'Verlaten': 'Lahku',
  'Weigeren en verlaten': 'Keeldu ja lahku',
  'Toestemming geven': 'Anna nõusolek',
  'Technische code: {code}': 'Tehniline kood: {code}',
  'Deelnemers ({aantal})': 'Osalejad ({aantal})',
  'Nog geen deelnemers.': 'Osalejaid veel pole.',
  'Deze vergadering geeft geen deelnemerslijst.':
      'See koosolek ei anna osalejate loendit.',
  'gast': 'külaline',
  'deelnemer': 'osaleja',
  'presentator': 'esitleja',
  'moderator': 'moderaator',
  'organisator': 'korraldaja',
  'rol onbekend': 'roll teadmata',
  'Bord': 'Tahvel',
