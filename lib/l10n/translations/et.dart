...
const _dutchSourceEt = {
  ...
  'Auditdossier geëxporteerd naar:':
      'Auditidokumentatsioon eksporditi asukohta:',
...
const _dutchSourceAddEt = <String, String>{
  ...
  'Aangemaakt op': 'Loodud',
  'Aanmeldprovider': 'Sisselogimise pakkuja',
  'Aanmeldsessies': 'Registreerimisseansid',
  'Aantal controles': 'Kontrollide arv',
  ...
  'Activiteitnummer': 'Tegevuse number',
  'Afgerond op': 'Ümardatud kuni',
  'Afgewezen': 'Tagasi lükatud',
  'Afspeelsessienummer': 'Taasesituse seansi number',
  'Afwezig': 'Puudub',
  'Antwoordgegevens': 'Vastuse üksikasjad',
  'Antwoordstatus': 'Vastuse olek',
  'Begint op': 'Algab',
  'Begrippen uitgelegd': 'Mõisted lahti seletatud',
  'Beheer van de installatie': 'Paigalduse juhtimine',
  'Beheerpogingen': 'Juhtkonna pingutused',
  'Bekeken lessen': 'Õppetunnid vaadatud',
  'Beleidsversie': 'Poliitika versioon',
  'Beoordeeld': 'Hinnatud',
  'Beoordeeld op': 'Hinnanud',
  'Beperking': 'Piirang',
  'Berekend op': 'Arvutatud',
  'Bericht': 'Sõnum',
  'Bestandsnaam': 'Failinimi',
  'Beveiligingsvraagnummer': 'Turvaküsimuse number',
  'Bevestigd': 'Kinnitatud',
  'Bevestigd op': 'Kinnitatud',
  'Bewaarregels': 'Säilitamise reeglid',
  'Bewaartermijn': 'Säilitusperiood',
  'Bewaren wegens een juridische verplichting':
      'Säilitatakse seadusest tuleneva kohustuse tõttu',
  'Bewerkingnummer bij aanmeldprovider':
      'Toimingu number registreerimisteenuse pakkuja juures',
  'Bewijsstukken': 'Tõendid',
  'Bezwaar': 'Vastulause',
  'Beëindigd op': 'Lõpetas',
  'Bijeenkomstnummer': 'Koosoleku number',
  'Certificaatnummer': 'Sertifikaadi number',
  'Certificaten': 'Sertifikaadid',
  'Controlecode van de PDF': 'PDF-i kontrollkood',
  'Controlecode van profielfoto': 'Profiilifoto kinnituskood',
  'Controlecodes van bewijsstukken': 'Täiendavate dokumentide kontrollkoodid',
  'Correctie': 'Parandus',
  'Cursistnummer waarop de actie gericht was':
      'Õpilase number, kellele tegevus oli suunatud',
  'Cursusaanbodnummer': 'Kursuse pakkumise number',
  'Cursusversienummer': 'Kursuse versiooni number',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Kuupäevi ja kellaaegu näidatakse teie kohaliku aja järgi. Tehnilised nimed jäävad nähtavaks, kui server esitab tundmatu välja.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'Testiküsimustele antud vastused.',
  'Deelnamenummer': 'Osalemisnumber',
  'Deelnames': 'Osalused',
  'Details': 'Üksikasjad',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Selle kategooria andis server. Tehnilised nimed jäävad teie organisatsiooni päringute jaoks nähtavaks.',
  'Door uzelf aangevraagd': 'Ise soovinud',
  'E-mailadres': 'E-posti aadress',
  'E-mailberichten': 'Meilisõnumid',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'ID on ainulaadne tehniline number, mida eLearning kasutab andmete ühendamiseks. See ei ole reiting ega staatus.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'Kategooriasse koondatakse sama teema andmed. Registreerimine on üks salvestatud andmed või üks sündmus.',
  'Eindigt op': 'Lõpeb sisse',
  'Geaccepteerd op': 'Vastu võetud',
  'Geannuleerd': 'Tühistatud',
  'Gecontroleerd': 'Kontrollitud',
  'Gecontroleerd op': 'Kontrollitud',
  'Geen gegevens gevonden': 'Andmeid ei leitud',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Teave teie andmete säilitamisperioodide ja kustutamise kohta.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Teave tõendavate dokumentide, saavutatud tulemuste ja sertifikaatide kohta.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Teave privaatsustaotluste ja teie teabe vaatamise või muutmise kohta.',
  'Gegevens over uw accountbewerking': 'Teave teie konto toimimise kohta',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Teave teie registreerimise, osalemise ja õppetundides edenemise kohta.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Teave teie profiili, konto ja ametikoha kohta organisatsioonis.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Teave teie testihetkede ja esitatud küsimuste kohta.',
  'Gegevens over willekeurige volgorde': 'Juhusliku tellimuse andmed',
  'Gegevenscategorie': 'Andmekategooria',
  'Gekoppeld accountnummer': 'Lingitud konto number',
  'Gekozen antwoorden': 'Valitud vastused',
  'Gelukt': 'Edu',
  'Geprobeerd op': 'Proovitud',
  'Gerechtvaardigd belang': 'Õigustatud huvi',
  'Gereserveerd': 'Reserveeritud',
  'Gereserveerd op': 'Reserveeritud',
  'Geslaagd': 'Läbitud',
  'Gestart op': 'Algas',
  'Getoonde tijd per dia in milliseconden':
      'Slaidi kohta kuvatav aeg millisekundites',
  'Herkomst van inschrijving': 'Registreerimise päritolu',
  'Hoogst haalbare score': 'Kõrgeim võimalik punktisumma',
  'Identificatienummer bij aanmeldprovider':
      'Registreerimisteenuse pakkuja identifitseerimisnumber',
  'Identiteitsbewerkingnummer': 'Isikutunnistuse operatsiooni number',
  'In afwachting': 'Ootel',
  'In behandeling': 'Pooleli',
  'In behandeling genomen op': 'Töödeldud edasi',
  'In quarantaine': 'Karantiinis',
  'Ingeleverd': 'Esitatud',
  'Ingeleverd op': 'Esitatud',
  'Ingericht op': 'Kaunistatud peale',
  'Ingeschreven op': 'Registreeritud',
  'Ingetrokken': 'Tagasi võetud',
  'Ingetrokken op': 'Tagasi võetud',
  'Inschrijvingen': 'Registreerimised',
  'Inschrijvingsnummer': 'Registreerimisnumber',
  'Installatiebeveiligingslogboek': 'Paigaldamise turvalogi',
  'Installatienummer': 'Paigaldusnumber',
  'Installatieverzoeken': 'Paigaldustaotlused',
  'Inzage': 'Ülevaatus',
  'Ja': 'Jah',
  'Kwalificatienummer': 'Kvalifikatsiooni number',
  'Kwalificaties': 'Kvalifikatsioonid',
  'Laatst actief op': 'Viimati aktiivne',
  'Laatst bekeken dia': 'Viimati vaadatud slaid',
  'Laatst gewijzigd op': 'Viimati muudetud',
  'Laatste fout': 'Viimane viga',
  'Lesnummer': 'Tunni number',
  'Lesreserveringen': 'Tunni broneeringud',
  'Lesvoortgang': 'Tunni edenemine',
  'Lidmaatschappen': 'Liikmelisus',
  'Locatie': 'Asukoht',
  'Manier van afronden': 'Ümardamise viis',
  'Maximaal aantal controles': 'Maksimaalne kontrollide arv',
  'Maximaal aantal pogingen': 'Maksimaalne katsete arv',
  'Maximale leeftijd van de aanmelding': 'Registreerimise maksimaalne vanus',
  'Mislukt': 'Ebaõnnestunud',
  'Naam van de activiteit': 'Tegevuse nimi',
  'Naam van de bijeenkomst': 'Koosoleku nimi',
  'Nee': 'Ei',
  'Netwerkadres': 'Võrgu aadress',
  'Niet actief': 'Pole aktiivne',
  'Niet geregistreerd': 'Registreerimata',
  'Niet ingevuld': 'Pole täidetud',
  'Niet verschenen': 'Ei avaldatud',
  'Niveau van extra aanmeldcontrole': 'Täiendava registreerimiskontrolli tase',
  'Nummer van de toetsopzet': 'Katseplaani number',
  'Nummer van het brongegeven': 'Lähteandmete arv',
  'Nummer van uw verwijderde gegeven': 'Teie kustutatud andmete arv',
  'Onderdeel {nummer}': 'Osa {nummer}',
  'Onderwerp van de actie': 'Meetme objekt',
  'Ontvanger': 'Saaja',
  'Opgegeven bestandsgrootte': 'Määratud faili suurus',
  'Opgegeven bestandstype': 'Määratud failitüüp',
  'Opgegeven controlecode': 'Määratud kontrollkood',
  'Opgeslagen bestandsgrootte': 'Salvestatud faili suurus',
  'Opgeslagen controlecode': 'Salvestatud kontrollkood',
  'Organisatienummer': 'Organisatsiooni number',
  'Overdraagbaarheid': 'Ülekantavus',
  'PE-toekenningnummer': 'PE auhinna number',
  'Poging': 'Katse',
  'Positie': 'positsioon',
  'Privacyverzoeken': 'Privaatsusnõuded',
  'Probeer een andere zoekterm.': 'Proovige teist otsinguterminit.',
  'Reden': 'Põhjus',
  'Reden of grondslag': 'Põhjus või alus',
  'Reden van afwijzing': 'Tagasilükkamise põhjus',
  'Reden van bevestiging': 'Kinnituse põhjus',
  'Reden van intrekking': 'Taganemise põhjus',
  'Reden voor langer bewaren': 'Pikema ladustamise põhjus',
  'Regels voor de cursusversie': 'Kursuse versiooni reeglid',
  'Resultaat bij de aanmeldprovider':
      'Tulemus registreerimisteenuse pakkuja juures',
  'Rol': 'Rulli',
  'Score': 'Skoor',
  'Soort aanwezigheid': 'Omamoodi kohalolu',
  'Soort accountbewerking': 'Konto toimingu tüüp',
  'Soort gebeurtenis': 'Sündmuse tüüp',
  'Soort privacyverzoek': 'Privaatsustaotluse tüüp',
  'Status van de bijeenkomst': 'Koosoleku olek',
  'Strenge beveiligingsmodus': 'Kõrge turvalisuse režiim',
  'Technisch toegangslogboek': 'Tehnilise juurdepääsu logi',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Registreerimiseks, turvalisuseks ja usaldusväärseks töötlemiseks vajalikud tehnilised andmed.',
  'Technische naam: {naam}': 'Tehniline nimetus: {naam}',
  'Technische opslagcategorie': 'Tehnilise ladustamise kategooria',
  'Technische opslaglocatie van de PDF': 'PDF-i tehniline salvestuskoht',
  'Tijdstip van aanmelding': 'Registreerimise aeg',
  'Tijdzone': 'Ajavöönd',
  'Toestand': 'Seisund',
  'Toetspogingen': 'Testkatsed',
  'Toetspogingnummer': 'Katsekatse number',
  'Uiterste inlevermoment': 'Esitamise tähtaeg',
  'Uitgegeven op': 'Avaldatud',
  'Uitgenodigd e-mailadres': 'Kutsutud meiliaadress',
  'Uitnodigingen': 'Kutsed',
  'Uniek nummer (ID)': 'Unikaalne number (ID)',
  'Uniek verwerkingskenmerk': 'Unikaalne töötlemisfunktsioon',
  'Uw accountnummer': 'Teie konto number',
  'Uw accountnummer als uitvoerder': 'Teie kui täituri kontonumber',
  'Uzelf als uploader': 'Ise üleslaadijana',
  'Vaardigheidsversienummer': 'Oskuste versiooni number',
  'Vast internetadres van de installatie':
      'Installi fikseeritud Interneti-aadress',
  'Vastgelegde beslisgegevens': 'Salvestatud otsuseandmed',
  'Vastgelegde gegevens': 'Salvestatud andmed',
  'Vereist niveau van aanmeldzekerheid': 'Nõutav registreerimiskindluse tase',
  'Vereiste aanmeldmethoden': 'Nõutavad sisselogimismeetodid',
  'Verloopt bij inactiviteit op': 'Aegub, kui passiivne',
  'Verloopt definitief op': 'Aegub jäädavalt',
  'Verloopt op': 'Aegub',
  'Versienummer van de PE-regel': 'PE-reegli versiooni number',
  'Verwerkte verzoeken': 'Töödeldud taotlused',
  'Verwijderd op': 'Eemaldatud',
  'Verwijdering': 'Eemaldamine',
  'Verwijderingsregister': 'Eemaldamise register',
  'Verwijzing naar het antwoord': 'Viide vastusele',
  'Verzoeknummer': 'Küsi numbrit',
  'Verzoeknummer van de app': 'Rakenduse taotluse number',
  'Verzonden op': 'Saadetud',
  'Volgende controle op': 'Järgmine kontroll',
  'Volgnummer': 'Järjestuse number',
  'Volgorde van antwoordopties': 'Vastuste valikute järjekord',
  'Vraagnummer binnen de toetspoging': 'Küsimuse number katsekatses',
  'Vraagversienummer': 'Küsimuse versiooni number',
  'Vragen in toetspogingen': 'Küsimused testkatsetel',
  'Vrijgegeven': 'Välja antud',
  'Vrijgegeven op': 'Välja antud',
  'Wat gebeurt na de bewaartermijn': 'Mis juhtub pärast säilitusperioodi',
  'Wettelijke verplichting': 'Juriidiline kohustus',
  'Wijzigingen aan PE-punten': 'Muudatused PE-punktides',
  'Wijzigingen aan kwalificaties': 'Muudatused kvalifikatsioonis',
  'Wijzigingen in aanmeldbeveiliging': 'Muudatused sisselogimise turvalisuses',
  'Zekerheid': 'Kindlus',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Näiteks otsige kursuse, kuupäeva või oleku järgi',
  'Zoeken in uw gegevens': 'Otsige oma andmeid',
  '{aantal} categorieën gevonden': 'Leitud {aantal} kategooriad',
  'Aanwezigheid': 'Osalemine',
  'Lidmaatschap': 'Liikmesus',
  'Inzage en wijzigingen': 'Juurdepääs ja muudatused',
  'Beschikbaarheid van het inzagespoor': 'Juurdepääsulogi kättesaadavus',
  'Beschikbaar vanaf': 'Saadaval alates',
  'Historie vóór deze datum': 'Ajalugu enne seda kuupäeva',
  'Tijdstip': 'Kuupäev ja kellaaeg',
  'Handeling': 'Tegevus',
  'Gegevensonderdeel': 'Andmekategooria',
  'Handelde als': 'Tegutses nagu',
  'Organisatorische rol': 'Organisatsiooniline roll',
  'Bekeken': 'Vaadatud',
  'Gewijzigd': 'Muudetud',
  'Uzelf': 'Sina',
  'Medewerker': 'Töötaja',
  ...
  'Docent': 'Juhendaja',
  'Beoordelaar': 'Hindaja',
  'Organisatiebeheerder': 'Organisatsiooni administraator',
  'Niet beschikbaar': 'Ei ole saadaval',
  'Uitoefening van privacyrechten': 'Privaatsusõiguste teostamine',
  'Beoordeling en certificering': 'Hindamine ja sertifitseerimine',
  'Uitvoering van het leertraject': 'Õppeprogrammi kohaletoimetamine',
  'Cursistenadministratie': 'Õppija haldus',
  'Cursistprofiel': 'Õppija profiil',
  'Leerstatistieken': 'Statistika õppimine',
  'Inschrijving': 'Registreerimine',
  'Toetspoging': 'Hindamise katse',
  'Beoordeling': 'Hindamine',
  'Bewijsstuk': 'Tõendid',
  'Kwalificatie': 'Kvalifikatsioon',
  'Deelname': 'Osalemine',
  'PE-punten': 'Täiendusõppe punktid',
  'Certificaat': 'tunnistus',
  'Privacyverzoek': 'Privaatsustaotlus',
  'Bewaard tot': 'Säilitatakse kuni',
  'Bekijk mijn gegevens': 'Vaata minu andmeid',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Vaadake, milliseid andmeid on eLearning teie kohta salvestanud.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'See ülevaade hangiti {datum} otse eLearningust ja OciDeck seda ei säilita.',
  'Geen gegevens geregistreerd': 'Andmeid ei ole salvestatud',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'See sisaldab kõiki kategooriaid, mille server selle organisatsiooni jaoks edastas. Eesmärkide, vastuvõtjate, päritolu, säilitustähtaegade või muude privaatsusõiguste kohta teabe saamiseks võtke ühendust organisatsiooniga {organisatie}.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Teie andmeid ei õnnestunud laadida. Proovige uuesti.',
  'Meer tonen ({aantal} resterend)': 'Kuva rohkem ({aantal} jäänud)',
  'Mijn gegevens': 'Minu andmed',
  'Privacy-inzage': 'Juurdepääs isikuandmetele',
  'Uw geregistreerde gegevens': 'Teie salvestatud andmed',
  'uw organisatie': 'teie organisatsioon',
  '{aantal} registraties': '{aantal} kirjet',
  ...
  'Deze organisatie bevat te veel lessen om veilig te tonen.':
      'Selles organisatsioonis on turvaliseks kuvamiseks liiga palju tunde.',
  'Er wacht nog voortgang op synchronisatie.':
      'Edenemine ootab veel sünkroonimist.',
  'Met deze keuze wordt het vernieuwtoken in de sleutelbos bewaard. Een versleutelde wachtrij voor nog niet verstuurde voortgang wordt daar los van bewaard.':
      'Selle valikuga salvestatakse värskendustõend võtmeahelasse. Saatmata edenemise krüptitud järjekord salvestatakse sellest eraldi.',
  'Nog niet verstuurde voortgang is op dit apparaat bewaard.':
      'Veel saatmata edenemine on sellesse seadmesse salvestatud.',
  'Cursist': 'Kursusel osaleja',
  'Les afgerond': 'Õppetund lõpetatud',
  'Cursussen voor u': 'Kursused teile',
  'Ga verder waar u gebleven was, of kies een andere cursus die voor u klaarstaat.':
      'Jätkake sealt, kus pooleli jäite, või valige mõni teine teile valmis kursus.',
  'Klaar om te beginnen': 'Valmis alustama',
  'Mijn cursussen': 'Minu kursused',
  'Mijn leeromgeving': 'Minu õpikeskkond',
  'Mooi gedaan! Uw voortgang is bewaard.':
      'Tubli! Teie edenemine on salvestatud.',
  'Nu bezig': 'Pooleli',
  'Opnieuw starten': 'Alusta uuesti',
  'Terug naar mijn cursussen': 'Tagasi minu kursuste juurde',
  'U kunt deze cursus opnieuw bekijken.':
      'Saate selle kursuse uuesti läbi vaadata.',
  'Volgende: {les}': 'Järgmine: {les}',
  'Welkom, {naam}': 'Tere tulemast, {naam}',
  ...
  '{afgerond} van {totaal} lessen afgerond':
      'Lõpetatud {afgerond} / {totaal} õppetundi',
  'Uitloggen': 'Logi välja',
  ...
  'Het bestand is gewijzigd door een ander programma.':
      'Faili on muutnud teine programm.',
  'Herladen': 'Laadi uuesti',
  ...
  'Basislettergrootte: {pt} pt': 'Kirja põhisuurus: {pt} pt',
  ...
  'Elk hoofdstuk begon al op een nieuwe pagina':
      'Iga peatükk algas juba uuelt lehelt',
  ...
  'Met afloop wordt de pagina rondom groter dan het gekozen formaat, zodat inkt die tot de rand loopt dóór de snijlijn heen gaat. De afloop geldt voor élke export tot je hem weer op 0 zet. Laat dit op 0 voor gewoon afdrukken.':
      'Lõikevaruga muutub lehekülg igast küljest valitud formaadist suuremaks, nii et servani ulatuv värv jätkub üle lõikejoone. Lõikevaru kehtib igal eksportimisel, kuni seate selle uuesti nulliks. Tavaliseks printimiseks jäta see nulli.',
  'Pagina\'s': 'Leheküljed',
  'Maat': 'Suurus',
  'Staand': 'Püstine',
  'Liggend': 'Rõhtne',
  'documenten': 'dokumendid',
  'posters en boeken': 'plakatid ja raamatud',
  'enveloppen': 'ümbrikud',
  ...
  'Sluit één of meer OpenKAT-omgevingen aan (bijvoorbeeld productie en acceptatie). OciDeck toont beschikbare rapportages; de inhoud haalt u binnen via een JSON-export uit OpenKAT.':
      'Ühenda üks või mitu OpenKAT keskkonda (nt tootmine ja vastuvõtt). OciDeck näitab saadaolevaid aruandeid; sisu impordi OpenKAT-i JSON-ekspordist.',
  'Server toevoegen…': 'Lisa server…',
  'Rapportage van server…': 'Aruanne serverist…',
  'Nog geen OpenKAT-server aangesloten.':
      'OpenKAT serverit pole veel ühendatud.',
  'Bezig…': 'Töös…',
  'OpenKAT-server bewerken': 'Muuda OpenKAT serverit',
  'OpenKAT-server toevoegen': 'Lisa OpenKAT server',
  'OpenKAT-server toevoegen…': 'Lisa OpenKAT server…',
  'OpenKAT-server verwijderen?': 'Eemaldada OpenKAT server?',
  'Dit verwijdert “{name}” en het bijbehorende toegangstoken van dit apparaat. Dat kunt u niet ongedaan maken.':
      'See eemaldab “{name}” ja seotud juurdepääsutunnuse sellest seadmest. Seda ei saa tagasi võtta.',
  'Weergavenaam': 'Kuvatav nimi',
  'Bijvoorbeeld Productie of Acceptatie': 'Nt tootmine või vastuvõtt',
  'Adres van OpenKAT': 'OpenKAT aadress',
  'Verbinding met: {host}': 'Ühendus: {host}',
  'Eigen netwerk (LAN)': 'Kohalik võrk (LAN)',
  'Alleen voor OpenKAT op het eigen netwerk. Staat HTTP toe en laat privé-adressen toe. Uitgeschakeld: alleen HTTPS.':
      'Ainult OpenKAT kohalikus võrgus. Lubab HTTP-d ja privaatseid aadresse. Väljas: ainult HTTPS.',
  'Toegangstoken': 'Juurdepääsutunnus',
  'Laat leeg om het opgeslagen token te behouden':
      'Jätke tühjaks salvestatud tunnuse säilitamiseks',
  'Plak het token hier': 'Kleebi tunnus siia',
  'Vraag uw OpenKAT-beheerder om een API-token in het beheerdersscherm. Het token blijft op dit apparaat, in de sleutelhanger van uw besturingssysteem — niet in het deck.':
      'Küsige OpenKAT administraatorilt API tunnust haldusvaates. Tunnus jääb sellesse seadmesse OS võtmehoidlasse — mitte decki.',
  'Verbinding wordt getest…': 'Ühendust testitakse…',
  'Test de verbinding voordat u opslaat, zodat u weet dat naam, adres en token kloppen.':
      'Testige ühendust enne salvestamist, et veenduda nime, aadressi ja tunnuse õigsuses.',
  'De OpenKAT-koppeling is alleen beschikbaar in de desktopversie.':
      'OpenKAT ühendus on saadaval ainult töölauaversioonis.',
  'Lees OpenKAT-rapportages in als één managementoverzicht — vanuit een map of vanaf een server.':
      'Impordi OpenKAT aruanded ühe juhtimisülevaatena — kaustast või serverist.',
  'Er staat al een OpenKAT-bron ingesteld; de koppeling blijft daarom bereikbaar, zodat een bestaand OpenKAT-deck bij te werken blijft.':
      'OpenKAT allikas on juba seadistatud; ühendus jääb kättesaadavaks olemasoleva OpenKAT decki uuendamiseks.',
  'Rapportage van OpenKAT-server': 'Aruanne OpenKAT serverist',
  'Rapportage van OpenKAT-server…': 'Aruanne OpenKAT serverist…',
  'Server: {name}': 'Server: {name}',
  'Organisaties worden opgehaald…': 'Organisatsioone laaditakse…',
  'Rapportages worden opgehaald…': 'Aruandeid laaditakse…',
  'Er zijn geen organisaties zichtbaar voor dit token. Vraag uw beheerder om toegang, of kies een andere server.':
      'Selle tunnuse jaoks pole organisatsioone näha. Küsige administraatorilt juurdepääsu või valige teine server.',
  'Er staan geen organisatierapportages klaar op deze server. Maak in OpenKAT eerst een aggregaat-organisatierapport, of kies een andere organisatie.':
      'Sellel serveril pole valmis organisatsiooniaruandeid. Looge esmalt OpenKAT-is koondorganisatsiooni aruanne või valige teine organisatsioon.',
  'JSON-export uit OpenKAT': 'JSON-eksport OpenKAT-ist',
  'OpenKAT levert de rapportage-inhoud als JSON-bestand. Exporteer in OpenKAT het gekozen rapport als JSON, en wijs dat bestand of de map hieraan.':
      'OpenKAT pakub aruande sisu JSON-failina. Ekspordige valitud aruanne OpenKAT-is JSON-ina ja viidake siin sellele failile või kaustale.',
  'Gekozen: {reportName} · {orgName} · {serverName}':
      'Valitud: {reportName} · {orgName} · {serverName}',
  'JSON-bestand kiezen…': 'Vali JSON-fail…',
  'Map met exports kiezen…': 'Vali ekspordikaust…',
  'Vul een weergavenaam in, bijvoorbeeld Productie.':
      'Sisestage kuvatav nimi, nt tootmine.',
  'Vul een weergavenaam en een adres in.': 'Sisestage kuvatav nimi ja aadress.',
  'Plak een toegangstoken om verder te gaan.':
      'Jätkamiseks kleebi juurdepääsutunnus.',
  'Vul een adres in, bijvoorbeeld https://openkat.voorbeeld.nl':
      'Sisestage aadress, nt https://openkat.voorbeeld.nl',
  'Dit adres is niet geldig. Controleer of u een volledige URL heeft ingevuld.':
      'See aadress ei kehti. Kontrollige, kas sisestasite täieliku URL-i.',
  'Het adres moet met https:// beginnen, of zet Eigen netwerk aan voor HTTP op het eigen netwerk.':
      'Aadress peab algama https://-ga või lülitage kohalikus võrgus HTTP jaoks Kohalik võrk sisse.',
  'Verbonden met {host}. Er zijn nog geen organisaties zichtbaar voor dit token.':
      'Ühendatud aadressiga {host}. Selle tunnuse jaoks pole organisatsioone näha.',
  'Verbonden met {host}. {n} organisatie(s) bereikbaar.':
      'Ühendatud aadressiga {host}. Saadaval organisatsioone: {n}.',
  'De verbinding met OpenKAT is mislukt. Controleer het adres en uw netwerk, en probeer opnieuw.':
      'OpenKAT-iga ühendamine ebaõnnestus. Kontrollige aadressi ja võrku ning proovige uuesti.',
  'Er is geen toegangstoken. Plak het token van uw beheerder en probeer opnieuw.':
      'Juurdepääsutunnus puudub. Kleebi administraatori tunnus ja proovi uuesti.',
  'Alleen HTTPS is toegestaan, tenzij Eigen netwerk aan staat.':
      'Lubatud on ainult HTTPS, välja arvatud kui Kohalik võrk on sees.',
  'OpenKAT weigerde het token. Vraag uw beheerder om een geldig API-token en plak het opnieuw.':
      'OpenKAT lükkas tunnuse tagasi. Küsige administraatorilt kehtivat API tunnust ja kleebige uuesti.',
  'OpenKAT reageerde niet op tijd. Controleer of de server bereikbaar is en probeer opnieuw.':
      'OpenKAT ei vastanud õigeaegselt. Kontrollige serveri kättesaadavust ja proovige uuesti.',
  'Dit adres is niet bereikbaar. Controleer de spelling van de hostnaam en of u op het juiste netwerk zit.':
      'See aadress pole kättesaadav. Kontrollige hostinime kirjapilti ja õiget võrku.',
  'OpenKAT gaf een onverwacht groot antwoord. Probeer later opnieuw of vraag uw beheerder om hulp.':
      'OpenKAT tagastas ootamatult suure vastuse. Proovige hiljem uuesti või pöörduge administraatori poole.',
  'Verbonden': 'Ühendatud',
  'Token ontbreekt': 'Tunnus puudub',
  'Laatst gecontroleerd mislukt': 'Viimane kontroll ebaõnnestus',
  'Nog niet gecontroleerd': 'Veel kontrollimata',
  ...
  'Rapporteer de voortgang van een ISO-managementsysteem (27001/9001/42001): status per beheersmaatregel en een afgeleid voortgangsoverzicht. Standaard uit; zet de uitbreiding aan om het dia-type te gebruiken.':
      'Raporteeri ISO juhtimissüsteemi (27001/9001/42001) edenemine: olek iga meetme kohta ja tuletatud edenemise ülevaade. Vaikimisi väljas; lülita laiendus sisse, et kasutada slaiditüüpi.',
  'Module aan. De ISO-index is lokaal beschikbaar ({n} beheersmaatregelen over drie normen); alleen de nummers en korte titels, niet de normtekst.':
      'Moodul sees. ISO register on saadaval lokaalselt ({n} meedet kolmes standardis); ainult numbrid ja lühikesed pealkirjad, mitte standardi tekst.',
  'Beheersmaatregel-status': 'Kontrollide olek',
  ...
  'Videovergaderingen': 'Videokoosolekud',
  'Neem deel aan videovergaderingen en presenteer vanuit OciDeck met een eigen interface: deelnemers naast uw slide, niet in het venster van een andere app. Bring-your-own-server (Jitsi of Matrix); OciDeck host niets en houdt de gespreksgegevens buiten AI. De aansluiting op een vergaderdienst volgt in een volgende versie.':
      'Liitu videokoosolekutega ja esitle OciDeckist oma liidesega: osalejad su slaidi kõrval, mitte teise rakenduse aknas. Bring-your-own-server (Jitsi või Matrix); OciDeck ei majuta midagi ja hoiab vestlusandmed AI-st eemal. Ühendus koosolekuteenusega lisandub tulevases versioonis.',
  'Videovergadering': 'Videokoosolek',
  'Nog geen actieve vergadering. Het aansluiten op een vergaderdienst wordt in een volgende versie toegevoegd.':
      'Aktiivset koosolekut veel pole. Ühendus koosolekuteenusega lisatakse tulevases versioonis.',
  'Dempen opheffen': 'Eemalda vaigistus',
  'Dempen': 'Vaigista',
  'Camera aan': 'Kaamera sisse',
  'Camera uit': 'Kaamera välja',
  'Scherm delen': 'Jaga ekraani',
  'Vergadering verlaten': 'Lahku koosolekust',
  'De afbeeldingenbibliotheek is te groot; alleen de nieuwste afbeeldingen worden getoond.':
      'Pildikogu on liiga suur; kuvatakse ainult uusimad pildid.',
  'Dit pakket is te groot (maximaal 512 MB). Anders kan OciDeck het daarna niet meer openen. Gebruik minder of kleinere afbeeldingen, video’s of audiobestanden.':
      'See pakett on liiga suur (kõige rohkem 512 MB). Muidu ei saa OciDeck seda hiljem enam avada. Kasuta vähem või väiksemaid pilte, videoid või helifaile.',
  'De afbeeldingen samen zijn te groot voor één HTML-bestand (maximaal 512 MB). Gebruik minder of kleinere afbeeldingen, of exporteer als PDF of pakket.':
      'Pildid on koos liiga suured ühe HTML-faili jaoks (kuni 512 MB). Kasutage vähem või väiksemaid pilte või eksportige PDF-i või paketina.',
  'Deze export heeft te veel dia’s op te hoge resolutie om veilig te renderen. Exporteer in delen of gebruik de gecomprimeerde PDF.':
      'Sellel ekspordil on liiga palju slaide liiga suure resolutsiooniga, et neid saaks turvaliselt renderdada. Ekspordi osade kaupa või kasuta pakitud PDF-i.',
  ...
  'De eigenaar is weg — jij houdt de samenwerking nu gaande; jouw wijzigingen worden pas bewaard als de eigenaar terugkomt.':
      'Omanik on lahkunud — nüüd hoiad koostööd sina; sinu muudatused salvestatakse alles siis, kui omanik naaseb.',
  'De eigenaar is terug en neemt de samenwerking weer over.':
      'Omanik on tagasi ja võtab koostöö taas üle.',
  ...
  'Conflicterende meting overgeslagen': 'Vastuoluline mõõtmine jäeti vahele',
  'Geen ondersteunde OpenKAT-rapportage': 'Toetamata OpenKATi aruanne',
  ...
  'De inhoud verschijnt zodra alle noodzakelijke keuzes zijn gemaakt.':
      'Sisu ilmub, kui kõik vajalikud valikud on tehtud.',
  'De meetdekking verschilt tussen de gekozen meetmomenten; veranderingen zijn daardoor beperkt vergelijkbaar.':
      'Mõõtmisulatus on valitud mõõtehetkede vahel erinev; muutused on seetõttu võrreldavad vaid piiratud ulatuses.',
  'Dekking en actualiteit van metingen': 'Mõõtmiste katvus ja õigeaegsus',
  'Deze CVE is niet aangetroffen in de gekozen metingen.':
      'Seda CVE-d valitud mõõtmistes ei leitud.',
  'Deze map bevat geen bruikbare rapportages':
      'See kaust ei sisalda kasulikke aruandeid',
  'Deze selectie bevat te veel gegevens om veilig in één rapport te verwerken.':
      'See valik sisaldab liiga palju andmeid, et neid ohutult ühte aruannet lisada.',
  'Dit onderdeel kan niet volledig uit de gekozen rapportages worden opgebouwd.':
      'Seda jaotist ei saa täielikult valitud aruannetest üles ehitada.',
  'Dit rapport bevat': 'See aruanne sisaldab',
  'Een of meer metingen zijn ouder dan de gekozen actualiteitsgrens.':
      'Üks või mitu mõõtmist on valitud ajakohasuse piirangust vanemad.',
  'Eerdere bruikbare meting': 'Eelmine kasulik mõõtmine',
  'Engels': 'inglise keel',
  'Er zijn geen bruikbare metingen gevonden.': 'Kasulikke mõõtmisi ei leitud.',
  'Feitelijke gegevens': 'Faktilised andmed',
  ...
  'Import': 'Import',
  'Importverslag bekijken': 'Kuva impordiaruanne',
  'Kerncijfers en aandachtspunten': 'Võtmenumbrid ja huvipunktid',
  ...
  'OciDeck gebruikt dezelfde bron en keuzes en neemt de nieuwste geschikte metingen. Uw eigen dia’s en kopieën blijven behouden.':
      'OciDeck kasutab samu allikaid ja valikuid ning teeb uusimad sobivad mõõtmised. Teie enda slaidid ja koopiad jäävad alles.',
  'OciDeck kon geen bruikbare OpenKAT-metingen vinden. Kies een andere map of bekijk het importverslag om te zien welke bestanden zijn overgeslagen.':
      'OciDeck ei leidnud kasulikke OpenKAT-i mõõtmisi. Valige mõni muu kaust või vaadake impordiaruannet, et näha, millised failid vahele jäeti.',
  'OpenKAT-importverslag': 'OpenKAT-i impordiaruanne',
  'OpenKAT-rapport': 'OpenKAT aruanne',
  'OpenKAT-rapport bijwerken': 'Värskendage OpenKAT-i aruannet',
  'OpenKAT-rapport bijwerken…': 'OpenKAT-i aruande värskendamine…',
  'OpenKAT-rapport kon niet worden gemaakt.':
      'OpenKAT aruannet ei saanud luua.',
  'OpenKAT-rapport maken': 'Loo OpenKAT aruanne',
  'OpenKAT-rapport maken…': 'Loo OpenKAT aruanne…',
  'Organisaties': 'Organisatsioonid',
  'Organisaties kiezen': 'Organisatsioonide valimine',
  'Rapport bijgewerkt. Uw eigen dia’s zijn behouden.':
      'Aruanne uuendatud. Teie enda slaidid on säilinud.',
  'Rapport bijwerken': 'Värskenda aruannet',
  'Rapport gemaakt.': 'Aruanne loodud.',
  'Rapport maken': 'Loo aruanne',
  'Rapportages controleren…': 'Kontrolli aruandeid…',
  ...
  'Welke organisaties vragen aandacht?':
      'Millised organisatsioonid vajavad tähelepanu?',
  'Werkelijke meetdatums': 'Tegelikud mõõtmiskuupäevad',
  'Wie is geraakt door een CVE?': 'Keda CVE mõjutab?',
  'Zijn de metingen compleet en actueel?':
      'Kas mõõdud on täielikud ja ajakohased?',
  'bruikbaar': 'kasutatav',
  'metingen': 'mõõtmised',
  'organisaties': 'organisatsioonid',
  ...
  'USL (bovengrens)': 'USL (ülemine piir)',
  'LSL (ondergrens)': 'LSL (alumine piir)',
  'Optionele Y-01-velden': 'Valikulised Y-01 väljad',
  'Procesdoel (target)': 'Protsessi siht (target)',
  'Specificatielimieten van Y-01 (deck)': 'Y-01 spetsifikatsioonipiirid (deck)',
  'Dit deck heeft Y-01-limieten. Schakel bovenstaande schakelaar in om die te gebruiken in plaats van lokale waarden.':
      'Sellel deckil on Y-01 piirid. Lülitage ülalolev lüliti sisse, et kasutada neid kohalike väärtuste asemel.',
  'USL (bovengrens, optioneel)': 'USL (ülemine piir, valikuline)',
  ...
  'Te weinig gegevens voor een interactieplot':
      'Liiga vähe andmeid interaktsioonigraafiku jaoks',
  'DOE-proefopzet…': 'DOE kavand…',
  'DOE-proefopzet': 'DOE kavand',
  'Genereert een ontwerptabel met gecodeerde factoren (−1/+1) en een lege Y-kolom in het raster.':
      'Loob disainitabeli kodeeritud teguritega (−1/+1) ja tühja Y-veeruga ruudustikus.',
  'Aantal factoren': 'Tekijöiden määrä',
  'Volledig factorial (2^k)': 'Täysi faktoriaalinen (2^k)',
  'Fractioneel (2^(k−p))': 'Fraktsionaalne (2^(k−p))',
  'Fractie p': 'Fraktsioon p',
  'runs in standaard Yates-volgorde': 'ajot standardissa Yates-järjestyksessä',
  'In raster zetten': 'Täida ruudustik',
  'Eén reeks per factor met gecodeerde niveaus −1 en +1; laatste reeks is de respons (Y). Rijen zijn proefruns.':
      'Üks seeria teguri kohta kodeeritud tasemetega −1 ja +1; viimane seeria on vastus (Y). Read on katsesõidud.',
  'Golden-thread-id': 'Golden thread’i tunnus',
  'wordt ergens genoemd maar staat niet op een boom-dia — definieer hem op een CTQ- of Ishikawa-boom.':
      'mainitakse kuskil, kuid puu-slaidil puudub — määratlege see CTQ- või Ishikawa-puu peal.',
  ...
  'Project starten': 'Alusta projekti',
  'Procesverbetering: DMAIC-project': 'Protsesside parendamine: DMAIC projekt',
  'DMAIC-skelet met charter, CTQ-boom (Y-01), SIPOC en fase-secties.':
      'DMAIC karkass charteriga, CTQ-puuga (Y-01), SIPOC-iga ja faasi sektsioonidega.',
  'Een fasepoort-checklist: bevestig scope, stakeholders en go/no-go voordat je naar de volgende fase gaat.':
      'Faasi värava checklist: kinnita scope, huvigrupid ja go/no-go enne järgmisesse faasi liikumist.',
  'Stroom': 'Voog',
  'Zwembanen': 'Rajad',
  'Een processtroom, zwembanen of VSM. Stappen als titel :: soort :: pt=…; lt=…. Totalen (PCE, bottleneck) worden berekend, niet opgeslagen.':
      'Protsessivoog, rajad või VSM. Sammud pealkirjana :: liik :: pt=…; lt=…. Summad (PCE, bottleneck) arvutatakse ja ei salvestata.',
  'Boom': 'Puu',
  'Visgraat': 'Kalaluud',
  'Lay-out': 'Paigutus',
  'Punten': 'Punktid',
  'Inspringen': 'Taanda',
  'Uitspringen': 'Vähenda taanet',
  'Punt toevoegen': 'Lisa punkt',
  'Punt verwijderen': 'Eemalda punkt',
  'Een boom of visgraat (5× Why, CTQ, Ishikawa). Diepte met tabs; markeer oorzaken als **X-01** inline.':
      'Puu või kalaluud (5× Why, CTQ, Ishikawa). Sügavus tabidega; märgi põhjused kui **X-01** reas.',
  'Canvas': 'Lõuend',
  'Een canvas van regio\'s (A3, charter, SWOT, bord). Kies een sjabloon; de ##-koppen op schijf zijn de vakken.':
      'Piirkondade lõuend (A3, charter, SWOT, tahvel). Vali mall; kettal olevad ## pealkirjad on lahtrid.',
  'Matrix': 'Maatriks',
  'Een getypeerd raster (SIPOC, FMEA, RACI, …). Kies een sjabloon; afgeleide kolommen zoals RPN worden berekend en niet opgeslagen.':
      'Tüübistatud ruudustik (SIPOC, FMEA, RACI, …). Vali mall; tuletatud veerud nagu RPN arvutatakse ja ei salvestata.',
  'Regelkaart': 'Juhtimiskaart',
  'Histogram': 'Histogramm',
  'Pareto': 'Pareto',
  'Run chart': 'Kulgemisdiagramm',
  'Boxplot': 'Karpdiagramm',
  'Plakken uit klembord': 'Kleebi lõikelaualt',
  'Te weinig gegevens voor een regelkaart':
      'Liiga vähe andmeid juhtimiskaardi jaoks',
  'Te weinig gegevens voor een histogram':
      'Liiga vähe andmeid histogrammi jaoks',
  ...
  'De browser blokkeert media van een externe bron. Open deze presentatie in de app om online media te tonen.':
      'Brauser blokeerib välisallikast pärineva meedia. Ava see esitlus rakenduses, et võrgumeediat kuvada.',
  ...
  'Dia bevat meerdere audiofragmenten; OciDeck ondersteunt er maar één per dia.':
      'Slaid sisaldab mitut heliklippi; OciDeck toetab vaid ühte slaidi kohta.',
  'Dia bevat meerdere grafieken; OciDeck ondersteunt er maar één per dia.':
      'Slaid sisaldab mitut diagrammi; OciDeck toetab vaid ühte slaidi kohta.',
  'Dia bevat meerdere tabellen; OciDeck ondersteunt er maar één per dia.':
      'Slaid sisaldab mitut tabelit; OciDeck toetab vaid ühte slaidi kohta.',
  'Dia bevat meerdere video\'s; OciDeck ondersteunt er maar één per dia.':
      'Slaid sisaldab mitut videot; OciDeck toetab vaid ühte slaidi kohta.',
  'Dia {n} overgeslagen': 'Slaid {n} vahele jäetud',
  'Dia {n}: alleen de afbeelding overgenomen':
      'Slaid {n}: üle võeti ainult pilt',
  'Een niet-tekstuele vorm, lijn of ander object kon niet worden omgezet.':
      'Mittetekstilist kujundit, joont või muud objekti ei õnnestunud teisendada.',
  'Footerrijen worden in Markdown niet ondersteund.':
      'Jaluseridu Markdownis ei toetata.',
  'Formaat herkennen…': 'Vormingu tuvastamine…',
  'Gegroepeerde objecten zijn uitgeklapt; groepering en volgorde binnen de groep gaan verloren.':
      'Rühmitatud objektid on rühmadest lahutatud; rühmitus ja järjekord rühma sees lähevad kaotsi.',
  'Groepering': 'Rühmitamine',
  'Headerkolommen worden in OciDeck niet ondersteund.':
      'Päiseveerge OciDeckis ei toetata.',
  'IWA-objecten inlezen…': 'IWA objektide lugemine…',
  'IWA-structuur gedeeltelijk geparseerd — de vormgeving (thema, kleuren, posities) is niet overgenomen; tekst, slide-volgorde, notities en, waar de structuren herkend werden, tabellen, grafieken en media wel':
      'IWA-struktuur osaliselt parsitud — kujundust (teema, värvid, asukohad) üle ei võetud; tekst, slaidide järjekord, märkmed ja, kus struktuurid ära tunti, tabelid, diagrammid ja meedia võeti üle.',
  'IWA-structuur niet volledig geparseerd — opmaak, tabellen, grafieken, media en slide-volgorde niet overgenomen':
      'IWA-struktuuri ei parsitud täielikult — vormingut, tabeleid, diagramme, meediat ja slaidide järjekorda üle ei võetud',
  'IWA-tekst salvage…': 'IWA-teksti päästmine…',
  'Keynote IWA-intern': 'Keynote IWA sisemine',
  'Keynote IWA-intern (~{n} dia’s)': 'Keynote IWA sisemine (~{n} slaidi)',
  'Keynote tabel footer': 'Keynote\'i tabeli jalus',
  'Keynote tabel header': 'Keynote\'i tabeli päis',
  'Keynote tabel headerkolommen': 'Keynote\'i tabeli päiseveerud',
  'Klaar.': 'Valmis.',
  'Koppeling “{tekst}”': 'Link "{tekst}"',
  'Meerdere audio': 'Mitu heli',
  'Meerdere grafieken': 'Mitu diagrammi',
  'Meerdere headerrijen worden in Markdown niet ondersteund; alleen de eerste rij wordt als tabelheader gebruikt.':
      'Mitut päiserida Markdownis ei toetata; tabeli päisena kasutatakse ainult esimest rida.',
  'Meerdere tabellen': 'Mitu tabelit',
  'Meerdere video\'s': 'Mitu videot',
  'Metadata uitlezen…': 'Metaandmete lugemine…',
  'Niet overgenomen van dit document': 'Sellest dokumendist üle ei võetud',
  'Niet overgenomen van slide {n}': 'Slaidilt {n} üle ei võetud',
  'Ondersteund grafiektype': 'Toetatud diagrammitüüp',
  'Samengevoegde cellen': 'Ühendatud lahtrid',
  'Samengevoegde tabelcellen worden in GFM-tabellen niet ondersteund; de tabel is platgeklapt.':
      'Ühendatud tabelilahtreid GFM-tabelites ei toetata; tabel on lamedaks tehtud.',
  'Scatter x-as': 'Hajuvusdiagrammi x-telg',
  'Scatter-grafiek met aparte x-waardes per serie kan niet volledig worden weergegeven.':
      'Hajuvusdiagrammi, millel on iga seeria jaoks eraldi x-väärtused, ei saa täielikult kuvada.',
  'Slides classificeren…': 'Slaidide klassifitseerimine…',
  'Slides reconstrueren…': 'Slaidide taasloomine…',
  'Tabel naast grafiek': 'Tabel diagrammi kõrval',
  'Voorbeeldafbeelding zoeken…': 'Eelvaatepildi otsimine…',
  'Vorm of object': 'Kujund või objekt',
  'de tekst blijft staan, de verwijzing niet': 'tekst jääb, viide mitte',
  'deels overgenomen': 'osaliselt üle võetud',
  'doel onschadelijk gemaakt; het wees naar {url}':
      'sihtmärk kahjutuks tehtud; see osutas aadressile {url}',
  'eerste audio overgenomen': 'esimene heli võeti üle',
  'eerste grafiek overgenomen': 'esimene diagramm võeti üle',
  'eerste rij als header': 'esimene rida päisena',
  'eerste tabel overgenomen': 'esimene tabel võeti üle',
  'eerste video overgenomen': 'esimene video võeti üle',
  'gedeelde x-as gebruikt': 'kasutati ühist x-telge',
  'niet overgenomen (OciDeck heeft geen audio-slides)':
      'üle ei võetud (OciDeckil pole helislaide)',
  'niet overgenomen (deze dia werd een {type})':
      'üle ei võetud (sellest slaidist sai {type})',
  'niet overgenomen (deze dia werd een {type}, en die draagt geen opsomming)':
      'üle ei võetud (sellest slaidist sai {type}, mis täpploendit ei kanna)',
  'niet overgenomen (een {type}-dia toont er {aantal})':
      'üle ei võetud ({type}-slaid näitab neid {aantal})',
  'niet overgenomen (een {type}-dia toont geen losse alineatekst)':
      'üle ei võetud ({type}-slaid ei näita eraldiseisvat lõiguteksti)',
  'niet overgenomen (één grafiek of tabel per slide)':
      'üle ei võetud (üks diagramm või tabel slaidi kohta)',
  'objecten apart overgenomen': 'objektid võeti üle eraldi',
  'samengevoegd in leesvolgorde': 'ühendatud lugemisjärjekorras',
  'tekst, volgorde, notities en herkende tabellen, grafieken en media':
      'tekst, järjekord, märkmed ning äratuntud tabelid, diagrammid ja meedia',
  '{n} afbeelding': '{n} pilt',
  '{n} afbeeldingen': '{n} pilti',
  '{n} alinea’s': '{n} lõiku',
  '{n} opsommingspunt': '{n} täpp',
  '{n} opsommingspunten': '{n} täppi',
  '{n} vrij geplaatste tekstvakken': '{n} vabalt paigutatud tekstivälja',
  'voorbeeldafbeelding en tekst': 'eelvaatepilt ja tekst',
  'voorbeeldafbeelding': 'eelvaatepilt',
  'tekst': 'tekst',
  '{bestand} is groter dan de limiet van {limiet} en wordt niet geïmporteerd.':
      '{bestand} on suurem kui {limiet} ja seda ei impordita.',
  '{bestand} is geen herkende presentatie. OciDeck leest PowerPoint (.pptx), OpenDocument (.odp) en Keynote (.key).':
      '{bestand} ei ole äratuntud esitlus. OciDeck loeb PowerPoint (.pptx), OpenDocument (.odp) ja Keynote (.key).',
  '{bestand} lijkt beschadigd: het archief kan niet volledig worden uitgepakt.':
      '{bestand} näib olevat kahjustatud: arhiivi ei saa täielikult lahti pakkida.',
  'Het {formaat}-formaat wordt nog niet ondersteund ({bestand}).':
      'Vormingut {formaat} veel ei toetata ({bestand}).',
  'Geen dia’s gevonden in {bestand} — is dit een geldig {formaat}-bestand?':
      'Failist {bestand} ei leitud slaide — kas see on kehtiv {formaat}-fail?',
  'Kon {bestand} niet lezen als {formaat}-presentatie.':
      'Faili {bestand} ei õnnestunud lugeda {formaat}-esitlusena.',
  ...
  'Deze afbeelding naar het AI-model sturen?':
      'Kas saata see pilt tehisintellekti mudelile?',
  'De afbeelding gaat ongewijzigd naar':
      'Pilt saadetakse muutmata kujul aadressile',
  'OciDeck lakt niets weg in een afbeelding: gezichten, tekst op een schermafdruk en gegevens in beeld gaan mee.':
      'OciDeck ei redigeeri pildil midagi: näod, ekraanipildil olev tekst ja nähtavad andmed lähevad kaasa.',
  'De beeldcontrole vond hier een of meer herkenbare gezichten.':
      'Pildikontroll leidis siit ühe või mitu äratuntavat nägu.',
  'Naast de export komen twee bestanden te staan waarmee een ontvanger de redacties kan natrekken.':
      'Ekspordi kõrvale kirjutatakse kaks faili, mille abil saaja saab redigeerimised üle kontrollida.',
  ...
  '•  CVE opzoeken (staat standaard uit): staat het aan, dan gaat je zoekterm naar de ingestelde CVE-spiegel en, als die niets vindt, naar de Europese database van ENISA en naar MITRE.':
      '•  CVE otsing (vaikimisi väljas): kui see on sees, läheb teie otsingusõna määratud CVE peeglisse ja, kui see midagi ei leia, ENISA Euroopa andmebaasi ja MITRE-sse.',
  ...
  'Afbeeldingen, video en audio die je in dit tabblad koos, leven alleen in het geheugen. Een los .md-bestand bewaart ze niet — bij heropenen zijn ze weg. Exporteer als .ocideck-pakket om het beeld mee te nemen.':
      'Sellel vahekaardil valitud pildid, video ja heli asuvad ainult mälus. Tavaline .md-fail neid ei säilita — uuesti avades on need kadunud. Ekspordi .ocideck-paketina, et meedia endaga kaasa võtta.',
  ...
  'Zwakheden (CWE)': 'Nõrkused (CWE)',
  'Testgevallen (WSTG)': 'Testjuhtumid (WSTG)',
  'MIAUW-eisen': 'MIAUW nõuded',
  'CVSS-scoretabel': 'CVSS-i skooritabel',
  'Bevindingsjablonen': 'Leidude mallid',
  ...
  'AI-assistentie (staat standaard uit): kies je een zelf-gehoste of cloud-backend, dan worden de teksten of afbeeldingen die je laat verwerken naar dat adres gestuurd. Wat je hebt geredigeerd, gaat er eerst uit. Een lokaal AI-model op dit apparaat verstuurt niets.':
      'TI-abi (vaikimisi väljas): kui valid isemajutatud või pilvepõhise taustsüsteemi, saadetakse töötlemiseks antud tekstid või pildid sellele aadressile. Redigeeritu eemaldatakse enne. Kohalik TI-mudel selles seadmes ei saada midagi.',
  'Gegevens weglaten (redactie)': 'Andmete väljajätmine (redigeerimine)',
  'Zet je tekst tussen dubbele blokhaken, zoals [[het adres]], dan laat OciDeck die weg uit alles wat je toont en exporteert. Op de dia, in de presentatie, in de PDF, de PowerPoint en de HTML verschijnen alleen blokken.':
      'Pane tekst topeltnurksulgudesse, näiteks [[aadress]], ja OciDeck jätab selle välja kõigest, mida näitad ja ekspordid. Slaidil, esitluses, PDF-is, PowerPointis ja HTML-is on näha ainult plokid.',
  'Weggelaten is écht weggelaten, niet afgedekt. De tekst zit niet als onzichtbare laag onder een zwart balkje in de PDF, niet in de sprekersnotities van de PowerPoint, en niet in de broncode van de HTML. Wie het bestand openmaakt, kan er niets uit terughalen.':
      'Välja jäetud tähendab tõesti välja jäetud, mitte kinni kaetud. Tekst ei ole nähtamatu kihina musta riba all PDF-is, ei PowerPointi esineja märkmetes ega HTML-i lähtekoodis. Kes faili avab, ei saa sealt midagi kätte.',
  'Je eigen bestand verandert niet. De oorspronkelijke tekst blijft in je markdown staan; redactie geldt alleen voor wat je deelt. Zo houd je je eigen gegevens.':
      'Sinu enda fail ei muutu. Algne tekst jääb sinu markdowni; redigeerimine kehtib ainult selle kohta, mida jagad. Nii jäävad sinu andmed sinule.',
  ...
  'LibrePlan importeren': 'Impordi LibrePlanist',
  ...
  'Gantt-planning': 'Gantti ajakava',
  'WBS (hiërarchie)': 'WBS (hierarhia)',
  'Projectstatus (cockpit)': 'Projekti olek (juhtpaneel)',
  'Milestones (tijdlijn)': 'Verstapostid (ajatelg)',
  'Kritieke pad (flow)': 'Kriitiline tee (voog)',
  'Resources (tabel)': 'Ressursid (tabel)',
  'Timesheet (tabel)': 'Tööajaleht (tabel)',
  'Resourcebelasting (grafiek)': 'Ressursikoormus (diagramm)',
