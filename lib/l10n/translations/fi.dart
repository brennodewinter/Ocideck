...
const _dutchSourceAddFi = <String, String>{
  ...
  'Ctrl/Cmd+V plakt een afbeelding in het archief':
      'Ctrl/Cmd+V liittää kuvan arkistoon',
  'hoofdstukken': 'luvut',
  ...
  'Aangemaakt op': 'Luotu',
  'Aanmeldprovider': 'Kirjautumisen tarjoaja',
  'Aanmeldsessies': 'Ilmoittautumiset',
  'Aantal controles': 'Sekkien määrä',
  ...
  'Activiteitnummer': 'Toiminnan numero',
  'Afgerond op': 'Pyöristetty',
  'Afgewezen': 'Hylätty',
  'Afspeelsessienummer': 'Toistoistunnon numero',
  'Afwezig': 'Poissa',
  'Antwoordgegevens': 'Vastauksen yksityiskohdat',
  'Antwoordstatus': 'Vastauksen tila',
  'Begint op': 'Alkaa',
  'Begrippen uitgelegd': 'Käsitteet selitetty',
  'Beheer van de installatie': 'Asennuksen hallinta',
  'Beheerpogingen': 'Johdon ponnistelut',
  'Bekeken lessen': 'Oppitunnit katsottu',
  'Beleidsversie': 'Käytännön versio',
  'Beoordeeld': 'Arvioitu',
  'Beoordeeld op': 'Arvioinut',
  'Beperking': 'Rajoitus',
  'Berekend op': 'Laskettu',
  'Bericht': 'Viesti',
  'Bestandsnaam': 'Tiedostonimi',
  'Beveiligingsvraagnummer': 'Turvakysymyksen numero',
  'Bevestigd': 'Vahvistettu',
  'Bevestigd op': 'Vahvistettu',
  'Bewaarregels': 'Säilytyssäännöt',
  'Bewaartermijn': 'Säilytysaika',
  'Bewaren wegens een juridische verplichting':
      'Säilytetty lakisääteisen velvoitteen vuoksi',
  'Bewerkingnummer bij aanmeldprovider':
      'Toimintonumero rekisteröintipalvelussa',
  'Bewijsstukken': 'Todisteet',
  'Bezwaar': 'Vastalause',
  'Beëindigd op': 'Päättyi',
  'Bijeenkomstnummer': 'Kokouksen numero',
  'Certificaatnummer': 'Todistuksen numero',
  'Certificaten': 'Sertifikaatit',
  'Controlecode van de PDF': 'PDF-tiedoston ohjauskoodi',
  'Controlecode van profielfoto': 'Profiilikuvan vahvistuskoodi',
  'Controlecodes van bewijsstukken': 'Tukiasiakirjojen valvontakoodit',
  'Correctie': 'Korjaus',
  'Cursistnummer waarop de actie gericht was':
      'Opiskelijanumero, jolle toiminta oli suunnattu',
  'Cursusaanbodnummer': 'Kurssin tarjousnumero',
  'Cursusversienummer': 'Kurssin versionumero',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Päivämäärät ja ajat näytetään paikallisessa ajassasi. Tekniset nimet jäävät näkyviin, kun palvelin tarjoaa tuntemattoman kentän.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'Vastaukset, jotka annoit testikysymyksiin.',
  'Deelnamenummer': 'Osallistumisnumero',
  'Deelnames': 'Osallistumiset',
  'Details': 'Yksityiskohdat',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Tämän kategorian toimitti palvelin. Tekniset nimet pysyvät näkyvissä organisaatiosi tiedusteluille.',
  'Door uzelf aangevraagd': 'Itse pyytänyt',
  'E-mailadres': 'Sähköpostiosoite',
  'E-mailberichten': 'Sähköpostiviestit',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'Tunnus on ainutlaatuinen tekninen numero, jota eLearning käyttää tietojen linkittämiseen. Se ei ole luokitus tai tila.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'Luokka ryhmittelee tiedot samasta aiheesta. Ilmoittautuminen on yksi tallennettu tieto tai yksi tapahtuma.',
  'Eindigt op': 'Päättyy sisään',
  'Geaccepteerd op': 'Hyväksytty',
  'Geannuleerd': 'Peruutettu',
  'Gecontroleerd': 'Tarkistettu',
  'Gecontroleerd op': 'Tarkistettu',
  'Geen gegevens gevonden': 'Tietoja ei löytynyt',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Tietoja säilytysajoista ja tietojesi poistamisesta.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Tietoja todistusasiakirjoista, saavutetuista tuloksista ja todistuksista.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Tietoa tietosuojapyynnöistä ja siitä, kuka katseli tai muutti tietojasi.',
  'Gegevens over uw accountbewerking': 'Tietoja tilisi toiminnasta',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Tietoja ilmoittautumisestasi, osallistumisestasi ja oppituntien edistymisestä.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Tiedot profiilistasi, tilistäsi ja asemastasi organisaatiossa.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Tietoja koehetkistäsi ja esitetyistä kysymyksistä.',
  'Gegevens over willekeurige volgorde': 'Satunnaiset tilaustiedot',
  'Gegevenscategorie': 'Tietoluokka',
  'Gekoppeld accountnummer': 'Linkitetty tilinumero',
  'Gekozen antwoorden': 'Valitut vastaukset',
  'Gelukt': 'Menestystä',
  'Geprobeerd op': 'Kokeiltu',
  'Gerechtvaardigd belang': 'Perusteltu etu',
  'Gereserveerd': 'Varattu',
  'Gereserveerd op': 'Varattu',
  'Geslaagd': 'Läpäisty',
  'Gestart op': 'Alkoi',
  'Getoonde tijd per dia in milliseconden':
      'Diaa kohden näytettävä aika millisekunteina',
  'Herkomst van inschrijving': 'Rekisteröinnin alkuperä',
  'Hoogst haalbare score': 'Korkein mahdollinen pistemäärä',
  'Identificatienummer bij aanmeldprovider':
      'Rekisteröinnin tarjoajan tunnusnumero',
  'Identiteitsbewerkingnummer': 'Henkilöllisyysoperaationumero',
  'In afwachting': 'Odottaa',
  'In behandeling': 'Käynnissä',
  'In behandeling genomen op': 'Käsitelty',
  'In quarantaine': 'Karanteenissa',
  'Ingeleverd': 'Lähetetty',
  'Ingeleverd op': 'Lähetetty',
  'Ingericht op': 'Sisustettu päälle',
  'Ingeschreven op': 'Rekisteröity',
  'Ingetrokken': 'Peruutettu',
  'Ingetrokken op': 'Peruutettu',
  'Inschrijvingen': 'Rekisteröinnit',
  'Inschrijvingsnummer': 'Rekisteröintinumero',
  'Installatiebeveiligingslogboek': 'Asennuksen turvaloki',
  'Installatienummer': 'Asennusnumero',
  'Installatieverzoeken': 'Asennuspyynnöt',
  'Inzage': 'Tarkastus',
  'Ja': 'Kyllä',
  'Kwalificatienummer': 'Pätevyysnumero',
  'Kwalificaties': 'Pätevyydet',
  'Laatst actief op': 'Viimeksi aktiivinen päällä',
  'Laatst bekeken dia': 'Viimeksi katsottu dia',
  'Laatst gewijzigd op': 'Viimeksi muokattu',
  'Laatste fout': 'Viimeinen virhe',
  'Lesnummer': 'Oppitunnin numero',
  'Lesreserveringen': 'Oppituntien varaukset',
  'Lesvoortgang': 'Oppitunnin edistyminen',
  'Lidmaatschappen': 'Jäsenyydet',
  'Locatie': 'Sijainti',
  'Manier van afronden': 'Pyöristystapa',
  'Maximaal aantal controles': 'Sekkien enimmäismäärä',
  'Maximaal aantal pogingen': 'Yritysten enimmäismäärä',
  'Maximale leeftijd van de aanmelding': 'Ilmoittautumisen enimmäisikä',
  'Mislukt': 'Epäonnistui',
  'Naam van de activiteit': 'Aktiviteetin nimi',
  'Naam van de bijeenkomst': 'Kokouksen nimi',
  'Nee': 'Ei',
  'Netwerkadres': 'Verkko-osoite',
  'Niet actief': 'Ei aktiivinen',
  'Niet geregistreerd': 'Ei rekisteröity',
  'Niet ingevuld': 'Ei täytetty',
  'Niet verschenen': 'Ei julkaistu',
  'Niveau van extra aanmeldcontrole': 'Lisärekisteröinnin hallinnan taso',
  'Nummer van de toetsopzet': 'Testisuunnitelman numero',
  'Nummer van het brongegeven': 'Lähdetietojen numero',
  'Nummer van uw verwijderde gegeven': 'Poistettujen tietojesi lukumäärä',
  'Onderdeel {nummer}': 'Osa {nummer}',
  'Onderwerp van de actie': 'Toimenpiteen aihe',
  'Ontvanger': 'Vastaanottaja',
  'Opgegeven bestandsgrootte': 'Määritetty tiedostokoko',
  'Opgegeven bestandstype': 'Määritetty tiedostotyyppi',
  'Opgegeven controlecode': 'Määritetty ohjauskoodi',
  'Opgeslagen bestandsgrootte': 'Tallennetun tiedoston koko',
  'Opgeslagen controlecode': 'Tallennettu ohjauskoodi',
  'Organisatienummer': 'Organisaation numero',
  'Overdraagbaarheid': 'Siirrettävyys',
  'PE-toekenningnummer': 'PE-palkinnon numero',
  'Poging': 'Yritä',
  'Positie': 'asema',
  'Privacyverzoeken': 'Tietosuojapyynnöt',
  'Probeer een andere zoekterm.': 'Kokeile toista hakutermiä.',
  'Reden': 'Syy',
  'Reden of grondslag': 'Syy tai peruste',
  'Reden van afwijzing': 'Hylkäämisen syy',
  'Reden van bevestiging': 'Vahvistuksen syy',
  'Reden van intrekking': 'Peruuttamisen syy',
  'Reden voor langer bewaren': 'Syy pidempään säilytykseen',
  'Regels voor de cursusversie': 'Kurssiversion säännöt',
  'Resultaat bij de aanmeldprovider': 'Tulos rekisteröintipalvelussa',
  'Rol': 'Rullaa',
  'Score': 'Pisteet',
  'Soort aanwezigheid': 'Sellaista läsnäoloa',
  'Soort accountbewerking': 'Tilin toiminnan tyyppi',
  'Soort gebeurtenis': 'Tapahtuman tyyppi',
  'Soort privacyverzoek': 'Tietosuojapyynnön tyyppi',
  'Status van de bijeenkomst': 'Kokouksen tila',
  'Strenge beveiligingsmodus': 'Korkea suojaustila',
  'Technisch toegangslogboek': 'Tekninen pääsyloki',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Rekisteröinnin, turvallisuuden ja luotettavan käsittelyn edellyttämät tekniset tiedot.',
  'Technische naam: {naam}': 'Tekninen nimi: {naam}',
  'Technische opslagcategorie': 'Tekninen varastoluokka',
  'Technische opslaglocatie van de PDF':
      'PDF-tiedoston tekninen säilytyspaikka',
  'Tijdstip van aanmelding': 'Ilmoittautumisaika',
  'Tijdzone': 'Aikavyöhyke',
  'Toestand': 'Kunto',
  'Toetspogingen': 'Testiyritykset',
  'Toetspogingnummer': 'Testiyrityksen numero',
  'Uiterste inlevermoment': 'Lähetyksen määräaika',
  'Uitgegeven op': 'Julkaistu',
  'Uitgenodigd e-mailadres': 'Kutsuttu sähköpostiosoite',
  'Uitnodigingen': 'Kutsut',
  'Uniek nummer (ID)': 'Yksilöllinen numero (ID)',
  'Uniek verwerkingskenmerk': 'Ainutlaatuinen käsittelyominaisuus',
  'Uw accountnummer': 'Tilinumerosi',
  'Uw accountnummer als uitvoerder': 'Tilinumerosi toimeenpanijana',
  'Uzelf als uploader': 'Itsesi lataajana',
  'Vaardigheidsversienummer': 'Taidon versionumero',
  'Vast internetadres van de installatie': 'Asennuksen kiinteä internet-osoite',
  'Vastgelegde beslisgegevens': 'Tallennetut päätöstiedot',
  'Vastgelegde gegevens': 'Tallennetut tiedot',
  'Vereist niveau van aanmeldzekerheid': 'Vaadittu rekisteröintivarmuuden taso',
  'Vereiste aanmeldmethoden': 'Vaaditut kirjautumistavat',
  'Verloopt bij inactiviteit op': 'Vanhenee, kun se ei ole aktiivinen',
  'Verloopt definitief op': 'Vanhenee pysyvästi',
  'Verloopt op': 'Vanhenee',
  'Versienummer van de PE-regel': 'PE-säännön versionumero',
  'Verwerkte verzoeken': 'Käsitellyt pyynnöt',
  'Verwijderd op': 'Poistettu päällä',
  'Verwijdering': 'Poisto',
  'Verwijderingsregister': 'Poistorekisteri',
  'Verwijzing naar het antwoord': 'Viittaus vastaukseen',
  'Verzoeknummer': 'Pyydä numeroa',
  'Verzoeknummer van de app': 'Sovelluspyynnön numero',
  'Verzonden op': 'Lähetetty',
  'Volgende controle op': 'Seuraava tarkastus',
  'Volgnummer': 'Järjestysnumero',
  'Volgorde van antwoordopties': 'Vastausvaihtoehtojen järjestys',
  'Vraagnummer binnen de toetspoging': 'Kysymysnumero testiyrityksen sisällä',
  'Vraagversienummer': 'Kysymys versionumerosta',
  'Vragen in toetspogingen': 'Kysymyksiä testiyrityksissä',
  'Vrijgegeven': 'Julkaistu',
  'Vrijgegeven op': 'Julkaistu',
  'Wat gebeurt na de bewaartermijn': 'Mitä tapahtuu säilytysajan jälkeen',
  'Wettelijke verplichting': 'Laillinen velvoite',
  'Wijzigingen aan PE-punten': 'Muutoksia PE-pisteisiin',
  'Wijzigingen aan kwalificaties': 'Muutoksia pätevyyksiin',
  'Wijzigingen in aanmeldbeveiliging': 'Muutoksia kirjautumisen suojaukseen',
  'Zekerheid': 'Varmuutta',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Hae esimerkiksi kurssin, päivämäärän tai tilan mukaan',
  'Zoeken in uw gegevens': 'Hae tiedoistasi',
  '{aantal} categorieën gevonden': '{aantal} luokat löytyivät',
  'Aanwezigheid': 'Läsnäolo',
  'Lidmaatschap': 'Jäsenyys',
  'Inzage en wijzigingen': 'Pääsy ja muutokset',
  'Beschikbaarheid van het inzagespoor': 'Käyttölokin saatavuus',
  'Beschikbaar vanaf': 'Saatavilla alkaen',
  'Historie vóór deze datum': 'Historia ennen tätä päivämäärää',
  'Tijdstip': 'Päivämäärä ja aika',
  'Handeling': 'Toiminta',
  'Gegevensonderdeel': 'Tietoluokka',
  'Handelde als': 'Toiminut kuten',
  'Organisatorische rol': 'Organisatorinen rooli',
  'Bekeken': 'Katsottu',
  'Gewijzigd': 'Muutettu',
  'Uzelf': 'sinä',
  'Medewerker': 'Henkilökunnan jäsen',
  'Systeem': 'Järjestelmä',
  'Onbekend': 'Tuntematon',
  'Docent': 'Ohjaaja',
  'Beoordelaar': 'Arvioija',
  'Organisatiebeheerder': 'Organisaation ylläpitäjä',
  'Niet beschikbaar': 'Ei saatavilla',
  'Uitoefening van privacyrechten': 'Yksityisyysoikeuksien käyttäminen',
  'Beoordeling en certificering': 'Arviointi ja sertifiointi',
  'Uitvoering van het leertraject': 'Oppimisohjelman toimitus',
  'Cursistenadministratie': 'Oppijan hallinto',
  'Cursistprofiel': 'Opiskelijaprofiili',
  'Leerstatistieken': 'Tilastojen oppiminen',
  'Inschrijving': 'Ilmoittautuminen',
  'Toetspoging': 'Arviointiyritys',
  'Beoordeling': 'Arviointi',
  'Bewijsstuk': 'Todisteet',
  'Kwalificatie': 'Pätevyys',
  'Deelname': 'Osallistuminen',
  'PE-punten': 'Täydennyskoulutuspisteet',
  'Certificaat': 'Todistus',
  'Privacyverzoek': 'Tietosuojapyyntö',
  'Bewaard tot': 'Säilytetty asti',
  'Bekijk mijn gegevens': 'Näytä tietoni',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Katso, mitä tietoja eLearning on tallentanut sinusta.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Tämä yhteenveto haettiin suoraan eLearningista {datum}, eikä OciDeck tallenna sitä.',
  'Geen gegevens geregistreerd': 'Tietoja ei ole tallennettu',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'Se sisältää kaikki palvelimen tälle organisaatiolle toimittamat luokat. Lisätietoja käyttötarkoituksista, vastaanottajista, alkuperästä, säilytysajoista tai muista tietosuojaoikeuksistasi saat organisaatiolta {organisatie}.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Tietojasi ei voitu ladata. Yritä uudelleen.',
  'Meer tonen ({aantal} resterend)': 'Näytä lisää ({aantal} jäljellä)',
  'Mijn gegevens': 'Tietoni',
  'Privacy-inzage': 'Pääsy henkilötietoihin',
  'Uw geregistreerde gegevens': 'Tallennetut tietosi',
  'uw organisatie': 'organisaatiosi',
  '{aantal} registraties': '{aantal} tietuetta',
  ...
  'Deze organisatie bevat te veel lessen om veilig te tonen.':
      'Tässä organisaatiossa on liian monta oppituntia turvalliseen näyttämiseen.',
  'Er wacht nog voortgang op synchronisatie.':
      'Edistyminen odottaa yhä synkronointia.',
  'Met deze keuze wordt het vernieuwtoken in de sleutelbos bewaard. Een versleutelde wachtrij voor nog niet verstuurde voortgang wordt daar los van bewaard.':
      'Tällä valinnalla päivitystunnus tallennetaan avainnippuun. Salaattu jono vielä lähettämättömälle edistymiselle tallennetaan erikseen.',
  'Nog niet verstuurde voortgang is op dit apparaat bewaard.':
      'Vielä lähettämätön edistyminen on tallennettu tälle laitteelle.',
  'Cursist': 'Kurssilainen',
  'Les afgerond': 'Oppitunti suoritettu',
  'Cursussen voor u': 'Kursseja sinulle',
  'Ga verder waar u gebleven was, of kies een andere cursus die voor u klaarstaat.':
      'Jatka siitä, mihin jäit, tai valitse toinen sinua varten valmis kurssi.',
  'Klaar om te beginnen': 'Valmis aloittamaan',
  'Mijn cursussen': 'Omat kurssini',
  'Mijn leeromgeving': 'Oma oppimisympäristöni',
  'Mooi gedaan! Uw voortgang is bewaard.':
      'Hienoa! Edistymisesi on tallennettu.',
  'Nu bezig': 'Kesken',
  'Opnieuw starten': 'Aloita uudelleen',
  'Terug naar mijn cursussen': 'Takaisin omiin kursseihini',
  'U kunt deze cursus opnieuw bekijken.':
      'Voit käydä tämän kurssin uudelleen läpi.',
  'Volgende: {les}': 'Seuraava: {les}',
  'Welkom, {naam}': 'Tervetuloa, {naam}',
  ...
  '{afgerond} van {totaal} lessen afgerond':
      '{afgerond} / {totaal} oppituntia suoritettu',
  'Uitloggen': 'Kirjaudu ulos',
  ...
  'Klik met Ctrl/Cmd of Shift om meerdere bestanden te kiezen.':
      'Napsauta Ctrl/Cmd- tai Shift-näppäin pohjassa valitaksesi useita tiedostoja.',
  'Presentaties openen': 'Avaa esitykset',
  ...
  'Thema documentband': 'Teeman ylä-/alatunniste',
  ...
  'Met afloop wordt de pagina rondom groter dan het gekozen formaat, zodat inkt die tot de rand loopt dóór de snijlijn heen gaat. De afloop geldt voor élke export tot je hem weer op 0 zet. Laat dit op 0 voor gewoon afdrukken.':
      'Leikkuuvaran ansiosta sivu on joka puolelta valittua kokoa suurempi, jolloin reunaan asti ulottuva muste jatkuu leikkuuviivan yli. Leikkuuvara koskee jokaista vientiä, kunnes asetat sen takaisin nollaan. Jätä tämä nollaan tavallista tulostusta varten.',
  'Pagina\'s': 'Sivut',
  'Maat': 'Koko',
  'Staand': 'Pysty',
  'Liggend': 'Vaaka',
  'documenten': 'asiakirjat',
  'posters en boeken': 'julisteet ja kirjat',
  ...
  'Aanleiding, opties met kosten en baten, risico\'s en het gevraagde besluit.':
      'Tausta, vaihtoehdot kustannuksineen ja hyötyineen, riskit ja pyydetty päätös.',
  'Begroting / budgetpresentatie': 'Budjettiesittely',
  'Uitgangspunten, posten met vergelijking, keuzeruimte, risico\'s en beslispunten.':
      'Lähtökohdat, vertailtavat erät, valinnanvara, riskit ja päätöskohdat.',
  'Besluitvormend overleg': 'Päätöskokous',
  'Agenda, toelichting per punt, besluitenlijst en acties met eigenaar.':
      'Esityslista, selostus kohdittain, päätösluettelo ja toimenpiteet vastuuhenkilöineen.',
  'Ledenvergadering (ALV)': 'Yhdistyksen kokous (vuosikokous)',
  'Agenda, jaarverslag, kascommissie, begroting en stemmingen voor vereniging of VvE.':
      'Esityslista, vuosikertomus, toiminnantarkastus, talousarvio ja äänestykset yhdistykselle tai taloyhtiölle.',
  'Ouderavond / informatieavond': 'Vanhempainilta / infoilta',
  'Jaarprogramma, aanpak, praktische afspraken en hoe ouders kunnen helpen.':
      'Vuosiohjelma, toimintatapa, käytännön sopimukset ja miten vanhemmat voivat auttaa.',
  ...
  'Scenario\'s, wensen, taakverdeling en afspraken voor een zwaar familiegesprek.':
      'Skenaariot, toiveet, tehtävänjako ja sopimukset raskasta perhekeskustelua varten.',
  'Raads- / collegevoorstel': 'Esitys valtuustolle / hallitukselle',
  'Aanleiding, beslispunten, argumenten én kanttekeningen, dekking en vervolg.':
      'Tausta, päätöskohdat, perustelut ja varaumat, rahoitus ja jatkotoimet.',
  'Bewonersavond / participatiebijeenkomst': 'Asukasilta / osallisuustilaisuus',
  'Wat vaststaat en wat openligt, cijfers, reactiemogelijkheden en vervolg.':
      'Mikä on päätetty ja mikä avoinna, luvut, tavat vaikuttaa ja jatko.',
  'Sprint review / demo': 'Sprintin katselmointi / demo',
  'Sprintdoel, opgeleverd werk, demo, metrieken en vooruitblik.':
      'Sprintin tavoite, toimitettu työ, demo, mittarit ja katse eteenpäin.',
  ...
  'Object, bereikbaarheid, gevaren, kwadranten, waterwinning en taakverdeling.':
      'Kohde, saavutettavuus, vaarat, neljännekset, vedensaanti ja tehtävänjako.',
  ...
  'Voorgenomen besluit, beweegredenen, personele gevolgen en het adviestraject.':
      'Aiottu päätös, perustelut, henkilöstövaikutukset ja lausuntomenettely.',
  'Stagepresentatie': 'Harjoitteluesitys',
  'Bedrijf, opdracht, aanpak, resultaat, leerdoelen en reflectie.':
      'Yritys, toimeksianto, toimintatapa, tulos, oppimistavoitteet ja reflektio.',
  'Debriefing / after-action review': 'Jälkipuinti / after-action review',
  'Wat was gepland, wat gebeurde er, waarom — en welke afspraken maken we.':
      'Mitä oli suunniteltu, mitä tapahtui, miksi — ja mitä sovimme jatkosta.',
  'Threat modeling-sessie': 'Uhkamallinnusistunto',
  'Scope, datastromen, vertrouwensgrenzen, dreigingen per STRIDE-categorie en maatregelen.':
      'Rajaus, tietovirrat, luottamusrajat, uhat STRIDE-kategorioittain ja toimenpiteet.',
  'Casuïstiekbespreking sociaal domein': 'Tapauskäsittely sosiaalialalla',
  'Geanonimiseerde casus: leefdomeinen, veiligheid, wettelijk kader en regie.':
      'Anonymisoitu tapaus: elämänalueet, turvallisuus, lainsäädäntökehys ja koordinointi.',
  'Gesprek voorbereiden': 'Valmistele keskustelu',
  'Doel, de ander, opbouw, vragen en afspraken voor elk gesprek dat je goed wilt voorbereiden.':
      'Tavoite, toinen osapuoli, rakenne, kysymykset ja sopimukset jokaiseen keskusteluun, jonka haluat valmistella hyvin.',
  'Cruciaal gesprek voorbereiden': 'Valmistele ratkaiseva keskustelu',
  'Hoge belangen en sterke emoties, volgens de aanpak voor cruciale gesprekken.':
      'Suuret panokset ja voimakkaat tunteet, ratkaisevien keskustelujen lähestymistavan mukaan.',
  'Vluchtdebriefing': 'Lennon jälkipuinti',
  'Zelfevaluatie, verloop per fase, TEM-terugblik en leerpunten na een vlucht of les.':
      'Itsearviointi, vaiheittainen kulku, TEM-katsaus ja opit lennon tai oppitunnin jälkeen.',
  'Passagiersbriefing (kleine luchtvaart)': 'Matkustajabriefing (yleisilmailu)',
  'Gordels, deuren, noodprocedures en afspraken aan boord vóór het taxiën.':
      'Vyöt, ovet, hätämenetelmät ja sopimukset koneessa ennen rullausta.',
  ...
  'DOE-proefopzet…': 'DOE-koeasetelma…',
  'DOE-proefopzet': 'DOE-koeasetelma',
  ...
  'De browser blokkeert media van een externe bron. Open deze presentatie in de app om online media te tonen.':
      'Selain estää ulkoisesta lähteestä tulevan median. Avaa tämä esitys sovelluksessa, jotta online-media näytetään.',
  ...
  'Presentaties openen uit en opslaan naar WebDAV, S3 en git-repository’s, met versiebeheer en samenwerken via een forge. Een deel van deze paden is tot nu toe vooral tegen testomgevingen beproefd; kies dit bewust. Zonder de module werkt alles lokaal gewoon: mappen, bestanden en pakketten.':
      'Avaa esityksiä WebDAV:sta, S3:sta ja git-arkistoista ja tallenna niihin, mukana versionhallinta ja yhteistyö forgen kautta. Osa näistä poluista on toistaiseksi kokeiltu lähinnä testiympäristöjä vasten; valitse tämä tietoisesti. Ilman moduulia kaikki paikallinen toimii normaalisti: kansiot, tiedostot ja paketit.',
  'Er staan al online verbindingen ingesteld; die blijven werken, net als wachtend werk in de wachtrij. Uit betekent alleen: geen nieuwe online verbindingen toevoegen.':
      'Verkkoyhteyksiä on jo määritetty; ne toimivat edelleen, samoin kuin jonossa odottava työ. Pois tarkoittaa vain: uusia verkkoyhteyksiä ei voi lisätä.',
  ...
  'werkgeversnummer (EIN)': 'työnantajanumero (EIN)',
  'laatste vier cijfers van een SSN': 'SSN-numeron neljä viimeistä numeroa',
  ...
  'De branch is verzet; je commits staan lokaal klaar.':
      'Haara siirtyi; commitisi ovat valmiina paikallisesti.',
  'Synchroniseren mislukt.': 'Synkronointi epäonnistui.',
  ...
  'Zwakheden (CWE)': 'Heikkoudet (CWE)',
  'Testgevallen (WSTG)': 'Testitapaukset (WSTG)',
  'MIAUW-eisen': 'MIAUW-vaatimukset',
  'CVSS-scoretabel': 'CVSS-pisteytystaulukko',
  'Bevindingsjablonen': 'Havaintomallit',
  ...
  'LibrePlan-connector': 'LibrePlan-liitin',
  'De LibrePlan-connector is alleen beschikbaar in de desktopversie.':
      'LibrePlan-liitin on käytettävissä vain työpöytäversiossa.',
  'LibrePlan-connector is optioneel en staat standaard uit. Er wordt niets opgehaald totdat u dit inschakelt en zelf een server configureert. Alleen-lezen: de connector schrijft niets terug naar LibrePlan. Het wachtwoord wordt in de sleutelhanger van uw besturingssysteem opgeslagen, niet in het deck.':
      'LibrePlan-liitin on valinnainen ja oletuksena pois päältä. Mitään ei haeta, ennen kuin otat sen käyttöön ja määrität itse palvelimen. Vain luku: liitin ei kirjoita mitään takaisin LibrePlaniin. Salasana tallennetaan käyttöjärjestelmän avainnippuun, ei deckiin.',
  'Opgeslagen in de sleutelhanger': 'Tallennettu avainnippuun',
  'Alleen voor servers op het eigen netwerk (LAN). Staat plain-HTTP toe en staat privé-adressen door de NetGuard. Uitgeschakeld: HTTPS verplicht.':
      'Vain oman verkon (LAN) palvelimille. Sallii tavallisen HTTP:n ja päästää yksityiset osoitteet NetGuardin läpi. Pois päältä: HTTPS vaaditaan.',
  'Verbinding succesvol.': 'Yhteys onnistui.',
  'Onverwachte fout.': 'Odottamaton virhe.',
  'Importeren uit LibrePlan': 'Tuo LibrePlanista',
  'LibrePlan importeren': 'Tuo LibrePlanista',
  'Kies welke slides u uit het LibrePlan-project wilt halen. De import is alleen-lezen en schrijft niets terug.':
      'Valitse, mitkä diat haetaan LibrePlan-projektista. Tuonti on vain luku eikä kirjoita mitään takaisin.',
  'Gantt-planning': 'Gantt-aikataulu',
  'WBS (hiërarchie)': 'WBS (hierarkia)',
  'Projectstatus (cockpit)': 'Projektin tila (kojelauta)',
  'Milestones (tijdlijn)': 'Virstanpylväät (aikajana)',
  'Kritieke pad (flow)': 'Kriittinen polku (kulku)',
  'Resources (tabel)': 'Resurssit (taulukko)',
  'Timesheet (tabel)': 'Tuntikirjaus (taulukko)',
  'Resourcebelasting (grafiek)': 'Resurssikuormitus (kaavio)',
  'Ophalen uit LibrePlan…': 'Haetaan LibrePlanista…',
  ...
  'Vul server-URL en gebruikersnaam in.':
      'Anna palvelimen URL ja käyttäjätunnus.',
