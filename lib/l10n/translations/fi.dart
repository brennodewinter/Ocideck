...
const _dutchSourceAddFi = <String, String>{
  'OciDeck mag uw microfoon of camera niet gebruiken. Geef toestemming in uw browser of systeeminstellingen en probeer het opnieuw.':
      'OciDeck ei saa käyttää mikrofoniasi tai kameraasi. Anna lupa selaimessa tai järjestelmän asetuksissa ja yritä uudelleen.',
  'Er is geen werkende microfoon gevonden. Sluit er een aan of kies een ander apparaat.':
      'Toimivaa mikrofonia ei löytynyt. Liitä mikrofoni tai valitse toinen laite.',
  'Er is geen werkende camera gevonden. U kunt zonder beeld meedoen.':
      'Toimivaa kameraa ei löytynyt. Voit osallistua ilman kuvaa.',
  'De dienst die het toegangsbewijs afgeeft is onbereikbaar. Probeer het later opnieuw; uw presentatie blijft ondertussen gewoon open.':
      'Käyttöoikeustodisteen myöntävään palveluun ei saada yhteyttä. Yritä myöhemmin uudelleen; esityksesi pysyy sillä välin auki.',
  'De dienst die het toegangsbewijs afgeeft heeft zijn grens voor nu bereikt. Probeer het later opnieuw.':
      'Käyttöoikeustodisteen myöntävä palvelu on saavuttanut rajansa toistaiseksi. Yritä myöhemmin uudelleen.',
  'Het toegangsbewijs voor deze vergadering is verlopen. Doe opnieuw mee met dezelfde link.':
      'Tämän kokouksen käyttöoikeustodiste on vanhentunut. Osallistu uudelleen samalla linkillä.',
  'Het netwerk laat deze vergadering niet door. Op een bedrijfsnetwerk blokkeert een firewall of proxy dit soort verkeer vaak; een andere verbinding lukt meestal wel.':
      'Verkko ei päästä tätä kokousta läpi. Yritysverkossa palomuuri tai välityspalvelin estää usein tällaisen liikenteen; toinen yhteys toimii yleensä.',
  'Deze vergadering is voorbij.': 'Tämä kokous on ohi.',
  'De vergaderdienst is zelf niet beschikbaar. Dit ligt niet aan uw verbinding; probeer het later opnieuw.':
      'Kokouspalvelu itse ei ole käytettävissä. Tämä ei johdu yhteydestäsi; yritä myöhemmin uudelleen.',
  'Meedoen is niet gelukt, en de dienst zegt niet waarom. De technische code staat bij de details — probeer het opnieuw, en geef die code door als het blijft misgaan.':
      'Osallistuminen ei onnistunut, eikä palvelu kerro syytä. Tekninen koodi on tiedoissa — yritä uudelleen ja välitä koodi eteenpäin, jos vika jatkuu.',
  'Dit is geen bruikbare vergaderlink. Kopieer hem opnieuw uit de uitnodiging — een link die door een chatprogramma is afgekapt of aangepast, doet het vaak niet meer.':
      'Tämä ei ole käyttökelpoinen kokouslinkki. Kopioi se uudelleen kutsusta — linkki, jonka keskusteluohjelma on katkaissut tai muuttanut, ei useinkaan enää toimi.',
  'Deze dienst kennen we, maar dit soort vergadering niet. Webinars, uitzendingen en persoonlijke vergaderkamers werken anders dan een gewone vergadering; open deze link in de browser.':
      'Tämän palvelun tunnemme, mutta tätä kokoustyyppiä emme. Verkkoseminaarit, lähetykset ja henkilökohtaiset kokoushuoneet toimivat toisin kuin tavallinen kokous; avaa tämä linkki selaimessa.',
  'Deze vergaderdienst kennen we niet. OciDeck weet dus ook niet wat er achter deze link zit; u kunt hem in uw browser openen als u de afzender vertrouwt.':
      'Emme tunne tätä kokouspalvelua. Siksi OciDeck ei tiedä, mitä tämän linkin takana on; voit avata sen selaimessasi, jos luotat lähettäjään.',
  'Meedoen kan op deze uitvoering van OciDeck niet. Gebruik de webversie in uw browser.':
      'Tässä OciDeckin versiossa osallistuminen ei ole mahdollista. Käytä selaimessa verkkoversiota.',
  'Deze browser mist iets wat voor meedoen nodig is. Een recente Chrome, Edge, Firefox of Safari lukt doorgaans wel.':
      'Tästä selaimesta puuttuu jotain, mitä osallistuminen vaatii. Tuore Chrome, Edge, Firefox tai Safari toimii yleensä.',
  'De organisatie van deze vergadering laat geen gasten zonder account toe. Vraag de organisator om u uit te nodigen op een manier die gasten toestaat.':
      'Tämän kokouksen järjestävä organisaatio ei salli vieraita ilman tiliä. Pyydä järjestäjää kutsumaan sinut tavalla, joka sallii vieraat.',
  'Meedoen aan deze vergadering vereist een account bij de aanbieder. Open de link in uw browser en meld u daar aan.':
      'Tähän kokoukseen osallistuminen vaatii tilin palveluntarjoajalla. Avaa linkki selaimessa ja kirjaudu siellä sisään.',
  'Deze aanbieder laat alleen goedgekeurde programma\'s meedoen, en die goedkeuring is er voor OciDeck nog niet. Open de vergadering in uw browser.':
      'Tämä palveluntarjoaja päästää mukaan vain hyväksytyt ohjelmat, eikä OciDeckillä ole vielä sitä hyväksyntää. Avaa kokous selaimessa.',
  'De organisator heeft u niet toegelaten. Vraag of hij u binnenlaat en probeer het daarna opnieuw.':
      'Järjestäjä ei päästänyt sinua sisään. Pyydä päästä sisään ja yritä sen jälkeen uudelleen.',
  'Deze vergadering is op slot; er komt niemand meer bij. Vraag de organisator om het slot eraf te halen.':
      'Tämä kokous on lukittu; kukaan ei enää pääse mukaan. Pyydä järjestäjää poistamaan lukitus.',
  'Deze vergadering is eind-tot-eind versleuteld en laat daarom geen externe deelnemers toe. Dat is een keuze van de organisator; vraag hem om een gewone vergadering als u erbij moet zijn.':
      'Tämä kokous on salattu päästä päähän eikä siksi salli ulkopuolisia osallistujia. Se on järjestäjän valinta; pyydä häneltä tavallista kokousta, jos sinun on oltava mukana.',
  '{plek} krijgt contact zodra u meedoet.':
      'Palveluun {plek} otetaan yhteys heti, kun osallistut.',
  'U doet mee met alleen de naam die u zelf opgeeft; u bent niet aangemeld als die persoon.':
      'Osallistut vain sillä nimellä, jonka itse annat; et ole kirjautunut sisään kyseisenä henkilönä.',
  'De dienst maakt een tijdelijke gastidentiteit voor u, die na de vergadering verdwijnt.':
      'Palvelu luo sinulle väliaikaisen vierasidentiteetin, joka katoaa kokouksen jälkeen.',
  'U doet mee als gast onder een dienstaccount van een organisatie.':
      'Osallistut vieraana organisaation palvelutilin kautta.',
  'De organisator heeft een identiteit voor u klaargezet.':
      'Järjestäjä on valmistellut sinulle identiteetin.',
  'Meedoen gaat met uw eigen account bij deze aanbieder.':
      'Osallistut omalla tililläsi tämän palveluntarjoajan kautta.',
  'De aanbieder ziet uw netwerkgegevens en het beeld en geluid dat u verstuurt. Wat u deelt, deelt u met alle deelnemers.':
      'Palveluntarjoaja näkee verkkotietosi sekä lähettämäsi kuvan ja äänen. Sen, minkä jaat, jaat kaikille osallistujille.',
  'Het verkeer is versleuteld naar de dienst toe; de dienst zelf kan meekijken.':
      'Liikenne on salattu palveluun asti; palvelu itse voi nähdä sen.',
  'De aanbieder beheert de versleuteling en dus ook de sleutels.':
      'Palveluntarjoaja hallinnoi salausta ja siten myös avaimia.',
  'De aanbieder beschrijft dit als eind-tot-eind versleuteld.':
      'Palveluntarjoaja kuvaa tämän päästä päähän salatuksi.',
  'Over de versleuteling is niets vastgesteld. OciDeck belooft daar dus niets over.':
      'Salauksesta ei ole todettu mitään. Siksi OciDeck ei lupaa siitä mitään.',
  'U komt eerst in een wachtruimte: een organisator moet u toelaten. Uw presentatie blijft ondertussen gewoon te bewerken.':
      'Päädyt ensin odotustilaan: järjestäjän on päästettävä sinut sisään. Esitystäsi voi sillä välin muokata normaalisti.',
  'Deze vergadering vraagt om een wachtwoord.': 'Tämä kokous pyytää salasanaa.',
  'Deze vergadering vraagt om aanmelding vooraf.':
      'Tämä kokous vaatii ennakkoilmoittautumisen.',
  'Vergadering wordt voorbereid': 'Kokousta valmistellaan',
  'Verbinden met de vergadering': 'Yhdistetään kokoukseen',
  'Wachten op toelating door de organisator':
      'Odotetaan, että järjestäjä päästää sinut sisään',
  'U doet mee aan de vergadering': 'Osallistut kokoukseen',
  'De verbinding is weggevallen — opnieuw verbinden':
      'Yhteys katkesi — yhdistetään uudelleen',
  'De vergadering wordt verlaten': 'Poistutaan kokouksesta',
  'De vergadering is beëindigd': 'Kokous on päättynyt',
  'Meedoen is niet gelukt': 'Osallistuminen ei onnistunut',
  'Deze vergadering wordt opgenomen.': 'Tämä kokous tallennetaan.',
  'Deze vergadering wordt uitgeschreven.': 'Tämä kokous litteroidaan.',
  'Deze vergadering wordt opgenomen en uitgeschreven.':
      'Tämä kokous tallennetaan ja litteroidaan.',
  'De vergadering vraagt uw uitdrukkelijke toestemming om mee te blijven doen.':
      'Kokous pyytää nimenomaista suostumustasi, jotta voit jatkaa osallistumista.',
  'Een organisator moet u nog toelaten. U kunt gewoon doorwerken; zodra u binnen bent, opent het gespreksvenster zich.':
      'Järjestäjän on vielä päästettävä sinut sisään. Voit jatkaa työskentelyä rauhassa; heti kun olet sisällä, puheluikkuna avautuu.',
  'Herkend als een vergadering bij {plek}.':
      'Tunnistettu kokoukseksi palvelussa {plek}.',
  '{uitleg} De link wijst naar {plek}.':
      '{uitleg} Linkki osoittaa kohteeseen {plek}.',
  'Deze naam kiest u zelf; niemand controleert hem. De anderen zien u als gast.':
      'Valitset tämän nimen itse; kukaan ei tarkista sitä. Muut näkevät sinut vieraana.',
  'Afsluiten': 'Lopeta',
  'Camera aanzetten': 'Ota kamera käyttöön',
  'Camera uitzetten': 'Poista kamera käytöstä',
  'Microfoon aanzetten': 'Ota mikrofoni käyttöön',
  'Microfoon dempen': 'Mykistä mikrofoni',
  'Presentatie delen': 'Jaa esitys',
  'Delen stoppen': 'Lopeta jakaminen',
  'Gespreksvenster': 'Puheluikkuna',
  'Venster sluiten': 'Sulje ikkuna',
  'Meedoen': 'Osallistu',
  'Meedoen aan een onlinevergadering': 'Osallistuminen verkkokokoukseen',
  'Onlinevergadering': 'Verkkokokous',
  'Onlinevergadering…': 'Verkkokokous…',
  'Vergaderlink': 'Kokouslinkki',
  'Plak hier de link uit de uitnodiging': 'Liitä tähän kutsussa oleva linkki',
  'Uw naam, zoals de anderen die zien':
      'Nimesi sellaisena kuin muut sen näkevät',
  'Wat er gebeurt als u meedoet': 'Mitä tapahtuu, kun osallistut',
  'Verlaten': 'Poistu',
  'Weigeren en verlaten': 'Kiellä ja poistu',
  'Toestemming geven': 'Anna suostumus',
  'Technische code: {code}': 'Tekninen koodi: {code}',
  'Deelnemers ({aantal})': 'Osallistujat ({aantal})',
  'Nog geen deelnemers.': 'Ei vielä osallistujia.',
  'Deze vergadering geeft geen deelnemerslijst.':
      'Tämä kokous ei anna osallistujaluetteloa.',
  'gast': 'vieras',
  'deelnemer': 'osallistuja',
  'presentator': 'esittäjä',
  'moderator': 'moderaattori',
  'organisator': 'järjestäjä',
  'rol onbekend': 'rooli tuntematon',
  'Bord': 'Taulu',
  ...
  'Onlinevergaderingen': 'Verkkokokoukset',
  'Meedoen aan een vergadering van een andere aanbieder, met uw presentatie als wat u deelt. Standaard uit; met de module uit neemt OciDeck met geen enkele vergaderdienst contact op. Er is nog geen aanbieder aangesloten, dus meedoen kan nog niet — dit legt de basis.':
      'Osallistu toisen palveluntarjoajan kokoukseen niin, että jaat esityksesi. Oletuksena pois päältä; kun moduuli on pois päältä, OciDeck ei ota yhteyttä mihinkään kokouspalveluun. Yhtään palveluntarjoajaa ei ole vielä liitetty, joten osallistuminen ei vielä onnistu — tämä luo perustan.',
  'Er loopt een vergadering. Het gespreksvenster blijft daarom bereikbaar tot u die verlaat.':
      'Kokous on käynnissä. Puheluikkuna pysyy siksi saatavilla, kunnes poistut siitä.',
  'Er is nog geen vergaderdienst beschikbaar om aan mee te doen. Zolang dat zo is verandert deze schakelaar niets en gaat er niets naar buiten.':
      'Vielä ei ole kokouspalvelua, johon voisi osallistua. Niin kauan kuin näin on, tämä kytkin ei muuta mitään eikä mitään lähde ulos.',
  'Plak een vergaderlink om mee te doen. Wie er contact krijgt en wat die te zien krijgt, staat op het scherm voordat u meedoet.':
      'Liitä kokouslinkki osallistuaksesi. Keneen otetaan yhteyttä ja mitä tämä näkee, näkyy näytöllä ennen kuin osallistut.',
