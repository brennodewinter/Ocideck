...
const _dutchSourceDa = {
  ...
  'Auditdossier geëxporteerd naar:': 'Revisionsdossier eksporteret til:',
  ...
  'Volledige MIAUW-rapportstructuur: documentbeheer, scope, executie, managementsamenvatting, bevindingen, checklists en ondertekening.':
      'Fuld MIAUW-rapportstruktur: dokumentstyring, scope, udførelse, ledelsesresumé, fund, tjeklister og underskrift.',
  ...
  'Informatieveiligheid: RASCI / TVB': 'Informationssikkerhed: RASCI / TVB',
  'Takenplan informatieveiligheid': 'Plan for sikkerhedsopgaver',
...
const _dutchSourceAddDa = <String, String>{
  ...
  'De microfoon kon niet worden aangeschakeld':
      'Mikrofonen kunne ikke aktiveres',
  'Geef OciDeck toegang tot de microfoon in de systeeminstellingen, en controleer dat er een invoerapparaat is aangesloten.':
      'Giv OciDeck adgang til mikrofonen i systemindstillingerne, og kontrollér, at der er tilsluttet en inputenhed.',
  'Open systeeminstellingen': 'Åbn systemindstillinger',
  ...
  'Aangemaakt op': 'Oprettet den',
  'Aanmeldprovider': 'Login udbyder',
  'Aanmeldsessies': 'Registreringssessioner',
  'Aantal controles': 'Antal checks',
  ...
  'Activiteitnummer': 'Aktivitetsnummer',
  'Afgerond op': 'Afrundet til',
  'Afgewezen': 'Afvist',
  'Afspeelsessienummer': 'Afspilningssessionsnummer',
  'Afwezig': 'Fraværende',
  'Antwoordgegevens': 'Svar detaljer',
  'Antwoordstatus': 'Svarstatus',
  'Begint op': 'Starter på',
  'Begrippen uitgelegd': 'Begreber forklaret',
  'Beheer van de installatie': 'Styring af installationen',
  'Beheerpogingen': 'Ledelsesindsats',
  'Bekeken lessen': 'Lektioner set',
  'Beleidsversie': 'Politik version',
  'Beoordeeld': 'Bedømt',
  'Beoordeeld op': 'Bedømt af',
  'Beperking': 'Begrænsning',
  'Berekend op': 'Beregnet på',
  'Bericht': 'Besked',
  'Bestandsnaam': 'Filnavn',
  'Beveiligingsvraagnummer': 'Sikkerhedsspørgsmålsnummer',
  'Bevestigd': 'Bekræftet',
  'Bevestigd op': 'Bekræftet på',
  'Bewaarregels': 'Opbevaringsregler',
  'Bewaartermijn': 'Opbevaringsperiode',
  'Bewaren wegens een juridische verplichting':
      'Bevares på grund af en juridisk forpligtelse',
  'Bewerkingnummer bij aanmeldprovider':
      'Operationsnummer hos registreringsudbyder',
  'Bewijsstukken': 'Beviser',
  'Bezwaar': 'Indsigelse',
  'Beëindigd op': 'Sluttede på',
  'Bijeenkomstnummer': 'Mødenummer',
  'Certificaatnummer': 'Certifikatnummer',
  'Certificaten': 'Certifikater',
  'Controlecode van de PDF': 'Kontrolkode for PDF',
  'Controlecode van profielfoto': 'Bekræftelseskode for profilbillede',
  'Controlecodes van bewijsstukken': 'Kontrolkoder for støttedokumenter',
  'Correctie': 'Rettelse',
  'Cursistnummer waarop de actie gericht was':
      'Elevnummer, som handlingen var rettet mod',
  'Cursusaanbodnummer': 'Kursustilbudsnummer',
  'Cursusversienummer': 'Kursusversionsnummer',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Datoer og tidspunkter vises i din lokale tid. Tekniske navne forbliver synlige, når serveren leverer et ukendt felt.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'De svar, du gav på testspørgsmål.',
  'Deelnamenummer': 'Deltagelsesnummer',
  'Deelnames': 'Deltagelser',
  'Details': 'Detaljer',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Denne kategori blev leveret af serveren. De tekniske navne forbliver synlige for henvendelser fra din organisation.',
  'Door uzelf aangevraagd': 'Forespurgt af dig selv',
  'E-mailadres': 'E-mailadresse',
  'E-mailberichten': 'E-mail beskeder',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'Et ID er et unikt teknisk nummer, som eLearning bruger til at linke data sammen. Det er ikke en vurdering eller status.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'En kategori grupperer data om det samme emne. En registrering er én gemt data eller én hændelse.',
  'Eindigt op': 'Ender i',
  'Geaccepteerd op': 'Accepteret den',
  'Geannuleerd': 'Annulleret',
  'Gecontroleerd': 'Tjekket',
  'Gecontroleerd op': 'Tjekket på',
  'Geen gegevens gevonden': 'Ingen data fundet',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Oplysninger om opbevaringsperioder og sletning af dine data.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Oplysninger om understøttende dokumenter, opnåede resultater og certifikater.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Oplysninger om anmodninger om privatliv og hvem der har set eller ændret dine oplysninger.',
  'Gegevens over uw accountbewerking': 'Oplysninger om din kontodrift',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Oplysninger om din tilmelding, deltagelse og fremskridt i undervisningen.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Oplysninger om din profil, konto og position i organisationen.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Information om dine testøjeblikke og de stillede spørgsmål.',
  'Gegevens over willekeurige volgorde': 'Tilfældige ordredata',
  'Gegevenscategorie': 'Datakategori',
  'Gekoppeld accountnummer': 'Tilknyttet kontonummer',
  'Gekozen antwoorden': 'Udvalgte svar',
  'Gelukt': 'Succes',
  'Geprobeerd op': 'Prøvede på',
  'Gerechtvaardigd belang': 'Berettiget interesse',
  'Gereserveerd': 'Reserveret',
  'Gereserveerd op': 'Reserveret på',
  'Geslaagd': 'Bestået',
  'Gestart op': 'Startede på',
  'Getoonde tijd per dia in milliseconden': 'Tid vist pr. dias i millisekunder',
  'Herkomst van inschrijving': 'Oprindelse af registrering',
  'Hoogst haalbare score': 'Højest mulige score',
  'Identificatienummer bij aanmeldprovider':
      'Identifikationsnummer for registreringsudbyder',
  'Identiteitsbewerkingnummer': 'Identitetsoperationsnummer',
  'In afwachting': 'Afventer',
  'In behandeling': 'I gang',
  'In behandeling genomen op': 'Behandlet på',
  'In quarantaine': 'I karantæne',
  'Ingeleverd': 'Indsendt',
  'Ingeleverd op': 'Indsendt den',
  'Ingericht op': 'Dekoreret på',
  'Ingeschreven op': 'Registreret d',
  'Ingetrokken': 'Tilbagetrukket',
  'Ingetrokken op': 'Tilbagetrukket den',
  'Inschrijvingen': 'Registreringer',
  'Inschrijvingsnummer': 'Registreringsnummer',
  'Installatiebeveiligingslogboek': 'Installationssikkerhedslog',
  'Installatienummer': 'Installationsnummer',
  'Installatieverzoeken': 'Installationsanmodninger',
  'Inzage': 'Inspektion',
  'Ja': 'Ja',
  'Kwalificatienummer': 'Kvalifikationsnummer',
  'Kwalificaties': 'Kvalifikationer',
  'Laatst actief op': 'Sidst aktiv den',
  'Laatst bekeken dia': 'Sidst set dias',
  'Laatst gewijzigd op': 'Sidst ændret den',
  'Laatste fout': 'Sidste fejl',
  'Lesnummer': 'Lektionsnummer',
  'Lesreserveringen': 'Lektionsforbehold',
  'Lesvoortgang': 'Lektionens fremskridt',
  'Lidmaatschappen': 'Medlemskaber',
  'Locatie': 'Beliggenhed',
  'Manier van afronden': 'Måde at afrunde på',
  'Maximaal aantal controles': 'Maksimalt antal checks',
  'Maximaal aantal pogingen': 'Maksimalt antal forsøg',
  'Maximale leeftijd van de aanmelding': 'Maksimal alder for registrering',
  'Mislukt': 'Mislykkedes',
  'Naam van de activiteit': 'Navn på aktiviteten',
  'Naam van de bijeenkomst': 'Mødets navn',
  'Nee': 'Nej',
  'Netwerkadres': 'Netværksadresse',
  'Niet actief': 'Ikke aktiv',
  'Niet geregistreerd': 'Ikke registreret',
  'Niet ingevuld': 'Ikke udfyldt',
  'Niet verschenen': 'Ikke offentliggjort',
  'Niveau van extra aanmeldcontrole':
      'Niveau af yderligere registreringskontrol',
  'Nummer van de toetsopzet': 'Nummer på testplanen',
  'Nummer van het brongegeven': 'Nummer på kildedata',
  'Nummer van uw verwijderde gegeven': 'Nummer på dine slettede data',
  'Onderdeel {nummer}': 'Del {nummer}',
  'Onderwerp van de actie': 'Sagens genstand',
  'Ontvanger': 'Modtager',
  'Opgegeven bestandsgrootte': 'Angivet filstørrelse',
  'Opgegeven bestandstype': 'Specificeret filtype',
  'Opgegeven controlecode': 'Specificeret kontrolkode',
  'Opgeslagen bestandsgrootte': 'Gemt filstørrelse',
  'Opgeslagen controlecode': 'Gemt kontrolkode',
  'Organisatienummer': 'Organisationsnummer',
  'Overdraagbaarheid': 'Overførbarhed',
  'PE-toekenningnummer': 'PE tildelingsnummer',
  'Poging': 'Forsøg',
  'Positie': 'Stilling',
  'Privacyverzoeken': 'Anmodninger om beskyttelse af personlige oplysninger',
  'Probeer een andere zoekterm.': 'Prøv en anden søgeterm.',
  'Reden': 'Årsag',
  'Reden of grondslag': 'Grund eller grundlag',
  'Reden van afwijzing': 'Årsag til afvisning',
  'Reden van bevestiging': 'Begrundelse for bekræftelse',
  'Reden van intrekking': 'Årsag til tilbagetrækning',
  'Reden voor langer bewaren': 'Grund til længere opbevaring',
  'Regels voor de cursusversie': 'Regler for kursusversionen',
  'Resultaat bij de aanmeldprovider': 'Resultat hos registreringsudbyderen',
  'Rol': 'Rul',
  'Score': 'Score',
  'Soort aanwezigheid': 'En slags tilstedeværelse',
  'Soort accountbewerking': 'Type kontooperation',
  'Soort gebeurtenis': 'Type begivenhed',
  'Soort privacyverzoek': 'Type for anmodning om privatliv',
  'Status van de bijeenkomst': 'Status på mødet',
  'Strenge beveiligingsmodus': 'Høj sikkerhedstilstand',
  'Technisch toegangslogboek': 'Teknisk adgangslog',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Tekniske data, der kræves til registrering, sikkerhed og pålidelig behandling.',
  'Technische naam: {naam}': 'Teknisk navn: {naam}',
  'Technische opslagcategorie': 'Teknisk opbevaringskategori',
  'Technische opslaglocatie van de PDF': 'Teknisk opbevaringssted for PDF\'en',
  'Tijdstip van aanmelding': 'Tidspunkt for registrering',
  'Tijdzone': 'Tidszone',
  'Toestand': 'Tilstand',
  'Toetspogingen': 'Testforsøg',
  'Toetspogingnummer': 'Testforsøgsnummer',
  'Uiterste inlevermoment': 'Deadline for aflevering',
  'Uitgegeven op': 'Udgivet den',
  'Uitgenodigd e-mailadres': 'Inviteret e-mailadresse',
  'Uitnodigingen': 'Invitationer',
  'Uniek nummer (ID)': 'Unikt nummer (ID)',
  'Uniek verwerkingskenmerk': 'Unik behandlingsfunktion',
  'Uw accountnummer': 'Dit kontonummer',
  'Uw accountnummer als uitvoerder': 'Dit kontonummer som bobestyrer',
  'Uzelf als uploader': 'Dig selv som uploader',
  'Vaardigheidsversienummer': 'Skill versionsnummer',
  'Vast internetadres van de installatie':
      'Fast internetadresse på installationen',
  'Vastgelegde beslisgegevens': 'Registrerede beslutningsdata',
  'Vastgelegde gegevens': 'Registrerede data',
  'Vereist niveau van aanmeldzekerheid':
      'Påkrævet niveau af registreringssikkerhed',
  'Vereiste aanmeldmethoden': 'Påkrævede login-metoder',
  'Verloopt bij inactiviteit op': 'Udløber, når den er inaktiv',
  'Verloopt definitief op': 'Udløber permanent',
  'Verloopt op': 'Udløber',
  'Versienummer van de PE-regel': 'PE-reglens versionsnummer',
  'Verwerkte verzoeken': 'Behandlede anmodninger',
  'Verwijderd op': 'Fjernet på',
  'Verwijdering': 'Fjernelse',
  'Verwijderingsregister': 'Fjernelsesregister',
  'Verwijzing naar het antwoord': 'Henvisning til svaret',
  'Verzoeknummer': 'Anmodningsnummer',
  'Verzoeknummer van de app': 'Appens anmodningsnummer',
  'Verzonden op': 'Sendt videre',
  'Volgende controle op': 'Næste tjek',
  'Volgnummer': 'Sekvensnummer',
  'Volgorde van antwoordopties': 'Rækkefølge af svarmuligheder',
  'Vraagnummer binnen de toetspoging': 'Spørgsmålsnummer i testforsøget',
  'Vraagversienummer': 'Spørgsmålets versionsnummer',
  'Vragen in toetspogingen': 'Spørgsmål i testforsøg',
  'Vrijgegeven': 'Udgivet',
  'Vrijgegeven op': 'Udgivet den',
  'Wat gebeurt na de bewaartermijn': 'Hvad sker der efter opbevaringsperioden',
  'Wettelijke verplichting': 'Lovlig forpligtelse',
  'Wijzigingen aan PE-punten': 'Ændringer til PE-punkter',
  'Wijzigingen aan kwalificaties': 'Ændringer i kvalifikationer',
  'Wijzigingen in aanmeldbeveiliging': 'Ændringer i login-sikkerhed',
  'Zekerheid': 'Sikkerhed',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Søg for eksempel på kursus, dato eller status',
  'Zoeken in uw gegevens': 'Søg i dine data',
  '{aantal} categorieën gevonden': '{aantal} kategorier fundet',
  'Aanwezigheid': 'Fremmøde',
  'Lidmaatschap': 'Medlemskab',
  'Inzage en wijzigingen': 'Adgang og ændringer',
  'Beschikbaarheid van het inzagespoor': 'Adgangsloggens tilgængelighed',
  'Beschikbaar vanaf': 'Tilgængelig fra',
  'Historie vóór deze datum': 'Historie før denne dato',
  'Tijdstip': 'Dato og tid',
  'Handeling': 'Handling',
  'Gegevensonderdeel': 'Datakategori',
  'Handelde als': 'Fungerede som',
  'Organisatorische rol': 'Organisatorisk rolle',
  'Bekeken': 'Set',
  'Gewijzigd': 'Ændret',
  'Uzelf': 'Dig',
  ...
  'Organisatiebeheerder': 'Organisationsadministrator',
  'Niet beschikbaar': 'Ikke tilgængelig',
  'Uitoefening van privacyrechten': 'Udøvelse af privatlivets fred',
  'Beoordeling en certificering': 'Vurdering og certificering',
  'Uitvoering van het leertraject': 'Levering af læringsprogrammet',
  'Cursistenadministratie': 'Elevadministration',
  'Cursistprofiel': 'Lærerprofil',
  'Leerstatistieken': 'Læringsstatistik',
  'Inschrijving': 'Tilmelding',
  'Toetspoging': 'Vurderingsforsøg',
  'Beoordeling': 'Vurdering',
  'Bewijsstuk': 'Beviser',
  'Kwalificatie': 'Kvalifikation',
  'Deelname': 'Deltagelse',
  'PE-punten': 'Efteruddannelsespoint',
  'Certificaat': 'Certifikat',
  'Privacyverzoek': 'Anmodning om beskyttelse af personlige oplysninger',
  'Bewaard tot': 'Bevares indtil',
  'Bekijk mijn gegevens': 'Se mine data',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Se, hvilke data eLearning har registreret om dig.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Denne oversigt blev hentet direkte fra eLearning den {datum} og gemmes ikke af OciDeck.',
  'Geen gegevens geregistreerd': 'Ingen data registreret',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'Den indeholder alle kategorier, som serveren har leveret for denne organisation. Kontakt {organisatie} for oplysninger om formål, modtagere, oprindelse, opbevaringsperioder eller dine øvrige rettigheder til privatliv.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Dine data kunne ikke indlæses. Prøv igen.',
  'Meer tonen ({aantal} resterend)': 'Vis flere ({aantal} tilbage)',
  'Mijn gegevens': 'Mine data',
  'Privacy-inzage': 'Indsigt i persondata',
  'Uw geregistreerde gegevens': 'Dine registrerede data',
  'uw organisatie': 'din organisation',
  '{aantal} registraties': '{aantal} registreringer',
  ...
  'Deze organisatie bevat te veel lessen om veilig te tonen.':
      'Denne organisation indeholder for mange lektioner til at blive vist sikkert.',
  'Er wacht nog voortgang op synchronisatie.':
      'Fremskridt venter stadig på synkronisering.',
  'Met deze keuze wordt het vernieuwtoken in de sleutelbos bewaard. Een versleutelde wachtrij voor nog niet verstuurde voortgang wordt daar los van bewaard.':
      'Med dette valg gemmes opdateringstokenet i nøgleringen. En krypteret kø for fremskridt, der endnu ikke er sendt, gemmes separat.',
  'Nog niet verstuurde voortgang is op dit apparaat bewaard.':
      'Fremskridt, der endnu ikke er sendt, er gemt på denne enhed.',
  'Cursist': 'Kursist',
  'Les afgerond': 'Lektion gennemført',
  'Cursussen voor u': 'Kurser til dig',
  'Ga verder waar u gebleven was, of kies een andere cursus die voor u klaarstaat.':
      'Fortsæt, hvor du slap, eller vælg et andet kursus, der er klar til dig.',
  'Klaar om te beginnen': 'Klar til at begynde',
  'Mijn cursussen': 'Mine kurser',
  'Mijn leeromgeving': 'Mit læringsmiljø',
  'Mooi gedaan! Uw voortgang is bewaard.':
      'Godt gået! Dine fremskridt er gemt.',
  'Nu bezig': 'I gang',
  'Opnieuw starten': 'Start igen',
  'Terug naar mijn cursussen': 'Tilbage til mine kurser',
  'U kunt deze cursus opnieuw bekijken.': 'Du kan gennemgå dette kursus igen.',
  'Volgende: {les}': 'Næste: {les}',
  'Welkom, {naam}': 'Velkommen, {naam}',
  ...
  '{afgerond} van {totaal} lessen afgerond':
      '{afgerond} af {totaal} lektioner fuldført',
  'Uitloggen': 'Log ud',
  ...
  '{n} tabellen passen niet op de bladbreedte, ook niet op de kleinste letter.':
      '{n} tabeller passer ikke til sidebredden, heller ikke ved mindste skriftstørrelse.',
  'Lange woorden en waarden zoals hashes of IP-adressen zijn daardoor middenin afgebroken.':
      'Lange ord og værdier som hash eller IP-adresser er derfor brudt midt over.',
  ...
  'Thema documentband': 'Tema side-/bundtekst',
  ...
  'Sluit één of meer OpenKAT-omgevingen aan (bijvoorbeeld productie en acceptatie). OciDeck toont beschikbare rapportages; de inhoud haalt u binnen via een JSON-export uit OpenKAT.':
      'Tilslut et eller flere OpenKAT-miljøer (f.eks. produktion og accept). OciDeck viser tilgængelige rapporter; indholdet hentes via et JSON-eksport fra OpenKAT.',
  'Server toevoegen…': 'Tilføj server…',
  'Rapportage van server…': 'Rapport fra server…',
  'Nog geen OpenKAT-server aangesloten.':
      'Ingen OpenKAT-server tilsluttet endnu.',
  'Bezig…': 'Arbejder…',
  'OpenKAT-server bewerken': 'Rediger OpenKAT-server',
  'OpenKAT-server toevoegen': 'Tilføj OpenKAT-server',
  'OpenKAT-server toevoegen…': 'Tilføj OpenKAT-server…',
  'OpenKAT-server verwijderen?': 'Fjern OpenKAT-server?',
  'Dit verwijdert “{name}” en het bijbehorende toegangstoken van dit apparaat. Dat kunt u niet ongedaan maken.':
      'Dette fjerner “{name}” og det tilhørende adgangstoken fra denne enhed. Det kan ikke fortrydes.',
  'Weergavenaam': 'Visningsnavn',
  'Bijvoorbeeld Productie of Acceptatie': 'F.eks. Produktion eller Accept',
  'Adres van OpenKAT': 'OpenKAT-adresse',
  'Verbinding met: {host}': 'Forbindelse til: {host}',
  'Eigen netwerk (LAN)': 'Lokalt netværk (LAN)',
  'Alleen voor OpenKAT op het eigen netwerk. Staat HTTP toe en laat privé-adressen toe. Uitgeschakeld: alleen HTTPS.':
      'Kun til OpenKAT på det lokale netværk. Tillader HTTP og private adresser. Fra: kun HTTPS.',
  'Toegangstoken': 'Adgangstoken',
  'Laat leeg om het opgeslagen token te behouden':
      'Lad stå tom for at beholde det gemte token',
  'Plak het token hier': 'Indsæt token her',
  'Vraag uw OpenKAT-beheerder om een API-token in het beheerdersscherm. Het token blijft op dit apparaat, in de sleutelhanger van uw besturingssysteem — niet in het deck.':
      'Bed din OpenKAT-administrator om et API-token i admin-skærmen. Tokenet bliver på denne enhed, i operativsystemets nøglering — ikke i decket.',
  'Verbinding wordt getest…': 'Tester forbindelse…',
  'Test de verbinding voordat u opslaat, zodat u weet dat naam, adres en token kloppen.':
      'Test forbindelsen før du gemmer, så du ved at navn, adresse og token er korrekte.',
  'De OpenKAT-koppeling is alleen beschikbaar in de desktopversie.':
      'OpenKAT-forbindelsen er kun tilgængelig i desktopversionen.',
  'Lees OpenKAT-rapportages in als één managementoverzicht — vanuit een map of vanaf een server.':
      'Indlæs OpenKAT-rapporter som ét managementoverblik — fra en mappe eller en server.',
  'Er staat al een OpenKAT-bron ingesteld; de koppeling blijft daarom bereikbaar, zodat een bestaand OpenKAT-deck bij te werken blijft.':
      'Der er allerede konfigureret en OpenKAT-kilde; forbindelsen forbliver tilgængelig, så et eksisterende OpenKAT-deck kan opdateres.',
  'Rapportage van OpenKAT-server': 'Rapport fra OpenKAT-server',
  'Rapportage van OpenKAT-server…': 'Rapport fra OpenKAT-server…',
  'Server: {name}': 'Server: {name}',
  'Organisaties worden opgehaald…': 'Henter organisationer…',
  'Rapportages worden opgehaald…': 'Henter rapporter…',
  'Er zijn geen organisaties zichtbaar voor dit token. Vraag uw beheerder om toegang, of kies een andere server.':
      'Ingen organisationer er synlige for dette token. Bed din administrator om adgang, eller vælg en anden server.',
  'Er staan geen organisatierapportages klaar op deze server. Maak in OpenKAT eerst een aggregaat-organisatierapport, of kies een andere organisatie.':
      'Der er ingen organisationsrapporter klar på denne server. Opret først en samlet organisationsrapport i OpenKAT, eller vælg en anden organisation.',
  'JSON-export uit OpenKAT': 'JSON-eksport fra OpenKAT',
  'OpenKAT levert de rapportage-inhoud als JSON-bestand. Exporteer in OpenKAT het gekozen rapport als JSON, en wijs dat bestand of de map hieraan.':
      'OpenKAT leverer rapportindholdet som JSON-fil. Eksporter den valgte rapport som JSON i OpenKAT, og peg på den fil eller mappe her.',
  'Gekozen: {reportName} · {orgName} · {serverName}':
      'Valgt: {reportName} · {orgName} · {serverName}',
  'JSON-bestand kiezen…': 'Vælg JSON-fil…',
  'Map met exports kiezen…': 'Vælg eksportmappe…',
  'Vul een weergavenaam in, bijvoorbeeld Productie.':
      'Indtast et visningsnavn, f.eks. Produktion.',
  'Vul een weergavenaam en een adres in.':
      'Indtast et visningsnavn og en adresse.',
  'Plak een toegangstoken om verder te gaan.':
      'Indsæt et adgangstoken for at fortsætte.',
  'Vul een adres in, bijvoorbeeld https://openkat.voorbeeld.nl':
      'Indtast en adresse, f.eks. https://openkat.voorbeeld.nl',
  'Dit adres is niet geldig. Controleer of u een volledige URL heeft ingevuld.':
      'Denne adresse er ikke gyldig. Kontroller, at du har indtastet en fuld URL.',
  'Het adres moet met https:// beginnen, of zet Eigen netwerk aan voor HTTP op het eigen netwerk.':
      'Adressen skal starte med https://, eller slå Lokalt netværk til for HTTP på det lokale netværk.',
  'Verbonden met {host}. Er zijn nog geen organisaties zichtbaar voor dit token.':
      'Forbundet til {host}. Ingen organisationer er synlige for dette token endnu.',
  'Verbonden met {host}. {n} organisatie(s) bereikbaar.':
      'Forbundet til {host}. {n} organisation(er) tilgængelige.',
  'De verbinding met OpenKAT is mislukt. Controleer het adres en uw netwerk, en probeer opnieuw.':
      'Forbindelsen til OpenKAT mislykkedes. Kontroller adressen og dit netværk, og prøv igen.',
  'Er is geen toegangstoken. Plak het token van uw beheerder en probeer opnieuw.':
      'Intet adgangstoken. Indsæt tokenet fra din administrator, og prøv igen.',
  'Alleen HTTPS is toegestaan, tenzij Eigen netwerk aan staat.':
      'Kun HTTPS er tilladt, medmindre Lokalt netværk er slået til.',
  'OpenKAT weigerde het token. Vraag uw beheerder om een geldig API-token en plak het opnieuw.':
      'OpenKAT afviste tokenet. Bed din administrator om et gyldigt API-token, og indsæt det igen.',
  'OpenKAT reageerde niet op tijd. Controleer of de server bereikbaar is en probeer opnieuw.':
      'OpenKAT svarede ikke i tide. Kontroller at serveren er tilgængelig, og prøv igen.',
  'Dit adres is niet bereikbaar. Controleer de spelling van de hostnaam en of u op het juiste netwerk zit.':
      'Denne adresse er ikke tilgængelig. Kontroller stavningen af værtsnavnet og at du er på det rigtige netværk.',
  'OpenKAT gaf een onverwacht groot antwoord. Probeer later opnieuw of vraag uw beheerder om hulp.':
      'OpenKAT returnerede et uventet stort svar. Prøv igen senere, eller bed din administrator om hjælp.',
  'Verbonden': 'Forbundet',
  'Token ontbreekt': 'Token mangler',
  'Laatst gecontroleerd mislukt': 'Seneste kontrol mislykkedes',
  'Nog niet gecontroleerd': 'Endnu ikke kontrolleret',
  ...
  'Dit is een presentatie, geen Markdown-bestand. Zet de module Importeren aan om hem om te zetten naar een deck.':
      'Dette er en præsentation, ikke en Markdown-fil. Slå modulet Importer til for at konvertere den til et deck.',
  'De zwakhedenlijst (78): id, titel, MASVS-categorie, platform, de CWE-koppeling en een korte omschrijving. Plus een brug van de oude beta-nummering (tot 0119) naar de canonieke id\'s, zodat de MASTG-kruiskoppeling blijft kloppen.':
      'Listen over svagheder (78): id, titel, MASVS-kategori, platform, CWE-koblingen og en kort beskrivelse. Plus en bro fra den gamle beta-nummerering (op til 0119) til de kanoniske id\'er, så MASTG-krydshenvisningen stadig passer.',
  ...
  'Media-stack testen': 'Test mediestakken',
  'De media-stack werkt op dit apparaat.':
      'Mediestakken fungerer på denne enhed.',
  'De media-stack kon niet laden op dit apparaat.':
      'Mediestakken kunne ikke indlæses på denne enhed.',
  'Media-versleuteling (E2EE): uit op dit platform.':
      'Mediekryptering (E2EE): slået fra på denne platform.',
  'Media-versleuteling (E2EE): nog niet beschikbaar.':
      'Mediekryptering (E2EE): endnu ikke tilgængelig.',
  'Media-versleuteling (E2EE): aan.': 'Mediekryptering (E2EE): slået til.',
  ...
  'Vergelijk organisaties en breng portfolio-aandachtspunten in beeld.':
      'Sammenlign organisationer og identificer porteføljepunkter af interesse.',
  'Bekijk de actuele stand of aantoonbare veranderingen bij één organisatie.':
      'Se den aktuelle status eller påviselige ændringer i én organisation.',
  'Onderzoek betrouwbare CVE-koppelingen in de gekozen metingen.':
      'Undersøg pålidelige CVE-links i de valgte målinger.',
  'Leg vast welke metingen en bronbestanden het rapport werkelijk gebruikt.':
      'Registrer hvilke målinger og kildefiler rapporten rent faktisk bruger.',
  'Wat is het managementbeeld over de gekozen organisaties?':
      'Hvad er ledelsessynet for de valgte organisationer?',
  'Waar worden de meeste en minste findings waargenomen?':
      'Hvor er de fleste og mindste fund observeret?',
  'Hoe ontwikkelt het portfolio zich over de tijd?':
      'Hvordan udvikler porteføljen sig over tid?',
  'Welke problemen komen bij de meeste organisaties voor?':
      'Hvilke problemer opstår i de fleste organisationer?',
  'Waar concentreren de ernstigste findings zich?':
      'Hvor er de mest alvorlige fund koncentreret?',
  'Welke controls lopen achter?': 'Hvilke kontroller halter bagefter?',
  'Welke maatregelen adviseert OpenKAT het vaakst?':
      'Hvilke tiltag anbefaler OpenKAT oftest?',
  'Hoe staat deze organisatie er nu voor?':
      'Hvad er den aktuelle status for denne organisation?',
  'Wat veranderde er sinds de vorige meting?':
      'Hvad har ændret sig siden den forrige måling?',
  'Welke findings zijn nieuw of niet meer waargenomen?':
      'Hvilke fund er nye eller ikke længere observeret?',
  'Welke findings staan het langst open?': 'Hvilke fund har været åbne længst?',
  'Op welke systemen worden de meeste findings waargenomen?':
      'På hvilke systemer er de fleste fund observeret?',
  'Welke systemen verbeterden of verslechterden?':
      'Hvilke systemer er blevet forbedret eller forringet?',
  'Welke controls verbeterden of verslechterden?':
      'Hvilke kontroller blev forbedret eller forringet?',
  'Welke systemen zijn in de metingen opgenomen?':
      'Hvilke systemer indgår i målingerne?',
  'Welke assets zijn aantoonbaar in monitoring?':
      'Hvilke aktiver kan påvises ved overvågning?',
  'Welke monitoringstatussen veranderden?':
      'Hvilke overvågningsstatusser ændrede sig?',
  'Wie is geraakt door deze CVE?': 'Hvem er berørt af denne CVE?',
  'Welke CVE’s raken de meeste organisaties?':
      'Hvilke CVE\'er påvirker de fleste organisationer?',
  'Welke CVE’s zijn nieuw of niet meer waargenomen?':
      'Hvilke CVE\'er er nye eller observeres ikke længere?',
  ...
  'Nog niet beschikbaar: niet iedere finding heeft een betrouwbare eerste waarnemingsdatum.':
      'Ikke tilgængelig endnu: Ikke alle fund har en pålidelig dato for første observation.',
  'Nog niet beschikbaar: de bron bewijst geen stabiele identiteit voor alle findings.':
      'Endnu ikke tilgængelig: Kilden beviser ikke en stabil identitet for alle fund.',
  'Nog niet beschikbaar: vergelijkbare meetdekking is niet aangetoond.':
      'Endnu ikke tilgængelig: sammenlignelig målingsdækning er ikke blevet påvist.',
  'Nog niet beschikbaar: betrouwbare controlnoemers ontbreken.':
      'Ikke tilgængelig endnu: pålidelige kontrolnævnere mangler.',
  'Nog niet beschikbaar: stabiele assetidentiteit is niet aangetoond.':
      'Endnu ikke tilgængelig: stabil aktividentitet er ikke blevet påvist.',
  'Dit rapport ondersteunt de gekozen organisatiescope niet.':
      'Denne rapport understøtter ikke det valgte organisatoriske omfang.',
  'De gekozen bron bevat niet genoeg betrouwbare gegevens voor dit rapport.':
      'Den valgte kilde indeholder ikke nok pålidelige data til denne rapport.',
  'Kerncijfers en gemeten bereik': 'Nøgletal og målt rækkevidde',
  'Organisaties vergelijken': 'Sammenlign organisationer',
  'Concentratie van critical/high findings':
      'Koncentration af kritiske/høje fund',
  'Portfolioverloop per meetmoment': 'Porteføljeoversigt pr. målemoment',
  'Meest voorkomende findingtypen': 'Mest almindelige fundtyper',
  'Bron- en meetverantwoording': 'Kilde- og måleansvar',
  'Nieuwe en niet meer waargenomen findings':
      'Nye og ikke længere observerede fund',
  'Langst waargenomen findings': 'Længst observerede fund',
  'Systemen met de meeste findings': 'Systemer med flest resultater',
  'Veranderingen per systeem': 'Ændringer pr system',
  'Blootstelling aan één CVE': 'Eksponering for én CVE',
  'CVE’s over organisaties': 'CVE\'er om organisationer',
  'Nieuwe en niet meer waargenomen CVE’s':
      'Nye og ikke længere observerede CVE\'er',
  'Controldekking': 'Kontrol dækning',
  'Controlveranderingen': 'Kontrol ændringer',
  'Aanbevelingen uit OpenKAT': 'Anbefalinger fra OpenKAT',
  'Assetinventaris': 'Aktivbeholdning',
  'Monitoringdekking': 'Overvågning af dækning',
  'Actueel organisatiebeeld': 'Aktuelt organisationsbillede',
  'Kies eerst het onderwerp en daarna de vraag die het rapport moet beantwoorden.':
      'Vælg først emnet og derefter det spørgsmål, som rapporten skal besvare.',
  'Onderwerp': 'Emne',
  ...
  'De browser blokkeert media van een externe bron. Open deze presentatie in de app om online media te tonen.':
      'Browseren blokerer medier fra en ekstern kilde. Åbn denne præsentation i appen for at vise onlinemedier.',
  ...
  'Dia bevat meerdere audiofragmenten; OciDeck ondersteunt er maar één per dia.':
      'Diaset indeholder flere lydklip; OciDeck understøtter kun ét pr. dias.',
  'Dia bevat meerdere grafieken; OciDeck ondersteunt er maar één per dia.':
      'Diaset indeholder flere diagrammer; OciDeck understøtter kun ét pr. dias.',
  'Dia bevat meerdere tabellen; OciDeck ondersteunt er maar één per dia.':
      'Diaset indeholder flere tabeller; OciDeck understøtter kun én pr. dias.',
  'Dia bevat meerdere video\'s; OciDeck ondersteunt er maar één per dia.':
      'Diaset indeholder flere videoer; OciDeck understøtter kun én pr. dias.',
  'Dia {n} overgeslagen': 'Dias {n} sprunget over',
  'Dia {n}: alleen de afbeelding overgenomen':
      'Dias {n}: kun billedet blev overført',
  'Een niet-tekstuele vorm, lijn of ander object kon niet worden omgezet.':
      'En ikke-tekstuel figur, linje eller andet objekt kunne ikke konverteres.',
  'Footerrijen worden in Markdown niet ondersteund.':
      'Sidefodsrækker understøttes ikke i Markdown.',
  'Formaat herkennen…': 'Registrerer format…',
  'Gegroepeerde objecten zijn uitgeklapt; groepering en volgorde binnen de groep gaan verloren.':
      'Grupperede objekter er blevet opdelt; gruppering og rækkefølge i gruppen går tabt.',
  'Groepering': 'Gruppering',
  'Headerkolommen worden in OciDeck niet ondersteund.':
      'Overskriftskolonner understøttes ikke i OciDeck.',
  'IWA-objecten inlezen…': 'Læser IWA-objekter…',
  'IWA-structuur gedeeltelijk geparseerd — de vormgeving (thema, kleuren, posities) is niet overgenomen; tekst, slide-volgorde, notities en, waar de structuren herkend werden, tabellen, grafieken en media wel':
      'IWA-strukturen blev delvist fortolket — udformningen (tema, farver, positioner) blev ikke overført; tekst, diasrækkefølge, noter og, hvor strukturerne blev genkendt, tabeller, diagrammer og medier blev.',
  'IWA-structuur niet volledig geparseerd — opmaak, tabellen, grafieken, media en slide-volgorde niet overgenomen':
      'IWA-strukturen blev ikke fuldt fortolket — formatering, tabeller, diagrammer, medier og diasrækkefølge blev ikke overført',
  'IWA-tekst salvage…': 'Redder IWA-tekst…',
  'Keynote IWA-intern': 'Keynote IWA-internt',
  'Keynote IWA-intern (~{n} dia’s)': 'Keynote IWA-internt (~{n} dias)',
  'Keynote tabel footer': 'Keynote-tabelsidefod',
  'Keynote tabel header': 'Keynote-tabeloverskrift',
  'Keynote tabel headerkolommen': 'Keynote-tabeloverskriftskolonner',
  'Klaar.': 'Færdig.',
  'Koppeling “{tekst}”': 'Link "{tekst}"',
  'Meerdere audio': 'Flere lydfiler',
  'Meerdere grafieken': 'Flere diagrammer',
  'Meerdere headerrijen worden in Markdown niet ondersteund; alleen de eerste rij wordt als tabelheader gebruikt.':
      'Flere overskriftsrækker understøttes ikke i Markdown; kun den første række bruges som tabeloverskrift.',
  'Meerdere tabellen': 'Flere tabeller',
  'Meerdere video\'s': 'Flere videoer',
  'Metadata uitlezen…': 'Læser metadata…',
  'Niet overgenomen van dit document': 'Ikke overført fra dette dokument',
  'Niet overgenomen van slide {n}': 'Ikke overført fra dias {n}',
  'Ondersteund grafiektype': 'Understøttet diagramtype',
  'Samengevoegde cellen': 'Flettede celler',
  'Samengevoegde tabelcellen worden in GFM-tabellen niet ondersteund; de tabel is platgeklapt.':
      'Flettede tabelceller understøttes ikke i GFM-tabeller; tabellen er blevet fladet ud.',
  'Scatter x-as': 'Punktdiagrammets x-akse',
  'Scatter-grafiek met aparte x-waardes per serie kan niet volledig worden weergegeven.':
      'Et punktdiagram med separate x-værdier pr. serie kan ikke vises fuldt ud.',
  'Slides classificeren…': 'Klassificerer dias…',
  'Slides reconstrueren…': 'Rekonstruerer dias…',
  'Tabel naast grafiek': 'Tabel ved siden af diagram',
  'Voorbeeldafbeelding zoeken…': 'Søger efter forhåndsvisningsbillede…',
  'Vorm of object': 'Figur eller objekt',
  'de tekst blijft staan, de verwijzing niet':
      'teksten bliver, henvisningen ikke',
  'deels overgenomen': 'delvist overført',
  'doel onschadelijk gemaakt; het wees naar {url}':
      'målet uskadeliggjort; det pegede på {url}',
  'eerste audio overgenomen': 'første lyd overført',
  'eerste grafiek overgenomen': 'første diagram overført',
  'eerste rij als header': 'første række som overskrift',
  'eerste tabel overgenomen': 'første tabel overført',
  'eerste video overgenomen': 'første video overført',
  'gedeelde x-as gebruikt': 'fælles x-akse brugt',
  'niet overgenomen (OciDeck heeft geen audio-slides)':
      'ikke overført (OciDeck har ingen lyddias)',
  'niet overgenomen (deze dia werd een {type})':
      'ikke overført (dette dias blev til en {type})',
  'niet overgenomen (deze dia werd een {type}, en die draagt geen opsomming)':
      'ikke overført (dette dias blev til en {type}, som ikke har en punktliste)',
  'niet overgenomen (een {type}-dia toont er {aantal})':
      'ikke overført (et {type}-dias viser {aantal})',
  'niet overgenomen (een {type}-dia toont geen losse alineatekst)':
      'ikke overført (et {type}-dias viser ikke løs afsnitstekst)',
  'niet overgenomen (één grafiek of tabel per slide)':
      'ikke overført (ét diagram eller én tabel pr. dias)',
  'objecten apart overgenomen': 'objekter overført enkeltvis',
  'samengevoegd in leesvolgorde': 'sammenføjet i læserækkefølge',
  'tekst, volgorde, notities en herkende tabellen, grafieken en media':
      'tekst, rækkefølge, noter og genkendte tabeller, diagrammer og medier',
  '{n} afbeelding': '{n} billede',
  '{n} afbeeldingen': '{n} billeder',
  '{n} alinea’s': '{n} afsnit',
  '{n} opsommingspunt': '{n} punkt',
  '{n} opsommingspunten': '{n} punkter',
  '{n} vrij geplaatste tekstvakken': '{n} frit placerede tekstfelter',
  'voorbeeldafbeelding en tekst': 'forhåndsvisningsbillede og tekst',
  'voorbeeldafbeelding': 'forhåndsvisningsbillede',
  'tekst': 'tekst',
  '{bestand} is groter dan de limiet van {limiet} en wordt niet geïmporteerd.':
      '{bestand} er større end grænsen på {limiet} og importeres ikke.',
  '{bestand} is geen herkende presentatie. OciDeck leest PowerPoint (.pptx), OpenDocument (.odp) en Keynote (.key).':
      '{bestand} er ikke en genkendt præsentation. OciDeck læser PowerPoint (.pptx), OpenDocument (.odp) og Keynote (.key).',
  '{bestand} lijkt beschadigd: het archief kan niet volledig worden uitgepakt.':
      '{bestand} ser ud til at være beskadiget: arkivet kan ikke pakkes helt ud.',
  'Het {formaat}-formaat wordt nog niet ondersteund ({bestand}).':
      'Formatet {formaat} understøttes endnu ikke ({bestand}).',
  'Geen dia’s gevonden in {bestand} — is dit een geldig {formaat}-bestand?':
      'Ingen dias fundet i {bestand} — er dette en gyldig {formaat}-fil?',
  'Kon {bestand} niet lezen als {formaat}-presentatie.':
      '{bestand} kunne ikke læses som en {formaat}-præsentation.',
  ...
  'OciDeck zelf staat onder de EUPL-1.2. Daarnaast bundelt het software van derden: de Dart- en Flutter-pakketten, twee gevendorde pakketten, vijf lettertypefamilies, het gezichtsmodel voor de privacycontrole en de JavaScript die in een HTML-export meegaat. Elk daarvan houdt zijn eigen licentie.':
      'OciDeck selv er udgivet under EUPL-1.2. Derudover samler det tredjepartssoftware: Dart- og Flutter-pakkerne, to medfølgende pakker, fire skriftfamilier, ansigtsmodellen til privatlivskontrollen og den JavaScript, der følger med en HTML-eksport. Hver af dem beholder sin egen licens.',
  ...
  'Het token heeft lees- en schrijfrechten op de repository nodig. Gitea en Forgejo kennen geen server-side zoeken; OciDeck zoekt lokaal.':
      'Tokenet skal have læse- og skriveadgang til lageret. Gitea og Forgejo har ingen søgning på serveren; OciDeck søger lokalt.',
  'Het token heeft de repo-scope nodig (of fijnmazig: Contents lezen en schrijven).':
      'Tokenet skal have repo-scope (eller finkornet: Contents læse og skrive).',
  'Het token heeft read_repository, write_repository en read_api nodig. Server-side zoeken vereist Advanced- of Exact Search.':
      'Tokenet skal have read_repository, write_repository og read_api. Søgning på serveren kræver Advanced eller Exact Search.',
  'Snelle server-zoekopdracht — door indexeringsvertraging kan een net gewijzigd deck ontbreken.':
      'Hurtig søgning på serveren — på grund af indekseringsforsinkelse kan et netop ændret deck mangle.',
  ...
  'werkgeversnummer (EIN)': 'arbejdsgivernummer (EIN)',
  'laatste vier cijfers van een SSN': 'sidste fire cifre i et SSN',
  ...
  'Je bent aangemeld, maar hebt hier geen toegang. Je wachtwoord is niet het probleem — vraag de beheerder om rechten op deze map.':
      'Du er logget ind, men har ikke adgang her. Din adgangskode er ikke problemet — bed administratoren om rettigheder til denne mappe.',
  'Je token is geldig, maar mag dit niet. Geef het meer rechten, of wacht als de forge een limiet oplegt.':
      'Dit token er gyldigt, men må ikke dette. Giv det flere rettigheder, eller vent, hvis forgen sætter en grænse.',
  ...
  'IMSI van een abonnee': 'IMSI på en abonnent',
  'sociale-mediaprofiel': 'profil på sociale medier',
  'advertentie- of apparaat-ID': 'annonce- eller enheds-id',
  'IP-adres': 'IP-adresse',
  ...
  'Gebruikte hulpmiddelen': 'Anvendte værktøjer',
  'Hulpmiddel': 'Værktøj',
  'Referentie': 'Reference',
  'Eén per regel, bijv. Burp Suite@2026.4 | https://portswigger.net | Webproxy':
      'Ét pr. linje, f.eks. Burp Suite@2026.4 | https://portswigger.net | Webproxy',
  'Nog geen hulpmiddelen vastgelegd — vul ze in bij Presentatie-info.':
      'Ingen værktøjer registreret endnu — angiv dem under Præsentationsinfo.',
  'Bijlage met hulpmiddelen toegevoegd.': 'Bilag med værktøjer tilføjet.',
  'Bijlage toegevoegd, maar niet elk hulpmiddel heeft beschrijving, versie én referentie:':
      'Bilag tilføjet, men ikke alle værktøjer har beskrivelse, version og reference:',
  ...
  'Rapportagetaal': 'Rapportsprog',
  'Niet vastgelegd': 'Ikke angivet',
  ...
  'Stijlprofiel importeren': 'Importér stilprofil',
  ...
  'Dit is geen geldig stijlprofiel-bestand':
      'Dette er ikke en gyldig stilprofil-fil',
  'Dit bestand is te groot voor een stijlprofiel':
      'Denne fil er for stor til en stilprofil',
  ...
  'Eén per regel: je naam, e-mailadres, telefoonnummer of het domein van je organisatie. Wat hier staat wordt niet gemeld en niet geredigeerd — het is de afzender, geen bevinding. Een domein (example.org) dekt elk adres eronder.':
      'Ét pr. linje: dit navn, din e-mailadresse, dit telefonnummer eller din organisations domæne. Det, der står her, rapporteres ikke og redigeres ikke bort — det er afsenderen, ikke et fund. Et domæne (example.org) dækker enhver adresse under det.',
  ...
  'Zwakheden (CWE)': 'Svagheder (CWE)',
  'Testgevallen (WSTG)': 'Testtilfælde (WSTG)',
  'MIAUW-eisen': 'MIAUW-krav',
  'CVSS-scoretabel': 'CVSS-scoretabel',
  'Bevindingsjablonen': 'Fundskabeloner',
  ...
  'De TSA-handtekening is niet in-app geverifieerd; alleen de hash komt overeen.':
      'TSA-signaturen verificeres ikke i appen; kun hashen stemmer.',
  'Extern': 'Ekstern',
  ...
  'Alle scope-objecten hebben al een checklist':
      'Alle scope-objekter har allerede en tjekliste',
  'Maakt per scope-object een checklist (WSTG voor web/API); bestaande blijven staan.':
      'Opretter en tjekliste pr. scope-objekt (WSTG til web/API); eksisterende bevares.',
  ...
  'LibrePlan-connector': 'LibrePlan-konnektor',
  'De LibrePlan-connector is alleen beschikbaar in de desktopversie.':
      'LibrePlan-konnektoren er kun tilgængelig i skrivebordsversionen.',
  'LibrePlan-connector is optioneel en staat standaard uit. Er wordt niets opgehaald totdat u dit inschakelt en zelf een server configureert. Alleen-lezen: de connector schrijft niets terug naar LibrePlan. Het wachtwoord wordt in de sleutelhanger van uw besturingssysteem opgeslagen, niet in het deck.':
      'LibrePlan-konnektoren er valgfri og slået fra som standard. Der hentes intet, før du slår den til og selv opsætter en server. Skrivebeskyttet: konnektoren skriver intet tilbage til LibrePlan. Adgangskoden gemmes i operativsystemets nøglering, ikke i decket.',
  'Opgeslagen in de sleutelhanger': 'Gemt i nøgleringen',
  'Alleen voor servers op het eigen netwerk (LAN). Staat plain-HTTP toe en staat privé-adressen door de NetGuard. Uitgeschakeld: HTTPS verplicht.':
      'Kun til servere på dit eget netværk (LAN). Tillader almindelig HTTP og lader private adresser passere NetGuard. Slået fra: HTTPS er påkrævet.',
  'Verbinding succesvol.': 'Forbindelsen lykkedes.',
  'Onverwachte fout.': 'Uventet fejl.',
  'Importeren uit LibrePlan': 'Importér fra LibrePlan',
  'LibrePlan importeren': 'Importér fra LibrePlan',
  'Kies welke slides u uit het LibrePlan-project wilt halen. De import is alleen-lezen en schrijft niets terug.':
      'Vælg hvilke slides du vil hente fra LibrePlan-projektet. Importen er skrivebeskyttet og skriver intet tilbage.',
  'Gantt-planning': 'Gantt-plan',
  'WBS (hiërarchie)': 'WBS (hierarki)',
  'Projectstatus (cockpit)': 'Projektstatus (cockpit)',
  'Milestones (tijdlijn)': 'Milepæle (tidslinje)',
  'Kritieke pad (flow)': 'Kritisk vej (flow)',
  'Resources (tabel)': 'Ressourcer (tabel)',
  'Timesheet (tabel)': 'Timeseddel (tabel)',
  'Resourcebelasting (grafiek)': 'Ressourcebelastning (diagram)',
  'Ophalen uit LibrePlan…': 'Henter fra LibrePlan…',
