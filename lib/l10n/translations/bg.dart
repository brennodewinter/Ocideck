...
const _dutchSourceBg = {
  ...
  'Audio': 'Аудио',
  'Bijschrift': 'Надпис',
  'Bron citaat': 'Източник на цитата',
  'Codetaal': 'Език на кода',
  'Geen zichtbare verschillen — de slides zijn inhoudelijk gelijk.':
      'Няма видими разлики — слайдовете са идентични по съдържание.',
  'In meerdere presentaties': 'В няколко презентации',
  'Kop kolom 1': 'Заглавие на колона 1',
  'Kop kolom 2': 'Заглавие на колона 2',
  'Lijststijl': 'Стил на списъка',
  'Notities': 'Бележки',
  'Tweede bijschrift': 'Втори надпис',
  'Tweede opsomming': 'Втори списък',
  'Vergelijk met:': 'Сравни с:',
  'Verschillen': 'Разлики',
  'Verschillen tussen slides': 'Разлики между слайдовете',
  'duplica(a)t(en) verborgen': 'дубликати скрити',
  'slides — verfijn je zoekopdracht': 'слайда — прецизирайте търсенето си',
  'unieke slide(s)': 'уникални слайда',
  ...
  '"Oci" verwijst naar de ocicat, het kattenras van de katten van Brenno de Winter. "Deck" is het Engelse woord voor een diaset. OciDeck maakt van eenvoudige tekst een verzorgde presentatie.':
      '"Oci" препраща към оцикотката, породата на котките на Brenno de Winter. "Deck" е английската дума за набор от слайдове. OciDeck превръща обикновен текст в изящна презентация.',
  'Adressen': 'Адреси',
  'Bestuur': 'Управителен съвет',
  'Beveiliging': 'Сигурност',
  'Brenno de Winter (voorzitter), Jan Klopper (secretaris) en Astrid Oosenbrug (penningmeester).':
      'Brenno de Winter (председател), Jan Klopper (секретар) и Astrid Oosenbrug (касиер).',
  'Contact': 'Контакт',
  'De katten van Brenno': 'Котките на Brenno',
  ...
  'Mascotte van de checklisttool.':
      'Талисман на инструмента за контролни списъци.',
  'OciDeck wordt uitgegeven door Stichting LibreKAT. De stichting werkt aan een veiligere digitale samenleving via open, controleerbare informatiebeveiliging, met de nadruk op kennisdeling, community-vorming en het ondersteunen van opensource-oplossingen.':
      'OciDeck се издава от Stichting LibreKAT. Фондацията работи за по-сигурно цифрово общество чрез открита, проверяема информационна сигурност, с акцент върху споделянето на знания, изграждането на общност и подкрепата за решения с отворен код.',
  'Over OciDeck': 'Относно OciDeck',
  'Telefoon': 'Телефон',
  'Uitgever: Stichting LibreKAT': 'Издател: Stichting LibreKAT',
  ...
  'Actualiteiten, aandachtsvestigingen, bijzonderheden, onderhoud en bezetting voor de beveiligingsdienst.':
      'Актуални събития, обръщане на внимание, особености, поддръжка и заетост за охранителната служба.',
  'Operationele politiebriefing': 'Оперативен полицейски инструктаж',
  'Actualiteiten, hotspots, signaleringen, opdrachten, eigen veiligheid en gebiedsinzet voor de dienst.':
      'Актуални събития, горещи точки, обявления за издирване, задачи, лична безопасност и разполагане по райони за смяната.',
...
const _dutchSourceAddBg = <String, String>{
  ...
  'OciDeck vraagt dan maximaal eenmaal per dag aan pawprint.vigilis.online of er een nieuwere versie is.':
      'OciDeck тогава пита най-много веднъж дневно pawprint.vigilis.online дали има по-нова версия.',
  'Controleer nu': 'Провери сега',
  'De controle is mislukt — probeer het later opnieuw.':
      'Проверката не успя — опитайте отново по-късно.',
  'Er is geen nieuwere versie.': 'Няма по-нова версия.',
  'OciDeck {versie} is beschikbaar.': 'OciDeck {versie} е наличен.',
  'Download': 'Изтегли',
  'OciDeck {versie} is beschikbaar — tik om de releasepagina te openen.':
      'OciDeck {versie} е наличен — докоснете, за да отворите страницата на изданието.',
  ...
  'De microfoon kon niet worden aangeschakeld':
      'Микрофонът не можа да бъде включен',
  'Geef OciDeck toegang tot de microfoon in de systeeminstellingen, en controleer dat er een invoerapparaat is aangesloten.':
      'Разрешете на OciDeck достъп до микрофона в системните настройки и проверете дали е свързано входно устройство.',
  'Open systeeminstellingen': 'Отвори системните настройки',
  ...
  'PDF/A en digitale handtekeningen blijven zichtbaar. OciDeck controleert de handtekening niet.':
      'PDF/A и цифровите подписи остават видими. OciDeck не валидира подписа.',
  ...
  'Aangemaakt op': 'Създаден на',
  'Aanmeldprovider': 'Доставчик на вход',
  'Aanmeldsessies': 'Регистрационни сесии',
  'Aantal controles': 'Брой проверки',
  ...
  'Activiteitnummer': 'Номер на дейността',
  'Afgerond op': 'Закръглено до',
  'Afgewezen': 'Отхвърлено',
  'Afspeelsessienummer': 'Номер на сесията за възпроизвеждане',
  'Afwezig': 'отсъства',
  'Antwoordgegevens': 'Подробности за отговора',
  'Antwoordstatus': 'Състояние на отговора',
  'Begint op': 'Започва на',
  'Begrippen uitgelegd': 'Обяснени понятия',
  'Beheer van de installatie': 'Управление на инсталацията',
  'Beheerpogingen': 'Управленски усилия',
  'Bekeken lessen': 'Прегледани уроци',
  'Beleidsversie': 'Версия на правилата',
  'Beoordeeld': 'Оценен',
  'Beoordeeld op': 'Оценено от',
  'Beperking': 'Ограничение',
  'Berekend op': 'Изчислено на',
  'Bericht': 'Съобщение',
  'Bestandsnaam': 'Име на файл',
  'Beveiligingsvraagnummer': 'Номер на въпроса за сигурност',
  'Bevestigd': 'Потвърдено',
  'Bevestigd op': 'Потвърдено на',
  'Bewaarregels': 'Правила за задържане',
  'Bewaartermijn': 'Период на задържане',
  'Bewaren wegens een juridische verplichting':
      'Задържа се поради законово задължение',
  'Bewerkingnummer bij aanmeldprovider':
      'Номер на операция при доставчика на регистрация',
  'Bewijsstukken': 'Доказателство',
  'Bezwaar': 'Възражение',
  'Beëindigd op': 'Приключи на',
  'Bijeenkomstnummer': 'Номер на срещата',
  'Certificaatnummer': 'Номер на сертификата',
  'Certificaten': 'Сертификати',
  'Controlecode van de PDF': 'Контролен код на pdf',
  'Controlecode van profielfoto': 'Код за потвърждение на профилна снимка',
  'Controlecodes van bewijsstukken':
      'Контролни кодове на оправдателни документи',
  'Correctie': 'Корекция',
  'Cursistnummer waarop de actie gericht was':
      'Студентски номер, към който е насочена акцията',
  'Cursusaanbodnummer': 'Номер на офертата за курс',
  'Cursusversienummer': 'Номер на версията на курса',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Датите и часовете се показват във вашето местно време. Техническите имена остават видими, когато сървърът предостави неизвестно поле.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'Отговорите, които сте дали на тестови въпроси.',
  'Deelnamenummer': 'Номер на участие',
  'Deelnames': 'Участия',
  'Details': 'Подробности',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Тази категория е предоставена от сървъра. Техническите имена остават видими за запитвания от вашата организация.',
  'Door uzelf aangevraagd': 'Поискано от вас',
  'E-mailadres': 'Имейл адрес',
  'E-mailberichten': 'Имейл съобщения',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'ID е уникален технически номер, който eLearning използва за свързване на данни. Това не е рейтинг или статус.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'Категория групира данни по една и съща тема. Регистрацията е една запазена част от данните или едно събитие.',
  'Eindigt op': 'Завършва в',
  'Geaccepteerd op': 'Прието на',
  'Geannuleerd': 'Отменено',
  'Gecontroleerd': 'Проверено',
  'Gecontroleerd op': 'Проверено на',
  'Geen gegevens gevonden': 'Няма намерени данни',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Информация относно периодите на съхранение и изтриването на вашите данни.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Информация за оправдателни документи, постигнати резултати и сертификати.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Информация относно исканията за поверителност и кой е преглеждал или променял вашата информация.',
  'Gegevens over uw accountbewerking':
      'Информация за операцията по вашия акаунт',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Информация за вашата регистрация, участие и напредък в уроците.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Информация за вашия профил, акаунт и позиция в организацията.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Информация за вашите тестови моменти и представените въпроси.',
  'Gegevens over willekeurige volgorde': 'Данни за случаен ред',
  'Gegevenscategorie': 'Категория данни',
  'Gekoppeld accountnummer': 'Номер на свързан акаунт',
  'Gekozen antwoorden': 'Избрани отговори',
  'Gelukt': 'Успех',
  'Geprobeerd op': 'Пробвано',
  'Gerechtvaardigd belang': 'Легитимен интерес',
  'Gereserveerd': 'Запазено',
  'Gereserveerd op': 'Запазено на',
  'Geslaagd': 'премина',
  'Gestart op': 'Започна на',
  'Getoonde tijd per dia in milliseconden':
      'Показано време на слайд в милисекунди',
  'Herkomst van inschrijving': 'Произход на регистрация',
  'Hoogst haalbare score': 'Най-високият възможен резултат',
  'Identificatienummer bij aanmeldprovider':
      'Идентификационен номер за доставчика на регистрация',
  'Identiteitsbewerkingnummer': 'Идентификационен номер на операция',
  'In afwachting': 'В очакване',
  'In behandeling': 'В ход',
  'In behandeling genomen op': 'Обработено на',
  'In quarantaine': 'В карантина',
  'Ingeleverd': 'Изпратено',
  'Ingeleverd op': 'Изпратено на',
  'Ingericht op': 'Украсен на',
  'Ingeschreven op': 'Регистриран на',
  'Ingetrokken': 'Изтеглено',
  'Ingetrokken op': 'Изтеглено на',
  'Inschrijvingen': 'Регистрации',
  'Inschrijvingsnummer': 'Регистрационен номер',
  'Installatiebeveiligingslogboek': 'Дневник за сигурност на инсталацията',
  'Installatienummer': 'Инсталационен номер',
  'Installatieverzoeken': 'Заявки за инсталиране',
  'Inzage': 'инспекция',
  'Ja': 'да',
  'Kwalificatienummer': 'Квалификационен номер',
  'Kwalificaties': 'Квалификации',
  'Laatst actief op': 'Последно активно на',
  'Laatst bekeken dia': 'Последно гледан слайд',
  'Laatst gewijzigd op': 'Последна промяна на',
  'Laatste fout': 'Последна грешка',
  'Lesnummer': 'Номер на урока',
  'Lesreserveringen': 'Резервации за уроци',
  'Lesvoortgang': 'Напредък на урока',
  'Lidmaatschappen': 'Членство',
  'Locatie': 'Местоположение',
  'Manier van afronden': 'Начин на закръгляване',
  'Maximaal aantal controles': 'Максимален брой проверки',
  'Maximaal aantal pogingen': 'Максимален брой опити',
  'Maximale leeftijd van de aanmelding': 'Максимална възраст за регистрация',
  'Mislukt': 'Неуспешно',
  'Naam van de activiteit': 'Име на дейността',
  'Naam van de bijeenkomst': 'Име на срещата',
  'Nee': 'не',
  'Netwerkadres': 'Мрежов адрес',
  'Niet actief': 'Не е активно',
  'Niet geregistreerd': 'Не е регистриран',
  'Niet ingevuld': 'Не е попълнено',
  'Niet verschenen': 'Не е публикувано',
  'Niveau van extra aanmeldcontrole':
      'Ниво на допълнителен регистрационен контрол',
  'Nummer van de toetsopzet': 'Номер на тестовия план',
  'Nummer van het brongegeven': 'Номер на изходните данни',
  'Nummer van uw verwijderde gegeven': 'Брой на вашите изтрити данни',
  'Onderdeel {nummer}': 'Част {nummer}',
  'Onderwerp van de actie': 'Предмет на действието',
  'Ontvanger': 'Получател',
  'Opgegeven bestandsgrootte': 'Посочен размер на файла',
  'Opgegeven bestandstype': 'Посочен тип файл',
  'Opgegeven controlecode': 'Посочен контролен код',
  'Opgeslagen bestandsgrootte': 'Запазен размер на файла',
  'Opgeslagen controlecode': 'Съхранен контролен код',
  'Organisatienummer': 'Номер на организацията',
  'Overdraagbaarheid': 'Преносимост',
  'PE-toekenningnummer': 'Номер на наградата PE',
  'Poging': 'опит',
  'Positie': 'Позиция',
  'Privacyverzoeken': 'Искания за поверителност',
  'Probeer een andere zoekterm.': 'Опитайте с друга дума за търсене.',
  'Reden': 'Причина',
  'Reden of grondslag': 'Причина или основание',
  'Reden van afwijzing': 'Причина за отказ',
  'Reden van bevestiging': 'Причина за потвърждение',
  'Reden van intrekking': 'Причина за оттегляне',
  'Reden voor langer bewaren': 'Причина за по-продължително съхранение',
  'Regels voor de cursusversie': 'Правила за версията на курса',
  'Resultaat bij de aanmeldprovider': 'Резултат при доставчика на регистрация',
  'Rol': 'Руло',
  'Score': 'резултат',
  'Soort aanwezigheid': 'Вид присъствие',
  'Soort accountbewerking': 'Тип операция по сметката',
  'Soort gebeurtenis': 'Тип събитие',
  'Soort privacyverzoek': 'Тип заявка за поверителност',
  'Status van de bijeenkomst': 'Статус на срещата',
  'Strenge beveiligingsmodus': 'Режим на висока сигурност',
  'Technisch toegangslogboek': 'Дневник за технически достъп',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Технически данни, необходими за регистрация, сигурност и надеждна обработка.',
  'Technische naam: {naam}': 'Техническо наименование: {naam}',
  'Technische opslagcategorie': 'Категория за техническо съхранение',
  'Technische opslaglocatie van de PDF':
      'Техническо място за съхранение на PDF',
  'Tijdstip van aanmelding': 'Време на регистрация',
  'Tijdzone': 'Часова зона',
  'Toestand': 'Състояние',
  'Toetspogingen': 'Тестови опити',
  'Toetspogingnummer': 'Номер на опита за тест',
  'Uiterste inlevermoment': 'Краен срок за подаване',
  'Uitgegeven op': 'Публикувано на',
  'Uitgenodigd e-mailadres': 'Поканен имейл адрес',
  'Uitnodigingen': 'Покани',
  'Uniek nummer (ID)': 'Уникален номер (ID)',
  'Uniek verwerkingskenmerk': 'Уникална функция за обработка',
  'Uw accountnummer': 'Номерът на вашата сметка',
  'Uw accountnummer als uitvoerder': 'Номерът на вашата сметка като изпълнител',
  'Uzelf als uploader': 'Себе си като качил',
  'Vaardigheidsversienummer': 'Номер на версията на уменията',
  'Vast internetadres van de installatie':
      'Фиксиран интернет адрес на инсталацията',
  'Vastgelegde beslisgegevens': 'Записани данни за решение',
  'Vastgelegde gegevens': 'Записани данни',
  'Vereist niveau van aanmeldzekerheid':
      'Изисквано ниво на сигурност на регистрацията',
  'Vereiste aanmeldmethoden': 'Необходими методи за влизане',
  'Verloopt bij inactiviteit op': 'Изтича, когато е неактивен',
  'Verloopt definitief op': 'Изтича за постоянно',
  'Verloopt op': 'Изтича',
  'Versienummer van de PE-regel': 'Номер на версията на правилото PE',
  'Verwerkte verzoeken': 'Обработени заявки',
  'Verwijderd op': 'Премахнато на',
  'Verwijdering': 'Премахване',
  'Verwijderingsregister': 'Регистър за премахване',
  'Verwijzing naar het antwoord': 'Препратка към отговора',
  'Verzoeknummer': 'Номер на заявката',
  'Verzoeknummer van de app': 'Номер на заявка за приложение',
  'Verzonden op': 'Изпратено на',
  'Volgende controle op': 'Следваща проверка',
  'Volgnummer': 'Пореден номер',
  'Volgorde van antwoordopties': 'Ред на вариантите за отговор',
  'Vraagnummer binnen de toetspoging': 'Номер на въпроса в опита за тест',
  'Vraagversienummer': 'Номер на версията на въпроса',
  'Vragen in toetspogingen': 'Въпроси в тестовите опити',
  'Vrijgegeven': 'Освободен',
  'Vrijgegeven op': 'Пуснат на',
  'Wat gebeurt na de bewaartermijn':
      'Какво се случва след периода на задържане',
  'Wettelijke verplichting': 'Законово задължение',
  'Wijzigingen aan PE-punten': 'Промени в PE точките',
  'Wijzigingen aan kwalificaties': 'Промени в квалификациите',
  'Wijzigingen in aanmeldbeveiliging': 'Промени в сигурността при влизане',
  'Zekerheid': 'Сигурност',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Например, търсете по курс, дата или статус',
  'Zoeken in uw gegevens': 'Търсете вашите данни',
  '{aantal} categorieën gevonden': '{aantal} категории намерени',
  'Aanwezigheid': 'Присъствие',
  'Lidmaatschap': 'Членство',
  'Inzage en wijzigingen': 'Достъп и промени',
  'Beschikbaarheid van het inzagespoor': 'Наличие на регистър за достъп',
  'Beschikbaar vanaf': 'Предлага се от',
  'Historie vóór deze datum': 'История преди тази дата',
  'Tijdstip': 'Дата и час',
  'Handeling': 'Действие',
  'Gegevensonderdeel': 'Категория данни',
  'Handelde als': 'Действал като',
  'Organisatorische rol': 'Организационна роля',
  'Bekeken': 'Разгледано',
  'Gewijzigd': 'Променен',
  'Uzelf': 'Вие',
  'Medewerker': 'Член на персонала',
  'Systeem': 'система',
  'Onbekend': 'неизвестен',
  'Docent': 'Инструктор',
  'Beoordelaar': 'оценител',
  'Organisatiebeheerder': 'Организационен администратор',
  'Niet beschikbaar': 'Не е наличен',
  'Uitoefening van privacyrechten': 'Упражняване на правата за поверителност',
  'Beoordeling en certificering': 'Оценяване и сертифициране',
  'Uitvoering van het leertraject': 'Доставка на учебната програма',
  'Cursistenadministratie': 'Администриране на обучаемите',
  'Cursistprofiel': 'Профил на обучаемия',
  'Leerstatistieken': 'Статистика на обучението',
  'Inschrijving': 'Записване',
  'Toetspoging': 'Опит за оценка',
  'Beoordeling': 'оценка',
  'Bewijsstuk': 'Доказателство',
  'Kwalificatie': 'Квалификация',
  'Deelname': 'Участие',
  'PE-punten': 'Точки за продължаващо обучение',
  'Certificaat': 'Сертификат',
  'Privacyverzoek': 'Искане за поверителност',
  'Bewaard tot': 'Запазва се до',
  'Bekijk mijn gegevens': 'Преглед на моите данни',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Вижте какви данни е регистрирала eLearning за вас.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Този преглед е извлечен директно от eLearning на {datum} и не се съхранява от OciDeck.',
  'Geen gegevens geregistreerd': 'Няма регистрирани данни',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'Той съдържа всички категории, предоставени от сървъра за тази организация. За информация относно цели, получатели, произход, срокове за съхранение или други ваши права за поверителност се свържете с {organisatie}.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Данните ви не можаха да се заредят. Опитайте отново.',
  'Meer tonen ({aantal} resterend)': 'Показване на още ({aantal} остават)',
  'Mijn gegevens': 'Моите данни',
  'Privacy-inzage': 'Достъп до лични данни',
  'Uw geregistreerde gegevens': 'Вашите регистрирани данни',
  'uw organisatie': 'вашата организация',
  '{aantal} registraties': 'Брой записи: {aantal}',
  ...
  'Deze identiteitsprovider toestaan':
      'Разрешаване на този доставчик на самоличност',
  'Deze organisatie bevat te veel lessen om veilig te tonen.':
      'Тази организация съдържа твърде много уроци, за да бъдат показани безопасно.',
  'Er wacht nog voortgang op synchronisatie.':
      'Напредъкът все още чака синхронизация.',
  'Met deze keuze wordt het vernieuwtoken in de sleutelbos bewaard. Een versleutelde wachtrij voor nog niet verstuurde voortgang wordt daar los van bewaard.':
      'С този избор токенът за обновяване се съхранява в ключодържателя. Шифрована опашка за все още неизпратен напредък се съхранява отделно.',
  'Nog niet verstuurde voortgang is op dit apparaat bewaard.':
      'Все още неизпратеният напредък е запазен на това устройство.',
  'Cursist': 'Курсист',
  'Les afgerond': 'Урокът е завършен',
  'Cursussen voor u': 'Курсове за вас',
  'Ga verder waar u gebleven was, of kies een andere cursus die voor u klaarstaat.':
      'Продължете оттам, откъдето сте спрели, или изберете друг курс, който е готов за вас.',
  'Klaar om te beginnen': 'Готови да започнете',
  'Mijn cursussen': 'Моите курсове',
  'Mijn leeromgeving': 'Моята учебна среда',
  'Mooi gedaan! Uw voortgang is bewaard.': 'Браво! Напредъкът ви е запазен.',
  'Nu bezig': 'В процес',
  'Opnieuw starten': 'Започнете отново',
  'Terug naar mijn cursussen': 'Обратно към моите курсове',
  'U kunt deze cursus opnieuw bekijken.':
      'Можете да прегледате този курс отново.',
  'Volgende: {les}': 'Следващо: {les}',
  'Welkom, {naam}': 'Добре дошли, {naam}',
  ...
  '{afgerond} van {totaal} lessen afgerond':
      'Завършени {afgerond} от {totaal} урока',
  'Uitloggen': 'Изход',
  ...
  'Klik met Ctrl/Cmd of Shift om meerdere bestanden te kiezen.':
      'Щракнете с Ctrl/Cmd или Shift, за да изберете няколко файла.',
  'Presentaties openen': 'Отваряне на презентации',
  ...
  'Alleen een lege dia.': 'Само празен слайд.',
  ...
  'Elk hoofdstuk begon al op een nieuwe pagina':
      'Всяка глава вече започваше на нова страница',
  ...
  'Sluit één of meer OpenKAT-omgevingen aan (bijvoorbeeld productie en acceptatie). OciDeck toont beschikbare rapportages; de inhoud haalt u binnen via een JSON-export uit OpenKAT.':
      'Свържете една или повече OpenKAT среди (напр. продуктивна и приемателна). OciDeck показва наличните доклади; съдържанието внасяте чрез JSON експорт от OpenKAT.',
  'Server toevoegen…': 'Добави сървър…',
  'Rapportage van server…': 'Доклад от сървър…',
  'Nog geen OpenKAT-server aangesloten.':
      'Все още няма свързан OpenKAT сървър.',
  'Bezig…': 'Изпълнява се…',
  'OpenKAT-server bewerken': 'Редактирай OpenKAT сървър',
  'OpenKAT-server toevoegen': 'Добави OpenKAT сървър',
  'OpenKAT-server toevoegen…': 'Добави OpenKAT сървър…',
  'OpenKAT-server verwijderen?': 'Премахване на OpenKAT сървър?',
  'Dit verwijdert “{name}” en het bijbehorende toegangstoken van dit apparaat. Dat kunt u niet ongedaan maken.':
      'Това премахва “{name}” и съответния токен за достъп от това устройство. Не може да бъде отменено.',
  'Weergavenaam': 'Показвано име',
  'Bijvoorbeeld Productie of Acceptatie': 'Напр. Продуктивна или Приемателна',
  'Adres van OpenKAT': 'Адрес на OpenKAT',
  'Verbinding met: {host}': 'Връзка с: {host}',
  'Eigen netwerk (LAN)': 'Локална мрежа (LAN)',
  'Alleen voor OpenKAT op het eigen netwerk. Staat HTTP toe en laat privé-adressen toe. Uitgeschakeld: alleen HTTPS.':
      'Само за OpenKAT в локалната мрежа. Позволява HTTP и частни адреси. Изключено: само HTTPS.',
  'Toegangstoken': 'Токен за достъп',
  'Laat leeg om het opgeslagen token te behouden':
      'Оставете празно, за да запазите запазения токен',
  'Plak het token hier': 'Поставете токена тук',
  'Vraag uw OpenKAT-beheerder om een API-token in het beheerdersscherm. Het token blijft op dit apparaat, in de sleutelhanger van uw besturingssysteem — niet in het deck.':
      'Поискайте от администратора на OpenKAT API токен в административния екран. Токенът остава на това устройство, в keychain на ОС — не в deck.',
  'Verbinding wordt getest…': 'Тестване на връзката…',
  'Test de verbinding voordat u opslaat, zodat u weet dat naam, adres en token kloppen.':
      'Тествайте връзката преди запазване, за да сте сигурни, че името, адресът и токенът са верни.',
  'De OpenKAT-koppeling is alleen beschikbaar in de desktopversie.':
      'OpenKAT връзката е налична само в desktop версията.',
  'Lees OpenKAT-rapportages in als één managementoverzicht — vanuit een map of vanaf een server.':
      'Внасяйте OpenKAT доклади като един управленски преглед — от папка или сървър.',
  'Er staat al een OpenKAT-bron ingesteld; de koppeling blijft daarom bereikbaar, zodat een bestaand OpenKAT-deck bij te werken blijft.':
      'Вече е настроен OpenKAT източник; връзката остава достъпна, за да актуализирате съществуващ deck OpenKAT.',
  'Rapportage van OpenKAT-server': 'Доклад от OpenKAT сървър',
  'Rapportage van OpenKAT-server…': 'Доклад от OpenKAT сървър…',
  'Server: {name}': 'Сървър: {name}',
  'Organisaties worden opgehaald…': 'Извличане на организации…',
  'Rapportages worden opgehaald…': 'Извличане на доклади…',
  'Er zijn geen organisaties zichtbaar voor dit token. Vraag uw beheerder om toegang, of kies een andere server.':
      'Няма видими организации за този токен. Поискайте достъп от администратора или изберете друг сървър.',
  'Er staan geen organisatierapportages klaar op deze server. Maak in OpenKAT eerst een aggregaat-organisatierapport, of kies een andere organisatie.':
      'На този сървър няма готови организационни доклади. Първо създайте агрегиран организационен доклад в OpenKAT или изберете друга организация.',
  'JSON-export uit OpenKAT': 'JSON експорт от OpenKAT',
  'OpenKAT levert de rapportage-inhoud als JSON-bestand. Exporteer in OpenKAT het gekozen rapport als JSON, en wijs dat bestand of de map hieraan.':
      'OpenKAT предоставя съдържанието на доклада като JSON файл. Експортирайте избрания доклад като JSON в OpenKAT и посочете тук този файл или папка.',
  'Gekozen: {reportName} · {orgName} · {serverName}':
      'Избрано: {reportName} · {orgName} · {serverName}',
  'JSON-bestand kiezen…': 'Избор на JSON файл…',
  'Map met exports kiezen…': 'Избор на папка с експорти…',
  'Vul een weergavenaam in, bijvoorbeeld Productie.':
      'Въведете показвано име, напр. Продуктивна.',
  'Vul een weergavenaam en een adres in.': 'Въведете показвано име и адрес.',
  'Plak een toegangstoken om verder te gaan.':
      'Поставете токен за достъп, за да продължите.',
  'Vul een adres in, bijvoorbeeld https://openkat.voorbeeld.nl':
      'Въведете адрес, напр. https://openkat.voorbeeld.nl',
  'Dit adres is niet geldig. Controleer of u een volledige URL heeft ingevuld.':
      'Този адрес не е валиден. Проверете дали сте въвели пълен URL.',
  'Het adres moet met https:// beginnen, of zet Eigen netwerk aan voor HTTP op het eigen netwerk.':
      'Адресът трябва да започва с https:// или включете Локална мрежа за HTTP в локалната мрежа.',
  'Verbonden met {host}. Er zijn nog geen organisaties zichtbaar voor dit token.':
      'Свързано с {host}. Няма видими организации за този токен.',
  'Verbonden met {host}. {n} organisatie(s) bereikbaar.':
      'Свързано с {host}. Достъпни организации: {n}.',
  'De verbinding met OpenKAT is mislukt. Controleer het adres en uw netwerk, en probeer opnieuw.':
      'Връзката с OpenKAT не успя. Проверете адреса и мрежата и опитайте отново.',
  'Er is geen toegangstoken. Plak het token van uw beheerder en probeer opnieuw.':
      'Липсва токен за достъп. Поставете токена от администратора и опитайте отново.',
  'Alleen HTTPS is toegestaan, tenzij Eigen netwerk aan staat.':
      'Разрешен е само HTTPS, освен ако Локална мрежа е включена.',
  'OpenKAT weigerde het token. Vraag uw beheerder om een geldig API-token en plak het opnieuw.':
      'OpenKAT отхвърли токена. Поискайте валиден API токен от администратора и го поставете отново.',
  'OpenKAT reageerde niet op tijd. Controleer of de server bereikbaar is en probeer opnieuw.':
      'OpenKAT не отговори навреме. Проверете дали сървърът е достъпен и опитайте отново.',
  'Dit adres is niet bereikbaar. Controleer de spelling van de hostnaam en of u op het juiste netwerk zit.':
      'Този адрес не е достъпен. Проверете правописа на хоста и дали сте в правилната мрежа.',
  'OpenKAT gaf een onverwacht groot antwoord. Probeer later opnieuw of vraag uw beheerder om hulp.':
      'OpenKAT върна неочаквано голям отговор. Опитайте по-късно или поискайте помощ от администратора.',
  'Verbonden': 'Свързано',
  'Token ontbreekt': 'Липсва токен',
  'Laatst gecontroleerd mislukt': 'Последната проверка не успя',
  'Nog niet gecontroleerd': 'Все още не е проверено',
  'Zoekveld wissen': 'Изчисти полето за търсене',
  'Gantt': 'Gantt',
  'Dag': 'Ден',
  'Week': 'Седмица',
  'Maand': 'Месец',
  'Tijdschaal': 'Времева скала',
  'De as-granulariteit van het Gantt-diagram. “Auto” kiest op basis van het datumbereik van de taken.':
      'Гранулярността на оста на диаграмата на Гант. “Auto” избира въз основа на диапазона от дати на задачите.',
  'Sectiedelingen': 'Разделяния на секции',
  'Behandel een taaknaam die met “## ” begint als een sectiekop in het diagram.':
      'Третирайте име на задача, започващо с “## ”, като заглавие на секция в диаграмата.',
  'Secties': 'Секции',
  'Een projectschema als Gantt-diagram. Vul de tabel met taak, start, duur, voortgang en afhankelijkheden; het diagram wordt afgeleid. Een taaknaam die met “Milestone:” begint is een nulduur-mijlpaal.':
      'График на проекта като диаграма на Гант. Попълнете таблицата със задача, начало, продължителност, напредък и зависимости; диаграмата се извежда. Име на задача, започващо с “Milestone:”, е етап с нулева продължителност.',
  ...
  'Dit is een presentatie, geen Markdown-bestand. Zet de module Importeren aan om hem om te zetten naar een deck.':
      'Това е презентация, а не файл Markdown. Включете модула „Импортиране“, за да я преобразувате в дек.',
  'De zwakhedenlijst (78): id, titel, MASVS-categorie, platform, de CWE-koppeling en een korte omschrijving. Plus een brug van de oude beta-nummering (tot 0119) naar de canonieke id\'s, zodat de MASTG-kruiskoppeling blijft kloppen.':
      'Списъкът със слабости (78): id, заглавие, категория MASVS, платформа, връзката към CWE и кратко описание. Плюс мост от старото бета номериране (до 0119) към каноничните id, за да остане кръстосаната препратка към MASTG вярна.',
  ...
  'Rapporteer de voortgang van een ISO-managementsysteem (27001/9001/42001): status per beheersmaatregel en een afgeleid voortgangsoverzicht. Standaard uit; zet de uitbreiding aan om het dia-type te gebruiken.':
      'Докладвайте напредъка на система за управление по ISO (27001/9001/42001): състояние за всяка контрола и производен обзор на напредъка. По подразбиране изключено; включете разширението, за да използвате типа слайд.',
  'Module aan. De ISO-index is lokaal beschikbaar ({n} beheersmaatregelen over drie normen); alleen de nummers en korte titels, niet de normtekst.':
      'Модулът е включен. Индексът по ISO е наличен локално ({n} контроли в три стандарта); само номерата и кратките заглавия, но не и текста на стандарта.',
  'Beheersmaatregel-status': 'Състояние на контролите',
  ...
  'USL (bovengrens)': 'USL (горна граница)',
  'LSL (ondergrens)': 'LSL (долна граница)',
  'Optionele Y-01-velden': 'Незадължителни полета Y-01',
  'Procesdoel (target)': 'Цел на процеса (target)',
  'Specificatielimieten van Y-01 (deck)':
      'Лимити на спецификацията Y-01 (deck)',
  'Dit deck heeft Y-01-limieten. Schakel bovenstaande schakelaar in om die te gebruiken in plaats van lokale waarden.':
      'Този deck има лимити Y-01. Включете превключвателя по-горе, за да ги използвате вместо локални стойности.',
  'USL (bovengrens, optioneel)': 'USL (горна граница, незадължително)',
  ...
  'Één kolom getallen (minimaal 2 waarnemingen).':
      'Една колона с числа (поне 2 наблюдения).',
  'Twee kolommen gescheiden door een lege regel (minimaal 2 per groep).':
      'Две колони, разделени с празен ред (поне 2 на група).',
  'Meerdere groepen, elke groep een kolom, gescheiden door een lege regel (minimaal 2 groepen, 2 waarnemingen per groep).':
      'Няколко групи, всяка група колона, разделени с празен ред (поне 2 групи, 2 наблюдения на група).',
  'Plak Part, Operator en Value (tab of komma). Herhaal rijen voor replicaten. Minimaal 2 parts, 2 operators, 2 metingen per cel.':
      'Поставете Part, Operator и Value (таб или запетая). Повторете редовете за реплики. Поне 2 parts, 2 оператора, 2 измервания на клетка.',
  'Plak X en Y (één getal per regel). Minimaal 3 paren; de engine weigert bij te weinig waarnemingen.':
      'Поставете X и Y (едно число на ред). Поне 3 двойки; машината отказва при твърде малко наблюдения.',
  'Part × Operator interaction pooled into repeatability':
      'Взаимодействието Part × Operator е обединено в повторяемост',
  'Part × Operator interaction kept separate':
      'Взаимодействието Part × Operator е запазено отделно',
  ...
  'Te weinig gegevens voor een interactieplot':
      'Недостатъчно данни за график на взаимодействие',
  'DOE-proefopzet…': 'DOE план…',
  'DOE-proefopzet': 'DOE план',
  'Genereert een ontwerptabel met gecodeerde factoren (−1/+1) en een lege Y-kolom in het raster.':
      'Създава проектна таблица с кодирани фактори (−1/+1) и празна Y колона в мрежата.',
  'Aantal factoren': 'Кількість факторів',
  'Volledig factorial (2^k)': 'Повний факторіальний (2^k)',
  'Fractioneel (2^(k−p))': 'Фракционен (2^(k−p))',
  'Fractie p': 'Фракция p',
  'runs in standaard Yates-volgorde': 'прогони в стандартному порядку Єйтса',
  'In raster zetten': 'Подреждане в мрежа',
  'Eén reeks per factor met gecodeerde niveaus −1 en +1; laatste reeks is de respons (Y). Rijen zijn proefruns.':
      'Една серия на фактор с кодирани нива −1 и +1; последната серия е отговорът (Y). Редовете са експериментални проби.',
  'Golden-thread-id': 'Идентификатор на golden thread',
  'wordt ergens genoemd maar staat niet op een boom-dia — definieer hem op een CTQ- of Ishikawa-boom.':
      'се споменава някъде, но не е на слайд с дърво — дефинирайте го на CTQ или Ishikawa дърво.',
  ...
  'Project starten': 'Стартиране на проекта',
  'Procesverbetering: DMAIC-project': 'Подобряване на процесите: DMAIC проект',
  'DMAIC-skelet met charter, CTQ-boom (Y-01), SIPOC en fase-secties.':
      'DMAIC скелет с charter, CTQ дърво (Y-01), SIPOC и фазови секции.',
  'Een fasepoort-checklist: bevestig scope, stakeholders en go/no-go voordat je naar de volgende fase gaat.':
      'Checklist за фазова врата: потвърдете scope, stakeholders и go/no-go преди преминаване към следващата фаза.',
  'Stroom': 'Поток',
  'Zwembanen': 'Плувни пътеки',
  'Een processtroom, zwembanen of VSM. Stappen als titel :: soort :: pt=…; lt=…. Totalen (PCE, bottleneck) worden berekend, niet opgeslagen.':
      'Процесен поток, плувни пътеки или VSM. Стъпки като заглавие :: вид :: pt=…; lt=…. Общо (PCE, bottleneck) се изчисляват и не се записват.',
  'Boom': 'Дърво',
  'Visgraat': 'Рибена кост',
  'Lay-out': 'Оформление',
  'Punten': 'Точки',
  'Inspringen': 'Отстъп',
  'Uitspringen': 'Намали отстъп',
  'Punt toevoegen': 'Добави точка',
  'Punt verwijderen': 'Премахни точка',
  'Een boom of visgraat (5× Why, CTQ, Ishikawa). Diepte met tabs; markeer oorzaken als **X-01** inline.':
      'Дърво или рибена кост (5× Why, CTQ, Ishikawa). Дълбочина с табулации; маркирайте причините като **X-01** inline.',
  'Canvas': 'Платно',
  'Een canvas van regio\'s (A3, charter, SWOT, bord). Kies een sjabloon; de ##-koppen op schijf zijn de vakken.':
      'Платно от региони (A3, charter, SWOT, дъска). Изберете шаблон; заглавията ## на диска са полетата.',
  'Matrix': 'Матрица',
  'Een getypeerd raster (SIPOC, FMEA, RACI, …). Kies een sjabloon; afgeleide kolommen zoals RPN worden berekend en niet opgeslagen.':
      'Типизирана мрежа (SIPOC, FMEA, RACI, …). Изберете шаблон; производни колони като RPN се изчисляват и не се записват.',
  'Regelkaart': 'Контролна карта',
  'Histogram': 'Хистограма',
  'Pareto': 'Парето',
  'Run chart': 'Диаграма на протичане',
  'Boxplot': 'Кутия с мустаци',
  'Plakken uit klembord': 'Поставяне от клипборда',
  'Te weinig gegevens voor een regelkaart':
      'Твърде малко данни за контролна карта',
  'Te weinig gegevens voor een histogram': 'Твърде малко данни за хистограма',
  ...
  'De browser blokkeert media van een externe bron. Open deze presentatie in de app om online media te tonen.':
      'Браузърът блокира мултимедия от външен източник. Отворете тази презентация в приложението, за да се покаже онлайн мултимедията.',
  ...
  'Deze afbeelding naar het AI-model sturen?':
      'Да се изпрати ли това изображение до AI модела?',
  'De afbeelding gaat ongewijzigd naar':
      'Изображението ще бъде изпратено без промени до',
  'OciDeck lakt niets weg in een afbeelding: gezichten, tekst op een schermafdruk en gegevens in beeld gaan mee.':
      'OciDeck не заличава нищо в изображението: лица, текст на екранна снимка и видими данни се изпращат заедно с него.',
  'De beeldcontrole vond hier een of meer herkenbare gezichten.':
      'Проверката на изображенията откри тук едно или повече разпознаваеми лица.',
  'Naast de export komen twee bestanden te staan waarmee een ontvanger de redacties kan natrekken.':
      'До експорта се създават два файла, с които получателят може да провери заличаванията.',
  'somt op wat er is weggelaten, zonder de waarden zelf. Dit bestand mag met het rapport mee.':
      'изброява какво е пропуснато, без самите стойности. Този файл може да придружи доклада.',
  'bevat de sleutels waarmee elke weggelakte waarde is terug te rekenen. Stuur dit bestand niet mee: dan is de redactie ongedaan gemaakt. Bewaar het bij de bron.':
      'съдържа ключовете, с които всяка заличена стойност може да бъде възстановена. Не изпращайте този файл: така заличаването се обезсилва. Съхранявайте го при източника.',
  'slides': 'слайда',
  'Achtergehouden': 'Задържан',
  'Achtergehouden: strenger geclassificeerd dan de presentatie':
      'Задържан: класифициран по-строго от презентацията',
  '1 slide achtergehouden door haar TLP': '1 слайд задържан заради своя TLP',
  'slides achtergehouden door hun TLP': 'слайда задържани заради своя TLP',
  'Deze slides gaan niet mee bij presenteren, exporteren of in het pakket. Verhoog het TLP-niveau van de presentatie bij Presentatie-info om ze mee te nemen.':
      'Тези слайдове не се включват при представяне, експортиране или в пакета. Повишете нивото TLP на презентацията в Информация за презентацията, за да ги включите.',
  'Alle slides zijn achtergehouden door hun TLP-classificatie — niets om te tonen.':
      'Всички слайдове са задържани заради своята TLP класификация — няма какво да се покаже.',
  'Alle slides zijn achtergehouden door hun TLP-classificatie — niets om te exporteren.':
      'Всички слайдове са задържани заради своята TLP класификация — няма какво да се експортира.',
  'Alle slides zijn overgeslagen of achtergehouden door hun TLP-classificatie — niets om te tonen.':
      'Всички слайдове са пропуснати или задържани заради своята TLP класификация — няма какво да се покаже.',
  'Alle slides zijn overgeslagen of achtergehouden door hun TLP-classificatie — niets om te exporteren.':
      'Всички слайдове са пропуснати или задържани заради своята TLP класификация — няма какво да се експортира.',
  'Grafiekcijfers zijn niet opgeslagen — ze staan alleen nog in dit venster:':
      'Числата на диаграмите не бяха запазени — те съществуват само в този прозорец:',
  'In de browser is er geen crashherstel: sluit je dit tabblad, dan is niet-opgeslagen werk weg. Sla je presentatie zelf op.':
      'В браузъра няма възстановяване след срив: затворите ли този раздел, незапазената работа изчезва. Запазете презентацията си сами.',
  ...
  '•  CVE opzoeken (staat standaard uit): staat het aan, dan gaat je zoekterm naar de ingestelde CVE-spiegel en, als die niets vindt, naar de Europese database van ENISA en naar MITRE.':
      '•  Търсене на CVE (по подразбиране изключено): когато е включено, търсената от вас дума отива към зададеното CVE огледало, а ако то не открие нищо — към европейската база данни на ENISA и към MITRE.',
  ...
  'Je token is geldig, maar mag dit niet. Geef het meer rechten, of wacht als de forge een limiet oplegt.':
      'Токенът ви е валиден, но няма права за това. Дайте му повече права или изчакайте, ако форджът налага ограничение.',
  ...
  'De LibrePlan-connector is alleen beschikbaar in de desktopversie.':
      'Конекторът LibrePlan е достъпен само в настолната версия.',
  'LibrePlan-connector is optioneel en staat standaard uit. Er wordt niets opgehaald totdat u dit inschakelt en zelf een server configureert. Alleen-lezen: de connector schrijft niets terug naar LibrePlan. Het wachtwoord wordt in de sleutelhanger van uw besturingssysteem opgeslagen, niet in het deck.':
      'Конекторът LibrePlan е незадължителен и по подразбиране е изключен. Нищо не се изтегля, докато не го включите и сами не настроите сървър. Само за четене: конекторът не записва нищо обратно в LibrePlan. Паролата се съхранява в keychain на операционната ви система, не в deck.',
  'Opgeslagen in de sleutelhanger': 'Съхранено в keychain',
  'Alleen voor servers op het eigen netwerk (LAN). Staat plain-HTTP toe en staat privé-adressen door de NetGuard. Uitgeschakeld: HTTPS verplicht.':
      'Само за сървъри в собствената мрежа (LAN). Позволява обикновен HTTP и пропуска частни адреси през NetGuard. Изключено: изисква се HTTPS.',
  'Verbinding succesvol.': 'Връзката е успешна.',
  'Onverwachte fout.': 'Неочаквана грешка.',
  'Importeren uit LibrePlan': 'Импортиране от LibrePlan',
  'LibrePlan importeren': 'Импортиране от LibrePlan',
  'Kies welke slides u uit het LibrePlan-project wilt halen. De import is alleen-lezen en schrijft niets terug.':
      'Изберете кои слайдове искате да изтеглите от проекта в LibrePlan. Импортирането е само за четене и не записва нищо обратно.',
  'Gantt-planning': 'График по Гант',
  'WBS (hiërarchie)': 'WBS (йерархия)',
  'Projectstatus (cockpit)': 'Състояние на проекта (кокпит)',
  'Milestones (tijdlijn)': 'Етапи (времева линия)',
  'Kritieke pad (flow)': 'Критичен път (поток)',
  'Resources (tabel)': 'Ресурси (таблица)',
  'Timesheet (tabel)': 'Отчет за времето (таблица)',
  'Resourcebelasting (grafiek)': 'Натоварване на ресурсите (диаграма)',
  'Ophalen uit LibrePlan…': 'Изтегляне от LibrePlan…',
