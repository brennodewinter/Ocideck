...
const _dutchSourceSv = {
  ...
  'Je keuze wordt de standaardtaal van de app.':
      'Ditt val blir appens standardspråk.',
  ...
  'Nextcloud': 'Nextcloud',
  'Nextcloud-bron (WebDAV)': 'Nextcloud-källa (WebDAV)',
  'Open en bewaar presentaties in een map op je Nextcloud. Het wachtwoord wordt versleuteld in de sleutelhanger bewaard, niet bij de overige instellingen.':
      'Öppna och spara presentationer i en mapp på din Nextcloud. Lösenordet lagras krypterat i nyckelringen, inte tillsammans med de övriga inställningarna.',
  ...
  'Afbeelding kiezen op Nextcloud': 'Välj bild på Nextcloud',
  'Openen vanaf Nextcloud': 'Öppna från Nextcloud',
  ...
  'Geen Nextcloud-server ingesteld. Stel er een in bij Instellingen → Nextcloud.':
      'Ingen Nextcloud-server inställd. Ställ in en under Inställningar → Nextcloud.',
  'Kon de map niet laden. Controleer je verbinding en instellingen.':
      'Kunde inte ladda mappen. Kontrollera din anslutning och dina inställningar.',
  ...
  'Opgeslagen op Nextcloud:': 'Sparad till Nextcloud:',
  'Opslaan mislukt:': 'Sparandet misslyckades:',
  'Stel eerst een Nextcloud-server in bij Instellingen → Nextcloud.':
      'Ställ först in en Nextcloud-server under Inställningar → Nextcloud.',
  ...
  'Oefenoverzicht tonen na afloop': 'Visa övningssammanfattning efteråt',
  'Toon na een presentatie het overzicht met de bestede tijd per slide. De tijd wordt altijd gemeten; dit bepaalt alleen of het scherm verschijnt.':
      'Visa efter en presentation översikten över tid som lagts per bild. Tiden mäts alltid; detta styr bara om skärmen visas.',
  ...
  'Markeer alle juiste antwoorden. Bij presenteren wordt willekeurig een set getoond met minstens één juist en één fout.':
      'Markera alla rätta svar. Vid presentation visas en slumpmässig uppsättning med minst ett rätt och ett fel.',
  'Juist': 'Sant',
  'Onjuist': 'Falskt',
  ...
  'Standaard': 'Standard',
  'Standaardkleuren gebruiken': 'Använd standardfärger',
  ...
  'Standaard doeltijd voor de aftelling in de presenter. Tijdens presenteren fijn af te stellen met de toets K.':
      'Standardmåltid för presentatörens nedräkning. Finjustera den under presentationen med tangenten K.',
  'uit': 'av',
  ...
  'Data (CSV: eerste rij = reeksnamen, eerste kolom = labels)':
      'Data (CSV: första raden = serienamn, första kolumnen = etiketter)',
  ...
  'Data in de slide opslaan, of als los CSV-bestand naast de presentatie bewaren?':
      'Lagra data i bilden eller behålla den som en separat CSV-fil bredvid presentationen?',
  'In de slide': 'I bilden',
  ...
  'Onderdeel van stijlprofiel ': 'Del av stilprofil ',
  ...
  'Privacy en gebruik': 'Integritet och användning',
  'OciDeck is een lokale desktop-applicatie. Uw presentaties en gegevens worden uitsluitend op uw computer opgeslagen.':
      'OciDeck är en lokal skrivbordsapplikation. Dina presentationer och data lagras enbart på din dator.',
  'De app verzamelt geen persoonlijke gegevens, geen statistieken en geen gebruiksgegevens. Uw privacy is onze prioriteit.':
      'Appen samlar inte in några personuppgifter, ingen statistik och inga användningsdata. Din integritet är vår prioritet.',
  'Alle gegevens die u in OciDeck invoert, blijven op uw lokale systeem en worden niet naar externe servers gestuurd.':
      'All data du anger i OciDeck stannar på ditt lokala system och skickas inte till externa servrar.',
  ...
  'Door op "Akkoord gaan" te klikken, accepteert u deze voorwaarden en gaat u akkoord met het gebruik van OciDeck.':
      'Genom att klicka på "Godkänn" accepterar du dessa villkor och samtycker till användningen av OciDeck.',
  ...
  '… en meer problemen in het kwaliteitspaneel.':
      '… och fler problem i kvalitetspanelen.',
  ...
  'Pijltjes · Tab · Esc': 'Piltangenter · Tab · Esc',
...
const _dutchSourceAddSv = <String, String>{
  'OciDeck mag uw microfoon of camera niet gebruiken. Geef toestemming in uw browser of systeeminstellingen en probeer het opnieuw.':
      'OciDeck får inte använda din mikrofon eller kamera. Ge tillstånd i webbläsaren eller systeminställningarna och försök igen.',
  'Er is geen werkende microfoon gevonden. Sluit er een aan of kies een ander apparaat.':
      'Ingen fungerande mikrofon hittades. Anslut en eller välj en annan enhet.',
  'Er is geen werkende camera gevonden. U kunt zonder beeld meedoen.':
      'Ingen fungerande kamera hittades. Du kan delta utan bild.',
  'De dienst die het toegangsbewijs afgeeft is onbereikbaar. Probeer het later opnieuw; uw presentatie blijft ondertussen gewoon open.':
      'Tjänsten som utfärdar åtkomstbeviset går inte att nå. Försök igen senare; under tiden är din presentation fortfarande öppen.',
  'De dienst die het toegangsbewijs afgeeft heeft zijn grens voor nu bereikt. Probeer het later opnieuw.':
      'Tjänsten som utfärdar åtkomstbeviset har nått sin gräns för tillfället. Försök igen senare.',
  'Het toegangsbewijs voor deze vergadering is verlopen. Doe opnieuw mee met dezelfde link.':
      'Åtkomstbeviset för det här mötet har gått ut. Delta igen med samma länk.',
  'Het netwerk laat deze vergadering niet door. Op een bedrijfsnetwerk blokkeert een firewall of proxy dit soort verkeer vaak; een andere verbinding lukt meestal wel.':
      'Nätverket släpper inte igenom det här mötet. I ett företagsnätverk blockerar en brandvägg eller proxy ofta den här typen av trafik; en annan anslutning fungerar oftast.',
  'Deze vergadering is voorbij.': 'Det här mötet är över.',
  'De vergaderdienst is zelf niet beschikbaar. Dit ligt niet aan uw verbinding; probeer het later opnieuw.':
      'Själva mötestjänsten är inte tillgänglig. Det beror inte på din anslutning; försök igen senare.',
  'Meedoen is niet gelukt, en de dienst zegt niet waarom. De technische code staat bij de details — probeer het opnieuw, en geef die code door als het blijft misgaan.':
      'Det gick inte att delta, och tjänsten säger inte varför. Den tekniska koden står bland detaljerna — försök igen och lämna vidare koden om det fortsätter att gå fel.',
  'Dit is geen bruikbare vergaderlink. Kopieer hem opnieuw uit de uitnodiging — een link die door een chatprogramma is afgekapt of aangepast, doet het vaak niet meer.':
      'Det här är inte en användbar möteslänk. Kopiera den igen från inbjudan — en länk som ett chattprogram har kapat eller ändrat fungerar ofta inte längre.',
  'Deze dienst kennen we, maar dit soort vergadering niet. Webinars, uitzendingen en persoonlijke vergaderkamers werken anders dan een gewone vergadering; open deze link in de browser.':
      'Vi känner igen den här tjänsten, men inte den här typen av möte. Webbinarier, sändningar och personliga mötesrum fungerar annorlunda än ett vanligt möte; öppna länken i webbläsaren.',
  'Deze vergaderdienst kennen we niet. OciDeck weet dus ook niet wat er achter deze link zit; u kunt hem in uw browser openen als u de afzender vertrouwt.':
      'Vi känner inte den här mötestjänsten. OciDeck vet därför inte heller vad som ligger bakom länken; du kan öppna den i din webbläsare om du litar på avsändaren.',
  'Meedoen kan op deze uitvoering van OciDeck niet. Gebruik de webversie in uw browser.':
      'Det går inte att delta i den här versionen av OciDeck. Använd webbversionen i din webbläsare.',
  'Deze browser mist iets wat voor meedoen nodig is. Een recente Chrome, Edge, Firefox of Safari lukt doorgaans wel.':
      'Den här webbläsaren saknar något som behövs för att delta. En ny Chrome, Edge, Firefox eller Safari fungerar oftast.',
  'De organisatie van deze vergadering laat geen gasten zonder account toe. Vraag de organisator om u uit te nodigen op een manier die gasten toestaat.':
      'Organisationen bakom det här mötet tillåter inte gäster utan konto. Be organisatören att bjuda in dig på ett sätt som tillåter gäster.',
  'Meedoen aan deze vergadering vereist een account bij de aanbieder. Open de link in uw browser en meld u daar aan.':
      'För att delta i det här mötet krävs ett konto hos leverantören. Öppna länken i din webbläsare och logga in där.',
  'Deze aanbieder laat alleen goedgekeurde programma\'s meedoen, en die goedkeuring is er voor OciDeck nog niet. Open de vergadering in uw browser.':
      'Den här leverantören låter bara godkända program delta, och det godkännandet finns ännu inte för OciDeck. Öppna mötet i din webbläsare.',
  'De organisator heeft u niet toegelaten. Vraag of hij u binnenlaat en probeer het daarna opnieuw.':
      'Organisatören släppte inte in dig. Be om att bli insläppt och försök sedan igen.',
  'Deze vergadering is op slot; er komt niemand meer bij. Vraag de organisator om het slot eraf te halen.':
      'Det här mötet är låst; ingen mer kommer in. Be organisatören att låsa upp det.',
  'Deze vergadering is eind-tot-eind versleuteld en laat daarom geen externe deelnemers toe. Dat is een keuze van de organisator; vraag hem om een gewone vergadering als u erbij moet zijn.':
      'Det här mötet är end-to-end-krypterat och tillåter därför inga externa deltagare. Det är organisatörens val; be om ett vanligt möte om du behöver vara med.',
  '{plek} krijgt contact zodra u meedoet.':
      'Kontakt tas med {plek} så snart du deltar.',
  'U doet mee met alleen de naam die u zelf opgeeft; u bent niet aangemeld als die persoon.':
      'Du deltar bara med det namn du själv anger; du är inte inloggad som den personen.',
  'De dienst maakt een tijdelijke gastidentiteit voor u, die na de vergadering verdwijnt.':
      'Tjänsten skapar en tillfällig gästidentitet för dig, som försvinner efter mötet.',
  'U doet mee als gast onder een dienstaccount van een organisatie.':
      'Du deltar som gäst via en organisations tjänstekonto.',
  'De organisator heeft een identiteit voor u klaargezet.':
      'Organisatören har förberett en identitet för dig.',
  'Meedoen gaat met uw eigen account bij deze aanbieder.':
      'Du deltar med ditt eget konto hos den här leverantören.',
  'De aanbieder ziet uw netwerkgegevens en het beeld en geluid dat u verstuurt. Wat u deelt, deelt u met alle deelnemers.':
      'Leverantören ser dina nätverksuppgifter och den bild och det ljud du skickar. Det du delar delar du med alla deltagare.',
  'Het verkeer is versleuteld naar de dienst toe; de dienst zelf kan meekijken.':
      'Trafiken är krypterad fram till tjänsten; tjänsten själv kan se med.',
  'De aanbieder beheert de versleuteling en dus ook de sleutels.':
      'Leverantören hanterar krypteringen och därmed också nycklarna.',
  'De aanbieder beschrijft dit als eind-tot-eind versleuteld.':
      'Leverantören beskriver detta som end-to-end-krypterat.',
  'Over de versleuteling is niets vastgesteld. OciDeck belooft daar dus niets over.':
      'Ingenting har fastställts om krypteringen. OciDeck utlovar därför ingenting om den.',
  'U komt eerst in een wachtruimte: een organisator moet u toelaten. Uw presentatie blijft ondertussen gewoon te bewerken.':
      'Du hamnar först i ett väntrum: en organisatör måste släppa in dig. Din presentation går under tiden fortfarande att redigera.',
  'Deze vergadering vraagt om een wachtwoord.':
      'Det här mötet kräver ett lösenord.',
  'Deze vergadering vraagt om aanmelding vooraf.':
      'Det här mötet kräver anmälan i förväg.',
  'Vergadering wordt voorbereid': 'Mötet förbereds',
  'Verbinden met de vergadering': 'Ansluter till mötet',
  'Wachten op toelating door de organisator':
      'Väntar på att organisatören ska släppa in dig',
  'U doet mee aan de vergadering': 'Du deltar i mötet',
  'De verbinding is weggevallen — opnieuw verbinden':
      'Anslutningen bröts — ansluter igen',
  'De vergadering wordt verlaten': 'Lämnar mötet',
  'De vergadering is beëindigd': 'Mötet är avslutat',
  'Meedoen is niet gelukt': 'Det gick inte att delta',
  'Deze vergadering wordt opgenomen.': 'Det här mötet spelas in.',
  'Deze vergadering wordt uitgeschreven.': 'Det här mötet transkriberas.',
  'Deze vergadering wordt opgenomen en uitgeschreven.':
      'Det här mötet spelas in och transkriberas.',
  'De vergadering vraagt uw uitdrukkelijke toestemming om mee te blijven doen.':
      'Mötet ber om ditt uttryckliga samtycke för att du ska kunna fortsätta delta.',
  'Een organisator moet u nog toelaten. U kunt gewoon doorwerken; zodra u binnen bent, opent het gespreksvenster zich.':
      'En organisatör måste fortfarande släppa in dig. Du kan lugnt fortsätta arbeta; så snart du är inne öppnas samtalsfönstret.',
  'Herkend als een vergadering bij {plek}.':
      'Identifierat som ett möte hos {plek}.',
  '{uitleg} De link wijst naar {plek}.': '{uitleg} Länken pekar mot {plek}.',
  'Deze naam kiest u zelf; niemand controleert hem. De anderen zien u als gast.':
      'Det här namnet väljer du själv; ingen kontrollerar det. De andra ser dig som gäst.',
  'Afsluiten': 'Avsluta',
  'Camera aanzetten': 'Slå på kameran',
  'Camera uitzetten': 'Stäng av kameran',
  'Microfoon aanzetten': 'Slå på mikrofonen',
  'Microfoon dempen': 'Stäng av mikrofonen',
  'Presentatie delen': 'Dela presentationen',
  'Delen stoppen': 'Sluta dela',
  'Gespreksvenster': 'Samtalsfönster',
  'Venster sluiten': 'Stäng fönstret',
  'Meedoen': 'Delta',
  'Meedoen aan een onlinevergadering': 'Delta i ett onlinemöte',
  'Onlinevergadering': 'Onlinemöte',
  'Onlinevergadering…': 'Onlinemöte…',
  'Vergaderlink': 'Möteslänk',
  'Plak hier de link uit de uitnodiging': 'Klistra in länken från inbjudan här',
  'Uw naam, zoals de anderen die zien': 'Ditt namn, som de andra ser det',
  'Wat er gebeurt als u meedoet': 'Det här händer när du deltar',
  'Verlaten': 'Lämna',
  'Weigeren en verlaten': 'Neka och lämna',
  'Toestemming geven': 'Ge samtycke',
  'Technische code: {code}': 'Teknisk kod: {code}',
  'Deelnemers ({aantal})': 'Deltagare ({aantal})',
  'Nog geen deelnemers.': 'Inga deltagare ännu.',
  'Deze vergadering geeft geen deelnemerslijst.':
      'Det här mötet ger ingen deltagarlista.',
  'gast': 'gäst',
  'deelnemer': 'deltagare',
  'presentator': 'presentatör',
  'moderator': 'moderator',
  'organisator': 'organisatör',
  'rol onbekend': 'roll okänd',
  ...
  'Materiaal uit andere systemen binnenhalen. Twee bronnen: presentaties uit PowerPoint (.pptx), Keynote (.key) en Impress (.odp) worden een bewerkbaar deck, en OpenKAT-rapportages (een map met JSON) worden één managementoverzicht. Waar de OpenKAT-map staat, stelt u in onder Integraties.':
      'Hämta in material från andra system. Två källor: presentationer från PowerPoint (.pptx), Keynote (.key) och Impress (.odp) blir ett redigerbart deck, och OpenKAT-rapporter (en mapp med JSON) blir en enda ledningsöversikt. Var OpenKAT-mappen ligger ställs in under Integrationer.',
  'Presentaties uit PowerPoint (.pptx), Keynote (.key) en Impress (.odp) binnenhalen als bewerkbaar deck. Het inlezen van OpenKAT-rapportagemappen kan alleen in de desktopversie.':
      'Hämta in presentationer från PowerPoint (.pptx), Keynote (.key) och Impress (.odp) som ett redigerbart deck. Inläsning av OpenKAT-rapportmappar är bara möjlig i skrivbordsversionen.',
  'Alinea': 'Stycke',
  ...
  'OpenKAT-deck bijgewerkt; handmatige dia’s zijn behouden.':
      'OpenKAT-decket uppdaterat; manuella bilder har behållits.',
  'Geen OpenKAT-rapportages gevonden in deze map.':
      'Inga OpenKAT-rapporter hittades i den här mappen.',
  'OpenKAT-import mislukt.': 'OpenKAT-importen misslyckades.',
  ...
  'Actie': 'Åtgärd',
  'Deadline': 'Deadline',
  'Op de lijst sinds': 'På listan sedan',
  'Stand': 'Status',
  'Wat vraagt u': 'Vad du ber om',
  'geen datum': 'inget datum',
  'Ter informatie': 'För kännedom',
  ...
  'Alleen een besluit of escalatie krijgt een label op de slide; "te laat" volgt uit de deadline en zet u niet zelf.':
      'Bara ett beslut eller en eskalering får en etikett på bilden; "försenad" följer av deadline och sätts inte av dig.',
  'Datums als jjjj-mm-dd. Een andere schrijfwijze wordt niet geraden: 05-08-2026 is twee verschillende dagen.':
      'Datum som åååå-mm-dd. Andra skrivsätt avvisas i stället för att gissas: 05-08-2026 är två olika dagar.',
  'Een actieslide draagt hoogstens acht regels; daarna gaat de zaal skimmen in plaats van besluiten.':
      'En åtgärdsbild bär högst åtta rader; därefter skummar rummet i stället för att besluta.',
  'Wat er moet gebeuren, wie het doet en wanneer. Geef per regel aan of het ter informatie is, of dat u een besluit vraagt — dat is waar de zaal op scant.':
      'Vad som måste hända, vem som gör det och när. Ange per rad om det är för kännedom eller om du ber om ett beslut — det är vad rummet letar efter.',
  ...
  'Procesverbetering (ontwerp)': 'Processförbättring (design)',
