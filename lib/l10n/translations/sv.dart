...
const _dutchSourceAddSv = <String, String>{
  ...
  'OciDeck vraagt dan maximaal eenmaal per dag aan pawprint.vigilis.online of er een nieuwere versie is.':
      'OciDeck frågar då högst en gång om dagen pawprint.vigilis.online om det finns en nyare version.',
  'Controleer nu': 'Kontrollera nu',
  'De controle is mislukt — probeer het later opnieuw.':
      'Kontrollen misslyckades — försök igen senare.',
  'Er is geen nieuwere versie.': 'Det finns ingen nyare version.',
  'OciDeck {versie} is beschikbaar.': 'OciDeck {versie} är tillgänglig.',
  'Download': 'Ladda ner',
  'OciDeck {versie} is beschikbaar — tik om de releasepagina te openen.':
      'OciDeck {versie} är tillgänglig — tryck för att öppna releasesidan.',
  ...
  'Aangemaakt op': 'Skapad den',
  'Aanmeldprovider': 'Inloggningsleverantör',
  'Aanmeldsessies': 'Registreringssessioner',
  'Aantal controles': 'Antal kontroller',
  ...
  'Afgerond op': 'Avrundad till',
  'Afgewezen': 'Avvisad',
  'Afspeelsessienummer': 'Uppspelningssessionsnummer',
  'Afwezig': 'Frånvarande',
  'Antwoordgegevens': 'Svarsdetaljer',
  'Antwoordstatus': 'Svarsstatus',
  'Begint op': 'Börjar på',
  'Begrippen uitgelegd': 'Begrepp förklaras',
  'Beheer van de installatie': 'Hantering av installationen',
  'Beheerpogingen': 'Ledningsinsatser',
  'Bekeken lessen': 'Lektioner ses',
  'Beleidsversie': 'Policyversion',
  'Beoordeeld': 'Betygsatt',
  'Beoordeeld op': 'Betygsatt av',
  'Beperking': 'Begränsning',
  'Berekend op': 'Beräknat på',
  'Bericht': 'Meddelande',
  'Bestandsnaam': 'Filnamn',
  'Beveiligingsvraagnummer': 'Säkerhetsfrågans nummer',
  'Bevestigd': 'Bekräftad',
  'Bevestigd op': 'Bekräftad på',
  'Bewaarregels': 'Lagringsregler',
  'Bewaartermijn': 'Lagringsperiod',
  'Bewaren wegens een juridische verplichting':
      'Behålls på grund av laglig skyldighet',
  'Bewerkingnummer bij aanmeldprovider':
      'Operationsnummer hos registreringsleverantören',
  'Bewijsstukken': 'Bevis',
  'Bezwaar': 'Invändning',
  'Beëindigd op': 'Slutade på',
  'Bijeenkomstnummer': 'Mötesnummer',
  'Certificaatnummer': 'Certifikatnummer',
  'Certificaten': 'Certifikat',
  'Controlecode van de PDF': 'Kontrollkod för PDF',
  'Controlecode van profielfoto': 'Verifieringskod för profilfoto',
  'Controlecodes van bewijsstukken': 'Kontrollkoder för styrkande dokument',
  'Correctie': 'Rättelse',
  'Cursistnummer waarop de actie gericht was':
      'Elevnummer som åtgärden var riktad mot',
  'Cursusaanbodnummer': 'Kursutbudsnummer',
  'Cursusversienummer': 'Kursens versionsnummer',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Datum och tider visas i din lokala tid. Tekniska namn förblir synliga när servern tillhandahåller ett okänt fält.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'Svaren du gav på testfrågor.',
  'Deelnamenummer': 'Deltagande nummer',
  'Deelnames': 'Deltaganden',
  'Details': 'Detaljer',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Denna kategori tillhandahölls av servern. De tekniska namnen förblir synliga för förfrågningar från din organisation.',
  'Door uzelf aangevraagd': 'Efterfrågat av dig själv',
  'E-mailadres': 'E-postadress',
  'E-mailberichten': 'E-postmeddelanden',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'Ett ID är ett unikt tekniskt nummer som eLearning använder för att länka samman data. Det är inte ett betyg eller status.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'En kategori grupperar data om samma ämne. En registrering är en sparad databit eller en händelse.',
  'Eindigt op': 'Slutar i',
  'Geaccepteerd op': 'Godkänd på',
  'Geannuleerd': 'Avbruten',
  'Gecontroleerd': 'Kontrollerat',
  'Gecontroleerd op': 'Kollade på',
  'Geen gegevens gevonden': 'Ingen data hittades',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Information om lagringstider och radering av dina uppgifter.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Information om styrkande dokument, uppnådda resultat och certifikat.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Information om integritetsförfrågningar och vem som har sett eller ändrat din information.',
  'Gegevens over uw accountbewerking': 'Information om din kontodrift',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Information om din anmälan, deltagande och framsteg på lektioner.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Information om din profil, konto och position inom organisationen.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Information om dina testögonblick och de frågor som presenteras.',
  'Gegevens over willekeurige volgorde': 'Slumpmässig beställningsdata',
  'Gegevenscategorie': 'Datakategori',
  'Gekoppeld accountnummer': 'Länkat kontonummer',
  'Gekozen antwoorden': 'Valda svar',
  'Gelukt': 'Framgång',
  'Geprobeerd op': 'Provade på',
  'Gerechtvaardigd belang': 'Berättigat intresse',
  'Gereserveerd': 'Reserverad',
  'Gereserveerd op': 'Reserverad på',
  'Geslaagd': 'Godkänd',
  'Gestart op': 'Började på',
  'Getoonde tijd per dia in milliseconden':
      'Tid som visas per bild i millisekunder',
  'Herkomst van inschrijving': 'Ursprung för registrering',
  'Hoogst haalbare score': 'Högsta möjliga poäng',
  'Identificatienummer bij aanmeldprovider':
      'Identifikationsnummer för registreringsleverantör',
  'Identiteitsbewerkingnummer': 'Identitetsoperationsnummer',
  'In afwachting': 'Väntar',
  'In behandeling': 'Pågår',
  'In behandeling genomen op': 'Bearbetas på',
  'In quarantaine': 'I karantän',
  'Ingeleverd': 'Inlämnad',
  'Ingeleverd op': 'Inlämnad den',
  'Ingericht op': 'Dekorerad på',
  'Ingeschreven op': 'Registrerad på',
  'Ingetrokken': 'Indragen',
  'Ingetrokken op': 'Indragen på',
  'Inschrijvingen': 'Registreringar',
  'Inschrijvingsnummer': 'Registreringsnummer',
  'Installatiebeveiligingslogboek': 'Installationssäkerhetslogg',
  'Installatienummer': 'Installationsnummer',
  'Installatieverzoeken': 'Installationsförfrågningar',
  'Inzage': 'Besiktning',
  'Ja': 'Ja',
  'Kwalificatienummer': 'Kvalifikationsnummer',
  'Kwalificaties': 'Kvalifikationer',
  'Laatst actief op': 'Senast aktiv på',
  'Laatst bekeken dia': 'Senast visade bild',
  'Laatst gewijzigd op': 'Senast ändrad den',
  'Laatste fout': 'Sista misstaget',
  'Lesnummer': 'Lektionsnummer',
  'Lesreserveringen': 'Lektionsreservation',
  'Lesvoortgang': 'Lektionens framsteg',
  'Lidmaatschappen': 'Medlemskap',
  'Locatie': 'Plats',
  'Manier van afronden': 'Sätt att avrunda',
  'Maximaal aantal controles': 'Maximalt antal kontroller',
  'Maximaal aantal pogingen': 'Maximalt antal försök',
  'Maximale leeftijd van de aanmelding': 'Högsta ålder för registrering',
  'Mislukt': 'Misslyckades',
  'Naam van de activiteit': 'Namn på aktiviteten',
  'Naam van de bijeenkomst': 'Namn på mötet',
  'Nee': 'Nej',
  'Netwerkadres': 'Nätverksadress',
  'Niet actief': 'Inte aktiv',
  'Niet geregistreerd': 'Ej registrerad',
  'Niet ingevuld': 'Ej ifylld',
  'Niet verschenen': 'Ej publicerad',
  'Niveau van extra aanmeldcontrole':
      'Nivå av ytterligare registreringskontroll',
  'Nummer van de toetsopzet': 'Nummer på testplanen',
  'Nummer van het brongegeven': 'Antalet källdata',
  'Nummer van uw verwijderde gegeven': 'Antalet raderade data',
  'Onderdeel {nummer}': 'Del {nummer}',
  'Onderwerp van de actie': 'Föremål för talan',
  'Ontvanger': 'Mottagare',
  'Opgegeven bestandsgrootte': 'Angiven filstorlek',
  'Opgegeven bestandstype': 'Angiven filtyp',
  'Opgegeven controlecode': 'Angiven kontrollkod',
  'Opgeslagen bestandsgrootte': 'Sparad filstorlek',
  'Opgeslagen controlecode': 'Lagrad kontrollkod',
  'Organisatienummer': 'Organisationsnummer',
  'Overdraagbaarheid': 'Överförbarhet',
  'PE-toekenningnummer': 'PE-prisnummer',
  'Poging': 'Försök',
  'Positie': 'Position',
  'Privacyverzoeken': 'Sekretessförfrågningar',
  'Probeer een andere zoekterm.': 'Prova en annan sökterm.',
  'Reden': 'Anledning',
  'Reden of grondslag': 'Orsak eller grund',
  'Reden van afwijzing': 'Orsak till avslag',
  'Reden van bevestiging': 'Anledning till bekräftelse',
  'Reden van intrekking': 'Orsak till uttag',
  'Reden voor langer bewaren': 'Anledning till längre förvaring',
  'Regels voor de cursusversie': 'Regler för kursversionen',
  'Resultaat bij de aanmeldprovider': 'Resultat hos registreringsleverantören',
  'Rol': 'Rulla',
  'Score': 'Betyg',
  'Soort aanwezigheid': 'Typ av närvaro',
  'Soort accountbewerking': 'Typ av kontooperation',
  'Soort gebeurtenis': 'Typ av händelse',
  'Soort privacyverzoek': 'Typ av sekretessförfrågan',
  'Status van de bijeenkomst': 'Status för mötet',
  'Strenge beveiligingsmodus': 'Högsäkerhetsläge',
  'Technisch toegangslogboek': 'Teknisk åtkomstlogg',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Tekniska data som krävs för registrering, säkerhet och tillförlitlig behandling.',
  'Technische naam: {naam}': 'Tekniskt namn: {naam}',
  'Technische opslagcategorie': 'Teknisk förvaringskategori',
  'Technische opslaglocatie van de PDF': 'Teknisk lagringsplats för PDF-filen',
  'Tijdstip van aanmelding': 'Tidpunkt för registrering',
  'Tijdzone': 'Tidszon',
  'Toestand': 'Skick',
  'Toetspogingen': 'Testförsök',
  'Toetspogingnummer': 'Testförsöksnummer',
  'Uiterste inlevermoment': 'Deadline för inlämning',
  'Uitgegeven op': 'Publicerad på',
  'Uitgenodigd e-mailadres': 'Inbjuden e-postadress',
  'Uitnodigingen': 'Inbjudningar',
  'Uniek nummer (ID)': 'Unikt nummer (ID)',
  'Uniek verwerkingskenmerk': 'Unik bearbetningsfunktion',
  'Uw accountnummer': 'Ditt kontonummer',
  'Uw accountnummer als uitvoerder': 'Ditt kontonummer som exekutor',
  'Uzelf als uploader': 'Dig själv som uppladdare',
  'Vaardigheidsversienummer': 'Skill versionsnummer',
  'Vast internetadres van de installatie':
      'Fast internetadress för installationen',
  'Vastgelegde beslisgegevens': 'Registrerade beslutsdata',
  'Vastgelegde gegevens': 'Inspelade data',
  'Vereist niveau van aanmeldzekerheid':
      'Nödvändig nivå av registreringssäkerhet',
  'Vereiste aanmeldmethoden': 'Nödvändiga inloggningsmetoder',
  'Verloopt bij inactiviteit op': 'Upphör att gälla när den är inaktiv',
  'Verloopt definitief op': 'Upphör permanent',
  'Verloopt op': 'Upphör att gälla',
  'Versienummer van de PE-regel': 'PE-regelns versionsnummer',
  'Verwerkte verzoeken': 'Bearbetade förfrågningar',
  'Verwijderd op': 'Borttagen på',
  'Verwijdering': 'Borttagning',
  'Verwijderingsregister': 'Borttagningsregister',
  'Verwijzing naar het antwoord': 'Hänvisning till svaret',
  'Verzoeknummer': 'Begärans nummer',
  'Verzoeknummer van de app': 'Appbegärans nummer',
  'Verzonden op': 'Skickade vidare',
  'Volgende controle op': 'Nästa kontroll',
  'Volgnummer': 'Sekvensnummer',
  'Volgorde van antwoordopties': 'Ordningsföljd på svarsalternativ',
  'Vraagnummer binnen de toetspoging': 'Frågenummer inom testförsöket',
  'Vraagversienummer': 'Frågans versionsnummer',
  'Vragen in toetspogingen': 'Frågor i testförsök',
  'Vrijgegeven': 'Släppt',
  'Vrijgegeven op': 'Släppt på',
  'Wat gebeurt na de bewaartermijn': 'Vad händer efter lagringstiden',
  'Wettelijke verplichting': 'Laglig skyldighet',
  'Wijzigingen aan PE-punten': 'Ändringar av PE-punkter',
  'Wijzigingen aan kwalificaties': 'Ändringar av kvalifikationer',
  'Wijzigingen in aanmeldbeveiliging': 'Ändringar av inloggningssäkerhet',
  'Zekerheid': 'Säkerhet',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Sök till exempel på kurs, datum eller status',
  'Zoeken in uw gegevens': 'Sök i din data',
  '{aantal} categorieën gevonden': '{aantal} kategorier hittades',
  'Aanwezigheid': 'Närvaro',
  'Lidmaatschap': 'Medlemskap',
  'Inzage en wijzigingen': 'Åtkomst och ändringar',
  'Beschikbaarheid van het inzagespoor': 'Tillgänglighet för åtkomstloggen',
  'Beschikbaar vanaf': 'Tillgänglig från',
  'Historie vóór deze datum': 'Historik före detta datum',
  'Tijdstip': 'Datum och tid',
  'Handeling': 'Åtgärd',
  'Gegevensonderdeel': 'Datakategori',
  'Handelde als': 'Agerade som',
  'Organisatorische rol': 'Organisatorisk roll',
  'Bekeken': 'Visas',
  'Gewijzigd': 'Ändrad',
  'Uzelf': 'Du',
  'Medewerker': 'Personalmedlem',
  'Systeem': 'System',
  'Onbekend': 'Okänd',
  'Docent': 'Instruktör',
  'Beoordelaar': 'Bedömare',
  'Organisatiebeheerder': 'Organisationsadministratör',
  'Niet beschikbaar': 'Ej tillgängligt',
  'Uitoefening van privacyrechten': 'Utövande av integritetsrätten',
  'Beoordeling en certificering': 'Bedömning och certifiering',
  'Uitvoering van het leertraject': 'Leverans av läroprogrammet',
  'Cursistenadministratie': 'Elevadministration',
  'Cursistprofiel': 'Elevprofil',
  'Leerstatistieken': 'Lärande statistik',
  'Inschrijving': 'Inskrivning',
  'Toetspoging': 'Bedömningsförsök',
  'Beoordeling': 'Bedömning',
  'Bewijsstuk': 'Bevis',
  'Kwalificatie': 'Kvalificering',
  'Deelname': 'Deltagande',
  'PE-punten': 'Fortbildningspoäng',
  'Certificaat': 'Certifikat',
  'Privacyverzoek': 'Sekretessförfrågan',
  'Bewaard tot': 'Behålls till',
  'Bekijk mijn gegevens': 'Visa mina uppgifter',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Se vilka uppgifter eLearning har registrerat om dig.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Den här översikten hämtades direkt från eLearning den {datum} och sparas inte av OciDeck.',
  'Geen gegevens geregistreerd': 'Inga uppgifter registrerade',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'Den innehåller alla kategorier som servern har tillhandahållit för den här organisationen. Kontakta {organisatie} för information om ändamål, mottagare, ursprung, lagringstider eller dina andra integritetsrättigheter.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Det gick inte att läsa in dina uppgifter. Försök igen.',
  'Meer tonen ({aantal} resterend)': 'Visa fler ({aantal} återstår)',
  'Mijn gegevens': 'Mina uppgifter',
  'Privacy-inzage': 'Tillgång till personuppgifter',
  'Uw geregistreerde gegevens': 'Dina registrerade uppgifter',
  'uw organisatie': 'din organisation',
  '{aantal} registraties': '{aantal} poster',
  'Volg opleidingen uit uw eLearning-omgeving. Cursusbestanden openen alleen in afspeelmodus; voortgang wordt alleen na aanmelden gesynchroniseerd.':
      'Gå kurser från din eLearning-miljö. Kursfiler öppnas endast i uppspelningsläge; framsteg synkroniseras endast efter inloggning.',
  'eLearning-aanmelding is alleen beschikbaar in de desktop-app, omdat de webversie geen veilige sleutelbos heeft.':
      'Inloggning till eLearning är bara tillgänglig i skrivbordsappen eftersom webbversionen saknar en säker nyckelring.',
  ...
  'Bij het volgen van een cursus stuurt OciDeck uw laatste dia, voltooiing en getoonde tijd per dia naar de gekozen eLearning-organisatie. Antwoorden, notities en cursusinhoud worden niet als voortgang verstuurd.':
      'När du går en kurs skickar OciDeck din senaste bild, slutförande och visad tid per bild till den valda eLearning-organisationen. Svar, anteckningar och kursinnehåll skickas inte som framsteg.',
  'Ingelogd bij eLearning': 'Inloggad på eLearning',
  'Deze eLearning-server gebruikt {host} voor het aanmelden. Er worden pas gegevens met die identiteitsprovider uitgewisseld nadat u dit toestaat.':
      'Den här eLearning-servern använder {host} för inloggning. Data utbyts med den identitetsleverantören först när du tillåter det.',
  'Gebruik een HTTPS-adres voor eLearning.':
      'Använd en HTTPS-adress för eLearning.',
  'Vul een geldig eLearning-adres in.': 'Ange en giltig eLearning-adress.',
  'Aanmelden bij eLearning is niet gelukt. Controleer de server en probeer opnieuw.':
      'Inloggningen på eLearning misslyckades. Kontrollera servern och försök igen.',
  'eLearning-organisatie': 'eLearning-organisation',
  'Alle lessen, voortgang en bekeken tijd bij elkaar.':
      'Alla lektioner, framsteg och sedd tid tillsammans.',
  'Bekeken tijd betekent dat een dia in beeld stond. Het is geen meting van aandacht of actieve studietijd.':
      'Visad tid betyder att en bild var på skärmen. Det är inte ett mått på uppmärksamhet eller aktiv studietid.',
  'Bekijk mijn voortgang': 'Kolla in mina framsteg',
  'Bekijk uw resultaten': 'Se dina resultat',
  'Bekijk uw resultaten, activiteit en voortgang per cursus.':
      'Se dina resultat, aktivitet och framsteg per kurs.',
  'Cursussen afgerond': 'Kurser genomförda',
  'Een volledig overzicht van uw afgeronde lessen.':
      'En fullständig översikt över dina genomförda lektioner.',
  'Laatste activiteit': 'Senaste aktiviteten',
  'Lessen afgerond': 'Lektioner avklarade',
  'Mijn voortgang': 'Mina framsteg',
  'Nog geen lessen bekeken.': 'Inga lektioner har visats ännu.',
  'Nog niet gestart': 'Inte börjat än',
  'Persoonlijk overzicht': 'Personlig översikt',
  'Recente activiteit': 'Senaste aktiviteten',
  'Tijd in beeld': 'Tid i bilden',
  'Uw cursussen': 'Dina kurser',
  'Uw laatst bekeken lessen, meest recent bovenaan.':
      'Dina senast visade lektioner, senast överst.',
  'Uw persoonlijke leerresultaten': 'Dina personliga lärandemål',
  'Voortgang per cursus': 'Framsteg per kurs',
  '{afgerond} van {totaal}': '{afgerond} av {totaal}',
  '{percentage}% van de cursussen afgerond':
      '{percentage}% av slutförda kurser',
  '{uren} u {minuten} min': '{uren} timmar {minuten} min',
  ...
  'HTML-bestand opent in elke browser zonder internet en rendert codeblokken, wiskunde en mermaid-diagrammen. LaTeX-bron compileer je met pdflatex of xelatex.':
      'En HTML-fil öppnas i valfri webbläsare utan internet och renderar kodblock, matematik och mermaid-diagram. LaTeX-källan kompileras med pdflatex eller xelatex.',
  ...
  'Neem deel aan videovergaderingen en presenteer vanuit OciDeck met een eigen interface: deelnemers naast uw slide, niet in het venster van een andere app. Bring-your-own-server (Jitsi); OciDeck host niets en houdt de gespreksgegevens buiten AI. De aansluiting op een vergaderdienst volgt in een volgende versie.':
      'Delta i videomöten och presentera från OciDeck med ett eget gränssnitt: deltagarna bredvid din slide, inte i ett annat programs fönster. Bring-your-own-server (Jitsi); OciDeck är inte värd för något och håller samtalsdatan borta från AI. Anslutningen till en mötestjänst kommer i en framtida version.',
