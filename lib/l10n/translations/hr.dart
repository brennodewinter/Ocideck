...
const _dutchSourceAddHr = <String, String>{
  'OciDeck mag uw microfoon of camera niet gebruiken. Geef toestemming in uw browser of systeeminstellingen en probeer het opnieuw.':
      'OciDeck ne smije koristiti vaš mikrofon ili kameru. Dajte dopuštenje u pregledniku ili postavkama sustava i pokušajte ponovno.',
  'Er is geen werkende microfoon gevonden. Sluit er een aan of kies een ander apparaat.':
      'Nije nađen mikrofon koji radi. Priključite jedan ili odaberite drugi uređaj.',
  'Er is geen werkende camera gevonden. U kunt zonder beeld meedoen.':
      'Nije nađena kamera koja radi. Možete se pridružiti bez slike.',
  'De dienst die het toegangsbewijs afgeeft is onbereikbaar. Probeer het later opnieuw; uw presentatie blijft ondertussen gewoon open.':
      'Usluga koja izdaje pristupnu vjerodajnicu nije dostupna. Pokušajte ponovno kasnije; vaša prezentacija u međuvremenu jednostavno ostaje otvorena.',
  'De dienst die het toegangsbewijs afgeeft heeft zijn grens voor nu bereikt. Probeer het later opnieuw.':
      'Usluga koja izdaje pristupnu vjerodajnicu za sada je dosegla svoju granicu. Pokušajte ponovno kasnije.',
  'Het toegangsbewijs voor deze vergadering is verlopen. Doe opnieuw mee met dezelfde link.':
      'Pristupna vjerodajnica za ovaj sastanak istekla je. Pridružite se ponovno istom vezom.',
  'Het netwerk laat deze vergadering niet door. Op een bedrijfsnetwerk blokkeert een firewall of proxy dit soort verkeer vaak; een andere verbinding lukt meestal wel.':
      'Mreža ne propušta ovaj sastanak. Na poslovnoj mreži vatrozid ili proxy često blokira takav promet; druga veza obično uspije.',
  'Deze vergadering is voorbij.': 'Ovaj je sastanak završio.',
  'De vergaderdienst is zelf niet beschikbaar. Dit ligt niet aan uw verbinding; probeer het later opnieuw.':
      'Sama usluga sastanaka nije dostupna. To nije zbog vaše veze; pokušajte ponovno kasnije.',
  'Meedoen is niet gelukt, en de dienst zegt niet waarom. De technische code staat bij de details — probeer het opnieuw, en geef die code door als het blijft misgaan.':
      'Pridruživanje nije uspjelo, a usluga ne kaže zašto. Tehnički kod nalazi se u detaljima — pokušajte ponovno i prenesite taj kod ako se problem nastavi.',
  'Dit is geen bruikbare vergaderlink. Kopieer hem opnieuw uit de uitnodiging — een link die door een chatprogramma is afgekapt of aangepast, doet het vaak niet meer.':
      'Ovo nije upotrebljiva veza sastanka. Kopirajte je ponovno iz pozivnice — veza koju je program za razgovor skratio ili promijenio često više ne radi.',
  'Deze dienst kennen we, maar dit soort vergadering niet. Webinars, uitzendingen en persoonlijke vergaderkamers werken anders dan een gewone vergadering; open deze link in de browser.':
      'Ovu uslugu poznajemo, ali ovu vrstu sastanka ne. Webinari, prijenosi i osobne sobe za sastanke rade drugačije od običnog sastanka; otvorite ovu vezu u pregledniku.',
  'Deze vergaderdienst kennen we niet. OciDeck weet dus ook niet wat er achter deze link zit; u kunt hem in uw browser openen als u de afzender vertrouwt.':
      'Ovu uslugu sastanaka ne poznajemo. OciDeck stoga ne zna ni što se nalazi za ovom vezom; možete je otvoriti u pregledniku ako vjerujete pošiljatelju.',
  'Meedoen kan op deze uitvoering van OciDeck niet. Gebruik de webversie in uw browser.':
      'U ovoj izvedbi OciDecka pridruživanje nije moguće. Koristite web-verziju u pregledniku.',
  'Deze browser mist iets wat voor meedoen nodig is. Een recente Chrome, Edge, Firefox of Safari lukt doorgaans wel.':
      'Ovom pregledniku nedostaje nešto što je potrebno za pridruživanje. Noviji Chrome, Edge, Firefox ili Safari obično uspije.',
  'De organisatie van deze vergadering laat geen gasten zonder account toe. Vraag de organisator om u uit te nodigen op een manier die gasten toestaat.':
      'Organizacija ovog sastanka ne dopušta goste bez računa. Zamolite organizatora da vas pozove na način koji dopušta goste.',
  'Meedoen aan deze vergadering vereist een account bij de aanbieder. Open de link in uw browser en meld u daar aan.':
      'Za pridruživanje ovom sastanku potreban je račun kod pružatelja. Otvorite vezu u pregledniku i tamo se prijavite.',
  'Deze aanbieder laat alleen goedgekeurde programma\'s meedoen, en die goedkeuring is er voor OciDeck nog niet. Open de vergadering in uw browser.':
      'Ovaj pružatelj dopušta sudjelovanje samo odobrenim programima, a to odobrenje za OciDeck još ne postoji. Otvorite sastanak u pregledniku.',
  'De organisator heeft u niet toegelaten. Vraag of hij u binnenlaat en probeer het daarna opnieuw.':
      'Organizator vas nije pustio unutra. Zamolite da vas pusti i zatim pokušajte ponovno.',
  'Deze vergadering is op slot; er komt niemand meer bij. Vraag de organisator om het slot eraf te halen.':
      'Ovaj je sastanak zaključan; nitko više ne može ući. Zamolite organizatora da ga otključa.',
  'Deze vergadering is eind-tot-eind versleuteld en laat daarom geen externe deelnemers toe. Dat is een keuze van de organisator; vraag hem om een gewone vergadering als u erbij moet zijn.':
      'Ovaj je sastanak šifriran s kraja na kraj i zato ne dopušta vanjske sudionike. To je odluka organizatora; zamolite ga za običan sastanak ako morate biti prisutni.',
  '{plek} krijgt contact zodra u meedoet.':
      'S {plek} će se ostvariti kontakt čim se pridružite.',
  'U doet mee met alleen de naam die u zelf opgeeft; u bent niet aangemeld als die persoon.':
      'Sudjelujete samo s imenom koje sami navedete; niste prijavljeni kao ta osoba.',
  'De dienst maakt een tijdelijke gastidentiteit voor u, die na de vergadering verdwijnt.':
      'Usluga za vas stvara privremeni identitet gosta, koji nakon sastanka nestaje.',
  'U doet mee als gast onder een dienstaccount van een organisatie.':
      'Sudjelujete kao gost putem servisnog računa neke organizacije.',
  'De organisator heeft een identiteit voor u klaargezet.':
      'Organizator je za vas pripremio identitet.',
  'Meedoen gaat met uw eigen account bij deze aanbieder.':
      'Pridružujete se s vlastitim računom kod ovog pružatelja.',
  'De aanbieder ziet uw netwerkgegevens en het beeld en geluid dat u verstuurt. Wat u deelt, deelt u met alle deelnemers.':
      'Pružatelj vidi vaše mrežne podatke te sliku i zvuk koje šaljete. Ono što dijelite, dijelite sa svim sudionicima.',
  'Het verkeer is versleuteld naar de dienst toe; de dienst zelf kan meekijken.':
      'Promet je šifriran do usluge; sama usluga može gledati.',
  'De aanbieder beheert de versleuteling en dus ook de sleutels.':
      'Pružatelj upravlja šifriranjem, a time i ključevima.',
  'De aanbieder beschrijft dit als eind-tot-eind versleuteld.':
      'Pružatelj to opisuje kao šifrirano s kraja na kraj.',
  'Over de versleuteling is niets vastgesteld. OciDeck belooft daar dus niets over.':
      'O šifriranju nije ništa utvrđeno. OciDeck stoga o tome ništa ne obećava.',
  'U komt eerst in een wachtruimte: een organisator moet u toelaten. Uw presentatie blijft ondertussen gewoon te bewerken.':
      'Najprije dolazite u čekaonicu: organizator vas mora pustiti unutra. Vašu prezentaciju u međuvremenu možete i dalje uređivati.',
  'Deze vergadering vraagt om een wachtwoord.':
      'Ovaj sastanak zahtijeva zaporku.',
  'Deze vergadering vraagt om aanmelding vooraf.':
      'Ovaj sastanak zahtijeva prethodnu prijavu.',
  'Vergadering wordt voorbereid': 'Sastanak se priprema',
  'Verbinden met de vergadering': 'Povezivanje sa sastankom',
  'Wachten op toelating door de organisator':
      'Čekanje da vas organizator pusti unutra',
  'U doet mee aan de vergadering': 'Sudjelujete na sastanku',
  'De verbinding is weggevallen — opnieuw verbinden':
      'Veza je prekinuta — ponovno povezivanje',
  'De vergadering wordt verlaten': 'Napuštanje sastanka',
  'De vergadering is beëindigd': 'Sastanak je završen',
  'Meedoen is niet gelukt': 'Pridruživanje nije uspjelo',
  'Deze vergadering wordt opgenomen.': 'Ovaj se sastanak snima.',
  'Deze vergadering wordt uitgeschreven.': 'Ovaj se sastanak transkribira.',
  'Deze vergadering wordt opgenomen en uitgeschreven.':
      'Ovaj se sastanak snima i transkribira.',
  'De vergadering vraagt uw uitdrukkelijke toestemming om mee te blijven doen.':
      'Sastanak traži vašu izričitu privolu za nastavak sudjelovanja.',
  'Een organisator moet u nog toelaten. U kunt gewoon doorwerken; zodra u binnen bent, opent het gespreksvenster zich.':
      'Organizator vas još mora pustiti unutra. Možete jednostavno nastaviti raditi; čim uđete, otvorit će se prozor razgovora.',
  'Herkend als een vergadering bij {plek}.':
      'Prepoznato kao sastanak na {plek}.',
  '{uitleg} De link wijst naar {plek}.': '{uitleg} Veza vodi na {plek}.',
  'Deze naam kiest u zelf; niemand controleert hem. De anderen zien u als gast.':
      'Ovo ime birate sami; nitko ga ne provjerava. Ostali vas vide kao gosta.',
  'Afsluiten': 'Završi',
  'Camera aanzetten': 'Uključi kameru',
  'Camera uitzetten': 'Isključi kameru',
  'Microfoon aanzetten': 'Uključi mikrofon',
  'Microfoon dempen': 'Isključi mikrofon',
  'Presentatie delen': 'Podijeli prezentaciju',
  'Delen stoppen': 'Zaustavi dijeljenje',
  'Gespreksvenster': 'Prozor razgovora',
  'Venster sluiten': 'Zatvori prozor',
  'Meedoen': 'Pridruži se',
  'Meedoen aan een onlinevergadering': 'Pridruživanje mrežnom sastanku',
  'Onlinevergadering': 'Mrežni sastanak',
  'Onlinevergadering…': 'Mrežni sastanak…',
  'Vergaderlink': 'Veza sastanka',
  'Plak hier de link uit de uitnodiging': 'Zalijepite ovdje vezu iz pozivnice',
  'Uw naam, zoals de anderen die zien': 'Vaše ime, kako ga vide ostali',
  'Wat er gebeurt als u meedoet': 'Što se događa kada se pridružite',
  'Verlaten': 'Napusti',
  'Weigeren en verlaten': 'Odbij i napusti',
  'Toestemming geven': 'Daj privolu',
  'Technische code: {code}': 'Tehnički kod: {code}',
  'Deelnemers ({aantal})': 'Sudionici ({aantal})',
  'Nog geen deelnemers.': 'Još nema sudionika.',
  'Deze vergadering geeft geen deelnemerslijst.':
      'Ovaj sastanak ne daje popis sudionika.',
  'gast': 'gost',
  'deelnemer': 'sudionik',
  'presentator': 'izlagač',
  'moderator': 'moderator',
  'organisator': 'organizator',
  'rol onbekend': 'nepoznata uloga',
  'Bord': 'Ploča',
