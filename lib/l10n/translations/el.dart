...
const _dutchSourceAddEl = <String, String>{
  ...
  'tabellen': 'πίνακες',
  'afbeeldingen': 'εικόνες',
  'Document importeren…': 'Εισαγωγή εγγράφου…',
  'Document kiezen': 'Επιλογή εγγράφου',
  'Document geïmporteerd.': 'Το έγγραφο εισήχθη.',
  'Importeren uit Word of LibreOffice…': 'Εισαγωγή από Word ή LibreOffice…',
  ...
  'Aangemaakt op': 'Δημιουργήθηκε στις',
  'Aanmeldprovider': 'Πάροχος σύνδεσης',
  'Aanmeldsessies': 'Συνεδρίες εγγραφής',
  'Aantal controles': 'Αριθμός ελέγχων',
  ...
  'Activiteitnummer': 'Αριθμός δραστηριότητας',
  'Afgerond op': 'Στρογγυλεμένο σε',
  'Afgewezen': 'Απορρίφθηκε',
  'Afspeelsessienummer': 'Αριθμός συνεδρίας αναπαραγωγής',
  'Afwezig': 'Απών',
  'Antwoordgegevens': 'Απαντήστε στις λεπτομέρειες',
  'Antwoordstatus': 'Κατάσταση απάντησης',
  'Begint op': 'Ξεκινά',
  'Begrippen uitgelegd': 'Έννοιες εξηγούνται',
  'Beheer van de installatie': 'Διαχείριση της εγκατάστασης',
  'Beheerpogingen': 'Διοικητικές προσπάθειες',
  'Bekeken lessen': 'Προβλήθηκαν μαθήματα',
  'Beleidsversie': 'Έκδοση πολιτικής',
  'Beoordeeld': 'Βαθμολογήθηκε',
  'Beoordeeld op': 'Βαθμολογήθηκε από',
  'Beperking': 'Περιορισμός',
  'Berekend op': 'Υπολογίστηκε στις',
  'Bericht': 'Μήνυμα',
  'Bestandsnaam': 'Όνομα αρχείου',
  'Beveiligingsvraagnummer': 'Αριθμός ερώτησης ασφαλείας',
  'Bevestigd': 'Επιβεβαιώθηκε',
  'Bevestigd op': 'Επιβεβαιώθηκε στις',
  'Bewaarregels': 'Κανόνες διατήρησης',
  'Bewaartermijn': 'Περίοδος διατήρησης',
  'Bewaren wegens een juridische verplichting':
      'Διατηρήθηκε λόγω νομικής υποχρέωσης',
  'Bewerkingnummer bij aanmeldprovider':
      'Αριθμός λειτουργίας στον πάροχο εγγραφής',
  'Bewijsstukken': 'Στοιχεία',
  'Bezwaar': 'Ένσταση',
  'Beëindigd op': 'Τελείωσε στις',
  'Bijeenkomstnummer': 'Αριθμός συνάντησης',
  'Certificaatnummer': 'Αριθμός πιστοποιητικού',
  'Certificaten': 'Πιστοποιητικά',
  'Controlecode van de PDF': 'Κωδικός ελέγχου του PDF',
  'Controlecode van profielfoto': 'Κωδικός επαλήθευσης φωτογραφίας προφίλ',
  'Controlecodes van bewijsstukken': 'Κωδικοί ελέγχου των δικαιολογητικών',
  'Correctie': 'Διόρθωση',
  'Cursistnummer waarop de actie gericht was':
      'Αριθμός μαθητή στον οποίο απευθυνόταν η δράση',
  'Cursusaanbodnummer': 'Αριθμός προσφοράς μαθήματος',
  'Cursusversienummer': 'Αριθμός έκδοσης μαθήματος',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Οι ημερομηνίες και οι ώρες εμφανίζονται στην τοπική σας ώρα. Τα τεχνικά ονόματα παραμένουν ορατά όταν ο διακομιστής παρέχει ένα άγνωστο πεδίο.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'Οι απαντήσεις που δώσατε στις ερωτήσεις του τεστ.',
  'Deelnamenummer': 'Αριθμός συμμετοχής',
  'Deelnames': 'Συμμετοχές',
  'Details': 'Λεπτομέρειες',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Αυτή η κατηγορία παρέχεται από τον διακομιστή. Τα τεχνικά ονόματα παραμένουν ορατά για ερωτήσεις από τον οργανισμό σας.',
  'Door uzelf aangevraagd': 'Ζητήθηκε από τον εαυτό σας',
  'E-mailadres': 'Διεύθυνση ηλεκτρονικού ταχυδρομείου',
  'E-mailberichten': 'Μηνύματα ηλεκτρονικού ταχυδρομείου',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'Το αναγνωριστικό είναι ένας μοναδικός τεχνικός αριθμός που χρησιμοποιεί το eLearning για τη σύνδεση δεδομένων μεταξύ τους. Δεν είναι βαθμολογία ή κατάσταση.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'Μια κατηγορία ομαδοποιεί δεδομένα για το ίδιο θέμα. Μια εγγραφή είναι ένα αποθηκευμένο κομμάτι δεδομένων ή ένα συμβάν.',
  'Eindigt op': 'Τελειώνει σε',
  'Geaccepteerd op': 'Αποδεκτό στις',
  'Geannuleerd': 'Ακυρώθηκε',
  'Gecontroleerd': 'Ελεγμένο',
  'Gecontroleerd op': 'Έλεγξε',
  'Geen gegevens gevonden': 'Δεν βρέθηκαν δεδομένα',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Πληροφορίες σχετικά με τις περιόδους διατήρησης και τη διαγραφή των δεδομένων σας.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Πληροφορίες σχετικά με δικαιολογητικά, αποτελέσματα και πιστοποιητικά.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Πληροφορίες σχετικά με αιτήματα απορρήτου και ποιοι είδαν ή άλλαξαν τα στοιχεία σας.',
  'Gegevens over uw accountbewerking':
      'Πληροφορίες σχετικά με τη λειτουργία του λογαριασμού σας',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Πληροφορίες για την εγγραφή, τη συμμετοχή και την πρόοδό σας στα μαθήματα.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Πληροφορίες σχετικά με το προφίλ, τον λογαριασμό και τη θέση σας στον οργανισμό.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Πληροφορίες για τις δοκιμαστικές στιγμές σας και τις ερωτήσεις που παρουσιάστηκαν.',
  'Gegevens over willekeurige volgorde': 'Δεδομένα τυχαίας παραγγελίας',
  'Gegevenscategorie': 'Κατηγορία δεδομένων',
  'Gekoppeld accountnummer': 'Συνδεδεμένος αριθμός λογαριασμού',
  'Gekozen antwoorden': 'Επιλεγμένες απαντήσεις',
  'Gelukt': 'Επιτυχία',
  'Geprobeerd op': 'Δοκιμασμένο',
  'Gerechtvaardigd belang': 'Έννομο συμφέρον',
  'Gereserveerd': 'Με κράτηση',
  'Gereserveerd op': 'Έγινε κράτηση στις',
  'Geslaagd': 'Πέρασε',
  'Gestart op': 'Ξεκίνησε στις',
  'Getoonde tijd per dia in milliseconden':
      'Ο χρόνος που εμφανίζεται ανά διαφάνεια σε χιλιοστά του δευτερολέπτου',
  'Herkomst van inschrijving': 'Προέλευση εγγραφής',
  'Hoogst haalbare score': 'Η υψηλότερη δυνατή βαθμολογία',
  'Identificatienummer bij aanmeldprovider':
      'Αριθμός αναγνώρισης για τον πάροχο εγγραφής',
  'Identiteitsbewerkingnummer': 'Αριθμός λειτουργίας ταυτότητας',
  'In afwachting': 'Σε εκκρεμότητα',
  'In behandeling': 'Σε εξέλιξη',
  'In behandeling genomen op': 'Επεξεργασία στις',
  'In quarantaine': 'Σε καραντίνα',
  'Ingeleverd': 'Υποβλήθηκε',
  'Ingeleverd op': 'Υποβλήθηκε στις',
  'Ingericht op': 'Διακοσμημένο σε',
  'Ingeschreven op': 'Εγγεγραμμένος στις',
  'Ingetrokken': 'Αποσύρθηκε',
  'Ingetrokken op': 'Αποσύρθηκε στις',
  'Inschrijvingen': 'Εγγραφές',
  'Inschrijvingsnummer': 'Αριθμός εγγραφής',
  'Installatiebeveiligingslogboek': 'Ημερολόγιο ασφαλείας εγκατάστασης',
  'Installatienummer': 'Αριθμός εγκατάστασης',
  'Installatieverzoeken': 'Αιτήματα εγκατάστασης',
  'Inzage': 'Επιθεώρηση',
  'Ja': 'Ναι',
  'Kwalificatienummer': 'Αριθμός προσόντων',
  'Kwalificaties': 'Προσόντα',
  'Laatst actief op': 'Τελευταία ενεργή ενεργοποίηση',
  'Laatst bekeken dia': 'Τελευταία προβολή διαφάνεια',
  'Laatst gewijzigd op': 'Τελευταία τροποποίηση στις',
  'Laatste fout': 'Τελευταίο λάθος',
  'Lesnummer': 'Αριθμός μαθήματος',
  'Lesreserveringen': 'Κρατήσεις μαθημάτων',
  'Lesvoortgang': 'Πρόοδος μαθήματος',
  'Lidmaatschappen': 'Συνδρομές',
  'Locatie': 'Τοποθεσία',
  'Manier van afronden': 'Τρόπος στρογγυλοποίησης',
  'Maximaal aantal controles': 'Μέγιστος αριθμός επιταγών',
  'Maximaal aantal pogingen': 'Μέγιστος αριθμός προσπαθειών',
  'Maximale leeftijd van de aanmelding': 'Ανώτατο όριο ηλικίας εγγραφής',
  'Mislukt': 'Απέτυχε',
  'Naam van de activiteit': 'Όνομα της δραστηριότητας',
  'Naam van de bijeenkomst': 'Όνομα της συνάντησης',
  'Nee': 'Όχι',
  'Netwerkadres': 'Διεύθυνση δικτύου',
  'Niet actief': 'Μη ενεργό',
  'Niet geregistreerd': 'Μη εγγεγραμμένος',
  'Niet ingevuld': 'Μη συμπληρωμένο',
  'Niet verschenen': 'Δεν δημοσιεύτηκε',
  'Niveau van extra aanmeldcontrole': 'Επίπεδο πρόσθετου ελέγχου εγγραφής',
  'Nummer van de toetsopzet': 'Αριθμός του σχεδίου δοκιμής',
  'Nummer van het brongegeven': 'Αριθμός των δεδομένων πηγής',
  'Nummer van uw verwijderde gegeven':
      'Ο αριθμός των διαγραμμένων δεδομένων σας',
  'Onderdeel {nummer}': 'Μέρος {nummer}',
  'Onderwerp van de actie': 'Αντικείμενο της δράσης',
  'Ontvanger': 'Παραλήπτης',
  'Opgegeven bestandsgrootte': 'Καθορισμένο μέγεθος αρχείου',
  'Opgegeven bestandstype': 'Καθορισμένος τύπος αρχείου',
  'Opgegeven controlecode': 'Καθορισμένος κωδικός ελέγχου',
  'Opgeslagen bestandsgrootte': 'Αποθηκευμένο μέγεθος αρχείου',
  'Opgeslagen controlecode': 'Αποθηκευμένος κωδικός ελέγχου',
  'Organisatienummer': 'Αριθμός οργανισμού',
  'Overdraagbaarheid': 'Μεταβιβασιμότητα',
  'PE-toekenningnummer': 'Αριθμός βραβείου PE',
  'Poging': 'Προσπάθεια',
  'Positie': 'Θέση',
  'Privacyverzoeken': 'Αιτήματα απορρήτου',
  'Probeer een andere zoekterm.': 'Δοκιμάστε έναν διαφορετικό όρο αναζήτησης.',
  'Reden': 'Λόγος',
  'Reden of grondslag': 'Λόγος ή βάση',
  'Reden van afwijzing': 'Λόγος απόρριψης',
  'Reden van bevestiging': 'Λόγος επιβεβαίωσης',
  'Reden van intrekking': 'Λόγος απόσυρσης',
  'Reden voor langer bewaren': 'Λόγος για μεγαλύτερη αποθήκευση',
  'Regels voor de cursusversie': 'Κανόνες για την έκδοση του μαθήματος',
  'Resultaat bij de aanmeldprovider': 'Αποτέλεσμα στον πάροχο εγγραφής',
  'Rol': 'Ρολό',
  'Score': 'Σκορ',
  'Soort aanwezigheid': 'Είδος παρουσίας',
  'Soort accountbewerking': 'Τύπος λειτουργίας λογαριασμού',
  'Soort gebeurtenis': 'Είδος εκδήλωσης',
  'Soort privacyverzoek': 'Τύπος αιτήματος απορρήτου',
  'Status van de bijeenkomst': 'Κατάσταση της συνάντησης',
  'Strenge beveiligingsmodus': 'Λειτουργία υψηλής ασφάλειας',
  'Technisch toegangslogboek': 'Μητρώο τεχνικής πρόσβασης',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Τεχνικά δεδομένα που απαιτούνται για εγγραφή, ασφάλεια και αξιόπιστη επεξεργασία.',
  'Technische naam: {naam}': 'Τεχνική ονομασία: {naam}',
  'Technische opslagcategorie': 'Κατηγορία τεχνικής αποθήκευσης',
  'Technische opslaglocatie van de PDF': 'Τεχνική θέση αποθήκευσης του PDF',
  'Tijdstip van aanmelding': 'Ώρα εγγραφής',
  'Tijdzone': 'Ζώνη ώρας',
  'Toestand': 'Κατάσταση',
  'Toetspogingen': 'Δοκιμαστικές προσπάθειες',
  'Toetspogingnummer': 'Αριθμός προσπάθειας δοκιμής',
  'Uiterste inlevermoment': 'Προθεσμία υποβολής',
  'Uitgegeven op': 'Δημοσιεύθηκε στις',
  'Uitgenodigd e-mailadres': 'Προσκεκλημένη διεύθυνση email',
  'Uitnodigingen': 'Προσκλήσεις',
  'Uniek nummer (ID)': 'Μοναδικός αριθμός (ID)',
  'Uniek verwerkingskenmerk': 'Μοναδική δυνατότητα επεξεργασίας',
  'Uw accountnummer': 'Ο αριθμός του λογαριασμού σας',
  'Uw accountnummer als uitvoerder': 'Ο αριθμός λογαριασμού σας ως εκτελεστής',
  'Uzelf als uploader': 'Τον εαυτό σας ως ανέβασμα',
  'Vaardigheidsversienummer': 'Αριθμός έκδοσης δεξιοτήτων',
  'Vast internetadres van de installatie':
      'Σταθερή διεύθυνση Διαδικτύου της εγκατάστασης',
  'Vastgelegde beslisgegevens': 'Καταγεγραμμένα δεδομένα απόφασης',
  'Vastgelegde gegevens': 'Καταγεγραμμένα δεδομένα',
  'Vereist niveau van aanmeldzekerheid':
      'Απαιτούμενο επίπεδο βεβαιότητας εγγραφής',
  'Vereiste aanmeldmethoden': 'Απαιτούμενοι τρόποι σύνδεσης',
  'Verloopt bij inactiviteit op': 'Λήγει όταν είναι ανενεργό',
  'Verloopt definitief op': 'Λήγει οριστικά',
  'Verloopt op': 'Λήγει',
  'Versienummer van de PE-regel': 'Αριθμός έκδοσης του κανόνα PE',
  'Verwerkte verzoeken': 'Επεξεργασμένα αιτήματα',
  'Verwijderd op': 'Καταργήθηκε στις',
  'Verwijdering': 'Αφαίρεση',
  'Verwijderingsregister': 'Μητρώο αφαίρεσης',
  'Verwijzing naar het antwoord': 'Αναφορά στην απάντηση',
  'Verzoeknummer': 'Αριθμός αιτήματος',
  'Verzoeknummer van de app': 'Αριθμός αιτήματος εφαρμογής',
  'Verzonden op': 'Στάλθηκε',
  'Volgende controle op': 'Επόμενος έλεγχος',
  'Volgnummer': 'Αριθμός ακολουθίας',
  'Volgorde van antwoordopties': 'Σειρά επιλογών απάντησης',
  'Vraagnummer binnen de toetspoging':
      'Αριθμός ερώτησης στην προσπάθεια δοκιμής',
  'Vraagversienummer': 'Αριθμός έκδοσης ερώτησης',
  'Vragen in toetspogingen': 'Ερωτήσεις σε δοκιμαστικές προσπάθειες',
  'Vrijgegeven': 'Απελευθερώθηκε',
  'Vrijgegeven op': 'Κυκλοφόρησε στις',
  'Wat gebeurt na de bewaartermijn': 'Τι συμβαίνει μετά την περίοδο διατήρησης',
  'Wettelijke verplichting': 'Νομική υποχρέωση',
  'Wijzigingen aan PE-punten': 'Αλλαγές στα σημεία PE',
  'Wijzigingen aan kwalificaties': 'Αλλαγές στα προσόντα',
  'Wijzigingen in aanmeldbeveiliging': 'Αλλαγές στην ασφάλεια σύνδεσης',
  'Zekerheid': 'Βεβαιότητα',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Για παράδειγμα, αναζητήστε ανά μάθημα, ημερομηνία ή κατάσταση',
  'Zoeken in uw gegevens': 'Αναζητήστε τα δεδομένα σας',
  '{aantal} categorieën gevonden': 'Βρέθηκαν κατηγορίες {aantal}',
  ...
  'eLearning-aanmelding is alleen beschikbaar in de desktop-app, omdat de webversie geen veilige sleutelbos heeft.':
      'Η σύνδεση στο eLearning είναι διαθέσιμη μόνο στην εφαρμογή υπολογιστή, επειδή η έκδοση ιστού δεν διαθέτει ασφαλή κλειδοθήκη.',
  'eLearning-server': 'Διακομιστής eLearning',
  'Bij het volgen van een cursus stuurt OciDeck uw laatste dia, voltooiing en getoonde tijd per dia naar de gekozen eLearning-organisatie. Antwoorden, notities en cursusinhoud worden niet als voortgang verstuurd.':
      'Κατά την παρακολούθηση ενός μαθήματος, το OciDeck στέλνει στον επιλεγμένο οργανισμό eLearning την τελευταία διαφάνεια, την ολοκλήρωση και τον χρόνο εμφάνισης ανά διαφάνεια. Απαντήσεις, σημειώσεις και περιεχόμενο μαθήματος δεν αποστέλλονται ως πρόοδος.',
  'Ingelogd bij eLearning': 'Συνδεδεμένοι στο eLearning',
  'Deze eLearning-server gebruikt {host} voor het aanmelden. Er worden pas gegevens met die identiteitsprovider uitgewisseld nadat u dit toestaat.':
      'Αυτός ο διακομιστής eLearning χρησιμοποιεί το {host} για σύνδεση. Δεδομένα ανταλλάσσονται με αυτόν τον πάροχο ταυτότητας μόνο αφού το επιτρέψετε.',
  'Gebruik een HTTPS-adres voor eLearning.':
      'Χρησιμοποιήστε μια διεύθυνση HTTPS για το eLearning.',
  'Vul een geldig eLearning-adres in.':
      'Εισαγάγετε έγκυρη διεύθυνση eLearning.',
  ...
  'Het token heeft de repo-scope nodig (of fijnmazig: Contents lezen en schrijven).':
      'Το διακριτικό χρειάζεται το εύρος repo (ή αναλυτικά: Contents ανάγνωση και εγγραφή).',
  ...
  'IMSI van een abonnee': 'IMSI ενός συνδρομητή',
  'sociale-mediaprofiel': 'προφίλ σε μέσα κοινωνικής δικτύωσης',
  'advertentie- of apparaat-ID': 'αναγνωριστικό διαφήμισης ή συσκευής',
  ...
  'AI-assistentie (staat standaard uit): kies je een zelf-gehoste of cloud-backend, dan worden de teksten of afbeeldingen die je laat verwerken naar dat adres gestuurd. Wat je hebt geredigeerd, gaat er eerst uit. Een lokaal AI-model op dit apparaat verstuurt niets.':
      'Βοήθεια AI (ανενεργή από προεπιλογή): αν επιλέξεις self-hosted ή cloud backend, τα κείμενα ή οι εικόνες που δίνεις για επεξεργασία στέλνονται σε εκείνη τη διεύθυνση. Ό,τι έχεις αποκρύψει αφαιρείται πρώτα. Ένα τοπικό μοντέλο AI σε αυτή τη συσκευή δεν στέλνει τίποτα.',
  'Gegevens weglaten (redactie)': 'Παράλειψη δεδομένων (απόκρυψη)',
  'Zet je tekst tussen dubbele blokhaken, zoals [[het adres]], dan laat OciDeck die weg uit alles wat je toont en exporteert. Op de dia, in de presentatie, in de PDF, de PowerPoint en de HTML verschijnen alleen blokken.':
      'Βάλε κείμενο μέσα σε διπλές αγκύλες, όπως [[η διεύθυνση]], και το OciDeck το παραλείπει από όλα όσα δείχνεις και εξάγεις. Στη διαφάνεια, στην παρουσίαση, στο PDF, στο PowerPoint και στο HTML εμφανίζονται μόνο μπλοκ.',
  'Weggelaten is écht weggelaten, niet afgedekt. De tekst zit niet als onzichtbare laag onder een zwart balkje in de PDF, niet in de sprekersnotities van de PowerPoint, en niet in de broncode van de HTML. Wie het bestand openmaakt, kan er niets uit terughalen.':
      'Παραλειμμένο σημαίνει πραγματικά παραλειμμένο, όχι σκεπασμένο. Το κείμενο δεν βρίσκεται ως αόρατο στρώμα κάτω από μια μαύρη μπάρα στο PDF, ούτε στις σημειώσεις ομιλητή του PowerPoint, ούτε στον πηγαίο κώδικα του HTML. Όποιος ανοίξει το αρχείο δεν μπορεί να ανακτήσει τίποτα.',
  'Je eigen bestand verandert niet. De oorspronkelijke tekst blijft in je markdown staan; redactie geldt alleen voor wat je deelt. Zo houd je je eigen gegevens.':
      'Το δικό σου αρχείο δεν αλλάζει. Το αρχικό κείμενο παραμένει στο markdown σου· η απόκρυψη ισχύει μόνο για ό,τι μοιράζεσαι. Έτσι κρατάς τα δικά σου δεδομένα.',
  ...
  'LibrePlan importeren': 'Εισαγωγή από το LibrePlan',
  ...
  'Gantt-planning': 'Χρονοδιάγραμμα Gantt',
  'WBS (hiërarchie)': 'WBS (ιεραρχία)',
  'Projectstatus (cockpit)': 'Κατάσταση έργου (cockpit)',
  'Milestones (tijdlijn)': 'Ορόσημα (χρονογραμμή)',
  'Kritieke pad (flow)': 'Κρίσιμη διαδρομή (ροή)',
  'Resources (tabel)': 'Πόροι (πίνακας)',
  'Timesheet (tabel)': 'Φύλλο χρόνου (πίνακας)',
  'Resourcebelasting (grafiek)': 'Φόρτος πόρων (γράφημα)',
