...
const _stringsFr = {
  ...
  'exportAsPdf': 'PDF (image par diapositive)',
  'exportAsPptx': 'PowerPoint',
  'exportAsOdp': 'Présentation OpenDocument',
  'exportAsHtml': 'Fichier HTML (fonctionne hors ligne)',
  'exportAsLatex': 'Source LaTeX',
...
const _dutchSourceFr = {
  ...
  'Laatste reeks als lijn op een tweede as; de rest als staven.':
      'Dernière série en ligne sur un second axe ; les autres en barres.',
  'Eerste reeks: elke waarde is een op- of neerwaartse stap op het vorige totaal.':
      'Première série : chaque valeur est un pas vers le haut ou le bas sur le cumul.',
  'Reeks = rij, kolom = label, celkleur volgt de waarde. Label de assen kans en impact voor een risicomatrix.':
      'Série = ligne, colonne = étiquette, la couleur de la cellule suit la valeur. Nommez les axes probabilité et impact pour une matrice des risques.',
  'Auditdossier exporteren': 'Exporter le dossier d\'audit',
  'Finaliseer en verzegel het rapport eerst.':
      'Finalisez et scellez d\'abord le rapport.',
  'Auditdossier geëxporteerd naar:': 'Dossier d\'audit exporté vers :',
  ...
  'Scope-dekking controleren': 'Vérifier la couverture du périmètre',
  'Scope-dekking': 'Couverture du périmètre',
  'Geen dekkingsgaten': 'Aucune lacune de couverture',
  'In scope, maar niet getest en geen bevinding:':
      'Dans le périmètre, mais non testé et sans constatation :',
  'MIAUW-compliance': 'Conformité MIAUW',
  'Voldaan': 'Satisfait',
  'Openstaand': 'Ouvert',
  'Uitgesloten door klant': 'Exclu par le client',
  'Handmatig': 'Manuel',
  'Uitsluiten': 'Exclure',
  'Opheffen': 'Rétablir',
  'Reden voor uitsluiting': 'Motif de l\'exclusion',
  'Fundamentele eisen zijn uitgesloten':
      'Des exigences fondamentales sont exclues',
  'Nieuwe bevinding (wizard)': 'Nouvelle constatation (assistant)',
  'Bevinding maken': 'Créer la constatation',
  'CIA-rating (scope-object)': 'Évaluation CIA (objet de périmètre)',
  'Vertrouwelijkheid': 'Confidentialité',
  'Integriteit': 'Intégrité',
  'Beschikbaarheid': 'Disponibilité',
  'Detailslide toevoegen': 'Ajouter une diapositive de détail',
  'Bewijsslide toevoegen': 'Ajouter une diapositive de preuve',
  'CIA-gewogen': 'Pondéré CIA',
  'Severity (bevindingen)': 'Gravité (constatations)',
  'CWE kiezen': 'Choisir un CWE',
  'Zoek op naam of CWE-nummer': 'Rechercher par nom ou numéro CWE',
  'Geen CWE gevonden': 'Aucun CWE trouvé',
  'Kies CWE…': 'Choisir un CWE…',
  ...
  'Alle afbeeldingen hebben al tags.':
      'Toutes les images ont déjà des étiquettes.',
  'Afbeeldingen taggen…': 'Étiquetage des images…',
  'afbeeldingen getagd door AI.': 'images étiquetées par l\'IA.',
  'Ongetagde afbeeldingen taggen met AI':
      'Étiqueter les images sans étiquette avec l\'IA',
  'Ongedaan maken': 'Annuler',
  'Kon de afbeelding niet lezen voor AI-analyse.':
      'Impossible de lire l\'image pour l\'analyse IA.',
  'Het model gaf geen alt-tekst terug.':
      'Le modèle n\'a renvoyé aucun texte alternatif.',
  'Er staat al alt-tekst. Vervangen door het AI-concept?':
      'Un texte alternatif existe déjà. Le remplacer par le brouillon IA ?',
  'Vervangen': 'Remplacer',
  'AI-assistentie is niet beschikbaar. Controleer de instellingen.':
      'L\'assistance IA n\'est pas disponible. Vérifiez les paramètres.',
  'De AI-aanroep is mislukt (model niet geladen of server onbereikbaar).':
      'L\'appel IA a échoué (modèle non chargé ou serveur injoignable).',
  'Bezig met AI-analyse…': 'Analyse IA en cours…',
  'Stel alt-tekst voor (AI)': 'Proposer un texte alternatif (IA)',
  ...
  'Nog niet ondertekend': 'Pas encore signé',
  'Nog niet verzegeld': 'Pas encore scellé',
  'Verzegeld op': 'Scellé le',
  ...
  'Object': 'Objet',
  'gedekt': 'couvert',
  'Object toevoegen': 'Ajouter un objet',
  'Object verwijderen': 'Supprimer l\'objet',
  'Niet getest': 'Non testé',
  'Getest': 'Testé',
  ...
  'Alle': 'Tout',
  'Linksom': 'Pivoter à gauche',
  'Rechtsom': 'Pivoter à droite',
  ...
  'Techniek': 'Technique',
  'Licentie en naleving': 'Licence et conformité',
  'Architectuur': 'Architecture',
  'Licentienaleving': 'Conformité des licences',
  'Softwarestuklijst (SBOM)': 'Nomenclature logicielle (SBOM)',
  ...
  'Gebruikershandleiding': 'Guide de l\'utilisateur',
  'Bestandsformaat': 'Format de fichier',
  'Online openen': 'Ouvrir en ligne',
  ...
  '"Oci" verwijst naar de ocicat, het kattenras van de katten van Brenno de Winter. "Deck" is het Engelse woord voor een diaset. OciDeck maakt van eenvoudige tekst een verzorgde presentatie.':
      '« Oci » fait référence à l\'ocicat, la race des chats de Brenno de Winter. « Deck » est le mot anglais désignant un jeu de diapositives. OciDeck transforme un texte simple en une présentation soignée.',
  'Adressen': 'Adresses',
  ...
  'Brenno de Winter (voorzitter), Jan Klopper (secretaris) en Astrid Oosenbrug (penningmeester).':
      'Brenno de Winter (président), Jan Klopper (secrétaire) et Astrid Oosenbrug (trésorière).',
  'Contact': 'Contact',
  'De katten van Brenno': 'Les chats de Brenno',
  ...
  'Mascotte van de checklisttool.':
      'Mascotte de l\'outil de liste de contrôle.',
  'OciDeck wordt uitgegeven door Stichting LibreKAT. De stichting werkt aan een veiligere digitale samenleving via open, controleerbare informatiebeveiliging, met de nadruk op kennisdeling, community-vorming en het ondersteunen van opensource-oplossingen.':
      'OciDeck est publié par la Stichting LibreKAT. La fondation œuvre pour une société numérique plus sûre grâce à une sécurité de l\'information ouverte et vérifiable, en mettant l\'accent sur le partage des connaissances, la création de communautés et le soutien aux solutions open source.',
  'Over OciDeck': 'À propos d\'OciDeck',
  'Telefoon': 'Téléphone',
  'Uitgever: Stichting LibreKAT': 'Éditeur : Stichting LibreKAT',
  ...
  'Afronden & verzegelen': 'Finaliser et sceller',
  'Verzegelen': 'Sceller',
  'Handtekening (optioneel)': 'Signature (facultative)',
  'Naam': 'Nom',
  'Rol of functie': 'Rôle ou fonction',
  'Verklaring': 'Déclaration',
  'Getypte handtekening': 'Signature saisie',
  'Deze presentatie is afgerond en verzegeld en kan niet worden bewerkt.':
      'Cette présentation est finalisée et scellée et ne peut pas être modifiée.',
  'Integriteit intact': 'Intégrité intacte',
  'Gewijzigd na afronden': 'Modifié après la finalisation',
  'Verzegeld met SHA-512. De inhoud komt overeen met het zegel.':
      'Scellé avec SHA-512. Le contenu correspond au sceau.',
  'De inhoud wijkt af van het zegel — het bestand is na het afronden gewijzigd.':
      'Le contenu diffère du sceau — le fichier a été modifié après la finalisation.',
  'Presentatie afgerond en verzegeld.': 'Présentation finalisée et scellée.',
};
...
const _dutchSourceAddFr = {
  ...
  'OciDeck vraagt dan maximaal eenmaal per dag aan pawprint.vigilis.online of er een nieuwere versie is.':
      'OciDeck demande alors au maximum une fois par jour à pawprint.vigilis.online si une version plus récente existe.',
  'Controleer nu': 'Vérifier maintenant',
  'De controle is mislukt — probeer het later opnieuw.':
      'La vérification a échoué — réessayez plus tard.',
  'Er is geen nieuwere versie.': 'Il n\'existe pas de version plus récente.',
  'OciDeck {versie} is beschikbaar.': 'OciDeck {versie} est disponible.',
  'Download': 'Télécharger',
  'OciDeck {versie} is beschikbaar — tik om de releasepagina te openen.':
      'OciDeck {versie} est disponible — appuyez pour ouvrir la page de la version.',
  ...
  'Kies de backend op het tabblad Integraties. Zolang daar niets staat, gebeurt er niets.':
      'Choisissez le backend dans l\'onglet Intégrations. Tant que rien n\'y est défini, rien ne se passe.',
  'Configureer de server op het tabblad Integraties. Zolang daar niets staat, gebeurt er niets.':
      'Configurez le serveur dans l\'onglet Intégrations. Tant qu\'il n\'y a rien, rien ne se passe.',
  'eLearning volgen': 'Suivre un eLearning',
  'eLearning maken': 'Créer un eLearning',
  'Koppelingen met andere systemen. Elke koppeling staat standaard uit; aanzetten doet u bij Uitbreidingen, uitzetten kan hier.':
      'Connexions à d\'autres systèmes. Chaque connexion est désactivée par défaut ; activez-la dans Extensions, désactivez-la ici.',
  'Deze koppeling staat uit. Zet hem aan bij Uitbreidingen.':
      'Cette connexion est désactivée. Activez-la dans Extensions.',
  'Instellen doet u op het tabblad Integraties.':
      'Configurez-la dans l\'onglet Intégrations.',
  ...
  'Dit document verwijst naar afbeeldingen of grafiekdata in losse bestanden. Een kale .md- of .tex-download bevat alleen de tekst — bij de ontvanger zijn de verwijzingen dood. Kies HTML, PDF of DOCX om alles in één bestand te leveren, of ga door als alleen de tekst telt.':
      'Ce document fait référence à des images ou des données de graphiques dans des fichiers séparés. Un téléchargement .md ou .tex brut ne contient que le texte — les références sont mortes pour le destinataire. Choisissez HTML, PDF ou DOCX pour tout livrer dans un seul fichier, ou continuez si seul le texte compte.',
  'Datum en tijd kiezen': 'Choisir la date et l’heure',
  'Deze lokale tijd bestaat niet door de overgang naar zomertijd. Kies een andere tijd.':
      'Cette heure locale n’existe pas en raison du passage à l’heure d’été. Choisissez une autre heure.',
  'Deze lokale tijd komt twee keer voor. Kies de juiste UTC-offset.':
      'Cette heure locale se produit deux fois. Choisissez le bon décalage UTC.',
  'Een datum blijft een datum. Kies je ook een tijd, dan slaat OciDeck het tijdstip op in UTC en toont het met de lokale UTC-offset.':
      'Une date reste une date. Si vous choisissez également une heure, OciDeck enregistre l’instant en UTC et l’affiche avec le décalage UTC local.',
  ...
  'De volledige tekst verhuist naar de speakernotities — er gaat niets verloren.':
      'Le texte complet est déplacé dans les notes de l\'orateur — rien n\'est perdu.',
  'Korte samenvatting': 'Résumé court',
  'Eén alinea die op één dia past.':
      'Un paragraphe qui tient sur une diapositive.',
  'Kernpunten (max. 8)': 'Points clés (max. 8)',
  'Een compacte lijst met de hoofdpunten.':
      'Une liste compacte des points principaux.',
  'Genereer': 'Générer',
  ...
  'Aanbod': 'Offre',
  'Aanwezig geweest': 'Était présent',
  'Afmelden': 'Se désinscrire',
  'Afmelden voor bijeenkomst': 'Se désinscrire de la séance',
  'Afzien': 'Refuser',
  'Bekijk mijn inschrijvingen': 'Voir mes inscriptions',
  'Bekijk welke bewijsstukken u heeft ingediend.':
      'Consultez les preuves que vous avez soumises.',
  'Binnenkort': 'Bientôt',
  'De code wordt niet opgeslagen en alleen bij inschrijven verstuurd.':
      'Le code n\'est pas enregistré et n\'est envoyé que lors de l\'inscription.',
  'De gekozen sessie is vol. Kies een andere sessie of plaats u op de wachtlijst.':
      'La séance choisie est complète. Choisissez une autre séance ou inscrivez-vous sur liste d\'attente.',
  ...
  'Deze code klopt niet — controleer de code op typefouten.':
      'Ce code n\'est pas correct — vérifiez les fautes de frappe.',
  'Deze sessie overlapt met een bestaande afspraak in uw agenda.':
      'Cette séance chevauche un rendez-vous existant dans votre agenda.',
  'Deze vouchercode is niet geldig voor deze uitvoering.':
      'Ce code de bon n\'est pas valable pour cette session.',
  'Dit aanbod is niet meer geldig. De lijst is ververst.':
      'Cette offre n\'est plus valable. La liste a été actualisée.',
  'Er is een plaats vrij': 'Une place est libre',
  'Er is een plaats vrij voor u. Bevestig zo snel mogelijk — het aanbod vervalt uiterlijk {deadline}.':
      'Une place est disponible pour vous. Confirmez dès que possible — l\'offre expire au plus tard le {deadline}.',
  'Er is nu geen aanbod om u voor in te schrijven.':
      'Il n\'y a actuellement aucune offre à laquelle vous inscrire.',
  'Geen sessies gepland.': 'Aucune séance prévue.',
  'Geweest': 'Passées',
  'Het aanbod kon niet worden opgehaald.':
      'L\'offre n\'a pas pu être récupérée.',
  'In uw tijdzone: {datum} · {van}–{tot}':
      'Dans votre fuseau horaire : {datum} · {van}–{tot}',
  ...
  'Inschrijven kan pas als u aan alle toelatingseisen voldoet.':
      'Vous ne pouvez vous inscrire que lorsque vous remplissez toutes les conditions d\'admission.',
  'Inschrijven voor deze uitvoering is gesloten.':
      'Les inscriptions à cette session sont closes.',
  'Kies per les precies één sessie.':
      'Choisissez exactement une séance par leçon.',
  'Mijn inschrijvingen': 'Mes inscriptions',
  'Niet aanwezig geweest': 'Était absent',
  'Onbekende status': 'Statut inconnu',
  'Op de wachtlijst': 'Sur liste d\'attente',
  'Op de wachtlijst, plaats {plaats} van {totaal}':
      'Sur liste d\'attente, position {plaats} sur {totaal}',
  'Plaats mij op de wachtlijst voor de volle sessie(s)':
      'M\'inscrire sur liste d\'attente pour la ou les séances complètes',
  'Schrijf u zelf in voor een uitvoering van deze organisatie.':
      'Inscrivez-vous vous-même à une session de cette organisation.',
  'Sessie': 'Séance',
  'Te veel pogingen — probeer het over {seconden} seconden opnieuw.':
      'Trop de tentatives — réessayez dans {seconden} secondes.',
  'Toelatingseisen': 'Conditions d\'admission',
  ...
  'U bent nog niet ingeschreven voor een bijeenkomst.':
      'Vous n\'êtes encore inscrit à aucune séance.',
  'U heeft het maximum aantal inschrijvingen voor deze uitvoering bereikt.':
      'Vous avez atteint le nombre maximal d\'inscriptions pour cette session.',
  'U voldoet nog niet aan de toelatingseisen.':
      'Vous ne remplissez pas encore les conditions d\'admission.',
  'Uitvoering': 'Session',
  'Uw inschrijving': 'Votre inscription',
  'Uw inschrijving is verwerkt.': 'Votre inscription a été traitée.',
  'Uw inschrijvingen konden niet worden opgehaald.':
      'Vos inscriptions n\'ont pas pu être récupérées.',
  'Uw klassikale bijeenkomsten: binnenkort en geweest.':
      'Vos séances en présentiel : à venir et passées.',
  'Vol': 'Complet',
  'Voldoet u bijna? Vraag uw organisatie of een ontheffing mogelijk is.':
      'Presque ? Demandez à votre organisation si une dérogation est possible.',
  'Voor deze uitvoering is een vouchercode vereist.':
      'Un code de bon est requis pour cette session.',
  'Vouchercode': 'Code de bon',
  'Vouchercode vereist': 'Code de bon requis',
  'Wilt u zich afmelden voor {titel} op {datum}? Een eventuele plaats op de wachtlijst gaat dan naar de volgende.':
      'Voulez-vous vous désinscrire de {titel} le {datum} ? Une éventuelle place sur liste d\'attente passera au suivant.',
  'Zelf afmelden kon tot {deadline}. Daarna afmelden kan alleen nog via {organisatie}.':
      'La désinscription était possible jusqu\'au {deadline}. Ensuite, elle n\'est possible que via {organisatie}.',
  'ingeschreven': 'inscrit',
  'nog niet voldaan': 'pas encore remplie',
  'ontheffing verleend': 'dérogation accordée',
  'op de wachtlijst': 'sur liste d\'attente',
  'verloopt vóór de start': 'expire avant le début',
  'voldaan': 'remplie',
  'wachtlijst': 'liste d\'attente',
  ...
  'Ctrl/Cmd+V plakt een afbeelding in het archief':
      'Ctrl/Cmd+V colle une image dans l\'archive',
  'hoofdstukken': 'chapitres',
  'paragrafen': 'paragraphes',
  'tabellen': 'tableaux',
  'afbeeldingen': 'images',
  'Document importeren…': 'Importer un document…',
  'Document kiezen': 'Choisir un document',
  'Document geïmporteerd.': 'Document importé.',
  'Importeren uit Word of LibreOffice…': 'Importer depuis Word ou LibreOffice…',
  ...
  'PDF/A en digitale handtekeningen blijven zichtbaar. OciDeck controleert de handtekening niet.':
      'Le PDF/A et les signatures numériques restent visibles. OciDeck ne valide pas la signature.',
  'Logo niet importeren': 'Ne pas importer le logo',
  'Logo gevonden': 'Logo trouvé',
  'Dit logo komt ook voor in de stijl {naam}.':
      'Ce logo apparaît également dans le style {naam}.',
  ...
  'Aangemaakt op': 'Créé le',
  'Aanmeldprovider': 'Fournisseur de connexion',
  'Aanmeldsessies': 'Séances d\'inscription',
  'Aantal controles': 'Nombre de chèques',
  ...
  'Activiteitnummer': 'Numéro d\'activité',
  'Afgerond op': 'Arrondi à',
  'Afgewezen': 'Rejeté',
  'Afspeelsessienummer': 'Numéro de session de lecture',
  'Afwezig': 'Absent',
  'Antwoordgegevens': 'Détails de la réponse',
  'Antwoordstatus': 'Statut de la réponse',
  'Begint op': 'Commence le',
  'Begrippen uitgelegd': 'Notions expliquées',
  'Beheer van de installatie': 'Gestion de l\'installation',
  'Beheerpogingen': 'Efforts de gestion',
  'Bekeken lessen': 'Leçons consultées',
  'Beleidsversie': 'Version de la politique',
  'Beoordeeld': 'Noté',
  'Beoordeeld op': 'Évalué par',
  'Beperking': 'Restriction',
  'Berekend op': 'Calculé sur',
  'Bericht': 'Message',
  'Bestandsnaam': 'Nom du fichier',
  'Beveiligingsvraagnummer': 'Numéro de question de sécurité',
  'Bevestigd': 'Confirmé',
  'Bevestigd op': 'Confirmé le',
  'Bewaarregels': 'Règles de conservation',
  'Bewaartermijn': 'Période de conservation',
  'Bewaren wegens een juridische verplichting':
      'Retenu en raison d\'une obligation légale',
  'Bewerkingnummer bij aanmeldprovider':
      'Numéro d\'opération auprès du fournisseur d\'enregistrement',
  'Bewijsstukken': 'Preuve',
  'Bezwaar': 'Objection',
  'Beëindigd op': 'Terminé le',
  'Bijeenkomstnummer': 'Numéro de réunion',
  'Certificaatnummer': 'Numéro de certificat',
  'Certificaten': 'Certificats',
  'Controlecode van de PDF': 'Code de contrôle du PDF',
  'Controlecode van profielfoto': 'Code de vérification de la photo de profil',
  'Controlecodes van bewijsstukken':
      'Codes de contrôle des pièces justificatives',
  'Correctie': 'Correction',
  'Cursistnummer waarop de actie gericht was':
      'Numéro d\'étudiant auquel l\'action était destinée',
  'Cursusaanbodnummer': 'Numéro d\'offre de cours',
  'Cursusversienummer': 'Numéro de version du cours',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Les dates et heures sont affichées selon votre heure locale. Les noms techniques restent visibles lorsque le serveur fournit un champ inconnu.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'Les réponses que vous avez données aux questions du test.',
  'Deelnamenummer': 'Numéro de participation',
  'Deelnames': 'Participation',
  'Details': 'Détails',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Cette catégorie a été fournie par le serveur. Les noms techniques restent visibles pour les demandes de renseignements de votre organisation.',
  'Door uzelf aangevraagd': 'Demandé par vous-même',
  'E-mailadres': 'Adresse e-mail',
  'E-mailberichten': 'Messages électroniques',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'Un identifiant est un numéro technique unique que le eLearning utilise pour relier les données entre elles. Il ne s\'agit pas d\'une note ou d\'un statut.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'Une catégorie regroupe des données sur un même sujet. Une inscription est une donnée enregistrée ou un événement.',
  'Eindigt op': 'Se termine dans',
  'Geaccepteerd op': 'Accepté le',
  'Geannuleerd': 'Annulé',
  'Gecontroleerd': 'Vérifié',
  'Gecontroleerd op': 'Vérifié',
  'Geen gegevens gevonden': 'Aucune donnée trouvée',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Informations sur les durées de conservation et la suppression de vos données.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Informations sur les pièces justificatives, les résultats obtenus et les certificats.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Informations sur les demandes de confidentialité et sur qui a consulté ou modifié vos informations.',
  'Gegevens over uw accountbewerking':
      'Informations sur le fonctionnement de votre compte',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Informations sur votre inscription, votre participation et votre progression dans les cours.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Informations sur votre profil, votre compte et votre position au sein de l\'organisation.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Informations sur vos moments de test et les questions présentées.',
  'Gegevens over willekeurige volgorde': 'Données de commande aléatoires',
  'Gegevenscategorie': 'Catégorie de données',
  'Gekoppeld accountnummer': 'Numéro de compte lié',
  'Gekozen antwoorden': 'Réponses sélectionnées',
  'Gelukt': 'Succès',
  'Geprobeerd op': 'Essayé',
  'Gerechtvaardigd belang': 'Intérêt légitime',
  'Gereserveerd': 'Réservé',
  'Gereserveerd op': 'Réservé le',
  'Geslaagd': 'Réussi',
  'Gestart op': 'Commencé le',
  'Getoonde tijd per dia in milliseconden':
      'Temps affiché par diapositive en millisecondes',
  'Herkomst van inschrijving': 'Origine de l\'inscription',
  'Hoogst haalbare score': 'Score le plus élevé possible',
  'Identificatienummer bij aanmeldprovider':
      'Numéro d\'identification du fournisseur d\'enregistrement',
  'Identiteitsbewerkingnummer': 'Numéro d\'opération d\'identité',
  'In afwachting': 'En attente',
  'In behandeling': 'En cours',
  'In behandeling genomen op': 'Traité le',
  'In quarantaine': 'En quarantaine',
  'Ingeleverd': 'Soumis',
  'Ingeleverd op': 'Soumis le',
  'Ingericht op': 'Décoré sur',
  'Ingeschreven op': 'Inscrit le',
  'Ingetrokken': 'Retiré',
  'Ingetrokken op': 'Retiré le',
  'Inschrijvingen': 'Inscriptions',
  'Inschrijvingsnummer': 'Numéro d\'enregistrement',
  'Installatiebeveiligingslogboek': 'Journal de sécurité de l\'installation',
  'Installatienummer': 'Numéro d\'installation',
  'Installatieverzoeken': 'Demandes d\'installation',
  'Inzage': 'Contrôle',
  'Ja': 'Oui',
  'Kwalificatienummer': 'Numéro de qualification',
  'Kwalificaties': 'Qualifications',
  'Laatst actief op': 'Dernière activité le',
  'Laatst bekeken dia': 'Dernière diapositive consultée',
  'Laatst gewijzigd op': 'Dernière modification le',
  'Laatste fout': 'Dernière erreur',
  'Lesnummer': 'Numéro de leçon',
  'Lesreserveringen': 'Réservations de cours',
  'Lesvoortgang': 'Progression de la leçon',
  'Lidmaatschappen': 'Adhésions',
  'Locatie': 'Emplacement',
  'Manier van afronden': 'Mode d\'arrondi',
  'Maximaal aantal controles': 'Nombre maximum de chèques',
  'Maximaal aantal pogingen': 'Nombre maximum de tentatives',
  'Maximale leeftijd van de aanmelding': 'Âge maximum d\'inscription',
  'Mislukt': 'Échec',
  'Naam van de activiteit': 'Nom de l\'activité',
  'Naam van de bijeenkomst': 'Nom de la réunion',
  'Nee': 'Non',
  'Netwerkadres': 'Adresse réseau',
  'Niet actief': 'Pas actif',
  'Niet geregistreerd': 'Non inscrit',
  'Niet ingevuld': 'Non rempli',
  'Niet verschenen': 'Non publié',
  'Niveau van extra aanmeldcontrole':
      'Niveau de contrôle d\'enregistrement supplémentaire',
  'Nummer van de toetsopzet': 'Numéro du plan de test',
  'Nummer van het brongegeven': 'Numéro des données sources',
  'Nummer van uw verwijderde gegeven': 'Nombre de vos données supprimées',
  'Onderdeel {nummer}': 'Pièce {nummer}',
  'Onderwerp van de actie': 'Objet de l\'action',
  'Ontvanger': 'Destinataire',
  'Opgegeven bestandsgrootte': 'Taille de fichier spécifiée',
  'Opgegeven bestandstype': 'Type de fichier spécifié',
  'Opgegeven controlecode': 'Code de contrôle spécifié',
  'Opgeslagen bestandsgrootte': 'Taille du fichier enregistré',
  'Opgeslagen controlecode': 'Code de contrôle stocké',
  'Organisatienummer': 'Numéro d\'organisation',
  'Overdraagbaarheid': 'Transférabilité',
  'PE-toekenningnummer': 'Numéro de récompense PE',
  'Poging': 'Tentative',
  'Positie': 'Poste',
  'Privacyverzoeken': 'Demandes de confidentialité',
  'Probeer een andere zoekterm.': 'Essayez un autre terme de recherche.',
  'Reden': 'Raison',
  'Reden of grondslag': 'Raison ou fondement',
  'Reden van afwijzing': 'Motif du refus',
  'Reden van bevestiging': 'Motif de la confirmation',
  'Reden van intrekking': 'Raison du retrait',
  'Reden voor langer bewaren': 'Raison d\'un stockage plus long',
  'Regels voor de cursusversie': 'Règles pour la version cours',
  'Resultaat bij de aanmeldprovider':
      'Résultat chez le prestataire d\'inscription',
  'Rol': 'Rouler',
  'Score': 'Score',
  'Soort aanwezigheid': 'Type de présence',
  'Soort accountbewerking': 'Type d\'opération de compte',
  'Soort gebeurtenis': 'Type d\'événement',
  'Soort privacyverzoek': 'Type de demande de confidentialité',
  'Status van de bijeenkomst': 'Statut de la réunion',
  'Strenge beveiligingsmodus': 'Mode haute sécurité',
  'Technisch toegangslogboek': 'Journal d\'accès technique',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Données techniques nécessaires à l\'enregistrement, à la sécurité et au traitement fiable.',
  'Technische naam: {naam}': 'Nom technique : {naam}',
  'Technische opslagcategorie': 'Catégorie de stockage technique',
  'Technische opslaglocatie van de PDF': 'Lieu de stockage technique du PDF',
  'Tijdstip van aanmelding': 'Heure d\'inscription',
  'Tijdzone': 'Fuseau horaire',
  'Toestand': 'État',
  'Toetspogingen': 'Tentatives de tests',
  'Toetspogingnummer': 'Numéro de tentative de test',
  'Uiterste inlevermoment': 'Date limite de soumission',
  'Uitgegeven op': 'Publié le',
  'Uitgenodigd e-mailadres': 'Adresse e-mail invitée',
  'Uitnodigingen': 'Invitations',
  'Uniek nummer (ID)': 'Numéro unique (ID)',
  'Uniek verwerkingskenmerk': 'Fonctionnalité de traitement unique',
  'Uw accountnummer': 'Votre numéro de compte',
  'Uw accountnummer als uitvoerder':
      'Votre numéro de compte en tant qu\'exécuteur testamentaire',
  'Uzelf als uploader': 'Vous-même en tant que téléchargeur',
  'Vaardigheidsversienummer': 'Numéro de version de la compétence',
  'Vast internetadres van de installatie':
      'Adresse internet fixe de l\'installation',
  'Vastgelegde beslisgegevens': 'Données de décision enregistrées',
  'Vastgelegde gegevens': 'Données enregistrées',
  'Vereist niveau van aanmeldzekerheid':
      'Niveau de certitude requis pour l’enregistrement',
  'Vereiste aanmeldmethoden': 'Méthodes de connexion requises',
  'Verloopt bij inactiviteit op': 'Expire en cas d\'inactivité',
  'Verloopt definitief op': 'Expire définitivement',
  'Verloopt op': 'Expire',
  'Versienummer van de PE-regel': 'Numéro de version de la règle PE',
  'Verwerkte verzoeken': 'Demandes traitées',
  'Verwijderd op': 'Supprimé le',
  'Verwijdering': 'Suppression',
  'Verwijderingsregister': 'Registre de suppression',
  'Verwijzing naar het antwoord': 'Référence à la réponse',
  'Verzoeknummer': 'Numéro de demande',
  'Verzoeknummer van de app': 'Numéro de demande d\'application',
  'Verzonden op': 'Envoyé le',
  'Volgende controle op': 'Prochaine vérification',
  'Volgnummer': 'Numéro de séquence',
  'Volgorde van antwoordopties': 'Ordre des options de réponse',
  'Vraagnummer binnen de toetspoging':
      'Numéro de question dans la tentative de test',
  'Vraagversienummer': 'Numéro de version de la question',
  'Vragen in toetspogingen': 'Questions lors des tentatives de test',
  'Vrijgegeven': 'Libéré',
  'Vrijgegeven op': 'Sorti le',
  'Wat gebeurt na de bewaartermijn':
      'Que se passe-t-il après la période de conservation',
  'Wettelijke verplichting': 'Obligation légale',
  'Wijzigingen aan PE-punten': 'Modifications des points PE',
  'Wijzigingen aan kwalificaties': 'Modifications des qualifications',
  'Wijzigingen in aanmeldbeveiliging':
      'Modifications apportées à la sécurité de connexion',
  'Zekerheid': 'Certitude',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Par exemple, recherchez par cours, date ou statut',
  'Zoeken in uw gegevens': 'Recherchez vos données',
  '{aantal} categorieën gevonden': 'Catégories {aantal} trouvées',
  'Aanwezigheid': 'Présence',
  'Lidmaatschap': 'Adhésion',
  'Inzage en wijzigingen': 'Accès et modifications',
  'Beschikbaarheid van het inzagespoor': 'Disponibilité du journal d\'accès',
  'Beschikbaar vanaf': 'Disponible à partir de',
  'Historie vóór deze datum': 'Histoire avant cette date',
  'Tijdstip': 'Date et heure',
  'Handeling': 'Action',
  'Gegevensonderdeel': 'Catégorie de données',
  'Handelde als': 'Agi comme',
  'Organisatorische rol': 'Rôle organisationnel',
  'Bekeken': 'Vu',
  'Gewijzigd': 'Changé',
  'Uzelf': 'Vous',
  'Medewerker': 'Membre du personnel',
  'Systeem': 'Système',
  'Onbekend': 'Inconnu',
  'Docent': 'Instructeur',
  'Beoordelaar': 'Évaluateur',
  'Organisatiebeheerder': 'Administrateur de l\'organisation',
  'Niet beschikbaar': 'Non disponible',
  'Uitoefening van privacyrechten': 'Exercice du droit à la vie privée',
  'Beoordeling en certificering': 'Évaluation et certification',
  'Uitvoering van het leertraject': 'Livraison du programme d\'apprentissage',
  'Cursistenadministratie': 'Administration des apprenants',
  'Cursistprofiel': 'Profil de l\'apprenant',
  'Leerstatistieken': 'Statistiques d\'apprentissage',
  'Inschrijving': 'Inscription',
  'Toetspoging': 'Tentative d\'évaluation',
  'Beoordeling': 'Évaluation',
  'Bewijsstuk': 'Preuve',
  'Kwalificatie': 'Diplôme',
  'Deelname': 'Participation',
  'PE-punten': 'Points de formation continue',
  'Certificaat': 'Certificat',
  'Privacyverzoek': 'Demande de confidentialité',
  'Bewaard tot': 'Conservé jusqu\'à',
  'Bekijk mijn gegevens': 'Consulter mes données',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Consultez les données qu’eLearning a enregistrées à votre sujet.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Cet aperçu a été récupéré directement auprès d’eLearning le {datum} et n’est pas conservé par OciDeck.',
  'Geen gegevens geregistreerd': 'Aucune donnée enregistrée',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'Il contient toutes les catégories fournies par le serveur pour cette organisation. Pour en savoir plus sur les finalités, les destinataires, l’origine, les durées de conservation ou vos autres droits en matière de confidentialité, contactez {organisatie}.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Impossible de charger vos données. Réessayez.',
  'Meer tonen ({aantal} resterend)': 'Afficher plus ({aantal} restants)',
  'Mijn gegevens': 'Mes données',
  'Privacy-inzage': 'Accès aux données personnelles',
  'Uw geregistreerde gegevens': 'Vos données enregistrées',
  'uw organisatie': 'votre organisation',
  '{aantal} registraties': '{aantal} enregistrements',
  'Volg opleidingen uit uw eLearning-omgeving. Cursusbestanden openen alleen in afspeelmodus; voortgang wordt alleen na aanmelden gesynchroniseerd.':
      'Suivez des formations de votre environnement eLearning. Les fichiers de cours ne s\'ouvrent qu\'en mode lecture ; la progression n\'est synchronisée qu\'après connexion.',
  'eLearning-aanmelding is alleen beschikbaar in de desktop-app, omdat de webversie geen veilige sleutelbos heeft.':
      'La connexion à eLearning n\'est disponible que dans l\'application de bureau, car la version web ne dispose pas d\'un trousseau sécurisé.',
  'eLearning-server': 'Serveur eLearning',
  'Bij het volgen van een cursus stuurt OciDeck uw laatste dia, voltooiing en getoonde tijd per dia naar de gekozen eLearning-organisatie. Antwoorden, notities en cursusinhoud worden niet als voortgang verstuurd.':
      'Lors du suivi d\'un cours, OciDeck envoie à l\'organisation eLearning choisie votre dernière diapositive, la réalisation et le temps affiché par diapositive. Les réponses, notes et contenus du cours ne sont pas envoyés comme progression.',
  'Ingelogd bij eLearning': 'Connecté à eLearning',
  'Deze eLearning-server gebruikt {host} voor het aanmelden. Er worden pas gegevens met die identiteitsprovider uitgewisseld nadat u dit toestaat.':
      'Ce serveur eLearning utilise {host} pour la connexion. Les données ne sont échangées avec ce fournisseur d’identité qu’après votre autorisation.',
  'Gebruik een HTTPS-adres voor eLearning.':
      'Utilisez une adresse HTTPS pour eLearning.',
  'Vul een geldig eLearning-adres in.':
      'Saisissez une adresse eLearning valide.',
  ...
  'Nu niet': 'Pas maintenant',
  'Herstelkopie weggooien': 'Supprimer la copie de récupération',
  'Openen en verder werken': 'Ouvrir et continuer',
  ...
  'De dia-achtergrond is donker, maar het logo heeft geen donkere variant. Het logo is op de dia vrijwel onzichtbaar. Stel een donker logo in de presentatie-instellingen.':
      'L\'arrière-plan de la diapositive est sombre, mais le logo n\'a pas de variante sombre. Le logo est presque invisible sur la diapositive. Définissez un logo sombre dans les paramètres de présentation.',
  'Klik met Ctrl/Cmd of Shift om meerdere bestanden te kiezen.':
      'Cliquez avec Ctrl/Cmd ou Maj pour choisir plusieurs fichiers.',
  'Presentaties openen': 'Ouvrir des présentations',
  ...
  'Eén tabel past niet op de bladbreedte, ook niet op de kleinste letter.':
      'Un tableau ne tient pas dans la largeur de page, même au plus petit corps.',
  '{n} tabellen passen niet op de bladbreedte, ook niet op de kleinste letter.':
      '{n} tableaux ne tiennent pas dans la largeur de page, même au plus petit corps.',
  'Lange woorden en waarden zoals hashes of IP-adressen zijn daardoor middenin afgebroken.':
      'Les mots et valeurs longs comme les empreintes ou les adresses IP sont donc coupés en plein milieu.',
  'Splits de tabel, of zet lange waarden onder elkaar in plaats van naast elkaar.':
      'Divisez le tableau, ou placez les valeurs longues les unes sous les autres plutôt que côte à côte.',
  'Een ODT (OpenDocument Text) die opent in LibreOffice of Word. Bewerkbaar, met native voetnoten en koppen als outline. Het open tegenhanger van een Word-bestand.':
      'Un ODT (OpenDocument Text) qui s\'ouvre dans LibreOffice ou Word. Modifiable, avec des notes de bas de page natives et des titres comme plan. L\'alternative ouverte à un fichier Word.',
  'Een Word-document (.docx) dat opent in Word, Pages en LibreOffice. Bewerkbaar, met native voetnoten en koppen als outline. Mermaid-diagrammen worden als hoogwaardige afbeeldingen ingebed.':
      'Un document Word (.docx) qui s\'ouvre dans Word, Pages et LibreOffice. Modifiable, avec des notes de bas de page natives et des titres en plan. Les diagrammes Mermaid sont integres en tant qu\'images de haute qualite.',
  'Een ePub 3 met herflowbare tekst voor e-readers, tablets en telefoons. Koppen worden navigatie, noten staan achterin.':
      'Un ePub 3 avec texte refluable pour liseuses, tablettes et téléphones. Les titres deviennent la navigation, les notes sont à la fin.',
  ...
  'Volgorde (marker)': 'Ordre (marqueur)',
  'Toelichting (optioneel)': 'Description (facultatif)',
  ...
  'Kies een logo van minstens {px} px breed, of zet de logomaat kleiner.':
      'Choisissez un logo d\'au moins {px} px de large, ou réduisez la taille du logo.',
  ...
  'Voorbeeld': 'Aperçu',
  'Voorbeeld tonen': 'Afficher l\'aperçu',
  'Voorbeeld tonen bij openen': 'Afficher un aperçu à l\'ouverture',
  'Wijs een bestand aan om er hier een voorbeeld van te zien.':
      'Pointez un fichier pour en voir un aperçu ici.',
  'Dit bestand kan niet worden getoond. Openen weigert het ook — de inhoud is onveilig, beschadigd of onleesbaar.':
      'Ce fichier ne peut pas être affiché. L\'ouverture le refuse aussi — le contenu est dangereux, endommagé ou illisible.',
  'Dit document is leeg.': 'Ce document est vide.',
  'Deze presentatie heeft nog geen dia.':
      'Cette présentation n\'a encore aucune diapositive.',
  'Alleen het begin van het document wordt getoond.':
      'Seul le début du document est affiché.',
  'Bestanden zoeken op deze computer':
      'Trouver des fichiers sur cet ordinateur',
  'Dubbele bestanden opruimen': 'Nettoyer les fichiers en double',
  'bestand(en) gevonden': 'fichier(s) trouvé(s)',
  'Geen presentaties of documenten gevonden in de bekende mappen.':
      'Aucune présentation ni document trouvé dans les dossiers connus.',
  'Zoek op bestandsnaam, titel of tekst in het bestand…':
      'Rechercher par nom de fichier, titre ou texte dans le fichier…',
  'Toont in het openscherm een gerenderd voorbeeld van het bestand dat je aanwijst, zodat je ziet wat erin staat voordat je het opent.':
      'Affiche dans la fenêtre d\'ouverture un aperçu rendu du fichier que vous pointez, pour voir son contenu avant de l\'ouvrir.',
  ...
  'Alleen een lege dia.': 'Uniquement une diapositive vide.',
  ...
  'Dit bestand is {grootte} groot. Dat is meer dan de aanbevolen limiet van {limiet}. Importeren kan traag zijn en veel geheugen vragen — op een kleiner apparaat kan de app vastlopen.':
      'Ce fichier fait {grootte}. C\'est plus que la limite recommandée de {limiet}. L\'importation peut être lente et utiliser beaucoup de mémoire — sur un appareil plus petit, l\'application peut se figer.',
  'Toch importeren': 'Importer quand même',
  'Koptekst': 'En-tête',
  ...
  'De ingestelde map is niet beschikbaar; de presentatie is in de documentenmap geopend:':
      'Le dossier configuré n’est pas disponible ; la présentation a été ouverte dans le dossier des documents :',
  'De naam in deze URL bestaat niet, of is niet op te zoeken. Controleer de URL op een typefout.':
      'Le nom dans cette URL n’existe pas ou ne peut pas être résolu. Vérifiez que l’URL ne contient pas de faute de frappe.',
  'Deze URL stuurt door naar een ander adres. Vul dat adres rechtstreeks in — een omleiding volgen we niet, want die kan de veiligheidscontrole omzeilen.':
      'Cette URL redirige vers une autre adresse. Saisissez directement cette adresse : nous ne suivons pas les redirections, car elles peuvent contourner le contrôle de sécurité.',
  'Deze URL wijst naar een privé- of LAN-adres. Zulke adressen worden om veiligheidsredenen niet opgehaald.':
      'Cette URL pointe vers une adresse privée ou LAN. Pour des raisons de sécurité, ces adresses ne sont pas récupérées.',
  'Deze link is geen http(s)-adres. Plak een link die met http:// of https:// begint.':
      'Ce lien n’est pas une adresse http(s). Collez un lien qui commence par http:// ou https://.',
  'Deze server gebruikt geen https. Gebruik een https-adres — je wachtwoord gaat bij elk verzoek mee en zou anders onversleuteld over het netwerk gaan.':
      'Ce serveur n’utilise pas https. Utilisez une adresse https — votre mot de passe est envoyé à chaque requête et circulerait sinon en clair sur le réseau.',
  'Dit endpoint gebruikt geen https. Gebruik een https-endpoint, of markeer het als vertrouwd intern — anders gaan je presentaties onversleuteld over het netwerk.':
      'Ce point de terminaison n’utilise pas https. Utilisez un point de terminaison https, ou marquez-le comme interne de confiance — sinon vos présentations circulent en clair sur le réseau.',
  'Gebruik een https-adres — anders gaat je wachtwoord onversleuteld over het netwerk.':
      'Utilisez une adresse https — sinon votre mot de passe circule en clair sur le réseau.',
  'Gebruik een https-endpoint, of vink "Vertrouwd intern endpoint" aan — anders gaan je presentaties onversleuteld over het netwerk.':
      'Utilisez un point de terminaison https, ou cochez "Point de terminaison interne de confiance" — sinon vos présentations circulent en clair sur le réseau.',
  'Het beveiligingscertificaat van deze server wordt niet vertrouwd. Controleer de URL of probeer een andere bron.':
      'Le certificat de sécurité de ce serveur n’est pas approuvé. Vérifiez l’URL ou essayez une autre source.',
  'Het endpoint stuurt door naar een ander adres — meestal een verkeerde regio of endpoint-URL. Controleer de regio en het endpoint bij Instellingen → Opslag; opnieuw proberen helpt hier niet.':
      'Le point de terminaison redirige vers une autre adresse — le plus souvent une région ou une URL de point de terminaison erronée. Vérifiez la région et le point de terminaison dans Paramètres → Stockage ; réessayer n’aide pas ici.',
  'Het endpoint stuurt door — meestal een verkeerde regio of endpoint-URL. Opnieuw proberen helpt hier niet.':
      'Le point de terminaison redirige — le plus souvent une région ou une URL de point de terminaison erronée. Réessayer n’aide pas ici.',
  'Lokaal opgeslagen, maar publiceren naar de forge lukte niet:':
      'Enregistré localement, mais la publication sur la forge a échoué :',
  ...
  'Het zegel van dit deck klopt niet meer met de inhoud — het is bewerkt na het verzegelen.':
      'Le sceau de ce deck ne correspond plus à son contenu — il a été modifié après la scellée.',
  'HTML-bestand opent in elke browser zonder internet en rendert codeblokken, wiskunde en mermaid-diagrammen. LaTeX-bron compileer je met pdflatex of xelatex.':
      'Un fichier HTML s\'ouvre dans n\'importe quel navigateur sans internet et rend les blocs de code, les mathématiques et les diagrammes mermaid. La source LaTeX se compile avec pdflatex ou xelatex.',
  'Een LaTeX article-document. Wiskunde gaat rechtstreeks door; afbeeldingen worden op relatief pad gereferentieerd. Compileer met pdflatex of xelatex.':
      'Un document LaTeX article. Les mathématiques passent directement ; les images sont référencées par chemin relatif. Compilez avec pdflatex ou xelatex.',
  ...
  'Converteer naar document…': 'Convertir en document…',
  'Converteer naar presentatie…': 'Convertir en présentation…',
  'Converteren': 'Convertir',
  'De indeling in dia\'s (de tekst loopt door als één document).':
      'Le découpage en diapositives (le texte se poursuit comme un seul document).',
  'De indeling in dia\'s is een voorstel; presentatie en document zijn geen perfecte spiegeling van elkaar.':
      'Le découpage en diapositives est une suggestion ; présentation et document ne sont pas un miroir parfait l\'un de l\'autre.',
  'Document exporteren': 'Exporter le document',
  'Een geredigeerde kopie van de platte tekst — opent in elke Markdown-lezer.':
      'Une copie caviardée du texte brut — s\'ouvre dans n\'importe quel lecteur Markdown.',
  'Een thematische regel (---) wordt een diagrens.':
      'Une ligne thématique (---) devient une limite de diapositive.',
  'Exporteren maakt een geredigeerde kopie voor een ontvanger. Je byte-getrouwe origineel bewaar je met Opslaan.':
      'L\'exportation crée une copie caviardée pour un destinataire. Vous conservez votre original fidèle aux octets avec Enregistrer.',
  'Exporteren…': 'Exporter…',
  'Eén toegankelijk HTML-bestand dat in elke browser opent zonder internet, met tabellen, wiskunde, mermaid en grafieken.':
      'Un seul fichier HTML accessible qui s\'ouvre dans n\'importe quel navigateur sans internet, avec tableaux, mathématiques, mermaid et graphiques.',
  'Het thema en de opmaak per dia (_class).':
      'Le thème et la mise en forme par diapositive (_class).',
  'Het zegel: een geconverteerd bestand is nieuw en draagt geen zegel.':
      'Le sceau : un fichier converti est neuf et ne porte aucun sceau.',
  ...
  'Voor de opdrachtgever of auditor: alleen wat je zelf op "weglaten" hebt gezet, gaat eruit. De rest blijft leesbaar.':
      'Pour le donneur d\'ordre ou l\'auditeur : seul ce que vous avez marqué « omettre » est retiré. Le reste reste lisible.',
  'Wat gaat er verloren bij het converteren:':
      'Ce qui est perdu lors de la conversion :',
  'Wat verandert er bij het converteren:':
      'Ce qui change lors de la conversion :',
  'We maken een kopie in een nieuw tabblad; je originele bestand blijft ongewijzigd.':
      'Nous créons une copie dans un nouvel onglet ; votre fichier d\'origine reste inchangé.',
  'Welk formaat?': 'Quel format ?',
  'document': 'document',
  'volledig': 'complet',
  'Invoegen': 'Insérer',
  'Visueel': 'Visuel',
  ...
  'Vanuit een OpenKAT-server': 'Depuis un serveur OpenKAT',
  'Vanuit een map': 'Depuis un dossier',
  'Sluit één of meer OpenKAT-omgevingen aan (bijvoorbeeld productie en acceptatie). OciDeck toont beschikbare rapportages; de inhoud haalt u binnen via een JSON-export uit OpenKAT.':
      'Connectez un ou plusieurs environnements OpenKAT (par exemple production et recette). OciDeck affiche les rapports disponibles ; vous importez le contenu via une exportation JSON depuis OpenKAT.',
  'Server toevoegen…': 'Ajouter un serveur…',
  'Rapportage van server…': 'Rapport du serveur…',
  'Nog geen OpenKAT-server aangesloten.':
      'Aucun serveur OpenKAT connecté pour l\'instant.',
  'Bezig…': 'En cours…',
  'OpenKAT-server bewerken': 'Modifier le serveur OpenKAT',
  'OpenKAT-server toevoegen': 'Ajouter un serveur OpenKAT',
  'OpenKAT-server toevoegen…': 'Ajouter un serveur OpenKAT…',
  'OpenKAT-server verwijderen?': 'Supprimer le serveur OpenKAT ?',
  'Dit verwijdert “{name}” en het bijbehorende toegangstoken van dit apparaat. Dat kunt u niet ongedaan maken.':
      'Cela supprime “{name}” et son jeton d\'accès de cet appareil. Vous ne pourrez pas annuler cette action.',
  'Weergavenaam': 'Nom affiché',
  'Bijvoorbeeld Productie of Acceptatie': 'Par exemple Production ou Recette',
  'Adres van OpenKAT': 'Adresse OpenKAT',
  'Verbinding met: {host}': 'Connexion à : {host}',
  'Eigen netwerk (LAN)': 'Réseau local (LAN)',
  'Alleen voor OpenKAT op het eigen netwerk. Staat HTTP toe en laat privé-adressen toe. Uitgeschakeld: alleen HTTPS.':
      'Uniquement pour OpenKAT sur le réseau local. Autorise HTTP et les adresses privées. Désactivé : HTTPS uniquement.',
  'Toegangstoken': 'Jeton d\'accès',
  'Laat leeg om het opgeslagen token te behouden':
      'Laissez vide pour conserver le jeton enregistré',
  'Plak het token hier': 'Collez le jeton ici',
  'Vraag uw OpenKAT-beheerder om een API-token in het beheerdersscherm. Het token blijft op dit apparaat, in de sleutelhanger van uw besturingssysteem — niet in het deck.':
      'Demandez à votre administrateur OpenKAT un jeton API dans l\'écran d\'administration. Le jeton reste sur cet appareil, dans le trousseau du système — pas dans le deck.',
  'Verbinding wordt getest…': 'Test de la connexion…',
  'Test de verbinding voordat u opslaat, zodat u weet dat naam, adres en token kloppen.':
      'Testez la connexion avant d\'enregistrer, pour vérifier le nom, l\'adresse et le jeton.',
  'De OpenKAT-koppeling is alleen beschikbaar in de desktopversie.':
      'La connexion OpenKAT n\'est disponible que dans la version de bureau.',
  'Lees OpenKAT-rapportages in als één managementoverzicht — vanuit een map of vanaf een server.':
      'Importez les rapports OpenKAT comme une vue de gestion unique — depuis un dossier ou un serveur.',
  'Er staat al een OpenKAT-bron ingesteld; de koppeling blijft daarom bereikbaar, zodat een bestaand OpenKAT-deck bij te werken blijft.':
      'Une source OpenKAT est déjà configurée ; la connexion reste disponible pour continuer à mettre à jour un deck OpenKAT existant.',
  'Rapportage van OpenKAT-server': 'Rapport du serveur OpenKAT',
  'Rapportage van OpenKAT-server…': 'Rapport du serveur OpenKAT…',
  'Server: {name}': 'Serveur : {name}',
  'Organisaties worden opgehaald…': 'Récupération des organisations…',
  'Rapportages worden opgehaald…': 'Récupération des rapports…',
  'Er zijn geen organisaties zichtbaar voor dit token. Vraag uw beheerder om toegang, of kies een andere server.':
      'Aucune organisation visible pour ce jeton. Demandez l\'accès à votre administrateur ou choisissez un autre serveur.',
  'Er staan geen organisatierapportages klaar op deze server. Maak in OpenKAT eerst een aggregaat-organisatierapport, of kies een andere organisatie.':
      'Aucun rapport d\'organisation n\'est prêt sur ce serveur. Créez d\'abord un rapport d\'organisation agrégé dans OpenKAT, ou choisissez une autre organisation.',
  'JSON-export uit OpenKAT': 'Export JSON depuis OpenKAT',
  'OpenKAT levert de rapportage-inhoud als JSON-bestand. Exporteer in OpenKAT het gekozen rapport als JSON, en wijs dat bestand of de map hieraan.':
      'OpenKAT fournit le contenu du rapport sous forme de fichier JSON. Exportez le rapport choisi en JSON dans OpenKAT, puis indiquez ce fichier ou dossier ici.',
  'Gekozen: {reportName} · {orgName} · {serverName}':
      'Choisi : {reportName} · {orgName} · {serverName}',
  'JSON-bestand kiezen…': 'Choisir un fichier JSON…',
  'Map met exports kiezen…': 'Choisir le dossier d\'export…',
  'Vul een weergavenaam in, bijvoorbeeld Productie.':
      'Saisissez un nom affiché, par exemple Production.',
  'Vul een weergavenaam en een adres in.':
      'Saisissez un nom affiché et une adresse.',
  'Plak een toegangstoken om verder te gaan.':
      'Collez un jeton d\'accès pour continuer.',
  'Vul een adres in, bijvoorbeeld https://openkat.voorbeeld.nl':
      'Saisissez une adresse, par exemple https://openkat.voorbeeld.nl',
  'Dit adres is niet geldig. Controleer of u een volledige URL heeft ingevuld.':
      'Cette adresse n\'est pas valide. Vérifiez que vous avez saisi une URL complète.',
  'Het adres moet met https:// beginnen, of zet Eigen netwerk aan voor HTTP op het eigen netwerk.':
      'L\'adresse doit commencer par https://, ou activez Réseau local pour HTTP sur le réseau local.',
  'Verbonden met {host}. Er zijn nog geen organisaties zichtbaar voor dit token.':
      'Connecté à {host}. Aucune organisation visible pour ce jeton.',
  'Verbonden met {host}. {n} organisatie(s) bereikbaar.':
      'Connecté à {host}. {n} organisation(s) accessible(s).',
  'De verbinding met OpenKAT is mislukt. Controleer het adres en uw netwerk, en probeer opnieuw.':
      'La connexion à OpenKAT a échoué. Vérifiez l\'adresse et votre réseau, puis réessayez.',
  'Er is geen toegangstoken. Plak het token van uw beheerder en probeer opnieuw.':
      'Aucun jeton d\'accès. Collez le jeton de votre administrateur et réessayez.',
  'Alleen HTTPS is toegestaan, tenzij Eigen netwerk aan staat.':
      'Seul HTTPS est autorisé, sauf si Réseau local est activé.',
  'OpenKAT weigerde het token. Vraag uw beheerder om een geldig API-token en plak het opnieuw.':
      'OpenKAT a refusé le jeton. Demandez à votre administrateur un jeton API valide et collez-le à nouveau.',
  'OpenKAT reageerde niet op tijd. Controleer of de server bereikbaar is en probeer opnieuw.':
      'OpenKAT n\'a pas répondu à temps. Vérifiez que le serveur est accessible et réessayez.',
  'Dit adres is niet bereikbaar. Controleer de spelling van de hostnaam en of u op het juiste netwerk zit.':
      'Cette adresse est inaccessible. Vérifiez l\'orthographe du nom d\'hôte et que vous êtes sur le bon réseau.',
  'OpenKAT gaf een onverwacht groot antwoord. Probeer later opnieuw of vraag uw beheerder om hulp.':
      'OpenKAT a renvoyé une réponse anormalement volumineuse. Réessayez plus tard ou demandez de l\'aide à votre administrateur.',
  'Verbonden': 'Connecté',
  'Token ontbreekt': 'Jeton manquant',
  'Laatst gecontroleerd mislukt': 'Dernière vérification échouée',
  'Nog niet gecontroleerd': 'Pas encore vérifié',
  'Zoekveld wissen': 'Effacer le champ de recherche',
  'Gantt': 'Gantt',
  'Dag': 'Jour',
  'Week': 'Semaine',
  'Maand': 'Mois',
  'Tijdschaal': 'Échelle de temps',
  'De as-granulariteit van het Gantt-diagram. “Auto” kiest op basis van het datumbereik van de taken.':
      'La granularité de l\'axe du diagramme Gantt. “Auto” choisit en fonction de la plage de dates des tâches.',
  'Sectiedelingen': 'Divisions de section',
  'Behandel een taaknaam die met “## ” begint als een sectiekop in het diagram.':
      'Traitez un nom de tâche commençant par “## ” comme en-tête de section dans le diagramme.',
  'Secties': 'Sections',
  'Een projectschema als Gantt-diagram. Vul de tabel met taak, start, duur, voortgang en afhankelijkheden; het diagram wordt afgeleid. Een taaknaam die met “Milestone:” begint is een nulduur-mijlpaal.':
      'Un calendrier de projet sous forme de diagramme Gantt. Remplissez le tableau avec tâche, début, durée, progression et dépendances ; le diagramme est déduit. Un nom de tâche commençant par “Milestone:” est un jalon à durée nulle.',
  'Let op: er staan mogelijk persoonsgegevens in de sessie-data.':
      'Attention : les données de session contiennent peut-être des données personnelles.',
  'Privacy-bevindingen in sessie-data':
      'Constats de confidentialité dans les données de session',
  'De privacyscan vond mogelijk persoonsgegevens in de sessie-data. De export redigeert deze automatisch; klik op een bevinding voor de details.':
      'L\'analyse de confidentialité a peut-être trouvé des données personnelles dans les données de session. L\'export les rédige automatiquement ; cliquez sur un constat pour les détails.',
  'Tijdens het presenteren heb je checklists ingevuld en tabellen bijgewerkt op {aantal} dia’s.':
      'Pendant la présentation, tu as rempli des listes de contrôle et mis à jour des tableaux sur {aantal} diapositives.',
  'en nog {aantal} dia’s.': 'et {aantal} diapositives de plus.',
  'Sessie-wijzigingen bewaren?':
      'Enregistrer les modifications de la session ?',
  'In deck behouden': 'Conserver dans le deck',
  'Downloaden als losse bestanden': 'Télécharger comme fichiers séparés',
  'Map voor sessie-bestanden kiezen':
      'Choisir un dossier pour les fichiers de session',
  'Zoek op taal of code': 'Rechercher par langue ou code',
  'Geen talen gevonden': 'Aucune langue trouvée',
  ...
  'Alles inschakelen': 'Tout activer',
  'Alles uitschakelen': 'Tout désactiver',
  'Presentaties uit PowerPoint (.pptx), Keynote (.key) en Impress (.odp) binnenhalen als bewerkbaar deck. Koppelingen met andere systemen, zoals OpenKAT, staan onder Integraties.':
      'Faire entrer les présentations depuis PowerPoint (.pptx), Keynote (.key) et Impress (.odp) sous forme de deck modifiable. Les connexions avec d\'autres systèmes, comme OpenKAT, se trouvent sous Intégrations.',
  ...
  'Dit pakket is te groot (maximaal 512 MB). Anders kan OciDeck het daarna niet meer openen. Gebruik minder of kleinere afbeeldingen, video’s of audiobestanden.':
      'Ce paquet est trop volumineux (512 Mo maximum). Sinon, OciDeck ne pourra plus l’ouvrir ensuite. Utilisez moins d’images, de vidéos ou de fichiers audio, ou des fichiers plus petits.',
  'De afbeeldingen samen zijn te groot voor één HTML-bestand (maximaal 512 MB). Gebruik minder of kleinere afbeeldingen, of exporteer als PDF of pakket.':
      'Les images sont ensemble trop volumineuses pour un seul fichier HTML (512 Mo maximum). Utilisez moins d’images ou des images plus petites, ou exportez au format PDF ou en paquet.',
  'Deze export heeft te veel dia’s op te hoge resolutie om veilig te renderen. Exporteer in delen of gebruik de gecomprimeerde PDF.':
      'Cette exportation contient trop de diapositives à une résolution trop élevée pour un rendu sûr. Exportez par parties ou utilisez le PDF compressé.',
  ...
  'Afbeeldingsrechten': 'Droits à l\'image',
  'Afbeeldingsrechten controleren…': 'Vérifiez les droits à l’image…',
  'Afdoening': 'Règlement',
  'Afdoening vastleggen': 'Règlement record',
  'Bijvoorbeeld een factuur-, licentie- of dossierverwijzing':
      'Par exemple, une facture, une licence ou une référence de fichier',
  'Controleert afbeeldingen lokaal op mogelijke auteursrechtelijke risico’s. Nieuwe repositoryafbeeldingen en de volledige assetpool kunnen worden gescand; een beheerder handelt waarschuwingen af. Dit is een signalering, geen juridisch oordeel, en er worden geen afbeeldingen naar derden gestuurd.':
      'Vérifie les images localement pour détecter d\'éventuels risques de droits d\'auteur. Les nouvelles images du référentiel et l\'ensemble du pool d\'actifs peuvent être analysés ; un administrateur gère les alertes. Il s\'agit d\'une alerte, pas d\'un avis juridique, et aucune image ne sera transmise à des tiers.',
  'De afdoening kon niet worden opgeslagen. Scan opnieuw en probeer het nogmaals.':
      'Le règlement n\'a pas pu être sauvé. Effectuez une nouvelle analyse et réessayez.',
  'Dit is een technische signalering, geen juridisch oordeel. Een beheerder beoordeelt de aanwijzingen.':
      'Il s\'agit d\'une alerte technique et non d\'un avis juridique. Un administrateur examine les instructions.',
  'Geen openstaande aanwijzingen.': 'Aucun indice remarquable.',
  'Geldige rechten aangetoond': 'Droits valides démontrés',
  'Mogelijke auteursrechtelijke risico’s':
      'Risques possibles en matière de droits d\'auteur',
  'Niet gebruiken': 'Ne pas utiliser',
  'Notitie (optioneel)': 'Remarque (facultatif)',
  'Onterechte signalering': 'Signalisation erronée',
  'afbeeldingen vragen om beoordeling': 'les images doivent être révisées',
  'bestanden konden niet veilig worden beoordeeld':
      'les fichiers n\'ont pas pu être examinés en toute sécurité',
  'nieuw gescand': 'nouvellement numérisé',
  'Realtime samenwerken': 'Collaboration en temps réel',
  'Werk live samen aan een presentatie via een versleuteld doorgeefluik. Standaard uit. De inhoud wordt end-to-end versleuteld met OciDecks eigen sleutels; de server ziet alleen versleutelde gegevens.':
      'Collaborez en direct sur une présentation via un relais chiffré. Désactivé par défaut. Le contenu est chiffré de bout en bout avec les propres clés d\'OciDeck ; le serveur ne voit que des données chiffrées.',
  'Chat': 'Chat',
  ...
  'Samenwerking gestart.': 'Collaboration démarrée.',
  'Deelgenomen aan de samenwerking.': 'Vous avez rejoint la collaboration.',
  ...
  'RPN = S×O×D wordt berekend — typ hem niet zelf.':
      'RPN = S×O×D est calculé — ne le saisissez pas vous-même.',
  'Eén R per rij.': 'Un R par ligne.',
  'Vul rechts naar links in — begin bij de klant.':
      'Remplissez de droite à gauche — commencez par le client.',
  'Kolommen zijn statussen; kaarten zijn taken.':
      'Les colonnes sont des statuts ; les cartes sont des tâches.',
  'Scope en succescriteria eerst — daarna pas het hoe.':
      'Le périmètre et les critères de succès d\'abord — le comment viendra ensuite.',
  'Van klantwens (Y) naar meetbare CTQ\'s.':
      'Du besoin client (Y) vers des CTQ mesurables.',
  'Vijf niveaus diep — eindig met een X-id.':
      'Cinq niveaux de profondeur — finir avec un X-id.',
  'Zes M\'s als botten — oorzaken eronder.':
      'Six M comme arêtes — causes en dessous.',
  'Stappen als titel :: soort :: kenmerken.':
      'Étapes comme titre :: type :: attributs.',
  'Zet de rol in het lane=… kenmerk.': 'Mettez le rôle dans l\'attribut lane=…',
  'PT/LT per stap — totalen worden berekend, niet opgeslagen.':
      'PT/LT par étape — les totaux sont calculés, non stockés.',
  'Lijst per kwadrant — geen coördinaten tekenen.':
      'Une liste par quadrant — ne tracez pas de coordonnées.',
  'Intern': 'Interne',
  'Negatief': 'Négatif',
  'Positief': 'Positif',
  'Weinige inspanning': 'Effort faible',
  'Veel inspanning': 'Effort élevé',
  'Lage impact': 'Impact faible',
  'Hoge impact': 'Impact élevé',
  'Sterktes': 'Forces',
  'Zwaktes': 'Faiblesses',
  'Kansen': 'Opportunités',
  ...
  'Oorzaakanalyse': 'Analyse des causes racines',
  'Tegenmaatregelen': 'Contre-mesures',
  'Opvolging': 'Suivi',
  'Bezig': 'En cours',
  'Probleem': 'Problème',
  'Succescriteria': 'Critères de succès',
  'Snelle winst': 'Victoires rapides',
  'Grote projecten': 'Projets majeurs',
  'Opvullers': 'Bouche-trous',
  'Ondankbaar': 'Ingrat',
  'Processtap': 'Étape de processus',
  'Faalwijze': 'Mode de défaillance',
  'Oorzaak': 'Cause',
  'Beheersing': 'Contrôle',
  'Activiteit': 'Activité',
  ...
  'Vat de huidige stand, gebruikte metingen en belangrijkste aandachtspunten samen.':
      'Un aperçu de la gestion large mais factuel avec des moments de mesure traçables.',
  'Laat zien waar de meeste en minste findings zijn gevonden; ontbrekende metingen staan apart.':
      'Classe sans score total et affiche les mesures manquantes séparément.',
  'Laat zien hoe aantallen findings veranderden en welke organisaties daaraan bijdroegen.':
      'Affiche les décomptes de gravité, les contributeurs et les mesures reportées par moment.',
  'Laat zien welke soorten problemen bij de meeste organisaties en systemen voorkomen.':
      'Organise les types de résultats par organisations, systèmes et observations concernés.',
  'Laat per organisatie zien hoeveel findings critical of high zijn.':
      'Affiche les nombres critiques/élevés sans aucune pesée conçue.',
  'Laat per control zien welk deel voldoet, maar alleen als het totaal bekend is.':
      'Affiche le numérateur, le dénominateur et uniquement des pourcentages fiables.',
  'Bundelt de aanbevelingen uit OpenKAT zonder er zelf prioriteit aan te geven.':
      'Regroupe les recommandations littérales d’OpenKAT sans leur propre priorité.',
  'Laat zien welke findings nieuw, terug of niet meer gezien zijn.':
      'Distingue le nouveau, le nouveau et celui qui n\'est plus observé.',
  'Laat zien welke findings het langst openstaan als de begindatum bekend is.':
      'Utilise uniquement des dates de première observation fiables.',
  'Laat zien op welke systemen de meeste en ernstigste findings staan.':
      'Classe les systèmes avec des compteurs de gravité distincts.',
  'Laat per systeem zien of het aantal findings steeg of daalde.':
      'Affiche les valeurs delta individuelles sans score pondéré.',
  'Vergelijkt controls alleen als beide metingen dezelfde reikwijdte hebben.':
      'Compare le numérateur et le dénominateur avec une couverture manifestement comparable.',
  'Geeft de systemen, hostnamen en IP-adressen uit de gekozen meting weer.':
      'Inventaire les systèmes, les noms d’hôtes et les adresses IP éprouvés.',
  'Laat alleen monitoringveranderingen zien die de bron bewijst.':
      'Affiche uniquement les mutations de surveillance explicitement prouvées.',
  'Laat zien bij welke organisaties en systemen deze CVE is aangetroffen.':
      'Affiche les organisations et les systèmes autour d’un lien CVE fiable.',
  'Laat zien welke CVE’s bij de meeste organisaties en systemen voorkomen.':
      'Classe les CVE avec déduplication explicite.',
  'Laat zien welke CVE’s nieuw, terug of niet meer gezien zijn.':
      'Distingue les CVE nouveaux, nouveaux et plus observés.',
  'Toont de gebruikte meetdatums, bronbestanden en technische bronkenmerken.':
      'Comptabilise les dates clés, les fichiers sources, les adaptateurs et les hachages sources.',
  'Vergelijk organisaties en breng portfolio-aandachtspunten in beeld.':
      'Comparez les organisations et identifiez les points d’intérêt du portefeuille.',
  'Bekijk de actuele stand of aantoonbare veranderingen bij één organisatie.':
      'Affichez l’état actuel ou les changements démontrables dans une organisation.',
  'Onderzoek betrouwbare CVE-koppelingen in de gekozen metingen.':
      'Recherchez des liens CVE fiables dans les mesures choisies.',
  'Leg vast welke metingen en bronbestanden het rapport werkelijk gebruikt.':
      'Enregistrez les mesures et les fichiers sources que le rapport utilise réellement.',
  'Wat is het managementbeeld over de gekozen organisaties?':
      'Quelle est la vision managériale des organisations choisies ?',
  'Waar worden de meeste en minste findings waargenomen?':
      'Où sont observés le plus et le moins de découvertes ?',
  'Hoe ontwikkelt het portfolio zich over de tijd?':
      'Comment le portefeuille évolue-t-il au fil du temps ?',
  'Welke problemen komen bij de meeste organisaties voor?':
      'Quels problèmes surviennent dans la plupart des organisations ?',
  'Waar concentreren de ernstigste findings zich?':
      'Où se concentrent les découvertes les plus graves ?',
  'Welke controls lopen achter?': 'Quels contrôles sont à la traîne ?',
  'Welke maatregelen adviseert OpenKAT het vaakst?':
      'Quelles mesures OpenKAT recommande-t-il le plus souvent ?',
  'Hoe staat deze organisatie er nu voor?':
      'Quel est le statut actuel de cette organisation ?',
  'Wat veranderde er sinds de vorige meting?':
      'Qu\'est-ce qui a changé depuis la mesure précédente ?',
  'Welke findings zijn nieuw of niet meer waargenomen?':
      'Quelles découvertes sont nouvelles ou ne sont plus observées ?',
  'Welke findings staan het langst open?':
      'Quelles découvertes sont restées ouvertes le plus longtemps ?',
  'Op welke systemen worden de meeste findings waargenomen?':
      'Sur quels systèmes le plus de constats sont-ils observés ?',
  'Welke systemen verbeterden of verslechterden?':
      'Quels systèmes se sont améliorés ou détériorés ?',
  'Welke controls verbeterden of verslechterden?':
      'Quels contrôles se sont améliorés ou détériorés ?',
  'Welke systemen zijn in de metingen opgenomen?':
      'Quels systèmes sont inclus dans les mesures ?',
  'Welke assets zijn aantoonbaar in monitoring?':
      'Quels sont les atouts démontrables en matière de surveillance ?',
  'Welke monitoringstatussen veranderden?':
      'Quels statuts de surveillance ont changé ?',
  'Wie is geraakt door deze CVE?': 'Qui est concerné par cette CVE ?',
  'Welke CVE’s raken de meeste organisaties?':
      'Quels CVE affectent la plupart des organisations ?',
  'Welke CVE’s zijn nieuw of niet meer waargenomen?':
      'Quels CVE sont nouveaux ou ne sont plus observés ?',
  'Welke meetgegevens ontbreken of zijn verouderd?':
      'Quelles données de mesure sont manquantes ou obsolètes ?',
  'Op welke gegevens is dit rapport gebaseerd?':
      'Sur quelles données ce rapport est-il basé ?',
  'Een gericht actueel beeld van één organisatie en haar meetdatum.':
      'Une image actuelle ciblée d’une organisation et sa date de mesure.',
  'Vergelijkt twee gekozen meetmomenten binnen één organisatie.':
      'Compare deux moments de mesure choisis au sein d’une organisation.',
  'Scheidt gemonitord, niet gemonitord en onbekend.':
      'Sépare surveillé, non surveillé et inconnu.',
  'Toont ontbrekende, verouderde en werkelijk gebruikte metingen.':
      'Affiche les mesures manquantes, obsolètes et réellement utilisées.',
  'Nog niet beschikbaar: de bron bewijst geen monitoringstatus voor alle assets.':
      'Pas encore disponible : la source ne prouve pas le statut de surveillance de tous les actifs.',
  'Nog niet beschikbaar: niet iedere finding heeft een betrouwbare eerste waarnemingsdatum.':
      'Pas encore disponible : toutes les découvertes n’ont pas de date de première observation fiable.',
  'Nog niet beschikbaar: de bron bewijst geen stabiele identiteit voor alle findings.':
      'Pas encore disponible : la source ne prouve pas une identité stable pour toutes les découvertes.',
  'Nog niet beschikbaar: vergelijkbare meetdekking is niet aangetoond.':
      'Pas encore disponible : une couverture de mesure comparable n’a pas été démontrée.',
  'Nog niet beschikbaar: betrouwbare controlnoemers ontbreken.':
      'Pas encore disponible : il manque des dénominateurs de contrôle fiables.',
  'Nog niet beschikbaar: stabiele assetidentiteit is niet aangetoond.':
      'Pas encore disponible : l’identité stable des actifs n’a pas été démontrée.',
  'Dit rapport ondersteunt de gekozen organisatiescope niet.':
      'Ce rapport ne prend pas en charge la portée organisationnelle choisie.',
  'De gekozen bron bevat niet genoeg betrouwbare gegevens voor dit rapport.':
      'La source sélectionnée ne contient pas suffisamment de données fiables pour ce rapport.',
  'Kerncijfers en gemeten bereik': 'Chiffres clés et portée mesurée',
  'Organisaties vergelijken': 'Comparez les organisations',
  'Concentratie van critical/high findings':
      'Concentration de résultats critiques/élevés',
  'Portfolioverloop per meetmoment':
      'Aperçu du portefeuille par moment de mesure',
  'Meest voorkomende findingtypen': 'Types de résultats les plus courants',
  'Bron- en meetverantwoording': 'Responsabilité des sources et des mesures',
  'Nieuwe en niet meer waargenomen findings':
      'Découvertes nouvelles et non plus observées',
  'Langst waargenomen findings': 'Résultats observés les plus longtemps',
  'Systemen met de meeste findings': 'Systèmes avec le plus de résultats',
  'Veranderingen per systeem': 'Modifications par système',
  'Blootstelling aan één CVE': 'Exposition à un CVE',
  'CVE’s over organisaties': 'CVE sur les organisations',
  'Nieuwe en niet meer waargenomen CVE’s': 'CVE nouveaux et non observés',
  'Controldekking': 'Couverture de contrôle',
  'Controlveranderingen': 'Contrôler les changements',
  'Aanbevelingen uit OpenKAT': 'Recommandations d\'OpenKAT',
  'Assetinventaris': 'Inventaire des actifs',
  'Monitoringdekking': 'Couverture de surveillance',
  'Actueel organisatiebeeld': 'Image organisationnelle actuelle',
  'Kies eerst het onderwerp en daarna de vraag die het rapport moet beantwoorden.':
      'Choisissez d’abord le sujet, puis la question à laquelle le rapport doit répondre.',
  'Onderwerp': 'Sujet',
  'Welk rapport beantwoordt uw vraag?':
      'Quel rapport répond à votre question ?',
  'Meer rapportvragen': 'Plus de questions sur le rapport',
  ...
  'systemen': 'systèmes',
  'Nog geen specificatielimiet': 'Pas encore de limite de spécification',
  'USL (bovengrens)': 'USL (limite supérieure)',
  'LSL (ondergrens)': 'LSL (limite inférieure)',
  'Optionele Y-01-velden': 'Champs Y-01 facultatifs',
  'Procesdoel (target)': 'Cible de processus (target)',
  'Specificatielimieten van Y-01 (deck)':
      'Limites de spécification Y-01 (deck)',
  'Dit deck heeft Y-01-limieten. Schakel bovenstaande schakelaar in om die te gebruiken in plaats van lokale waarden.':
      'Ce deck a des limites Y-01. Activez l\'interrupteur ci-dessus pour les utiliser à la place des valeurs locales.',
  ...
  'Hypothesetoets': 'Test d’hypothèse',
  'Hypothesetoets…': 'Test d’hypothèse…',
  'Hypothetisch gemiddelde': 'Moyenne hypothétique',
  'Lineaire regressie': 'Régression linéaire',
  'Regressie…': 'Régression…',
  'Meetdata': 'Données de mesure',
  'Toets': 'Test',
  'Tolerantie (optioneel)': 'Tolérance (facultatif)',
  'Eénsteeks t-toets': 'Test t à un échantillon',
  'Twee-steeks t-toets (Welch)': 'Test t à deux échantillons (Welch)',
  'Één kolom getallen (minimaal 2 waarnemingen).':
      'Une colonne de nombres (au moins 2 observations).',
  'Twee kolommen gescheiden door een lege regel (minimaal 2 per groep).':
      'Deux colonnes séparées par une ligne vide (au moins 2 par groupe).',
  'Meerdere groepen, elke groep een kolom, gescheiden door een lege regel (minimaal 2 groepen, 2 waarnemingen per groep).':
      'Plusieurs groupes, chaque groupe une colonne, séparés par une ligne vide (au moins 2 groupes, 2 observations par groupe).',
  'Plak Part, Operator en Value (tab of komma). Herhaal rijen voor replicaten. Minimaal 2 parts, 2 operators, 2 metingen per cel.':
      'Collez Part, Operator et Value (tabulation ou virgule). Répétez les lignes pour les réplicats. Au moins 2 parts, 2 opérateurs, 2 mesures par cellule.',
  'Plak X en Y (één getal per regel). Minimaal 3 paren; de engine weigert bij te weinig waarnemingen.':
      'Collez X et Y (un nombre par ligne). Au moins 3 paires ; le moteur refuse s’il y a trop peu d’observations.',
  'Part × Operator interaction pooled into repeatability':
      'Interaction Part × Operator regroupée dans la répétabilité',
  'Part × Operator interaction kept separate':
      'Interaction Part × Operator conservée séparément',
  'Te weinig gegevens voor een probability plot':
      'Trop peu de données pour un probability plot',
  'Met dank aan': 'Avec gratitude',
  'Automatisch oplosbare problemen aangepakt. Wat overblijft vraagt om een keuze.':
      'Les problèmes corrigibles automatiquement ont été traités. Le reste demande un choix.',
  'Niets dat zich vanzelf laat oplossen — dit vraagt om een keuze.':
      'Rien qui se règle tout seul — cela demande un choix.',
  'Probleem op deze dia oplossen': 'Corriger le problème sur cette diapositive',
  'Deze dia is geredigeerd en wordt niet aangepast.':
      'Cette diapositive est caviardée et ne sera pas modifiée.',
  'Geen probleem om hier op te lossen.': 'Aucun problème à corriger ici.',
  'SBAR-overdracht': 'Transmission SBAR',
  '(A)MIST traumaoverdracht': 'Transmission trauma (A)MIST',
  'Multidisciplinair overleg (MDO)': 'Réunion pluridisciplinaire (MDT)',
  'Chirurgische veiligheidscheck (WHO)':
      'Checklist de sécurité chirurgicale (WHO)',
  'Verpleegkundige dienstoverdracht': 'Transmission de service infirmier',
  'Inwerkplan (30-60-90 dagen)': 'Plan d\'intégration (30-60-90 jours)',
  'Eerste dag / introductie': 'Premier jour / accueil',
  'Buddy- / mentorafspraak': 'Plan buddy / mentor',
  'Uitdiensttreding / offboarding': 'Offboarding / départ',
  'IMSAFE fit-to-fly-check': 'IMSAFE contrôle d\'aptitude au vol',
  'Crew- / departurebriefing': 'Briefing équipage / départ',
  'Voorvalmelding (just culture)': 'Signalement d\'événement (just culture)',
  'Toolbox / LMRA veiligheidscheck': 'Toolbox / contrôle de sécurité LMRA',
  'Evenement- en crowd-safetybriefing':
      'Briefing événement et sécurité des foules',
  'Ontruimings- en BHV-oefening': 'Exercice d\'évacuation et BHV',
  'Werkvergunning (permit to work)': 'Permis de travail (permit to work)',
  'METHANE grootschalig-incidentmelding':
      'METHANE signalement d\'incident majeur',
  'GRIP-opschaling': 'Montée en puissance GRIP',
  ...
  'Draag een patiënt of situatie gestructureerd over: Situatie, Achtergrond, Beoordeling en Aanbeveling.':
      'Transmettez un patient ou une situation de façon structurée : Situation, Contexte, Évaluation et Recommandation.',
  'Prehospitale overdracht naar de SEH met leeftijd, mechanisme, letsels, symptomen en behandeling.':
      'Transmission préhospitalière aux urgences avec âge, mécanisme, lésions, signes et traitement.',
  'Bespreek een casus met alle disciplines: beeld, behandeldoel, besluiten en afspraken.':
      'Discutez d\'un cas entre les disciplines : tableau, objectif de traitement, décisions et actions.',
  'Sign in, time-out en sign out rond een ingreep volgens de WHO-checklist.':
      'Sign in, time-out et sign out autour d\'une intervention selon la checklist WHO.',
  'Draag de zorg per patiënt over: toestand, aandachtspunten en openstaande taken.':
      'Transmettez les soins par patient : état, points d\'attention et tâches en cours.',
  'Zet verwachtingen, mijlpalen en begeleiding uit over de eerste 30, 60 en 90 dagen.':
      'Définissez attentes, jalons et accompagnement sur les 30, 60 et 90 premiers jours.',
  'Mensen, systemen, huisregels en de veiligheids- en privacybasis voor een nieuwe medewerker.':
      'Les personnes, les systèmes, le règlement intérieur et les bases de sécurité et de confidentialité pour un nouvel arrivant.',
  'Doelen, ritme en checkpoints tussen nieuwkomer en buddy of mentor.':
      'Objectifs, rythme et points de suivi entre le nouveau venu et son buddy ou mentor.',
  'Kennisoverdracht, intrekken van toegang en een net exitgesprek bij vertrek.':
      'Transfert de connaissances, retrait des accès et un entretien de départ correct lors du départ.',
  'Persoonlijke go/no-go: ziekte, medicatie, stress, alcohol, vermoeidheid en gemoed.':
      'Go/no-go personnel : maladie, médicaments, stress, alcool, fatigue et émotion.',
  'Taakverdeling, bedreigingen en fouten (TEM) en afwijkingen vóór vertrek met de bemanning.':
      'Répartition des tâches, menaces et erreurs (TEM) et écarts avant le départ avec l\'équipage.',
  'Meld een voorval feitelijk en zonder schuldvraag: wat, factoren, risico en verbetering.':
      'Signalez un événement de façon factuelle et sans recherche de faute : quoi, facteurs, risque et amélioration.',
  'Taak, gevaren, maatregelen en akkoord vlak voordat het werk begint.':
      'Tâche, dangers, mesures et validation juste avant le début du travail.',
  'Capaciteit, risico\'s, in- en uitstroom en incidentrollen voor een evenement.':
      'Capacité, risques, flux de personnes et rôles en cas d\'incident pour un événement.',
  'Scenario, taken, verzamelplaats, waarnemingen en evaluatie van een ontruiming.':
      'Scénario, tâches, point de rassemblement, observations et évaluation d\'une évacuation.',
  'Werk, isolaties, controles en vrijgave voor risicovol werk vastleggen.':
      'Consignez travail, isolements, contrôles et autorisation pour les travaux à haut risque.',
  'Eerste melding bij een groot incident: melding, locatie, type, gevaren, toegang, aantal en diensten.':
      'Premier message lors d\'un incident majeur : incident majeur, localisation exacte, type, dangers, accès, nombre et services.',
  'Bepaal het GRIP-niveau, de crisisstructuur, rollen en op- en afschalingsbesluiten.':
      'Définissez le niveau GRIP, la structure de crise, les rôles et les décisions de montée et de descente.',
  'Reisplan en brugafspraken (appraisal, planning, execution, monitoring) met kritieke routepunten.':
      'Plan de route et accords de passerelle (appraisal, planning, execution, monitoring) avec points critiques de la route.',
  'Afbeelding of media': 'Image ou média',
  'Dia-inhoud': 'Contenu de la diapositive',
  'kon niet worden gelezen en is overgeslagen':
      'n\'a pas pu être lu et a été ignoré',
  'ontbrak in het bestand en is overgeslagen':
      'était absent du fichier et a été ignoré',
  'Hoofdeffecten': 'Effets principaux',
  'Interactie': 'Interaction',
  'Te weinig gegevens voor een hoofdeffectenplot':
      'Pas assez de données pour un graphique d\'effets principaux',
  'Te weinig gegevens voor een interactieplot':
      'Pas assez de données pour un graphique d\'interaction',
  'DOE-proefopzet…': 'Plan d\'expérience DOE…',
  'DOE-proefopzet': 'Plan d\'expérience DOE',
  'Genereert een ontwerptabel met gecodeerde factoren (−1/+1) en een lege Y-kolom in het raster.':
      'Génère un tableau d\'expérience avec facteurs codés (−1/+1) et une colonne Y vide dans la grille.',
  'Aantal factoren': 'Nombre de facteurs',
  'Volledig factorial (2^k)': 'Factoriel complet (2^k)',
  'Fractioneel (2^(k−p))': 'Fractionnaire (2^(k−p))',
  'Fractie p': 'Fraction p',
  'runs in standaard Yates-volgorde': 'essais en ordre Yates standard',
  'In raster zetten': 'Remplir la grille',
  'Eén reeks per factor met gecodeerde niveaus −1 en +1; laatste reeks is de respons (Y). Rijen zijn proefruns.':
      'Une série par facteur avec niveaux codés −1 et +1 ; la dernière série est la réponse (Y). Les lignes sont des essais.',
  'Golden-thread-id': 'Identifiant golden thread',
  'wordt ergens genoemd maar staat niet op een boom-dia — definieer hem op een CTQ- of Ishikawa-boom.':
      'est mentionné ailleurs mais n\'apparaît pas sur une diapositive arbre — définissez-le sur un arbre CTQ ou Ishikawa.',
  'staat op een boom-dia maar wordt nergens anders gebruikt — koppel hem aan een matrix, stroom of andere dia.':
      'figure sur une diapositive arbre mais n\'est utilisé nulle part ailleurs — reliez-le à une matrice, un flux ou une autre diapositive.',
  'Nieuw verbeteringsproject': 'Nouveau projet d\'amélioration',
  'Kader': 'Cadre',
  'Primaire Y-metriek (Y-01)': 'Métrique Y principale (Y-01)',
  'Bijvoorbeeld: doorlooptijd orderintake in werkdagen':
      'Par exemple : délai de traitement de la prise de commande en jours ouvrés',
  'Project starten': 'Démarrer le projet',
  'Procesverbetering: DMAIC-project':
      'Amélioration des processus : projet DMAIC',
  'DMAIC-skelet met charter, CTQ-boom (Y-01), SIPOC en fase-secties.':
      'Squelette DMAIC avec charte, arbre CTQ (Y-01), SIPOC et sections de phase.',
  'Een fasepoort-checklist: bevestig scope, stakeholders en go/no-go voordat je naar de volgende fase gaat.':
      'Une checklist de porte de phase : confirmez le périmètre, les parties prenantes et le go/no-go avant de passer à la phase suivante.',
  'Stroom': 'Flux',
  'Zwembanen': 'Couloirs',
  'Een processtroom, zwembanen of VSM. Stappen als titel :: soort :: pt=…; lt=…. Totalen (PCE, bottleneck) worden berekend, niet opgeslagen.':
      'Un flux de processus, couloirs ou VSM. Étapes sous titre :: type :: pt=…; lt=…. Les totaux (PCE, bottleneck) sont calculés et non enregistrés.',
  'Boom': 'Arbre',
  'Visgraat': 'Arête de poisson',
  'Lay-out': 'Disposition',
  'Punten': 'Points',
  'Inspringen': 'Indenter',
  'Uitspringen': 'Désindenter',
  'Punt toevoegen': 'Ajouter un point',
  'Punt verwijderen': 'Supprimer le point',
  'Een boom of visgraat (5× Why, CTQ, Ishikawa). Diepte met tabs; markeer oorzaken als **X-01** inline.':
      'Un arbre ou une arête de poisson (5× Why, CTQ, Ishikawa). Profondeur avec tabulations ; marquez les causes en **X-01** inline.',
  'Canvas': 'Canevas',
  'Een canvas van regio\'s (A3, charter, SWOT, bord). Kies een sjabloon; de ##-koppen op schijf zijn de vakken.':
      'Un canevas de régions (A3, charte, SWOT, tableau). Choisissez un modèle ; les titres ## sur disque sont les cases.',
  'Matrix': 'Matrice',
  'Een getypeerd raster (SIPOC, FMEA, RACI, …). Kies een sjabloon; afgeleide kolommen zoals RPN worden berekend en niet opgeslagen.':
      'Une grille typée (SIPOC, FMEA, RACI, …). Choisissez un modèle ; les colonnes dérivées comme RPN sont calculées et non enregistrées.',
  'Regelkaart': 'Carte de contrôle',
  'Histogram': 'Histogramme',
  'Pareto': 'Pareto',
  'Run chart': 'Graphique de séquence',
  'Boxplot': 'Boîte à moustaches',
  'Plakken uit klembord': 'Coller depuis le presse-papiers',
  'Te weinig gegevens voor een regelkaart':
      'Trop peu de données pour une carte de contrôle',
  'Te weinig gegevens voor een histogram':
      'Trop peu de données pour un histogramme',
  'Te weinig gegevens voor een boxplot':
      'Trop peu de données pour une boîte à moustaches',
  'Procesverbetering': 'Amélioration des processus',
  'Deze presentatie bevat onderdelen van de Procesverbetering-module. Zet de module aan om ze te bewerken.':
      'Cette présentation contient des éléments du module Amélioration des processus. Activez le module pour les modifier.',
  'Online media staat uit — aanzetten': 'Médias en ligne désactivés — activer',
  '{bestand} bevat uitvoerbare inhoud en wordt niet geïmporteerd.':
      '{bestand} contient du contenu exécutable et ne sera pas importé.',
  'Aanzetten in instellingen': 'Activer dans les paramètres',
  'Online media werkt niet in de webversie':
      'Les médias en ligne ne fonctionnent pas dans la version web',
  'De browser blokkeert media van een externe bron. Open deze presentatie in de app om online media te tonen.':
      'Le navigateur bloque les médias provenant d\'une source externe. Ouvrez cette présentation dans l\'application pour afficher les médias en ligne.',
  'Bron niet toegestaan': 'Source non autorisée',
  'Deze URL is door de beveiliging geweigerd.':
      'Cette URL a été rejetée par la sécurité.',
  'Alinea': 'Paragraphe',
  'Audio "{bestand}"': 'Audio "{bestand}"',
  'Deck opbouwen…': 'Construction du deck…',
  'Dia bevat meerdere audiofragmenten; OciDeck ondersteunt er maar één per dia.':
      'La diapositive contient plusieurs clips audio ; OciDeck n\'en prend en charge qu\'un seul par diapositive.',
  'Dia bevat meerdere grafieken; OciDeck ondersteunt er maar één per dia.':
      'La diapositive contient plusieurs graphiques ; OciDeck n\'en prend en charge qu\'un seul par diapositive.',
  'Dia bevat meerdere tabellen; OciDeck ondersteunt er maar één per dia.':
      'La diapositive contient plusieurs tableaux ; OciDeck n\'en prend en charge qu\'un seul par diapositive.',
  'Dia bevat meerdere video\'s; OciDeck ondersteunt er maar één per dia.':
      'La diapositive contient plusieurs vidéos ; OciDeck n\'en prend en charge qu\'une seule par diapositive.',
  'Dia {n} overgeslagen': 'Diapositive {n} ignorée',
  'Dia {n}: alleen de afbeelding overgenomen':
      'Diapositive {n} : seule l\'image a été conservée',
  'Een niet-tekstuele vorm, lijn of ander object kon niet worden omgezet.':
      'Une forme, une ligne ou un autre objet non textuel n\'a pas pu être converti.',
  'Footerrijen worden in Markdown niet ondersteund.':
      'Les lignes de pied de page ne sont pas prises en charge dans Markdown.',
  'Formaat herkennen…': 'Détection du format…',
  'Gegroepeerde objecten zijn uitgeklapt; groepering en volgorde binnen de groep gaan verloren.':
      'Les objets groupés ont été dissociés ; le groupement et l\'ordre au sein du groupe sont perdus.',
  'Groepering': 'Groupement',
  'Headerkolommen worden in OciDeck niet ondersteund.':
      'Les colonnes d\'en-tête ne sont pas prises en charge dans OciDeck.',
  'IWA-objecten inlezen…': 'Lecture des objets IWA…',
  'IWA-structuur gedeeltelijk geparseerd — de vormgeving (thema, kleuren, posities) is niet overgenomen; tekst, slide-volgorde, notities en, waar de structuren herkend werden, tabellen, grafieken en media wel':
      'Structure IWA partiellement analysée — la mise en forme (thème, couleurs, positions) n\'a pas été reprise ; le texte, l\'ordre des diapositives, les notes et, là où les structures ont été reconnues, les tableaux, graphiques et médias l\'ont été.',
  'IWA-structuur niet volledig geparseerd — opmaak, tabellen, grafieken, media en slide-volgorde niet overgenomen':
      'Structure IWA non entièrement analysée — mise en forme, tableaux, graphiques, médias et ordre des diapositives non repris',
  'IWA-tekst salvage…': 'Récupération du texte IWA…',
  'Keynote IWA-intern': 'Keynote IWA interne',
  'Keynote IWA-intern (~{n} dia’s)': 'Keynote IWA interne (~{n} diapositives)',
  'Keynote tabel footer': 'Pied de tableau Keynote',
  'Keynote tabel header': 'En-tête de tableau Keynote',
  'Keynote tabel headerkolommen': 'Colonnes d\'en-tête de tableau Keynote',
  'Klaar.': 'Terminé.',
  'Koppeling “{tekst}”': 'Lien "{tekst}"',
  'Meerdere audio': 'Plusieurs audios',
  'Meerdere grafieken': 'Plusieurs graphiques',
  'Meerdere headerrijen worden in Markdown niet ondersteund; alleen de eerste rij wordt als tabelheader gebruikt.':
      'Les lignes d\'en-tête multiples ne sont pas prises en charge dans Markdown ; seule la première ligne est utilisée comme en-tête de tableau.',
  'Meerdere tabellen': 'Plusieurs tableaux',
  'Meerdere video\'s': 'Plusieurs vidéos',
  'Metadata uitlezen…': 'Lecture des métadonnées…',
  'Niet overgenomen van dit document': 'Non repris de ce document',
  'Niet overgenomen van slide {n}': 'Non repris de la diapositive {n}',
  'Ondersteund grafiektype': 'Type de graphique pris en charge',
  'Samengevoegde cellen': 'Cellules fusionnées',
  'Samengevoegde tabelcellen worden in GFM-tabellen niet ondersteund; de tabel is platgeklapt.':
      'Les cellules de tableau fusionnées ne sont pas prises en charge dans les tableaux GFM ; le tableau a été aplati.',
  'Scatter x-as': 'Axe x du nuage de points',
  'Scatter-grafiek met aparte x-waardes per serie kan niet volledig worden weergegeven.':
      'Un nuage de points avec des valeurs x distinctes par série ne peut pas être entièrement représenté.',
  'Slides classificeren…': 'Classification des diapositives…',
  'Slides reconstrueren…': 'Reconstruction des diapositives…',
  'Tabel naast grafiek': 'Tableau à côté du graphique',
  'Voorbeeldafbeelding zoeken…': 'Recherche de l\'image d\'aperçu…',
  'Vorm of object': 'Forme ou objet',
  'de tekst blijft staan, de verwijzing niet': 'le texte reste, pas le lien',
  'deels overgenomen': 'partiellement repris',
  'doel onschadelijk gemaakt; het wees naar {url}':
      'cible neutralisée ; elle pointait vers {url}',
  'eerste audio overgenomen': 'premier audio conservé',
  'eerste grafiek overgenomen': 'premier graphique conservé',
  'eerste rij als header': 'première ligne comme en-tête',
  'eerste tabel overgenomen': 'premier tableau conservé',
  'eerste video overgenomen': 'première vidéo conservée',
  'gedeelde x-as gebruikt': 'axe x partagé utilisé',
  'niet overgenomen (OciDeck heeft geen audio-slides)':
      'non repris (OciDeck n\'a pas de diapositives audio)',
  'niet overgenomen (deze dia werd een {type})':
      'non repris (cette diapositive est devenue un {type})',
  'niet overgenomen (deze dia werd een {type}, en die draagt geen opsomming)':
      'non repris (cette diapositive est devenue un {type}, qui ne contient pas de liste à puces)',
  'niet overgenomen (een {type}-dia toont er {aantal})':
      'non repris (une diapositive {type} en affiche {aantal})',
  'niet overgenomen (een {type}-dia toont geen losse alineatekst)':
      'non repris (une diapositive {type} n\'affiche pas de texte de paragraphe libre)',
  'niet overgenomen (één grafiek of tabel per slide)':
      'non repris (un graphique ou un tableau par diapositive)',
  'objecten apart overgenomen': 'objets repris séparément',
  'samengevoegd in leesvolgorde': 'fusionnés dans l\'ordre de lecture',
  'tekst, volgorde, notities en herkende tabellen, grafieken en media':
      'texte, ordre, notes et tableaux, graphiques et médias reconnus',
  '{n} afbeelding': '{n} image',
  '{n} afbeeldingen': '{n} images',
  '{n} alinea’s': '{n} paragraphes',
  '{n} opsommingspunt': '{n} puce',
  '{n} opsommingspunten': '{n} puces',
  '{n} vrij geplaatste tekstvakken': '{n} zones de texte placées librement',
  'voorbeeldafbeelding en tekst': 'image d\'aperçu et texte',
  'voorbeeldafbeelding': 'image d\'aperçu',
  'tekst': 'texte',
  '{bestand} is groter dan de limiet van {limiet} en wordt niet geïmporteerd.':
      '{bestand} dépasse la limite de {limiet} et ne sera pas importé.',
  '{bestand} is geen herkende presentatie. OciDeck leest PowerPoint (.pptx), OpenDocument (.odp) en Keynote (.key).':
      '{bestand} n\'est pas une présentation reconnue. OciDeck lit PowerPoint (.pptx), OpenDocument (.odp) et Keynote (.key).',
  '{bestand} lijkt beschadigd: het archief kan niet volledig worden uitgepakt.':
      '{bestand} semble endommagé : l\'archive ne peut pas être entièrement extraite.',
  'Het {formaat}-formaat wordt nog niet ondersteund ({bestand}).':
      'Le format {formaat} n\'est pas encore pris en charge ({bestand}).',
  'Geen dia’s gevonden in {bestand} — is dit een geldig {formaat}-bestand?':
      'Aucune diapositive trouvée dans {bestand} — s\'agit-il d\'un fichier {formaat} valide ?',
  'Kon {bestand} niet lezen als {formaat}-presentatie.':
      'Impossible de lire {bestand} comme présentation {formaat}.',
  'Wat doen we met deze dia’s?': 'Que faire de ces diapositives ?',
  'Deze dia’s konden niet volledig worden omgezet. Kies per dia wat er moet gebeuren; wat u niet aanraakt wordt zo volledig mogelijk overgenomen, met een notitie erbij over wat er ontbreekt.':
      'Ces diapositives n\'ont pas pu être converties entièrement. Choisissez pour chaque diapositive ce qui doit se passer ; ce que vous ne touchez pas sera repris aussi complètement que possible, avec une note sur ce qui manque.',
  'Voor alle dia’s:': 'Pour toutes les diapositives :',
  'Dia': 'Diapositive',
  'Zo volledig mogelijk': 'Le plus complet possible',
  'Alleen de afbeelding': 'Image seule',
  'Import afbreken': 'Annuler l\'importation',
  'Niet meer vragen': 'Ne plus demander',
  'Voortaan alles zo volledig mogelijk overnemen.':
      'Désormais, tout reprendre aussi complètement que possible.',
  ...
  'Geen OpenKAT-rapportages gevonden in deze map.':
      'Aucun rapport OpenKAT trouvé dans ce dossier.',
  'rapportages': 'rapports',
  'overgeslagen': 'ignorés',
  ...
  'Het bestand kon niet worden opgebouwd of weggeschreven. Controleer of er schijfruimte is en of de exportmap beschrijfbaar is.':
      'Le fichier n\'a pas pu être créé ni écrit. Vérifiez qu\'il reste de l\'espace disque et que le dossier d\'export est accessible en écriture.',
  'Het renderen van de dia\'s naar beeld is mislukt. Dit ligt aan een dia, niet aan het bestandsformaat: de HTML-export komt hier niet langs en werkt in dit geval meestal wel.':
      'Le rendu des diapositives en images a échoué. Cela vient d\'une diapositive, pas du format de fichier : l\'export HTML ne passe pas par là et fonctionne généralement dans ce cas.',
  'Technische melding:': 'Message technique :',
  ...
  'Export geblokkeerd door classificatiebeleid: dit deck is {deck}, lager dan het vereiste minimum {limit}.':
      'Export bloqué par la politique de classification : cette présentation est {deck}, en dessous du minimum requis {limit}.',
  'Export geblokkeerd door classificatiebeleid: dit deck is {deck}, hoger dan het toegestane vrijgaveniveau {limit}.':
      'Export bloqué par la politique de classification : cette présentation est {deck}, au-dessus du plafond de diffusion autorisé {limit}.',
  'niet geclassificeerd': 'sans classification',
  ...
  'Een laag naast dit deck was te groot en is niet ingelezen; het bestand zelf is ongewijzigd:':
      'Une couche à côté de ce deck était trop volumineuse et n\'a pas été chargée ; le fichier lui-même est inchangé :',
  ...
  'min': 'min',
  '# Bedankt\n\nVragen?': '# Merci\n\nDes questions ?',
  'P {pitch}  B {bank}': 'T {pitch}  I {bank}',
  'ACT {value}°': 'ACT {value}°',
  'TGT {heading}°': 'CIB {heading}°',
  ...
  'Ondertitel / toelichting': 'Sous-titre / explication',
  'Ondertitel (optioneel)': 'Sous-titre (facultatif)',
  'Titel overlay (optioneel)': 'Titre en surimpression (facultatif)',
  'Tekst (links)': 'Texte (gauche)',
  'Bullets links': 'Puces à gauche',
  'Bullets rechts': 'Puces à droite',
  'Titeltekstkleur': 'Couleur du texte du titre',
  'Knippen': 'Découpe',
  'Geen achtergrondafbeelding': 'Aucune image d\'arrière-plan',
  'Breedte afbeeldingspaneel (rechts)': 'Largeur du panneau image (droite)',
  'Verdeling (links / rechts)': 'Répartition (gauche / droite)',
  'TYPE': 'TYPE',
  'STIJL': 'STYLE',
  'Bijv. 1.0': 'Ex. 1.0',
  ...
  'Komma-gescheiden, bijv. kwartaal, cijfers, 2026':
      'Séparés par des virgules, ex. trimestre, chiffres, 2026',
  'Komma-gescheiden, bijv. OWASP WSTG@4.2':
      'Séparés par des virgules, ex. OWASP WSTG@4.2',
  'Korte omschrijving van de presentatie':
      'Brève description de la présentation',
  'Titel van de presentatie': 'Titre de la présentation',
  ...
  'Intrekken is niet vastgelegd. Bij de volgende start geldt uw toestemming weer.':
      'Le retrait n\'a pas été enregistré. Au prochain démarrage, votre consentement s\'applique de nouveau.',
  ...
  'Niet doorzocht': 'Non parcouru',
  'Deze controle draait niet in de webversie: gezichtsherkenning vergt een systeembibliotheek die de browser niet heeft. Gebruik de desktopversie om afbeeldingen op gezichten na te kijken.':
      'Cette vérification ne s\'exécute pas dans la version web : la détection de visages nécessite une bibliothèque système absente du navigateur. Utilisez la version bureau pour vérifier les visages sur les images.',
  'Het token heeft lees- en schrijfrechten op de repository nodig. Gitea en Forgejo kennen geen server-side zoeken; OciDeck zoekt lokaal.':
      'Le jeton doit avoir un accès en lecture et écriture au dépôt. Gitea et Forgejo n\'ont pas de recherche côté serveur ; OciDeck cherche en local.',
  'Het token heeft de repo-scope nodig (of fijnmazig: Contents lezen en schrijven).':
      'Le jeton doit avoir la portée repo (ou fin : Contents en lecture et écriture).',
  'Het token heeft read_repository, write_repository en read_api nodig. Server-side zoeken vereist Advanced- of Exact Search.':
      'Le jeton doit avoir read_repository, write_repository et read_api. La recherche côté serveur nécessite Advanced ou Exact Search.',
  'Snelle server-zoekopdracht — door indexeringsvertraging kan een net gewijzigd deck ontbreken.':
      'Recherche côté serveur rapide — en raison du délai d\'indexation, un deck récemment modifié peut manquer.',
  ...
  'TOTP-seed (tweede factor)': 'graine TOTP (second facteur)',
  'mogelijk een sleutel of wachtwoord': 'peut-être une clé ou un mot de passe',
  ...
  'Deadline': 'Échéance',
  'Stand': 'État',
  'geen datum': 'sans date',
  'Besluit gevraagd': 'Décision requise',
  'Escalatie': 'Escalade',
  'Open': 'Ouvert',
  'Loopt': 'En cours',
  'Afgerond': 'Terminé',
  ...
  'Lager is beter': 'Plus bas, c\'est mieux',
  'Hoger is beter': 'Plus haut, c\'est mieux',
  'Neutraal': 'Neutre',
  'Nu': 'Maintenant',
  'Vorige rapportage': 'Rapport précédent',
  'Een scorecard toont hoogstens vijf cijfers; meer leest niet meer als een oordeel.':
      'Une fiche de résultats affiche au maximum cinq indicateurs ; au-delà, ce n\'est plus un jugement.',
  'Laat de vorige rapportage leeg als er nog geen meting was; de slide toont dan geen verandering.':
      'Laissez le rapport précédent vide s\'il n\'y avait pas encore de mesure ; la diapositive n\'affichera aucun changement.',
  ...
  'zorgverzekeringsnummer (OHIP) — een zorggegeven':
      'numéro d\'assurance maladie (OHIP) — donnée de santé',
  'bedrijfsnummer (BN)': 'numéro d\'entreprise (BN)',
  'zorgverlenersnummer (NPI)': 'numéro de professionnel de santé (NPI)',
  'Medicare-nummer (MBI) — een zorggegeven':
      'numéro Medicare (MBI) — une donnée de santé',
  'wacht op verbinding': 'en attente de connexion',
  'Opgeslagen op deze computer, nog niet in de repository. Gaat mee zodra er weer verbinding is — of nu, met "Wachtrij legen".':
      'Enregistré sur cet ordinateur, pas encore dans le dépôt. Il partira dès qu\'il y aura de nouveau une connexion — ou maintenant, avec « Vider la file ».',
  ...
  'Je bent aangemeld, maar hebt hier geen toegang. Je wachtwoord is niet het probleem — vraag de beheerder om rechten op deze map.':
      'Vous êtes connecté, mais vous n\'avez pas accès ici. Votre mot de passe n\'est pas en cause : demandez les droits sur ce dossier à l\'administrateur.',
  'Je token is geldig, maar mag dit niet. Geef het meer rechten, of wacht als de forge een limiet oplegt.':
      'Votre jeton est valide, mais n\'a pas le droit de faire cela. Donnez-lui plus de droits, ou attendez si la forge applique une limite.',
  'Het token is geldig, maar mag dit niet — geef het meer rechten op de repository.':
      'Le jeton est valide, mais n\'a pas le droit de faire cela — donnez-lui plus de droits sur le dépôt.',
  'Aangemeld, maar geen toegang — je wachtwoord is niet het probleem. Vraag rechten op deze map.':
      'Connecté, mais sans accès — votre mot de passe n\'est pas en cause. Demandez les droits sur ce dossier.',
  'Dit lijkt een volledige DAV-URL. Bij Nextcloud leidt OciDeck dat pad zelf af — hier hoort alleen de server te staan.':
      'Cela ressemble à une URL DAV complète. Pour Nextcloud, OciDeck déduit ce chemin lui-même : seul le serveur va ici.',
  'Overnemen': 'Appliquer',
  'WebDAV is niet (goed) ingesteld — controleer de servergegevens bij Instellingen → Opslag.':
      'WebDAV n\'est pas (bien) configuré — vérifiez les données du serveur dans Paramètres → Stockage.',
  'De git-repository is niet (goed) ingesteld — controleer server, eigenaar en repository bij Instellingen → Opslag.':
      'Le dépôt git n\'est pas (bien) configuré — vérifiez serveur, propriétaire et dépôt dans Paramètres → Stockage.',
  'De servernaam van de forge bestaat niet, of is niet op te zoeken. Controleer de server-URL op een typefout.':
      'Le nom du serveur de la forge n\'existe pas ou ne peut pas être résolu. Vérifiez que l\'URL du serveur ne contient pas de faute de frappe.',
  'Deze forge heeft een privé- of LAN-adres. Markeer hem als vertrouwd intern bij Instellingen → Opslag.':
      'Cette forge a une adresse privée ou LAN. Marquez-la comme interne de confiance dans Paramètres → Stockage.',
  'De forge is niet bereikbaar — controleer je verbinding en de server-URL.':
      'La forge est injoignable — vérifiez votre connexion et l\'URL du serveur.',
  'Aanmelden bij de forge mislukt. Controleer je token: het heeft leesrechten op de repository nodig, en schrijfrechten om op te slaan.':
      'Échec de la connexion à la forge. Vérifiez votre jeton : il lui faut un accès en lecture au dépôt, et en écriture pour enregistrer.',
  'Niet gevonden in de repository — of je token mag het niet zien.':
      'Introuvable dans le dépôt — ou votre jeton n\'a pas le droit de le voir.',
  'De forge gaf een fout. Probeer het later opnieuw.':
      'La forge a renvoyé une erreur. Réessayez plus tard.',
  'Dit adres antwoordt niet als een forge. Klopt de soort forge bij Instellingen → Opslag?':
      'Cette adresse ne répond pas comme une forge. Le type de forge dans Paramètres → Stockage est-il correct ?',
  'Stel eerst een WebDAV-server in bij Instellingen → Opslag.':
      'Configurez d\'abord un serveur WebDAV dans Paramètres → Stockage.',
  ...
  'Landpakketten voor identificatienummers':
      'Modules nationaux pour les numéros d\'identification',
  'Nummers als het BSN of het PESEL zijn landgebonden. Heel Europa staat aan omdat de meeste van die nummers een controlegetal hebben: die aanzetten kost vrijwel geen valse meldingen. IBAN, e-mail, geheimen en paspoortstroken staan hier los van en worden altijd nagekeken.':
      'Des numéros comme le BSN néerlandais ou le PESEL polonais sont propres à un pays. Toute l\'Europe est activée parce que la plupart de ces numéros comportent un chiffre de contrôle : les activer ne coûte presque aucune fausse alerte. IBAN, e-mail, secrets et bandes de passeport en sont indépendants et sont toujours vérifiés.',
  ...
  'IMSI van een abonnee': 'IMSI d\'un abonné',
  'sociale-mediaprofiel': 'profil de réseau social',
  'advertentie- of apparaat-ID': 'identifiant publicitaire ou d\'appareil',
  'IP-adres': 'adresse IP',
  ...
  'Mogelijk persoonsgegevens': 'Données personnelles possibles',
  'Persoonsgegevens geaccepteerd': 'Données personnelles acceptées',
  'Persoonsgegevens gevonden': 'Données personnelles trouvées',
  ...
  'Sinds je dit deck opende is de versie op de server veranderd. Overschrijven maakt het werk van de ander ongedaan.':
      'La version sur le serveur a changé depuis que vous avez ouvert cette présentation. Écraser supprime le travail de l\'autre personne.',
  'Overschrijven': 'Écraser',
  ...
  'Opslag': 'Stockage',
  'Opslagwijzen': 'Modes de stockage',
  'Ingesteld': 'Configuré',
  'Niet ingesteld': 'Non configuré',
  ...
  'Iemand anders had dit deck ook bewerkt — samengevoegd en opgeslagen.':
      'Quelqu\'un d\'autre avait aussi modifié ce deck — fusionné et enregistré.',
  'Keuzes toegepast — sla op om ze vast te leggen.':
      'Choix appliqués — enregistrez pour les valider.',
  'Allebei bewerkt — kies per slide':
      'Modifié des deux côtés — choisissez par diapositive',
  'Iemand anders bewerkte dit deck tegelijk met jou. Alles wat vanzelf kon is al samengevoegd; deze slides niet.':
      'Quelqu\'un d\'autre a modifié ce deck en même temps que vous. Tout ce qui pouvait être fusionné automatiquement l\'a été ; pas ces diapositives.',
  'Mijn versie': 'Ma version',
  'Hun versie': 'Leur version',
  ...
  'Beveiligingsontwerp': 'Conception de la sécurité',
  'Hosting en uitrol': 'Hébergement et déploiement',
  'Bijdragen': 'Contribuer',
  'Migratiegids': 'Guide de migration',
  'Versies…': 'Versions…',
  'Versies:': 'Versions :',
  'Nog geen uitgebrachte versies van dit deck.':
      'Aucune version publiée de ce deck pour l\'instant.',
  'Horizontale gestapelde staaf': 'Barres horizontales empilées',
  'Git-geschiedenis…': 'Historique git…',
  'Git-geschiedenis:': 'Historique git :',
  'Nog geen commits voor dit deck.':
      'Aucun commit pour ce deck pour l\'instant.',
  'Gepusht': 'Poussé',
  'Nog niet gepusht': 'Pas encore poussé',
  'Gesynchroniseerd met git.': 'Synchronisé avec git.',
  'Nog geen verbinding — het gaat later mee.':
      'Pas encore de connexion — ce sera envoyé plus tard.',
  'De branch is verzet; je commits staan lokaal klaar.':
      'La branche a bougé ; vos commits sont prêts en local.',
  'Synchroniseren mislukt.': 'Échec de la synchronisation.',
  'Native git gevonden:': 'git natif trouvé :',
  'Native git: bezig met detecteren…': 'git natif : détection…',
  'Native git: niet gevonden — het REST-pad wordt gebruikt':
      'git natif : introuvable — le chemin REST est utilisé',
  'echte offline-historie mogelijk': 'historique hors ligne réel possible',
  ...
  'Alleen letters, cijfers, punt, streep en liggend streepje':
      'Uniquement lettres, chiffres, point, tiret et trait de soulignement',
  ...
  'Bijgewerkt met OciDeck': 'Mis à jour avec OciDeck',
  ...
  'Open presentaties uit een git-repository. Elke opgeslagen versie blijft bewaard. Het token wordt versleuteld in de sleutelhanger bewaard, niet bij de overige instellingen.':
      'Ouvrez des présentations depuis un dépôt Git. Chaque version enregistrée est conservée. Le jeton est stocké chiffré dans le trousseau, pas avec les autres réglages.',
  ...
  'Onderbouwing van de bevestiging': 'Justification de la confirmation',
  'De eigenaar staat insluiten niet toe':
      'Le propriétaire n\'autorise pas l\'intégration',
  'Deze video is alleen op de bron zelf te bekijken.':
      'Cette vidéo ne peut être visionnée que sur la source elle-même.',
  'Video niet gevonden': 'Vidéo introuvable',
  'De video is verwijderd, privé of de link klopt niet.':
      'La vidéo a été supprimée, est privée ou le lien est incorrect.',
  'Ongeldige video-link': 'Lien vidéo invalide',
  'Controleer de URL van de video op deze slide.':
      'Vérifiez l\'URL de la vidéo sur cette diapositive.',
  'Geen verbinding met de videobron': 'Aucune connexion à la source vidéo',
  ...
  'Logo tonen': 'Afficher le logo',
  'Footer tonen': 'Afficher le pied de page',
  'Tabel bewerkbaar': 'Tableau modifiable',
  ...
  'Gewaarschuwd': 'Averti',
  'Weggelaten': 'Retiré',
  'Bewerkbaar': 'Modifiable',
  'De privacycontrole': 'Le contrôle de confidentialité',
  'OciDeck leest je dia\'s na op gegevens die privacygevoelig kunnen zijn: identificatienummers, contactgegevens, telefoonnummers, bankrekeningen, sleutels en wachtwoorden, en bijzondere persoonsgegevens. Dat gebeurt volledig op dit apparaat: er wordt niets verstuurd, en de gevonden waarde zelf komt in geen enkele melding te staan.':
      'OciDeck parcourt tes diapositives à la recherche de données potentiellement sensibles : numéros d\'identification, coordonnées, numéros de téléphone, comptes bancaires, clés et mots de passe, et catégories particulières de données personnelles. Tout se passe sur cet appareil : rien n\'est envoyé, et la valeur trouvée n\'apparaît dans aucun message.',
  'De controle garandeert niet dat alles wordt gevonden; ze verkleint de kans dat er persoonsgegevens onbedoeld uitlekken.':
      'Le contrôle ne garantit pas que tout soit trouvé ; il réduit le risque que des données personnelles fuitent involontairement.',
  'Tekst in afbeeldingen blijft buiten beeld, gelinkte bestanden worden niet geopend, en gegevens zonder herkenbaar patroon herkent geen enkele scanner. Een dia zonder meldingen is een dia waarin wíj niets hebben gevonden, niet een dia waarvan vaststaat dat er niets in staat. Wat je deelt, blijft jouw beslissing en jouw verantwoordelijkheid.':
      'Le texte dans les images reste hors de portée, les fichiers liés ne sont pas ouverts, et aucun scanner ne reconnaît des données sans motif identifiable. Une diapositive sans signalement est une diapositive où *nous* n\'avons rien trouvé, pas une diapositive dont il est prouvé qu\'elle ne contient rien. Ce que tu partages reste ta décision et ta responsabilité.',
  ...
  'massa-persoonsgegevens op één slide':
      'données personnelles en masse sur une diapositive',
  'gebruikerspad met een naam erin': 'chemin utilisateur contenant un nom',
  'toegangstoken in een link': 'jeton d\'accès dans un lien',
  'persoonsgegeven in een link': 'donnée personnelle dans un lien',
  'deellink met ingebakken toegang': 'lien de partage avec accès intégré',
  'e-mailadres in een link': 'adresse e-mail dans un lien',
  'ingesloten afbeelding — wij kunnen er niet in kijken':
      'image intégrée — nous ne pouvons pas regarder dedans',
  ...
  'Eén per regel: je naam, e-mailadres, telefoonnummer of het domein van je organisatie. Wat hier staat wordt niet gemeld en niet geredigeerd — het is de afzender, geen bevinding. Een domein (example.org) dekt elk adres eronder.':
      'Un par ligne : ton nom, ton adresse e-mail, ton numéro de téléphone ou le domaine de ton organisation. Ce qui figure ici n\'est ni signalé ni caviardé — c\'est l\'expéditeur, pas un constat. Un domaine (example.org) couvre toutes les adresses en dessous.',
  'Bij onafgehandelde persoonsgegevens':
      'En cas de données personnelles non traitées',
  'Export afgebroken vanwege privacybevindingen.':
      'Export annulé en raison de constats de confidentialité.',
  'Export blokkeren': 'Bloquer l\'export',
  'Export geblokkeerd': 'Export bloqué',
  'Export geblokkeerd: er staan persoonsgegevens in dit deck waarvoor nog geen keuze is gemaakt.':
      'Export bloqué : cette présentation contient des données personnelles sur lesquelles tu n\'as pas encore tranché.',
  'Kies per slide wat er moet gebeuren, of exporteer bewust zoals het is.':
      'Choisis par diapositive ce qui doit se passer, ou exporte délibérément tel quel.',
  'Maak per slide een keuze (accepteren, waarschuwen of weglaten) voordat je exporteert. Dit is zo ingesteld bij Beveiliging.':
      'Fais un choix par diapositive (accepter, avertir ou omettre) avant d\'exporter. C\'est réglé sous Sécurité.',
  'Niets doen': 'Ne rien faire',
  'Persoonsgegevens in dit deck':
      'Données personnelles dans cette présentation',
  'Verder in dit deck:': 'Ailleurs dans cette présentation :',
  'Waarschuwen vóór export': 'Avertir avant l\'export',
  'bevinding(en) zonder keuze.': 'constat(s) sans décision.',
  'geaccepteerd': 'acceptés',
  ...
  ' Op deze slide staat ook een identificerend gegeven, dus dit is herleidbaar tot een persoon.':
      ' Cette diapositive contient aussi une donnée identifiante, ceci est donc rattachable à une personne.',
  'Bijzonder persoonsgegeven (AVG art. 9/10)':
      'Catégorie particulière de données personnelles (RGPD art. 9/10)',
  'gezondheidsgegeven': 'donnée de santé',
  'strafrechtelijk gegeven': 'donnée pénale',
  'religie of levensovertuiging': 'religion ou conviction',
  'vakbondslidmaatschap': 'appartenance syndicale',
  'biometrisch gegeven': 'donnée biométrique',
  'genetisch gegeven': 'donnée génétique',
  'parketnummer': 'numéro de dossier du parquet',
  'nationaal identificatienummer': 'numéro d\'identification national',
  ...
  'Afgebroken. Er is niets half achtergebleven.':
      'Annulé. Rien n\'est resté à moitié fait.',
  'Bijwerken': 'Mettre à jour',
  'Binnenhalen…': 'Téléchargement…',
  'CVE\'s': 'CVE',
  'Database ophalen': 'Récupérer la base de données',
  'De CVE-lijst kon niet worden opgehaald. Controleer je verbinding en probeer het opnieuw; een half binnengehaalde lijst is weggegooid.':
      'La liste CVE n\'a pas pu être récupérée. Vérifie ta connexion et réessaie ; une liste téléchargée à moitié a été supprimée.',
  'De nieuwste uitgave opzoeken…': 'Recherche de la dernière version…',
  'Dit is een grote download: ruim 500 MB binnenhalen, tijdelijk zo\'n 1,5 GB schijfruimte, en afhankelijk van je verbinding en apparaat al gauw tien tot dertig minuten werk. Daarna blijft er een index van enkele honderden megabytes staan. Op een verbinding die per megabyte betaalt, doe je dit liever niet.':
      'C\'est un gros téléchargement : plus de 500 MB à récupérer, environ 1,5 GB d\'espace disque temporairement et, selon ta connexion et ton appareil, facilement dix à trente minutes de travail. Ensuite, il reste un index de quelques centaines de mégaoctets. Sur une connexion facturée au mégaoctet, mieux vaut s\'abstenir.',
  'Er was te weinig schijfruimte. De opbouw vraagt tijdelijk ruim 1,5 GB.':
      'L\'espace disque était insuffisant. La construction nécessite temporairement plus de 1,5 GB.',
  'Het opgehaalde archief was niet wat we verwachtten en is geweigerd. Er is niets geïnstalleerd.':
      'L\'archive récupérée n\'était pas celle attendue et a été refusée. Rien n\'a été installé.',
  'Indexeren…': 'Indexation…',
  'Lokaal beschikbaar — opzoeken gebeurt offline, er gaat geen zoekterm naar buiten.':
      'Disponible en local — les recherches se font hors ligne, aucun terme de recherche ne sort.',
  'Lokale CVE-database': 'Base de données CVE locale',
  'Met de CVE-lijst op je eigen apparaat blijft het opzoeken hier: er gaat geen zoekterm meer naar een server, en niemand kan zien welk lek je onderzoekt.':
      'Avec la liste CVE sur ton propre appareil, les recherches restent ici : plus aucun terme de recherche ne part vers un serveur, et personne ne peut voir quelle faille tu examines.',
  'Uitpakken…': 'Extraction…',
  'Zet de volledige CVE-lijst op dit apparaat, zodat opzoeken offline gebeurt en je zoekterm nergens heen gaat. De database komt van CVE List V5 (het officiële CVE-programma, via GitHub).':
      'Place la liste CVE complète sur cet appareil, pour que les recherches se fassent hors ligne et que ton terme de recherche n\'aille nulle part. La base de données provient de CVE List V5 (le programme CVE officiel, via GitHub).',
  'Wat er lokaal beschikbaar is': 'Ce qui est disponible localement',
  'Nu bijwerken': 'Mettre à jour maintenant',
  'Gegevens lokaal beschikbaar — het opzoeken gebeurt op dit apparaat, er gaat niets naar buiten.':
      'Données disponibles localement — les recherches se font sur cet appareil ; rien n\'en sort.',
  'Zwakheden (CWE)': 'Faiblesses (CWE)',
  'Testgevallen (WSTG)': 'Cas de test (WSTG)',
  'MIAUW-eisen': 'Exigences MIAUW',
  'CVSS-scoretabel': 'Table de scores CVSS',
  'Bevindingsjablonen': 'Modèles de constat',
  ...
  'Accepteren: de gegevens horen hier en de melding verdwijnt. Accepteren + waarschuwen: de ontvanger ziet een badge dat er persoonsgegevens op de slide staan. Weglaten: de gevonden gegevens worden onleesbaar gemaakt op het scherm en in de export — je markdown-bestand houdt de oorspronkelijke tekst.':
      'Accepter : les données sont à leur place et l\'avis disparaît. Accepter + avertir : le destinataire voit un badge indiquant des données personnelles sur la diapositive. Omettre : les données trouvées deviennent illisibles à l\'écran et à l\'export — ton fichier Markdown conserve le texte d\'origine.',
  'Alleen melden': 'Signaler seulement',
  'PERSOONSGEGEVENS': 'DONNÉES PERSONNELLES',
  'Volg de presentatie': 'Suivre la présentation',
  'Weglaten uit tonen en exporteren': 'Omettre de l\'affichage et de l\'export',
  ...
  'De TSA-handtekening is niet in-app geverifieerd; alleen de hash komt overeen.':
      'La signature de la TSA n\'est pas vérifiée dans l\'application ; seul le hachage correspond.',
  'Extern': 'Externe',
  ...
  'Laad een eigen checklist-sjabloon':
      'Charger un modèle de checklist personnalisé',
  'Leeg laten': 'Laisser vide',
  'Maak herbruikbare testlijsten die je per scope-object in een checklist kunt laden, naast de gebundelde WSTG-lijst.':
      'Créez des listes de tests réutilisables que vous pouvez charger dans une checklist par objet de la portée, en plus de la liste WSTG intégrée.',
  'Nieuw sjabloon': 'Nouveau modèle',
  'Nog geen eigen checklists.':
      'Aucune checklist personnalisée pour l\'instant.',
  'Sjabloon laden…': 'Charger un modèle…',
  'Sjabloon voor overige objecten': 'Modèle pour les autres objets',
  'Testen': 'Tests',
  'Genereer checklists voor scope-objecten':
      'Générer des checklists pour les objets de la portée',
  'checklists toegevoegd': 'checklists ajoutées',
  'Alle scope-objecten hebben al een checklist':
      'Tous les objets de la portée ont déjà une checklist',
  'Maakt per scope-object een checklist (WSTG voor web/API); bestaande blijven staan.':
      'Crée une checklist par objet de la portée (WSTG pour web/API) ; les existantes sont conservées.',
  ...
  'Passief': 'Passif',
  'Actief': 'Actif',
  'Aanvalsvector': 'Vecteur d\'attaque',
  'Aanvalscomplexiteit': 'Complexité de l\'attaque',
  'Aanvalsvereisten': 'Exigences de l\'attaque',
  'Vereiste rechten': 'Privilèges requis',
  'Gebruikersinteractie': 'Interaction utilisateur',
  'Vertrouwelijkheid (kwetsbaar systeem)':
      'Confidentialité (système vulnérable)',
  'Integriteit (kwetsbaar systeem)': 'Intégrité (système vulnérable)',
  'Beschikbaarheid (kwetsbaar systeem)': 'Disponibilité (système vulnérable)',
  'Vertrouwelijkheid (vervolgsysteem)': 'Confidentialité (système ultérieur)',
  'Integriteit (vervolgsysteem)': 'Intégrité (système ultérieur)',
  'Beschikbaarheid (vervolgsysteem)': 'Disponibilité (système ultérieur)',
  'PTES-fasen laden': 'Charger les phases PTES',
  'Voegt de zeven PTES-fasen toe; bestaande gebeurtenissen blijven staan.':
      'Ajoute les sept phases PTES ; les événements existants sont conservés.',
  'Basis': 'Base',
  'Context': 'Contexte',
  'CVSS-wizard': 'Assistant CVSS',
  'Kies uit de scope': 'Choisir dans le périmètre',
  'Bepaalt de contextscore van bevindingen op dit object; laat leeg als de weging niet bekend is.':
      'Détermine le score contextuel des constatations sur cet objet ; laisser vide si la pondération est inconnue.',
  'De contextscore is gewogen met de CIA-rating van het gekozen scope-object.':
      'Le score contextuel est pondéré selon la cotation CIA de l\'objet de périmètre choisi.',
  ...
  'Veel bullets op deze slide': 'Beaucoup de puces sur cette slide',
  'bullets': 'puces',
  'Overweeg de inhoud te splitsen.': 'Envisagez de diviser le contenu.',
  'Erg veel bullets op deze slide': 'Trop de puces sur cette slide',
  'Splits deze inhoud over meerdere slides.':
      'Répartissez ce contenu sur plusieurs slides.',
  'Veel woorden in bullets': 'Beaucoup de mots dans les puces',
  'woorden': 'mots',
  'Maak bullets korter of splits de slide.':
      'Raccourcissez les puces ou divisez la slide.',
  'Erg veel woorden in bullets': 'Trop de mots dans les puces',
  'Gemiddeld lange bullets': 'Puces longues en moyenne',
  'woorden per bullet': 'mots par puce',
  'Maak elke bullet kernachtiger.': 'Rendez chaque puce plus concise.',
  'Bullet met meerdere zinnen gevonden. Maak bullets kernachtiger of splits de inhoud.':
      'Puce contenant plusieurs phrases détectée. Rendez les puces plus concises ou divisez le contenu.',
  'Diepe bulletniveaus gevonden': 'Niveaux de puces profonds détectés',
  'niveau': 'niveau',
  'Beperk nesting voor betere leesbaarheid.':
      'Limitez l\'imbrication pour une meilleure lisibilité.',
  'Twee kolommen zijn sterk uit balans':
      'Les deux colonnes sont fortement déséquilibrées',
  'tegenover': 'contre',
  'Verdeel of splits de inhoud.': 'Redistribuez ou divisez le contenu.',
  ...
  'Kies een video': 'Choisir une vidéo',
  'Kies een audiobestand': 'Choisir un fichier audio',
  ...
  'Aanmelden mislukt — controleer gebruikersnaam en wachtwoord. Tip: gebruik bij Nextcloud een app-wachtwoord (Instellingen → Beveiliging), niet je accountwachtwoord.':
      'Échec de la connexion — vérifiez le nom d\'utilisateur et le mot de passe. Astuce : avec Nextcloud, utilisez un mot de passe d\'application (Paramètres → Sécurité), pas celui de votre compte.',
  'Annuleren…': 'Annulation…',
  'Afbeeldingen vergelijken…': 'Comparaison des images…',
  'Presentaties scannen…': 'Analyse des présentations…',
  'Opruimen…': 'Nettoyage…',
  'Kon een of meer mappen van de bibliotheek niet lezen; de lijst kan onvolledig zijn.':
      'Impossible de lire un ou plusieurs dossiers de la bibliothèque ; la liste peut être incomplète.',
  'Uit recente bestanden verwijderen': 'Retirer des fichiers récents',
  'OciDeck wordt gestart…': 'Démarrage d\'OciDeck…',
  'Herstelbestanden': 'Fichiers de récupération',
  'Herstelbestanden nu wissen':
      'Effacer les fichiers de récupération maintenant',
  'Er waren geen herstelbestanden.':
      'Il n\'y avait aucun fichier de récupération.',
  'herstelbestand(en) gewist.': 'fichier(s) de récupération effacé(s).',
  ...
  'Geavanceerd': 'Avancé',
  'Knippen en audio': 'Découpe et audio',
  'Bereik en kleurzones': 'Plage et zones de couleur',
  'Leeg deck': 'Deck vide',
  ...
  'Actualiteiten, aandachtsvestigingen, bijzonderheden, onderhoud en bezetting voor de beveiligingsdienst.':
      'Actualités, points d\'attention, particularités, maintenance et effectifs pour le service de sécurité.',
  'Operationele politiebriefing': 'Briefing opérationnel de police',
  'Actualiteiten, hotspots, signaleringen, opdrachten, eigen veiligheid en gebiedsinzet voor de dienst.':
      'Actualités, points chauds, avis de recherche (BOLO), missions, sécurité des agents et déploiement territorial pour le service.',
  'Handhavingsbriefing (BOA)': 'Briefing d\'application (BOA)',
  'Aandachtslocaties, overlast, evenementen, bevoegdheden, eigen veiligheid en gebiedsinzet voor de handhavingsdienst.':
      'Lieux sensibles, nuisances, événements, pouvoirs, sécurité des agents et déploiement territorial pour le service d\'application.',
  // Nieuwe gesprekssjablonen (titel + beschrijving).
  'Sollicitatiegesprek': 'Entretien d\'embauche',
  'Functioneringsgesprek': 'Entretien d\'évaluation',
  'Salarisonderhandeling': 'Négociation salariale',
  'Meer verantwoordelijkheid vragen': 'Demander plus de responsabilités',
  'Probleem op de werkvloer aankaarten': 'Aborder un problème au travail',
  'Conflict uitpraten': 'Résoudre un conflit',
  'Kritiek geven of ontvangen': 'Donner ou recevoir des critiques',
  'Slecht nieuws brengen': 'Annoncer une mauvaise nouvelle',
  'Grenzen stellen': 'Poser des limites',
  'Stroef lopende relatie bespreken': 'Aborder une relation difficile',
  'Klantgesprek': 'Entretien client',
  'Verkoopgesprek': 'Entretien de vente',
  'Onderhandeling met leveranciers': 'Négociation avec les fournisseurs',
  ...
  'Bereid je voor met STAR-antwoorden, eigen vragen en arbeidsvoorwaarden.':
      'Préparez-vous avec des réponses STAR, vos propres questions et les conditions de travail.',
  'Resultaten, ontwikkelwensen en afspraken volgens de aanpak voor cruciale gesprekken.':
      'Résultats, souhaits de développement et accords selon la méthode des conversations cruciales.',
  'Onderbouwing, bandbreedte en tegenargumenten volgens de aanpak voor cruciale gesprekken.':
      'Argumentation, marge de manœuvre et contre-arguments selon la méthode des conversations cruciales.',
  'Vraag je leidinggevende om een grotere rol volgens de aanpak voor cruciale gesprekken.':
      'Demandez à votre responsable un rôle plus important selon la méthode des conversations cruciales.',
  'Maak een probleem bespreekbaar zonder te beschuldigen, volgens de aanpak voor cruciale gesprekken.':
      'Rendez un problème abordable sans accuser, selon la méthode des conversations cruciales.',
  'Kom er samen uit met feiten, veiligheid en luisteren, volgens de aanpak voor cruciale gesprekken.':
      'Trouvez une issue commune avec des faits, de la sécurité et de l\'écoute, selon la méthode des conversations cruciales.',
  'Geef en ontvang feedback met feit, effect en verzoek, volgens de aanpak voor cruciale gesprekken.':
      'Donnez et recevez un retour avec fait, effet et demande, selon la méthode des conversations cruciales.',
  'Breng slecht nieuws duidelijk en met respect, volgens de aanpak voor cruciale gesprekken.':
      'Annoncez une mauvaise nouvelle avec clarté et respect, selon la méthode des conversations cruciales.',
  'Zet je grens rustig en duidelijk neer, volgens de aanpak voor cruciale gesprekken.':
      'Posez votre limite avec calme et clarté, selon la méthode des conversations cruciales.',
  'Bespreek een relatie of vriendschap die stroef loopt, volgens de aanpak voor cruciale gesprekken.':
      'Abordez une relation ou une amitié qui se passe mal, selon la méthode des conversations cruciales.',
  'Behoefteanalyse, waardevertaling en bezwaren voor een goed klantgesprek.':
      'Analyse des besoins, traduction de la valeur et objections pour un bon entretien client.',
  'SPIN-vragen, waardevertaling, bezwaren en afsluiten voor een verkoopgesprek.':
      'Questions SPIN, traduction de la valeur, objections et conclusion pour un entretien de vente.',
  'Eisen, onderhandelruimte en tactieken met BATNA en ZOPA voor een leveranciersonderhandeling.':
      'Exigences, marge de négociation et tactiques avec BATNA et ZOPA pour une négociation fournisseur.',
  'Haak, probleem, oplossing, bewijs en vraag voor een overtuigende pitch.':
      'Accroche, problème, solution, preuve et demande pour un pitch convaincant.',
  'Stakeholders, argumentatie en bezwaren om een besluit of steun te krijgen in een vergadering.':
      'Parties prenantes, argumentation et objections pour obtenir une décision ou un soutien en réunion.',
  'Pitch geven': 'Faire un pitch',
  'LibrePlan-connector': 'Connecteur LibrePlan',
  'De LibrePlan-connector is alleen beschikbaar in de desktopversie.':
      'Le connecteur LibrePlan n\'est disponible que dans la version bureau.',
  'LibrePlan-connector is optioneel en staat standaard uit. Er wordt niets opgehaald totdat u dit inschakelt en zelf een server configureert. Alleen-lezen: de connector schrijft niets terug naar LibrePlan. Het wachtwoord wordt in de sleutelhanger van uw besturingssysteem opgeslagen, niet in het deck.':
      'Le connecteur LibrePlan est facultatif et désactivé par défaut. Rien n\'est récupéré tant que vous ne l\'activez pas et ne configurez pas vous-même un serveur. Lecture seule : le connecteur n\'écrit rien vers LibrePlan. Le mot de passe est conservé dans le trousseau de votre système d\'exploitation, pas dans le deck.',
  'Opgeslagen in de sleutelhanger': 'Enregistré dans le trousseau',
  'Alleen voor servers op het eigen netwerk (LAN). Staat plain-HTTP toe en staat privé-adressen door de NetGuard. Uitgeschakeld: HTTPS verplicht.':
      'Uniquement pour les serveurs de votre propre réseau (LAN). Autorise le HTTP simple et laisse passer les adresses privées par le NetGuard. Désactivé : HTTPS obligatoire.',
  'Verbinding succesvol.': 'Connexion réussie.',
  'Onverwachte fout.': 'Erreur inattendue.',
  'Importeren uit LibrePlan': 'Importer depuis LibrePlan',
  'LibrePlan importeren': 'Importer depuis LibrePlan',
  'Kies welke slides u uit het LibrePlan-project wilt halen. De import is alleen-lezen en schrijft niets terug.':
      'Choisissez les diapositives à récupérer du projet LibrePlan. L\'import est en lecture seule et n\'écrit rien en retour.',
  'Gantt-planning': 'Planning Gantt',
  'WBS (hiërarchie)': 'WBS (hiérarchie)',
  'Projectstatus (cockpit)': 'Statut du projet (cockpit)',
  'Milestones (tijdlijn)': 'Jalons (chronologie)',
  'Kritieke pad (flow)': 'Chemin critique (flux)',
  'Resources (tabel)': 'Ressources (tableau)',
  'Timesheet (tabel)': 'Feuille de temps (tableau)',
  ...
  'Importeer een projectsnapshot van een LibrePlan-instantie als slides: Gantt, WBS, resourcebelasting, timesheet en meer. Alleen-lezen, op verzoek — er gaat niets naar buiten tot u een server configureert en een import start.':
      'Importez un instantané de projet d\'une instance LibrePlan sous forme de diapositives : Gantt, WBS, charge des ressources, feuille de temps et plus. Lecture seule, à la demande — rien ne sort tant que vous n\'avez pas configuré un serveur et lancé un import.',
  'Vul server-URL en gebruikersnaam in.':
      'Saisissez l\'URL du serveur et le nom d\'utilisateur.',
