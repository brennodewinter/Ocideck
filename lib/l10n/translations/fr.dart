...
const _dutchSourceAddFr = {
  'OciDeck mag uw microfoon of camera niet gebruiken. Geef toestemming in uw browser of systeeminstellingen en probeer het opnieuw.':
      'OciDeck n\'a pas l\'autorisation d\'utiliser votre microphone ou votre caméra. Accordez l\'autorisation dans votre navigateur ou dans les paramètres système, puis réessayez.',
  'Er is geen werkende microfoon gevonden. Sluit er een aan of kies een ander apparaat.':
      'Aucun microphone fonctionnel n\'a été trouvé. Branchez-en un ou choisissez un autre appareil.',
  'Er is geen werkende camera gevonden. U kunt zonder beeld meedoen.':
      'Aucune caméra fonctionnelle n\'a été trouvée. Vous pouvez participer sans image.',
  'De dienst die het toegangsbewijs afgeeft is onbereikbaar. Probeer het later opnieuw; uw presentatie blijft ondertussen gewoon open.':
      'Le service qui délivre le justificatif d\'accès est injoignable. Réessayez plus tard ; entre-temps, votre présentation reste simplement ouverte.',
  'De dienst die het toegangsbewijs afgeeft heeft zijn grens voor nu bereikt. Probeer het later opnieuw.':
      'Le service qui délivre le justificatif d\'accès a atteint sa limite pour le moment. Réessayez plus tard.',
  'Het toegangsbewijs voor deze vergadering is verlopen. Doe opnieuw mee met dezelfde link.':
      'Le justificatif d\'accès à cette réunion a expiré. Participez à nouveau avec le même lien.',
  'Het netwerk laat deze vergadering niet door. Op een bedrijfsnetwerk blokkeert een firewall of proxy dit soort verkeer vaak; een andere verbinding lukt meestal wel.':
      'Le réseau ne laisse pas passer cette réunion. Sur un réseau d\'entreprise, un pare-feu ou un proxy bloque souvent ce type de trafic ; avec une autre connexion, cela fonctionne généralement.',
  'Deze vergadering is voorbij.': 'Cette réunion est terminée.',
  'De vergaderdienst is zelf niet beschikbaar. Dit ligt niet aan uw verbinding; probeer het later opnieuw.':
      'Le service de réunion lui-même est indisponible. Cela ne vient pas de votre connexion ; réessayez plus tard.',
  'Meedoen is niet gelukt, en de dienst zegt niet waarom. De technische code staat bij de details — probeer het opnieuw, en geef die code door als het blijft misgaan.':
      'La participation a échoué et le service n\'indique pas pourquoi. Le code technique figure dans les détails — réessayez et transmettez ce code si le problème persiste.',
  'Dit is geen bruikbare vergaderlink. Kopieer hem opnieuw uit de uitnodiging — een link die door een chatprogramma is afgekapt of aangepast, doet het vaak niet meer.':
      'Ce n\'est pas un lien de réunion utilisable. Copiez-le à nouveau depuis l\'invitation — un lien tronqué ou modifié par un programme de messagerie ne fonctionne souvent plus.',
  'Deze dienst kennen we, maar dit soort vergadering niet. Webinars, uitzendingen en persoonlijke vergaderkamers werken anders dan een gewone vergadering; open deze link in de browser.':
      'Nous connaissons ce service, mais pas ce type de réunion. Les webinaires, les diffusions et les salles de réunion personnelles fonctionnent différemment d\'une réunion ordinaire ; ouvrez ce lien dans le navigateur.',
  'Deze vergaderdienst kennen we niet. OciDeck weet dus ook niet wat er achter deze link zit; u kunt hem in uw browser openen als u de afzender vertrouwt.':
      'Nous ne connaissons pas ce service de réunion. OciDeck ne sait donc pas non plus ce qui se cache derrière ce lien ; vous pouvez l\'ouvrir dans votre navigateur si vous faites confiance à l\'expéditeur.',
  'Meedoen kan op deze uitvoering van OciDeck niet. Gebruik de webversie in uw browser.':
      'La participation n\'est pas possible dans cette version d\'OciDeck. Utilisez la version web dans votre navigateur.',
  'Deze browser mist iets wat voor meedoen nodig is. Een recente Chrome, Edge, Firefox of Safari lukt doorgaans wel.':
      'Ce navigateur ne dispose pas de tout ce qui est nécessaire pour participer. Une version récente de Chrome, Edge, Firefox ou Safari fonctionne généralement.',
  'De organisatie van deze vergadering laat geen gasten zonder account toe. Vraag de organisator om u uit te nodigen op een manier die gasten toestaat.':
      'L\'organisation de cette réunion n\'admet pas d\'invités sans compte. Demandez à l\'organisateur de vous inviter d\'une manière qui autorise les invités.',
  'Meedoen aan deze vergadering vereist een account bij de aanbieder. Open de link in uw browser en meld u daar aan.':
      'Participer à cette réunion nécessite un compte chez le fournisseur. Ouvrez le lien dans votre navigateur et connectez-vous là.',
  'Deze aanbieder laat alleen goedgekeurde programma\'s meedoen, en die goedkeuring is er voor OciDeck nog niet. Open de vergadering in uw browser.':
      'Ce fournisseur n\'autorise que les programmes approuvés, et cette approbation n\'existe pas encore pour OciDeck. Ouvrez la réunion dans votre navigateur.',
  'De organisator heeft u niet toegelaten. Vraag of hij u binnenlaat en probeer het daarna opnieuw.':
      'L\'organisateur ne vous a pas admis. Demandez à être admis, puis réessayez.',
  'Deze vergadering is op slot; er komt niemand meer bij. Vraag de organisator om het slot eraf te halen.':
      'Cette réunion est verrouillée ; personne ne peut plus la rejoindre. Demandez à l\'organisateur de la déverrouiller.',
  'Deze vergadering is eind-tot-eind versleuteld en laat daarom geen externe deelnemers toe. Dat is een keuze van de organisator; vraag hem om een gewone vergadering als u erbij moet zijn.':
      'Cette réunion est chiffrée de bout en bout et n\'admet donc pas de participants externes. C\'est un choix de l\'organisateur ; demandez-lui une réunion ordinaire si vous devez y assister.',
  '{plek} krijgt contact zodra u meedoet.':
      '{plek} sera contacté dès que vous participerez.',
  'U doet mee met alleen de naam die u zelf opgeeft; u bent niet aangemeld als die persoon.':
      'Vous participez uniquement avec le nom que vous indiquez vous-même ; vous n\'êtes pas connecté en tant que cette personne.',
  'De dienst maakt een tijdelijke gastidentiteit voor u, die na de vergadering verdwijnt.':
      'Le service crée pour vous une identité d\'invité temporaire, qui disparaît après la réunion.',
  'U doet mee als gast onder een dienstaccount van een organisatie.':
      'Vous participez en tant qu\'invité via un compte de service d\'une organisation.',
  'De organisator heeft een identiteit voor u klaargezet.':
      'L\'organisateur a préparé une identité pour vous.',
  'Meedoen gaat met uw eigen account bij deze aanbieder.':
      'La participation se fait avec votre propre compte chez ce fournisseur.',
  'De aanbieder ziet uw netwerkgegevens en het beeld en geluid dat u verstuurt. Wat u deelt, deelt u met alle deelnemers.':
      'Le fournisseur voit vos données réseau ainsi que l\'image et le son que vous envoyez. Ce que vous partagez, vous le partagez avec tous les participants.',
  'Het verkeer is versleuteld naar de dienst toe; de dienst zelf kan meekijken.':
      'Le trafic est chiffré jusqu\'au service ; le service lui-même peut y accéder.',
  'De aanbieder beheert de versleuteling en dus ook de sleutels.':
      'Le fournisseur gère le chiffrement, et donc aussi les clés.',
  'De aanbieder beschrijft dit als eind-tot-eind versleuteld.':
      'Le fournisseur décrit cela comme chiffré de bout en bout.',
  'Over de versleuteling is niets vastgesteld. OciDeck belooft daar dus niets over.':
      'Rien n\'a été établi au sujet du chiffrement. OciDeck ne promet donc rien à ce sujet.',
  'U komt eerst in een wachtruimte: een organisator moet u toelaten. Uw presentatie blijft ondertussen gewoon te bewerken.':
      'Vous arrivez d\'abord dans une salle d\'attente : un organisateur doit vous admettre. Entre-temps, votre présentation reste modifiable.',
  'Deze vergadering vraagt om een wachtwoord.':
      'Cette réunion demande un mot de passe.',
  'Deze vergadering vraagt om aanmelding vooraf.':
      'Cette réunion demande une inscription préalable.',
  'Vergadering wordt voorbereid': 'Préparation de la réunion',
  'Verbinden met de vergadering': 'Connexion à la réunion',
  'Wachten op toelating door de organisator':
      'En attente d\'admission par l\'organisateur',
  'U doet mee aan de vergadering': 'Vous participez à la réunion',
  'De verbinding is weggevallen — opnieuw verbinden':
      'La connexion a été perdue — reconnexion en cours',
  'De vergadering wordt verlaten': 'Vous quittez la réunion',
  'De vergadering is beëindigd': 'La réunion est terminée',
  'Meedoen is niet gelukt': 'Échec de la participation',
  'Deze vergadering wordt opgenomen.': 'Cette réunion est enregistrée.',
  'Deze vergadering wordt uitgeschreven.': 'Cette réunion est transcrite.',
  'Deze vergadering wordt opgenomen en uitgeschreven.':
      'Cette réunion est enregistrée et transcrite.',
  'De vergadering vraagt uw uitdrukkelijke toestemming om mee te blijven doen.':
      'La réunion demande votre consentement explicite pour que vous puissiez continuer à participer.',
  'Een organisator moet u nog toelaten. U kunt gewoon doorwerken; zodra u binnen bent, opent het gespreksvenster zich.':
      'Un organisateur doit encore vous admettre. Vous pouvez simplement continuer à travailler ; dès que vous serez entré, la fenêtre d\'appel s\'ouvrira.',
  'Herkend als een vergadering bij {plek}.':
      'Reconnu comme une réunion chez {plek}.',
  '{uitleg} De link wijst naar {plek}.': '{uitleg} Le lien pointe vers {plek}.',
  'Deze naam kiest u zelf; niemand controleert hem. De anderen zien u als gast.':
      'Vous choisissez ce nom vous-même ; personne ne le vérifie. Les autres vous voient comme invité.',
  'Afsluiten': 'Terminer',
  'Camera aanzetten': 'Activer la caméra',
  'Camera uitzetten': 'Désactiver la caméra',
  'Microfoon aanzetten': 'Activer le microphone',
  'Microfoon dempen': 'Couper le microphone',
  'Presentatie delen': 'Partager la présentation',
  'Delen stoppen': 'Arrêter le partage',
  'Gespreksvenster': 'Fenêtre d\'appel',
  'Venster sluiten': 'Fermer la fenêtre',
  'Meedoen': 'Participer',
  'Meedoen aan een onlinevergadering': 'Participer à une réunion en ligne',
  'Onlinevergadering': 'Réunion en ligne',
  'Onlinevergadering…': 'Réunion en ligne…',
  'Vergaderlink': 'Lien de la réunion',
  'Plak hier de link uit de uitnodiging': 'Collez ici le lien de l\'invitation',
  'Uw naam, zoals de anderen die zien':
      'Votre nom, tel que les autres le voient',
  'Wat er gebeurt als u meedoet': 'Ce qui se passe si vous participez',
  'Verlaten': 'Quitter',
  'Weigeren en verlaten': 'Refuser et quitter',
  'Toestemming geven': 'Donner son consentement',
  'Technische code: {code}': 'Code technique : {code}',
  'Deelnemers ({aantal})': 'Participants ({aantal})',
  'Nog geen deelnemers.': 'Aucun participant pour l\'instant.',
  'Deze vergadering geeft geen deelnemerslijst.':
      'Cette réunion ne fournit pas de liste des participants.',
  'gast': 'invité',
  'deelnemer': 'participant',
  'presentator': 'présentateur',
  'moderator': 'modérateur',
  'organisator': 'organisateur',
  'rol onbekend': 'rôle inconnu',
  'Bord': 'Tableau',
  ...
  'Er loopt een vergadering. Het gespreksvenster blijft daarom bereikbaar tot u die verlaat.':
      'Une réunion est en cours. La fenêtre d\'appel reste donc accessible jusqu\'à ce que vous la quittiez.',
  'Er is nog geen vergaderdienst beschikbaar om aan mee te doen. Zolang dat zo is verandert deze schakelaar niets en gaat er niets naar buiten.':
      'Aucun service de réunion n\'est encore disponible pour participer. Tant que c\'est le cas, cet interrupteur ne change rien et rien ne sort.',
  'Plak een vergaderlink om mee te doen. Wie er contact krijgt en wat die te zien krijgt, staat op het scherm voordat u meedoet.':
      'Collez un lien de réunion pour participer. Qui sera contacté et ce qu\'il verra s\'affiche à l\'écran avant que vous participiez.',
  ...
  'Artefacten voor procesverbetering en Lean Six Sigma-projecten (DMAIC, Kaizen, A3). Standaard uit. De module is beschikbaar; de artefacten volgen in volgende stappen.':
      'Artefacts pour l\'amélioration des processus et les projets Lean Six Sigma (DMAIC, Kaizen, A3). Désactivé par défaut. Le module est disponible ; les artefacts suivront dans les prochaines étapes.',
  'Module aan. Rekenkern lokaal beschikbaar ({n} control-chartfactoren). Slidetypes en sjablonen komen erbij zodra ze klaar zijn.':
      'Module activé. Noyau de calcul disponible localement ({n} facteurs de control chart). Les types de diapositives et les modèles seront ajoutés dès qu\'ils seront prêts.',
