...
const _dutchSourceIt = {
  ...
  'Waterval': 'Cascata',
  'Laatste reeks als lijn op een tweede as; de rest als staven.': 'Ultima serie come linea su un secondo asse; le altre come barre.',
  'Eerste reeks: elke waarde is een op- of neerwaartse stap op het vorige totaal.': 'Prima serie: ogni valore è un passo in su o in giù sul totale progressivo.',
  'Reeks = rij, kolom = label, celkleur volgt de waarde. Label de assen kans en impact voor een risicomatrix.': 'Serie = riga, colonna = etichetta, il colore della cella segue il valore. Etichetta gli assi come probabilità e impatto per una matrice di rischio.',
  ...
  'Pentestrapportage volgens MIAUW. Inschakelen haalt de referentiegegevens eenmalig op; daarna werkt de module offline.':
      'Rendicontazione dei pentest secondo MIAUW. L\'attivazione scarica una volta i dati di riferimento; poi il modulo funziona offline.',
