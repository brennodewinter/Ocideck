...
const _dutchSourceAddIt = {
  'OciDeck mag uw microfoon of camera niet gebruiken. Geef toestemming in uw browser of systeeminstellingen en probeer het opnieuw.':
      'OciDeck non può usare il suo microfono o la sua videocamera. Conceda l\'autorizzazione nel browser o nelle impostazioni di sistema e riprovi.',
  'Er is geen werkende microfoon gevonden. Sluit er een aan of kies een ander apparaat.':
      'Non è stato trovato alcun microfono funzionante. Ne colleghi uno o scelga un altro dispositivo.',
  'Er is geen werkende camera gevonden. U kunt zonder beeld meedoen.':
      'Non è stata trovata alcuna videocamera funzionante. Può partecipare senza immagine.',
  'De dienst die het toegangsbewijs afgeeft is onbereikbaar. Probeer het later opnieuw; uw presentatie blijft ondertussen gewoon open.':
      'Il servizio che rilascia il titolo di accesso non è raggiungibile. Riprovi più tardi; nel frattempo la sua presentazione resta semplicemente aperta.',
  'De dienst die het toegangsbewijs afgeeft heeft zijn grens voor nu bereikt. Probeer het later opnieuw.':
      'Il servizio che rilascia il titolo di accesso ha raggiunto per ora il suo limite. Riprovi più tardi.',
  'Het toegangsbewijs voor deze vergadering is verlopen. Doe opnieuw mee met dezelfde link.':
      'Il titolo di accesso per questa riunione è scaduto. Partecipi di nuovo con lo stesso link.',
  'Het netwerk laat deze vergadering niet door. Op een bedrijfsnetwerk blokkeert een firewall of proxy dit soort verkeer vaak; een andere verbinding lukt meestal wel.':
      'La rete non fa passare questa riunione. Su una rete aziendale un firewall o un proxy blocca spesso questo tipo di traffico; con un\'altra connessione di solito funziona.',
  'Deze vergadering is voorbij.': 'Questa riunione è finita.',
  'De vergaderdienst is zelf niet beschikbaar. Dit ligt niet aan uw verbinding; probeer het later opnieuw.':
      'Il servizio di riunioni stesso non è disponibile. Non dipende dalla sua connessione; riprovi più tardi.',
  'Meedoen is niet gelukt, en de dienst zegt niet waarom. De technische code staat bij de details — probeer het opnieuw, en geef die code door als het blijft misgaan.':
      'La partecipazione non è riuscita e il servizio non dice perché. Il codice tecnico è tra i dettagli — riprovi e comunichi quel codice se continua ad andare male.',
  'Dit is geen bruikbare vergaderlink. Kopieer hem opnieuw uit de uitnodiging — een link die door een chatprogramma is afgekapt of aangepast, doet het vaak niet meer.':
      'Questo non è un link di riunione utilizzabile. Lo copi di nuovo dall\'invito — un link troncato o modificato da un programma di chat spesso non funziona più.',
  'Deze dienst kennen we, maar dit soort vergadering niet. Webinars, uitzendingen en persoonlijke vergaderkamers werken anders dan een gewone vergadering; open deze link in de browser.':
      'Questo servizio lo conosciamo, ma non questo tipo di riunione. Webinar, trasmissioni e sale riunioni personali funzionano in modo diverso da una riunione normale; apra questo link nel browser.',
  'Deze vergaderdienst kennen we niet. OciDeck weet dus ook niet wat er achter deze link zit; u kunt hem in uw browser openen als u de afzender vertrouwt.':
      'Questo servizio di riunioni non lo conosciamo. OciDeck non sa quindi cosa si trovi dietro questo link; può aprirlo nel browser se si fida del mittente.',
  'Meedoen kan op deze uitvoering van OciDeck niet. Gebruik de webversie in uw browser.':
      'Con questa versione di OciDeck non è possibile partecipare. Usi la versione web nel browser.',
  'Deze browser mist iets wat voor meedoen nodig is. Een recente Chrome, Edge, Firefox of Safari lukt doorgaans wel.':
      'A questo browser manca qualcosa che serve per partecipare. Una versione recente di Chrome, Edge, Firefox o Safari di solito funziona.',
  'De organisatie van deze vergadering laat geen gasten zonder account toe. Vraag de organisator om u uit te nodigen op een manier die gasten toestaat.':
      'L\'organizzazione di questa riunione non ammette ospiti senza account. Chieda all\'organizzatore di invitarla in un modo che consenta gli ospiti.',
  'Meedoen aan deze vergadering vereist een account bij de aanbieder. Open de link in uw browser en meld u daar aan.':
      'Per partecipare a questa riunione è necessario un account presso il fornitore. Apra il link nel browser e vi acceda.',
  'Deze aanbieder laat alleen goedgekeurde programma\'s meedoen, en die goedkeuring is er voor OciDeck nog niet. Open de vergadering in uw browser.':
      'Questo fornitore consente la partecipazione solo a programmi approvati, e per OciDeck tale approvazione non c\'è ancora. Apra la riunione nel browser.',
  'De organisator heeft u niet toegelaten. Vraag of hij u binnenlaat en probeer het daarna opnieuw.':
      'L\'organizzatore non l\'ha ammessa. Chieda di essere fatto entrare e poi riprovi.',
  'Deze vergadering is op slot; er komt niemand meer bij. Vraag de organisator om het slot eraf te halen.':
      'Questa riunione è bloccata; non può entrare nessun altro. Chieda all\'organizzatore di sbloccarla.',
  'Deze vergadering is eind-tot-eind versleuteld en laat daarom geen externe deelnemers toe. Dat is een keuze van de organisator; vraag hem om een gewone vergadering als u erbij moet zijn.':
      'Questa riunione è cifrata end-to-end e per questo non ammette partecipanti esterni. È una scelta dell\'organizzatore; gli chieda una riunione normale se deve esserci.',
  '{plek} krijgt contact zodra u meedoet.':
      '{plek} verrà contattato appena parteciperà.',
  'U doet mee met alleen de naam die u zelf opgeeft; u bent niet aangemeld als die persoon.':
      'Partecipa solo con il nome che indica lei stesso; non è autenticato come quella persona.',
  'De dienst maakt een tijdelijke gastidentiteit voor u, die na de vergadering verdwijnt.':
      'Il servizio crea per lei un\'identità ospite temporanea, che scompare dopo la riunione.',
  'U doet mee als gast onder een dienstaccount van een organisatie.':
      'Partecipa come ospite tramite un account di servizio di un\'organizzazione.',
  'De organisator heeft een identiteit voor u klaargezet.':
      'L\'organizzatore ha predisposto un\'identità per lei.',
  'Meedoen gaat met uw eigen account bij deze aanbieder.':
      'Parteciperà con il suo account presso questo fornitore.',
  'De aanbieder ziet uw netwerkgegevens en het beeld en geluid dat u verstuurt. Wat u deelt, deelt u met alle deelnemers.':
      'Il fornitore vede i suoi dati di rete e il video e l\'audio che invia. Ciò che condivide, lo condivide con tutti i partecipanti.',
  'Het verkeer is versleuteld naar de dienst toe; de dienst zelf kan meekijken.':
      'Il traffico è cifrato verso il servizio; il servizio stesso può guardare.',
  'De aanbieder beheert de versleuteling en dus ook de sleutels.':
      'Il fornitore gestisce la cifratura e quindi anche le chiavi.',
  'De aanbieder beschrijft dit als eind-tot-eind versleuteld.':
      'Il fornitore descrive questa riunione come cifrata end-to-end.',
  'Over de versleuteling is niets vastgesteld. OciDeck belooft daar dus niets over.':
      'Sulla cifratura non è stato accertato nulla. OciDeck non promette quindi nulla al riguardo.',
  'U komt eerst in een wachtruimte: een organisator moet u toelaten. Uw presentatie blijft ondertussen gewoon te bewerken.':
      'Prima entrerà in una sala d\'attesa: un organizzatore deve ammetterla. Nel frattempo la sua presentazione resta modificabile.',
  'Deze vergadering vraagt om een wachtwoord.':
      'Questa riunione richiede una password.',
  'Deze vergadering vraagt om aanmelding vooraf.':
      'Questa riunione richiede l\'iscrizione anticipata.',
  'Vergadering wordt voorbereid': 'Preparazione della riunione',
  'Verbinden met de vergadering': 'Connessione alla riunione',
  'Wachten op toelating door de organisator':
      'In attesa che l\'organizzatore la ammetta',
  'U doet mee aan de vergadering': 'Sta partecipando alla riunione',
  'De verbinding is weggevallen — opnieuw verbinden':
      'La connessione è caduta — riconnessione in corso',
  'De vergadering wordt verlaten': 'Uscita dalla riunione',
  'De vergadering is beëindigd': 'La riunione è terminata',
  'Meedoen is niet gelukt': 'Partecipazione non riuscita',
  'Deze vergadering wordt opgenomen.': 'Questa riunione viene registrata.',
  'Deze vergadering wordt uitgeschreven.': 'Questa riunione viene trascritta.',
  'Deze vergadering wordt opgenomen en uitgeschreven.':
      'Questa riunione viene registrata e trascritta.',
  'De vergadering vraagt uw uitdrukkelijke toestemming om mee te blijven doen.':
      'La riunione chiede il suo consenso esplicito per poter continuare a partecipare.',
  'Een organisator moet u nog toelaten. U kunt gewoon doorwerken; zodra u binnen bent, opent het gespreksvenster zich.':
      'Un organizzatore deve ancora ammetterla. Può tranquillamente continuare a lavorare; appena sarà dentro, la finestra della chiamata si aprirà.',
  'Herkend als een vergadering bij {plek}.':
      'Riconosciuta come riunione presso {plek}.',
  '{uitleg} De link wijst naar {plek}.': '{uitleg} Il link rimanda a {plek}.',
  'Deze naam kiest u zelf; niemand controleert hem. De anderen zien u als gast.':
      'Questo nome lo sceglie lei; nessuno lo verifica. Gli altri la vedono come ospite.',
  'Afsluiten': 'Termina',
  'Camera aanzetten': 'Attiva la videocamera',
  'Camera uitzetten': 'Disattiva la videocamera',
  'Microfoon aanzetten': 'Attiva il microfono',
  'Microfoon dempen': 'Disattiva il microfono',
  'Presentatie delen': 'Condividi la presentazione',
  'Delen stoppen': 'Interrompi la condivisione',
  'Gespreksvenster': 'Finestra della chiamata',
  'Venster sluiten': 'Chiudi la finestra',
  'Meedoen': 'Partecipa',
  'Meedoen aan een onlinevergadering': 'Partecipare a una riunione online',
  'Onlinevergadering': 'Riunione online',
  'Onlinevergadering…': 'Riunione online…',
  'Vergaderlink': 'Link della riunione',
  'Plak hier de link uit de uitnodiging': 'Incolli qui il link dell\'invito',
  'Uw naam, zoals de anderen die zien': 'Il suo nome, come lo vedono gli altri',
  'Wat er gebeurt als u meedoet': 'Cosa succede se partecipa',
  'Verlaten': 'Abbandona',
  'Weigeren en verlaten': 'Rifiuta e abbandona',
  'Toestemming geven': 'Dare il consenso',
  'Technische code: {code}': 'Codice tecnico: {code}',
  'Deelnemers ({aantal})': 'Partecipanti ({aantal})',
  'Nog geen deelnemers.': 'Ancora nessun partecipante.',
  'Deze vergadering geeft geen deelnemerslijst.':
      'Questa riunione non fornisce un elenco dei partecipanti.',
  'gast': 'ospite',
  'deelnemer': 'partecipante',
  'presentator': 'presentatore',
  'moderator': 'moderatore',
  'organisator': 'organizzatore',
  'rol onbekend': 'ruolo sconosciuto',
  'Bord': 'Tabellone',
