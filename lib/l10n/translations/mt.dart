...
const _dutchSourceMt = {
  ...
  'Laatste reeks als lijn op een tweede as; de rest als staven.':
      'L-aħħar serje bħala linja fuq it-tieni assi; il-bqija bħala bars.',
  'Eerste reeks: elke waarde is een op- of neerwaartse stap op het vorige totaal.':
      'L-ewwel serje: kull valur huwa pass \'il fuq jew \'l isfel fuq it-total kurrenti.',
  'Reeks = rij, kolom = label, celkleur volgt de waarde. Label de assen kans en impact voor een risicomatrix.':
      'Serje = ringiela, kolonna = tikketta, il-kulur taċ-ċellula jsegwi l-valur. Semmi l-assi bħala probabbiltà u impatt għal matriċi tar-riskju.',
...
const _dutchSourceAddMt = <String, String>{
  ...
  'Aangemaakt op': 'Maħluq fuq',
  'Aanmeldprovider': 'Fornitur tal-login',
  'Aanmeldsessies': 'Sessjonijiet ta\' reġistrazzjoni',
  'Aantal controles': 'Numru ta\' kontrolli',
  ...
  'Activiteitnummer': 'Numru tal-attività',
  'Afgerond op': 'Imqarreb lejn',
  'Afgewezen': 'Miċħuda',
  'Afspeelsessienummer': 'Numru tas-sessjoni tal-plejbek',
  'Afwezig': 'Assenti',
  'Antwoordgegevens': 'Irrispondi dettalji',
  'Antwoordstatus': 'L-istatus tat-tweġiba',
  'Begint op': 'Jibda fuq',
  'Begrippen uitgelegd': 'Kunċetti spjegati',
  'Beheer van de installatie': 'Ġestjoni tal-installazzjoni',
  'Beheerpogingen': 'Sforzi ta\' ġestjoni',
  'Bekeken lessen': 'Lezzjonijiet meqjusa',
  'Beleidsversie': 'Verżjoni tal-politika',
  'Beoordeeld': 'Rated',
  'Beoordeeld op': 'Rated minn',
  'Beperking': 'Restrizzjoni',
  'Berekend op': 'Ikkalkulat fuq',
  'Bericht': 'Messaġġ',
  'Bestandsnaam': 'Isem tal-fajl',
  'Beveiligingsvraagnummer': 'Numru tal-Mistoqsija tas-Sigurtà',
  'Bevestigd': 'Ikkonfermat',
  'Bevestigd op': 'Ikkonfermat fuq',
  'Bewaarregels': 'Regoli ta\' żamma',
  'Bewaartermijn': 'Perjodu ta\' żamma',
  'Bewaren wegens een juridische verplichting':
      'Miżmum minħabba obbligu legali',
  'Bewerkingnummer bij aanmeldprovider':
      'Numru tal-operazzjoni fil-fornitur tar-reġistrazzjoni',
  'Bewijsstukken': 'Evidenza',
  'Bezwaar': 'Oġġezzjoni',
  'Beëindigd op': 'Intemm nhar',
  'Bijeenkomstnummer': 'Numru tal-laqgħa',
  'Certificaatnummer': 'Numru taċ-ċertifikat',
  'Certificaten': 'Ċertifikati',
  'Controlecode van de PDF': 'Kodiċi ta\' kontroll tal-PDF',
  'Controlecode van profielfoto': 'Kodiċi tal-verifika tar-ritratti tal-profil',
  'Controlecodes van bewijsstukken':
      'Kodiċi ta\' kontroll ta\' dokumenti ta\' sostenn',
  'Correctie': 'Korrezzjoni',
  'Cursistnummer waarop de actie gericht was':
      'Numru tal-istudenti li għalih kienet immirata l-azzjoni',
  'Cursusaanbodnummer': 'Numru tal-offerta tal-kors',
  'Cursusversienummer': 'Numru tal-verżjoni tal-kors',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Id-dati u l-ħinijiet huma murija fil-ħin lokali tiegħek. L-ismijiet tekniċi jibqgħu viżibbli meta s-server jipprovdi qasam mhux magħruf.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'It-tweġibiet li tajt għall-mistoqsijiet tat-test.',
  'Deelnamenummer': 'Numru ta\' parteċipazzjoni',
  'Deelnames': 'Parteċipazzjonijiet',
  'Details': 'Dettalji',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Din il-kategorija ġiet ipprovduta mis-server. L-ismijiet tekniċi jibqgħu viżibbli għal mistoqsijiet mill-organizzazzjoni tiegħek.',
  'Door uzelf aangevraagd': 'Mitlub minnek innifsek',
  'E-mailadres': 'Indirizz elettroniku',
  'E-mailberichten': 'Messaġġi bil-posta elettronika',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'ID huwa numru tekniku uniku li eLearning juża biex jgħaqqad id-dejta flimkien. Mhijiex klassifikazzjoni jew status.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'Kategorija tiġbor id-dejta dwar l-istess suġġett. Reġistrazzjoni hija biċċa data waħda ssejvjata jew avveniment wieħed.',
  'Eindigt op': 'Tispiċċa fi',
  'Geaccepteerd op': 'Aċċettat fuq',
  'Geannuleerd': 'Ikkanċellat',
  'Gecontroleerd': 'Iċċekkjat',
  'Gecontroleerd op': 'Iċċekkjat',
  'Geen gegevens gevonden': 'Ma nstabet l-ebda dejta',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Informazzjoni dwar il-perjodi taż-żamma u t-tħassir tad-dejta tiegħek.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Informazzjoni dwar dokumenti ta\' sostenn, riżultati miksuba u ċertifikati.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Informazzjoni dwar talbiet għall-privatezza u min ra jew biddel l-informazzjoni tiegħek.',
  'Gegevens over uw accountbewerking':
      'Informazzjoni dwar l-operat tal-kont tiegħek',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Informazzjoni dwar ir-reġistrazzjoni, il-parteċipazzjoni u l-progress tiegħek fil-lezzjonijiet.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Informazzjoni dwar il-profil, il-kont u l-pożizzjoni tiegħek fi ħdan l-organizzazzjoni.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Informazzjoni dwar il-mumenti tat-test tiegħek u l-mistoqsijiet ippreżentati.',
  'Gegevens over willekeurige volgorde': 'Data tal-ordni bl-addoċċ',
  'Gegevenscategorie': 'Kategorija tad-data',
  'Gekoppeld accountnummer': 'Numru tal-kont konness',
  'Gekozen antwoorden': 'Tweġibiet magħżula',
  'Gelukt': 'Suċċess',
  'Geprobeerd op': 'Ippruvat',
  'Gerechtvaardigd belang': 'Interess leġittimu',
  'Gereserveerd': 'Riżervat',
  'Gereserveerd op': 'Riżervat fuq',
  'Geslaagd': 'Għadda',
  'Gestart op': 'Bdiet fuq',
  'Getoonde tijd per dia in milliseconden':
      'Ħin muri għal kull slide f\'millisekondi',
  'Herkomst van inschrijving': 'Oriġini tar-reġistrazzjoni',
  'Hoogst haalbare score': 'L-ogħla punteġġ possibbli',
  'Identificatienummer bij aanmeldprovider':
      'Numru ta\' identifikazzjoni għall-fornitur tar-reġistrazzjoni',
  'Identiteitsbewerkingnummer': 'Numru tal-operazzjoni tal-identità',
  'In afwachting': 'Pendenti',
  'In behandeling': 'Fil-progress',
  'In behandeling genomen op': 'Ipproċessat fuq',
  'In quarantaine': 'Fil-kwarantina',
  'Ingeleverd': 'Sottomessi',
  'Ingeleverd op': 'Mibgħuta nhar',
  'Ingericht op': 'Imżejjen fuq',
  'Ingeschreven op': 'Irreġistrat fuq',
  'Ingetrokken': 'Irtirat',
  'Ingetrokken op': 'Irtirat fuq',
  'Inschrijvingen': 'Reġistrazzjonijiet',
  'Inschrijvingsnummer': 'Numru tar-reġistrazzjoni',
  'Installatiebeveiligingslogboek': 'Log tas-sigurtà tal-installazzjoni',
  'Installatienummer': 'Numru tal-installazzjoni',
  'Installatieverzoeken': 'Talbiet għall-installazzjoni',
  'Inzage': 'Spezzjoni',
  'Ja': 'Iva',
  'Kwalificatienummer': 'Numru ta\' kwalifika',
  'Kwalificaties': 'Kwalifiki',
  'Laatst actief op': 'L-aħħar attiv fuq',
  'Laatst bekeken dia': 'L-aħħar slide li dehret',
  'Laatst gewijzigd op': 'Modifikat l-aħħar nhar',
  'Laatste fout': 'L-aħħar żball',
  'Lesnummer': 'Numru tal-lezzjoni',
  'Lesreserveringen': 'Riżervi tal-lezzjonijiet',
  'Lesvoortgang': 'Progress tal-lezzjoni',
  'Lidmaatschappen': 'Sħubiji',
  'Locatie': 'Post',
  'Manier van afronden': 'Mod ta\' arrotondament',
  'Maximaal aantal controles': 'Numru massimu ta\' kontrolli',
  'Maximaal aantal pogingen': 'Numru massimu ta\' tentattivi',
  'Maximale leeftijd van de aanmelding': 'Età massima tar-reġistrazzjoni',
  'Mislukt': 'Falliet',
  'Naam van de activiteit': 'Isem l-attività',
  'Naam van de bijeenkomst': 'Isem il-laqgħa',
  'Nee': 'Nru',
  'Netwerkadres': 'Indirizz tan-netwerk',
  'Niet actief': 'Mhux attiv',
  'Niet geregistreerd': 'Mhux irreġistrat',
  'Niet ingevuld': 'Mhux mimli',
  'Niet verschenen': 'Mhux ippubblikat',
  'Niveau van extra aanmeldcontrole':
      'Livell ta\' kontroll addizzjonali tar-reġistrazzjoni',
  'Nummer van de toetsopzet': 'Numru tal-pjan tat-test',
  'Nummer van het brongegeven': 'Numru tad-dejta tas-sors',
  'Nummer van uw verwijderde gegeven': 'Numru tad-dejta mħassra tiegħek',
  'Onderdeel {nummer}': 'Parti {nummer}',
  'Onderwerp van de actie': 'Suġġett ta\' l-azzjoni',
  'Ontvanger': 'Riċevitur',
  'Opgegeven bestandsgrootte': 'Daqs tal-fajl speċifikat',
  'Opgegeven bestandstype': 'Tip ta\' fajl speċifikat',
  'Opgegeven controlecode': 'Kodiċi ta\' kontroll speċifikat',
  'Opgeslagen bestandsgrootte': 'Daqs tal-fajl salvat',
  'Opgeslagen controlecode': 'Kodiċi ta \'kontroll maħżun',
  'Organisatienummer': 'Numru ta\' l-organizzazzjoni',
  'Overdraagbaarheid': 'Trasferibbiltà',
  'PE-toekenningnummer': 'Numru tal-għotja tal-PE',
  'Poging': 'Tentattiv',
  'Positie': 'Pożizzjoni',
  'Privacyverzoeken': 'Talbiet għall-privatezza',
  'Probeer een andere zoekterm.': 'Ipprova terminu ta\' tfittxija differenti.',
  'Reden': 'Raġuni',
  'Reden of grondslag': 'Raġuni jew bażi',
  'Reden van afwijzing': 'Raġuni għaċ-ċaħda',
  'Reden van bevestiging': 'Raġuni għall-konferma',
  'Reden van intrekking': 'Raġuni għall-irtirar',
  'Reden voor langer bewaren': 'Raġuni għal ħażna itwal',
  'Regels voor de cursusversie': 'Regoli għall-verżjoni tal-kors',
  'Resultaat bij de aanmeldprovider':
      'Riżultat fil-fornitur tar-reġistrazzjoni',
  'Rol': 'Roll',
  'Score': 'Score',
  'Soort aanwezigheid': 'Tip ta \'preżenza',
  'Soort accountbewerking': 'Tip ta\' operazzjoni tal-kont',
  'Soort gebeurtenis': 'Tip ta\' avveniment',
  'Soort privacyverzoek': 'Tip ta\' talba għall-privatezza',
  'Status van de bijeenkomst': 'Status tal-laqgħa',
  'Strenge beveiligingsmodus': 'Mod ta \'sigurtà għolja',
  'Technisch toegangslogboek': 'Log ta\' aċċess tekniku',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Dejta teknika meħtieġa għar-reġistrazzjoni, is-sigurtà u l-ipproċessar affidabbli.',
  'Technische naam: {naam}': 'Isem tekniku: {naam}',
  'Technische opslagcategorie': 'Kategorija tal-ħażna teknika',
  'Technische opslaglocatie van de PDF': 'Post tal-ħażna teknika tal-PDF',
  'Tijdstip van aanmelding': 'Ħin tar-reġistrazzjoni',
  'Tijdzone': 'Żona tal-ħin',
  'Toestand': 'Kundizzjoni',
  'Toetspogingen': 'Tentattivi tat-test',
  'Toetspogingnummer': 'Numru tat-tentattiv tat-test',
  'Uiterste inlevermoment': 'Skadenza għas-sottomissjoni',
  'Uitgegeven op': 'Ippubblikat fuq',
  'Uitgenodigd e-mailadres': 'Indirizz elettroniku mistieden',
  'Uitnodigingen': 'Stediniet',
  'Uniek nummer (ID)': 'Numru uniku (ID)',
  'Uniek verwerkingskenmerk': 'Karatteristika unika tal-ipproċessar',
  'Uw accountnummer': 'In-numru tal-kont tiegħek',
  'Uw accountnummer als uitvoerder': 'In-numru tal-kont tiegħek bħala eżekutur',
  'Uzelf als uploader': 'Inti stess bħala uploader',
  'Vaardigheidsversienummer': 'Numru tal-verżjoni tal-ħiliet',
  'Vast internetadres van de installatie':
      'Indirizz tal-internet fiss tal-installazzjoni',
  'Vastgelegde beslisgegevens': 'Data tad-deċiżjoni rreġistrata',
  'Vastgelegde gegevens': 'Data rreġistrata',
  'Vereist niveau van aanmeldzekerheid':
      'Livell meħtieġ ta\' ċertezza tar-reġistrazzjoni',
  'Vereiste aanmeldmethoden': 'Metodi ta\' login meħtieġa',
  'Verloopt bij inactiviteit op': 'Tiskadi meta inattiva',
  'Verloopt definitief op': 'Tiskadi b\'mod permanenti',
  'Verloopt op': 'Tiskadi',
  'Versienummer van de PE-regel': 'Numru tal-verżjoni tar-regola PE',
  'Verwerkte verzoeken': 'Talbiet ipproċessati',
  'Verwijderd op': 'Imneħħija fuq',
  'Verwijdering': 'Tneħħija',
  'Verwijderingsregister': 'Reġistru tat-Tneħħija',
  'Verwijzing naar het antwoord': 'Referenza għat-tweġiba',
  'Verzoeknummer': 'Numru tat-talba',
  'Verzoeknummer van de app': 'Numru tat-talba tal-app',
  'Verzonden op': 'Mibgħuta fuq',
  'Volgende controle op': 'Li jmiss check up',
  'Volgnummer': 'Numru tas-sekwenza',
  'Volgorde van antwoordopties': 'Ordni ta\' għażliet ta\' tweġiba',
  'Vraagnummer binnen de toetspoging':
      'Numru tal-mistoqsija fit-tentattiv tat-test',
  'Vraagversienummer': 'Numru tal-verżjoni tal-mistoqsija',
  'Vragen in toetspogingen': 'Mistoqsijiet f\'tentattivi tat-test',
  'Vrijgegeven': 'Meħlus',
  'Vrijgegeven op': 'Meħlus fuq',
  'Wat gebeurt na de bewaartermijn': 'X\'jiġri wara l-perjodu taż-żamma',
  'Wettelijke verplichting': 'Obbligu legali',
  'Wijzigingen aan PE-punten': 'Bidliet fil-punti PE',
  'Wijzigingen aan kwalificaties': 'Bidliet fil-kwalifiki',
  'Wijzigingen in aanmeldbeveiliging': 'Bidliet fis-sigurtà tal-login',
  'Zekerheid': 'Ċertezza',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Pereżempju, fittex skont il-kors, id-data jew l-istatus',
  'Zoeken in uw gegevens': 'Fittex id-data tiegħek',
  '{aantal} categorieën gevonden': 'Kategoriji {aantal} misjuba',
  ...
  'eLearning-aanmelding is alleen beschikbaar in de desktop-app, omdat de webversie geen veilige sleutelbos heeft.':
      'Il-login f\'eLearning huwa disponibbli biss fl-app tad-desktop, għax il-verżjoni web m\'għandhiex keychain sigur.',
  ...
  'Bij het volgen van een cursus stuurt OciDeck uw laatste dia, voltooiing en getoonde tijd per dia naar de gekozen eLearning-organisatie. Antwoorden, notities en cursusinhoud worden niet als voortgang verstuurd.':
      'Meta ssegwi kors, OciDeck jibgħat lill-organizzazzjoni eLearning magħżula l-aħħar slide tiegħek, it-tlestija u l-ħin muri għal kull slide. It-tweġibiet, in-noti u l-kontenut tal-kors ma jintbagħtux bħala progress.',
  'Ingelogd bij eLearning': 'Illoggjat f\'eLearning',
  'Deze eLearning-server gebruikt {host} voor het aanmelden. Er worden pas gegevens met die identiteitsprovider uitgewisseld nadat u dit toestaat.':
      'Dan is-server eLearning juża {host} biex tidħol. Id-data tiġi skambjata ma’ dak il-fornitur tal-identità biss wara li tippermetti dan.',
  'Gebruik een HTTPS-adres voor eLearning.':
      'Uża indirizz HTTPS għal eLearning.',
  'Vul een geldig eLearning-adres in.': 'Daħħal indirizz eLearning validu.',
  ...
  'Met afloop wordt de pagina rondom groter dan het gekozen formaat, zodat inkt die tot de rand loopt dóór de snijlijn heen gaat. De afloop geldt voor élke export tot je hem weer op 0 zet. Laat dit op 0 voor gewoon afdrukken.':
      'Bil-bleed il-paġna ssir akbar mid-daqs magħżul mad-dawra kollha, biex il-linka li tasal sat-tarf tkompli lil hinn mil-linja tal-qtugħ. Il-bleed japplika għal kull esportazzjoni sakemm terġa\' tqiegħdu fuq 0. Ħalli 0 għal stampar normali.',
  'Pagina\'s': 'Paġni',
  'Maat': 'Daqs',
  'Staand': 'Wieqaf',
  'Liggend': 'Mimdud',
  'documenten': 'dokumenti',
  'posters en boeken': 'posters u kotba',
  ...
  'Eénsteeks t-toets': 'Test t ta’ kampjun wieħed',
  ...
  'Fractioneel (2^(k−p))': 'Frazzjonarju (2^(k−p))',
  'Fractie p': 'Frazzjoni p',
  'runs in standaard Yates-volgorde': 'prove in ordine Yates standard',
  'In raster zetten': 'Imla l-gradilja',
  ...
  'Deze afbeelding naar het AI-model sturen?':
      'Tibgħat din l-istampa lill-mudell AI?',
  'De afbeelding gaat ongewijzigd naar': 'L-istampa tintbagħat kif inhi lil',
  'OciDeck lakt niets weg in een afbeelding: gezichten, tekst op een schermafdruk en gegevens in beeld gaan mee.':
      'OciDeck ma jirrediġi xejn ġo stampa: uċuħ, test fuq screenshot u data li tidher jintbagħtu wkoll.',
  'De beeldcontrole vond hier een of meer herkenbare gezichten.':
      'Il-kontroll tal-istampi sab hawn wiċċ rikonoxxibbli wieħed jew aktar.',
  'Naast de export komen twee bestanden te staan waarmee een ontvanger de redacties kan natrekken.':
      'Ħdejn l-esportazzjoni jinħolqu żewġ fajls li bihom min jirċievi jista\' jivverifika r-redazzjonijiet.',
  ...
  'Het token heeft de repo-scope nodig (of fijnmazig: Contents lezen en schrijven).':
      'It-token jeħtieġ l-ambitu repo (jew fin: Contents qari u kitba).',
  ...
  'Afbeeldingen, video en audio die je in dit tabblad koos, leven alleen in het geheugen. Een los .md-bestand bewaart ze niet — bij heropenen zijn ze weg. Exporteer als .ocideck-pakket om het beeld mee te nemen.':
      'L-istampi, il-vidjo u l-awdjo li għażilt f\'din it-tab jeżistu biss fil-memorja. Fajl .md sempliċi ma jżommhomx — jintilfu meta terġa\' tiftħu. Esporta bħala pakkett .ocideck biex tieħu l-media miegħek.',
  ...
  'Open bevindingen': 'Sejbiet miftuħa',
  'dagen': 'jiem',
  'was': 'kien',
  'Cijfers': 'Ċifri',
  'Cijfer': 'Ċifra',
  ...
  'Native git: niet gevonden — het REST-pad wordt gebruikt':
      'git nattiv: ma nstabx — jintuża l-mogħdija REST',
  'echte offline-historie mogelijk': 'storja offline vera possibbli',
  ...
  'deellink met ingebakken toegang': 'link ta\' qsim b\'aċċess inkorporat',
  'e-mailadres in een link': 'indirizz tal-email f\'link',
  ...
  'LibrePlan importeren': 'Importa minn LibrePlan',
  ...
  'Gantt-planning': 'Skeda Gantt',
  'WBS (hiërarchie)': 'WBS (ġerarkija)',
  'Projectstatus (cockpit)': 'Status tal-proġett (cockpit)',
  'Milestones (tijdlijn)': 'Stadji importanti (linja ta\' żmien)',
  'Kritieke pad (flow)': 'Passaġġ kritiku (fluss)',
  'Resources (tabel)': 'Riżorsi (tabella)',
  'Timesheet (tabel)': 'Skeda tal-ħin (tabella)',
  'Resourcebelasting (grafiek)': 'Tagħbija tar-riżorsi (grafika)',
