...
const _dutchSourceUk = {
  ...
  'Twee opsommingskolommen naast elkaar — handig om twee dingen te vergelijken.':
      'Дві колонки маркерів поруч — зручно для порівняння двох речей.',
  'Opsomming links, afbeelding rechts. Kies een beeld uit de bibliotheek of sleep het naar binnen.':
      'Маркери ліворуч, зображення праворуч. Оберіть зображення з бібліотеки або перетягніть його сюди.',
  'Twee afbeeldingen naast elkaar, elk met een eigen bijschrift.':
      'Два зображення поруч, кожне з власним підписом.',
  'Eén grote, beeldvullende afbeelding met een optioneel bijschrift.':
      'Одне велике зображення на весь екран із необов\'язковим підписом.',
  'Zet begin- en eindtijd in seconden om te knippen, of knip live op het afspeelpunt in het voorbeeld.':
      'Задайте час початку та кінця в секундах для обрізання, або обріжте наживо в точці відтворення в попередньому перегляді.',
  'Een uitgelicht citaat met bronvermelding.':
      'Виділена цитата із зазначенням джерела.',
  'Plak een selectie uit een spreadsheet met Ctrl/Cmd+V, of typ per cel. Vink "bewerkbaar tijdens presenteren" aan om live te wijzigen.':
      'Вставте виділення з електронної таблиці за допомогою Ctrl/Cmd+V або вводьте по клітинках. Позначте "редаговане під час презентації", щоб змінювати наживо.',
  'Ruwe Markdown met koppen, code, wiskundige LaTeX-formules en mermaid-diagrammen.':
      'Необроблений Markdown із заголовками, кодом, математичними формулами LaTeX і діаграмами mermaid.',
  'Een codeblok met syntaxiskleuring. Kies de programmeertaal voor de juiste opmaak.':
      'Блок коду з підсвічуванням синтаксису. Оберіть мову програмування для правильного форматування.',
  'Importeer cijfers uit een CSV-bestand of typ ze in het rooster. Kies staaf, lijn, taart of radar.':
      'Імпортуйте числа з файлу CSV або введіть їх у сітку. Оберіть стовпчикову, лінійну, кругову діаграму чи радар.',
  'Een dashboard van meters. Geef elke meter een waarde, bereik en label.':
      'Панель приладів. Задайте кожному приладу значення, діапазон і мітку.',
  'Een interactieve quizvraag. Kies het soort (meerkeuze, juist/onjuist, meerdere goed of volgorde) en vul de antwoorden in.':
      'Інтерактивне запитання вікторини. Оберіть тип (кілька варіантів, правда/неправда, кілька правильних чи послідовність) і заповніть відповіді.',
  'Een tijdlijn van gedateerde gebeurtenissen. Kies de opmaak en hoe de gebeurtenissen verschijnen.':
      'Хронологія датованих подій. Оберіть оформлення та спосіб появи подій.',
  'De TLP-classificatie bepaalt wie de slide mag zien. Slides met een hoger niveau dan het deck worden bij presenteren en exporteren weggelaten.':
      'Класифікація TLP визначає, хто може бачити слайд. Слайди з рівнем вищим за колоду пропускаються під час презентації та експорту.',
  'Wat kan ik hier?': 'Що я можу тут робити?',
  'Uitvoeren': 'Виконати',
  'Nieuwe grafiek': 'Нова діаграма',
  'Commandopalet': 'Палітра команд',
  'Typ een commando…': 'Введіть команду…',
  ...
  'Informatieveiligheid: RASCI / TVB': 'Інформаційна безпека: RASCI / TVB',
  'Takenplan informatieveiligheid': 'План завдань з безпеки',
...
const _dutchSourceAddUk = <String, String>{
  ...
  'PDF/A en digitale handtekeningen blijven zichtbaar. OciDeck controleert de handtekening niet.':
      'PDF/A та цифрові підписи залишаються видимими. OciDeck не перевіряє підпис.',
  ...
  'Aangemaakt op': 'Створено на',
  'Aanmeldprovider': 'Провайдер входу',
  'Aanmeldsessies': 'Реєстраційні сесії',
  'Aantal controles': 'Кількість перевірок',
  ...
  'Activiteitnummer': 'Номер діяльності',
  'Afgerond op': 'Округлено до',
  'Afgewezen': 'Відхилено',
  'Afspeelsessienummer': 'Номер сеансу відтворення',
  'Afwezig': 'Відсутній',
  'Antwoordgegevens': 'Деталі відповіді',
  'Antwoordstatus': 'Статус відповіді',
  'Begint op': 'Починається на',
  'Begrippen uitgelegd': 'Пояснення понять',
  'Beheer van de installatie': 'Керування установкою',
  'Beheerpogingen': 'Зусилля управління',
  'Bekeken lessen': 'Переглянуті уроки',
  'Beleidsversie': 'Версія політики',
  'Beoordeeld': 'Оцінений',
  'Beoordeeld op': 'Оцінено',
  'Beperking': 'обмеження',
  'Berekend op': 'Розраховано на',
  'Bericht': 'повідомлення',
  'Bestandsnaam': 'Ім\'я файлу',
  'Beveiligingsvraagnummer': 'Номер секретного питання',
  'Bevestigd': 'Підтверджено',
  'Bevestigd op': 'Підтверджено',
  'Bewaarregels': 'Правила зберігання',
  'Bewaartermijn': 'Термін зберігання',
  'Bewaren wegens een juridische verplichting':
      'Зберігається через юридичне зобов\'язання',
  'Bewerkingnummer bij aanmeldprovider':
      'Номер операції в постачальника реєстрації',
  'Bewijsstukken': 'Докази',
  'Bezwaar': 'Заперечення',
  'Beëindigd op': 'Закінчився о',
  'Bijeenkomstnummer': 'Номер зустрічі',
  'Certificaatnummer': 'Номер сертифіката',
  'Certificaten': 'Сертифікати',
  'Controlecode van de PDF': 'Контрольний код pdf',
  'Controlecode van profielfoto': 'Код підтвердження фотографії профілю',
  'Controlecodes van bewijsstukken': 'Контрольні коди супровідних документів',
  'Correctie': 'Виправлення',
  'Cursistnummer waarop de actie gericht was':
      'Номер студента, на якого була спрямована акція',
  'Cursusaanbodnummer': 'Номер пропозиції курсу',
  'Cursusversienummer': 'Номер версії курсу',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Дати та час відображаються за вашим місцевим часом. Технічні назви залишаються видимими, коли сервер надає невідоме поле.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'Відповіді, які ви дали на запитання тесту.',
  'Deelnamenummer': 'Номер участі',
  'Deelnames': 'Участь',
  'Details': 'Подробиці',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Цю категорію надав сервер. Технічні назви залишаються видимими для запитів від вашої організації.',
  'Door uzelf aangevraagd': 'Запитали самі',
  'E-mailadres': 'Адреса електронної пошти',
  'E-mailberichten': 'Повідомлення електронної пошти',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'Ідентифікатор — це унікальний технічний номер, який eLearning використовує для зв’язування даних. Це не рейтинг чи статус.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'Категорія групує дані з однієї теми. Реєстрація – це один збережений фрагмент даних або одна подія.',
  'Eindigt op': 'Закінчується в',
  'Geaccepteerd op': 'Прийнято на',
  'Geannuleerd': 'Скасовано',
  'Gecontroleerd': 'Перевірено',
  'Gecontroleerd op': 'Перевірено',
  'Geen gegevens gevonden': 'Дані не знайдено',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Інформація про терміни зберігання та видалення ваших даних.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Інформація про підтверджуючі документи, досягнуті результати та сертифікати.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Інформація про запити щодо конфіденційності та про те, хто переглядав або змінював вашу інформацію.',
  'Gegevens over uw accountbewerking':
      'Інформація про операції з вашим рахунком',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Інформація про вашу реєстрацію, участь і успішність уроків.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Інформація про ваш профіль, обліковий запис і посаду в організації.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Інформація про моменти тестування та подані запитання.',
  'Gegevens over willekeurige volgorde': 'Дані випадкового порядку',
  'Gegevenscategorie': 'Категорія даних',
  'Gekoppeld accountnummer': 'Прив\'язаний номер рахунку',
  'Gekozen antwoorden': 'Вибрані відповіді',
  'Gelukt': 'Успіх',
  'Geprobeerd op': 'Приміряв',
  'Gerechtvaardigd belang': 'Законний інтерес',
  'Gereserveerd': 'Зарезервовано',
  'Gereserveerd op': 'Зарезервовано на',
  'Geslaagd': 'Пройшов',
  'Gestart op': 'Розпочато на',
  'Getoonde tijd per dia in milliseconden':
      'Час, показаний на слайді в мілісекундах',
  'Herkomst van inschrijving': 'Походження реєстрації',
  'Hoogst haalbare score': 'Максимально можливий бал',
  'Identificatienummer bij aanmeldprovider':
      'Ідентифікаційний номер реєстратора',
  'Identiteitsbewerkingnummer': 'Ідентифікаційний номер операції',
  'In afwachting': 'В очікуванні',
  'In behandeling': 'В роботі',
  'In behandeling genomen op': 'Оброблено на',
  'In quarantaine': 'На карантині',
  'Ingeleverd': 'Надіслано',
  'Ingeleverd op': 'Подано на',
  'Ingericht op': 'Прикрашений на',
  'Ingeschreven op': 'Зареєстровано на',
  'Ingetrokken': 'Вилучено',
  'Ingetrokken op': 'Вилучено на',
  'Inschrijvingen': 'Реєстрації',
  'Inschrijvingsnummer': 'Реєстраційний номер',
  'Installatiebeveiligingslogboek': 'Журнал безпеки встановлення',
  'Installatienummer': 'Номер установки',
  'Installatieverzoeken': 'Запити на встановлення',
  'Inzage': 'Огляд',
  'Ja': 'так',
  'Kwalificatienummer': 'Кваліфікаційний номер',
  'Kwalificaties': 'кваліфікація',
  'Laatst actief op': 'Востаннє активний на',
  'Laatst bekeken dia': 'Останній переглянутий слайд',
  'Laatst gewijzigd op': 'Востаннє змінено',
  'Laatste fout': 'Остання помилка',
  'Lesnummer': 'Номер уроку',
  'Lesreserveringen': 'Бронювання уроків',
  'Lesvoortgang': 'Хід уроку',
  'Lidmaatschappen': 'Членство',
  'Locatie': 'Розташування',
  'Manier van afronden': 'Спосіб округлення',
  'Maximaal aantal controles': 'Максимальна кількість перевірок',
  'Maximaal aantal pogingen': 'Максимальна кількість спроб',
  'Maximale leeftijd van de aanmelding': 'Максимальний вік реєстрації',
  'Mislukt': 'Не вдалося',
  'Naam van de activiteit': 'Назва діяльності',
  'Naam van de bijeenkomst': 'Назва зустрічі',
  'Nee': 'немає',
  'Netwerkadres': 'Адреса мережі',
  'Niet actief': 'Неактивний',
  'Niet geregistreerd': 'Не зареєстрований',
  'Niet ingevuld': 'Не заповнюється',
  'Niet verschenen': 'Не опубліковано',
  'Niveau van extra aanmeldcontrole':
      'Рівень додаткового реєстраційного контролю',
  'Nummer van de toetsopzet': 'Номер тестового плану',
  'Nummer van het brongegeven': 'Номер вихідних даних',
  'Nummer van uw verwijderde gegeven': 'Кількість ваших видалених даних',
  'Onderdeel {nummer}': 'Частина {nummer}',
  'Onderwerp van de actie': 'Предмет акції',
  'Ontvanger': 'одержувач',
  'Opgegeven bestandsgrootte': 'Зазначений розмір файлу',
  'Opgegeven bestandstype': 'Визначений тип файлу',
  'Opgegeven controlecode': 'Вказаний контрольний код',
  'Opgeslagen bestandsgrootte': 'Збережений розмір файлу',
  'Opgeslagen controlecode': 'Збережений контрольний код',
  'Organisatienummer': 'Номер організації',
  'Overdraagbaarheid': 'Переказність',
  'PE-toekenningnummer': 'Номер премії PE',
  'Poging': 'Спроба',
  'Positie': 'Позиція',
  'Privacyverzoeken': 'Запити щодо конфіденційності',
  'Probeer een andere zoekterm.': 'Спробуйте інший термін пошуку.',
  'Reden': 'Причина',
  'Reden of grondslag': 'Причина чи підстава',
  'Reden van afwijzing': 'Причина відмови',
  'Reden van bevestiging': 'Причина підтвердження',
  'Reden van intrekking': 'Причина відкликання',
  'Reden voor langer bewaren': 'Причина більш тривалого зберігання',
  'Regels voor de cursusversie': 'Правила оформлення курсової версії',
  'Resultaat bij de aanmeldprovider': 'Результат у постачальника реєстрації',
  'Rol': 'рулет',
  'Score': 'Оцінка',
  'Soort aanwezigheid': 'Вид присутності',
  'Soort accountbewerking': 'Тип операції по рахунку',
  'Soort gebeurtenis': 'Тип події',
  'Soort privacyverzoek': 'Тип запиту конфіденційності',
  'Status van de bijeenkomst': 'Статус зустрічі',
  'Strenge beveiligingsmodus': 'Режим високої безпеки',
  'Technisch toegangslogboek': 'Журнал технічного доступу',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Технічні дані, необхідні для реєстрації, безпеки та надійної обробки.',
  'Technische naam: {naam}': 'Технічна назва: {naam}',
  'Technische opslagcategorie': 'Категорія технічного зберігання',
  'Technische opslaglocatie van de PDF': 'Технічне місце зберігання PDF-файлу',
  'Tijdstip van aanmelding': 'Час реєстрації',
  'Tijdzone': 'Часовий пояс',
  'Toestand': 'Стан',
  'Toetspogingen': 'Тестові спроби',
  'Toetspogingnummer': 'Номер тестової спроби',
  'Uiterste inlevermoment': 'Кінцевий термін подання',
  'Uitgegeven op': 'Опубліковано на',
  'Uitgenodigd e-mailadres': 'Адреса електронної пошти запрошеного',
  'Uitnodigingen': 'Запрошення',
  'Uniek nummer (ID)': 'Унікальний номер (ID)',
  'Uniek verwerkingskenmerk': 'Унікальна функція обробки',
  'Uw accountnummer': 'Ваш номер рахунку',
  'Uw accountnummer als uitvoerder': 'Ваш номер рахунку як виконавця',
  'Uzelf als uploader': 'Ви як завантажувач',
  'Vaardigheidsversienummer': 'Номер версії навички',
  'Vast internetadres van de installatie':
      'Фіксована інтернет-адреса установки',
  'Vastgelegde beslisgegevens': 'Записані дані рішення',
  'Vastgelegde gegevens': 'Записані дані',
  'Vereist niveau van aanmeldzekerheid':
      'Необхідний рівень достовірності реєстрації',
  'Vereiste aanmeldmethoden': 'Необхідні методи входу',
  'Verloopt bij inactiviteit op':
      'Термін дії закінчується, коли він неактивний',
  'Verloopt definitief op': 'Термін дії закінчується безстроково',
  'Verloopt op': 'Термін дії закінчується',
  'Versienummer van de PE-regel': 'Номер версії правила PE',
  'Verwerkte verzoeken': 'Опрацьовані запити',
  'Verwijderd op': 'Видалено на',
  'Verwijdering': 'Видалення',
  'Verwijderingsregister': 'Реєстр видалення',
  'Verwijzing naar het antwoord': 'Посилання на відповідь',
  'Verzoeknummer': 'Номер запиту',
  'Verzoeknummer van de app': 'Номер запиту програми',
  'Verzonden op': 'Надіслано далі',
  'Volgende controle op': 'Наступна перевірка',
  'Volgnummer': 'Порядковий номер',
  'Volgorde van antwoordopties': 'Порядок варіантів відповідей',
  'Vraagnummer binnen de toetspoging': 'Номер питання в тестовій спробі',
  'Vraagversienummer': 'Номер версії питання',
  'Vragen in toetspogingen': 'Питання в тестових спробах',
  'Vrijgegeven': 'Звільнений',
  'Vrijgegeven op': 'Випущено на',
  'Wat gebeurt na de bewaartermijn':
      'Що відбувається після закінчення терміну зберігання',
  'Wettelijke verplichting': 'Юридичний обов\'язок',
  'Wijzigingen aan PE-punten': 'Зміни в балах PE',
  'Wijzigingen aan kwalificaties': 'Зміни кваліфікації',
  'Wijzigingen in aanmeldbeveiliging': 'Зміни в безпеці входу',
  'Zekerheid': 'Впевненість',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Наприклад, шукайте за курсом, датою чи статусом',
  'Zoeken in uw gegevens': 'Пошук даних',
  '{aantal} categorieën gevonden': 'Знайдено категорії {aantal}',
  'Aanwezigheid': 'Відвідування',
  'Lidmaatschap': 'Членство',
  'Inzage en wijzigingen': 'Доступ і зміни',
  'Beschikbaarheid van het inzagespoor': 'Наявність журналу доступу',
  'Beschikbaar vanaf': 'Доступний з',
  'Historie vóór deze datum': 'Історія до цієї дати',
  'Tijdstip': 'Дата і час',
  'Handeling': 'Дія',
  'Gegevensonderdeel': 'Категорія даних',
  'Handelde als': 'Виконував роль',
  'Organisatorische rol': 'Організаційна роль',
  'Bekeken': 'Переглянуто',
  'Gewijzigd': 'Змінено',
  'Uzelf': 'Ви',
  ...
  'Docent': 'Інструктор',
  'Beoordelaar': 'Асесор',
  'Organisatiebeheerder': 'Адміністратор організації',
  'Niet beschikbaar': 'Не доступний',
  'Uitoefening van privacyrechten': 'Здійснення прав на конфіденційність',
  'Beoordeling en certificering': 'Оцінка та атестація',
  'Uitvoering van het leertraject': 'Подача навчальної програми',
  'Cursistenadministratie': 'Адміністрування учня',
  'Cursistprofiel': 'Профіль учня',
  'Leerstatistieken': 'Статистика навчання',
  'Inschrijving': 'Зарахування',
  'Toetspoging': 'Спроба оцінки',
  'Beoordeling': 'Оцінка',
  'Bewijsstuk': 'Докази',
  'Kwalificatie': 'Кваліфікація',
  'Deelname': 'Участь',
  'PE-punten': 'Пункти підвищення кваліфікації',
  'Certificaat': 'Сертифікат',
  'Privacyverzoek': 'Запит на конфіденційність',
  'Bewaard tot': 'Зберігається до',
  'Bekijk mijn gegevens': 'Переглянути мої дані',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Перегляньте, які дані про вас зареєстровано в eLearning.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Цей огляд отримано безпосередньо з eLearning {datum}; OciDeck його не зберігає.',
  'Geen gegevens geregistreerd': 'Дані не зареєстровано',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'Він містить усі категорії, надані сервером для цієї організації. Щоб дізнатися про цілі, одержувачів, походження, строки зберігання або інші права на приватність, зверніться до {organisatie}.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Не вдалося завантажити ваші дані. Спробуйте ще раз.',
  'Meer tonen ({aantal} resterend)': 'Показати більше (залишилося: {aantal})',
  'Mijn gegevens': 'Мої дані',
  'Privacy-inzage': 'Доступ до персональних даних',
  'Uw geregistreerde gegevens': 'Ваші зареєстровані дані',
  'uw organisatie': 'ваша організація',
  '{aantal} registraties': 'Записів: {aantal}',
  ...
  'Deze identiteitsprovider toestaan':
      'Дозволити цього постачальника ідентифікації',
  'Deze organisatie bevat te veel lessen om veilig te tonen.':
      'Ця організація містить надто багато уроків, щоб безпечно їх показати.',
  'Er wacht nog voortgang op synchronisatie.':
      'Поступ іще очікує синхронізації.',
  'Met deze keuze wordt het vernieuwtoken in de sleutelbos bewaard. Een versleutelde wachtrij voor nog niet verstuurde voortgang wordt daar los van bewaard.':
      'За цього вибору токен оновлення зберігається у зв’язці ключів. Зашифрована черга ще не надісланого поступу зберігається окремо.',
  'Nog niet verstuurde voortgang is op dit apparaat bewaard.':
      'Ще не надісланий поступ збережено на цьому пристрої.',
  'Cursist': 'Учень',
  'Les afgerond': 'Урок завершено',
  'Cursussen voor u': 'Курси для вас',
  'Ga verder waar u gebleven was, of kies een andere cursus die voor u klaarstaat.':
      'Продовжуйте з того місця, де ви зупинилися, або виберіть інший курс, готовий для вас.',
  'Klaar om te beginnen': 'Готові почати',
  'Mijn cursussen': 'Мої курси',
  'Mijn leeromgeving': 'Моє навчальне середовище',
  'Mooi gedaan! Uw voortgang is bewaard.': 'Чудово! Ваш прогрес збережено.',
  'Nu bezig': 'Триває',
  'Opnieuw starten': 'Почати знову',
  'Terug naar mijn cursussen': 'Повернутися до моїх курсів',
  'U kunt deze cursus opnieuw bekijken.':
      'Ви можете переглянути цей курс ще раз.',
  'Volgende: {les}': 'Далі: {les}',
  'Welkom, {naam}': 'Вітаємо, {naam}',
  ...
  '{afgerond} van {totaal} lessen afgerond':
      'Завершено {afgerond} із {totaal} уроків',
  'Uitloggen': 'Вийти',
  ...
  'Uiterlijk van de app': 'Вигляд застосунку',
  'Uiterlijk van dia\'s': 'Вигляд слайдів',
  'Privacy en classificatie': 'Конфіденційність та класифікація',
  'Uiterlijk van documenten': 'Вигляд документів',
  'Exportkwaliteit': 'Якість експорту',
  'Geef eerst toestemming voor uitgaand verkeer bij Privacy en classificatie.':
      'Спершу надайте згоду на вихідний трафік у розділі «Конфіденційність та класифікація».',
  'Een clouddienst vereist eerst je privacytoestemming bij "Privacy en classificatie" en werkt niet in de webversie.':
      'Хмарний сервіс спершу потребує вашої згоди на конфіденційність у розділі "Конфіденційність та класифікація" і не працює у веб-версії.',
  'Deze instellingen bepalen wat OciDeck vanaf het internet mag laden en welke sporen op dit apparaat achterblijven. Ze staan los van je privacyverklaring en toestemming, die je bij "Privacy en classificatie" vindt.':
      'Ці налаштування визначають, що OciDeck може завантажувати з інтернету та які сліди залишаються на цьому пристрої. Вони не пов\'язані з твоєю заявою про конфіденційність і згодою, які ти знайдеш у розділі "Конфіденційність та класифікація".',
  ...
  'Sleep op de afbeelding om een gebied te markeren.':
      'Перетягніть на зображенні, щоб позначити область.',
  'Geldt voor de hele dia — bepaalt hoe verwijzingen tijdens de presentatie worden getekend, niet hoe je ze bewerkt.':
      'Стосується всього слайда — визначає, як посилання малюються під час презентації, а не як ви їх редагуєте.',
  ...
  'Basislettergrootte: {pt} pt': 'Базовий розмір шрифту: {pt} pt',
  ...
  'Dit is een presentatie, geen Markdown-bestand. OciDeck kan hem importeren naar een nieuw deck.':
      'Це презентація, а не файл Markdown. OciDeck може імпортувати її в новий дек.',
  'Dit is een presentatie, geen Markdown-bestand. Zet de module Importeren aan om hem om te zetten naar een deck.':
      'Це презентація, а не файл Markdown. Увімкніть модуль «Імпортувати», щоб перетворити її на дек.',
  ...
  'Dit pakket is te groot (maximaal 512 MB). Anders kan OciDeck het daarna niet meer openen. Gebruik minder of kleinere afbeeldingen, video’s of audiobestanden.':
      'Цей пакунок завеликий (максимум 512 МБ). Інакше OciDeck згодом не зможе його відкрити. Використовуйте менше або менші зображення, відео чи аудіофайли.',
  ...
  'De eigenaar is weg — jij houdt de samenwerking nu gaande; jouw wijzigingen worden pas bewaard als de eigenaar terugkomt.':
      'Власник пішов — тепер саме ви підтримуєте співпрацю; ваші зміни буде збережено лише тоді, коли власник повернеться.',
  'De eigenaar is terug en neemt de samenwerking weer over.':
      'Власник повернувся й знову перебирає співпрацю на себе.',
  ...
  'Vergelijk organisaties en breng portfolio-aandachtspunten in beeld.':
      'Порівняйте організації та визначте цікаві точки портфоліо.',
  'Bekijk de actuele stand of aantoonbare veranderingen bij één organisatie.':
      'Перегляньте поточний статус або помітні зміни в одній організації.',
  'Onderzoek betrouwbare CVE-koppelingen in de gekozen metingen.':
      'Дослідіть надійні зв’язки CVE у вибраних вимірюваннях.',
  'Leg vast welke metingen en bronbestanden het rapport werkelijk gebruikt.':
      'Запишіть, які вимірювання та вихідні файли фактично використовує звіт.',
  'Wat is het managementbeeld over de gekozen organisaties?':
      'Який погляд керівництва обраних організацій?',
  'Waar worden de meeste en minste findings waargenomen?':
      'Де спостерігається найбільше і найменше знахідок?',
  'Hoe ontwikkelt het portfolio zich over de tijd?':
      'Як портфоліо розвивається з часом?',
  'Welke problemen komen bij de meeste organisaties voor?':
      'Які проблеми виникають у більшості організацій?',
  'Waar concentreren de ernstigste findings zich?':
      'Де зосереджені найсерйозніші знахідки?',
  'Welke controls lopen achter?': 'Які елементи керування відстають?',
  'Welke maatregelen adviseert OpenKAT het vaakst?':
      'Які заходи OpenKAT рекомендує найчастіше?',
  'Hoe staat deze organisatie er nu voor?': 'Який зараз стан цієї організації?',
  'Wat veranderde er sinds de vorige meting?':
      'Що змінилося після попереднього вимірювання?',
  'Welke findings zijn nieuw of niet meer waargenomen?':
      'Які знахідки є новими або які більше не спостерігаються?',
  'Welke findings staan het langst open?':
      'Які знахідки були відкритими найдовше?',
  'Op welke systemen worden de meeste findings waargenomen?':
      'На яких системах спостерігається найбільше знахідок?',
  'Welke systemen verbeterden of verslechterden?':
      'Які системи покращилися чи погіршилися?',
  'Welke controls verbeterden of verslechterden?':
      'Які елементи керування покращилися чи погіршилися?',
  'Welke systemen zijn in de metingen opgenomen?':
      'Які системи включені до вимірювань?',
  'Welke assets zijn aantoonbaar in monitoring?':
      'Які активи можна продемонструвати під час моніторингу?',
  'Welke monitoringstatussen veranderden?':
      'Які статуси моніторингу змінилися?',
  'Wie is geraakt door deze CVE?': 'На кого впливає цей CVE?',
  'Welke CVE’s raken de meeste organisaties?':
      'Які CVE впливають на більшість організацій?',
  'Welke CVE’s zijn nieuw of niet meer waargenomen?':
      'Які CVE є новими або більше не спостерігаються?',
  ...
  'Nog niet beschikbaar: niet iedere finding heeft een betrouwbare eerste waarnemingsdatum.':
      'Ще немає: не кожна знахідка має надійну дату першого спостереження.',
  'Nog niet beschikbaar: de bron bewijst geen stabiele identiteit voor alle findings.':
      'Ще недоступно: джерело не підтверджує стабільну ідентичність для всіх знахідок.',
  'Nog niet beschikbaar: vergelijkbare meetdekking is niet aangetoond.':
      'Ще не доступно: порівняльне покриття вимірювань не було продемонстровано.',
  'Nog niet beschikbaar: betrouwbare controlnoemers ontbreken.':
      'Ще недоступно: відсутні надійні контрольні знаменники.',
  'Nog niet beschikbaar: stabiele assetidentiteit is niet aangetoond.':
      'Ще не доступно: стабільна ідентичність активу не продемонстрована.',
  'Dit rapport ondersteunt de gekozen organisatiescope niet.':
      'Цей звіт не підтримує вибраний обсяг організації.',
  'De gekozen bron bevat niet genoeg betrouwbare gegevens voor dit rapport.':
      'Вибране джерело не містить достатньо надійних даних для цього звіту.',
  'Kerncijfers en gemeten bereik': 'Ключові цифри та виміряне охоплення',
  'Organisaties vergelijken': 'Порівняйте організації',
  'Concentratie van critical/high findings':
      'Концентрація критичних/високих показників',
  'Portfolioverloop per meetmoment': 'Огляд портфоліо на момент вимірювання',
  'Meest voorkomende findingtypen': 'Найпоширеніші види знахідок',
  'Bron- en meetverantwoording': 'Підзвітність джерела та вимірювання',
  'Nieuwe en niet meer waargenomen findings':
      'Нові знахідки, які більше не спостерігаються',
  'Langst waargenomen findings': 'Знахідки, які спостерігалися найдовше',
  'Systemen met de meeste findings': 'Системи з найбільшою кількістю знахідок',
  'Veranderingen per systeem': 'Зміни в системі',
  'Blootstelling aan één CVE': 'Вплив одного CVE',
  'CVE’s over organisaties': 'CVE про організації',
  'Nieuwe en niet meer waargenomen CVE’s':
      'Нові та більше не спостерігаються CVE',
  'Controldekking': 'Контроль покриття',
  'Controlveranderingen': 'Контрольні зміни',
  'Aanbevelingen uit OpenKAT': 'Рекомендації від OpenKAT',
  'Assetinventaris': 'Інвентаризація активів',
  'Monitoringdekking': 'Моніторинг покриття',
  'Actueel organisatiebeeld': 'Поточна організаційна картина',
  'Kies eerst het onderwerp en daarna de vraag die het rapport moet beantwoorden.':
      'Спочатку виберіть тему, а потім питання, на яке повинна відповісти доповідь.',
  'Onderwerp': 'Тема',
  ...
  'Verpleegkundige dienstoverdracht': 'Передача сестринської зміни',
  'Inwerkplan (30-60-90 dagen)': 'План адаптації (30-60-90 днів)',
  'Eerste dag / introductie': 'Перший день / знайомство',
  'Buddy- / mentorafspraak': 'План бадді / наставника',
  'Uitdiensttreding / offboarding': 'Офбординг / звільнення',
  'IMSAFE fit-to-fly-check': 'IMSAFE перевірка придатності до польоту',
  'Crew- / departurebriefing': 'Брифінг екіпажу / перед вильотом',
  'Voorvalmelding (just culture)': 'Повідомлення про подію (just culture)',
  'Toolbox / LMRA veiligheidscheck': 'Toolbox / перевірка безпеки LMRA',
  'Evenement- en crowd-safetybriefing': 'Брифінг заходу та безпеки натовпу',
  'Ontruimings- en BHV-oefening': 'Навчання з евакуації та BHV',
  'Werkvergunning (permit to work)': 'Дозвіл на роботу (permit to work)',
  'METHANE grootschalig-incidentmelding':
      'METHANE повідомлення про велику подію',
  'GRIP-opschaling': 'Ескалація GRIP',
  'Maritieme passage-/brugbriefing': 'Морський брифінг переходу / містка',
  'Draag een patiënt of situatie gestructureerd over: Situatie, Achtergrond, Beoordeling en Aanbeveling.':
      'Структуровано передайте пацієнта або ситуацію: ситуація, передумови, оцінка та рекомендація.',
  'Prehospitale overdracht naar de SEH met leeftijd, mechanisme, letsels, symptomen en behandeling.':
      'Догоспітальна передача до приймального відділення з віком, механізмом, ушкодженнями, ознаками та лікуванням.',
  'Bespreek een casus met alle disciplines: beeld, behandeldoel, besluiten en afspraken.':
      'Обговоріть випадок між дисциплінами: картина, мета лікування, рішення та домовленості.',
  'Sign in, time-out en sign out rond een ingreep volgens de WHO-checklist.':
      'Sign in, time-out і sign out навколо втручання за контрольним списком WHO.',
  'Draag de zorg per patiënt over: toestand, aandachtspunten en openstaande taken.':
      'Передайте догляд за кожним пацієнтом: стан, точки уваги та невиконані завдання.',
  'Zet verwachtingen, mijlpalen en begeleiding uit over de eerste 30, 60 en 90 dagen.':
      'Окресліть очікування, віхи та підтримку на перші 30, 60 і 90 днів.',
  'Mensen, systemen, huisregels en de veiligheids- en privacybasis voor een nieuwe medewerker.':
      'Люди, системи, внутрішні правила та основи безпеки й приватності для нового працівника.',
  'Doelen, ritme en checkpoints tussen nieuwkomer en buddy of mentor.':
      'Цілі, ритм і контрольні точки між новачком та його бадді чи наставником.',
  'Kennisoverdracht, intrekken van toegang en een net exitgesprek bij vertrek.':
      'Передача знань, відкликання доступів і належна вихідна співбесіда під час звільнення.',
  'Persoonlijke go/no-go: ziekte, medicatie, stress, alcohol, vermoeidheid en gemoed.':
      'Особисте go/no-go: хвороба, ліки, стрес, алкоголь, втома та настрій.',
  'Taakverdeling, bedreigingen en fouten (TEM) en afwijkingen vóór vertrek met de bemanning.':
      'Розподіл завдань, загрози та помилки (TEM) і відхилення перед вильотом з екіпажем.',
  'Meld een voorval feitelijk en zonder schuldvraag: wat, factoren, risico en verbetering.':
      'Повідомте про подію фактично й без пошуку винних: що, чинники, ризик та покращення.',
  'Taak, gevaren, maatregelen en akkoord vlak voordat het werk begint.':
      'Завдання, небезпеки, заходи та погодження безпосередньо перед початком роботи.',
  'Capaciteit, risico\'s, in- en uitstroom en incidentrollen voor een evenement.':
      'Місткість, ризики, потоки людей і ролі під час інциденту для заходу.',
  'Scenario, taken, verzamelplaats, waarnemingen en evaluatie van een ontruiming.':
      'Сценарій, завдання, місце збору, спостереження та оцінка евакуації.',
  'Werk, isolaties, controles en vrijgave voor risicovol werk vastleggen.':
      'Зафіксуйте роботу, ізоляції, перевірки та дозвіл для робіт високого ризику.',
  'Eerste melding bij een groot incident: melding, locatie, type, gevaren, toegang, aantal en diensten.':
      'Перше повідомлення про велику подію: велика подія, точне місце, тип, небезпеки, доступ, кількість і служби.',
  ...
  'De browser blokkeert media van een externe bron. Open deze presentatie in de app om online media te tonen.':
      'Браузер блокує медіа із зовнішнього джерела. Відкрийте цю презентацію в застосунку, щоб показати онлайн-медіа.',
  ...
  'Dia bevat meerdere audiofragmenten; OciDeck ondersteunt er maar één per dia.':
      'Слайд містить кілька аудіофрагментів; OciDeck підтримує лише один на слайд.',
  'Dia bevat meerdere grafieken; OciDeck ondersteunt er maar één per dia.':
      'Слайд містить кілька діаграм; OciDeck підтримує лише одну на слайд.',
  'Dia bevat meerdere tabellen; OciDeck ondersteunt er maar één per dia.':
      'Слайд містить кілька таблиць; OciDeck підтримує лише одну на слайд.',
  'Dia bevat meerdere video\'s; OciDeck ondersteunt er maar één per dia.':
      'Слайд містить кілька відео; OciDeck підтримує лише одне на слайд.',
  'Dia {n} overgeslagen': 'Слайд {n} пропущено',
  'Dia {n}: alleen de afbeelding overgenomen':
      'Слайд {n}: перенесено лише зображення',
  'Een niet-tekstuele vorm, lijn of ander object kon niet worden omgezet.':
      'Не вдалося перетворити нетекстову фігуру, лінію чи інший об\'єкт.',
  'Footerrijen worden in Markdown niet ondersteund.':
      'Рядки нижнього колонтитула не підтримуються в Markdown.',
  'Formaat herkennen…': 'Розпізнавання формату…',
  'Gegroepeerde objecten zijn uitgeklapt; groepering en volgorde binnen de groep gaan verloren.':
      'Згруповані об\'єкти розгруповано; групування та порядок усередині групи втрачено.',
  'Groepering': 'Групування',
  'Headerkolommen worden in OciDeck niet ondersteund.':
      'Стовпці заголовка не підтримуються в OciDeck.',
  'IWA-objecten inlezen…': 'Читання об\'єктів IWA…',
  'IWA-structuur gedeeltelijk geparseerd — de vormgeving (thema, kleuren, posities) is niet overgenomen; tekst, slide-volgorde, notities en, waar de structuren herkend werden, tabellen, grafieken en media wel':
      'Структуру IWA частково розібрано — оформлення (тема, кольори, позиції) не перенесено; текст, порядок слайдів, нотатки та, де структури було розпізнано, таблиці, діаграми й медіа — перенесено.',
  'IWA-structuur niet volledig geparseerd — opmaak, tabellen, grafieken, media en slide-volgorde niet overgenomen':
      'Структуру IWA розібрано не повністю — форматування, таблиці, діаграми, медіа та порядок слайдів не перенесено',
  'IWA-tekst salvage…': 'Відновлення тексту IWA…',
  'Keynote IWA-intern': 'Keynote IWA внутрішній',
  'Keynote IWA-intern (~{n} dia’s)': 'Keynote IWA внутрішній (~{n} слайдів)',
  'Keynote tabel footer': 'Нижній колонтитул таблиці Keynote',
  'Keynote tabel header': 'Заголовок таблиці Keynote',
  'Keynote tabel headerkolommen': 'Стовпці заголовка таблиці Keynote',
  'Klaar.': 'Готово.',
  'Koppeling “{tekst}”': 'Посилання "{tekst}"',
  'Meerdere audio': 'Кілька аудіо',
  'Meerdere grafieken': 'Кілька діаграм',
  'Meerdere headerrijen worden in Markdown niet ondersteund; alleen de eerste rij wordt als tabelheader gebruikt.':
      'Кілька рядків заголовка не підтримуються в Markdown; як заголовок таблиці використовується лише перший рядок.',
  'Meerdere tabellen': 'Кілька таблиць',
  'Meerdere video\'s': 'Кілька відео',
  'Metadata uitlezen…': 'Читання метаданих…',
  'Niet overgenomen van dit document': 'Не перенесено з цього документа',
  'Niet overgenomen van slide {n}': 'Не перенесено зі слайда {n}',
  'Ondersteund grafiektype': 'Підтримуваний тип діаграми',
  'Samengevoegde cellen': 'Об\'єднані клітинки',
  'Samengevoegde tabelcellen worden in GFM-tabellen niet ondersteund; de tabel is platgeklapt.':
      'Об\'єднані клітинки таблиці не підтримуються в таблицях GFM; таблицю зведено до плоскої.',
  'Scatter x-as': 'Вісь x точкової діаграми',
  'Scatter-grafiek met aparte x-waardes per serie kan niet volledig worden weergegeven.':
      'Точкову діаграму з окремими значеннями x для кожної серії неможливо відобразити повністю.',
  'Slides classificeren…': 'Класифікація слайдів…',
  'Slides reconstrueren…': 'Реконструкція слайдів…',
  'Tabel naast grafiek': 'Таблиця поряд із діаграмою',
  'Voorbeeldafbeelding zoeken…': 'Пошук зображення для попереднього перегляду…',
  'Vorm of object': 'Фігура або об\'єкт',
  'de tekst blijft staan, de verwijzing niet':
      'текст залишається, посилання ні',
  'deels overgenomen': 'частково перенесено',
  'doel onschadelijk gemaakt; het wees naar {url}':
      'ціль знешкоджено; вона вказувала на {url}',
  'eerste audio overgenomen': 'збережено перше аудіо',
  'eerste grafiek overgenomen': 'збережено першу діаграму',
  'eerste rij als header': 'перший рядок як заголовок',
  'eerste tabel overgenomen': 'збережено першу таблицю',
  'eerste video overgenomen': 'збережено перше відео',
  'gedeelde x-as gebruikt': 'використано спільну вісь x',
  'niet overgenomen (OciDeck heeft geen audio-slides)':
      'не перенесено (OciDeck не має аудіослайдів)',
  'niet overgenomen (deze dia werd een {type})':
      'не перенесено (цей слайд став типом {type})',
  'niet overgenomen (deze dia werd een {type}, en die draagt geen opsomming)':
      'не перенесено (цей слайд став типом {type}, який не містить маркованого списку)',
  'niet overgenomen (een {type}-dia toont er {aantal})':
      'не перенесено (слайд типу {type} показує {aantal})',
  'niet overgenomen (een {type}-dia toont geen losse alineatekst)':
      'не перенесено (слайд типу {type} не показує окремого тексту абзацу)',
  'niet overgenomen (één grafiek of tabel per slide)':
      'не перенесено (одна діаграма або таблиця на слайд)',
  'objecten apart overgenomen': 'об\'єкти перенесено окремо',
  'samengevoegd in leesvolgorde': 'об\'єднано в порядку читання',
  'tekst, volgorde, notities en herkende tabellen, grafieken en media':
      'текст, порядок, нотатки та розпізнані таблиці, діаграми й медіа',
  '{n} afbeelding': '{n} зображення',
  '{n} afbeeldingen': '{n} зображень',
  '{n} alinea’s': '{n} абзаців',
  '{n} opsommingspunt': '{n} маркер',
  '{n} opsommingspunten': '{n} маркерів',
  '{n} vrij geplaatste tekstvakken': '{n} довільно розміщених текстових полів',
  'voorbeeldafbeelding en tekst': 'зображення попереднього перегляду та текст',
  'voorbeeldafbeelding': 'зображення попереднього перегляду',
  'tekst': 'текст',
  '{bestand} is groter dan de limiet van {limiet} en wordt niet geïmporteerd.':
      '{bestand} перевищує обмеження {limiet} і не буде імпортований.',
  '{bestand} is geen herkende presentatie. OciDeck leest PowerPoint (.pptx), OpenDocument (.odp) en Keynote (.key).':
      '{bestand} не є розпізнаною презентацією. OciDeck читає PowerPoint (.pptx), OpenDocument (.odp) і Keynote (.key).',
  '{bestand} lijkt beschadigd: het archief kan niet volledig worden uitgepakt.':
      '{bestand} здається пошкодженим: архів не можна повністю розпакувати.',
  'Het {formaat}-formaat wordt nog niet ondersteund ({bestand}).':
      'Формат {formaat} ще не підтримується ({bestand}).',
  'Geen dia’s gevonden in {bestand} — is dit een geldig {formaat}-bestand?':
      'У {bestand} не знайдено слайдів — це дійсний файл {formaat}?',
  'Kon {bestand} niet lezen als {formaat}-presentatie.':
      'Не вдалося прочитати {bestand} як презентацію {formaat}.',
  ...
  'Niet meer tonen': 'Більше не показувати',
  'met verlies': 'із втратами',
  'dia’s': 'слайдів',
  'dia’s vragen aandacht': 'слайдів потребують уваги',
  'Doelmap': 'Цільова тека',
  'Nog geen doelmap gekozen': 'Цільову теку ще не вибрано',
  'Uit de rij halen': 'Прибрати з черги',
  'Stoppen': 'Зупинити',
  'Bezig met importeren…': 'Імпортування…',
  'Resultaat': 'Результат',
  'Opgeslagen in': 'Збережено в',
  'geslaagd': 'успішно',
  'mislukt': 'з помилкою',
  'niet meer aan de beurt gekomen': 'не дійшла черга',
  'Importeren is best-effort en geen één-op-één-kopie: OciDeck heeft een eenvoudiger diamodel dan PowerPoint. Wat niet past, komt op een “niet overgenomen”-notitie te staan; controleer het resultaat na afloop.':
      'Імпорт виконується за можливістю і не є копією один в один: OciDeck має простішу модель слайда, ніж PowerPoint. Те, що не вміщується, потрапляє в нотатку «не перенесено»; перевірте результат після завершення.',
  'Tip: bewaar geïmporteerde presentaties in een aparte map. De kwaliteit verschilt per bron, en zo blijft geïmporteerd materiaal gescheiden van uw eigen werk.':
      'Порада: зберігайте імпортовані презентації в окремій теці. Якість залежить від джерела, і так імпортований матеріал лишається відокремленим від вашої власної роботи.',
  ...
  'Export geblokkeerd door classificatiebeleid: dit deck is {deck}, lager dan het vereiste minimum {limit}.':
      'Експорт заблоковано політикою класифікації: ця презентація — {deck}, нижче необхідного мінімуму {limit}.',
  'Export geblokkeerd door classificatiebeleid: dit deck is {deck}, hoger dan het toegestane vrijgaveniveau {limit}.':
      'Експорт заблоковано політикою класифікації: ця презентація — {deck}, вище дозволеної стелі випуску {limit}.',
  'niet geclassificeerd': 'без класифікації',
  ...
  'Titel van de presentatie': 'Назва презентації',
  ...
  'Het token heeft de repo-scope nodig (of fijnmazig: Contents lezen en schrijven).':
      'Токен потребує область repo (або деталізовано: Contents на читання й запис).',
  ...
  'Deze afbeelding toont minstens één herkenbaar gezicht.':
      'На цьому зображенні видно щонайменше одне впізнаване обличчя.',
  ...
  'Logo tonen': 'Показувати логотип',
  'Footer tonen': 'Показувати нижній колонтитул',
  'Tabel bewerkbaar': 'Таблиця редагована',
  ...
  'Gewaarschuwd': 'З попередженням',
  'Weggelaten': 'Вилучено',
  'Bewerkbaar': 'Редаговане',
  'De privacycontrole': 'Перевірка приватності',
  'OciDeck leest je dia\'s na op gegevens die privacygevoelig kunnen zijn: identificatienummers, contactgegevens, telefoonnummers, bankrekeningen, sleutels en wachtwoorden, en bijzondere persoonsgegevens. Dat gebeurt volledig op dit apparaat: er wordt niets verstuurd, en de gevonden waarde zelf komt in geen enkele melding te staan.':
      'OciDeck переглядає ваші слайди на предмет даних, які можуть бути чутливими: ідентифікаційні номери, контактні дані, номери телефонів, банківські рахунки, ключі та паролі, а також особливі категорії персональних даних. Усе відбувається на цьому пристрої: нічого не надсилається, і знайдене значення не з\'являється в жодному повідомленні.',
  'De controle garandeert niet dat alles wordt gevonden; ze verkleint de kans dat er persoonsgegevens onbedoeld uitlekken.':
      'Перевірка не гарантує, що буде знайдено все; вона зменшує ймовірність ненавмисного витоку персональних даних.',
  'Tekst in afbeeldingen blijft buiten beeld, gelinkte bestanden worden niet geopend, en gegevens zonder herkenbaar patroon herkent geen enkele scanner. Een dia zonder meldingen is een dia waarin wíj niets hebben gevonden, niet een dia waarvan vaststaat dat er niets in staat. Wat je deelt, blijft jouw beslissing en jouw verantwoordelijkheid.':
      'Текст на зображеннях залишається поза увагою, пов\'язані файли не відкриваються, а дані без розпізнаваного шаблону не розпізнає жоден сканер. Слайд без повідомлень — це слайд, на якому *ми* нічого не знайшли, а не слайд, про який доведено, що на ньому нічого немає. Те, чим ви ділитеся, залишається вашим рішенням і вашою відповідальністю.',
  ...
  'Bijzonder persoonsgegeven (AVG art. 9/10)':
      'Особлива категорія персональних даних (GDPR ст. 9/10)',
  'gezondheidsgegeven': 'дані про здоров\'я',
  'strafrechtelijk gegeven': 'дані про судимість',
  'religie of levensovertuiging': 'релігія або переконання',
  'vakbondslidmaatschap': 'членство у профспілці',
  'biometrisch gegeven': 'біометричні дані',
  ...
  'Alle scope-objecten hebben al een checklist':
      'Усі об\'єкти обсягу вже мають контрольний список',
  'Maakt per scope-object een checklist (WSTG voor web/API); bestaande blijven staan.':
      'Створює контрольний список для кожного об\'єкта обсягу (WSTG для web/API); наявні залишаються.',
  ...
  'LibrePlan-connector': 'Конектор LibrePlan',
  'De LibrePlan-connector is alleen beschikbaar in de desktopversie.':
      'Конектор LibrePlan доступний лише в настільній версії.',
  'LibrePlan-connector is optioneel en staat standaard uit. Er wordt niets opgehaald totdat u dit inschakelt en zelf een server configureert. Alleen-lezen: de connector schrijft niets terug naar LibrePlan. Het wachtwoord wordt in de sleutelhanger van uw besturingssysteem opgeslagen, niet in het deck.':
      'Конектор LibrePlan необов’язковий і типово вимкнений. Нічого не завантажується, доки ви його не увімкнете й самі не налаштуєте сервер. Лише для читання: конектор нічого не записує назад до LibrePlan. Пароль зберігається у сховищі ключів вашої операційної системи, а не в deck.',
  'Opgeslagen in de sleutelhanger': 'Збережено у сховищі ключів',
  'Alleen voor servers op het eigen netwerk (LAN). Staat plain-HTTP toe en staat privé-adressen door de NetGuard. Uitgeschakeld: HTTPS verplicht.':
      'Лише для серверів у власній мережі (LAN). Дозволяє звичайний HTTP і пропускає приватні адреси через NetGuard. Вимкнено: HTTPS обов’язковий.',
  'Verbinding succesvol.': 'З’єднання успішне.',
  'Onverwachte fout.': 'Неочікувана помилка.',
  'Importeren uit LibrePlan': 'Імпортувати з LibrePlan',
  'LibrePlan importeren': 'Імпортувати з LibrePlan',
  'Kies welke slides u uit het LibrePlan-project wilt halen. De import is alleen-lezen en schrijft niets terug.':
      'Виберіть, які слайди отримати з проєкту LibrePlan. Імпорт лише для читання й нічого не записує назад.',
  'Gantt-planning': 'Графік Ганта',
  'WBS (hiërarchie)': 'WBS (ієрархія)',
  'Projectstatus (cockpit)': 'Стан проєкту (кокпіт)',
  'Milestones (tijdlijn)': 'Віхи (шкала часу)',
  'Kritieke pad (flow)': 'Критичний шлях (потік)',
  'Resources (tabel)': 'Ресурси (таблиця)',
  'Timesheet (tabel)': 'Табель обліку часу (таблиця)',
