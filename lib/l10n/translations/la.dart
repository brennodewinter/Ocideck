...
const _dutchSourceAddLa = <String, String>{
  ...
  'Aangemaakt op': 'Creatus est',
  'Aanmeldprovider': 'Provisor authenticationis',
  'Aanmeldsessies': 'Registration sessiones',
  'Aantal controles': 'Numerus checks',
  ...
  'Activiteitnummer': 'Actio numerus',
  'Afgerond op': 'rotundato',
  'Afgewezen': 'reprobum',
  'Afspeelsessienummer': 'Playback sessionis numerus',
  'Afwezig': 'Absens',
  'Antwoordgegevens': 'Responde singula',
  'Antwoordstatus': 'Respondeo status',
  'Begint op': 'Incipit on',
  'Begrippen uitgelegd': 'conceptus explicavit',
  'Beheer van de installatie': 'Procuratio institutionis',
  'Beheerpogingen': 'Management nisus',
  'Bekeken lessen': 'Lectiones spectatum',
  'Beleidsversie': 'Consilium versionis',
  'Beoordeeld': 'Ratum',
  'Beoordeeld op': 'Ratum by',
  'Beperking': 'Restrictio',
  'Berekend op': 'Calculus initus est',
  'Bericht': 'Nuntius',
  'Bestandsnaam': 'Filename',
  'Beveiligingsvraagnummer': 'Securitas Quaestio Number',
  'Bevestigd': 'confirmatus',
  'Bevestigd op': 'Confirmatus est',
  'Bewaarregels': 'Retention praecepta',
  'Bewaartermijn': 'Retention tempus',
  'Bewaren wegens een juridische verplichting':
      'Retinuit debitum ad obligationem legalem',
  'Bewerkingnummer bij aanmeldprovider':
      'Operatio numerus in adnotatione provisor',
  'Bewijsstukken': 'Testimonium',
  'Bezwaar': 'Obiectio',
  'Beëindigd op': 'Finivit on',
  'Bijeenkomstnummer': 'Numerus testimonii',
  'Certificaatnummer': 'Numerus certificatorium',
  'Certificaten': 'Testimonia',
  'Controlecode van de PDF': 'Imperium PDF',
  'Controlecode van profielfoto': 'Profile photo tesseram',
  'Controlecodes van bewijsstukken':
      'Imperium codicibus supportandis documentis',
  'Correctie': 'Correctio',
  'Cursistnummer waarop de actie gericht was':
      'Discipulus numerus cui actio intenditur',
  'Cursusaanbodnummer': 'Scilicet numerus offering',
  'Cursusversienummer': 'Scilicet versio numerus',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Dies et tempora monstrantur in tempore locali tuo. Nomina technica conspicua manent cum minister campum ignotum praebet.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'Responsa dedistis ut quaestiones experirentur.',
  'Deelnamenummer': 'Participatio numerus',
  'Deelnames': 'Participationes',
  'Details': 'Singula',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Genus hoc a servo praebitum est. Nomina technica pro inquisitionibus ex vestra ordinatione manent.',
  'Door uzelf aangevraagd': 'Rogatus a te ipso',
  'E-mailadres': 'Inscriptio electronica',
  'E-mailberichten': 'Epistulae electronicae',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'An ID est numerus technicus singularis, qui eLearning utitur ad ligaturam datam simul. Is not a rating or status.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'Categoriae notitiae de eodem argumento. A adnotatione pars una notitia vel eventu servata est.',
  'Eindigt op': 'desinit in',
  'Geaccepteerd op': 'Accepit in',
  'Geannuleerd': 'Pax',
  'Gecontroleerd': 'sedatus',
  'Gecontroleerd op': 'Sedatus est',
  'Geen gegevens gevonden': 'Nulla notitia found',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Informationes de periodis retentio et deletione notitiarum tuarum.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Informationes de documentis suffragantibus, effectis ac testimoniis.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Informationes de petitionibus secretis et informationes tuas spectaverunt vel mutaverunt.',
  'Gegevens over uw accountbewerking':
      'Informationem de ratione vestra operatio',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Informationes de adnotatione, participatione et progressu in lectionibus tuis.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Informationes de profile, ratione ac situ in regimine tuo.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Informationes de momentis experimentis et quaestionibus propositis.',
  'Gegevens over willekeurige volgorde': 'Data ordinis fortuiti',
  'Gegevenscategorie': 'Data categoria',
  'Gekoppeld accountnummer': 'Coniuncta propter numerum',
  'Gekozen antwoorden': 'Electus responsa',
  'Gelukt': 'Success',
  'Geprobeerd op': 'Conatus est',
  'Gerechtvaardigd belang': 'Legitima cura',
  'Gereserveerd': 'ligula',
  'Gereserveerd op': 'ligula on',
  'Geslaagd': 'Transierunt',
  'Gestart op': 'Coepi on',
  'Getoonde tijd per dia in milliseconden':
      'Tempus ostensum est per slide in milliseconds',
  'Herkomst van inschrijving': 'Origo inscriptionis',
  'Hoogst haalbare score': 'Summa score fieri',
  'Identificatienummer bij aanmeldprovider':
      'Lepidium sativum numerum in adnotatione provisor',
  'Identiteitsbewerkingnummer': 'Identity operatio numerus',
  'In afwachting': 'Eviewray',
  'In behandeling': 'In cursu',
  'In behandeling genomen op': 'Processionaliter in',
  'In quarantaine': 'in quarentenam',
  'Ingeleverd': 'summitto',
  'Ingeleverd op': 'in summitto',
  'Ingericht op': 'Ornatus est',
  'Ingeschreven op': 'Relatus on',
  'Ingetrokken': 'abductus',
  'Ingetrokken op': 'abductus est',
  'Inschrijvingen': 'Registrations',
  'Inschrijvingsnummer': 'Registration numerus',
  'Installatiebeveiligingslogboek': 'Installation securitatem iniuriarum',
  'Installatienummer': 'Installation numerus',
  'Installatieverzoeken': 'Installation petitiones',
  'Inzage': 'inspicienda',
  'Ja': 'Ita',
  'Kwalificatienummer': 'Numerus absolute',
  'Kwalificaties': 'industria',
  'Laatst actief op': 'Postremo activus die',
  'Laatst bekeken dia': 'Last visum slide',
  'Laatst gewijzigd op': 'Postremo mutatum die',
  'Laatste fout': 'Last error',
  'Lesnummer': 'Lectio numerus',
  'Lesreserveringen': 'Lectio exceptiones',
  'Lesvoortgang': 'Lectio progressus',
  'Lidmaatschappen': 'Sodalitates',
  'Locatie': 'Locus',
  'Manier van afronden': 'Via flectendis promunturiis',
  'Maximaal aantal controles': 'Maximus numerus checks',
  'Maximaal aantal pogingen': 'Maximum numerum conatusque prohibebit',
  'Maximale leeftijd van de aanmelding': 'Maxime aetate registration',
  'Mislukt': 'Defecit',
  'Naam van de activiteit': 'Nomen de actione',
  'Naam van de bijeenkomst': 'Nomen testimonii',
  'Nee': 'No',
  'Netwerkadres': 'Network inscriptio',
  'Niet actief': 'Non active',
  'Niet geregistreerd': 'Non descripserunt',
  'Niet ingevuld': 'Non Repleti',
  'Niet verschenen': 'Non publicatum',
  'Niveau van extra aanmeldcontrole': 'Gradu additional adnotatione imperium',
  'Nummer van de toetsopzet': 'Numerus test consilium',
  'Nummer van het brongegeven': 'Numerus fons notitia',
  'Nummer van uw verwijderde gegeven': 'Numerus tuorum delevit notitia',
  'Onderdeel {nummer}': 'Pars {nummer}',
  'Onderwerp van de actie': 'Subiecti sunt actiones',
  'Ontvanger': 'Recipient',
  'Opgegeven bestandsgrootte': 'Certa lima amplitudo',
  'Opgegeven bestandstype': 'Certa file type',
  'Opgegeven controlecode': 'Certa potestate codice',
  'Opgeslagen bestandsgrootte': 'Servatum lima amplitudo',
  'Opgeslagen controlecode': 'Repono imperium codice',
  'Organisatienummer': 'Organization numerus',
  'Overdraagbaarheid': 'Transferability',
  'PE-toekenningnummer': 'PE numerus',
  'Poging': 'attentare',
  'Positie': 'Position',
  'Privacyverzoeken': 'Secretum petitiones',
  'Probeer een andere zoekterm.': 'Diversam inquisitionis terminum proba.',
  'Reden': 'ratio',
  'Reden of grondslag': 'Ratio seu basis',
  'Reden van afwijzing': 'Causa rejectionis',
  'Reden van bevestiging': 'Ratio confirmationis',
  'Reden van intrekking': 'Causa detractionis',
  'Reden voor langer bewaren': 'Ratio iam repono',
  'Regels voor de cursusversie': 'Praecepta ad cursum version',
  'Resultaat bij de aanmeldprovider': 'Consequuntur in adnotatione provisor',
  'Rol': 'Roll',
  'Score': 'score',
  'Soort aanwezigheid': 'Genus praesentia',
  'Soort accountbewerking': 'Genus rationis operandi',
  'Soort gebeurtenis': 'Genus res',
  'Soort privacyverzoek': 'Genus secretum petitionem',
  'Status van de bijeenkomst': 'Status testimonii',
  'Strenge beveiligingsmodus': 'Princeps securitatem modus',
  'Technisch toegangslogboek': 'Technical log accessum',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Technica notitia requisita ad adnotationem, securitatem et certas processus.',
  'Technische naam: {naam}': 'Nomen technicum: {naam}',
  'Technische opslagcategorie': 'Categoria technica repono',
  'Technische opslaglocatie van de PDF': 'Repositiones technicae PDF',
  'Tijdstip van aanmelding': 'Tempus registration',
  'Tijdzone': 'Tempus zona',
  'Toestand': 'Conditio',
  'Toetspogingen': 'Test conatusque prohibebit',
  'Toetspogingnummer': 'Test conatus numerus',
  'Uiterste inlevermoment': 'Deadline ad submissionem',
  'Uitgegeven op': 'Publicatum die',
  'Uitgenodigd e-mailadres': 'Invitavit inscriptio electronica',
  'Uitnodigingen': 'Invitationes',
  'Uniek nummer (ID)': 'Numerus singularis (ID)',
  'Uniek verwerkingskenmerk': 'Unique processus pluma',
  'Uw accountnummer': 'Rationem vestram numerus',
  'Uw accountnummer als uitvoerder': 'Rationem vestram numerus exsecutor',
  'Uzelf als uploader': 'Te ipsum ut uploader',
  'Vaardigheidsversienummer': 'Scientia versio numerus',
  'Vast internetadres van de installatie':
      'Certa penitus inscriptio institutionis',
  'Vastgelegde beslisgegevens': 'Memoriae consilium data',
  'Vastgelegde gegevens': 'Memoriae notitia',
  'Vereist niveau van aanmeldzekerheid':
      'Requiritur gradu adnotatione certitudo',
  'Vereiste aanmeldmethoden': 'Requiritur login modi',
  'Verloopt bij inactiviteit op': 'Exspirat cum ullo conatu sedentes',
  'Verloopt definitief op': 'Vivamus in perpetuum',
  'Verloopt op': 'Expirat',
  'Versienummer van de PE-regel': 'Versione numerus PE regulae',
  'Verwerkte verzoeken': 'Processionaliter petitiones',
  'Verwijderd op': 'Remota est',
  'Verwijdering': 'Remotio',
  'Verwijderingsregister': 'Remotio Register',
  'Verwijzing naar het antwoord': 'Ad responsum',
  'Verzoeknummer': 'Request numerus',
  'Verzoeknummer van de app': 'App petitionem numerus',
  'Verzonden op': 'Praemissus',
  'Volgende controle op': 'Next reprehendo sursum',
  'Volgnummer': 'Sequentia numerus',
  'Volgorde van antwoordopties': 'Ordo responsum optiones',
  'Vraagnummer binnen de toetspoging': 'Quaeritur numerus in test conatus',
  'Vraagversienummer': 'Quaestio versionis numerus',
  'Vragen in toetspogingen': 'Quaestiones in test conatusque prohibebit',
  'Vrijgegeven': 'Dimissi',
  'Vrijgegeven op': 'Dimisit on',
  'Wat gebeurt na de bewaartermijn': 'Quid accidit post retentione tempus?',
  'Wettelijke verplichting': 'Obligatio legalis',
  'Wijzigingen aan PE-punten': 'Mutationes ad PE puncta',
  'Wijzigingen aan kwalificaties': 'Mutationes industria',
  'Wijzigingen in aanmeldbeveiliging': 'Mutationes login securitatis',
  'Zekerheid': 'Certum',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Exempli gratia, quaerere cursum, diem vel statum',
  'Zoeken in uw gegevens': 'Quaeres data',
  '{aantal} categorieën gevonden': '{aantal} categoria inventa',
  'Aanwezigheid': 'Praesentia',
  'Lidmaatschap': 'Sodalicium',
  'Inzage en wijzigingen': 'Accessus et mutationes',
  'Beschikbaarheid van het inzagespoor': 'Disponibilitate aditus iniuriarum',
  'Beschikbaar vanaf': 'Praesto ab',
  'Historie vóór deze datum': 'Historia ante hunc diem',
  'Tijdstip': 'Dies et tempus',
  'Handeling': 'Actio',
  'Gegevensonderdeel': 'Data categoria',
  'Handelde als': 'sicut fecerunt',
  'Organisatorische rol': 'Munus organicum',
  'Bekeken': 'Viewed',
  'Gewijzigd': 'mutatus',
  'Uzelf': 'Tu',
  'Medewerker': 'Staff membrum',
  'Systeem': 'Systema',
  'Onbekend': 'Ignota',
  'Docent': 'Instructor',
  'Beoordelaar': 'Assessorem',
  'Organisatiebeheerder': 'Administrator ordinationis',
  'Niet beschikbaar': 'Non praesto',
  'Uitoefening van privacyrechten': 'Exercitium iurium secretorum',
  'Beoordeling en certificering': 'Taxationem et certificationem',
  'Uitvoering van het leertraject': 'Partus studiorum programmata',
  'Cursistenadministratie': 'Discipulus administratione',
  'Cursistprofiel': 'Discentis profile',
  'Leerstatistieken': 'Doctrina mutant',
  'Inschrijving': 'Dilectus',
  'Toetspoging': 'Census conatus',
  'Beoordeling': 'aestimatione',
  'Bewijsstuk': 'Testimonium',
  'Kwalificatie': 'quid',
  'Deelname': 'Participatio',
  'PE-punten': 'Continuing educationem puncta',
  'Certificaat': 'Testimonium',
  'Privacyverzoek': 'Secretum petitionem',
  'Bewaard tot': 'retinuit usque ad',
  'Bekijk mijn gegevens': 'Data mea inspicere',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Vide quae data eLearning de te descripserit.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Haec conspectus die {datum} directe ab eLearning receptus est neque ab OciDeck servatur.',
  'Geen gegevens geregistreerd': 'Nulla data descripta',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'Omnia genera continet quae servus huic ordinationi praebuit. De finibus, accipientibus, origine, temporibus retentionis aliisve iuribus tuis privatis, {organisatie} consule.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Data tua onerari non potuerunt. Iterum tenta.',
  'Meer tonen ({aantal} resterend)': 'Plura ostendere ({aantal} restant)',
  'Mijn gegevens': 'Data mea',
  'Privacy-inzage': 'Accessus ad data privata',
  'Uw geregistreerde gegevens': 'Data tua descripta',
  'uw organisatie': 'ordinatio tua',
  '{aantal} registraties': '{aantal} inscriptiones',
  'Volg opleidingen uit uw eLearning-omgeving. Cursusbestanden openen alleen in afspeelmodus; voortgang wordt alleen na aanmelden gesynchroniseerd.':
      'Cursos ex ambitu tuo eLearning sequere. Fasciculi cursus solum modo agendi aperiuntur; progressus solum post accessum synchronizatur.',
  'eLearning-aanmelding is alleen beschikbaar in de desktop-app, omdat de webversie geen veilige sleutelbos heeft.':
      'Accessus eLearning solum in applicatione escritorio praesto est, quod versio interretialis claviarium securum non habet.',
  'eLearning-server': 'Servus eLearning',
  'Bij het volgen van een cursus stuurt OciDeck uw laatste dia, voltooiing en getoonde tijd per dia naar de gekozen eLearning-organisatie. Antwoorden, notities en cursusinhoud worden niet als voortgang verstuurd.':
      'Cum cursum sequeris, OciDeck ultimam paginam, perfectionem et tempus ostensum pro pagina ad electam ordinationem eLearning mittit. Responsa, adnotationes et cursus contentum ut progressus non mittuntur.',
  'Ingelogd bij eLearning': 'Ad eLearning accessit',
  'Deze eLearning-server gebruikt {host} voor het aanmelden. Er worden pas gegevens met die identiteitsprovider uitgewisseld nadat u dit toestaat.':
      'Hic servus eLearning {host} ad accessum utitur. Data cum illo identitatis provisore non commutantur nisi postquam id permiseris.',
  'Gebruik een HTTPS-adres voor eLearning.':
      'Inscriptione HTTPS pro eLearning utere.',
  'Vul een geldig eLearning-adres in.':
      'Inscriptionem eLearning validam insere.',
  ...
  'Een Word-document (.docx) dat opent in Word, Pages en LibreOffice. Bewerkbaar, met native voetnoten en koppen als outline. Mermaid-diagrammen worden als hoogwaardige afbeeldingen ingebed.':
      'Documentum Word (.docx) quod aperitur in Word, Pages et LibreOffice. Mutabile, cum notis pedum nativis et titulis ut schema. Mermaid diagrammata insita sunt ut imagines altae qualitatis.',
  ...
  'Het bestand is gewijzigd door een ander programma.':
      'File ab alio programma mutatum est.',
  'Herladen': 'Recarica',
  ...
  'Thema documentband': 'Caput et calx paginae thematis',
  ...
  'Organisaties vergelijken': 'Instituta comparare',
  ...
  'Fractioneel (2^(k−p))': 'Fractionalis (2^(k−p))',
  'Fractie p': 'Fractio p',
  'runs in standaard Yates-volgorde': 'prove in ordine Yates standard',
  'In raster zetten': 'In craticulam ponere',
  ...
  'De browser blokkeert media van een externe bron. Open deze presentatie in de app om online media te tonen.':
      'Navigatrum media ex fonte externo obstruit. Hanc praesentationem in applicatione aperi ut media online ostendantur.',
  ...
  'Het volledige EIS-schema (88 toetsbare eisen).':
      'Schema EIS plenum (88 postulata probabilia).',
  'Aandoeningsnamen in negen talen als gezondheidslexicon voor de privacycontrole (assets/privacy/health_lexicon.json).':
      'Nomina morborum novem linguis ut lexicon sanitatis ad privatam inspectionem (assets/privacy/health_lexicon.json).',
  'Een eigen Dart-implementatie van de publieke specificatie, inclusief de MacroVector-tabel en de gepubliceerde bandindeling.':
      'Nostra in Dart exsecutio specificationis publicae, cum tabula MacroVector et fasciis gravitatis editis.',
  'Specificatie van FIRST.Org — attributie':
      'Specificatio FIRST.Org — attributio',
  'Ctrl/Cmd': 'Ctrl/Cmd',
  'Shift': 'Shift',
  ...
  'Het token heeft de repo-scope nodig (of fijnmazig: Contents lezen en schrijven).':
      'Signum ambitum repo requirit (vel subtiliter: Contents legere et scribere).',
  ...
  'LibrePlan-connector': 'Coniunctio LibrePlan',
  'De LibrePlan-connector is alleen beschikbaar in de desktopversie.':
      'Coniunctio LibrePlan tantum in versione desktop praesto est.',
  'LibrePlan-connector is optioneel en staat standaard uit. Er wordt niets opgehaald totdat u dit inschakelt en zelf een server configureert. Alleen-lezen: de connector schrijft niets terug naar LibrePlan. Het wachtwoord wordt in de sleutelhanger van uw besturingssysteem opgeslagen, niet in het deck.':
      'Coniunctio LibrePlan optionalis est et implicite inactiva. Nihil accersitur donec eam actives et ipse servitorem constituas. Tantum legendum: coniunctio nihil in LibrePlan rescribit. Tessera in claviario systematis tui conditur, non in deck.',
  'Opgeslagen in de sleutelhanger': 'In claviario conditum',
  'Alleen voor servers op het eigen netwerk (LAN). Staat plain-HTTP toe en staat privé-adressen door de NetGuard. Uitgeschakeld: HTTPS verplicht.':
      'Tantum pro servitoribus in rete proprio (LAN). HTTP simplex permittit et inscriptiones privatas per NetGuard transire sinit. Inactivum: HTTPS requiritur.',
  'Verbinding succesvol.': 'Coniunctio successit.',
  'Onverwachte fout.': 'Error inopinatus.',
  'Importeren uit LibrePlan': 'Ex LibrePlan importare',
  'LibrePlan importeren': 'Ex LibrePlan importare',
  'Kies welke slides u uit het LibrePlan-project wilt halen. De import is alleen-lezen en schrijft niets terug.':
      'Elige quas paginas ex proiecto LibrePlan accersere velis. Importatio tantum legenda est et nihil rescribit.',
  'Gantt-planning': 'Ordinatio Gantt',
  'WBS (hiërarchie)': 'WBS (hierarchia)',
  'Projectstatus (cockpit)': 'Status incepti (gubernaculum)',
  'Milestones (tijdlijn)': 'Lapides miliarii (temporum linea)',
  'Kritieke pad (flow)': 'Via critica (fluxus)',
  'Resources (tabel)': 'Opes (tabula)',
  'Timesheet (tabel)': 'Ratio horarum (tabula)',
  'Resourcebelasting (grafiek)': 'Onus opum (diagramma)',
  'Ophalen uit LibrePlan…': 'Ex LibrePlan accersitur…',
  ...
  'Vul server-URL en gebruikersnaam in.':
      'URL servitoris et nomen usoris insere.',
  'https://libreplan.example.org/libreplan/':
      'https://libreplan.example.org/libreplan/',
  'wsreader': 'wsreader',
  'Centreren': 'Centrare',
  'Getalnotatie': 'Forma numerorum',
  'Kolom naar links': 'Columnam ad sinistram movere',
  'Kolom naar rechts': 'Columnam ad dextram movere',
