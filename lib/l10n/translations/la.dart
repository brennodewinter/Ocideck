...
const _dutchSourceAddLa = <String, String>{
  'OciDeck mag uw microfoon of camera niet gebruiken. Geef toestemming in uw browser of systeeminstellingen en probeer het opnieuw.':
      'OciDeck microphonio vel camera tua uti non licet. Permissionem in navigatro vel in optionibus systematis da et iterum conare.',
  'Er is geen werkende microfoon gevonden. Sluit er een aan of kies een ander apparaat.':
      'Nullum microphonium operans inventum est. Unum adiunge vel aliud instrumentum elige.',
  'Er is geen werkende camera gevonden. U kunt zonder beeld meedoen.':
      'Nulla camera operans inventa est. Sine imagine interesse potes.',
  'De dienst die het toegangsbewijs afgeeft is onbereikbaar. Probeer het later opnieuw; uw presentatie blijft ondertussen gewoon open.':
      'Servitium quod tesseram aditus dat attingi non potest. Postea iterum conare; interea praesentatio tua simpliciter aperta manet.',
  'De dienst die het toegangsbewijs afgeeft heeft zijn grens voor nu bereikt. Probeer het later opnieuw.':
      'Servitium quod tesseram aditus dat modum suum in praesens attigit. Postea iterum conare.',
  'Het toegangsbewijs voor deze vergadering is verlopen. Doe opnieuw mee met dezelfde link.':
      'Tessera aditus huius conventus exspiravit. Eodem nexu iterum intra.',
  'Het netwerk laat deze vergadering niet door. Op een bedrijfsnetwerk blokkeert een firewall of proxy dit soort verkeer vaak; een andere verbinding lukt meestal wel.':
      'Rete hunc conventum non transmittit. In rete societatis murus ignis vel procurator tale commercium saepe impedit; alia conexio plerumque valet.',
  'Deze vergadering is voorbij.': 'Hic conventus praeteriit.',
  'De vergaderdienst is zelf niet beschikbaar. Dit ligt niet aan uw verbinding; probeer het later opnieuw.':
      'Ipsum servitium conventuum non praesto est. Hoc non ex conexione tua est; postea iterum conare.',
  'Meedoen is niet gelukt, en de dienst zegt niet waarom. De technische code staat bij de details — probeer het opnieuw, en geef die code door als het blijft misgaan.':
      'Interesse non successit, neque servitium cur dicit. Codex technicus inter particularia est — iterum conare et illum codicem trade, si res male ire perget.',
  'Dit is geen bruikbare vergaderlink. Kopieer hem opnieuw uit de uitnodiging — een link die door een chatprogramma is afgekapt of aangepast, doet het vaak niet meer.':
      'Hic nexus conventus utilis non est. Eum ex invitatione iterum exscribe — nexus a programmate colloquendi truncatus vel mutatus saepe non iam valet.',
  'Deze dienst kennen we, maar dit soort vergadering niet. Webinars, uitzendingen en persoonlijke vergaderkamers werken anders dan een gewone vergadering; open deze link in de browser.':
      'Hoc servitium novimus, sed hoc genus conventus non. Seminaria interretialia, emissiones et cubicula conventuum propria aliter quam conventus communis operantur; hunc nexum in navigatro aperi.',
  'Deze vergaderdienst kennen we niet. OciDeck weet dus ook niet wat er achter deze link zit; u kunt hem in uw browser openen als u de afzender vertrouwt.':
      'Hoc servitium conventuum non novimus. OciDeck igitur nescit quid post hunc nexum lateat; eum in navigatro tuo aperire potes, si mittenti credis.',
  'Meedoen kan op deze uitvoering van OciDeck niet. Gebruik de webversie in uw browser.':
      'In hac forma OciDeck interesse non licet. Forma interretiali in navigatro tuo utere.',
  'Deze browser mist iets wat voor meedoen nodig is. Een recente Chrome, Edge, Firefox of Safari lukt doorgaans wel.':
      'Huic navigatro deest aliquid quod ad interessendum necessarium est. Chrome, Edge, Firefox vel Safari recens plerumque valet.',
  'De organisatie van deze vergadering laat geen gasten zonder account toe. Vraag de organisator om u uit te nodigen op een manier die gasten toestaat.':
      'Institutum huius conventus hospites sine ratione non admittit. Ordinatorem roga ut te eo modo invitet qui hospites admittit.',
  'Meedoen aan deze vergadering vereist een account bij de aanbieder. Open de link in uw browser en meld u daar aan.':
      'Ut huic conventui intersis, ratione apud praebitorem opus est. Nexum in navigatro tuo aperi et ibi te inscribe.',
  'Deze aanbieder laat alleen goedgekeurde programma\'s meedoen, en die goedkeuring is er voor OciDeck nog niet. Open de vergadering in uw browser.':
      'Hic praebitor sola programmata approbata interesse sinit, quae approbatio OciDeck adhuc deest. Conventum in navigatro tuo aperi.',
  'De organisator heeft u niet toegelaten. Vraag of hij u binnenlaat en probeer het daarna opnieuw.':
      'Ordinator te non admisit. Roga ut te intromittat et postea iterum conare.',
  'Deze vergadering is op slot; er komt niemand meer bij. Vraag de organisator om het slot eraf te halen.':
      'Hic conventus clausus est; nemo amplius accedit. Ordinatorem roga ut claustrum removeat.',
  'Deze vergadering is eind-tot-eind versleuteld en laat daarom geen externe deelnemers toe. Dat is een keuze van de organisator; vraag hem om een gewone vergadering als u erbij moet zijn.':
      'Hic conventus a fine ad finem cifratus est ideoque participes externos non admittit. Id ordinator elegit; eum de conventu communi roga, si adesse debes.',
  '{plek} krijgt contact zodra u meedoet.':
      '{plek} contingetur simul atque intereris.',
  'U doet mee met alleen de naam die u zelf opgeeft; u bent niet aangemeld als die persoon.':
      'Solo nomine quod ipse indicas interes; non ut ea persona inscriptus es.',
  'De dienst maakt een tijdelijke gastidentiteit voor u, die na de vergadering verdwijnt.':
      'Servitium identitatem hospitis temporariam tibi creat, quae post conventum evanescit.',
  'U doet mee als gast onder een dienstaccount van een organisatie.':
      'Ut hospes per rationem servitii instituti interes.',
  'De organisator heeft een identiteit voor u klaargezet.':
      'Ordinator identitatem tibi paravit.',
  'Meedoen gaat met uw eigen account bij deze aanbieder.':
      'Ratione tua apud hunc praebitorem interes.',
  'De aanbieder ziet uw netwerkgegevens en het beeld en geluid dat u verstuurt. Wat u deelt, deelt u met alle deelnemers.':
      'Praebitor data retis tui videt et imaginem sonumque quae mittis. Quod communicas, cum omnibus participibus communicas.',
  'Het verkeer is versleuteld naar de dienst toe; de dienst zelf kan meekijken.':
      'Commeatus ad servitium cifratus est; servitium ipsum inspicere potest.',
  'De aanbieder beheert de versleuteling en dus ook de sleutels.':
      'Praebitor cifrationem administrat ideoque etiam claves.',
  'De aanbieder beschrijft dit als eind-tot-eind versleuteld.':
      'Praebitor hoc ut a fine ad finem cifratum describit.',
  'Over de versleuteling is niets vastgesteld. OciDeck belooft daar dus niets over.':
      'De cifratione nihil constitutum est. OciDeck igitur nihil de ea promittit.',
  'U komt eerst in een wachtruimte: een organisator moet u toelaten. Uw presentatie blijft ondertussen gewoon te bewerken.':
      'Primum in vestibulum venis: ordinator te admittere debet. Interea praesentationem tuam mutare pergere potes.',
  'Deze vergadering vraagt om een wachtwoord.':
      'Hic conventus tesseram poscit.',
  'Deze vergadering vraagt om aanmelding vooraf.':
      'Hic conventus inscriptionem ante actam poscit.',
  'Vergadering wordt voorbereid': 'Conventus paratur',
  'Verbinden met de vergadering': 'Cum conventu conectitur',
  'Wachten op toelating door de organisator':
      'Exspectatur admissio ab ordinatore',
  'U doet mee aan de vergadering': 'Conventui interes',
  'De verbinding is weggevallen — opnieuw verbinden':
      'Conexio interrupta est — iterum conectitur',
  'De vergadering wordt verlaten': 'E conventu disceditur',
  'De vergadering is beëindigd': 'Conventus finitus est',
  'Meedoen is niet gelukt': 'Interesse non successit',
  'Deze vergadering wordt opgenomen.': 'Hic conventus registratur.',
  'Deze vergadering wordt uitgeschreven.':
      'Hic conventus in scriptum vertitur.',
  'Deze vergadering wordt opgenomen en uitgeschreven.':
      'Hic conventus registratur et in scriptum vertitur.',
  'De vergadering vraagt uw uitdrukkelijke toestemming om mee te blijven doen.':
      'Conventus consensum tuum expressum petit ut interesse pergas.',
  'Een organisator moet u nog toelaten. U kunt gewoon doorwerken; zodra u binnen bent, opent het gespreksvenster zich.':
      'Ordinator te adhuc admittere debet. Interim opus tuum tranquille pergere potes; simul atque intus eris, fenestra colloquii aperietur.',
  'Herkend als een vergadering bij {plek}.':
      'Ut conventus apud {plek} agnitus.',
  '{uitleg} De link wijst naar {plek}.': '{uitleg} Nexus ad {plek} spectat.',
  'Deze naam kiest u zelf; niemand controleert hem. De anderen zien u als gast.':
      'Hoc nomen ipse eligis; nemo id probat. Ceteri te ut hospitem vident.',
  'Afsluiten': 'Concludere',
  'Camera aanzetten': 'Cameram accendere',
  'Camera uitzetten': 'Cameram exstinguere',
  'Microfoon aanzetten': 'Microphonium accendere',
  'Microfoon dempen': 'Microphonium exstinguere',
  'Presentatie delen': 'Praesentationem communicare',
  'Delen stoppen': 'Communicationem sistere',
  'Gespreksvenster': 'Fenestra colloquii',
  'Venster sluiten': 'Fenestram claudere',
  'Meedoen': 'Interesse',
  'Meedoen aan een onlinevergadering': 'Conventui interretiali interesse',
  'Onlinevergadering': 'Conventus interretialis',
  'Onlinevergadering…': 'Conventus interretialis…',
  'Vergaderlink': 'Nexus conventus',
  'Plak hier de link uit de uitnodiging': 'Nexum ex invitatione hic insere',
  'Uw naam, zoals de anderen die zien': 'Nomen tuum, ut ceteri id vident',
  'Wat er gebeurt als u meedoet': 'Quid fiat si intersis',
  'Verlaten': 'Discedere',
  'Weigeren en verlaten': 'Recusare et discedere',
  'Toestemming geven': 'Consensum dare',
  'Technische code: {code}': 'Codex technicus: {code}',
  'Deelnemers ({aantal})': 'Participes ({aantal})',
  'Nog geen deelnemers.': 'Nulli adhuc participes.',
  'Deze vergadering geeft geen deelnemerslijst.':
      'Hic conventus indicem participum non praebet.',
  'gast': 'hospes',
  'deelnemer': 'particeps',
  'presentator': 'praesentator',
  'moderator': 'temperator',
  'organisator': 'ordinator',
  'rol onbekend': 'munus ignotum',
  'Bord': 'Tabula',
