...
const _dutchSourceEn = {
  ...
  'Auditdossier geëxporteerd naar:': 'Audit dossier exported to:',
  'MIAUW-pentestrapport': 'MIAUW pentest report',
  'Volledige MIAUW-rapportstructuur: documentbeheer, scope, executie, managementsamenvatting, bevindingen, checklists en ondertekening.':
      'Full MIAUW report structure: document control, scope, execution, management summary, findings, checklists and sign-off.',
  'Tekst voorstellen (AI)': 'Suggest text (AI)',
  'Het model gaf geen tekst terug.': 'The model returned no text.',
  'Er staat al tekst. Vervangen door het AI-concept?':
      'There is already text. Replace it with the AI draft?',
  ...
  'Scope-dekking controleren': 'Check scope coverage',
  'Scope-dekking': 'Scope coverage',
  'Geen dekkingsgaten': 'No coverage gaps',
  'In scope, maar niet getest en geen bevinding:':
      'In scope, but not tested and no finding:',
  ...
  'Detailslide toevoegen': 'Add detail slide',
  'Bewijsslide toevoegen': 'Add evidence slide',
  'CIA-gewogen': 'CIA-weighted',
  'Severity (bevindingen)': 'Severity (findings)',
  'CWE kiezen': 'Choose CWE',
  'Zoek op naam of CWE-nummer': 'Search by name or CWE number',
  'Geen CWE gevonden': 'No CWE found',
  'Kies CWE…': 'Choose CWE…',
  'AI-concept': 'AI draft',
  'Nagekeken': 'Reviewed',
  ...
  'Er staat al alt-tekst. Vervangen door het AI-concept?':
      'There is already alt text. Replace it with the AI draft?',
  'Vervangen': 'Replace',
  'AI-assistentie is niet beschikbaar. Controleer de instellingen.':
      'AI assistance is unavailable. Check the settings.',
  'De AI-aanroep is mislukt (model niet geladen of server onbereikbaar).':
      'The AI request failed (model not loaded or server unreachable).',
  'Bezig met AI-analyse…': 'Analysing with AI…',
  'Stel alt-tekst voor (AI)': 'Suggest alt text (AI)',
  ...
  'Mogelijke impact': 'Possible impact',
  'Aanbeveling': 'Recommendation',
  'Bevinding-id': 'Finding ID',
  'Controleer de CVSS-vector': 'Check the CVSS vector',
  'Notitie': 'Note',
  'Status': 'Status',
  'getoetst': 'tested',
  'Test toevoegen': 'Add test',
  'Test verwijderen': 'Remove test',
  'Niet getoetst': 'Not tested',
  'Getoetst': 'Tested',
  'Afwijking': 'Anomaly',
  'Niet toetsbaar': 'Not testable',
  'Object': 'Object',
  'gedekt': 'covered',
  ...
  'Bewaar dit wachtwoord goed: raak je het kwijt, dan is dit pakket niet meer te openen.':
      'Keep this password safe: if you lose it, this package can no longer be opened.',
  'Dit pakket is met een wachtwoord beveiligd. Voer het wachtwoord in om het te openen.':
      'This package is password-protected. Enter the password to open it.',
  'Dit pakket is versleuteld; er kon niet om een wachtwoord worden gevraagd.':
      'This package is encrypted; a password could not be requested.',
  'Exporteren': 'Export',
  'Genereer sterk wachtwoord': 'Generate strong password',
  'Maak het langer voor betere bescherming.':
      'Make it longer for better protection.',
  'Onjuist wachtwoord. Probeer het opnieuw.': 'Incorrect password. Try again.',
  'Ontgrendelen': 'Unlock',
  'Optioneel. Alleen wie het wachtwoord heeft, kan het pakket openen.':
      'Optional. Only someone who has the password can open the package.',
  'Redelijk': 'Fair',
  'Sterk': 'Strong',
  ...
  'Online openen': 'Open online',
  'Dit document kon niet worden geladen.': 'This document could not be loaded.',
  'Kwaliteit': 'Quality',
...
const _dutchSourceAddEn = {
  ...
  'OciDeck vraagt dan maximaal eenmaal per dag aan pawprint.vigilis.online of er een nieuwere versie is.':
      'OciDeck then asks pawprint.vigilis.online at most once a day whether a newer version exists.',
  'Controleer nu': 'Check now',
  'De controle is mislukt — probeer het later opnieuw.':
      'The check failed — please try again later.',
  'Er is geen nieuwere versie.': 'There is no newer version.',
  'OciDeck {versie} is beschikbaar.': 'OciDeck {versie} is available.',
  'Download': 'Download',
  'OciDeck {versie} is beschikbaar — tik om de releasepagina te openen.':
      'OciDeck {versie} is available — tap to open the release page.',
  ...
  'PDF/A en digitale handtekeningen blijven zichtbaar. OciDeck controleert de handtekening niet.':
      'PDF/A and digital signatures remain visible. OciDeck does not validate the signature.',
  'Logo niet importeren': 'Do not import logo',
  'Logo gevonden': 'Logo found',
  'Dit logo komt ook voor in de stijl {naam}.':
      'This logo also appears in the {naam} style.',
  'Als afbeelding behouden': 'Keep as image',
  'bovenaan': 'at the top',
  'onderaan': 'at the bottom',
  'Is dit een logo?': 'Is this a logo?',
  'Deze afbeelding staat op {n} dia’s {plaats}. OciDeck kan hem als vast logo gebruiken in plaats van als dia-afbeelding.':
      'This image appears {plaats} on {n} slides. OciDeck can use it as a fixed logo instead of a slide image.',
  'Mogelijk logo': 'Possible logo',
  'Geen logo': 'Not a logo',
  'Ja, als logo gebruiken': 'Yes, use as logo',
  'Ook als stijl toevoegen?': 'Also add as a style?',
  'Je kunt de kleuren, het lettertype en dit logo bewaren voor volgende presentaties.':
      'You can save the colours, font and this logo for future presentations.',
  'Naam van de stijl': 'Style name',
  'Alleen in deze presentatie': 'Only in this presentation',
  'Stijl toevoegen': 'Add style',
  ...
  'Aanmeldprovider': 'Login provider',
  'Aanmeldsessies': 'Registration sessions',
  'Aantal controles': 'Number of checks',
  ...
  'Afgerond op': 'Rounded to',
  'Afgewezen': 'Rejected',
  'Afspeelsessienummer': 'Playback session number',
  'Afwezig': 'Absent',
  'Antwoordgegevens': 'Answer details',
  'Antwoordstatus': 'Reply status',
  'Begint op': 'Starts on',
  'Begrippen uitgelegd': 'Concepts explained',
  'Beheer van de installatie': 'Management of the installation',
  'Beheerpogingen': 'Management efforts',
  'Bekeken lessen': 'Lessons viewed',
  'Beleidsversie': 'Policy version',
  'Beoordeeld': 'Rated',
  'Beoordeeld op': 'Rated by',
  'Beperking': 'Restriction',
  'Berekend op': 'Calculated on',
  'Bericht': 'Message',
  'Bestandsnaam': 'Filename',
  'Beveiligingsvraagnummer': 'Security Question Number',
  'Bevestigd': 'Confirmed',
  'Bevestigd op': 'Confirmed on',
  'Bewaarregels': 'Retention rules',
  'Bewaartermijn': 'Retention period',
  'Bewaren wegens een juridische verplichting':
      'Retained due to a legal obligation',
  'Bewerkingnummer bij aanmeldprovider':
      'Operation number at registration provider',
  'Bewijsstukken': 'Evidence',
  'Bezwaar': 'Objection',
  'Beëindigd op': 'Ended on',
  'Bijeenkomstnummer': 'Meeting number',
  'Certificaatnummer': 'Certificate number',
  'Certificaten': 'Certificates',
  'Controlecode van de PDF': 'Control code of the PDF',
  'Controlecode van profielfoto': 'Profile photo verification code',
  'Controlecodes van bewijsstukken': 'Control codes of supporting documents',
  'Correctie': 'Correction',
  'Cursistnummer waarop de actie gericht was':
      'Student number to which the action was aimed',
  'Cursusaanbodnummer': 'Course offering number',
  'Cursusversienummer': 'Course version number',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Dates and times are shown in your local time. Technical names remain visible when the server provides an unknown field.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'The answers you gave to test questions.',
  'Deelnamenummer': 'Participation number',
  ...
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'This category was provided by the server. The technical names remain visible for inquiries from your organization.',
  'Door uzelf aangevraagd': 'Requested by yourself',
  ...
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'An ID is a unique technical number that eLearning uses to link data together. It is not a rating or status.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'A category groups data on the same topic. A registration is one saved piece of data or one event.',
  'Eindigt op': 'Ends in',
  'Geaccepteerd op': 'Accepted on',
  'Geannuleerd': 'Canceled',
  'Gecontroleerd': 'Checked',
  'Gecontroleerd op': 'Checked on',
  'Geen gegevens gevonden': 'No data found',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Information about retention periods and the deletion of your data.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Information about supporting documents, results achieved and certificates.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Information about privacy requests and who viewed or changed your information.',
  'Gegevens over uw accountbewerking':
      'Information about your account operation',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Information about your registration, participation and progress in lessons.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Information about your profile, account and position within the organization.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Information about your test moments and the questions presented.',
  'Gegevens over willekeurige volgorde': 'Random order data',
  'Gegevenscategorie': 'Data category',
  'Gekoppeld accountnummer': 'Linked account number',
  'Gekozen antwoorden': 'Selected answers',
  'Gelukt': 'Success',
  'Geprobeerd op': 'Tried on',
  'Gerechtvaardigd belang': 'Legitimate interest',
  'Gereserveerd': 'Reserved',
  'Gereserveerd op': 'Reserved on',
  'Geslaagd': 'Passed',
  'Gestart op': 'Started on',
  'Getoonde tijd per dia in milliseconden':
      'Time shown per slide in milliseconds',
  'Herkomst van inschrijving': 'Origin of registration',
  'Hoogst haalbare score': 'Highest possible score',
  'Identificatienummer bij aanmeldprovider':
      'Identification number for registration provider',
  'Identiteitsbewerkingnummer': 'Identity operation number',
  'In afwachting': 'Pending',
  'In behandeling': 'In progress',
  'In behandeling genomen op': 'Processed on',
  'In quarantaine': 'In quarantine',
  'Ingeleverd': 'Submitted',
  'Ingeleverd op': 'Submitted on',
  'Ingericht op': 'Decorated on',
  'Ingeschreven op': 'Registered on',
  'Ingetrokken': 'Withdrawn',
  'Ingetrokken op': 'Withdrawn on',
  'Inschrijvingen': 'Registrations',
  'Inschrijvingsnummer': 'Registration number',
  'Installatiebeveiligingslogboek': 'Installation security log',
  'Installatienummer': 'Installation number',
  'Installatieverzoeken': 'Installation requests',
  'Inzage': 'Inspection',
  'Ja': 'Yes',
  'Kwalificatienummer': 'Qualification number',
  'Kwalificaties': 'Qualifications',
  'Laatst actief op': 'Last active on',
  'Laatst bekeken dia': 'Last viewed slide',
  'Laatst gewijzigd op': 'Last modified on',
  'Laatste fout': 'Last mistake',
  'Lesnummer': 'Lesson number',
  'Lesreserveringen': 'Lesson reservations',
  'Lesvoortgang': 'Lesson progress',
  'Lidmaatschappen': 'Memberships',
  'Locatie': 'Location',
  'Manier van afronden': 'Way of rounding',
  'Maximaal aantal controles': 'Maximum number of checks',
  'Maximaal aantal pogingen': 'Maximum number of attempts',
  'Maximale leeftijd van de aanmelding': 'Maximum age of registration',
  'Mislukt': 'Failed',
  'Naam van de activiteit': 'Name of the activity',
  'Naam van de bijeenkomst': 'Name of the meeting',
  'Nee': 'No',
  'Netwerkadres': 'Network address',
  'Niet actief': 'Not active',
  'Niet geregistreerd': 'Not registered',
  'Niet ingevuld': 'Not filled in',
  'Niet verschenen': 'Not published',
  'Niveau van extra aanmeldcontrole':
      'Level of additional registration control',
  'Nummer van de toetsopzet': 'Number of the test plan',
  'Nummer van het brongegeven': 'Number of the source data',
  'Nummer van uw verwijderde gegeven': 'Number of your deleted data',
  'Onderdeel {nummer}': 'Part {nummer}',
  'Onderwerp van de actie': 'Subject of the action',
  'Ontvanger': 'Recipient',
  'Opgegeven bestandsgrootte': 'Specified file size',
  'Opgegeven bestandstype': 'Specified file type',
  'Opgegeven controlecode': 'Specified control code',
  'Opgeslagen bestandsgrootte': 'Saved file size',
  'Opgeslagen controlecode': 'Stored control code',
  'Organisatienummer': 'Organization number',
  'Overdraagbaarheid': 'Transferability',
  'PE-toekenningnummer': 'PE award number',
  'Poging': 'Attempt',
  'Positie': 'Position',
  'Privacyverzoeken': 'Privacy requests',
  'Probeer een andere zoekterm.': 'Try a different search term.',
  'Reden': 'Reason',
  'Reden of grondslag': 'Reason or basis',
  'Reden van afwijzing': 'Reason for rejection',
  'Reden van bevestiging': 'Reason for confirmation',
  'Reden van intrekking': 'Reason for withdrawal',
  'Reden voor langer bewaren': 'Reason for longer storage',
  'Regels voor de cursusversie': 'Rules for the course version',
  'Resultaat bij de aanmeldprovider': 'Result at the registration provider',
  'Rol': 'Roll',
  'Score': 'Score',
  'Soort aanwezigheid': 'Kind of presence',
  'Soort accountbewerking': 'Type of account operation',
  'Soort gebeurtenis': 'Type of event',
  'Soort privacyverzoek': 'Type of privacy request',
  'Status van de bijeenkomst': 'Status of the meeting',
  'Strenge beveiligingsmodus': 'High security mode',
  'Technisch toegangslogboek': 'Technical access log',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Technical data required for registration, security and reliable processing.',
  'Technische naam: {naam}': 'Technical name: {naam}',
  'Technische opslagcategorie': 'Technical storage category',
  'Technische opslaglocatie van de PDF':
      'Technical storage location of the PDF',
  'Tijdstip van aanmelding': 'Time of registration',
  'Tijdzone': 'Time zone',
  'Toestand': 'Condition',
  'Toetspogingen': 'Test attempts',
  'Toetspogingnummer': 'Test attempt number',
  'Uiterste inlevermoment': 'Deadline for submission',
  'Uitgegeven op': 'Published on',
  'Uitgenodigd e-mailadres': 'Invited email address',
  'Uitnodigingen': 'Invitations',
  'Uniek nummer (ID)': 'Unique number (ID)',
  'Uniek verwerkingskenmerk': 'Unique processing feature',
  'Uw accountnummer': 'Your account number',
  'Uw accountnummer als uitvoerder': 'Your account number as executor',
  'Uzelf als uploader': 'Yourself as an uploader',
  'Vaardigheidsversienummer': 'Skill version number',
  'Vast internetadres van de installatie':
      'Fixed internet address of the installation',
  'Vastgelegde beslisgegevens': 'Recorded decision data',
  'Vastgelegde gegevens': 'Recorded data',
  'Vereist niveau van aanmeldzekerheid':
      'Required level of registration certainty',
  'Vereiste aanmeldmethoden': 'Required login methods',
  'Verloopt bij inactiviteit op': 'Expires when inactive',
  'Verloopt definitief op': 'Expires permanently',
  'Verloopt op': 'Expires',
  'Versienummer van de PE-regel': 'Version number of the PE rule',
  'Verwerkte verzoeken': 'Processed requests',
  'Verwijderd op': 'Removed on',
  'Verwijdering': 'Removal',
  'Verwijderingsregister': 'Removal Register',
  'Verwijzing naar het antwoord': 'Reference to the answer',
  'Verzoeknummer': 'Request number',
  'Verzoeknummer van de app': 'App request number',
  'Verzonden op': 'Sent on',
  'Volgende controle op': 'Next check up',
  'Volgnummer': 'Sequence number',
  'Volgorde van antwoordopties': 'Order of answer options',
  'Vraagnummer binnen de toetspoging':
      'Question number within the test attempt',
  'Vraagversienummer': 'Question version number',
  'Vragen in toetspogingen': 'Questions in test attempts',
  'Vrijgegeven': 'Released',
  'Vrijgegeven op': 'Released on',
  'Wat gebeurt na de bewaartermijn': 'What happens after the retention period',
  'Wettelijke verplichting': 'Legal obligation',
  'Wijzigingen aan PE-punten': 'Changes to PE points',
  'Wijzigingen aan kwalificaties': 'Changes to qualifications',
  'Wijzigingen in aanmeldbeveiliging': 'Changes to login security',
  'Zekerheid': 'Certainty',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'For example, search by course, date or status',
  'Zoeken in uw gegevens': 'Search your data',
  '{aantal} categorieën gevonden': '{aantal} categories found',
  'Aanwezigheid': 'Attendance',
  'Lidmaatschap': 'Membership',
  'Inzage en wijzigingen': 'Access and changes',
  'Beschikbaarheid van het inzagespoor': 'Availability of the access log',
  'Beschikbaar vanaf': 'Available from',
  'Historie vóór deze datum': 'History before this date',
  'Tijdstip': 'Date and time',
  'Handeling': 'Action',
  'Gegevensonderdeel': 'Data category',
  'Handelde als': 'Acted as',
  'Organisatorische rol': 'Organizational role',
  'Bekeken': 'Viewed',
  'Gewijzigd': 'Changed',
  'Uzelf': 'You',
  ...
  'Organisatiebeheerder': 'Organization administrator',
  'Niet beschikbaar': 'Not available',
  'Uitoefening van privacyrechten': 'Exercise of privacy rights',
  'Beoordeling en certificering': 'Assessment and certification',
  'Uitvoering van het leertraject': 'Delivery of the learning program',
  'Cursistenadministratie': 'Learner administration',
  'Cursistprofiel': 'Learner profile',
  'Leerstatistieken': 'Learning statistics',
  'Inschrijving': 'Enrollment',
  'Toetspoging': 'Assessment attempt',
  'Beoordeling': 'Assessment',
  'Bewijsstuk': 'Evidence',
  'Kwalificatie': 'Qualification',
  'Deelname': 'Participation',
  'PE-punten': 'Continuing education points',
  'Certificaat': 'Certificate',
  'Privacyverzoek': 'Privacy request',
  'Bewaard tot': 'Retained until',
  'Bekijk mijn gegevens': 'View my data',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'See what data eLearning has recorded about you.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'This overview was retrieved directly from eLearning on {datum} and is not stored by OciDeck.',
  'Geen gegevens geregistreerd': 'No data recorded',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'It contains every category supplied by the server for this organization. For information about purposes, recipients, sources, retention periods, or your other privacy rights, contact {organisatie}.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Could not load your data. Try again.',
  'Meer tonen ({aantal} resterend)': 'Show more ({aantal} remaining)',
  'Mijn gegevens': 'My data',
  'Privacy-inzage': 'Privacy data access',
  'Uw geregistreerde gegevens': 'Your recorded data',
  'uw organisatie': 'your organization',
  '{aantal} registraties': '{aantal} records',
  ...
  'Deze organisatie bevat te veel lessen om veilig te tonen.':
      'This organization contains too many lessons to display safely.',
  'Er wacht nog voortgang op synchronisatie.':
      'Progress is still waiting to be synchronized.',
  'Met deze keuze wordt het vernieuwtoken in de sleutelbos bewaard. Een versleutelde wachtrij voor nog niet verstuurde voortgang wordt daar los van bewaard.':
      'With this choice, the refresh token is stored in the keychain. An encrypted queue for progress not yet sent is stored separately from it.',
  'Nog niet verstuurde voortgang is op dit apparaat bewaard.':
      'Progress not yet sent has been saved on this device.',
  'Cursist': 'Learner',
  'Les afgerond': 'Lesson completed',
  'Cursussen voor u': 'Courses for you',
  'Ga verder waar u gebleven was, of kies een andere cursus die voor u klaarstaat.':
      'Continue where you left off, or choose another course that is ready for you.',
  'Klaar om te beginnen': 'Ready to begin',
  'Mijn cursussen': 'My courses',
  'Mijn leeromgeving': 'My learning environment',
  'Mooi gedaan! Uw voortgang is bewaard.':
      'Well done! Your progress has been saved.',
  'Nu bezig': 'In progress',
  'Opnieuw starten': 'Start again',
  'Terug naar mijn cursussen': 'Back to my courses',
  'U kunt deze cursus opnieuw bekijken.': 'You can review this course again.',
  'Volgende: {les}': 'Next: {les}',
  'Welkom, {naam}': 'Welcome, {naam}',
  ...
  '{afgerond} van {totaal} lessen afgerond':
      '{afgerond} of {totaal} lessons completed',
  'Uitloggen': 'Sign out',
  ...
  'Doorlopende tekst, pagina\'s, exporteren naar PDF of Word':
      'Continuous text, pages, export to PDF or Word',
  'Uiterlijk van de app': 'App appearance',
  'Uiterlijk van dia\'s': 'Slide appearance',
  'Privacy en classificatie': 'Privacy and classification',
  'Uiterlijk van documenten': 'Document appearance',
  'Exportkwaliteit': 'Export quality',
  'Geef eerst toestemming voor uitgaand verkeer bij Privacy en classificatie.':
      'First grant consent for outbound traffic under Privacy and classification.',
  'Een clouddienst vereist eerst je privacytoestemming bij "Privacy en classificatie" en werkt niet in de webversie.':
      'A cloud service first requires your privacy consent under "Privacy and classification" and does not work in the web version.',
  'Deze instellingen bepalen wat OciDeck vanaf het internet mag laden en welke sporen op dit apparaat achterblijven. Ze staan los van je privacyverklaring en toestemming, die je bij "Privacy en classificatie" vindt.':
      'These settings determine what OciDeck may load from the internet and what traces are left behind on this device. They are separate from your privacy statement and consent, which you can find under "Privacy and classification".',
  'Dit bestand is elders gewijzigd': 'This file has been modified elsewhere',
  'Het bestand op schijf is veranderd sinds je het opende — waarschijnlijk in een ander venster of door een ander programma. Overschrijven gooit die wijzigingen weg.':
      'The file on disk has changed since you opened it — probably in another window or by another program. Overwriting discards those changes.',
  ...
  '{n} tabellen passen niet op de bladbreedte, ook niet op de kleinste letter.':
      '{n} tables do not fit the page width, not even at the smallest type size.',
  'Lange woorden en waarden zoals hashes of IP-adressen zijn daardoor middenin afgebroken.':
      'Long words and values such as hashes or IP addresses have therefore been broken mid-token.',
  ...
  'Thema documentband': 'Theme document header/footer',
  ...
  'Een veldwaarde mag maximaal 4096 tekens bevatten.':
      'A field value may contain at most 4096 characters.',
  'Gebruik {naam} in de kop- of voettekst.':
      'Use {naam} in the header or footer.',
  'Naam is ongeldig, gereserveerd of niet uniek.':
      'The name is invalid, reserved, or not unique.',
  ...
  'Dit bestand is {grootte} groot. Dat is meer dan de aanbevolen limiet van {limiet}. Importeren kan traag zijn en veel geheugen vragen — op een kleiner apparaat kan de app vastlopen.':
      'This file is {grootte} in size. That is more than the recommended limit of {limiet}. Importing may be slow and use a lot of memory — on a smaller device the app may freeze.',
  'Toch importeren': 'Import anyway',
  'Koptekst': 'Header',
  ...
  'Sluit één of meer OpenKAT-omgevingen aan (bijvoorbeeld productie en acceptatie). OciDeck toont beschikbare rapportages; de inhoud haalt u binnen via een JSON-export uit OpenKAT.':
      'Connect one or more OpenKAT environments (for example production and staging). OciDeck shows available reports; you import the content via a JSON export from OpenKAT.',
  'Server toevoegen…': 'Add server…',
  'Rapportage van server…': 'Report from server…',
  'Nog geen OpenKAT-server aangesloten.': 'No OpenKAT server connected yet.',
  'Bezig…': 'Working…',
  'OpenKAT-server bewerken': 'Edit OpenKAT server',
  'OpenKAT-server toevoegen': 'Add OpenKAT server',
  'OpenKAT-server toevoegen…': 'Add OpenKAT server…',
  'OpenKAT-server verwijderen?': 'Remove OpenKAT server?',
  'Dit verwijdert “{name}” en het bijbehorende toegangstoken van dit apparaat. Dat kunt u niet ongedaan maken.':
      'This removes “{name}” and its access token from this device. You cannot undo this.',
  'Weergavenaam': 'Display name',
  'Bijvoorbeeld Productie of Acceptatie': 'For example Production or Staging',
  'Adres van OpenKAT': 'OpenKAT address',
  'Verbinding met: {host}': 'Connecting to: {host}',
  'Eigen netwerk (LAN)': 'Local network (LAN)',
  'Alleen voor OpenKAT op het eigen netwerk. Staat HTTP toe en laat privé-adressen toe. Uitgeschakeld: alleen HTTPS.':
      'Only for OpenKAT on your local network. Allows HTTP and private addresses. When off: HTTPS only.',
  'Toegangstoken': 'Access token',
  'Laat leeg om het opgeslagen token te behouden':
      'Leave blank to keep the saved token',
  'Plak het token hier': 'Paste the token here',
  'Vraag uw OpenKAT-beheerder om een API-token in het beheerdersscherm. Het token blijft op dit apparaat, in de sleutelhanger van uw besturingssysteem — niet in het deck.':
      'Ask your OpenKAT administrator for an API token in the admin screen. The token stays on this device, in your operating system\'s keychain — not in the deck.',
  'Verbinding wordt getest…': 'Testing connection…',
  'Test de verbinding voordat u opslaat, zodat u weet dat naam, adres en token kloppen.':
      'Test the connection before saving, so you know the name, address, and token are correct.',
  'De OpenKAT-koppeling is alleen beschikbaar in de desktopversie.':
      'The OpenKAT connection is only available in the desktop version.',
  'Lees OpenKAT-rapportages in als één managementoverzicht — vanuit een map of vanaf een server.':
      'Import OpenKAT reports as one management overview — from a folder or from a server.',
  'Er staat al een OpenKAT-bron ingesteld; de koppeling blijft daarom bereikbaar, zodat een bestaand OpenKAT-deck bij te werken blijft.':
      'An OpenKAT source is already configured; the connection stays available so you can keep updating an existing OpenKAT deck.',
  'Rapportage van OpenKAT-server': 'Report from OpenKAT server',
  'Rapportage van OpenKAT-server…': 'Report from OpenKAT server…',
  'Server: {name}': 'Server: {name}',
  'Organisaties worden opgehaald…': 'Fetching organizations…',
  'Rapportages worden opgehaald…': 'Fetching reports…',
  'Er zijn geen organisaties zichtbaar voor dit token. Vraag uw beheerder om toegang, of kies een andere server.':
      'No organizations are visible for this token. Ask your administrator for access, or choose another server.',
  'Er staan geen organisatierapportages klaar op deze server. Maak in OpenKAT eerst een aggregaat-organisatierapport, of kies een andere organisatie.':
      'No organization reports are ready on this server. Create an aggregate organization report in OpenKAT first, or choose another organization.',
  'JSON-export uit OpenKAT': 'JSON export from OpenKAT',
  'OpenKAT levert de rapportage-inhoud als JSON-bestand. Exporteer in OpenKAT het gekozen rapport als JSON, en wijs dat bestand of de map hieraan.':
      'OpenKAT provides report content as a JSON file. Export the chosen report as JSON in OpenKAT, then point to that file or folder here.',
  'Gekozen: {reportName} · {orgName} · {serverName}':
      'Selected: {reportName} · {orgName} · {serverName}',
  'JSON-bestand kiezen…': 'Choose JSON file…',
  'Map met exports kiezen…': 'Choose export folder…',
  'Vul een weergavenaam in, bijvoorbeeld Productie.':
      'Enter a display name, for example Production.',
  'Vul een weergavenaam en een adres in.':
      'Enter a display name and an address.',
  'Plak een toegangstoken om verder te gaan.':
      'Paste an access token to continue.',
  'Vul een adres in, bijvoorbeeld https://openkat.voorbeeld.nl':
      'Enter an address, for example https://openkat.voorbeeld.nl',
  'Dit adres is niet geldig. Controleer of u een volledige URL heeft ingevuld.':
      'This address is not valid. Check that you entered a complete URL.',
  'Het adres moet met https:// beginnen, of zet Eigen netwerk aan voor HTTP op het eigen netwerk.':
      'The address must start with https://, or turn on Local network for HTTP on your local network.',
  'Verbonden met {host}. Er zijn nog geen organisaties zichtbaar voor dit token.':
      'Connected to {host}. No organizations are visible for this token yet.',
  'Verbonden met {host}. {n} organisatie(s) bereikbaar.':
      'Connected to {host}. {n} organization(s) reachable.',
  'De verbinding met OpenKAT is mislukt. Controleer het adres en uw netwerk, en probeer opnieuw.':
      'The connection to OpenKAT failed. Check the address and your network, then try again.',
  'Er is geen toegangstoken. Plak het token van uw beheerder en probeer opnieuw.':
      'No access token. Paste the token from your administrator and try again.',
  'Alleen HTTPS is toegestaan, tenzij Eigen netwerk aan staat.':
      'Only HTTPS is allowed unless Local network is on.',
  'OpenKAT weigerde het token. Vraag uw beheerder om een geldig API-token en plak het opnieuw.':
      'OpenKAT rejected the token. Ask your administrator for a valid API token and paste it again.',
  'OpenKAT reageerde niet op tijd. Controleer of de server bereikbaar is en probeer opnieuw.':
      'OpenKAT did not respond in time. Check that the server is reachable and try again.',
  'Dit adres is niet bereikbaar. Controleer de spelling van de hostnaam en of u op het juiste netwerk zit.':
      'This address is not reachable. Check the hostname spelling and that you are on the correct network.',
  'OpenKAT gaf een onverwacht groot antwoord. Probeer later opnieuw of vraag uw beheerder om hulp.':
      'OpenKAT returned an unexpectedly large response. Try again later or ask your administrator for help.',
  'Verbonden': 'Connected',
  'Token ontbreekt': 'Token missing',
  'Laatst gecontroleerd mislukt': 'Last check failed',
  'Nog niet gecontroleerd': 'Not checked yet',
  'Zoekveld wissen': 'Clear search field',
  'Gantt': 'Gantt',
  'Dag': 'Day',
  'Week': 'Week',
  'Maand': 'Month',
  ...
  'De privacyscan vond mogelijk persoonsgegevens in de sessie-data. De export redigeert deze automatisch; klik op een bevinding voor de details.':
      'The privacy scan may have found personal data in the session data. The export redacts it automatically; click a finding for the details.',
  'Tijdens het presenteren heb je checklists ingevuld en tabellen bijgewerkt op {aantal} dia’s.':
      'While presenting you filled in checklists and updated tables on {aantal} slides.',
  'en nog {aantal} dia’s.': 'and {aantal} more slides.',
  'Sessie-wijzigingen bewaren?': 'Save session changes?',
  'In deck behouden': 'Keep in deck',
  'Downloaden als losse bestanden': 'Download as separate files',
  'Map voor sessie-bestanden kiezen': 'Choose folder for session files',
  ...
  'Dit is een presentatie, geen Markdown-bestand. Zet de module Importeren aan om hem om te zetten naar een deck.':
      'This is a presentation, not a Markdown file. Turn on the Import module to convert it into a deck.',
  'De zwakhedenlijst (78): id, titel, MASVS-categorie, platform, de CWE-koppeling en een korte omschrijving. Plus een brug van de oude beta-nummering (tot 0119) naar de canonieke id\'s, zodat de MASTG-kruiskoppeling blijft kloppen.':
      'The weaknesses list (78): id, title, MASVS category, platform, the CWE link and a short description. Plus a bridge from the old beta numbering (up to 0119) to the canonical ids, so the MASTG cross-reference keeps matching.',
  ...
  'Media-stack testen': 'Test media stack',
  'De media-stack werkt op dit apparaat.':
      'The media stack works on this device.',
  'De media-stack kon niet laden op dit apparaat.':
      'The media stack could not load on this device.',
  'Media-versleuteling (E2EE): uit op dit platform.':
      'Media encryption (E2EE): off on this platform.',
  'Media-versleuteling (E2EE): nog niet beschikbaar.':
      'Media encryption (E2EE): not yet available.',
  'Media-versleuteling (E2EE): aan.': 'Media encryption (E2EE): on.',
  'Conferentie-URL (optioneel): toont de OciDeck-companion-kamer':
      'Conference URL (optional): shows the OciDeck companion room',
  'Companion-kamer': 'Companion room',
  ...
  'Markeer alle juiste antwoorden. Bij presenteren worden alle antwoorden in willekeurige volgorde getoond.':
      'Mark all correct answers. When presenting, all answers are shown in random order.',
  'Markeer de goede antwoorden. Bij presenteren wordt één goed antwoord met een willekeurige greep uit de foute antwoorden getoond.':
      'Mark the correct answers. When presenting, one correct answer is shown with a random selection of incorrect answers.',
  ...
  'Procesverbetering: Kaizen-project': 'Process improvement: Kaizen project',
  'Compact verbeterproject met Plan-, Do- en Check-fases.':
      'Compact improvement project with Plan, Do and Check phases.',
  'Procesverbetering: A3-project': 'Process improvement: A3 project',
  'A3-skelet voor probleem, analyse en verbeteracties.':
      'A3 skeleton for problem, analysis and improvement actions.',
  ...
  'Authentieke cockpit': 'Authentic cockpit',
  'Klassiek': 'Classic',
  'Bord': 'Board',
  ...
  'Laat zien waar de meeste en minste findings zijn gevonden; ontbrekende metingen staan apart.':
      'Shows where the most and fewest findings were found; missing measurements are listed separately.',
  'Laat zien hoe aantallen findings veranderden en welke organisaties daaraan bijdroegen.':
      'Shows how finding counts changed and which organizations contributed to them.',
  'Laat zien welke soorten problemen bij de meeste organisaties en systemen voorkomen.':
      'Shows which types of problems occur in the most organizations and systems.',
  'Laat per organisatie zien hoeveel findings critical of high zijn.':
      'Shows the number of critical or high findings for each organization.',
  'Laat per control zien welk deel voldoet, maar alleen als het totaal bekend is.':
      'Shows the compliant share for each control, but only when the total is known.',
  'Bundelt de aanbevelingen uit OpenKAT zonder er zelf prioriteit aan te geven.':
      'Groups recommendations from OpenKAT without assigning its own priority.',
  'Laat zien welke findings nieuw, terug of niet meer gezien zijn.':
      'Shows which findings are new, reobserved, or no longer observed.',
  'Laat zien welke findings het langst openstaan als de begindatum bekend is.':
      'Shows which findings have been open the longest when the start date is known.',
  'Laat zien op welke systemen de meeste en ernstigste findings staan.':
      'Shows which systems have the most and most severe findings.',
  'Laat per systeem zien of het aantal findings steeg of daalde.':
      'Shows whether the number of findings increased or decreased for each system.',
  'Vergelijkt controls alleen als beide metingen dezelfde reikwijdte hebben.':
      'Compares controls only when both measurements have the same scope.',
  'Geeft de systemen, hostnamen en IP-adressen uit de gekozen meting weer.':
      'Lists the systems, hostnames, and IP addresses from the selected measurement.',
  'Laat alleen monitoringveranderingen zien die de bron bewijst.':
      'Shows only monitoring changes supported by the source.',
  'Laat zien bij welke organisaties en systemen deze CVE is aangetroffen.':
      'Shows the organizations and systems where this CVE was found.',
  'Laat zien welke CVE’s bij de meeste organisaties en systemen voorkomen.':
      'Shows which CVEs occur in the most organizations and systems.',
  'Laat zien welke CVE’s nieuw, terug of niet meer gezien zijn.':
      'Shows which CVEs are new, reobserved, or no longer observed.',
  'Toont de gebruikte meetdatums, bronbestanden en technische bronkenmerken.':
      'Shows the measurement dates, source files, and technical source properties used.',
  'Vergelijk organisaties en breng portfolio-aandachtspunten in beeld.':
      'Compare organizations and identify portfolio points of interest.',
  'Bekijk de actuele stand of aantoonbare veranderingen bij één organisatie.':
      'View the current status or demonstrable changes at one organization.',
  'Onderzoek betrouwbare CVE-koppelingen in de gekozen metingen.':
      'Investigate reliable CVE links in the chosen measurements.',
  'Leg vast welke metingen en bronbestanden het rapport werkelijk gebruikt.':
      'Record which measurements and source files the report actually uses.',
  'Wat is het managementbeeld over de gekozen organisaties?':
      'What is the management view of the chosen organizations?',
  'Waar worden de meeste en minste findings waargenomen?':
      'Where are the most and least findings observed?',
  'Hoe ontwikkelt het portfolio zich over de tijd?':
      'How does the portfolio develop over time?',
  'Welke problemen komen bij de meeste organisaties voor?':
      'What problems occur in most organizations?',
  'Waar concentreren de ernstigste findings zich?':
      'Where are the most serious findings concentrated?',
  'Welke controls lopen achter?': 'Which controls are lagging behind?',
  'Welke maatregelen adviseert OpenKAT het vaakst?':
      'Which measures does OpenKAT recommend most often?',
  'Hoe staat deze organisatie er nu voor?':
      'What is the current status of this organization?',
  ...
  'Welke findings zijn nieuw of niet meer waargenomen?':
      'Which findings are new or no longer observed?',
  ...
  'Op welke systemen worden de meeste findings waargenomen?':
      'On which systems are the most findings observed?',
  'Welke systemen verbeterden of verslechterden?':
      'Which systems improved or deteriorated?',
  'Welke controls verbeterden of verslechterden?':
      'Which controls improved or deteriorated?',
  'Welke systemen zijn in de metingen opgenomen?':
      'Which systems are included in the measurements?',
  'Welke assets zijn aantoonbaar in monitoring?':
      'Which assets are demonstrable in monitoring?',
  'Welke monitoringstatussen veranderden?':
      'Which monitoring statuses changed?',
  'Wie is geraakt door deze CVE?': 'Who is affected by this CVE?',
  'Welke CVE’s raken de meeste organisaties?':
      'Which CVEs affect most organizations?',
  'Welke CVE’s zijn nieuw of niet meer waargenomen?':
      'Which CVEs are new or no longer observed?',
  'Welke meetgegevens ontbreken of zijn verouderd?':
      'Which measurement data is missing or outdated?',
  ...
  'Een gericht actueel beeld van één organisatie en haar meetdatum.':
      'A targeted current image of one organization and its measurement date.',
  'Vergelijkt twee gekozen meetmomenten binnen één organisatie.':
      'Compares two chosen measurement moments within one organization.',
  'Scheidt gemonitord, niet gemonitord en onbekend.':
      'Separates monitored, unmonitored and unknown.',
  'Toont ontbrekende, verouderde en werkelijk gebruikte metingen.':
      'Shows missing, outdated and actually used measurements.',
  'Nog niet beschikbaar: de bron bewijst geen monitoringstatus voor alle assets.':
      'Not yet available: the source does not prove monitoring status for all assets.',
  'Nog niet beschikbaar: niet iedere finding heeft een betrouwbare eerste waarnemingsdatum.':
      'Not yet available: not every finding has a reliable first observation date.',
  'Nog niet beschikbaar: de bron bewijst geen stabiele identiteit voor alle findings.':
      'Not yet available: the source does not prove a stable identity for all findings.',
  'Nog niet beschikbaar: vergelijkbare meetdekking is niet aangetoond.':
      'Not yet available: comparable measurement coverage has not been demonstrated.',
  'Nog niet beschikbaar: betrouwbare controlnoemers ontbreken.':
      'Not yet available: reliable control denominators are missing.',
  'Nog niet beschikbaar: stabiele assetidentiteit is niet aangetoond.':
      'Not yet available: stable asset identity has not been demonstrated.',
  'Dit rapport ondersteunt de gekozen organisatiescope niet.':
      'This report does not support the chosen organizational scope.',
  'De gekozen bron bevat niet genoeg betrouwbare gegevens voor dit rapport.':
      'The selected source does not contain enough reliable data for this report.',
  'Kerncijfers en gemeten bereik': 'Key figures and measured reach',
  'Organisaties vergelijken': 'Compare organizations',
  'Concentratie van critical/high findings':
      'Concentration of critical/high findings',
  'Portfolioverloop per meetmoment':
      'Portfolio overview per measurement moment',
  'Meest voorkomende findingtypen': 'Most common finding types',
  'Bron- en meetverantwoording': 'Source and measurement accountability',
  'Nieuwe en niet meer waargenomen findings':
      'New and no longer observed findings',
  'Langst waargenomen findings': 'Longest observed findings',
  'Systemen met de meeste findings': 'Systems with the most findings',
  'Veranderingen per systeem': 'Changes per system',
  'Blootstelling aan één CVE': 'Exposure to one CVE',
  'CVE’s over organisaties': 'CVEs about organizations',
  'Nieuwe en niet meer waargenomen CVE’s': 'New and no longer observed CVEs',
  'Controldekking': 'Control coverage',
  'Controlveranderingen': 'Control changes',
  'Aanbevelingen uit OpenKAT': 'Recommendations from OpenKAT',
  'Assetinventaris': 'Asset inventory',
  'Monitoringdekking': 'Monitoring coverage',
  'Actueel organisatiebeeld': 'Current organizational picture',
  'Kies eerst het onderwerp en daarna de vraag die het rapport moet beantwoorden.':
      'First choose the topic and then the question that the report should answer.',
  'Onderwerp': 'Subject',
  'Welk rapport beantwoordt uw vraag?': 'Which report answers your question?',
  'Meer rapportvragen': 'More report questions',
  'Kwetsbare systemen': 'Vulnerable systems',
  ...
  'Chirurgische veiligheidscheck (WHO)': 'Surgical safety checklist (WHO)',
  'Verpleegkundige dienstoverdracht': 'Nursing shift handover',
  'Inwerkplan (30-60-90 dagen)': 'Onboarding plan (30-60-90 days)',
  'Eerste dag / introductie': 'First day / induction',
  'Buddy- / mentorafspraak': 'Buddy / mentor plan',
  'Uitdiensttreding / offboarding': 'Offboarding / exit',
  'IMSAFE fit-to-fly-check': 'IMSAFE fitness-to-fly check',
  'Crew- / departurebriefing': 'Crew / departure briefing',
  'Voorvalmelding (just culture)': 'Occurrence report (just culture)',
  'Toolbox / LMRA veiligheidscheck': 'Toolbox talk / last-minute risk analysis',
  'Evenement- en crowd-safetybriefing': 'Event & crowd-safety briefing',
  'Ontruimings- en BHV-oefening': 'Evacuation & first-response drill',
  'Werkvergunning (permit to work)': 'Permit to work',
  'METHANE grootschalig-incidentmelding': 'METHANE major-incident report',
  'GRIP-opschaling': 'GRIP escalation',
  'Maritieme passage-/brugbriefing': 'Bridge passage briefing',
  'Draag een patiënt of situatie gestructureerd over: Situatie, Achtergrond, Beoordeling en Aanbeveling.':
      'Hand over a patient or situation with Situation, Background, Assessment and Recommendation.',
  'Prehospitale overdracht naar de SEH met leeftijd, mechanisme, letsels, symptomen en behandeling.':
      'Prehospital handover to the ED with age, mechanism, injuries, signs and treatment.',
  'Bespreek een casus met alle disciplines: beeld, behandeldoel, besluiten en afspraken.':
      'Discuss a case across disciplines: picture, treatment goal, decisions and actions.',
  'Sign in, time-out en sign out rond een ingreep volgens de WHO-checklist.':
      'Sign in, time-out and sign out around a procedure following the WHO checklist.',
  'Draag de zorg per patiënt over: toestand, aandachtspunten en openstaande taken.':
      'Hand over care per patient: condition, watch points and open tasks.',
  'Zet verwachtingen, mijlpalen en begeleiding uit over de eerste 30, 60 en 90 dagen.':
      'Lay out expectations, milestones and support across the first 30, 60 and 90 days.',
  'Mensen, systemen, huisregels en de veiligheids- en privacybasis voor een nieuwe medewerker.':
      'People, systems, house rules and the safety and privacy basics for a new hire.',
  'Doelen, ritme en checkpoints tussen nieuwkomer en buddy of mentor.':
      'Goals, cadence and checkpoints between a newcomer and their buddy or mentor.',
  'Kennisoverdracht, intrekken van toegang en een net exitgesprek bij vertrek.':
      'Knowledge transfer, revoking access and a proper exit interview when someone leaves.',
  'Persoonlijke go/no-go: ziekte, medicatie, stress, alcohol, vermoeidheid en gemoed.':
      'Personal go/no-go: illness, medication, stress, alcohol, fatigue and emotion.',
  'Taakverdeling, bedreigingen en fouten (TEM) en afwijkingen vóór vertrek met de bemanning.':
      'Task division, threats and errors (TEM) and deviations before departure with the crew.',
  'Meld een voorval feitelijk en zonder schuldvraag: wat, factoren, risico en verbetering.':
      'Report an occurrence factually and blame-free: what, factors, risk and improvement.',
  'Taak, gevaren, maatregelen en akkoord vlak voordat het werk begint.':
      'Task, hazards, controls and sign-off just before the work starts.',
  'Capaciteit, risico\'s, in- en uitstroom en incidentrollen voor een evenement.':
      'Capacity, risks, crowd flow and incident roles for an event.',
  'Scenario, taken, verzamelplaats, waarnemingen en evaluatie van een ontruiming.':
      'Scenario, tasks, assembly point, observations and evaluation of an evacuation.',
  'Werk, isolaties, controles en vrijgave voor risicovol werk vastleggen.':
      'Record work, isolations, checks and authorisation for high-risk work.',
  'Eerste melding bij een groot incident: melding, locatie, type, gevaren, toegang, aantal en diensten.':
      'First report at a major incident: major incident, exact location, type, hazards, access, number and services.',
  ...
  'Deck opbouwen…': 'Building deck…',
  'Dia bevat meerdere audiofragmenten; OciDeck ondersteunt er maar één per dia.':
      'Slide contains multiple audio clips; OciDeck supports only one per slide.',
  'Dia bevat meerdere grafieken; OciDeck ondersteunt er maar één per dia.':
      'Slide contains multiple charts; OciDeck supports only one per slide.',
  'Dia bevat meerdere tabellen; OciDeck ondersteunt er maar één per dia.':
      'Slide contains multiple tables; OciDeck supports only one per slide.',
  'Dia bevat meerdere video\'s; OciDeck ondersteunt er maar één per dia.':
      'Slide contains multiple videos; OciDeck supports only one per slide.',
  'Dia {n} overgeslagen': 'Slide {n} skipped',
  'Dia {n}: alleen de afbeelding overgenomen': 'Slide {n}: only the image kept',
  'Een niet-tekstuele vorm, lijn of ander object kon niet worden omgezet.':
      'A non-textual shape, line or other object could not be converted.',
  'Footerrijen worden in Markdown niet ondersteund.':
      'Footer rows are not supported in Markdown.',
  'Formaat herkennen…': 'Detecting format…',
  'Gegroepeerde objecten zijn uitgeklapt; groepering en volgorde binnen de groep gaan verloren.':
      'Grouped objects have been ungrouped; grouping and order within the group are lost.',
  'Groepering': 'Grouping',
  'Headerkolommen worden in OciDeck niet ondersteund.':
      'Header columns are not supported in OciDeck.',
  'IWA-objecten inlezen…': 'Reading IWA objects…',
  'IWA-structuur gedeeltelijk geparseerd — de vormgeving (thema, kleuren, posities) is niet overgenomen; tekst, slide-volgorde, notities en, waar de structuren herkend werden, tabellen, grafieken en media wel':
      'IWA structure partially parsed — the styling (theme, colours, positions) was not carried over; text, slide order, notes and, where the structures were recognised, tables, charts and media were.',
  'IWA-structuur niet volledig geparseerd — opmaak, tabellen, grafieken, media en slide-volgorde niet overgenomen':
      'IWA structure not fully parsed — formatting, tables, charts, media and slide order not carried over',
  'IWA-tekst salvage…': 'Salvaging IWA text…',
  'Keynote IWA-intern': 'Keynote IWA internal',
  'Keynote IWA-intern (~{n} dia’s)': 'Keynote IWA internal (~{n} slides)',
  'Keynote tabel footer': 'Keynote table footer',
  'Keynote tabel header': 'Keynote table header',
  'Keynote tabel headerkolommen': 'Keynote table header columns',
  'Klaar.': 'Done.',
  'Koppeling “{tekst}”': 'Link "{tekst}"',
  'Meerdere audio': 'Multiple audio',
  'Meerdere grafieken': 'Multiple charts',
  'Meerdere headerrijen worden in Markdown niet ondersteund; alleen de eerste rij wordt als tabelheader gebruikt.':
      'Multiple header rows are not supported in Markdown; only the first row is used as the table header.',
  'Meerdere tabellen': 'Multiple tables',
  'Meerdere video\'s': 'Multiple videos',
  'Metadata uitlezen…': 'Reading metadata…',
  'Niet overgenomen van dit document': 'Not carried over from this document',
  'Niet overgenomen van slide {n}': 'Not carried over from slide {n}',
  'Ondersteund grafiektype': 'Supported chart type',
  'Samengevoegde cellen': 'Merged cells',
  'Samengevoegde tabelcellen worden in GFM-tabellen niet ondersteund; de tabel is platgeklapt.':
      'Merged table cells are not supported in GFM tables; the table has been flattened.',
  'Scatter x-as': 'Scatter x-axis',
  'Scatter-grafiek met aparte x-waardes per serie kan niet volledig worden weergegeven.':
      'A scatter chart with separate x-values per series cannot be fully represented.',
  'Slides classificeren…': 'Classifying slides…',
  'Slides reconstrueren…': 'Reconstructing slides…',
  'Tabel naast grafiek': 'Table alongside chart',
  'Voorbeeldafbeelding zoeken…': 'Looking for preview image…',
  'Vorm of object': 'Shape or object',
  'de tekst blijft staan, de verwijzing niet':
      'the text remains, the reference does not',
  'deels overgenomen': 'partly carried over',
  'doel onschadelijk gemaakt; het wees naar {url}':
      'target neutralised; it pointed to {url}',
  'eerste audio overgenomen': 'first audio kept',
  'eerste grafiek overgenomen': 'first chart kept',
  'eerste rij als header': 'first row as header',
  'eerste tabel overgenomen': 'first table kept',
  'eerste video overgenomen': 'first video kept',
  'gedeelde x-as gebruikt': 'shared x-axis used',
  'niet overgenomen (OciDeck heeft geen audio-slides)':
      'not carried over (OciDeck has no audio slides)',
  'niet overgenomen (deze dia werd een {type})':
      'not carried over (this slide became a {type})',
  'niet overgenomen (deze dia werd een {type}, en die draagt geen opsomming)':
      'not carried over (this slide became a {type}, which carries no bullet list)',
  'niet overgenomen (een {type}-dia toont er {aantal})':
      'not carried over (a {type} slide shows {aantal})',
  'niet overgenomen (een {type}-dia toont geen losse alineatekst)':
      'not carried over (a {type} slide shows no loose paragraph text)',
  'niet overgenomen (één grafiek of tabel per slide)':
      'not carried over (one chart or table per slide)',
  'objecten apart overgenomen': 'objects carried over separately',
  'samengevoegd in leesvolgorde': 'merged in reading order',
  'tekst, volgorde, notities en herkende tabellen, grafieken en media':
      'text, order, notes and recognised tables, charts and media',
  '{n} afbeelding': '{n} image',
  '{n} afbeeldingen': '{n} images',
  '{n} alinea’s': '{n} paragraphs',
  '{n} opsommingspunt': '{n} bullet point',
  '{n} opsommingspunten': '{n} bullet points',
  '{n} vrij geplaatste tekstvakken': '{n} freely placed text boxes',
  'voorbeeldafbeelding en tekst': 'preview image and text',
  'voorbeeldafbeelding': 'preview image',
  'tekst': 'text',
  '{bestand} is groter dan de limiet van {limiet} en wordt niet geïmporteerd.':
      '{bestand} is larger than the {limiet} limit and will not be imported.',
  '{bestand} is geen herkende presentatie. OciDeck leest PowerPoint (.pptx), OpenDocument (.odp) en Keynote (.key).':
      '{bestand} is not a recognised presentation. OciDeck reads PowerPoint (.pptx), OpenDocument (.odp) and Keynote (.key).',
  '{bestand} lijkt beschadigd: het archief kan niet volledig worden uitgepakt.':
      '{bestand} appears to be damaged: the archive cannot be fully extracted.',
  'Het {formaat}-formaat wordt nog niet ondersteund ({bestand}).':
      'The {formaat} format is not yet supported ({bestand}).',
  'Geen dia’s gevonden in {bestand} — is dit een geldig {formaat}-bestand?':
      'No slides found in {bestand} — is this a valid {formaat} file?',
  'Kon {bestand} niet lezen als {formaat}-presentatie.':
      'Could not read {bestand} as a {formaat} presentation.',
  ...
  'Bewaar de presentatie onder een eigen naam. Je kunt de titel nu aanpassen.':
      'Save the presentation under your own name. You can adjust the title now.',
  'Openen': 'Open',
  ...
  'Geen OpenKAT-rapportages gevonden in deze map.':
      'No OpenKAT reports found in this folder.',
  'rapportages': 'reports',
  'overgeslagen': 'skipped',
  ...
  'Presentaties openen uit en opslaan naar WebDAV, S3 en git-repository’s, met versiebeheer en samenwerken via een forge. Een deel van deze paden is tot nu toe vooral tegen testomgevingen beproefd; kies dit bewust. Zonder de module werkt alles lokaal gewoon: mappen, bestanden en pakketten.':
      'Open presentations from and save them to WebDAV, S3 and git repositories, with version control and collaboration via a forge. So far some of these paths have mainly been tried against test environments; choose this deliberately. Without the module everything local simply works: folders, files and packages.',
  'Er staan al online verbindingen ingesteld; die blijven werken, net als wachtend werk in de wachtrij. Uit betekent alleen: geen nieuwe online verbindingen toevoegen.':
      'Online connections are already set up; they keep working, as does pending work in the queue. Off only means: no new online connections can be added.',
  ...
  'het classificatiebeleid bewaakt wat er uit mag.':
      'the classification policy guards what may leave.',
  'de markering reist mee, maar er is geen drempel: zet het classificatiebeleid aan onder Instellingen → Algemeen.':
      'the marking travels with it, but there is no barrier: turn on the classification policy under Settings → General.',
  ...
  'Export geblokkeerd door classificatiebeleid: stel een TLP-niveau in voor deze presentatie.':
      'Export blocked by the classification policy: set a TLP level for this presentation.',
  'Export geblokkeerd door classificatiebeleid: dit deck is {deck}, lager dan het vereiste minimum {limit}.':
      'Export blocked by the classification policy: this deck is {deck}, below the required minimum {limit}.',
  'Export geblokkeerd door classificatiebeleid: dit deck is {deck}, hoger dan het toegestane vrijgaveniveau {limit}.':
      'Export blocked by the classification policy: this deck is {deck}, above the permitted release ceiling {limit}.',
  'niet geclassificeerd': 'not classified',
  ...
  'Via deze website ophalen?': 'Fetch via this website?',
  'De server van deze presentatie liet de browser het bestand niet rechtstreeks lezen. OciDeck kan het adres doorgeven aan de website waar OciDeck zelf vandaan komt, en die haalt het dan op. Die website ziet daarmee het volledige adres — staat er een sleutel of code in de link, dan ziet die website die ook.':
      'The server of this presentation did not let the browser read the file directly. OciDeck can pass the address on to the website OciDeck itself comes from, and that website fetches it instead. That website then sees the full address — if there is a key or a code in the link, that website sees it too.',
  ...
  'OciDeck zelf staat onder de EUPL-1.2. Daarnaast bundelt het software van derden: de Dart- en Flutter-pakketten, twee gevendorde pakketten, vijf lettertypefamilies, het gezichtsmodel voor de privacycontrole en de JavaScript die in een HTML-export meegaat. Elk daarvan houdt zijn eigen licentie.':
      'OciDeck itself is licensed under the EUPL-1.2. On top of that it bundles third-party software: the Dart and Flutter packages, two vendored packages, five font families, the face model for the privacy check, and the JavaScript that travels along in an HTML export. Each of those keeps its own licence.',
  ...
  'Sporen op dit apparaat': 'Traces on this device',
  'OciDeck bewaart naast je instellingen ook een recente lijst en, bij een crash, een herstelbestand met de volledige inhoud van je presentatie. Niets daarvan verlaat dit apparaat, maar het staat er wel — in platte tekst, beschermd door je account op dit besturingssysteem en niet meer dan dat.':
      'Besides your settings, OciDeck also keeps a recent list and, after a crash, a recovery file with the full content of your presentation. None of that leaves this device, but it is there — in plain text, protected by your account on this operating system and no more than that.',
  'Recent geopende presentaties': 'Recently opened presentations',
  'De lijst bewaart het volledige pad en de classificatie van elk deck dat open is geweest — samen een gegeven over waar je aan werkt en voor wie.':
      'The list keeps the full path and the classification of every deck that has been open — together, a fact about what you are working on and for whom.',
  'Recente lijst wissen': 'Wipe recent list',
  'De recente lijst was al leeg.': 'The recent list was already empty.',
  'vermelding(en) uit de recente lijst gewist.':
      'item(s) wiped from the recent list.',
  'Crash-herstelbestanden bevatten de volledige inhoud van je presentaties in platte tekst. Ze worden na 7 dagen automatisch opgeruimd, en bij een nette afsluiting meteen.':
      'Crash-recovery files contain the full content of your presentations in plain text. They are cleaned up automatically after 7 days, and immediately on a clean shutdown.',
  'Alles terugzetten': 'Reset everything',
  'Wist elke instelling, de recente lijst, de herstelbestanden, de git-werkkopieën en de wachtwoorden in je sleutelbos. Je presentaties blijven staan: die zijn van jou, niet van OciDeck.':
      'Wipes every setting, the recent list, the recovery files, the git working copies and the passwords in your keychain. Your presentations stay: they are yours, not OciDeck\'s.',
  ...
  'Je instellingen, de recente lijst, de herstelbestanden, de git-werkkopieën en de opgeslagen wachtwoorden worden gewist. Dit kan niet ongedaan worden gemaakt. Je presentaties blijven staan.':
      'Your settings, the recent list, the recovery files, the git working copies and the saved passwords will be wiped. This cannot be undone. Your presentations stay.',
  'wijziging(en) zijn nog niet naar een git-server gestuurd en bestaan alleen op dit apparaat. Ook die gaan weg.':
      'change(s) have not been sent to a git server yet and exist only on this device. Those go too.',
  'Alles is teruggezet naar de begintoestand.':
      'Everything has been reset to its initial state.',
  'Terugzetten is niet gelukt.': 'The reset did not succeed.',
  'Er wacht nog werk dat niet verstuurd is': 'There is unsent work waiting',
  'Deze git-verbinding heeft wijzigingen die nog niet naar de server zijn gestuurd. Verwijder je de verbinding, dan gaat ook de werkkopie op dit apparaat weg — en bestaat dit werk nergens meer.':
      'This git connection has changes that have not been sent to the server yet. If you remove the connection, the working copy on this device goes with it — and this work exists nowhere any more.',
  'Verbinding behouden': 'Keep connection',
  'Toch verwijderen': 'Remove anyway',
  'esc': 'esc',
  'Enter': 'Enter',
  'OK': 'OK',
  'min': 'min',
  ...
  'Het token heeft lees- en schrijfrechten op de repository nodig. Gitea en Forgejo kennen geen server-side zoeken; OciDeck zoekt lokaal.':
      'The token needs read and write access to the repository. Gitea and Forgejo have no server-side search; OciDeck searches locally.',
  ...
  'Het token heeft read_repository, write_repository en read_api nodig. Server-side zoeken vereist Advanced- of Exact Search.':
      'The token needs read_repository, write_repository and read_api. Server-side search requires Advanced or Exact Search.',
  ...
  'Afbeeldingen, video en audio die je in dit tabblad koos, leven alleen in het geheugen. Een los .md-bestand bewaart ze niet — bij heropenen zijn ze weg. Exporteer als .ocideck-pakket om het beeld mee te nemen.':
      'Images, video and audio you chose in this tab live only in memory. A plain .md file does not keep them — they are gone when you reopen it. Export as an .ocideck package to take the media with you.',
  'Media verwijderd om privacyredenen': 'Media removed for privacy reasons',
  ...
  'Verdieping': 'Depth',
  'Hoeveel detail?': 'How much detail?',
  'Met verdieping': 'With depth',
  'Beknopt': 'Condensed',
  'Het detail achter het verhaal. Deze slide gaat mee in de volledige export en valt weg in de beknopte — los van wie hem mag zien.':
      'The detail behind the story. This slide travels with the full export and drops out of the condensed one — independently of who may see it.',
  ...
  'Stand': 'Status',
  'geen datum': 'no date',
  'Besluit gevraagd': 'Decision required',
  ...
  'Lager is beter': 'Lower is better',
  'Hoger is beter': 'Higher is better',
  'Neutraal': 'Neutral',
  'Nu': 'Now',
  'Vorige rapportage': 'Previous report',
  'Een scorecard toont hoogstens vijf cijfers; meer leest niet meer als een oordeel.':
      'A scorecard shows at most five figures; more stops reading as a verdict.',
  'Laat de vorige rapportage leeg als er nog geen meting was; de slide toont dan geen verandering.':
      'Leave the previous report empty when there was no earlier measurement; the slide then shows no change.',
  ...
  'werkgeversnummer (EIN)': 'employer number (EIN)',
  'laatste vier cijfers van een SSN': 'last four digits of an SSN',
  'geboortedatum, postcode en geslacht samen — die drie wijzen meestal één persoon aan, ook zonder naam':
      'date of birth, postcode and gender together — those three usually pinpoint one person, even without a name',
  'Het certificaat van deze server wordt niet vertrouwd. Bij een zelf gehoste server kun je het bekijken en vertrouwen bij Instellingen → Opslag.':
      'This server\'s certificate is not trusted. On a self-hosted server you can view it and choose to trust it under Settings → Storage.',
  'Het certificaat van de forge wordt niet vertrouwd. Bij een zelf gehoste forge kun je het bekijken en vertrouwen bij Instellingen → Opslag.':
      'This forge\'s certificate is not trusted. On a self-hosted forge you can view it and choose to trust it under Settings → Storage.',
  'Het certificaat van het endpoint wordt niet vertrouwd. Bij een zelf gehost endpoint kun je het bekijken en vertrouwen bij Instellingen → Opslag.':
      'This endpoint\'s certificate is not trusted. On a self-hosted endpoint you can view it and choose to trust it under Settings → Storage.',
  'Het certificaat van de forge wordt niet vertrouwd — zelfondertekend, verlopen, of op een andere naam gesteld.':
      'The forge\'s certificate is not trusted — self-signed, expired, or issued to a different name.',
  'Het certificaat van het endpoint wordt niet vertrouwd — zelfondertekend, verlopen, of op een andere naam gesteld.':
      'The endpoint\'s certificate is not trusted — self-signed, expired, or issued to a different name.',
  ...
  'Je token is geldig, maar mag dit niet. Geef het meer rechten, of wacht als de forge een limiet oplegt.':
      'Your token is valid, but not allowed to do this. Give it more rights, or wait if the forge is applying a rate limit.',
  'Het token is geldig, maar mag dit niet — geef het meer rechten op de repository.':
      'The token is valid, but not allowed to do this — give it more rights on the repository.',
  'Aangemeld, maar geen toegang — je wachtwoord is niet het probleem. Vraag rechten op deze map.':
      'Signed in, but no access — your password is not the problem. Ask for rights on this folder.',
  ...
  'IMSI van een abonnee': 'IMSI of a subscriber',
  'sociale-mediaprofiel': 'social media profile',
  'advertentie- of apparaat-ID': 'advertising or device ID',
  'IP-adres': 'IP address',
  ...
  'Welke verbinding?': 'Which connection?',
  'Bestandsverbindingen': 'File connections',
  'Een git-repository; elke opgeslagen versie blijft bewaard.':
      'A git repository; every saved version is kept.',
  'Een map op de schijf van deze computer.':
      'A folder on this computer\'s disk.',
  'Een map op een WebDAV-server, bijvoorbeeld Nextcloud.':
      'A folder on a WebDAV server, for example Nextcloud.',
  'Instellingen tonen': 'Show settings',
  'Instellingen verbergen': 'Hide settings',
  'Map op deze computer': 'Folder on this computer',
  'Naam van deze verbinding': 'Name of this connection',
  'Nog geen verbinding — voeg er hieronder een toe.':
      'No connection yet — add one below.',
  'Sleep om de volgorde te wijzigen': 'Drag to change the order',
  'Verbinding toevoegen': 'Add connection',
  'Verbinding verwijderen': 'Remove connection',
  ...
  'Afbeelding kiezen op WebDAV': 'Choose image on WebDAV',
  ...
  'Gebruikte hulpmiddelen': 'Tools used',
  'Hulpmiddel': 'Tool',
  'Referentie': 'Reference',
  'Eén per regel, bijv. Burp Suite@2026.4 | https://portswigger.net | Webproxy':
      'One per line, e.g. Burp Suite@2026.4 | https://portswigger.net | Web proxy',
  'Nog geen hulpmiddelen vastgelegd — vul ze in bij Presentatie-info.':
      'No tools recorded yet — enter them under Presentation info.',
  'Bijlage met hulpmiddelen toegevoegd.': 'Tools appendix added.',
  'Bijlage toegevoegd, maar niet elk hulpmiddel heeft beschrijving, versie én referentie:':
      'Appendix added, but not every tool has a description, version and reference:',
  ...
  'waarde(n) uit de CSV zijn niet als getal gelezen en staan nu op 0:':
      'value(s) from the CSV were not read as numbers and are now 0:',
  ...
  'De pool is nog leeg.': 'The pool is still empty.',
  'alleen nog in een uitgebrachte versie:': 'only in a released version now:',
  'nergens meer gevonden': 'found nowhere any more',
  'Niet te zeggen wat ongebruikt is: dit kon niet gelezen worden —':
      'Cannot say what is unused: these could not be read —',
  'Elke afbeelding wordt ergens gebruikt.': 'Every image is used somewhere.',
  'afbeeldingen worden nergens meer aangehaald — ook niet in een uitgebrachte versie. Dit is een voorstel, geen oordeel: op een andere branch kunnen ze nog in gebruik zijn.':
      'images are no longer referenced anywhere — not even in a released version. This is a suggestion, not a verdict: they may still be in use on another branch.',
  ...
  'Kies twee versies; de oudste van de twee is het vertrekpunt.':
      'Pick two versions; the older of the two is the starting point.',
  'Vergelijken': 'Compare',
  ...
  'Nog geen uitgebrachte versies van dit deck.':
      'No released versions of this deck yet.',
  'Horizontale gestapelde staaf': 'Horizontal stacked bar',
  'Git-geschiedenis…': 'Git history…',
  'Git-geschiedenis:': 'Git history:',
  'Nog geen commits voor dit deck.': 'No commits for this deck yet.',
  'Gepusht': 'Pushed',
  'Nog niet gepusht': 'Not pushed yet',
  'Gesynchroniseerd met git.': 'Synchronised with git.',
  'Nog geen verbinding — het gaat later mee.':
      'No connection yet — it will go along later.',
  'De branch is verzet; je commits staan lokaal klaar.':
      'The branch has moved; your commits are ready locally.',
  'Synchroniseren mislukt.': 'Synchronisation failed.',
  'Native git gevonden:': 'Native git found:',
  'Native git: bezig met detecteren…': 'Native git: detecting…',
  'Native git: niet gevonden — het REST-pad wordt gebruikt':
      'Native git: not found — the REST path is used',
  'echte offline-historie mogelijk': 'real offline history possible',
  ...
  'Open presentaties uit een git-repository. Elke opgeslagen versie blijft bewaard. Het token wordt versleuteld in de sleutelhanger bewaard, niet bij de overige instellingen.':
      'Open presentations from a git repository. Every saved version is kept. The token is stored encrypted in the keychain, not alongside the other settings.',
  'Eigenaar': 'Owner',
  ...
  'AI-assistentie (staat standaard uit): kies je een zelf-gehoste of cloud-backend, dan worden de teksten of afbeeldingen die je laat verwerken naar dat adres gestuurd. Wat je hebt geredigeerd, gaat er eerst uit. Een lokaal AI-model op dit apparaat verstuurt niets.':
      'AI assistance (off by default): if you pick a self-hosted or cloud backend, the texts or images you have it process are sent to that address. Anything you redacted is removed first. A local AI model on this device sends nothing.',
  'Gegevens weglaten (redactie)': 'Leaving data out (redaction)',
  'Zet je tekst tussen dubbele blokhaken, zoals [[het adres]], dan laat OciDeck die weg uit alles wat je toont en exporteert. Op de dia, in de presentatie, in de PDF, de PowerPoint en de HTML verschijnen alleen blokken.':
      'Put text between double square brackets, like [[the address]], and OciDeck leaves it out of everything you show and export. On the slide, in the presentation, in the PDF, the PowerPoint and the HTML, only blocks appear.',
  'Weggelaten is écht weggelaten, niet afgedekt. De tekst zit niet als onzichtbare laag onder een zwart balkje in de PDF, niet in de sprekersnotities van de PowerPoint, en niet in de broncode van de HTML. Wie het bestand openmaakt, kan er niets uit terughalen.':
      'Left out means really left out, not covered up. The text is not sitting as an invisible layer under a black bar in the PDF, nor in the PowerPoint\'s speaker notes, nor in the HTML source. Whoever opens the file cannot retrieve anything from it.',
  'Je eigen bestand verandert niet. De oorspronkelijke tekst blijft in je markdown staan; redactie geldt alleen voor wat je deelt. Zo houd je je eigen gegevens.':
      'Your own file does not change. The original text stays in your markdown; redaction only applies to what you share. That way you keep your own data.',
  ...
  'CVE opzoeken is niet beschikbaar in de webversie.':
      'CVE lookup is not available in the web version.',
  'CVE-mirror (basis-URL)': 'CVE mirror (base URL)',
  'Geen CVE gevonden.': 'No CVE found.',
  'Kon de CVE-bron niet bereiken.': 'Could not reach the CVE source.',
  'Sta toe om in de bevinding-editor online in CVE\'s te zoeken via een NVD-mirror. Standaard uit; vereist ook je toestemming en werkt alleen op desktop.':
      'Allow searching CVEs online in the finding editor via an NVD mirror. Off by default; also requires your consent and works only on desktop.',
  'Typ een (deel van een) CVE-id en zoek.':
      'Type (part of) a CVE id and search.',
  'Typ minstens 3 tekens.': 'Type at least 3 characters.',
  'Zet CVE opzoeken (online) aan in Instellingen → Beveiliging om online in CVE\'s te zoeken.':
      'Turn on CVE lookup (online) in Settings → Security to search CVEs online.',
  'Zoek CVE…': 'Search CVE…',
  'Zoek op CVE-id, bijv. 2021-44228': 'Search by CVE id, e.g. 2021-44228',
  'Zoeken': 'Search',
  'Hertest': 'Retest',
  ...
  'Kies uit de scope': 'Choose from the scope',
  'Bepaalt de contextscore van bevindingen op dit object; laat leeg als de weging niet bekend is.':
      'Sets the context score of findings on this object; leave empty if the weighting is unknown.',
  'De contextscore is gewogen met de CIA-rating van het gekozen scope-object.':
      'The context score is weighted with the CIA rating of the chosen scope object.',
  ...
  'Knippen en audio': 'Trimming and audio',
  'Bereik en kleurzones': 'Range and color zones',
  ...
  'Beveiligingsbriefing / dienststart': 'Security briefing / shift start',
  'Actualiteiten, aandachtsvestigingen, bijzonderheden, onderhoud en bezetting voor de beveiligingsdienst.':
      'Current events, points of attention, special notes, maintenance and staffing for the security shift.',
  'Operationele politiebriefing': 'Operational police briefing',
  'Actualiteiten, hotspots, signaleringen, opdrachten, eigen veiligheid en gebiedsinzet voor de dienst.':
      'Current events, hotspots, wanted notices (BOLO), assignments, officer safety and area deployment for the shift.',
