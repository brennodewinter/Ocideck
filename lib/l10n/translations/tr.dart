...
const _dutchSourceAddTr = <String, String>{
  'OciDeck mag uw microfoon of camera niet gebruiken. Geef toestemming in uw browser of systeeminstellingen en probeer het opnieuw.':
      'OciDeck mikrofonunuzu veya kameranızı kullanamıyor. Tarayıcınızda ya da sistem ayarlarında izin verin ve yeniden deneyin.',
  'Er is geen werkende microfoon gevonden. Sluit er een aan of kies een ander apparaat.':
      'Çalışan bir mikrofon bulunamadı. Bir mikrofon bağlayın veya başka bir aygıt seçin.',
  'Er is geen werkende camera gevonden. U kunt zonder beeld meedoen.':
      'Çalışan bir kamera bulunamadı. Görüntü olmadan da katılabilirsiniz.',
  'De dienst die het toegangsbewijs afgeeft is onbereikbaar. Probeer het later opnieuw; uw presentatie blijft ondertussen gewoon open.':
      'Erişim belgesini veren hizmete ulaşılamıyor. Daha sonra yeniden deneyin; bu sırada sunumunuz açık kalır.',
  'De dienst die het toegangsbewijs afgeeft heeft zijn grens voor nu bereikt. Probeer het later opnieuw.':
      'Erişim belgesini veren hizmet şimdilik sınırına ulaştı. Daha sonra yeniden deneyin.',
  'Het toegangsbewijs voor deze vergadering is verlopen. Doe opnieuw mee met dezelfde link.':
      'Bu toplantı için erişim belgesinin süresi doldu. Aynı bağlantıyla yeniden katılın.',
  'Het netwerk laat deze vergadering niet door. Op een bedrijfsnetwerk blokkeert een firewall of proxy dit soort verkeer vaak; een andere verbinding lukt meestal wel.':
      'Ağ bu toplantıyı geçirmiyor. Kurumsal bir ağda güvenlik duvarı veya proxy bu tür trafiği sık sık engeller; başka bir bağlantı genellikle çalışır.',
  'Deze vergadering is voorbij.': 'Bu toplantı bitti.',
  'De vergaderdienst is zelf niet beschikbaar. Dit ligt niet aan uw verbinding; probeer het later opnieuw.':
      'Toplantı hizmetinin kendisi kullanılamıyor. Bu, bağlantınızdan kaynaklanmıyor; daha sonra yeniden deneyin.',
  'Meedoen is niet gelukt, en de dienst zegt niet waarom. De technische code staat bij de details — probeer het opnieuw, en geef die code door als het blijft misgaan.':
      'Katılım başarısız oldu ve hizmet nedenini söylemiyor. Teknik kod ayrıntılarda yer alıyor — yeniden deneyin ve sorun sürerse bu kodu bildirin.',
  'Dit is geen bruikbare vergaderlink. Kopieer hem opnieuw uit de uitnodiging — een link die door een chatprogramma is afgekapt of aangepast, doet het vaak niet meer.':
      'Bu, kullanılabilir bir toplantı bağlantısı değil. Bağlantıyı davetten yeniden kopyalayın — bir sohbet programının kestiği veya değiştirdiği bağlantı çoğu zaman artık çalışmaz.',
  'Deze dienst kennen we, maar dit soort vergadering niet. Webinars, uitzendingen en persoonlijke vergaderkamers werken anders dan een gewone vergadering; open deze link in de browser.':
      'Bu hizmeti tanıyoruz, ama bu toplantı türünü tanımıyoruz. Web seminerleri, yayınlar ve kişisel toplantı odaları sıradan bir toplantıdan farklı çalışır; bu bağlantıyı tarayıcınızda açın.',
  'Deze vergaderdienst kennen we niet. OciDeck weet dus ook niet wat er achter deze link zit; u kunt hem in uw browser openen als u de afzender vertrouwt.':
      'Bu toplantı hizmetini tanımıyoruz. Bu nedenle OciDeck de bu bağlantının arkasında ne olduğunu bilmiyor; gönderene güveniyorsanız bağlantıyı tarayıcınızda açabilirsiniz.',
  'Meedoen kan op deze uitvoering van OciDeck niet. Gebruik de webversie in uw browser.':
      'OciDeck\'in bu sürümünde katılmak mümkün değil. Tarayıcınızda web sürümünü kullanın.',
  'Deze browser mist iets wat voor meedoen nodig is. Een recente Chrome, Edge, Firefox of Safari lukt doorgaans wel.':
      'Bu tarayıcıda katılmak için gereken bir şey eksik. Güncel bir Chrome, Edge, Firefox veya Safari genellikle çalışır.',
  'De organisatie van deze vergadering laat geen gasten zonder account toe. Vraag de organisator om u uit te nodigen op een manier die gasten toestaat.':
      'Bu toplantıyı düzenleyen kuruluş hesabı olmayan konukları kabul etmiyor. Düzenleyenden sizi konuklara izin veren bir yolla davet etmesini isteyin.',
  'Meedoen aan deze vergadering vereist een account bij de aanbieder. Open de link in uw browser en meld u daar aan.':
      'Bu toplantıya katılmak için sağlayıcıda bir hesap gerekir. Bağlantıyı tarayıcınızda açın ve orada oturum açın.',
  'Deze aanbieder laat alleen goedgekeurde programma\'s meedoen, en die goedkeuring is er voor OciDeck nog niet. Open de vergadering in uw browser.':
      'Bu sağlayıcı yalnızca onaylı programların katılmasına izin veriyor ve OciDeck için bu onay henüz yok. Toplantıyı tarayıcınızda açın.',
  'De organisator heeft u niet toegelaten. Vraag of hij u binnenlaat en probeer het daarna opnieuw.':
      'Düzenleyen sizi kabul etmedi. İçeri alınmayı isteyin ve sonra yeniden deneyin.',
  'Deze vergadering is op slot; er komt niemand meer bij. Vraag de organisator om het slot eraf te halen.':
      'Bu toplantı kilitli; artık kimse katılamaz. Düzenleyenden kilidi kaldırmasını isteyin.',
  'Deze vergadering is eind-tot-eind versleuteld en laat daarom geen externe deelnemers toe. Dat is een keuze van de organisator; vraag hem om een gewone vergadering als u erbij moet zijn.':
      'Bu toplantı uçtan uca şifreli olduğu için dışarıdan katılımcı kabul etmiyor. Bu, düzenleyenin bir seçimi; toplantıda bulunmanız gerekiyorsa ondan sıradan bir toplantı isteyin.',
  '{plek} krijgt contact zodra u meedoet.':
      'Katıldığınız anda {plek} ile bağlantı kurulur.',
  'U doet mee met alleen de naam die u zelf opgeeft; u bent niet aangemeld als die persoon.':
      'Yalnızca kendi girdiğiniz adla katılırsınız; o kişi olarak oturum açmış değilsiniz.',
  'De dienst maakt een tijdelijke gastidentiteit voor u, die na de vergadering verdwijnt.':
      'Hizmet sizin için geçici bir konuk kimliği oluşturur; bu kimlik toplantıdan sonra kaybolur.',
  'U doet mee als gast onder een dienstaccount van een organisatie.':
      'Bir kuruluşun hizmet hesabı üzerinden konuk olarak katılırsınız.',
  'De organisator heeft een identiteit voor u klaargezet.':
      'Düzenleyen sizin için bir kimlik hazırlamış.',
  'Meedoen gaat met uw eigen account bij deze aanbieder.':
      'Bu sağlayıcıdaki kendi hesabınızla katılırsınız.',
  'De aanbieder ziet uw netwerkgegevens en het beeld en geluid dat u verstuurt. Wat u deelt, deelt u met alle deelnemers.':
      'Sağlayıcı, ağ bilgilerinizi ve gönderdiğiniz görüntü ile sesi görür. Paylaştığınız şeyi tüm katılımcılarla paylaşırsınız.',
  'Het verkeer is versleuteld naar de dienst toe; de dienst zelf kan meekijken.':
      'Trafik hizmete kadar şifrelenir; hizmetin kendisi içeriği görebilir.',
  'De aanbieder beheert de versleuteling en dus ook de sleutels.':
      'Sağlayıcı şifrelemeyi, dolayısıyla anahtarları da yönetir.',
  'De aanbieder beschrijft dit als eind-tot-eind versleuteld.':
      'Sağlayıcı bunu uçtan uca şifreli olarak tanımlıyor.',
  'Over de versleuteling is niets vastgesteld. OciDeck belooft daar dus niets over.':
      'Şifreleme hakkında hiçbir şey saptanmadı. Bu nedenle OciDeck bu konuda hiçbir şey vaat etmiyor.',
  'U komt eerst in een wachtruimte: een organisator moet u toelaten. Uw presentatie blijft ondertussen gewoon te bewerken.':
      'Önce bir bekleme odasına girersiniz: bir düzenleyenin sizi kabul etmesi gerekir. Bu sırada sunumunuzu düzenlemeye devam edebilirsiniz.',
  'Deze vergadering vraagt om een wachtwoord.':
      'Bu toplantı bir parola istiyor.',
  'Deze vergadering vraagt om aanmelding vooraf.':
      'Bu toplantı önceden kayıt istiyor.',
  'Vergadering wordt voorbereid': 'Toplantı hazırlanıyor',
  'Verbinden met de vergadering': 'Toplantıya bağlanılıyor',
  'Wachten op toelating door de organisator':
      'Düzenleyenin sizi kabul etmesi bekleniyor',
  'U doet mee aan de vergadering': 'Toplantıya katılıyorsunuz',
  'De verbinding is weggevallen — opnieuw verbinden':
      'Bağlantı koptu — yeniden bağlanılıyor',
  'De vergadering wordt verlaten': 'Toplantıdan ayrılınıyor',
  'De vergadering is beëindigd': 'Toplantı sona erdi',
  'Meedoen is niet gelukt': 'Katılım başarısız oldu',
  'Deze vergadering wordt opgenomen.': 'Bu toplantı kaydediliyor.',
  'Deze vergadering wordt uitgeschreven.': 'Bu toplantı yazıya geçiriliyor.',
  'Deze vergadering wordt opgenomen en uitgeschreven.':
      'Bu toplantı kaydediliyor ve yazıya geçiriliyor.',
  'De vergadering vraagt uw uitdrukkelijke toestemming om mee te blijven doen.':
      'Toplantı, katılmaya devam etmeniz için açık izninizi istiyor.',
  'Een organisator moet u nog toelaten. U kunt gewoon doorwerken; zodra u binnen bent, opent het gespreksvenster zich.':
      'Bir düzenleyenin sizi kabul etmesi gerekiyor. Çalışmaya rahatça devam edebilirsiniz; içeri girdiğiniz anda görüşme penceresi açılır.',
  'Herkend als een vergadering bij {plek}.':
      '{plek} üzerinde bir toplantı olarak tanındı.',
  '{uitleg} De link wijst naar {plek}.':
      '{uitleg} Bağlantı {plek} adresine işaret ediyor.',
  'Deze naam kiest u zelf; niemand controleert hem. De anderen zien u als gast.':
      'Bu adı kendiniz seçersiniz; kimse denetlemez. Diğerleri sizi konuk olarak görür.',
  'Afsluiten': 'Bitir',
  'Camera aanzetten': 'Kamerayı aç',
  'Camera uitzetten': 'Kamerayı kapat',
  'Microfoon aanzetten': 'Mikrofonu aç',
  'Microfoon dempen': 'Mikrofonu kapat',
  'Presentatie delen': 'Sunumu paylaş',
  'Delen stoppen': 'Paylaşımı durdur',
  'Gespreksvenster': 'Görüşme penceresi',
  'Venster sluiten': 'Pencereyi kapat',
  'Meedoen': 'Katıl',
  'Meedoen aan een onlinevergadering': 'Çevrimiçi toplantıya katıl',
  'Onlinevergadering': 'Çevrimiçi toplantı',
  'Onlinevergadering…': 'Çevrimiçi toplantı…',
  'Vergaderlink': 'Toplantı bağlantısı',
  'Plak hier de link uit de uitnodiging':
      'Davetteki bağlantıyı buraya yapıştırın',
  'Uw naam, zoals de anderen die zien': 'Diğerlerinin göreceği adınız',
  'Wat er gebeurt als u meedoet': 'Katıldığınızda ne olur',
  'Verlaten': 'Ayrıl',
  'Weigeren en verlaten': 'Reddet ve ayrıl',
  'Toestemming geven': 'İzin ver',
  'Technische code: {code}': 'Teknik kod: {code}',
  'Deelnemers ({aantal})': 'Katılımcılar ({aantal})',
  'Nog geen deelnemers.': 'Henüz katılımcı yok.',
  'Deze vergadering geeft geen deelnemerslijst.':
      'Bu toplantı katılımcı listesi vermiyor.',
  'gast': 'konuk',
  'deelnemer': 'katılımcı',
  'presentator': 'sunucu',
  'moderator': 'moderatör',
