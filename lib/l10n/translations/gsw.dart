...
const _dutchSourceAddGsw = <String, String>{
  'OciDeck mag uw microfoon of camera niet gebruiken. Geef toestemming in uw browser of systeeminstellingen en probeer het opnieuw.':
      'OciDeck dörf Ihres Mikrofon oder Ihri Kamera nid bruuche. Gäbe Sie im Browser oder i de Systemiistellige d Erlaubnis und probiere Sie s nomol.',
  'Er is geen werkende microfoon gevonden. Sluit er een aan of kies een ander apparaat.':
      'Es isch kei funktionierends Mikrofon gfunde worde. Schlüsse Sie eis a oder wähle Sie es anders Grät.',
  'Er is geen werkende camera gevonden. U kunt zonder beeld meedoen.':
      'Es isch kei funktionierendi Kamera gfunde worde. Sie chöi ohni Bild teilnäh.',
  'De dienst die het toegangsbewijs afgeeft is onbereikbaar. Probeer het later opnieuw; uw presentatie blijft ondertussen gewoon open.':
      'De Dienscht, wo de Zuegangsnachwiis uusstellt, isch nid erreichbar. Probiere Sie s spöter nomol; Ihri Presentation blibt dezwüsche eifach offe.',
  'De dienst die het toegangsbewijs afgeeft heeft zijn grens voor nu bereikt. Probeer het later opnieuw.':
      'De Dienscht, wo de Zuegangsnachwiis uusstellt, hät sini Gränze für jetzt erreicht. Probiere Sie s spöter nomol.',
  'Het toegangsbewijs voor deze vergadering is verlopen. Doe opnieuw mee met dezelfde link.':
      'De Zuegangsnachwiis für die Bsprechig isch abgloffe. Näh Sie mit em gliiche Link nomol teil.',
  'Het netwerk laat deze vergadering niet door. Op een bedrijfsnetwerk blokkeert een firewall of proxy dit soort verkeer vaak; een andere verbinding lukt meestal wel.':
      'S Netzwärch laht die Bsprechig nid dure. In eme Firmenetzwärch blockiert e Firewall oder Proxy söttige Verchehr oft; mit ere andere Verbindig klappt s meischtens.',
  'Deze vergadering is voorbij.': 'Die Bsprechig isch verbii.',
  'De vergaderdienst is zelf niet beschikbaar. Dit ligt niet aan uw verbinding; probeer het later opnieuw.':
      'De Bsprechigsdienscht sälber isch nid verfüegbar. Das liegt nid a Ihrere Verbindig; probiere Sie s spöter nomol.',
  'Meedoen is niet gelukt, en de dienst zegt niet waarom. De technische code staat bij de details — probeer het opnieuw, en geef die code door als het blijft misgaan.':
      'S Teilnäh isch fehlgschlage, und de Dienscht seit nid, worum. De technisch Code staht bi de Details — probiere Sie s nomol und gäbe Sie de Code witer, wenn s wiiter schief gaht.',
  'Dit is geen bruikbare vergaderlink. Kopieer hem opnieuw uit de uitnodiging — een link die door een chatprogramma is afgekapt of aangepast, doet het vaak niet meer.':
      'Das isch kei bruchbare Bsprechigs-Link. Kopiere Sie ihn nomol us de Iiladig — en Link, wo es Chatprogramm abgschnitte oder veränderet hät, funktioniert oft nid meh.',
  'Deze dienst kennen we, maar dit soort vergadering niet. Webinars, uitzendingen en persoonlijke vergaderkamers werken anders dan een gewone vergadering; open deze link in de browser.':
      'Da Dienscht kenne mer, aber die Art vo Bsprechig nid. Webinare, Übertragige und persönlichi Bsprechigsruum funktioniere anders als e normali Bsprechig; mache Sie da Link im Browser uf.',
  'Deze vergaderdienst kennen we niet. OciDeck weet dus ook niet wat er achter deze link zit; u kunt hem in uw browser openen als u de afzender vertrouwt.':
      'Da Bsprechigsdienscht kenne mer nid. OciDeck weiss drum au nid, was hinder däm Link steckt; Sie chöi ihn im Browser ufmache, wenn Sie em Absänder vertroue.',
  'Meedoen kan op deze uitvoering van OciDeck niet. Gebruik de webversie in uw browser.':
      'I dere Uusgab vo OciDeck cha me nid teilnäh. Bruuche Sie d Webversion im Browser.',
  'Deze browser mist iets wat voor meedoen nodig is. Een recente Chrome, Edge, Firefox of Safari lukt doorgaans wel.':
      'Däm Browser fehlt öppis, wo s zum Teilnäh bruucht. Es aktuells Chrome, Edge, Firefox oder Safari klappt in de Regle.',
  'De organisatie van deze vergadering laat geen gasten zonder account toe. Vraag de organisator om u uit te nodigen op een manier die gasten toestaat.':
      'D Organisation vo dere Bsprechig laht kei Gäscht ohni Konto zue. Frage Sie de Organisator, ass er Sie uf e Art iiladet, wo Gäscht zuelaht.',
  'Meedoen aan deze vergadering vereist een account bij de aanbieder. Open de link in uw browser en meld u daar aan.':
      'Zum a dere Bsprechig teilnäh bruucht s es Konto bim Aabieter. Mache Sie de Link im Browser uf und mälde Sie sich det aa.',
  'Deze aanbieder laat alleen goedgekeurde programma\'s meedoen, en die goedkeuring is er voor OciDeck nog niet. Open de vergadering in uw browser.':
      'Da Aabieter laht nur zuegloh Programm mitmache, und die Zuelassig git s für OciDeck no nid. Mache Sie d Bsprechig im Browser uf.',
  'De organisator heeft u niet toegelaten. Vraag of hij u binnenlaat en probeer het daarna opnieuw.':
      'De Organisator hät Sie nid zuegloh. Frage Sie, ass er Sie iileht, und probiere Sie s denn nomol.',
  'Deze vergadering is op slot; er komt niemand meer bij. Vraag de organisator om het slot eraf te halen.':
      'Die Bsprechig isch abgschlosse; es chunnt niemert meh dezue. Frage Sie de Organisator, ass er s Schloss weg macht.',
  'Deze vergadering is eind-tot-eind versleuteld en laat daarom geen externe deelnemers toe. Dat is een keuze van de organisator; vraag hem om een gewone vergadering als u erbij moet zijn.':
      'Die Bsprechig isch Ändi-zu-Ändi verschlüsslet und laht drum kei externi Teilnämer zue. Das isch en Entscheid vom Organisator; frage Sie ihn um e normali Bsprechig, wenn Sie debii sii müend.',
  '{plek} krijgt contact zodra u meedoet.':
      '{plek} wird kontaktiert, sobald Sie teilnäh.',
  'U doet mee met alleen de naam die u zelf opgeeft; u bent niet aangemeld als die persoon.':
      'Sie näh nur mit em Name teil, wo Sie sälber aagäh; Sie sind nid als die Person aagmäldet.',
  'De dienst maakt een tijdelijke gastidentiteit voor u, die na de vergadering verdwijnt.':
      'De Dienscht macht für Sie e vorüberghendi Gaschtidentität, wo nach de Bsprechig verschwindet.',
  'U doet mee als gast onder een dienstaccount van een organisatie.':
      'Sie näh als Gascht über es Dienschtkonto vonere Organisation teil.',
  'De organisator heeft een identiteit voor u klaargezet.':
      'De Organisator hät e Identität für Sie parat gmacht.',
  'Meedoen gaat met uw eigen account bij deze aanbieder.':
      'S Teilnäh lauft über Ihres eigets Konto bi däm Aabieter.',
  'De aanbieder ziet uw netwerkgegevens en het beeld en geluid dat u verstuurt. Wat u deelt, deelt u met alle deelnemers.':
      'De Aabieter gseht Ihri Netzwärchdate und s Bild und de Ton, wo Sie schicke. Was Sie teile, teile Sie mit allne Teilnämer.',
  'Het verkeer is versleuteld naar de dienst toe; de dienst zelf kan meekijken.':
      'De Verchehr isch zum Dienscht hi verschlüsslet; de Dienscht sälber cha mitluege.',
  'De aanbieder beheert de versleuteling en dus ook de sleutels.':
      'De Aabieter verwaltet d Verschlüsslig und drum au d Schlüssel.',
  'De aanbieder beschrijft dit als eind-tot-eind versleuteld.':
      'De Aabieter beschriibt das als Ändi-zu-Ändi verschlüsslet.',
  'Over de versleuteling is niets vastgesteld. OciDeck belooft daar dus niets over.':
      'Über d Verschlüsslig isch nüt feschtgstellt. OciDeck verspricht drum au nüt drüber.',
  'U komt eerst in een wachtruimte: een organisator moet u toelaten. Uw presentatie blijft ondertussen gewoon te bewerken.':
      'Sie chöme zerscht ine Wartruum: en Organisator mues Sie zuelah. Ihri Presentation blibt dezwüsche ganz normal bearbeitbar.',
  'Deze vergadering vraagt om een wachtwoord.':
      'Die Bsprechig verlangt es Passwort.',
  'Deze vergadering vraagt om aanmelding vooraf.':
      'Die Bsprechig verlangt e Aamäldig im Vorus.',
  'Vergadering wordt voorbereid': 'Bsprechig wird vorbereitet',
  'Verbinden met de vergadering': 'Verbindig zur Bsprechig wird ufbaut',
  'Wachten op toelating door de organisator':
      'Warte uf d Zuelassig vom Organisator',
  'U doet mee aan de vergadering': 'Sie näh a de Bsprechig teil',
  'De verbinding is weggevallen — opnieuw verbinden':
      'D Verbindig isch abbroche — es wird neu verbunde',
  'De vergadering wordt verlaten': 'D Bsprechig wird verlah',
  'De vergadering is beëindigd': 'D Bsprechig isch verbii',
  'Meedoen is niet gelukt': 'Teilnäh isch fehlgschlage',
  'Deze vergadering wordt opgenomen.': 'Die Bsprechig wird ufgnoh.',
  'Deze vergadering wordt uitgeschreven.': 'Die Bsprechig wird transkribiert.',
  'Deze vergadering wordt opgenomen en uitgeschreven.':
      'Die Bsprechig wird ufgnoh und transkribiert.',
  'De vergadering vraagt uw uitdrukkelijke toestemming om mee te blijven doen.':
      'D Bsprechig frogt um Ihri usdrücklichi Zueschtimmig, ass Sie wiiter chöi teilnäh.',
  'Een organisator moet u nog toelaten. U kunt gewoon doorwerken; zodra u binnen bent, opent het gespreksvenster zich.':
      'En Organisator mues Sie no zuelah. Sie chöi eifach wiiterschaffe; sobald Sie dinn sind, gaht s Gsprächsfänschter uf.',
  'Herkend als een vergadering bij {plek}.': 'Als Bsprechig bi {plek} erkennt.',
  '{uitleg} De link wijst naar {plek}.': '{uitleg} De Link zeigt uf {plek}.',
  'Deze naam kiest u zelf; niemand controleert hem. De anderen zien u als gast.':
      'Die Name wähle Sie sälber; niemert prüeft ihn. Di andere gseh Sie als Gascht.',
  'Afsluiten': 'Beände',
  'Camera aanzetten': 'Kamera aaschalte',
  'Camera uitzetten': 'Kamera abschalte',
  'Microfoon aanzetten': 'Mikrofon aaschalte',
  'Microfoon dempen': 'Mikrofon stummschalte',
  'Presentatie delen': 'Presentation teile',
  'Delen stoppen': 'Teile beände',
  'Gespreksvenster': 'Gsprächsfänschter',
  'Venster sluiten': 'Fänschter zuemache',
  'Meedoen': 'Teilnäh',
  'Meedoen aan een onlinevergadering': 'A menere Online-Bsprechig teilnäh',
  'Onlinevergadering': 'Online-Bsprechig',
  'Onlinevergadering…': 'Online-Bsprechig…',
  'Vergaderlink': 'Bsprechigs-Link',
  'Plak hier de link uit de uitnodiging':
      'Füege Sie da de Link us de Iiladig ii',
  'Uw naam, zoals de anderen die zien': 'Ihre Name, wie ne di andere gseh',
  'Wat er gebeurt als u meedoet': 'Was passiert, wenn Sie teilnäh',
  'Verlaten': 'Verlah',
  'Weigeren en verlaten': 'Ablehne und verlah',
  'Toestemming geven': 'Zueschtimmig gäh',
  'Technische code: {code}': 'Technische Code: {code}',
  'Deelnemers ({aantal})': 'Teilnämer ({aantal})',
  'Nog geen deelnemers.': 'No kei Teilnämer.',
  'Deze vergadering geeft geen deelnemerslijst.':
      'Die Bsprechig git kei Teilnämerlischte.',
  'gast': 'Gascht',
  'deelnemer': 'Teilnämer',
  'presentator': 'Referänt',
  'moderator': 'Moderator',
