...
const _stringsGsw = {
  ...
  'exportNeedsSave': 'Speicher d Präsentation zerscht zum exportiere',
  'exportNeedsClean': 'Speicher dini Änderige zerscht zum exportiere',
  'saved': 'Gspeicheret',
  'unsaved': 'Nöd gspeicheret',
  'unsavedChanges': 'Änderige speichere (Ctrl/Cmd+S)',
  'noUnsavedChanges': 'Kei ungspeicherti Änderige',
  'notSavedYet': 'No nöd gspeicheret',
  'noFileYet': 'Die Präsentation het no kei Datei',
  'slides': 'Slides',
  'skipped': 'übersprunge',
  'allSlidesIncluded': 'Alli Slides werded presentiert und exportiert',
  'skippedSlidesExcluded': 'Slide(s) werded nöd presentiert oder exportiert',
  'styleProfile': 'Stilprofil',
  'classification': 'Klassifizierig',
  'exportNextToDeck': 'Export näbem Deck',
  'exportsNextToDeck': 'Exports werded näbem Deck gspeicheret',
  'exportFolder': 'Export',
  'newPresentationTab': 'Nöi Präsentation (Tab)',
  'exportPackage': 'Paket exportiere…',
  'importPackage': 'Paket importiere…',
  ...
  'exportIntro':
      'De Export bruucht gnau d Vorschau usem Editor, inklusiv dim Stilprofil.',
...
const _dutchSourceGsw = {
  ...
  'Laatste reeks als lijn op een tweede as; de rest als staven.':
      'Letschti Reie als Linie uf ere zweite Achs; d Rescht als Balke.',
  'Eerste reeks: elke waarde is een op- of neerwaartse stap op het vorige totaal.':
      'Erschti Reie: jede Wärt isch e Schritt ufe oder abe uf em laufende Total.',
  'Reeks = rij, kolom = label, celkleur volgt de waarde. Label de assen kans en impact voor een risicomatrix.':
      'Reie = Zile, Spalte = Beschriftig, d Zällefarb folgt em Wärt. Beschrift d Achse mit Wahrschinlichkeit und Uswirkig für e Risikomatrix.',
  ...
  'Vertrouwelijkheid': 'Vertroulechkeit',
  'Integriteit': 'Integrität',
  'Beschikbaarheid': 'Verfüegbarkeit',
  'Detailslide toevoegen': 'Detailfolie zuefüege',
  'Bewijsslide toevoegen': 'Nachwiisfolie zuefüege',
  'CIA-gewogen': 'CIA-gwichtet',
  'Severity (bevindingen)': 'Schweregrad (Befund)',
  ...
  'Certificering': 'Zertifizierig',
  'Nog niet ondertekend': 'Nonig unterschribe',
  'Nog niet verzegeld': 'Nonig versieglet',
  'Verzegeld op': 'Versieglet am',
  ...
  'Mogelijke impact': 'Möglichi Uswirkig',
  'Aanbeveling': 'Empfählig',
  'Bevinding-id': 'Befund-ID',
  'Controleer de CVSS-vector': 'CVSS-Vektor prüefe',
  'Notitie': 'Notiz',
  'Status': 'Status',
  'getoetst': 'teschtet',
  ...
  'Niet-opgeslagen werk herstellen?': 'Nöd gspicherti Arbet widerhärstelle?',
  ...
  'Plak de link naar een .ocideck-pakket of een Marp-markdownbestand.':
      'Kläb de Link zu me .ocideck-Paket oder eme Marp-Markdown-File ie.',
  'Ophalen': 'Abhole',
  'Laat los om toe te voegen': 'Loslah zum zuefüege',
  'Afbeeldingen → nieuwe slides · .md / .ocideck → openen':
      'Bilder → nöi Slides · .md / .ocideck → uufmache',
  'Open eerst een presentatie om afbeeldingen toe te voegen.':
      'Mach zerscht e Presentation uuf, bevor du Bilder zuefüegsch.',
  'Alle slides zijn overgeslagen — niets om te tonen.':
      'Alli Slides sind übersprunge, drum git\'s nüt zum zeige.',
  'Alle slides zijn overgeslagen — niets om te exporteren.':
      'Alli Slides sind übersprunge, drum git\'s nüt zum exportiere.',
  'Kon dit pakket niet importeren.': 'Ha das Paket nöd chöne importiere.',
  'Pakket geëxporteerd naar:': 'Paket exportiert nach:',
  'Export mislukt:': 'Export fehlgschlage:',
  'Deze slide kan geen afbeelding ontvangen. Kies eerst een afbeeldingsslide.':
      'Die Slide cha kes Bild empfah. Wähl zerscht e Bild-Slide.',
  'Kon van deze URL geen presentatie ophalen.':
      'Ha vo dere URL kei Presentation chöne abhole.',
  'Sleep om de slide-preview breder of smaller te maken':
      'Zieh zum d Slide-Vorschau breiter oder schmäler mache',
  'TLP-classificatie (Traffic Light Protocol)':
      'TLP-Klassifizierig (Traffic Light Protocol)',
  'Titelpagina': 'Titel-Slide',
  'Tussentitel': 'Abschnittsüberschrift',
  'Alleen Bullets': 'Nu Bullets',
  'Twee Bulletkolommen': 'Zwei Bullet-Spalte',
  'Bullets + Afbeelding': 'Bullets + Bild',
  ...
  'Weer tonen bij presenteren/exporteren':
      'Bim Presentiere/Exportiere wider zeige',
  'Overslaan bij presenteren/exporteren':
      'Bim Presentiere/Exportiere überspringe',
  'Kopiëren': 'Kopiere',
  'Kopieer als afbeelding': 'Als Bild kopiere',
  'Dupliceren': 'Duplizere',
  'Niet meer overslaan': 'Nöd überspringe',
  'Overslaan': 'Überspringe',
  'Titel': 'Titel',
  'Titel (optioneel)': 'Titel (optional)',
  'Slide titel': 'Slide-Titel',
  'Ondertitel': 'Undertitel',
  'Subtitel': 'Undertitel',
  'Optionele subtitel': 'Optionale Undertitel',
  'Bullets': 'Bullets',
  'Bullet toevoegen': 'Bullet zuefüege',
  'Verwijder': 'Ewägnäh',
  'Citaat': 'Zitat',
  'Citaat tekst...': 'Zitat-Täxt...',
  'Auteur': 'Autor',
  'Naam van de auteur': 'Name vom Autor',
  ...
  'De afbeelding wordt schermvullend als achtergrond getoond met verminderde opaciteit zodat de tekst leesbaar blijft.':
      'S Bild wird bildschirmfüllend als Hintergrund zeigt mit verminderter Deckchraft, damit de Täxt läsbar bliibt.',
  'Zoom achtergrond': 'Hintergrund-Zoom',
  'Zoom afbeelding': 'Bild-Zoom',
  'Afbeelding (rechts)': 'Bild (rächts)',
  'Bullets (links)': 'Bullets (links)',
  'Breedte afbeeldingspaneel (rechts)': 'Breiti vom Bildpanel (rächts)',
  'Linker afbeelding': 'Links Bild',
  'Rechter afbeelding': 'Rächts Bild',
  'Verdeling (links / rechts)': 'Uufteilig (links / rächts)',
  ...
  'Afbeelding plakken uit klembord': 'Bild us em Zwüscheablag iiläse',
  'Kopieer afbeelding naar klembord': 'Bild is Zwüscheablag kopiere',
  'Afbeelding gekopieerd naar klembord.': 'Bild is Zwüscheablag kopiert.',
  'Kopiëren naar klembord mislukt.': 'Kopiere is Zwüscheablag fehlgschlage.',
  'Verwijder afbeelding': 'Bild ewägnäh',
  'Geen afbeelding gekozen': 'Kes Bild uusgwählt',
  'Caption / bronvermelding (bijv. © Naam Fotograaf)':
      'Bildlägände / Quälleaagab (z.B. © Name vom Fotograf)',
  'Caption / bronvermelding': 'Bildlägände / Quälleaagab',
  'Beschrijving (doorzoekbaar)': 'Beschribig (durchsuechbar)',
  ...
  'Zoek slides op tekst, titel, onderschrift, pad…':
      'Suech Slides nach Täxt, Titel, Bildlägände, Pfad…',
  'Zoek op presentatie, titel of tekst…':
      'Suech nach Presentation, Titel oder Täxt…',
  'Geen andere presentaties (.md) in deze map gevonden.':
      'Kei anderi Presentatione (.md) i dem Ordner gfunde.',
  'Geen slides gevonden voor': 'Kei Slides gfunde für',
  ...
  'Zoeken naar': 'Sueche',
  'Vervangen door': 'Ersetze durch',
  'Vervang': 'Ersetze',
  'Vorige': 'Vorherig',
  'Volgende': 'Nöchschti',
  'Vet': 'Fett',
  'Cursief': 'Kursiv',
  'Doorhalen': 'Durchgstriche',
  'Code': 'Code',
  'Link': 'Link',
  'Kop': 'Überschrift',
  'Hoofdlettergevoelig': 'Gross-/Chliischribig beachte',
  'Vervang alles': 'Alles ersetze',
  'Niets vervangen': 'Nüt ersetzt',
  'vervangen': 'ersetzt',
  'Geen resultaten': 'Kei Ergäbnis',
  'resultaat': 'Ergäbnis',
  'resultaten': 'Ergäbnis',
  'Nieuwe presentatie': 'Nöi Presentation',
  'Bijv. Kwartaalupdate Q4': 'Z.B. Q4-Update',
  'Vul een titel in': 'Gib en Titel ie',
  'Aanmaken': 'Erstelle',
  'Slide type kiezen': 'Slide-Typ wähle',
  'Presentatie-eigenschappen': 'Presentations-Eigeschafte',
  'Versie': 'Version',
  'Bijv. Jan Jansen': 'Z.B. Jane Doe',
  'Bijv. Vigilis': 'Z.B. Vigilis',
  'Bijv. 2026-05-30': 'Z.B. 2026-05-30',
  'Beschrijving': 'Beschribig',
  'Korte omschrijving van de presentatie':
      'Churzi Beschribig vo de Presentation',
  ...
  'Dit is een ingebouwd thema. Maak een kopie om kleuren aan te passen.':
      'Das isch es igbouts Thema. Mach es Duplikat, zum d Farbe aapasse.',
  'Donkere interface': 'Dunkli Oberflächi',
  'Lettertype interface': 'Schrift vo dr Oberflächi',
  'Past contrast, invoervelden en systeemcomponenten aan.':
      'Passt Kontrascht, Igabfälder und Systemkomponänte aa.',
  'Hoofdkleur en bovenbalk': 'Hauptfarb und obere Balke',
  'Knoppen en accenten': 'Chnöpf und Aakzänt',
  'Schermachtergrond': 'Bildschirm-Hintergrund',
  'Kaarten en dialogen': 'Charte und Dialög',
  'Gedempte tekst': 'Gedämpfte Täxt',
  'Zijpanelen': 'Sitepaneel',
  ...
  'Standaardprofiel laden': 'Standardprofil lade',
  ...
  'Tabel koptekst': 'Tabälle-Chopftäxt',
  'Titelachtergrond': 'Titel-Hintergrund',
  'Titeltekst': 'Titeltäxt',
  'Sectieachtergrond': 'Abschnitt-Hintergrund',
  'Geselecteerd': 'Uusgwählt',
  'Logo': 'Logo',
  'Geen logo ingesteld': 'Kes Logo iigstellt',
  'Verwijder logo': 'Logo etferne',
  'Logo positie': 'Logo-Position',
  'Linksboven': 'Obe links',
  'Rechtsboven': 'Obe rächts',
  'Linksonder': 'Une links',
  'Rechtsonder': 'Une rächts',
  'Footertekst': 'Footer-Täxt',
  'bijv. Vertrouwelijk · {title} · {date}':
      'z. B. Vertroulich · {title} · {date}',
  ...
  'Tokens: {page}, {total}, {date}, {title}. Footer verschijnt op alle slides behalve titel- en sectieslides, tenzij je hem per slide uitzet.':
      'Tokens: {page}, {total}, {date}, {title}. De Footer erschiint uf allne Slides usser Titel- und Abschnitt-Slides, ussert du schaltisch en pro Slide us.',
  'Links': 'Links',
  'Midden': 'Mitti',
  'Rechts': 'Rächts',
  'Paginanummers tonen (rechtsonder)': 'Sitezahle zeige (une rächts)',
  'Voorvertoning': 'Vorschau',
  'De snelle bruine vos springt over de luie hond.':
      'De schnäll bruun Fuchs gumpet über de fuul Hund.',
  'Preview': 'Vorschau',
  'Uitzoomen': 'Uuszoome',
  'Uitgezoomd': 'Uuszoomt',
  'Inzoomen': 'Iizoome',
  ...
  'Volledig zichtbaar (100%)': 'Ganz sichtbar (100%)',
  'Uitzoomen (meer van de foto zichtbaar)': 'Uuszoome (meh vom Foto sichtbar)',
  'Inzoomen (minder van de foto zichtbaar)':
      'Iizoome (weniger vom Foto sichtbar)',
  'Terugzetten (volledige afbeelding zichtbaar)':
      'Zrugsetze (ganzs Bild sichtbar)',
  'Zoom resetten': 'Zoom zrugsetze',
  'Preview inklappen': 'Vorschau iklappe',
  'Preview uitklappen': 'Vorschau uusklappe',
  'Vorige slide': 'Vorherigi Slide',
  'Volgende slide': 'Nächschti Slide',
  'paginering aan': 'Sitezählig aa',
  'Thema': 'Thema',
  'volledig deck': 'ganzs Deck',
  'Slide': 'Slide',
  'TYPE': 'TYP',
  'STIJL': 'STIL',
  ...
  'Controleren': 'Syntax prüefe',
  'Syntaxproblemen gevonden': 'Syntaxprobläm gfunde',
  'De markdown bevat': 'S Markdown enthaltet',
  'fout(en) en': 'Fähler und',
  'waarschuwing(en). Slides kunnen daardoor verkeerd worden ingelezen.':
      'Warnig(e). Slides chönd dodurch falsch iigläse werde.',
  'Terug naar editor': 'Zrug zum Editor',
  'Toch toepassen': 'Trotzdem aawände',
  'Geen syntaxproblemen gevonden': 'Kei Syntaxprobläm gfunde',
  'fout(en),': 'Fähler,',
  'waarschuwing(en)': 'Warnig(e)',
  'Afbeelding kiezen': 'Bild uuswähle',
  'Afbeeldingen laden…': 'Bilder lade…',
  'Sluiten (Esc)': 'Zuemache (Esc)',
  'Zoek op naam of beschrijving…': 'Nach Name oder Beschribig sueche…',
  'Raster': 'Raschter',
  'Coverflow': 'Coverflow',
  'Geen afbeeldingen gevonden': 'Kei Bilder gfunde',
  ...
  'Het bestand wordt permanent van schijf verwijderd. Deze actie kan niet ongedaan worden gemaakt.':
      'S File wird permanent vo dr Feschtplatte glöscht. Die Aktion cha nöd rückgängig gmacht werde.',
  'Let op: deze afbeelding wordt nog gebruikt in':
      'Achtig: Das Bild wird no bruucht i',
  'Verwijderen maakt die slides leeg. Dit kan niet ongedaan worden gemaakt.':
      'S Lösche macht die Slides leer. Das cha nöd rückgängig gmacht werde.',
  '↑↓←→ navigeren  ·  Enter kiezen  ·  Dubbelklik selecteert':
      '↑↓←→ navigiere  ·  Enter uuswähle  ·  Dopplet-Klick wählt uus',
  'Sneltoetsen': 'Tastecho',
  'Toetsenlegenda': 'Tastelegändi',
  'spatie': 'Leertaste',
  'klik': 'Klick',
  'cijfers': 'Zahle',
  ...
  'Eerste · laatste slide': 'Erschti · letschti Slide',
  'Slide-overzicht': 'Slide-Übersicht',
  'Slide-overzicht (pijltjes + Enter)': 'Slide-Übersicht (Pfyl + Enter)',
  'Presenter view (notities, klok)': 'Präsentatorvyou (Notize, Uhr)',
  ...
  'VOLGENDE': 'NÄCHSCHTI',
  'NOTITIES': 'NOTIZE',
  'Einde van de presentatie': 'Änd vo dr Präsentation',
  'Verstreken': 'Verstriche',
  'Klok': 'Uhr',
  'Geen notities voor deze slide.': 'Kei Notize für die Slide.',
  'Mijn notities': 'Mini Notize',
  'Gebruikersnotities': 'Benutzernotize',
  'Gebruikersnotities voor deze slide...': 'Benutzernotize für die Slide...',
  ...
  'P publiek · H legenda · S scherm · G overzicht · B/W zwart/wit · R tijd · Esc stop':
      'P Publikum · H Legändi · S Bildschirm · G Übersicht · B/W schwarz/wyss · R Zit · Esc Stopp',
  'pijltjes + Enter of klik om te springen':
      'Pfyl + Enter oder klicke zum Springe',
  'Afsluiten (Escape)': 'Verlah (Escape)',
  'Sluiten (G of Esc)': 'Zuemache (G oder Esc)',
  'Slide renderen…': 'Slide rändere…',
  'Slide gekopieerd naar klembord.': 'Slide is Zwischeablag kopiert.',
  'Kopiëren mislukt.': 'Kopiere fählgschlage.',
  'Geen ander deck open. Open eerst een ander tabblad.':
      'Kei anders Deck offe. Mach zerscht en andere Tab uf.',
  '1 slide kopiëren naar…': '1 Slide kopiere zu…',
  'slides kopiëren naar…': 'Slides kopiere zu…',
  'slide(s) gekopieerd naar': 'Slide(s) kopiert nach',
  '1 slide geïmporteerd.': '1 Slide importiert.',
  'slides geïmporteerd.': 'Slides importiert.',
  'Export wordt voorbereid…': 'Export wird vorbereitet…',
  'tip(s)': 'Hiiwiis(e)',
  'fout(en)': 'Fähler',
  'Kwaliteitsoverzicht': 'Qualitäts-Überblick',
  'Bekijk meldingen…': 'Mäldige aaluege…',
  'Bekijk alle meldingen…': 'Alli Mäldige aaluege…',
  'Tips': 'Hiiwiis',
  'Waarschuwingen': 'Warnige',
  'Fouten': 'Fähler',
  'Tip: voeg alt-tekst / bijschrift toe voor toegankelijkheid':
      'Tipp: Alt-Text / Bildunterschrift für d Zuegänglichkeit hinzuefüege',
  'Zoek in slides…': 'In de Slides sueche…',
  'Geen slides met': 'Kei Slides mit',
  'SLIDES': 'SLIDES',
  'Geen afbeelding op het klembord gevonden.':
      'Kei Bild uf em Zwüscheablag gfunde.',
  'Afbeelding plakken': 'Bild iifüege',
  'Slide toevoegen': 'Slide hinzuefüege',
  'Slide plakken': 'Slide iifüege',
  '1 slide overgeslagen': '1 Slide übersprunge',
  'slides overgeslagen': 'Slides übersprunge',
  'Alles tonen': 'Alli zeige',
  'geselecteerd': 'usgwählt',
  'Kopiëren naar ander deck': 'In es anders Deck kopiere',
  'Weer tonen': 'Wider zeige',
  ...
  'OciDeck verzamelt geen statistieken en stuurt uit zichzelf niets naar buiten. Standaard blijft alles op dit apparaat. Gegevens verlaten dit apparaat alleen als jij dat kiest:\n\n•  Nextcloud/WebDAV: verbind je met een server, dan worden je inlognaam en wachtwoord bewaard (het wachtwoord veilig in de sleutelbos van je systeem) en worden de presentaties die je opent of opslaat naar die server verstuurd.\n•  Openen via URL: OciDeck haalt het bestand op van het adres dat je invoert.\n•  Online media (staat standaard uit): indien ingeschakeld laadt OciDeck afbeeldingen en video\'s van de adressen in je dia\'s.\n•  Externe links (zoals de online licentie) openen in je browser.':
      'OciDeck sammlet kei Statistike und schickt vo sich us nüt use. Standardmässig bliibt alles uf däm Grät. Date verlönd das Grät nume, wänn du das wählsch:\n\n•  Nextcloud/WebDAV: Wänn du di mit eme Server verbindisch, wärded din Login-Name und s Passwort gspeicheret (s Passwort sicher im Schlüsselbund vo dim System) und d Präsentatione, wo du öffnisch oder speicherisch, wärded uf de Server gschickt.\n•  Öffne über URL: OciDeck holt s Datei vo de Adrässe, wo du iigisch.\n•  Online-Medie (standardmässig us): Wänn iigschalte, ladt OciDeck Bilder und Video vo de Adrässe in dine Slides.\n•  Extärni Links (wie d Online-Lizänz) öffned sich in dim Browser.',
  'OciDeck wordt geleverd onder de European Union Public Licence v1.2. Door akkoord te gaan aanvaard je deze licentie. Je mag OciDeck gebruiken, kopiëren, aanpassen en verspreiden onder de voorwaarden van de EUPL 1.2.':
      'OciDeck wird under de European Union Public Licence v1.2 usgliifert. Mit em Iiverständnis akzeptiersch du die Lizänz. Du dörfsch OciDeck under de Bedingige vo de EUPL 1.2 bruuche, kopiere, aapasse und verbreite.',
  'Om te werken en je werk niet te verliezen, bewaart OciDeck gegevens lokaal op dit apparaat:\n\n•  Je instellingen en voorkeuren (taal, mappen, stijl- en weergaveprofielen, recente bestanden).\n•  Je presentatiematerialen: de presentaties die je opslaat, automatische herstelkopieën en bijlagen zoals afbeeldingsbeschrijvingen.\n•  Deze toestemmingskeuze.\n\nJe kunt dit verwijderen door de bestanden te wissen of de instellingen te resetten.':
      'Zum schaffe und zum din Arbet nöd verlüre, speicheret OciDeck Date lokal uf däm Grät:\n\n•  Dini Iistellige und Voriistellige (Sprach, Ordner, Stil- und Aazeigeprofil, letschti Datei).\n•  Dini Präsentationsmaterialie: d Präsentatione, wo du speicherisch, automatischi Wiederherstelligskopie und Aahäng wie Bildbeschriibige.\n•  Die Iiwilligungswahl.\n\nDu chasch das ewägmache, indem du d Datei löschsch oder d Iistellige zrucksetzisch.',
  'Volledige licentie online (23 officiële taalversies)':
      'Ganzi Lizänz online (23 offizielli Sprachversione)',
  'Wat OciDeck op dit apparaat bewaart': 'Was OciDeck uf däm Grät speicheret',
  'Wat je apparaat verlaat': 'Was dis Grät verlaht',
  'Vul server-URL en gebruikersnaam in': 'Server-URL und Benutzername iigäh',
  'Verbinding mislukt': 'Verbindig fehlgschlage',
  'Aanmelden mislukt — controleer gebruikersnaam en wachtwoord':
      'Aamäldig fehlgschlage — kontrollier Benutzername und Passwort',
  'De server staat op een privé-adres. Vink "Vertrouwde interne server" aan om verbinding toe te staan.':
      'De Server isch uf ere private Adrässe. Häkle "Vertraute intärni Server" aa, zum d Verbindig z erlaube.',
  'Map niet gevonden op de server': 'Ordner uf em Server nöd gfunde',
  'Ongeldige server-URL': 'Ungültigi Server-URL',
  ...
  'Submap (optioneel)': 'Underordner (optional)',
  'Vertrouwde interne server': 'Vertraute intärni Server',
  'Nodig wanneer de server op een privé- of thuisnetwerk (LAN) draait. Sta alleen verbindingen toe naar servers die je zelf vertrouwt.':
      'Nötig, wänn de Server uf eme private oder Heimnetz (LAN) lauft. Erlaub nume Verbindige zu Server, wo du selber vertraussch.',
  'Verbinding testen': 'Verbindig teste',
  ...
  'Gevonden:': 'Gfunde:',
  'Regel': 'Ziile',
  'Scriptuitvoering': 'Skript-Usfüehrig',
  'Ingesloten inhoud': 'Iigebettete Inhalt',
  'Onveilige URL': 'Unsicheri URL',
  'Zoekopdracht wissen': 'Suech lösche',
  'Bullet verwijderen': 'Bullet entfärne',
  'Kolom verwijderen': 'Spalte entfärne',
  'Rij omhoog': 'Ziile uf',
  'Rij omlaag': 'Ziile ab',
  'Optie verwijderen': 'Option entfärne',
  'Optie toevoegen': 'Option hinzuefüege',
  'Duur verkorten': 'Duur verchürze',
  'Duur verlengen': 'Duur verlängere',
  'Afspelen': 'Abspiele',
  'Pauzeren': 'Pausiere',
  'Opsommingsteken': 'Bullet',
  'Stip': 'Punkt',
  'Pootje': 'Pfötli',
  'In tweeën splitsen': 'In zwei teile',
  'Uitgevoerde controles': 'Usgfüehrti Kontrolle',
  'Contrast en leesbaarheid van tekstkleuren':
      'Kontrast und Läsbarkeit vo de Textfarbe',
  'Alt-teksten en bijschriften van afbeeldingen, grafieken en media':
      'Alt-Text und Bildunterschrifte vo Bilder, Diagramm und Medie',
  'Aanwezigheid van gekoppelde mediabestanden':
      'Vorhandesii vo verlinkte Mediedatei',
  'Tekstdichtheid: bullets, woorden, quotes, tabellen en code':
      'Textdichti: Bullets, Wörter, Zitat, Tabälle und Code',
  'Thema, slides, footer, checklist en titels over afbeeldingen, getoetst aan WCAG AA (4,5:1 voor tekst, 3:1 voor grote tekst).':
      'Thema, Slides, Footer, Checkliste und Titel über Bilder, gprüeft nach WCAG AA (4,5:1 für Text, 3:1 für grosse Text).',
  'Elke afbeelding, grafiek, video en audio heeft een beschrijving nodig voor schermlezers en bijsluiters.':
      'Jedes Bild, Diagramm, Video und Audio bruucht e Beschriibig für Bildschirmläser und Handout.',
  'Verwijzingen naar afbeeldingen, video en audio worden gecontroleerd op een bestaand bestand in het project.':
      'Verwiise uf Bilder, Video und Audio wärded uf es vorhandes Datei im Projäkt gprüeft.',
  'Aantal en lengte van bullets, woorden, nesting, kolombalans en de dichtheid van quotes, titels, tabellen en code zodat alles leesbaar past.':
      'Aazahl und Längi vo Bullets, Wörter, Verschachtelig, Spaltebalance und d Dichti vo Zitat, Titel, Tabälle und Code, sodass alles läsbar passt.',
  'Bodytekst met contrast onder {crit}:1 telt als fout; daarboven tot de AA-norm als waarschuwing.':
      'Fliesstext mit Kontrast under {crit}:1 zellt als Fähler; drüber bis zur AA-Norm als Warnig.',
  'Geen drempelwaarde: een niet-lege beschrijving is verplicht.':
      'Kei Schwällewärt: e nöd-läeri Beschriibig isch Pflicht.',
  'Geen drempelwaarde: het gekoppelde bestand moet binnen de projectmap bestaan.':
      'Kei Schwällewärt: s verlinkte Datei mues im Projäktordner existiere.',
  ...
  'Syntaxproblemen gekopieerd naar klembord.':
      'Syntaxproblem uf s Zwüscheablag kopiert.',
  'Online media': 'Online-Medie',
  'Online media staat uit': 'Online-Medie isch us',
  'Online media toestaan': 'Online-Medie erlaube',
  'Sta het live laden toe van afbeeldingen en video\'s via een URL en van YouTube/Vimeo-embeds. Standaard uit voor je privacy en veiligheid.':
      'Erlaub s live Lade vo Bilder und Video über e URL und vo YouTube/Vimeo-Embeds. Standardmässig us für dini Privatsphäre und Sicherheit.',
  'Bestandspad of URL (YouTube, Vimeo, .mp4 …)':
      'Dateipfad oder URL (YouTube, Vimeo, .mp4 …)',
  'Bestand kiezen': 'Datei uswähle',
  'Speel het segment van deze slide af in het voorbeeld en knip op het punt waar je wilt splitsen: het tweede deel komt op een nieuwe slide.':
      'Spiel s Segmänt vo dere Slide im Vorschau ab und schniid am Punkt, wo du wotsch teile: de zweit Teil chunt uf e neui Slide.',
  'Begin (sec)': 'Aafang (Sek)',
  'Einde (sec)': 'Ändi (Sek)',
  'einde': 'Ändi',
  'Knip de video op het huidige afspeelpunt':
      'Schniid s Video am aktuelle Abspielpunkt',
  'Speel de video eerst af in het voorbeeld':
      'Spiel s Video zerscht im Vorschau ab',
  'Knip hier': 'Da schniide',
  'Online': 'Online',
  ...
  'Markering': 'Markierig',
  'bijv. 2024': 'z.B. 2024',
  'Titel van gebeurtenis': 'Titel vom Ereignis',
  'Omschrijving (optioneel)': 'Beschriibig (optional)',
  'Soort vraag': 'Frag-Art',
  'Meerkeuze': 'Mehrfachuswahl',
  'Vraag': 'Frag',
  ...
  'Geef minstens één goed én één fout antwoord op.':
      'Gib mindeschtens ei richtigi und ei falschi Antwort a.',
  'Weergave': 'Aazeig',
  'Aantal getoonde opties': 'Aazahl aazeigti Optione',
  'Maximale antwoordtijd in seconden (0 = geen limiet)':
      'Maximali Antwortziit i Sekunde (0 = kei Limit)',
  'Bij een fout antwoord': 'Bi ere falsche Antwort',
  'Opnieuw proberen': 'Nomol probiere',
  'Doorgaan toestaan': 'Wiitermache erlaube',
  'Fout = niet doorgaan; de vraag moet opnieuw.':
      'Falsch = cha nöd wiiter; d Frog mues nomol gmacht werde.',
  'Fout = wel doorgaan, maar niet opnieuw doen.':
      'Falsch = cha wiiter, aber nöd nomol probiere.',
  'Afbeelding (optioneel)': 'Bild (optional)',
  'Breedte afbeelding': 'Bildbreiti',
  'Goed!': 'Richtig!',
  'Helaas, fout': 'Leider falsch',
  'van': 'vo',
  'opties worden willekeurig getoond': 'Optione werde zuefällig aazeigt',
  'antwoordtijd': 'Antwortziit',
  'bij fout: opnieuw proberen': 'bi falsch: nomol probiere',
  'bij fout: door, niet opnieuw': 'bi falsch: wiiter, nöd nomol',
  'Beantwoord eerst de vraag.': 'Beantworte zerscht d Frog.',
  'Klik om opnieuw te proberen': 'Klick zum nomol probiere',
  'Juist / Onjuist': 'Richtig / Falsch',
  'Meerdere juiste antwoorden': 'Mehreri richtigi Antworte',
  'Stelling': 'Uussag',
  ...
  'Dit is het ingebouwde schema. Maak een kopie om kleuren aan te passen.':
      'Das isch s iigbaute Schema. Mach e Kopie zum d Farbe apasse.',
  'Goed': 'Guet',
  'Waarschuwing': 'Warnig',
  'Kritiek': 'Kritisch',
  'Te laag (koud)': 'Z tüüf (chalt)',
  'Lucht (horizon)': 'Himmel (Horizont)',
  'Grond (horizon)': 'Bode (Horizont)',
  'De statuskleuren volgen het cockpit-kleurschema; pas het aan of maak varianten via Instellingen → Cockpit.':
      'D Statusfarbe folge em Cockpit-Farbschema; pass es a oder mach Variante über Iistellige → Cockpit.',
  'Veel bullets op deze slide': 'Vill Bullets uf dere Slide',
  'bullets': 'Bullets',
  'Overweeg de inhoud te splitsen.': 'Überlegg der, de Inhalt z splitte.',
  'Erg veel bullets op deze slide': 'Z vill Bullets uf dere Slide',
  'Splits deze inhoud over meerdere slides.':
      'Splitt de Inhalt über mehreri Slides.',
  'Veel woorden in bullets': 'Vill Wörter i de Bullets',
  'woorden': 'Wörter',
  'Maak bullets korter of splits de slide.':
      'Mach d Bullets chürzer oder splitt d Slide.',
  'Erg veel woorden in bullets': 'Z vill Wörter i de Bullets',
  'Gemiddeld lange bullets': 'Im Schnitt langi Bullets',
  'woorden per bullet': 'Wörter pro Bullet',
  'Maak elke bullet kernachtiger.': 'Mach jede Bullet chnackiger.',
  'Bullet met meerdere zinnen gevonden. Maak bullets kernachtiger of splits de inhoud.':
      'Bullet mit mehrere Sätz gfunde. Mach d Bullets chnackiger oder splitt de Inhalt.',
  'Diepe bulletniveaus gevonden': 'Tüüfi Bulletniveaus gfunde',
  'niveau': 'Niveau',
  'Beperk nesting voor betere leesbaarheid.':
      'Begränz d Verschachtelig für besseri Läsbarkeit.',
  'Twee kolommen zijn sterk uit balans':
      'Zwei Kolonne sind stark im Unglichgwicht',
  'tegenover': 'gäge',
  'Verdeel of splits de inhoud.': 'Verteil oder splitt de Inhalt.',
  'Slidetitel': 'Slidetitel',
  'Cockpitmeters': 'Cockpit-Mäter',
  'Meter toevoegen': 'Mäter hinzuefüege',
  'Animeren bij binnenkomst': 'Bim Iiträte animiere',
  'Activatieduur': 'Aktivierigsduur',
  'Splits slide': 'Slide splitte',
  'Doornummeren vanaf vorige slide': 'Wiiternummeriere ab vorige Slide',
  'Begin de nummering waar de vorige slide ophield.':
      'Fang mit em Nummeriere dört a, wo d vorig Slide ufghört het.',
  'Volg thema-animatieduur': 'Thema-Animationsduur folge',
  'Animatie bij openen': 'Bim Öffne animiere',
  'Meter': 'Mäter',
  'Type': 'Typ',
  'Waarde': 'Wärt',
  'Eenheid': 'Eiheit',
  'Pitch': 'Pitch',
  'Bank': 'Bank',
  'Werkelijk': 'Tatsächlich',
  'Doel': 'Ziel',
  'Markeringslabel': 'Markierigslabel',
  'Min': 'Min',
  'Max': 'Max',
  'Neutraal van': 'Neutral vo',
  ...
  'Hoogtemeter': 'Höhemäter',
  'Stijgen/dalen': 'Stiige/Sinke',
  'Kunstmatige horizon': 'Horizont',
  'Koers': 'Kurs',
  'Ander profiel kiezen': 'Es anders Profil wähle',
  ...
  'Volgende slide of pagina': 'Nächsti Slide oder Siite',
  'Vorige pagina': 'Vorig Siite',
  'Vorige slide of pagina': 'Vorig Slide oder Siite',
  'Toegankelijkheid': 'Zuegänglichkeit',
  'Presentatie': 'Presentation',
  'Tabel kopachtergrond': 'Tabälle-Chopfhintergrund',
  'Doeltijd': 'Zielziit',
  ...
  'Tijd & oefenrun resetten': 'Ziit & Oebigsrun zrugsetze',
  'Resterend': 'Restlich',
  'Over de tijd': 'Über de Ziit',
  'Binnen de tijd': 'I de Ziit',
  'Deze slide': 'Die Slide',
  'Oefenrun': 'Oebigsrun',
  'Totaal': 'Total',
  'Totale tijd': 'Totali Ziit',
  ...
  'Toont afgevinkt en niet afgevinkt als percentages.':
      'Zeigt aagchrüzti und nöd aagchrüzti Iiträg als Prozänt.',
  'Afgevinkt': 'Aagchrüzt',
  'Niet afgevinkt': 'Nöd aagchrüzt',
  'Er zijn geen aangevinkte checklist-items om te legen.':
      'Es git kei aagchrüzti Checklischte-Iiträg zum leere.',
  'Alle checkboxen legen?': 'Alli Checkboxe leere?',
  'Hiermee worden alle': 'Das chrüzt alli',
  'aangevinkte checklist-items in de hele presentatie uitgevinkt. Dit kun je ongedaan maken met Ctrl/Cmd+Z.':
      'aagchrüzti Checklischte-Iiträg i de ganze Presentation us. Das chasch mit Ctrl/Cmd+Z rückgängig mache.',
  'Alles legen': 'Alles leere',
  'checklist-items uitgevinkt.': 'Checklischte-Iiträg usgchrüzt.',
  'Alle checkboxen legen': 'Alli Checkboxe leere',
  'Afgevinkte tekst doorhalen': 'Aagchrüzte Text durchstriche',
  'Toont een streep door voltooide checklistitems.':
      'Zeigt fertigi Checklischte-Iiträg mit eme Durchstrich.',
  'Na media automatisch doorgaan': 'Nach Media automatisch wiiter',
  'Opsomming': 'Bullets',
  'Nummering': 'Nummerierig',
  'Varianten': 'Variante',
  'Grafiekvarianten maken': 'Grafikvariante mache',
  'Slides toevoegen': 'Slides hinzuefüege',
  'Omhoog': 'Ufe',
  'Omlaag': 'Abe',
  'Niet toevoegen': 'Nöd hinzuefüege',
  'Deze slides gebruiken dezelfde data, kleuren en titel. Kies met de pijlen de volgorde na de huidige slide.':
      'Die Slides bruuche di gliiche Date, Farbe und Titel. Bruuch d Pfiil zum ihri Reihefolg nach de aktuelle Slide z wähle.',
  'Afbeelding': 'Bild',
  'Broncode': 'Quällcode',
  'Bullet': 'Bullet',
  'Plak of typ hier je broncode...': 'Kläb oder tipp do dini Quällcode...',
  'Programmeertaal': 'Programmiersprach',
  'TLP van deze slide': 'TLP vo dere Slide',
  'Wis annotaties (C)': 'Annotatione lösche (C)',
  'Stoppen (Esc)': 'Stoppe (Esc)',
  'Pen · markeerstift · gum': 'Schtift · Markierer · Gummi',
  'Laser · annotaties wissen': 'Laser · Aamerkige lösche',
  'Grafiek': 'Diagramm',
  ...
  'Rij': 'Zile',
  'Reeks': 'Reihe',
  'Kleur van reeks': 'Farb vo de Reihe',
  'Kleur van rij': 'Farb vo de Zile',
  'Hexkleur': 'Hex-Farb',
  'Sorteren': 'Sortiere',
  'Oplopend sorteren': 'Ufschtiegend sortiere',
  'Aflopend sorteren': 'Abschtiegend sortiere',
  'Bij een cirkel worden maximaal de eerste twee reeksen getoond; de labels vormen de segmenten.':
      'Bimene Chueche wärded höchschtens die erschte zwei Reihe zeigt; d Label bilded d Segmänt.',
  'Een spider-diagram heeft minstens drie labels (assen) nodig; elke reeks vormt een vlak.':
      'Es Spider-Diagramm brucht mindeschtens drü Label (Achse); jedi Reihe bildet e Flächi.',
  'Een spider-diagram heeft minstens drie labels nodig':
      'Es Spider-Diagramm brucht mindeschtens drü Label',
  'Minimumlijn (optioneel)': 'Minimumlinie (optional)',
  'Maximumlijn (optioneel)': 'Maximumlinie (optional)',
  'Schaalminimum (optioneel)': 'Skala-Minimum (optional)',
  'Schaalmaximum (optioneel)': 'Skala-Maximum (optional)',
  'geen': 'kei',
  'Broncode achtergrond': 'Code-Hintergrund',
  'Broncode tekst': 'Code-Täxt',
  'Syntaxkleuring': 'Syntaxfärbig',
  'Uit = alles in één kleur (bijv. groen op zwart voor een CRT-scherm).':
      'Us = alles i einere Farb (z.B. grüen uf schwarz für en CRT-Bildschirm).',
  ...
  'PREVIEW': 'VORSCHAU',
  'Slides gerenderd.': 'Folie grändered.',
  'Standaard laatste slide gebruiken': 'Standard-letschti-Folie bruuche',
  'Wordt automatisch toegevoegd bij presenteren en exporteren.':
      'Wird automatisch dezuegfüegt bim Präsentiere und Exportiere.',
  'gerenderd.': 'grändered.',
  'renderen…': 'rändere…',
  'voorbereiden…': 'vorbereite…',
  'Duplicaten opruimen': 'Duplikat ufruume',
  'Zoek byte-identieke afbeeldingen (md5), voeg tags en opmerkingen samen en verwijder de kopieën':
      'Byte-identischi Bilder finde (md5), Tags und Aamerkige zämefüege und d Kopie entferne',
  'Geen dubbele afbeeldingen gevonden.': 'Kei doppleti Bilder gfunde.',
  'Dubbele afbeeldingen opruimen?': 'Doppleti Bilder ufruume?',
  'Van elke groep blijft één bestand staan. Tags en opmerkingen worden samengevoegd en slides die een kopie gebruiken verwijzen daarna naar het behouden bestand — ook in presentaties die nu niet geopend zijn.':
      'Vo jedere Gruppe blibt ei File schtah. Tags und Aamerkige wärded zämegfüegt und Folie wo e Kopie bruuched zeiged nachhär uf s bhaltene File — au i Präsentatione wo jetzt nöd offe sind.',
  'Opruimen': 'Ufruume',
  '1 presentatiebestand bijgewerkt.': '1 Präsentations-File aktualisiert.',
  'presentatiebestanden bijgewerkt.': 'Präsentations-Files aktualisiert.',
  'niet geopend': 'nöd offe',
  '1 dubbele afbeelding verwijderd.': '1 dopplets Bild entfernt.',
  'dubbele afbeeldingen verwijderd.': 'doppleti Bilder entfernt.',
  'Alleen afbeeldingen zonder tags tonen': 'Nu Bilder ohni Tags zeige',
  'Alle afbeeldingen hebben tags.': 'Alli Bilder händ Tags.',
  ...
  'Toestemming': 'Zueschtimmig',
  'Toestemming intrekken': 'Zueschtimmig zrugziah',
  'Toestemming intrekken?': 'Zueschtimmig zrugziah?',
  'Intrekken': 'Zrugziah',
  'U hebt al toegestemd in het gebruik van OciDeck.':
      'Du häsch em Gebruuch vo OciDeck scho zuegschtimmt.',
  'U kunt uw toestemming op elk moment intrekken. Na intrekking moet u deze voorwaarden opnieuw accepteren.':
      'Du chasch dini Zueschtimmig jederzit zrugziah. Nach em Zrugziah muesch du die Bedingige wider akzeptiere.',
  'Als u uw toestemming intrekt, moet u deze voorwaarden opnieuw accepteren wanneer u OciDeck opnieuw start.':
      'Wänn du dini Zueschtimmig zrugziahsch, muesch du die Bedingige wider akzeptiere, wänn du OciDeck neu schtartisch.',
  'Slidekwaliteit': 'Folie-Qualität',
  'Geen kwaliteitsproblemen gevonden': 'Kei Qualitätsprobläm gfunde',
  'Thema (hele presentatie)': 'Thema (ganzi Präsentation)',
  'Kwaliteitsprobleem': 'Qualitätsprobläm',
  'Kwaliteitsproblemen': 'Qualitätsprobläm',
  'Kwaliteitsproblemen (inclusief ernstige)':
      'Qualitätsprobläm (inklusiv schweri)',
  'Voeg alt-tekst / bijschrift toe voor toegankelijkheid':
      'Alt-Täxt / Bildunderschrift dezuefüege für Barrierefreiheit',
  'Alt-tekst': 'Alt-Täxt',
  'Tekstdichtheid': 'Täxtdichti',
  'Contrast': 'Kontrascht',
  'heeft geen bijschrift/alt-tekst.': 'hät kei Bildunderschrift/Alt-Täxt.',
  'contrastverhouding': 'Kontraschtverhältnis',
  '(minimaal ': '(mindeschtens ',
  ':1 voor normale tekst).': ':1 für normale Täxt).',
  ':1 voor grote tekst).': ':1 für grosse Täxt).',
  ':1).': ':1).',
  'Contrast van tekst op of over een afbeelding kan niet automatisch worden gecontroleerd — controleer visueel.':
      'Kontrascht vo Täxt uf oder über emene Bild cha nöd automatisch prüeft wärde — visuell kontrolliere.',
  'Grafiek heeft geen titel of beschrijvende data — voeg een titel of seriesnamen toe.':
      'S Diagramm hät kei Titel oder beschribendi Date — füeg en Titel oder Reihenäme dezue.',
  'heeft geen titel of sprekernotities die de inhoud beschrijven.':
      'hät kei Titel oder Sprächernotize wo de Inhalt beschribed.',
  'Veel tekst op deze slide: het lettertype wordt verkleind tot ':
      'Vill Täxt uf dere Folie: d Schriftgrössi wird verchleineret uf ',
  ...
  ' kolommen): celtekst staat op het minimumformaat.':
      ' Spalte): de Zälltäxt isch uf de Minimumgrössi.',
  'Veel broncode (': 'Vill Quällcode (',
  ' regels) — de tekst wordt sterk verkleind om te passen.':
      ' Zile) — de Täxt wird schtark verchleineret, damit er passt.',
  'Veel vrije markdown (': 'Vill freie Markdown (',
  ' regels) — controleer of alles leesbaar blijft op de slide.':
      ' Zile) — kontrolliere, öb alles läsbar blibt uf de Folie.',
  'Lange titelpagina (': 'Langi Titelfolie (',
  ' tekens) — de tekst wordt verkleind om te passen.':
      ' Zeiche) — de Täxt wird verchleineret, damit er passt.',
  'Thema bodytekst': 'Thema-Bodytäxt',
  'Thema titel': 'Thema-Titel',
  'Thema tabeltekst': 'Thema-Tabälletäxt',
  'Thema tabelkop': 'Thema-Tabällekopf',
  'Thema code': 'Thema-Code',
  'Thema accent': 'Thema-Akzänt',
  'Eerste afbeelding': 'Erschts Bild',
  'Tweede afbeelding': 'Zweits Bild',
  'Waarschuwing bij export': 'Warne bim Export',
  'Minimale contrastverhouding': 'Minimals Kontraschtverhältnis',
  'Tekst onder deze verhouding wordt gemarkeerd. 4.5 = WCAG AA, 3.0 = WCAG AA grote tekst. Hoger is strenger.':
      'Täxt under dem Verhältnis wird markiert. 4.5 = WCAG AA, 3.0 = WCAG AA grosse Täxt. Höcher isch schtränger.',
  'Vraag bevestiging voordat je exporteert wanneer er slide-kwaliteitsproblemen zijn.':
      'Frag nach ere Beschtätigung vor em Exportiere, wänn s Folie-Qualitätsprobläm hät.',
  'Kwaliteitsproblemen gevonden': 'Qualitätsprobläm gfunde',
  'Toch exporteren': 'Trotzdem exportiere',
  'ernstige probleem(en)': 'schweri Probläm',
  'De presentatie heeft kwaliteitsproblemen (':
      'D Präsentation hät Qualitätsprobläm (',
  'Lange quote (': 'Langs Zitat (',
  'Footer-tekst': 'Footer-Täxt',
  'Checklist (niet aangevinkt)': 'Checklischte (nöd aaghäklet)',
  'Checklist (aangevinkt)': 'Checklischte (aaghäklet)',
  ': bestand niet gevonden (': ': File nöd gfunde (',
  'Blokkeer export bij ernstige kwaliteitsproblemen':
      'Export bi schwere Qualitätsprobläm sperre',
  'Export is niet mogelijk zolang er fouten in de slide-kwaliteitscontrole staan.':
      'Export isch nöd möglich, solang d Folie-Qualitätskontrolle Fähler meldet.',
  ...
  'Hoogste TLP-niveau dat geëxporteerd mag worden. Leeg = geen plafond.':
      'Höchschts TLP-Niveau wo exportiert wärde dörf. Leer = kei Plafond.',
  'Vereist minimumniveau': 'Erforderlichs Minimum-Niveau',
  'Laagste classificatie die een deck moet hebben om te exporteren. Leeg = geen minimum.':
      'Tüfschti Klassifizierig wo es Deck muess ha zum exportiere. Leer = kei Minimum.',
  'Geen plafond': 'Kei Plafond',
  'Geen minimum': 'Kei Minimum',
  'Classificatie verplicht': 'Klassifizierig erforderlich',
  'Weiger export wanneer het deck geen TLP-niveau heeft.':
      'Export verweigere, wänn s Deck kei TLP-Niveau hät.',
  'Classificatie-watermerk': 'Klassifizierigs-Wasserzeiche',
  'Toon een diagonaal watermerk met TLP en organisatie op elke slide.':
      'Zeig es diagonals Wasserzeiche mit TLP und Organisation uf jedere Folie.',
  ...
  '"Oci" verwijst naar de ocicat, het kattenras van de katten van Brenno de Winter. "Deck" is het Engelse woord voor een diaset. OciDeck maakt van eenvoudige tekst een verzorgde presentatie.':
      '"Oci" wiist uf d Ocicat, d Chatzerass vo de Chatze vom Brenno de Winter. "Deck" isch s änglisch Wort für e Foliesatz. OciDeck macht us eifachem Text e gschtalteti Präsentation.',
  'Adressen': 'Adrässe',
  'Bestuur': 'Vorschtand',
  'Beveiliging': 'Sicherheit',
  'Brenno de Winter (voorzitter), Jan Klopper (secretaris) en Astrid Oosenbrug (penningmeester).':
      'Brenno de Winter (Presidänt), Jan Klopper (Sekretär) und Astrid Oosenbrug (Kassier).',
  'Contact': 'Kontakt',
  'De katten van Brenno': 'D Chatze vom Brenno',
  ...
  'OciDeck wordt uitgegeven door Stichting LibreKAT. De stichting werkt aan een veiligere digitale samenleving via open, controleerbare informatiebeveiliging, met de nadruk op kennisdeling, community-vorming en het ondersteunen van opensource-oplossingen.':
      'OciDeck wird vo de Stichting LibreKAT usegä. D Stiftig schaffet a nere sicherere digitale Gsellschaft über offeni, überprüfbari Informationssicherheit, mit em Schwärpunkt uf Wüsseteilig, Community-Bildig und em Ünderschtütze vo Opensource-Lösige.',
  'Over OciDeck': 'Über OciDeck',
  'Telefoon': 'Telefon',
  'Uitgever: Stichting LibreKAT': 'Userussgäber: Stichting LibreKAT',
...
const _dutchSourceAddGsw = <String, String>{
  ...
  'Aangemaakt op': 'Erstellt am',
  'Aanmeldprovider': 'Login-Anbieter',
  'Aanmeldsessies': 'Registrierungssitzungen',
  'Aantal controles': 'Anzahl der Schecks',
  ...
  'Activiteitnummer': 'Aktivitätsnummer',
  'Afgerond op': 'Gerundet auf',
  'Afgewezen': 'Abgelehnt',
  'Afspeelsessienummer': 'Nummer der Wiedergabesitzung',
  'Afwezig': 'Abwesend',
  'Antwoordgegevens': 'Antwortdetails',
  'Antwoordstatus': 'Antwortstatus',
  'Begint op': 'Beginnt am',
  'Begrippen uitgelegd': 'Konzepte erklärt',
  'Beheer van de installatie': 'Leitung der Installation',
  'Beheerpogingen': 'Managementbemühungen',
  'Bekeken lessen': 'Lektionen angesehen',
  'Beleidsversie': 'Richtlinienversion',
  'Beoordeeld': 'Bewertet',
  'Beoordeeld op': 'Bewertet von',
  'Beperking': 'Einschränkung',
  'Berekend op': 'Berechnet am',
  'Bericht': 'Nachricht',
  'Bestandsnaam': 'Dateiname',
  'Beveiligingsvraagnummer': 'Nummer der Sicherheitsfrage',
  'Bevestigd': 'Bestätigt',
  'Bevestigd op': 'Bestätigt am',
  'Bewaarregels': 'Aufbewahrungsregeln',
  'Bewaartermijn': 'Aufbewahrungsfrist',
  'Bewaren wegens een juridische verplichting':
      'Aufgrund einer gesetzlichen Verpflichtung aufbewahrt',
  'Bewerkingnummer bij aanmeldprovider':
      'Betriebsnummer beim Registrierungsanbieter',
  'Bewijsstukken': 'Beweise',
  'Bezwaar': 'Einspruch',
  'Beëindigd op': 'Endete am',
  'Bijeenkomstnummer': 'Sitzungsnummer',
  'Certificaatnummer': 'Zertifikatsnummer',
  'Certificaten': 'Zertifikate',
  'Controlecode van de PDF': 'Steuercode des PDF',
  'Controlecode van profielfoto': 'Bestätigungscode für das Profilfoto',
  'Controlecodes van bewijsstukken': 'Kontrollcodes der Belege',
  'Correctie': 'Korrektur',
  'Cursistnummer waarop de actie gericht was':
      'Studierendennummer, an die sich die Aktion richtete',
  'Cursusaanbodnummer': 'Kursangebotsnummer',
  'Cursusversienummer': 'Kursversionsnummer',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Datum und Uhrzeit werden in Ihrer Ortszeit angezeigt. Technische Namen bleiben sichtbar, wenn der Server ein unbekanntes Feld bereitstellt.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'Die Antworten, die Sie auf Testfragen gegeben haben.',
  'Deelnamenummer': 'Teilnehmernummer',
  'Deelnames': 'Beteiligungen',
  'Details': 'Einzelheiten',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Diese Kategorie wurde vom Server bereitgestellt. Die technischen Namen bleiben für Anfragen Ihrer Organisation sichtbar.',
  'Door uzelf aangevraagd': 'Von Ihnen selbst angefordert',
  'E-mailadres': 'E-Mail-Adresse',
  'E-mailberichten': 'E-Mail-Nachrichten',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'Eine ID ist eine eindeutige technische Nummer, die eLearning verwendet, um Daten miteinander zu verknüpfen. Es handelt sich nicht um eine Bewertung oder einen Status.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'Eine Kategorie gruppiert Daten zum gleichen Thema. Eine Registrierung ist ein gespeichertes Datenelement oder eine Veranstaltung.',
  'Eindigt op': 'Endet in',
  'Geaccepteerd op': 'Akzeptiert am',
  'Geannuleerd': 'Abgesagt',
  'Gecontroleerd': 'Geprüft',
  'Gecontroleerd op': 'Geprüft',
  'Geen gegevens gevonden': 'Keine Daten gefunden',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Informationen zu Aufbewahrungsfristen und zur Löschung Ihrer Daten.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Informationen zu Belegen, erzielten Ergebnissen und Zertifikaten.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Informationen zu Datenschutzanfragen und wer Ihre Informationen angezeigt oder geändert hat.',
  'Gegevens over uw accountbewerking': 'Informationen zu Ihrem Kontobetrieb',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Informationen zu Ihrer Anmeldung, Teilnahme und Ihrem Unterrichtsfortschritt.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Informationen zu Ihrem Profil, Konto und Ihrer Position innerhalb der Organisation.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Informationen zu Ihren Testmomenten und den gestellten Fragen.',
  'Gegevens over willekeurige volgorde': 'Daten in zufälliger Reihenfolge',
  'Gegevenscategorie': 'Datenkategorie',
  'Gekoppeld accountnummer': 'Verknüpfte Kontonummer',
  'Gekozen antwoorden': 'Ausgewählte Antworten',
  'Gelukt': 'Erfolg',
  'Geprobeerd op': 'Anprobiert',
  'Gerechtvaardigd belang': 'Berechtigtes Interesse',
  'Gereserveerd': 'Reserviert',
  'Gereserveerd op': 'Reserviert am',
  'Geslaagd': 'Bestanden',
  'Gestart op': 'Begonnen am',
  'Getoonde tijd per dia in milliseconden':
      'Pro Folie angezeigte Zeit in Millisekunden',
  'Herkomst van inschrijving': 'Herkunft der Registrierung',
  'Hoogst haalbare score': 'Höchstmögliche Punktzahl',
  'Identificatienummer bij aanmeldprovider':
      'Identifikationsnummer des Registrierungsanbieters',
  'Identiteitsbewerkingnummer': 'Nummer des Identitätsvorgangs',
  'In afwachting': 'Ausstehend',
  'In behandeling': 'In Bearbeitung',
  'In behandeling genomen op': 'Verarbeitet am',
  'In quarantaine': 'In Quarantäne',
  'Ingeleverd': 'Eingereicht',
  'Ingeleverd op': 'Eingereicht am',
  'Ingericht op': 'Auf dekoriert',
  'Ingeschreven op': 'Registriert am',
  'Ingetrokken': 'Zurückgezogen',
  'Ingetrokken op': 'Zurückgezogen am',
  'Inschrijvingen': 'Anmeldungen',
  'Inschrijvingsnummer': 'Registrierungsnummer',
  'Installatiebeveiligingslogboek': 'Sicherheitsprotokoll der Installation',
  'Installatienummer': 'Installationsnummer',
  'Installatieverzoeken': 'Installationsanfragen',
  'Inzage': 'Inspektion',
  'Ja': 'Ja',
  'Kwalificatienummer': 'Qualifikationsnummer',
  'Kwalificaties': 'Qualifikationen',
  'Laatst actief op': 'Zuletzt aktiv am',
  'Laatst bekeken dia': 'Zuletzt angesehene Folie',
  'Laatst gewijzigd op': 'Zuletzt geändert am',
  'Laatste fout': 'Letzter Fehler',
  'Lesnummer': 'Lektionsnummer',
  'Lesreserveringen': 'Unterrichtsreservierungen',
  'Lesvoortgang': 'Unterrichtsfortschritt',
  'Lidmaatschappen': 'Mitgliedschaften',
  'Locatie': 'Standort',
  'Manier van afronden': 'Art der Rundung',
  'Maximaal aantal controles': 'Maximale Anzahl von Schecks',
  'Maximaal aantal pogingen': 'Maximale Anzahl an Versuchen',
  'Maximale leeftijd van de aanmelding': 'Höchstalter für die Registrierung',
  'Mislukt': 'Fehlgeschlagen',
  'Naam van de activiteit': 'Name der Aktivität',
  'Naam van de bijeenkomst': 'Name des Treffens',
  'Nee': 'Nein',
  'Netwerkadres': 'Netzwerkadresse',
  'Niet actief': 'Nicht aktiv',
  'Niet geregistreerd': 'Nicht registriert',
  'Niet ingevuld': 'Nicht ausgefüllt',
  'Niet verschenen': 'Nicht veröffentlicht',
  'Niveau van extra aanmeldcontrole':
      'Grad der zusätzlichen Registrierungskontrolle',
  'Nummer van de toetsopzet': 'Nummer des Testplans',
  'Nummer van het brongegeven': 'Nummer der Quelldaten',
  'Nummer van uw verwijderde gegeven': 'Anzahl Ihrer gelöschten Daten',
  'Onderdeel {nummer}': 'Teil {nummer}',
  'Onderwerp van de actie': 'Gegenstand der Aktion',
  'Ontvanger': 'Empfänger',
  'Opgegeven bestandsgrootte': 'Angegebene Dateigröße',
  'Opgegeven bestandstype': 'Angegebener Dateityp',
  'Opgegeven controlecode': 'Angegebener Steuercode',
  'Opgeslagen bestandsgrootte': 'Gespeicherte Dateigröße',
  'Opgeslagen controlecode': 'Gespeicherter Steuercode',
  'Organisatienummer': 'Organisationsnummer',
  'Overdraagbaarheid': 'Übertragbarkeit',
  'PE-toekenningnummer': 'PE-Auszeichnungsnummer',
  'Poging': 'Versuch',
  'Positie': 'Position',
  'Privacyverzoeken': 'Datenschutzanfragen',
  'Probeer een andere zoekterm.':
      'Versuchen Sie es mit einem anderen Suchbegriff.',
  'Reden': 'Grund',
  'Reden of grondslag': 'Grund oder Grundlage',
  'Reden van afwijzing': 'Grund für die Ablehnung',
  'Reden van bevestiging': 'Grund für die Bestätigung',
  'Reden van intrekking': 'Grund für den Rückzug',
  'Reden voor langer bewaren': 'Grund für längere Lagerung',
  'Regels voor de cursusversie': 'Regeln für die Kursversion',
  'Resultaat bij de aanmeldprovider': 'Ergebnis beim Registrierungsanbieter',
  'Rol': 'Rollen',
  'Score': 'Punktzahl',
  'Soort aanwezigheid': 'Eine Art Präsenz',
  'Soort accountbewerking': 'Art der Kontooperation',
  'Soort gebeurtenis': 'Art der Veranstaltung',
  'Soort privacyverzoek': 'Art der Datenschutzanfrage',
  'Status van de bijeenkomst': 'Status der Besprechung',
  'Strenge beveiligingsmodus': 'Hochsicherheitsmodus',
  'Technisch toegangslogboek': 'Technisches Zugriffsprotokoll',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Technische Daten, die für die Registrierung, Sicherheit und zuverlässige Abwicklung erforderlich sind.',
  'Technische naam: {naam}': 'Technischer Name: {naam}',
  'Technische opslagcategorie': 'Kategorie der technischen Lagerung',
  'Technische opslaglocatie van de PDF': 'Technischer Speicherort des PDFs',
  'Tijdstip van aanmelding': 'Zeitpunkt der Anmeldung',
  'Tijdzone': 'Zeitzone',
  'Toestand': 'Zustand',
  'Toetspogingen': 'Testversuche',
  'Toetspogingnummer': 'Nummer des Testversuchs',
  'Uiterste inlevermoment': 'Frist für die Einreichung',
  'Uitgegeven op': 'Veröffentlicht am',
  'Uitgenodigd e-mailadres': 'Eingeladene E-Mail-Adresse',
  'Uitnodigingen': 'Einladungen',
  'Uniek nummer (ID)': 'Eindeutige Nummer (ID)',
  'Uniek verwerkingskenmerk': 'Einzigartige Verarbeitungsfunktion',
  'Uw accountnummer': 'Ihre Kontonummer',
  'Uw accountnummer als uitvoerder':
      'Ihre Kontonummer als Testamentsvollstrecker',
  'Uzelf als uploader': 'Sie selbst als Uploader',
  'Vaardigheidsversienummer': 'Skill-Versionsnummer',
  'Vast internetadres van de installatie':
      'Feste Internetadresse der Installation',
  'Vastgelegde beslisgegevens': 'Aufgezeichnete Entscheidungsdaten',
  'Vastgelegde gegevens': 'Aufgezeichnete Daten',
  'Vereist niveau van aanmeldzekerheid':
      'Erforderliches Maß an Registrierungssicherheit',
  'Vereiste aanmeldmethoden': 'Erforderliche Anmeldemethoden',
  'Verloopt bij inactiviteit op': 'Läuft bei Inaktivität ab',
  'Verloopt definitief op': 'Läuft dauerhaft ab',
  'Verloopt op': 'Läuft ab',
  'Versienummer van de PE-regel': 'Versionsnummer der PE-Regel',
  'Verwerkte verzoeken': 'Anfragen bearbeitet',
  'Verwijderd op': 'Entfernt am',
  'Verwijdering': 'Entfernung',
  'Verwijderingsregister': 'Umzugsregister',
  'Verwijzing naar het antwoord': 'Verweis auf die Antwort',
  'Verzoeknummer': 'Anfragenummer',
  'Verzoeknummer van de app': 'App-Anfragenummer',
  'Verzonden op': 'Weitergeschickt',
  'Volgende controle op': 'Nächste Kontrolle',
  'Volgnummer': 'Sequenznummer',
  'Volgorde van antwoordopties': 'Reihenfolge der Antwortmöglichkeiten',
  'Vraagnummer binnen de toetspoging': 'Fragenummer innerhalb des Testversuchs',
  'Vraagversienummer': 'Versionsnummer der Frage',
  'Vragen in toetspogingen': 'Fragen bei Testversuchen',
  'Vrijgegeven': 'Freigegeben',
  'Vrijgegeven op': 'Veröffentlicht am',
  'Wat gebeurt na de bewaartermijn':
      'Was passiert nach der Aufbewahrungsfrist?',
  'Wettelijke verplichting': 'Gesetzliche Verpflichtung',
  'Wijzigingen aan PE-punten': 'Änderungen an PE-Punkten',
  'Wijzigingen aan kwalificaties': 'Änderungen der Qualifikationen',
  'Wijzigingen in aanmeldbeveiliging': 'Änderungen an der Anmeldesicherheit',
  'Zekerheid': 'Gewissheit',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Suchen Sie beispielsweise nach Kurs, Datum oder Status',
  'Zoeken in uw gegevens': 'Durchsuchen Sie Ihre Daten',
  '{aantal} categorieën gevonden': '{aantal} Kategorien gefunden',
  'Aanwezigheid': 'Awäseheit',
  'Lidmaatschap': 'Mitgliedschaft',
  'Inzage en wijzigingen': 'Zugriff und Änderungen',
  'Beschikbaarheid van het inzagespoor': 'Verfügbarkeit des Zugriffsprotokolls',
  'Beschikbaar vanaf': 'Erhältlich ab',
  'Historie vóór deze datum': 'Geschichte vor diesem Datum',
  'Tijdstip': 'Datum und Uhrzeit',
  'Handeling': 'Aktion',
  'Gegevensonderdeel': 'Datenkategorie',
  'Handelde als': 'Als gehandelt',
  'Organisatorische rol': 'Organisatorische Rolle',
  'Bekeken': 'Gesehen',
  'Gewijzigd': 'Geändert',
  'Uzelf': 'Du',
  ...
  'Onbekend': 'Unbekannt',
  'Docent': 'Lehrer',
  'Beoordelaar': 'Gutachter',
  'Organisatiebeheerder': 'Organisationsadministrator',
  'Niet beschikbaar': 'Nicht verfügbar',
  'Uitoefening van privacyrechten': 'Ausübung von Datenschutzrechten',
  'Beoordeling en certificering': 'Bewertung und Zertifizierung',
  'Uitvoering van het leertraject': 'Lieferung des Lernprogramms',
  'Cursistenadministratie': 'Verwaltung der Lernenden',
  'Cursistprofiel': 'Lernerprofil',
  'Leerstatistieken': 'Statistik lernen',
  'Inschrijving': 'Einschreibung',
  'Toetspoging': 'Bewertungsversuch',
  'Beoordeling': 'Bewertung',
  'Bewijsstuk': 'Beweise',
  'Kwalificatie': 'Qualifikation',
  'Deelname': 'Teilnahme',
  'PE-punten': 'Weiterbildungspunkte',
  'Certificaat': 'Zertifikat',
  'Privacyverzoek': 'Datenschutzanfrage',
  'Bewaard tot': 'Behalten bis',
  'Bekijk mijn gegevens': 'Mini Date aaluege',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Lueg, weli Date eLearning über Si gspeicheret het.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Die Übersicht isch am {datum} direkt vo eLearning abgruefe worde und wird vo OciDeck nöd gspeicheret.',
  'Geen gegevens geregistreerd': 'Kei Date gspeicheret',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'Si enthaltet alli Kategorie, wo dr Server für die Organisation glieferet het. Für Informatione zu Zweck, Empfänger, Herkunft, Ufbewahrigsfrischte oder Ihre andere Dateschutzrächt chönd Si sich a {organisatie} wände.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Ihre Date händ nöd chönne glade werde. Versueched Si\'s nomal.',
  'Meer tonen ({aantal} resterend)': 'Meh aazeige ({aantal} übrig)',
  'Mijn gegevens': 'Mini Date',
  'Privacy-inzage': 'Dateschutzuuskunft',
  'Uw geregistreerde gegevens': 'Ihre gspeicherete Date',
  'uw organisatie': 'Ihre Organisation',
  '{aantal} registraties': '{aantal} Iiträg',
  'Volg opleidingen uit uw eLearning-omgeving. Cursusbestanden openen alleen in afspeelmodus; voortgang wordt alleen na aanmelden gesynchroniseerd.':
      'Folg Kurs us dinere eLearning-Umgebig. Kursdateie gönd nur im Abspielmodus uf; Fortschritt wird erst nach em Aamälde synchronisiert.',
  'eLearning-aanmelding is alleen beschikbaar in de desktop-app, omdat de webversie geen veilige sleutelbos heeft.':
      'D eLearning-Aamäldig isch nume i de Desktop-App verfüegbar, wil d Webversion kein sichere Schlüsselbund het.',
  ...
  'Bij het volgen van een cursus stuurt OciDeck uw laatste dia, voltooiing en getoonde tijd per dia naar de gekozen eLearning-organisatie. Antwoorden, notities en cursusinhoud worden niet als voortgang verstuurd.':
      'Biim Folge vo me Kurs schickt OciDeck dini letschti Folie, dr Abschluss und d azeigt Zyt pro Folie a d usgwählti eLearning-Organisation. Antworte, Notize und Kursinhalt werde nöd als Fortschritt gschickt.',
  'Ingelogd bij eLearning': 'Bi eLearning aagmäld',
  'Deze eLearning-server gebruikt {host} voor het aanmelden. Er worden pas gegevens met die identiteitsprovider uitgewisseld nadat u dit toestaat.':
      'Dä eLearning-Server bruucht {host} zum Aamälde. Date wärde ersch mit däm Identitätsanbieter uuschtuuscht, wenn Si das erlaubed.',
  'Gebruik een HTTPS-adres voor eLearning.':
      'Bruuch e HTTPS-Adräss für eLearning.',
  'Vul een geldig eLearning-adres in.': 'Gib e gültigi eLearning-Adräss ii.',
  'Aanmelden bij eLearning is niet gelukt. Controleer de server en probeer opnieuw.':
      'D Aamäldig bi eLearning isch fehlgschlage. Prüef de Server und versuechs nomal.',
  ...
  '{uren} u {minuten} min': '{uren} Std. {minuten} Min.',
  'Bekeken: {tijd}': 'Agschaut: {tijd}',
  'Doorgaan in de les': 'I dr Lektion wytermache',
  'De server is niet gewijzigd, omdat nog voortgang op verzending wacht.':
      'Dr Server isch nöd gänderet worde, wil no Fortschritt uf s’Versände wartet.',
  'Deze cursusles is alleen beschikbaar om af te spelen en wordt niet lokaal opgeslagen.':
      'Die Kurslektion isch nume zum Abspiele verfüegbar und wird nöd lokal gspeicheret.',
  'Deze identiteitsprovider toestaan': 'Dä Identitätsanbieter erlaube',
  'Deze organisatie bevat te veel lessen om veilig te tonen.':
      'Die Organisation het z’vill Lektione, zum si sicher azzeige.',
  'Er wacht nog voortgang op synchronisatie.':
      'Fortschritt wartet no uf Synchronisation.',
  'Met deze keuze wordt het vernieuwtoken in de sleutelbos bewaard. Een versleutelde wachtrij voor nog niet verstuurde voortgang wordt daar los van bewaard.':
      'Mit däre Uuswahl wird s’Aktualisierigstoken im Schlüsselbund gspeicheret. E verschlüssleti Warteschlange für no nöd gsendete Fortschritt wird devo getrennt gspeicheret.',
  'Nog niet verstuurde voortgang is op dit apparaat bewaard.':
      'No nöd gsendete Fortschritt isch uf däm Grät gspeicheret worde.',
  'Cursist': 'Kursteilnehmendi',
  'Les afgerond': 'Lektion abgeschlossen',
  'Cursussen voor u': 'Kurs für Si',
  'Ga verder waar u gebleven was, of kies een andere cursus die voor u klaarstaat.':
      'Mach det wiiter, wo Si ufg\'hört hend, oder wähled en andere Kurs, wo für Si parat isch.',
  'Klaar om te beginnen': 'Parat zum Afange',
  'Mijn cursussen': 'Mini Kurs',
  'Mijn leeromgeving': 'Mini Lernumgebig',
  'Mooi gedaan! Uw voortgang is bewaard.':
      'Guet gmacht! Ihre Fortschritt isch gspeicheret.',
  'Nu bezig': 'Am laufe',
  'Opnieuw starten': 'No einisch starte',
  'Terug naar mijn cursussen': 'Zrugg zu mine Kurs',
  'U kunt deze cursus opnieuw bekijken.': 'Si chönd dä Kurs no einisch aluege.',
  'Volgende: {les}': 'Nächsti: {les}',
  'Welkom, {naam}': 'Willkomme, {naam}',
  '{aantal} cursussen': '{aantal} Kurs',
  '{aantal} lessen': '{aantal} Lektione',
  'OciServe': 'OciServe',
  '{aantal} voortgangsrapport(en) wacht(en) op synchronisatie.':
      '{aantal} Fortschrittsbricht warted uf Synchronisation.',
  '{afgerond} van {totaal} lessen afgerond':
      '{afgerond} vo {totaal} Lektione abgschlosse',
  'Uitloggen': 'Abmälde',
  'Uw account hoort niet bij een actieve organisatie.':
      'Dis Konto ghört zu keiner aktive Organisation.',
  'Verdergaan': 'Wiiterfahre',
  'Sta een HTTPS-server op een intern netwerk toe. Tokens worden nooit via gewone HTTP verzonden.':
      'Erlaub e HTTPS-Server im interne Netzwerk. Tokens werde nie über normali HTTP gschickt.',
  'Starten': 'Starte',
  'Tijdens het afspelen synchroniseert OciDeck de laatste dia, voltooiing en getoonde tijd per dia met deze organisatie. Dit is geen bewijs van aandacht of actieve leertijd.':
      'Während em Abspiele synchronisiert OciDeck d letschti Folie, dr Abschluss und d azeigt Zyt pro Folie mit dere Organisation. Das isch kein Bewiis für Uufmerksamkeit oder aktivi Lernzyt.',
  'Opleiding': 'Kurs',
  'Ingelogd blijven op dit apparaat': 'Uf däm Grät aagmäld bliibe',
  'Inloggen': 'Aamälde',
  'Les': 'Lektion',
  'Er staan geen opleidingen voor u klaar.': 'Für di stöhnd kei Kurs bereit.',
  'Ingelogd als {naam}': 'Aagmäld als {naam}',
  'De lokale aanmelding kon niet volledig worden gewist. Probeer opnieuw.':
      'D lokali Aamäldig het nöd vollständig glöscht werde chönne. Versuechs nomal.',
  'De opleidingen konden niet worden opgehaald.':
      'D Kurs händ nöd abgruefe werde chönne.',
  ...
  'Het bestand is gewijzigd door een ander programma.':
      'D Datei isch vom ene andere Programm gänderet worde.',
  'Herladen': 'Neu lade',
  ...
  'Basislettergrootte: {pt} pt': 'Basis-Schriftgrössi: {pt} pt',
  ...
  'Sluit één of meer OpenKAT-omgevingen aan (bijvoorbeeld productie en acceptatie). OciDeck toont beschikbare rapportages; de inhoud haalt u binnen via een JSON-export uit OpenKAT.':
      'Verbind eini oder mehreri OpenKAT-Umgebige (z. B. Produktion und Abnahme). OciDeck zeigt verfügbari Bericht; de Inhalt holsch per JSON-Export us OpenKAT.',
  'Server toevoegen…': 'Server dezuefüege…',
  'Rapportage van server…': 'Bericht vom Server…',
  'Nog geen OpenKAT-server aangesloten.': 'Noch kei OpenKAT-Server verbunde.',
  'Bezig…': 'Am Laufen…',
  'OpenKAT-server bewerken': 'OpenKAT-Server bearbeite',
  'OpenKAT-server toevoegen': 'OpenKAT-Server dezuefüege',
  'OpenKAT-server toevoegen…': 'OpenKAT-Server dezuefüege…',
  'OpenKAT-server verwijderen?': 'OpenKAT-Server entferne?',
  'Dit verwijdert “{name}” en het bijbehorende toegangstoken van dit apparaat. Dat kunt u niet ongedaan maken.':
      'Das entfernt “{name}” und s zugehörige Zugriffstoken vo dem Grät. Das cha mer nöd rückgängig mache.',
  'Weergavenaam': 'Azeigename',
  'Bijvoorbeeld Productie of Acceptatie': 'Z. B. Produktion oder Abnahme',
  'Adres van OpenKAT': 'OpenKAT-Adrässe',
  'Verbinding met: {host}': 'Verbindig mit: {host}',
  'Eigen netwerk (LAN)': 'Eigenes Netz (LAN)',
  'Alleen voor OpenKAT op het eigen netwerk. Staat HTTP toe en laat privé-adressen toe. Uitgeschakeld: alleen HTTPS.':
      'Nur für OpenKAT im eigene Netz. Erlaubt HTTP und privat Adresse. Us: nur HTTPS.',
  'Toegangstoken': 'Zugriffstoken',
  'Laat leeg om het opgeslagen token te behouden':
      'Leer lah für gspeicherets Token',
  'Plak het token hier': 'Token da iifüege',
  'Vraag uw OpenKAT-beheerder om een API-token in het beheerdersscherm. Het token blijft op dit apparaat, in de sleutelhanger van uw besturingssysteem — niet in het deck.':
      'Frag din OpenKAT-Admin im Admin-Bereich nach em API-Token. S Token bliibt uf dem Grät im Schlüsselbund — nöd im Deck.',
  'Verbinding wordt getest…': 'Verbindig wird gtestet…',
  'Test de verbinding voordat u opslaat, zodat u weet dat naam, adres en token kloppen.':
      'Test d Verbindig vor em Speichere, damit Name, Adrässe und Token stimme.',
  'De OpenKAT-koppeling is alleen beschikbaar in de desktopversie.':
      'D OpenKAT-Verbindig git\'s nur i de Desktop-Version.',
  'Lees OpenKAT-rapportages in als één managementoverzicht — vanuit een map of vanaf een server.':
      'OpenKAT-Bericht als Management-Übersicht iilese — us Ordner oder vom Server.',
  'Er staat al een OpenKAT-bron ingesteld; de koppeling blijft daarom bereikbaar, zodat een bestaand OpenKAT-deck bij te werken blijft.':
      'Scho en OpenKAT-Quelle isch iigrichtet; d Verbindig bliibt verfüegbar zum es bestehends OpenKAT-Deck aktualisiere.',
  'Rapportage van OpenKAT-server': 'Bericht vom OpenKAT-Server',
  'Rapportage van OpenKAT-server…': 'Bericht vom OpenKAT-Server…',
  'Server: {name}': 'Server: {name}',
  'Organisaties worden opgehaald…': 'Organisatione werded abgholt…',
  'Rapportages worden opgehaald…': 'Bericht werded abgholt…',
  'Er zijn geen organisaties zichtbaar voor dit token. Vraag uw beheerder om toegang, of kies een andere server.':
      'Für das Token sind kei Organisatione sichtbar. Frag din Admin nach Zuegriff oder wähl en andere Server.',
  'Er staan geen organisatierapportages klaar op deze server. Maak in OpenKAT eerst een aggregaat-organisatierapport, of kies een andere organisatie.':
      'Uf dem Server sind kei Organisationsbericht parat. Erstell zersch en aggregierte Organisationsbericht in OpenKAT, oder wähl e anderi Organisation.',
  'JSON-export uit OpenKAT': 'JSON-Export us OpenKAT',
  'OpenKAT levert de rapportage-inhoud als JSON-bestand. Exporteer in OpenKAT het gekozen rapport als JSON, en wijs dat bestand of de map hieraan.':
      'OpenKAT liefert de Berichtsinhalt als JSON-Datei. Exportier de gwählte Bericht in OpenKAT als JSON und verwiis da uf die Datei oder de Ordner.',
  'Gekozen: {reportName} · {orgName} · {serverName}':
      'Gwählt: {reportName} · {orgName} · {serverName}',
  'JSON-bestand kiezen…': 'JSON-Datei wähle…',
  'Map met exports kiezen…': 'Export-Ordner wähle…',
  'Vul een weergavenaam in, bijvoorbeeld Productie.':
      'Gib en Azeigename ii, z. B. Produktion.',
  'Vul een weergavenaam en een adres in.':
      'Gib en Azeigename und e Adrässe ii.',
  'Plak een toegangstoken om verder te gaan.':
      'Füeg es Zugriffstoken ii zum Wiitermache.',
  'Vul een adres in, bijvoorbeeld https://openkat.voorbeeld.nl':
      'Gib e Adrässe ii, z. B. https://openkat.voorbeeld.nl',
  'Dit adres is niet geldig. Controleer of u een volledige URL heeft ingevuld.':
      'Die Adrässe isch ungültig. Prüef, ob du e vollständigi URL iigee hesch.',
  'Het adres moet met https:// beginnen, of zet Eigen netwerk aan voor HTTP op het eigen netwerk.':
      'D Adrässe muess mit https:// aafange, oder schalt Eigenes Netz ii für HTTP im eigene Netz.',
  'Verbonden met {host}. Er zijn nog geen organisaties zichtbaar voor dit token.':
      'Verbunde mit {host}. Für das Token sind no kei Organisatione sichtbar.',
  'Verbonden met {host}. {n} organisatie(s) bereikbaar.':
      'Verbunde mit {host}. {n} Organisation(e) erreichbar.',
  'De verbinding met OpenKAT is mislukt. Controleer het adres en uw netwerk, en probeer opnieuw.':
      'D Verbindig zu OpenKAT isch fehlgschlage. Prüef Adrässe und Netz und probier nomol.',
  'Er is geen toegangstoken. Plak het token van uw beheerder en probeer opnieuw.':
      'Kei Zugriffstoken. Füeg s Token vo dim Admin ii und probier nomol.',
  'Alleen HTTPS is toegestaan, tenzij Eigen netwerk aan staat.':
      'Nur HTTPS erlaubt, uss wenn Eigenes Netz aa isch.',
  'OpenKAT weigerde het token. Vraag uw beheerder om een geldig API-token en plak het opnieuw.':
      'OpenKAT het s Token abglehnt. Frag din Admin nach em gültige API-Token und füegs nomol ii.',
  'OpenKAT reageerde niet op tijd. Controleer of de server bereikbaar is en probeer opnieuw.':
      'OpenKAT het nöd rächtziitig antwortet. Prüef ob de Server erreichbar isch und probier nomol.',
  'Dit adres is niet bereikbaar. Controleer de spelling van de hostnaam en of u op het juiste netwerk zit.':
      'Die Adrässe isch nöd erreichbar. Prüef d Hostname-Schriibwis und ob du im richtige Netz bisch.',
  'OpenKAT gaf een onverwacht groot antwoord. Probeer later opnieuw of vraag uw beheerder om hulp.':
      'OpenKAT het e unerwartet grossi Antwort gee. Probier spöter nomol oder frag din Admin.',
  'Verbonden': 'Verbunde',
  'Token ontbreekt': 'Token fehlt',
  'Laatst gecontroleerd mislukt': 'Letscht Prüefig fehlgschlage',
  'Nog niet gecontroleerd': 'Noch nöd gprüeft',
  'Zoekveld wissen': 'Suechfeld lösche',
  'Gantt': 'Gantt',
  'Dag': 'Tag',
  'Week': 'Wuche',
  'Maand': 'Monet',
  ...
  'Dit is een presentatie, geen Markdown-bestand. Zet de module Importeren aan om hem om te zetten naar een deck.':
      'Das isch e Präsentation, kes Markdown-File. Schalt s Modul Importiere i, zum si in es Deck umwandle.',
  ...
  'Vergelijk organisaties en breng portfolio-aandachtspunten in beeld.':
      'Vergleichen Sie Organisationen und identifizieren Sie Portfolio-Points of Interest.',
  'Bekijk de actuele stand of aantoonbare veranderingen bij één organisatie.':
      'Sehen Sie sich den aktuellen Status oder nachweisbare Änderungen bei einer Organisation an.',
  'Onderzoek betrouwbare CVE-koppelingen in de gekozen metingen.':
      'Untersuchen Sie zuverlässige CVE-Verbindungen in den ausgewählten Messungen.',
  'Leg vast welke metingen en bronbestanden het rapport werkelijk gebruikt.':
      'Notieren Sie, welche Messungen und Quelldateien der Bericht tatsächlich verwendet.',
  'Wat is het managementbeeld over de gekozen organisaties?':
      'Wie ist die Managementsicht der ausgewählten Organisationen?',
  'Waar worden de meeste en minste findings waargenomen?':
      'Wo werden die meisten und die wenigsten Befunde beobachtet?',
  'Hoe ontwikkelt het portfolio zich over de tijd?':
      'Wie entwickelt sich das Portfolio im Laufe der Zeit?',
  'Welke problemen komen bij de meeste organisaties voor?':
      'Welche Probleme treten in den meisten Organisationen auf?',
  'Waar concentreren de ernstigste findings zich?':
      'Wo konzentrieren sich die gravierendsten Erkenntnisse?',
  'Welke controls lopen achter?': 'Welche Kontrollen hinken hinterher?',
  'Welke maatregelen adviseert OpenKAT het vaakst?':
      'Welche Maßnahmen empfiehlt OpenKAT am häufigsten?',
  'Hoe staat deze organisatie er nu voor?':
      'Wie ist der aktuelle Status dieser Organisation?',
  'Wat veranderde er sinds de vorige meting?':
      'Was hat sich seit der letzten Messung geändert?',
  'Welke findings zijn nieuw of niet meer waargenomen?':
      'Welche Erkenntnisse sind neu oder nicht mehr zu beobachten?',
  'Welke findings staan het langst open?':
      'Welche Funde waren am längsten offen?',
  'Op welke systemen worden de meeste findings waargenomen?':
      'Auf welchen Systemen werden die meisten Befunde beobachtet?',
  'Welke systemen verbeterden of verslechterden?':
      'Welche Systeme haben sich verbessert oder verschlechtert?',
  'Welke controls verbeterden of verslechterden?':
      'Welche Kontrollen haben sich verbessert oder verschlechtert?',
  'Welke systemen zijn in de metingen opgenomen?':
      'Welche Systeme werden in die Messungen einbezogen?',
  'Welke assets zijn aantoonbaar in monitoring?':
      'Welche Vermögenswerte sind im Monitoring nachweisbar?',
  'Welke monitoringstatussen veranderden?':
      'Welche Überwachungsstatus haben sich geändert?',
  'Wie is geraakt door deze CVE?': 'Wer ist von diesem CVE betroffen?',
  'Welke CVE’s raken de meeste organisaties?':
      'Welche CVEs betreffen die meisten Organisationen?',
  'Welke CVE’s zijn nieuw of niet meer waargenomen?':
      'Welche CVEs sind neu oder werden nicht mehr beobachtet?',
  ...
  'Nog niet beschikbaar: niet iedere finding heeft een betrouwbare eerste waarnemingsdatum.':
      'Noch nicht verfügbar: Nicht für jeden Befund gibt es ein verlässliches Erstbeobachtungsdatum.',
  'Nog niet beschikbaar: de bron bewijst geen stabiele identiteit voor alle findings.':
      'Noch nicht verfügbar: Die Quelle weist nicht für alle Ergebnisse eine stabile Identität nach.',
  'Nog niet beschikbaar: vergelijkbare meetdekking is niet aangetoond.':
      'Noch nicht verfügbar: Eine vergleichbare Messabdeckung wurde nicht nachgewiesen.',
  'Nog niet beschikbaar: betrouwbare controlnoemers ontbreken.':
      'Noch nicht verfügbar: Zuverlässige Kontrollnenner fehlen.',
  'Nog niet beschikbaar: stabiele assetidentiteit is niet aangetoond.':
      'Noch nicht verfügbar: Eine stabile Asset-Identität wurde nicht nachgewiesen.',
  'Dit rapport ondersteunt de gekozen organisatiescope niet.':
      'Dieser Bericht unterstützt den gewählten Organisationsbereich nicht.',
  'De gekozen bron bevat niet genoeg betrouwbare gegevens voor dit rapport.':
      'Die ausgewählte Quelle enthält nicht genügend zuverlässige Daten für diesen Bericht.',
  'Kerncijfers en gemeten bereik': 'Kennzahlen und gemessene Reichweite',
  'Organisaties vergelijken': 'Vergleichen Sie Organisationen',
  'Concentratie van critical/high findings':
      'Konzentration kritischer/hoher Erkenntnisse',
  'Portfolioverloop per meetmoment': 'Portfolioübersicht pro Messzeitpunkt',
  'Meest voorkomende findingtypen': 'Die häufigsten Befundarten',
  'Bron- en meetverantwoording': 'Verantwortlichkeit für Quelle und Messung',
  'Nieuwe en niet meer waargenomen findings':
      'Neue und nicht mehr beobachtete Erkenntnisse',
  'Langst waargenomen findings': 'Am längsten beobachtete Befunde',
  'Systemen met de meeste findings': 'Systeme mit den meisten Erkenntnissen',
  'Veranderingen per systeem': 'Änderungen pro System',
  'Blootstelling aan één CVE': 'Exposition gegenüber einem CVE',
  'CVE’s over organisaties': 'CVEs über Organisationen',
  'Nieuwe en niet meer waargenomen CVE’s':
      'Neue und nicht mehr beobachtete CVEs',
  'Controldekking': 'Kontrollabdeckung',
  'Controlveranderingen': 'Kontrolländerungen',
  'Aanbevelingen uit OpenKAT': 'Empfehlungen von OpenKAT',
  'Assetinventaris': 'Vermögensinventur',
  'Monitoringdekking': 'Überwachungsabdeckung',
  'Actueel organisatiebeeld': 'Aktuelles Organisationsbild',
  'Kies eerst het onderwerp en daarna de vraag die het rapport moet beantwoorden.':
      'Wählen Sie zunächst das Thema und dann die Frage aus, die der Bericht beantworten soll.',
  'Onderwerp': 'Thema',
  ...
  'Optionele Y-01-velden': 'Optionali Y-01-Fälder',
  'Procesdoel (target)': 'Prozessziel (Target)',
  'Specificatielimieten van Y-01 (deck)': 'Y-01-Spezifikationsgränze (Deck)',
  'Dit deck heeft Y-01-limieten. Schakel bovenstaande schakelaar in om die te gebruiken in plaats van lokale waarden.':
      'Das Deck hät Y-01-Gränze. Schalt de Schalter obe aa, zum die statt lokalen Wärt z\'bruuche.',
  'USL (bovengrens, optioneel)': 'USL (Obergränze, optional)',
  ...
  'Te weinig gegevens voor een interactieplot':
      'Z wenig Date für es Interaktionsdiagramm',
  'DOE-proefopzet…': 'DOE-Design…',
  'DOE-proefopzet': 'DOE-Design',
  'Genereert een ontwerptabel met gecodeerde factoren (−1/+1) en een lege Y-kolom in het raster.':
      'Erzügt e Design-Tabelle mit kodierte Faktore (−1/+1) und ere lääre Y-Spalte im Raster.',
  ...
  'In raster zetten': 'Is Raschter setze',
  'Eén reeks per factor met gecodeerde niveaus −1 en +1; laatste reeks is de respons (Y). Rijen zijn proefruns.':
      'Ei Serie pro Faktor mit kodierte Stufe −1 und +1; di letscht Serie isch d Antwort (Y). Zyyle si Versuechsläuf.',
  ...
  'wordt ergens genoemd maar staat niet op een boom-dia — definieer hem op een CTQ- of Ishikawa-boom.':
      'wird irgendwo erwähnt, staht aber nöd uf ere Baum-Folie — definiere ihn uf em CTQ- oder Ishikawa-Baum.',
  ...
  'Project starten': 'Projäkt starte',
  'Procesverbetering: DMAIC-project': 'Prozessverbesserig: DMAIC-Projäkt',
  'DMAIC-skelet met charter, CTQ-boom (Y-01), SIPOC en fase-secties.':
      'DMAIC-Skelett mit Charter, CTQ-Baum (Y-01), SIPOC und Phasesectione.',
  'Een fasepoort-checklist: bevestig scope, stakeholders en go/no-go voordat je naar de volgende fase gaat.':
      'E Phase-Gate-Checklist: bestätig Scope, Stakeholder und Go/No-Go, bevor du i d nächschti Phase gosch.',
  'Stroom': 'Fluss',
  'Zwembanen': 'Swimlanes',
  'Een processtroom, zwembanen of VSM. Stappen als titel :: soort :: pt=…; lt=…. Totalen (PCE, bottleneck) worden berekend, niet opgeslagen.':
      'En Prozessfluss, Swimlanes oder VSM. Schritt als Titel :: Art :: pt=…; lt=…. Total (PCE, bottleneck) werde berechnet und nöd gspeicheret.',
  'Boom': 'Baum',
  'Visgraat': 'Fischgrät',
  'Lay-out': 'Layout',
  'Punten': 'Punkt',
  'Inspringen': 'Iirücke',
  'Uitspringen': 'Usrücke',
  'Punt toevoegen': 'Punkt dezuefüege',
  'Punt verwijderen': 'Punkt entferne',
  'Een boom of visgraat (5× Why, CTQ, Ishikawa). Diepte met tabs; markeer oorzaken als **X-01** inline.':
      'En Baum oder Fischgrät (5× Why, CTQ, Ishikawa). Tiefe mit Tabs; markier Ursache als **X-01** inline.',
  'Canvas': 'Canvas',
  'Een canvas van regio\'s (A3, charter, SWOT, bord). Kies een sjabloon; de ##-koppen op schijf zijn de vakken.':
      'Es Canvas us Regionä (A3, Charter, SWOT, Board). Wähl e Vorlag; d ##-Überschrifte uf dr Platte sind d Fälder.',
  'Matrix': 'Matrix',
  'Een getypeerd raster (SIPOC, FMEA, RACI, …). Kies een sjabloon; afgeleide kolommen zoals RPN worden berekend en niet opgeslagen.':
      'Es typisierts Raster (SIPOC, FMEA, RACI, …). Wähl e Vorlag; abgleiteti Spalte wie RPN werde berechnet und nöd gspeicheret.',
  'Regelkaart': 'Regelchaarte',
  'Histogram': 'Histogramm',
  'Pareto': 'Pareto',
  'Run chart': 'Verlaufsdiagramm',
  'Boxplot': 'Boxplot',
  'Plakken uit klembord': 'Us em Zwüscheablag iiläse',
  'Te weinig gegevens voor een regelkaart': 'Z wenig Date für e Regelchaarte',
  ...
  'De browser blokkeert media van een externe bron. Open deze presentatie in de app om online media te tonen.':
      'De Browser blockiert Medie us ere externe Quelle. Öffne die Präsentation i de App, für online Medie azeige.',
  ...
  '•  CVE opzoeken (staat standaard uit): staat het aan, dan gaat je zoekterm naar de ingestelde CVE-spiegel en, als die niets vindt, naar de Europese database van ENISA en naar MITRE.':
      '•  CVE sueche (isch standardmässig us): wenn s aa isch, gaht dis Suechwort a de iigstellt CVE-Spiegel und, wenn dä nüt findt, a d europäisch Datebank vo de ENISA und a MITRE.',
  ...
  'Snelle server-zoekopdracht — door indexeringsvertraging kan een net gewijzigd deck ontbreken.':
      'Schnälli serversitigi Suech — wäge Indexierigsverzögerig cha nes grad gänderets Deck fähle.',
  ...
  'Je token is geldig, maar mag dit niet. Geef het meer rechten, of wacht als de forge een limiet oplegt.':
      'Dis Token isch gültig, darf das aber nid. Gib em meh Rächt, oder wart, wenn d Forge e Limite setzt.',
  ...
  'AI-assistentie (staat standaard uit): kies je een zelf-gehoste of cloud-backend, dan worden de teksten of afbeeldingen die je laat verwerken naar dat adres gestuurd. Wat je hebt geredigeerd, gaat er eerst uit. Een lokaal AI-model op dit apparaat verstuurt niets.':
      'KI-Hilf (isch standardmässig us): wählsch es sälber ghostets oder es Cloud-Backend, wärded d Täxt oder Bilder, wo du la verarbeite lohsch, a die Adrässe gschickt. Was du gschwärzt häsch, wird vorhär entfernt. Es lokals KI-Modäll uf dem Grät schickt nüt.',
  'Gegevens weglaten (redactie)': 'Date weglah (Schwärzig)',
  'Zet je tekst tussen dubbele blokhaken, zoals [[het adres]], dan laat OciDeck die weg uit alles wat je toont en exporteert. Op de dia, in de presentatie, in de PDF, de PowerPoint en de HTML verschijnen alleen blokken.':
      'Schriibsch Täxt zwüsched doppleti eckigi Chlammere, zum Bispil [[d Adrässe]], lot en OciDeck us allem use, wo du zeigsch und exportiersch. Uf de Folie, i de Präsentation, im PDF, im PowerPoint und im HTML chömed nur no Blöck.',
  'Weggelaten is écht weggelaten, niet afgedekt. De tekst zit niet als onzichtbare laag onder een zwart balkje in de PDF, niet in de sprekersnotities van de PowerPoint, en niet in de broncode van de HTML. Wie het bestand openmaakt, kan er niets uit terughalen.':
      'Wegglah heisst würkli wegglah, nöd zuedeckt. De Täxt liit nöd as unsichtbari Schicht under eme schwarze Balke im PDF, nöd i de Sprächernotize vom PowerPoint und nöd im Quälltäxt vom HTML. Wär d Datei ufmacht, cha nüt drus zrugghole.',
  'Je eigen bestand verandert niet. De oorspronkelijke tekst blijft in je markdown staan; redactie geldt alleen voor wat je deelt. Zo houd je je eigen gegevens.':
      'Dini eigeni Datei änderet sich nöd. De ursprünglich Täxt bliibt i dim Markdown; d Schwärzig gilt nur für das, wo du teilsch. So bhaltisch dini eigene Date.',
  ...
  'Alle scope-objecten hebben al een checklist':
      'Alli Scope-Objäkt händ scho e Checkliste',
  'Maakt per scope-object een checklist (WSTG voor web/API); bestaande blijven staan.':
      'Erstellt pro Scope-Objäkt e Checkliste (WSTG für Web/API); bestehendi bliibed.',
  ...
  'Kies uit de scope': 'Us em Scope uswähle',
  'Bepaalt de contextscore van bevindingen op dit object; laat leeg als de weging niet bekend is.':
      'Leit de Kontext-Score vo de Befind uf dem Objäkt ab; leer lah, wenn d Gwichtig unbekannt isch.',
  'De contextscore is gewogen met de CIA-rating van het gekozen scope-object.':
      'De Kontext-Score isch mit de CIA-Bewertig vom gwählte Scope-Objäkt gwichtet.',
  ...
  'De LibrePlan-connector is alleen beschikbaar in de desktopversie.':
      'De LibrePlan-Konnektor gits nume i de Desktop-Version.',
  'LibrePlan-connector is optioneel en staat standaard uit. Er wordt niets opgehaald totdat u dit inschakelt en zelf een server configureert. Alleen-lezen: de connector schrijft niets terug naar LibrePlan. Het wachtwoord wordt in de sleutelhanger van uw besturingssysteem opgeslagen, niet in het deck.':
      'De LibrePlan-Konnektor isch fakultativ und standardmässig us. S wird nüt abgholt, bis du en iischaltisch und sälber en Server iirichtisch. Nume läse: de Konnektor schriibt nüt zrugg uf LibrePlan. S Passwort wird im Schlüsselbund vo dim Betriebssystem gspeicheret, nöd im Deck.',
  'Opgeslagen in de sleutelhanger': 'Im Schlüsselbund gspeicheret',
  'Alleen voor servers op het eigen netwerk (LAN). Staat plain-HTTP toe en staat privé-adressen door de NetGuard. Uitgeschakeld: HTTPS verplicht.':
      'Nume für Server im eigene Netz (LAN). Laat eifachs HTTP zue und laat privati Adresse dur de NetGuard. Usgschalte: HTTPS Pflicht.',
  'Verbinding succesvol.': 'Verbindig isch glunge.',
  'Onverwachte fout.': 'Unerwartete Fähler.',
  'Importeren uit LibrePlan': 'Us LibrePlan importiere',
  'LibrePlan importeren': 'Us LibrePlan importiere',
  'Kies welke slides u uit het LibrePlan-project wilt halen. De import is alleen-lezen en schrijft niets terug.':
      'Wähl us, weli Slides du us em LibrePlan-Projekt wottsch hole. De Import isch nume läsend und schriibt nüt zrugg.',
  'Gantt-planning': 'Gantt-Planig',
  'WBS (hiërarchie)': 'WBS (Hierarchie)',
  'Projectstatus (cockpit)': 'Projäktstatus (Cockpit)',
  'Milestones (tijdlijn)': 'Meilestei (Ziitachse)',
  'Kritieke pad (flow)': 'Kritische Pfad (Flow)',
  'Resources (tabel)': 'Ressource (Tabälle)',
  'Timesheet (tabel)': 'Ziterfassig (Tabälle)',
  'Resourcebelasting (grafiek)': 'Ressourceuslaschtig (Diagramm)',
  'Ophalen uit LibrePlan…': 'Wird us LibrePlan gholt…',
