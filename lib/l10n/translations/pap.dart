...
const _dutchSourcePap = {
  ...
  'Laatste reeks als lijn op een tweede as; de rest als staven.':
      'Último serie komo liña riba un di dos èks; e restu komo bara.',
  'Eerste reeks: elke waarde is een op- of neerwaartse stap op het vorige totaal.':
      'Promé serie: kada balor ta un paso ariba òf abou riba e total akumulá.',
  'Reeks = rij, kolom = label, celkleur volgt de waarde. Label de assen kans en impact voor een risicomatrix.':
      'Serie = fila, kolom = etiket, koló di e selda ta sigui e balor. Pone nòmber na e èksnan probabilidat i impakto pa un matris di risiko.',
  ...
  'Vergrendelt het deck tot presenteren: de editor, menu\'s en export zijn niet beschikbaar. Uitzetten kan daarna alleen door de sleutel uit het markdown-bestand te halen.':
      'Ta blokeá e deck pa presentá: e editor, menu i eksportá no ta disponibel. Pa desblokeá despues, kita e yabi for di e archivo markdown.',
...
const _dutchSourceAddPap = {
  ...
  'Aangemaakt op': 'Kreá riba',
  'Aanmeldprovider': 'Proveedó di login',
  'Aanmeldsessies': 'Seshonnan di inskripshon',
  'Aantal controles': 'Kantidat di kòntròl',
  ...
  'Activiteitnummer': 'Number di aktividat',
  'Afgerond op': 'Rondoná na',
  'Afgewezen': 'Rechasá',
  'Afspeelsessienummer': 'Number di seshon di reprodukshon',
  'Afwezig': 'Ousente',
  'Antwoordgegevens': 'Detayenan di kontesta',
  'Antwoordstatus': 'Status di kontesta',
  'Begint op': 'Ta kuminsá riba',
  'Begrippen uitgelegd': 'Konseptonan splika',
  'Beheer van de installatie': 'Maneho di e instalashon',
  'Beheerpogingen': 'Esfuersonan di maneho',
  'Bekeken lessen': 'Lèsnan mira',
  'Beleidsversie': 'Vershon di polítika',
  'Beoordeeld': 'Klasifiká',
  'Beoordeeld op': 'Evaluá pa',
  'Beperking': 'Restrikshon',
  'Berekend op': 'Kalkulá riba',
  'Bericht': 'Mensahe',
  'Bestandsnaam': 'Nòmber di archivo',
  'Beveiligingsvraagnummer': 'Number di Pregunta di Seguridat',
  'Bevestigd': 'Konfirmá',
  'Bevestigd op': 'Konfirmá riba',
  'Bewaarregels': 'Reglanan di retenshon',
  'Bewaartermijn': 'Periodo di retenshon',
  'Bewaren wegens een juridische verplichting':
      'Retené pa motibu di un obligashon legal',
  'Bewerkingnummer bij aanmeldprovider':
      'Number di operashon na dunadó di registrashon',
  'Bewijsstukken': 'Evidensia',
  'Bezwaar': 'Obheshon',
  'Beëindigd op': 'A terminá riba',
  'Bijeenkomstnummer': 'Number di reunion',
  'Certificaatnummer': 'Number di sertifikado',
  'Certificaten': 'Sertifikadonan',
  'Controlecode van de PDF': 'Kódigo di kòntròl di e PDF',
  'Controlecode van profielfoto': 'Kódigo di verifikasion di potrèt di profil',
  'Controlecodes van bewijsstukken':
      'Kódigonan di kòntròl di dokumentonan di sosten',
  'Correctie': 'Korekshon',
  'Cursistnummer waarop de actie gericht was':
      'Kantidat di studiante na kua e akshon tabata dirigí',
  'Cursusaanbodnummer': 'Number di oferta di kurso',
  'Cursusversienummer': 'Number di vershon di kurso',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Fechanan i orarionan ta wòrdu mustra den bo ora lokal. Nòmbernan tékniko ta keda visibel ora e servidor ta proveé ​​un kampo deskonosí.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'E kontesta ku bo a duna na preguntanan di tèst.',
  'Deelnamenummer': 'Number di partisipashon',
  'Deelnames': 'Partisipashonnan',
  'Details': 'Detayenan',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'E kategoria aki a wòrdu suministrá dor di e servidor. E nòmbernan tékniko ta keda visibel pa preguntanan di bo organisashon.',
  'Door uzelf aangevraagd': 'Pidi pa bo mes',
  'E-mailadres': 'Adrès di email',
  'E-mailberichten': 'Mensahenan di email',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'Un ID ta un number tékniko úniko ku eLearning ta usa pa konektá dato huntu. E no ta un rating òf status.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'Un kategoria ta agrupá datonan riba e mesun tópiko. Un registrashon ta un pida dato wardá òf un evento.',
  'Eindigt op': 'Ta kaba na',
  'Geaccepteerd op': 'Aseptá riba',
  'Geannuleerd': 'Kanselá',
  'Gecontroleerd': 'Kontrolá',
  'Gecontroleerd op': 'Kontrolá riba',
  'Geen gegevens gevonden': 'No a haña dato',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Informashon tokante periodonan di retenshon i e eliminashon di bo datonan.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Informashon tokante dokumentonan di sosten, resultadonan alkansá i sertifikadonan.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Informashon tokante petishonnan di privasidat i ken a wak òf kambia bo informashon.',
  'Gegevens over uw accountbewerking':
      'Informashon tokante operashon di bo kuenta',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Informashon tokante bo inskripshon, partisipashon i progreso den lèsnan.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Informashon tokante bo profil, kuenta i posishon den e organisashon.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Informashon tokante bo momentunan di prueba i e preguntanan presentá.',
  'Gegevens over willekeurige volgorde': 'Datonan di òrdu aleatorio',
  'Gegevenscategorie': 'Kategoria di dato',
  'Gekoppeld accountnummer': 'Number di kuenta link',
  'Gekozen antwoorden': 'Kontesta selektá',
  'Gelukt': 'Éksito',
  'Geprobeerd op': 'A purba riba',
  'Gerechtvaardigd belang': 'Interes legítimo',
  'Gereserveerd': 'Reservá',
  'Gereserveerd op': 'Reservá riba',
  'Geslaagd': 'A pasa',
  'Gestart op': 'A kuminsá riba',
  'Getoonde tijd per dia in milliseconden':
      'Tempu mustra pa slide den milisekònde',
  'Herkomst van inschrijving': 'Orígen di registrashon',
  'Hoogst haalbare score': 'Skor mas haltu posibel',
  'Identificatienummer bij aanmeldprovider':
      'Number di identifikashon pa dunadó di registrashon',
  'Identiteitsbewerkingnummer': 'Number di operashon di identidat',
  'In afwachting': 'Pendiente',
  'In behandeling': 'Den proseso',
  'In behandeling genomen op': 'Prosesá riba',
  'In quarantaine': 'Den karentena',
  'Ingeleverd': 'Entregá',
  'Ingeleverd op': 'Entregá riba',
  'Ingericht op': 'Dekorá riba',
  'Ingeschreven op': 'Registrá riba',
  'Ingetrokken': 'Retirá',
  'Ingetrokken op': 'Retirá riba',
  'Inschrijvingen': 'Inskripshonnan',
  'Inschrijvingsnummer': 'Number di inskripshon',
  'Installatiebeveiligingslogboek': 'Registro di seguridat di instalashon',
  'Installatienummer': 'Number di instalashon',
  'Installatieverzoeken': 'Petishonnan di instalashon',
  'Inzage': 'Inspekshon',
  'Ja': 'Si',
  'Kwalificatienummer': 'Number di kualifikashon',
  'Kwalificaties': 'Kualifikashonnan',
  'Laatst actief op': 'Ultimo aktivo riba',
  'Laatst bekeken dia': 'Ultimo diapositiva bista',
  'Laatst gewijzigd op': 'Ultimo modifikashon riba',
  'Laatste fout': 'Ultimo eror',
  'Lesnummer': 'Number di lès',
  'Lesreserveringen': 'Reservashon di lès',
  'Lesvoortgang': 'Progreso di lès',
  'Lidmaatschappen': 'Miembresia',
  'Locatie': 'Lugá',
  'Manier van afronden': 'Manera di rondoná',
  'Maximaal aantal controles': 'Kantidat máksimo di kòntròl',
  'Maximaal aantal pogingen': 'Kantidat máksimo di intento',
  'Maximale leeftijd van de aanmelding': 'Edat máksimo di inskripshon',
  'Mislukt': 'Frakasá',
  'Naam van de activiteit': 'Nòmber di e aktividat',
  'Naam van de bijeenkomst': 'Nomber di e reunion',
  'Nee': 'No',
  'Netwerkadres': 'Adrès di ret',
  'Niet actief': 'No ta aktivo',
  'Niet geregistreerd': 'No ta registrá',
  'Niet ingevuld': 'No a yena',
  'Niet verschenen': 'No a publiká',
  'Niveau van extra aanmeldcontrole':
      'Nivel di kòntròl di registrashon adishonal',
  'Nummer van de toetsopzet': 'Number di e plan di prueba',
  'Nummer van het brongegeven': 'Kantidat di e datonan di fuente',
  'Nummer van uw verwijderde gegeven': 'Kantidat di bo datonan eliminá',
  'Onderdeel {nummer}': 'Parti {nummer}',
  'Onderwerp van de actie': 'Sujeto di e akshon',
  'Ontvanger': 'Destinatario',
  'Opgegeven bestandsgrootte': 'Tamaño di archivo spesifiká',
  'Opgegeven bestandstype': 'Tipo di archivo spesifiká',
  'Opgegeven controlecode': 'Kódigo di kòntròl spesifiká',
  'Opgeslagen bestandsgrootte': 'Tamaño di archivo wardá',
  'Opgeslagen controlecode': 'Kódigo di kòntròl wardá',
  'Organisatienummer': 'Number di organisashon',
  'Overdraagbaarheid': 'Transferibilidat',
  'PE-toekenningnummer': 'Number di premio di PE',
  'Poging': 'Intento',
  'Positie': 'Posishon',
  'Privacyverzoeken': 'Petishonnan di privasidat',
  'Probeer een andere zoekterm.': 'Purba un término di búskeda diferente.',
  'Reden': 'Motibu',
  'Reden of grondslag': 'Motibu òf base',
  'Reden van afwijzing': 'Motibu pa rechaso',
  'Reden van bevestiging': 'Motibu pa konfirmashon',
  'Reden van intrekking': 'Motibu pa retiro',
  'Reden voor langer bewaren': 'Motibu pa almasenamentu mas largu',
  'Regels voor de cursusversie': 'Reglanan pa e vershon di e kurso',
  'Resultaat bij de aanmeldprovider': 'Resultado na e dunadó di registrashon',
  'Rol': 'Rol',
  'Score': 'Skor',
  'Soort aanwezigheid': 'Tipo di presensia',
  'Soort accountbewerking': 'Tipo di operashon di kuenta',
  'Soort gebeurtenis': 'Tipo di evento',
  'Soort privacyverzoek': 'Tipo di petishon di privasidat',
  'Status van de bijeenkomst': 'Status di e reunion',
  'Strenge beveiligingsmodus': 'Modo di seguridat haltu',
  'Technisch toegangslogboek': 'Log di akseso tékniko',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Datonan tékniko nesesario pa registrashon, seguridat i prosesamentu konfiabel.',
  'Technische naam: {naam}': 'Nòmber tékniko: {naam}',
  'Technische opslagcategorie': 'Kategoria di almasenamentu tékniko',
  'Technische opslaglocatie van de PDF':
      'Lugá di almasenamentu tékniko di e PDF',
  'Tijdstip van aanmelding': 'Ora di inskripshon',
  'Tijdzone': 'Zona di ora',
  'Toestand': 'Kondishon',
  'Toetspogingen': 'Intentonan di prueba',
  'Toetspogingnummer': 'Number di intento di tèst',
  'Uiterste inlevermoment': 'Fecha límite pa entregá',
  'Uitgegeven op': 'Publiká riba',
  'Uitgenodigd e-mailadres': 'Adrès di email invitá',
  'Uitnodigingen': 'Invitashonnan',
  'Uniek nummer (ID)': 'Number úniko (ID)',
  'Uniek verwerkingskenmerk': 'Karakterístika di prosesamentu úniko',
  'Uw accountnummer': 'Bo number di kuenta',
  'Uw accountnummer als uitvoerder': 'Bo number di kuenta komo ehekutor',
  'Uzelf als uploader': 'Bo mes komo un subidó',
  'Vaardigheidsversienummer': 'Number di vershon di abilidat',
  'Vast internetadres van de installatie':
      'Adrès di internet fiho di e instalashon',
  'Vastgelegde beslisgegevens': 'Datonan di desishon registrá',
  'Vastgelegde gegevens': 'Datonan registrá',
  'Vereist niveau van aanmeldzekerheid':
      'Nivel nesesario di siguridat di registrashon',
  'Vereiste aanmeldmethoden': 'Métodonan di login nesesario',
  'Verloopt bij inactiviteit op': 'Ta kaduká ora ta inaktivo',
  'Verloopt definitief op': 'Ta kaduká permanentemente',
  'Verloopt op': 'Ta kaduká',
  'Versienummer van de PE-regel': 'Number di vershon di e regla di PE',
  'Verwerkte verzoeken': 'Petishonnan prosesá',
  'Verwijderd op': 'Kita riba',
  'Verwijdering': 'Remoshon',
  'Verwijderingsregister': 'Registro di Eliminashon',
  'Verwijzing naar het antwoord': 'Referensia na e kontesta',
  'Verzoeknummer': 'Number di petishon',
  'Verzoeknummer van de app': 'Number di petishon di app',
  'Verzonden op': 'Mandá riba',
  'Volgende controle op': 'Siguiente kòntròl',
  'Volgnummer': 'Number di sekuensia',
  'Volgorde van antwoordopties': 'Orden di opshonnan di kontesta',
  'Vraagnummer binnen de toetspoging':
      'Number di pregunta denter di e intento di prueba',
  'Vraagversienummer': 'Number di vershon di pregunta',
  'Vragen in toetspogingen': 'Preguntanan den intentonan di tèst',
  'Vrijgegeven': 'Lansa',
  'Vrijgegeven op': 'Lansa riba',
  'Wat gebeurt na de bewaartermijn':
      'Kiko ta pasa despues di e periodo di retenshon',
  'Wettelijke verplichting': 'Obligashon legal',
  'Wijzigingen aan PE-punten': 'Kambionan na puntonan di PE',
  'Wijzigingen aan kwalificaties': 'Kambionan den kualifikashonnan',
  'Wijzigingen in aanmeldbeveiliging': 'Kambionan na seguridat di login',
  'Zekerheid': 'Siguridat',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Por ehèmpel, buska pa kurso, fecha òf status',
  'Zoeken in uw gegevens': 'Buska bo datonan',
  '{aantal} categorieën gevonden': '{aantal} kategorianan hañá',
  'Aanwezigheid': 'Presensia',
  'Lidmaatschap': 'Membresia',
  'Inzage en wijzigingen': 'Acceso y cambios',
  'Beschikbaarheid van het inzagespoor':
      'Disponibilidad del registro de acceso',
  'Beschikbaar vanaf': 'Disponible desde',
  'Historie vóór deze datum': 'Historia antes de esta fecha',
  'Tijdstip': 'Fecha y hora',
  'Handeling': 'acción',
  'Gegevensonderdeel': 'Categoría de datos',
  'Handelde als': 'Actuó como',
  'Organisatorische rol': 'Rol organizacional',
  'Bekeken': 'Visto',
  'Gewijzigd': 'cambiado',
  'Uzelf': 'tu',
  'Medewerker': 'Miembro del personal',
  'Systeem': 'Sistema',
  'Onbekend': 'Desconocido',
  'Docent': 'Instructor',
  'Beoordelaar': 'tasador',
  'Organisatiebeheerder': 'Administrador de la organización',
  'Niet beschikbaar': 'No disponible',
  'Uitoefening van privacyrechten': 'Ejercicio de los derechos de privacidad',
  'Beoordeling en certificering': 'Evaluación y certificación',
  'Uitvoering van het leertraject': 'Entrega del programa de aprendizaje.',
  'Cursistenadministratie': 'administración de alumnos',
  'Cursistprofiel': 'Perfil de alumno',
  'Leerstatistieken': 'Estadísticas de aprendizaje',
  'Inschrijving': 'Inscripción',
  'Toetspoging': 'intento de evaluación',
  'Beoordeling': 'Evaluación',
  'Bewijsstuk': 'evidencia',
  'Kwalificatie': 'Calificación',
  'Deelname': 'Participación',
  'PE-punten': 'Puntos de educación continua',
  'Certificaat': 'Certificado',
  'Privacyverzoek': 'Solicitud de privacidad',
  'Bewaard tot': 'Retenido hasta',
  'Bekijk mijn gegevens': 'Mira mi datonan',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Mira ki datonan eLearning a registrá tokante bo.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'E resúmen aki a wordu buská direktamente for di eLearning riba {datum} i OciDeck no ta warda esaki.',
  'Geen gegevens geregistreerd': 'No tin dato registrá',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'E ta kontené tur kategoria ku e servidor a entregá pa e organisashon aki. Pa informashon tokante obhetivonan, resibidónan, orígen, tempu di warda òf bo otro derechonan di privasidat, tuma kontakto ku {organisatie}.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'No por a karga bo datonan. Purba atrobe.',
  'Meer tonen ({aantal} resterend)': 'Mustra mas ({aantal} ta sobra)',
  'Mijn gegevens': 'Mi datonan',
  'Privacy-inzage': 'Akseso na datonan personal',
  'Uw geregistreerde gegevens': 'Bo datonan registrá',
  'uw organisatie': 'bo organisashon',
  '{aantal} registraties': '{aantal} registro',
  ...
  'Deze organisatie bevat te veel lessen om veilig te tonen.':
      'E organisashon aki tin demasiá les pa mustra di un manera sigur.',
  'Er wacht nog voortgang op synchronisatie.':
      'Ainda tin progreso warda pa sincronisashon.',
  'Met deze keuze wordt het vernieuwtoken in de sleutelbos bewaard. Een versleutelde wachtrij voor nog niet verstuurde voortgang wordt daar los van bewaard.':
      'Cu e eskoho aki e token di renovashon ta wordo warda den e keychain. Un fila cifrá pa progreso ku ainda no a wordo manda ta wordo warda separá di dje.',
  'Nog niet verstuurde voortgang is op dit apparaat bewaard.':
      'Progreso ku ainda no a wordo manda ta warda riba e aparato aki.',
  'Cursist': 'Kursista',
  'Les afgerond': 'Les kompletá',
  'Cursussen voor u': 'Kursunan pa bo',
  'Ga verder waar u gebleven was, of kies een andere cursus die voor u klaarstaat.':
      'Sigui kaminda bo a keda, òf skohe un otro kurso ku ta kla pa bo.',
  'Klaar om te beginnen': 'Kla pa kuminsá',
  'Mijn cursussen': 'Mi kursunan',
  'Mijn leeromgeving': 'Mi ambiente di siña',
  'Mooi gedaan! Uw voortgang is bewaard.':
      'Bon hasi! Bo progreso a wòrdu warda.',
  'Nu bezig': 'Aktualmente',
  'Opnieuw starten': 'Kuminsá atrobe',
  'Terug naar mijn cursussen': 'Bai bek na mi kursunan',
  'U kunt deze cursus opnieuw bekijken.': 'Bo por wak e kurso aki atrobe.',
  'Volgende: {les}': 'Siguiente: {les}',
  'Welkom, {naam}': 'Bon biní, {naam}',
  ...
  '{afgerond} van {totaal} lessen afgerond':
      '{afgerond} di {totaal} lesnan kompletá',
  'Uitloggen': 'Sali',
  ...
  'Het bestand is gewijzigd door een ander programma.':
      'E archivo a kambia pa un otro programa.',
  'Herladen': 'Karga atrobe',
  ...
  'Thema documentband': 'Kabesera/pia di página di tema',
  ...
  'Basislettergrootte: {pt} pt': 'Tamaño di lèter básiko: {pt} pt',
  ...
  'Afdoening vastleggen': 'Liquidación récord',
  'Bijvoorbeeld een factuur-, licentie- of dossierverwijzing':
      'Por ejemplo, una factura, licencia o referencia de archivo.',
  'Controleert afbeeldingen lokaal op mogelijke auteursrechtelijke risico’s. Nieuwe repositoryafbeeldingen en de volledige assetpool kunnen worden gescand; een beheerder handelt waarschuwingen af. Dit is een signalering, geen juridisch oordeel, en er worden geen afbeeldingen naar derden gestuurd.':
      'Comprueba las imágenes localmente para detectar posibles riesgos de derechos de autor. Se pueden escanear nuevas imágenes del repositorio y todo el conjunto de activos; un administrador maneja las alertas. Esta es una alerta, no una opinión legal y no se enviarán imágenes a terceros.',
  'De afdoening kon niet worden opgeslagen. Scan opnieuw en probeer het nogmaals.':
      'El acuerdo no se pudo salvar. Vuelva a escanear e inténtelo de nuevo.',
  'Dit is een technische signalering, geen juridisch oordeel. Een beheerder beoordeelt de aanwijzingen.':
      'Esta es una alerta técnica, no una opinión legal. Un administrador revisa las instrucciones.',
  'Geen openstaande aanwijzingen.': 'No hay pistas pendientes.',
  'Geldige rechten aangetoond': 'Derechos válidos demostrados',
  'Mogelijke auteursrechtelijke risico’s':
      'Posibles riesgos de derechos de autor',
  'Niet gebruiken': 'no usar',
  'Notitie (optioneel)': 'Nota (opcional)',
  'Onterechte signalering': 'Señalización errónea',
  'afbeeldingen vragen om beoordeling': 'las imágenes requieren revisión',
  ...
  'Eénsteeks t-toets': 'Test t di un muestra',
  ...
  'Fractioneel (2^(k−p))': 'Frakshonal (2^(k−p))',
  'Fractie p': 'Frakshon p',
  'runs in standaard Yates-volgorde': 'ensayos en orden Yates estándar',
  'In raster zetten': 'Yena e reit',
  ...
  'De browser blokkeert media van een externe bron. Open deze presentatie in de app om online media te tonen.':
      'E navegador ta blokia media di un fuente eksterno. Habri e presentashon aki den e app pa mustra media online.',
  ...
  'Intrekken is niet vastgelegd. Bij de volgende start geldt uw toestemming weer.':
      'E retirada no a keda grabá. Ora bo start di nobo, bo konsentimentu ta bálido atrobe.',
  ...
  'Het token heeft de repo-scope nodig (of fijnmazig: Contents lezen en schrijven).':
      'E token mester tin e scope repo (òf detayá: Contents lesa i skirbi).',
  ...
  'Hoeveel detail?': 'Kuantu detaye?',
  'Met verdieping': 'Ku profundisashon',
  'Beknopt': 'Resumí',
  'Het detail achter het verhaal. Deze slide gaat mee in de volledige export en valt weg in de beknopte — los van wie hem mag zien.':
      'E detaye tras di e historia. E slide aki ta bai ku e eksportashon kompletu i ta kai afó den esun resumí — independiente di ken por mir\'é.',
  ...
  'werkgeversnummer (EIN)': 'number di dunadó di trabou (EIN)',
  'laatste vier cijfers van een SSN': 'último kuater sifra di un SSN',
  ...
  'Deze slide hoort bij de lijst van de vorige slide en deelt daarmee één lettergrootte: die van de volste pagina.':
      'E slide aki ta pertenesé na e lista di e slide anterior i pesei ta kompartí un tamaño di lèter: esun di e página mas yen.',
  ...
  'Veel bullets op deze slide': 'Hopi bullet riba e slide aki',
  'bullets': 'bullet',
  'Overweeg de inhoud te splitsen.': 'Konsiderá di dividí e kontenido.',
  'Erg veel bullets op deze slide': 'Muchu bullet riba e slide aki',
  'Splits deze inhoud over meerdere slides.':
      'Dividí e kontenido aki riba vários slide.',
  'Veel woorden in bullets': 'Hopi palabra den e bulletnan',
  'woorden': 'palabra',
  'Maak bullets korter of splits de slide.':
      'Hasi e bulletnan mas kòrtiku of dividí e slide.',
  'Erg veel woorden in bullets': 'Muchu palabra den e bulletnan',
  'Gemiddeld lange bullets': 'Bullet largo na promedio',
  'woorden per bullet': 'palabra pa bullet',
  'Maak elke bullet kernachtiger.': 'Hasi kada bullet mas konsiso.',
  'Bullet met meerdere zinnen gevonden. Maak bullets kernachtiger of splits de inhoud.':
      'A haña un bullet ku mas ku un frase. Hasi e bulletnan mas konsiso of dividí e kontenido.',
  'Diepe bulletniveaus gevonden': 'A haña nivelnan di bullet profundo',
  'niveau': 'nivel',
  'Beperk nesting voor betere leesbaarheid.':
      'Limitá nesting pa mihó lesibilidat.',
  'Twee kolommen zijn sterk uit balans': 'Dos kolòm ta masha desbalansá',
  'tegenover': 'kontra',
  'Verdeel of splits de inhoud.': 'Redistribuí of dividí e kontenido.',
  ...
  'Informatieveiligheid: RASCI / TVB': 'Seguridat di informashon: RASCI / TVB',
  'Takenplan informatieveiligheid': 'Plan di tarea di seguridat',
  ...
  'De LibrePlan-connector is alleen beschikbaar in de desktopversie.':
      'E konektor LibrePlan ta disponibel solamente den e vershon di desktop.',
  'LibrePlan-connector is optioneel en staat standaard uit. Er wordt niets opgehaald totdat u dit inschakelt en zelf een server configureert. Alleen-lezen: de connector schrijft niets terug naar LibrePlan. Het wachtwoord wordt in de sleutelhanger van uw besturingssysteem opgeslagen, niet in het deck.':
      'E konektor LibrePlan ta opshonal i ta pagá pa defekto. No ta wòrdu saká nada te ora bo aktivé i bo mes konfigurá un server. Solamente pa lesa: e konektor no ta skirbi nada bèk na LibrePlan. E kontraseña ta wòrdu wardá den e keychain di bo sistema operativo, no den e deck.',
  'Opgeslagen in de sleutelhanger': 'Wardá den e keychain',
  'Alleen voor servers op het eigen netwerk (LAN). Staat plain-HTTP toe en staat privé-adressen door de NetGuard. Uitgeschakeld: HTTPS verplicht.':
      'Solamente pa server riba bo mes red (LAN). Ta permití HTTP simpel i ta laga adresnan privá pasa dor di NetGuard. Pagá: HTTPS obligatorio.',
  'Verbinding succesvol.': 'Konekshon a bai bon.',
  'Onverwachte fout.': 'Eror inesperá.',
  'Importeren uit LibrePlan': 'Importá for di LibrePlan',
  'LibrePlan importeren': 'Importá for di LibrePlan',
  'Kies welke slides u uit het LibrePlan-project wilt halen. De import is alleen-lezen en schrijft niets terug.':
      'Skohe kua lámina bo ke saka for di e proyekto LibrePlan. E importashon ta solamente pa lesa i no ta skirbi nada bèk.',
  'Gantt-planning': 'Planifikashon Gantt',
  'WBS (hiërarchie)': 'WBS (herarkia)',
  'Projectstatus (cockpit)': 'Estado di proyekto (cockpit)',
  'Milestones (tijdlijn)': 'Hitonan (liña di tempu)',
  'Kritieke pad (flow)': 'Kaminda krítiko (flujo)',
  'Resources (tabel)': 'Rekursonan (tabel)',
  'Timesheet (tabel)': 'Hoja di ora (tabel)',
  'Resourcebelasting (grafiek)': 'Karga di rekurso (gráfiko)',
  'Ophalen uit LibrePlan…': 'Ta saka for di LibrePlan…',
  ...
  'Vul server-URL en gebruikersnaam in.':
      'Yena e URL di server i nòmber di usuario.',
