...
const _dutchSourceRo = {
  ...
  'Laatste reeks als lijn op een tweede as; de rest als staven.':
      'Ultima serie ca linie pe o a doua axă; restul ca bare.',
  'Eerste reeks: elke waarde is een op- of neerwaartse stap op het vorige totaal.':
      'Prima serie: fiecare valoare este un pas în sus sau în jos pe totalul curent.',
  'Reeks = rij, kolom = label, celkleur volgt de waarde. Label de assen kans en impact voor een risicomatrix.':
      'Serie = rând, coloană = etichetă, culoarea celulei urmează valoarea. Etichetează axele ca probabilitate și impact pentru o matrice de risc.',
...
const _dutchSourceAddRo = <String, String>{
  ...
  'Aangemaakt op': 'Creat pe',
  'Aanmeldprovider': 'Furnizor de conectare',
  'Aanmeldsessies': 'Sesiuni de înregistrare',
  'Aantal controles': 'Numărul de verificări',
  ...
  'Activiteitnummer': 'Numărul activității',
  'Afgerond op': 'Rotunjit la',
  'Afgewezen': 'Respins',
  'Afspeelsessienummer': 'Numărul sesiunii de redare',
  'Afwezig': 'absent',
  'Antwoordgegevens': 'Detalii de răspuns',
  'Antwoordstatus': 'Starea răspunsului',
  'Begint op': 'Începe',
  'Begrippen uitgelegd': 'Concepte explicate',
  'Beheer van de installatie': 'Managementul instalatiei',
  'Beheerpogingen': 'Eforturile de management',
  'Bekeken lessen': 'Lecții vizualizate',
  'Beleidsversie': 'Versiunea politicii',
  'Beoordeeld': 'Evaluat',
  'Beoordeeld op': 'Evaluat de',
  'Beperking': 'Restricție',
  'Berekend op': 'Calculat pe',
  'Bericht': 'Mesaj',
  'Bestandsnaam': 'Nume fișier',
  'Beveiligingsvraagnummer': 'Numărul întrebării de securitate',
  'Bevestigd': 'Confirmat',
  'Bevestigd op': 'Confirmat pe',
  'Bewaarregels': 'Reguli de reținere',
  'Bewaartermijn': 'Perioada de păstrare',
  'Bewaren wegens een juridische verplichting':
      'Reținut din cauza unei obligații legale',
  'Bewerkingnummer bij aanmeldprovider':
      'Numărul operațiunii la furnizorul de înregistrare',
  'Bewijsstukken': 'Dovezi',
  'Bezwaar': 'Obiecție',
  'Beëindigd op': 'S-a terminat pe',
  'Bijeenkomstnummer': 'Numărul întâlnirii',
  'Certificaatnummer': 'Numărul certificatului',
  'Certificaten': 'Certificate',
  'Controlecode van de PDF': 'Codul de control al PDF-ului',
  'Controlecode van profielfoto': 'Cod de verificare a fotografiei de profil',
  'Controlecodes van bewijsstukken':
      'Codurile de control ale documentelor justificative',
  'Correctie': 'Corectare',
  'Cursistnummer waarop de actie gericht was':
      'Numărul de student către care a fost vizată acțiunea',
  'Cursusaanbodnummer': 'Numărul ofertei de curs',
  'Cursusversienummer': 'Numărul versiunii cursului',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Datele și orele sunt afișate în ora dvs. locală. Numele tehnice rămân vizibile atunci când serverul oferă un câmp necunoscut.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'Răspunsurile pe care le-ați dat la întrebările de testare.',
  'Deelnamenummer': 'Numar de participare',
  'Deelnames': 'Participari',
  'Details': 'Detalii',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Această categorie a fost furnizată de server. Numele tehnice rămân vizibile pentru întrebări din partea organizației dvs.',
  'Door uzelf aangevraagd': 'Solicitat de tine',
  'E-mailadres': 'Adresă de e-mail',
  'E-mailberichten': 'Mesaje prin e-mail',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'Un ID este un număr tehnic unic pe care eLearning îl folosește pentru a lega datele între ele. Nu este o evaluare sau un statut.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'O categorie grupează date pe același subiect. O înregistrare este o bucată de date salvată sau un eveniment.',
  'Eindigt op': 'se termină în',
  'Geaccepteerd op': 'Acceptat pe',
  'Geannuleerd': 'Anulat',
  'Gecontroleerd': 'Verificat',
  'Gecontroleerd op': 'Verificat',
  'Geen gegevens gevonden': 'Nu s-au găsit date',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Informații despre perioadele de păstrare și ștergerea datelor dvs.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Informații despre documente justificative, rezultate obținute și certificate.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Informații despre solicitările de confidențialitate și cine v-a vizualizat sau modificat informațiile.',
  'Gegevens over uw accountbewerking':
      'Informații despre funcționarea contului dvs',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Informații despre înregistrarea, participarea și progresul dvs. la lecții.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Informații despre profilul, contul și poziția dvs. în cadrul organizației.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Informații despre momentele de testare și întrebările prezentate.',
  'Gegevens over willekeurige volgorde': 'Date ale comenzii aleatorii',
  'Gegevenscategorie': 'Categoria de date',
  'Gekoppeld accountnummer': 'Numărul de cont conectat',
  'Gekozen antwoorden': 'Răspunsuri selectate',
  'Gelukt': 'Succes',
  'Geprobeerd op': 'A încercat',
  'Gerechtvaardigd belang': 'Interes legitim',
  'Gereserveerd': 'Rezervat',
  'Gereserveerd op': 'Rezervat pe',
  'Geslaagd': 'A trecut',
  'Gestart op': 'A început pe',
  'Getoonde tijd per dia in milliseconden':
      'Timpul afișat pe diapozitiv în milisecunde',
  'Herkomst van inschrijving': 'Originea înregistrării',
  'Hoogst haalbare score': 'Cel mai mare scor posibil',
  'Identificatienummer bij aanmeldprovider':
      'Număr de identificare pentru furnizorul de înregistrare',
  'Identiteitsbewerkingnummer': 'Numărul operațiunii de identitate',
  'In afwachting': 'În așteptare',
  'In behandeling': 'În curs',
  'In behandeling genomen op': 'Procesat pe',
  'In quarantaine': 'În carantină',
  'Ingeleverd': 'Trimis',
  'Ingeleverd op': 'Trimis pe',
  'Ingericht op': 'Decorat pe',
  'Ingeschreven op': 'Înregistrat pe',
  'Ingetrokken': 'Retras',
  'Ingetrokken op': 'Retras pe',
  'Inschrijvingen': 'Înregistrări',
  'Inschrijvingsnummer': 'Număr de înregistrare',
  'Installatiebeveiligingslogboek': 'Jurnal de securitate de instalare',
  'Installatienummer': 'Numărul de instalare',
  'Installatieverzoeken': 'Cereri de instalare',
  'Inzage': 'Inspecție',
  'Ja': 'Da',
  'Kwalificatienummer': 'Numărul de calificare',
  'Kwalificaties': 'Calificări',
  'Laatst actief op': 'Ultima activitate pe',
  'Laatst bekeken dia': 'Ultimul diapozitiv vizualizat',
  'Laatst gewijzigd op': 'Ultima modificare pe',
  'Laatste fout': 'Ultima greseala',
  'Lesnummer': 'Numărul lecției',
  'Lesreserveringen': 'Rezervări pentru lecții',
  'Lesvoortgang': 'Progresul lecției',
  'Lidmaatschappen': 'Membrii',
  'Locatie': 'Locație',
  'Manier van afronden': 'Mod de rotunjire',
  'Maximaal aantal controles': 'Numărul maxim de verificări',
  'Maximaal aantal pogingen': 'Numărul maxim de încercări',
  'Maximale leeftijd van de aanmelding': 'Vârsta maximă de înregistrare',
  'Mislukt': 'A eșuat',
  'Naam van de activiteit': 'Denumirea activității',
  'Naam van de bijeenkomst': 'Numele întâlnirii',
  'Nee': 'Nu',
  'Netwerkadres': 'Adresa de rețea',
  'Niet actief': 'Nu este activ',
  'Niet geregistreerd': 'Neînregistrat',
  'Niet ingevuld': 'Nu completat',
  'Niet verschenen': 'Nepublicat',
  'Niveau van extra aanmeldcontrole':
      'Nivelul de control suplimentar al înregistrării',
  'Nummer van de toetsopzet': 'Numărul planului de testare',
  'Nummer van het brongegeven': 'Numărul datelor sursă',
  'Nummer van uw verwijderde gegeven': 'Numărul datelor dvs. șterse',
  'Onderdeel {nummer}': 'Piesa {nummer}',
  'Onderwerp van de actie': 'Obiectul actiunii',
  'Ontvanger': 'Destinatar',
  'Opgegeven bestandsgrootte': 'Dimensiunea specificată a fișierului',
  'Opgegeven bestandstype': 'Tipul de fișier specificat',
  'Opgegeven controlecode': 'Cod de control specificat',
  'Opgeslagen bestandsgrootte': 'Dimensiunea fișierului salvat',
  'Opgeslagen controlecode': 'Cod de control stocat',
  'Organisatienummer': 'Numărul organizației',
  'Overdraagbaarheid': 'Transferabilitate',
  'PE-toekenningnummer': 'Numărul premiului PE',
  'Poging': 'încercare',
  'Positie': 'Poziție',
  'Privacyverzoeken': 'Solicitări de confidențialitate',
  'Probeer een andere zoekterm.': 'Încercați un alt termen de căutare.',
  'Reden': 'Motivul',
  'Reden of grondslag': 'Motivul sau temeiul',
  'Reden van afwijzing': 'Motivul respingerii',
  'Reden van bevestiging': 'Motivul confirmării',
  'Reden van intrekking': 'Motivul retragerii',
  'Reden voor langer bewaren': 'Motiv pentru depozitare mai lungă',
  'Regels voor de cursusversie': 'Reguli pentru versiunea cursului',
  'Resultaat bij de aanmeldprovider': 'Rezultat la furnizorul de înregistrare',
  'Rol': 'Roll',
  'Score': 'Scor',
  'Soort aanwezigheid': 'Un fel de prezență',
  'Soort accountbewerking': 'Tipul operațiunii contului',
  'Soort gebeurtenis': 'Tipul evenimentului',
  'Soort privacyverzoek': 'Tipul cererii de confidențialitate',
  'Status van de bijeenkomst': 'Starea întâlnirii',
  'Strenge beveiligingsmodus': 'Mod de înaltă securitate',
  'Technisch toegangslogboek': 'Jurnal de acces tehnic',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Date tehnice necesare pentru înregistrare, securitate și procesare fiabilă.',
  'Technische naam: {naam}': 'Denumire tehnică: {naam}',
  'Technische opslagcategorie': 'Categoria tehnică de depozitare',
  'Technische opslaglocatie van de PDF':
      'Locația de stocare tehnică a PDF-ului',
  'Tijdstip van aanmelding': 'Ora inregistrarii',
  'Tijdzone': 'Fus orar',
  'Toestand': 'Stare',
  'Toetspogingen': 'Încercări de testare',
  'Toetspogingnummer': 'Numărul încercării de testare',
  'Uiterste inlevermoment': 'Termenul limită de depunere',
  'Uitgegeven op': 'Publicat pe',
  'Uitgenodigd e-mailadres': 'Adresă de e-mail invitată',
  'Uitnodigingen': 'Invitații',
  'Uniek nummer (ID)': 'Număr unic (ID)',
  'Uniek verwerkingskenmerk': 'Caracteristica unică de procesare',
  'Uw accountnummer': 'Numărul de cont',
  'Uw accountnummer als uitvoerder': 'Numărul de cont ca executor',
  'Uzelf als uploader': 'Tu însuți în calitate de încărcător',
  'Vaardigheidsversienummer': 'Numărul versiunii de calificare',
  'Vast internetadres van de installatie':
      'Adresa de internet fixă a instalării',
  'Vastgelegde beslisgegevens': 'Date de decizie înregistrate',
  'Vastgelegde gegevens': 'Date înregistrate',
  'Vereist niveau van aanmeldzekerheid':
      'Nivelul necesar de certitudine a înregistrării',
  'Vereiste aanmeldmethoden': 'Metode de conectare necesare',
  'Verloopt bij inactiviteit op': 'Expiră când este inactiv',
  'Verloopt definitief op': 'Expiră definitiv',
  'Verloopt op': 'Expiră',
  'Versienummer van de PE-regel': 'Numărul versiunii regulii PE',
  'Verwerkte verzoeken': 'Cereri procesate',
  'Verwijderd op': 'Eliminat pe',
  'Verwijdering': 'Îndepărtarea',
  'Verwijderingsregister': 'Registrul de eliminare',
  'Verwijzing naar het antwoord': 'Referire la răspuns',
  'Verzoeknummer': 'Numărul cererii',
  'Verzoeknummer van de app': 'Numărul solicitării aplicației',
  'Verzonden op': 'Trimis mai departe',
  'Volgende controle op': 'Următorul control',
  'Volgnummer': 'Numărul de ordine',
  'Volgorde van antwoordopties': 'Ordinea opțiunilor de răspuns',
  'Vraagnummer binnen de toetspoging':
      'Numărul întrebării în încercarea de testare',
  'Vraagversienummer': 'Numărul versiunii întrebării',
  'Vragen in toetspogingen': 'Întrebări în încercările de testare',
  'Vrijgegeven': 'Eliberat',
  'Vrijgegeven op': 'Eliberat pe',
  'Wat gebeurt na de bewaartermijn': 'Ce se întâmplă după perioada de păstrare',
  'Wettelijke verplichting': 'Obligație legală',
  'Wijzigingen aan PE-punten': 'Modificări ale punctelor PE',
  'Wijzigingen aan kwalificaties': 'Modificări ale calificărilor',
  'Wijzigingen in aanmeldbeveiliging':
      'Modificări ale securității de conectare',
  'Zekerheid': 'certitudine',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'De exemplu, căutați după curs, dată sau stare',
  'Zoeken in uw gegevens': 'Căutați datele dvs',
  '{aantal} categorieën gevonden': 'S-au găsit categorii {aantal}',
  'Aanwezigheid': 'Prezență',
  'Lidmaatschap': 'Calitate de membru',
  'Inzage en wijzigingen': 'Acces și modificări',
  'Beschikbaarheid van het inzagespoor': 'Disponibilitatea jurnalului de acces',
  'Beschikbaar vanaf': 'Disponibil de la',
  'Historie vóór deze datum': 'Istoric înainte de această dată',
  'Tijdstip': 'Data și ora',
  'Handeling': 'Acțiune',
  'Gegevensonderdeel': 'Categoria de date',
  'Handelde als': 'A acţionat ca',
  'Organisatorische rol': 'Rolul organizatoric',
  'Bekeken': 'Vizualizat',
  'Gewijzigd': 'Schimbat',
  'Uzelf': 'tu',
  'Medewerker': 'Membru al personalului',
  'Systeem': 'Sistem',
  'Onbekend': 'Necunoscut',
  'Docent': 'Instructor',
  'Beoordelaar': 'Evaluator',
  'Organisatiebeheerder': 'Administrator organizatie',
  'Niet beschikbaar': 'Nu este disponibil',
  'Uitoefening van privacyrechten':
      'Exercitarea drepturilor la confidențialitate',
  'Beoordeling en certificering': 'Evaluare și certificare',
  'Uitvoering van het leertraject': 'Livrarea programului de învățare',
  'Cursistenadministratie': 'Administrarea cursantului',
  'Cursistprofiel': 'Profilul cursantului',
  'Leerstatistieken': 'Statistici de învățare',
  'Inschrijving': 'Înscriere',
  'Toetspoging': 'Încercarea de evaluare',
  'Beoordeling': 'Evaluare',
  'Bewijsstuk': 'Dovezi',
  'Kwalificatie': 'Calificare',
  'Deelname': 'Participarea',
  'PE-punten': 'Puncte de formare continuă',
  'Certificaat': 'Certificat',
  'Privacyverzoek': 'Cerere de confidențialitate',
  'Bewaard tot': 'Reţinut până la',
  'Bekijk mijn gegevens': 'Vizualizați datele mele',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Vedeți ce date a înregistrat eLearning despre dumneavoastră.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Această prezentare generală a fost preluată direct din eLearning la {datum} și nu este păstrată de OciDeck.',
  'Geen gegevens geregistreerd': 'Nu există date înregistrate',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'Conține toate categoriile furnizate de server pentru această organizație. Pentru informații despre scopuri, destinatari, proveniență, perioade de păstrare sau alte drepturi privind confidențialitatea, contactați {organisatie}.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Datele dumneavoastră nu au putut fi încărcate. Încercați din nou.',
  'Meer tonen ({aantal} resterend)': 'Afișați mai multe ({aantal} rămase)',
  'Mijn gegevens': 'Datele mele',
  'Privacy-inzage': 'Acces la datele cu caracter personal',
  'Uw geregistreerde gegevens': 'Datele dumneavoastră înregistrate',
  'uw organisatie': 'organizația dumneavoastră',
  '{aantal} registraties': '{aantal} înregistrări',
  ...
  'Alle lessen, voortgang en bekeken tijd bij elkaar.':
      'Toate lecțiile, progresul și timpul văzut împreună.',
  'Bekeken tijd betekent dat een dia in beeld stond. Het is geen meting van aandacht of actieve studietijd.':
      'Ora vizualizată înseamnă că un diapozitiv a fost pe ecran. Nu este o măsură a atenției sau a timpului de studiu activ.',
  'Bekijk mijn voortgang': 'Vezi progresul meu',
  'Bekijk uw resultaten': 'Vedeți rezultatele dvs',
  'Bekijk uw resultaten, activiteit en voortgang per cursus.':
      'Vedeți rezultatele, activitatea și progresul pe curs.',
  'Cursussen afgerond': 'Cursuri finalizate',
  'Een volledig overzicht van uw afgeronde lessen.':
      'O prezentare completă a lecțiilor finalizate.',
  'Laatste activiteit': 'Ultima activitate',
  'Lessen afgerond': 'Lecții finalizate',
  'Mijn voortgang': 'Progresul meu',
  'Nog geen lessen bekeken.': 'Nu s-au văzut încă lecții.',
  'Nog niet gestart': 'Nu a început încă',
  'Persoonlijk overzicht': 'Privire de ansamblu personală',
  'Recente activiteit': 'Activitate recentă',
  'Tijd in beeld': 'Timpul din imagine',
  'Uw cursussen': 'Cursurile tale',
  'Uw laatst bekeken lessen, meest recent bovenaan.':
      'Ultimele tale lecții vizualizate, cele mai recente în partea de sus.',
  'Uw persoonlijke leerresultaten': 'Rezultatele tale personale ale învățării',
  'Voortgang per cursus': 'Progres pe curs',
  '{afgerond} van {totaal}': '{afgerond} din {totaal}',
  '{percentage}% van de cursussen afgerond':
      '{percentage}% din cursuri finalizate',
  ...
  'Volgorde (marker)': 'Ordine (marcator)',
  'Toelichting (optioneel)': 'Descriere (opțional)',
  ...
  'Met afloop wordt de pagina rondom groter dan het gekozen formaat, zodat inkt die tot de rand loopt dóór de snijlijn heen gaat. De afloop geldt voor élke export tot je hem weer op 0 zet. Laat dit op 0 voor gewoon afdrukken.':
      'Cu bleed, pagina devine mai mare decât formatul ales pe toate laturile, astfel încât cerneala care ajunge la margine trece dincolo de linia de tăiere. Bleed-ul se aplică la fiecare export până când îl setezi din nou la 0. Lasă 0 pentru tipărirea obișnuită.',
  'Pagina\'s': 'Pagini',
  'Maat': 'Dimensiune',
  'Staand': 'Portret',
  'Liggend': 'Peisaj',
  'documenten': 'documente',
  'posters en boeken': 'afișe și cărți',
  'enveloppen': 'plicuri',
  ...
  'Toch importeren': 'Importă oricum',
  'Koptekst': 'Antet',
  ...
  'Dit is een presentatie, geen Markdown-bestand. Zet de module Importeren aan om hem om te zetten naar een deck.':
      'Aceasta este o prezentare, nu un fișier Markdown. Activează modulul Importă pentru a o transforma într-un deck.',
  ...
  'Komma-gescheiden, bijv. OWASP WSTG@4.2':
      'Separate prin virgulă, ex. OWASP WSTG@4.2',
  'Titel van de presentatie': 'Titlul prezentării',
  ...
  '•  CVE opzoeken (staat standaard uit): staat het aan, dan gaat je zoekterm naar de ingestelde CVE-spiegel en, als die niets vindt, naar de Europese database van ENISA en naar MITRE.':
      '•  Căutare CVE (dezactivată implicit): când este activată, termenul dumneavoastră de căutare ajunge la oglinda CVE configurată și, dacă aceasta nu găsește nimic, la baza de date europeană a ENISA și la MITRE.',
  ...
  'Snelle server-zoekopdracht — door indexeringsvertraging kan een net gewijzigd deck ontbreken.':
      'Căutare rapidă pe server — din cauza întârzierii indexării, un pachet modificat recent poate lipsi.',
  ...
  'Certificaat vertrouwen?': 'Ai încredere în acest certificat?',
  'Het certificaat van deze server is niet ondertekend door een erkende uitgever. Dat is gewoon bij een zelf gehoste server, maar het is ook hoe een afgeluisterde verbinding eruitziet.':
      'Certificatul acestui server nu este semnat de un emitent recunoscut. Este normal pentru un server propriu, dar așa arată și o conexiune interceptată.',
  'Vergelijk de vingerafdruk hieronder met wat je server zelf toont. Komen ze overeen, dan praat je met de juiste machine.':
      'Compară amprenta de mai jos cu cea afișată de serverul tău. Dacă se potrivesc, vorbești cu mașina corectă.',
  'Uitgegeven aan': 'Emis pentru',
  'Uitgegeven door': 'Emis de',
  'Geldig tot': 'Valabil până la',
  'Vingerafdruk (SHA-256)': 'Amprentă (SHA-256)',
  ...
  'LibrePlan importeren': 'Importă din LibrePlan',
  ...
  'Gantt-planning': 'Planificare Gantt',
  'WBS (hiërarchie)': 'WBS (ierarhie)',
  'Projectstatus (cockpit)': 'Starea proiectului (cockpit)',
  'Milestones (tijdlijn)': 'Jaloane (cronologie)',
  'Kritieke pad (flow)': 'Drum critic (flux)',
  'Resources (tabel)': 'Resurse (tabel)',
  'Timesheet (tabel)': 'Fișă de pontaj (tabel)',
  ...
  'Scoring, feedback en metadata': 'Notare, feedback și metadate',
  'Punten, scoringstrategie, feedback, hints, pogingen en leerdoelkoppelingen.':
      'Puncte, strategie de notare, feedback, indicii, încercări și legături către obiective de învățare.',
  'Scoringstrategie': 'Strategie de notare',
  'Alles of niets': 'Totul sau nimic',
  'Deels': 'Parțial',
  'Per paar': 'Pe pereche',
  'Per item': 'Pe element',
  'Puntenaftrek per fout': 'Puncte deduse per răspuns greșit',
  'Maximum pogingen (0 = onbeperkt)': 'Încercări maxime (0 = nelimitat)',
  'Feedback per uitkomst': 'Feedback per rezultat',
  'Bij goed antwoord': 'La răspuns corect',
  'Bij fout antwoord': 'La răspuns greșit',
  'Bij deels goed': 'La răspuns parțial corect',
  'Bij timeout': 'La timeout',
  'Hints (één per regel, progressief)': 'Indicii (unul pe rând, progresiv)',
  'Eerste hint\nTweede hint': 'Primul indiciu\\nAl doilea indiciu',
  'Remediation — slide-anchor naar feedback-slide':
      'Remediation — ancoră slide către slide de feedback',
  'bijv. slide:3': 'ex. slide:3',
  'Leerdoelverwijzingen (slide-anchors, één per regel)':
      'Referințe ale obiectivelor de învățare (ancore slide, una pe rând)',
  'slide:0\nslide:5': 'slide:0\nslide:5',
  'Metadata': 'Metadate',
  'Vak/onderwerp': 'Materie/subiect',
  'Moeilijkheid': 'Dificultate',
  '— geen —': '— niciunul —',
  'Makkelijk': 'Ușor',
  'Gemiddeld': 'Mediu',
  'Moeilijk': 'Greu',
  'Geschatte duur in seconden': 'Durata estimată în secunde',
  'Tags (komma-gescheiden)': 'Etichete (separate prin virgulă)',
};
