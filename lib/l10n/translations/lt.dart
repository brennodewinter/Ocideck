...
const _dutchSourceAddLt = <String, String>{
  'OciDeck mag uw microfoon of camera niet gebruiken. Geef toestemming in uw browser of systeeminstellingen en probeer het opnieuw.':
      'OciDeck negali naudoti jūsų mikrofono ar kameros. Suteikite leidimą naršyklėje arba sistemos nuostatose ir bandykite dar kartą.',
  'Er is geen werkende microfoon gevonden. Sluit er een aan of kies een ander apparaat.':
      'Nerasta veikiančio mikrofono. Prijunkite jį arba pasirinkite kitą įrenginį.',
  'Er is geen werkende camera gevonden. U kunt zonder beeld meedoen.':
      'Nerasta veikiančios kameros. Galite prisijungti be vaizdo.',
  'De dienst die het toegangsbewijs afgeeft is onbereikbaar. Probeer het later opnieuw; uw presentatie blijft ondertussen gewoon open.':
      'Paslauga, išduodanti prieigos patvirtinimą, nepasiekiama. Bandykite vėliau; jūsų pateiktis tuo tarpu tiesiog lieka atverta.',
  'De dienst die het toegangsbewijs afgeeft heeft zijn grens voor nu bereikt. Probeer het later opnieuw.':
      'Paslauga, išduodanti prieigos patvirtinimą, kol kas pasiekė savo ribą. Bandykite vėliau.',
  'Het toegangsbewijs voor deze vergadering is verlopen. Doe opnieuw mee met dezelfde link.':
      'Šio susitikimo prieigos patvirtinimas nebegalioja. Prisijunkite dar kartą su ta pačia nuoroda.',
  'Het netwerk laat deze vergadering niet door. Op een bedrijfsnetwerk blokkeert een firewall of proxy dit soort verkeer vaak; een andere verbinding lukt meestal wel.':
      'Tinklas nepraleidžia šio susitikimo. Įmonės tinkle ugniasienė ar tarpinis serveris dažnai blokuoja tokį duomenų srautą; su kitu ryšiu paprastai pavyksta.',
  'Deze vergadering is voorbij.': 'Šis susitikimas jau baigėsi.',
  'De vergaderdienst is zelf niet beschikbaar. Dit ligt niet aan uw verbinding; probeer het later opnieuw.':
      'Pati susitikimų paslauga neprieinama. Tai nesusiję su jūsų ryšiu; bandykite vėliau.',
  'Meedoen is niet gelukt, en de dienst zegt niet waarom. De technische code staat bij de details — probeer het opnieuw, en geef die code door als het blijft misgaan.':
      'Prisijungti nepavyko, o paslauga nepasako kodėl. Techninis kodas nurodytas prie išsamesnės informacijos — bandykite dar kartą ir perduokite tą kodą, jei nesėkmė pasikartos.',
  'Dit is geen bruikbare vergaderlink. Kopieer hem opnieuw uit de uitnodiging — een link die door een chatprogramma is afgekapt of aangepast, doet het vaak niet meer.':
      'Tai nėra tinkama susitikimo nuoroda. Nukopijuokite ją dar kartą iš pakvietimo — nuoroda, kurią pokalbių programa apkirpo ar pakeitė, dažnai nebeveikia.',
  'Deze dienst kennen we, maar dit soort vergadering niet. Webinars, uitzendingen en persoonlijke vergaderkamers werken anders dan een gewone vergadering; open deze link in de browser.':
      'Šią paslaugą žinome, bet šio susitikimo tipo — ne. Internetiniai seminarai, transliacijos ir asmeniniai susitikimų kambariai veikia kitaip nei paprastas susitikimas; atverkite šią nuorodą naršyklėje.',
  'Deze vergaderdienst kennen we niet. OciDeck weet dus ook niet wat er achter deze link zit; u kunt hem in uw browser openen als u de afzender vertrouwt.':
      'Šios susitikimų paslaugos nežinome. Todėl OciDeck taip pat nežino, kas yra už šios nuorodos; galite ją atverti naršyklėje, jei pasitikite siuntėju.',
  'Meedoen kan op deze uitvoering van OciDeck niet. Gebruik de webversie in uw browser.':
      'Šioje OciDeck versijoje prisijungti negalima. Naudokite internetinę versiją naršyklėje.',
  'Deze browser mist iets wat voor meedoen nodig is. Een recente Chrome, Edge, Firefox of Safari lukt doorgaans wel.':
      'Šiai naršyklei kažko trūksta, kas reikalinga prisijungti. Naujesnė Chrome, Edge, Firefox ar Safari versija paprastai veikia.',
  'De organisatie van deze vergadering laat geen gasten zonder account toe. Vraag de organisator om u uit te nodigen op een manier die gasten toestaat.':
      'Šio susitikimo organizacija neįsileidžia svečių be paskyros. Paprašykite organizatoriaus pakviesti jus tokiu būdu, kuris leidžia svečius.',
  'Meedoen aan deze vergadering vereist een account bij de aanbieder. Open de link in uw browser en meld u daar aan.':
      'Norint prisijungti prie šio susitikimo, reikia paskyros pas teikėją. Atverkite nuorodą naršyklėje ir prisijunkite ten.',
  'Deze aanbieder laat alleen goedgekeurde programma\'s meedoen, en die goedkeuring is er voor OciDeck nog niet. Open de vergadering in uw browser.':
      'Šis teikėjas leidžia prisijungti tik patvirtintoms programoms, o OciDeck tokio patvirtinimo dar neturi. Atverkite susitikimą naršyklėje.',
  'De organisator heeft u niet toegelaten. Vraag of hij u binnenlaat en probeer het daarna opnieuw.':
      'Organizatorius jūsų neįleido. Paprašykite, kad jus įleistų, ir po to bandykite dar kartą.',
  'Deze vergadering is op slot; er komt niemand meer bij. Vraag de organisator om het slot eraf te halen.':
      'Šis susitikimas užrakintas; niekas daugiau neprisijungs. Paprašykite organizatoriaus atrakinti.',
  'Deze vergadering is eind-tot-eind versleuteld en laat daarom geen externe deelnemers toe. Dat is een keuze van de organisator; vraag hem om een gewone vergadering als u erbij moet zijn.':
      'Šis susitikimas šifruojamas nuo galo iki galo, todėl neįsileidžia išorinių dalyvių. Tai organizatoriaus pasirinkimas; paprašykite jo įprasto susitikimo, jei jums reikia jame būti.',
  '{plek} krijgt contact zodra u meedoet.':
      'Su {plek} bus susisiekta, kai tik prisijungsite.',
  'U doet mee met alleen de naam die u zelf opgeeft; u bent niet aangemeld als die persoon.':
      'Dalyvaujate tik tuo vardu, kurį patys nurodote; nesate prisijungę kaip tas asmuo.',
  'De dienst maakt een tijdelijke gastidentiteit voor u, die na de vergadering verdwijnt.':
      'Paslauga sukuria jums laikiną svečio tapatybę, kuri po susitikimo išnyksta.',
  'U doet mee als gast onder een dienstaccount van een organisatie.':
      'Dalyvaujate kaip svečias per organizacijos paslaugų paskyrą.',
  'De organisator heeft een identiteit voor u klaargezet.':
      'Organizatorius paruošė jums tapatybę.',
  'Meedoen gaat met uw eigen account bij deze aanbieder.':
      'Prisijungiate su savo paskyra pas šį teikėją.',
  'De aanbieder ziet uw netwerkgegevens en het beeld en geluid dat u verstuurt. Wat u deelt, deelt u met alle deelnemers.':
      'Teikėjas mato jūsų tinklo duomenis ir jūsų siunčiamą vaizdą bei garsą. Tai, kuo dalijatės, dalijatės su visais dalyviais.',
  'Het verkeer is versleuteld naar de dienst toe; de dienst zelf kan meekijken.':
      'Duomenų srautas šifruojamas pakeliui į paslaugą; pati paslauga gali jį matyti.',
  'De aanbieder beheert de versleuteling en dus ook de sleutels.':
      'Teikėjas valdo šifravimą, taigi ir raktus.',
  'De aanbieder beschrijft dit als eind-tot-eind versleuteld.':
      'Teikėjas tai aprašo kaip šifruojamą nuo galo iki galo.',
  'Over de versleuteling is niets vastgesteld. OciDeck belooft daar dus niets over.':
      'Apie šifravimą nieko nenustatyta. Todėl OciDeck nieko apie tai nežada.',
  'U komt eerst in een wachtruimte: een organisator moet u toelaten. Uw presentatie blijft ondertussen gewoon te bewerken.':
      'Pirmiausia atsidursite laukiamajame: organizatorius turi jus įleisti. Tuo tarpu savo pateiktį galite toliau redaguoti.',
  'Deze vergadering vraagt om een wachtwoord.':
      'Šis susitikimas prašo slaptažodžio.',
  'Deze vergadering vraagt om aanmelding vooraf.':
      'Šiam susitikimui reikia išankstinės registracijos.',
  'Vergadering wordt voorbereid': 'Susitikimas ruošiamas',
  'Verbinden met de vergadering': 'Prisijungiama prie susitikimo',
  'Wachten op toelating door de organisator':
      'Laukiama, kol organizatorius įleis',
  'U doet mee aan de vergadering': 'Dalyvaujate susitikime',
  'De verbinding is weggevallen — opnieuw verbinden':
      'Ryšys nutrūko — jungiamasi iš naujo',
  'De vergadering wordt verlaten': 'Išeinama iš susitikimo',
  'De vergadering is beëindigd': 'Susitikimas baigėsi',
  'Meedoen is niet gelukt': 'Prisijungti nepavyko',
  'Deze vergadering wordt opgenomen.': 'Šis susitikimas įrašomas.',
  'Deze vergadering wordt uitgeschreven.': 'Šis susitikimas transkribuojamas.',
  'Deze vergadering wordt opgenomen en uitgeschreven.':
      'Šis susitikimas įrašomas ir transkribuojamas.',
  'De vergadering vraagt uw uitdrukkelijke toestemming om mee te blijven doen.':
      'Susitikimas prašo jūsų aiškaus sutikimo toliau dalyvauti.',
  'Een organisator moet u nog toelaten. U kunt gewoon doorwerken; zodra u binnen bent, opent het gespreksvenster zich.':
      'Organizatorius dar turi jus įleisti. Galite ramiai dirbti toliau; kai tik būsite viduje, atsidarys skambučio langas.',
  'Herkend als een vergadering bij {plek}.':
      'Atpažinta kaip susitikimas svetainėje {plek}.',
  '{uitleg} De link wijst naar {plek}.': '{uitleg} Nuoroda veda į {plek}.',
  'Deze naam kiest u zelf; niemand controleert hem. De anderen zien u als gast.':
      'Šį vardą pasirenkate patys; niekas jo netikrina. Kiti mato jus kaip svečią.',
  'Afsluiten': 'Baigti',
  'Camera aanzetten': 'Įjungti kamerą',
  'Camera uitzetten': 'Išjungti kamerą',
  'Microfoon aanzetten': 'Įjungti mikrofoną',
  'Microfoon dempen': 'Nutildyti mikrofoną',
  'Presentatie delen': 'Bendrinti pateiktį',
  'Delen stoppen': 'Baigti bendrinimą',
  'Gespreksvenster': 'Skambučio langas',
  'Venster sluiten': 'Uždaryti langą',
  'Meedoen': 'Prisijungti',
  'Meedoen aan een onlinevergadering':
      'Prisijungimas prie internetinio susitikimo',
  'Onlinevergadering': 'Internetinis susitikimas',
  'Onlinevergadering…': 'Internetinis susitikimas…',
  'Vergaderlink': 'Susitikimo nuoroda',
  'Plak hier de link uit de uitnodiging':
      'Įklijuokite čia nuorodą iš pakvietimo',
  'Uw naam, zoals de anderen die zien': 'Jūsų vardas, kokį jį mato kiti',
  'Wat er gebeurt als u meedoet': 'Kas nutinka, kai prisijungiate',
  'Verlaten': 'Išeiti',
  'Weigeren en verlaten': 'Atsisakyti ir išeiti',
  'Toestemming geven': 'Duoti sutikimą',
  'Technische code: {code}': 'Techninis kodas: {code}',
  'Deelnemers ({aantal})': 'Dalyviai ({aantal})',
  'Nog geen deelnemers.': 'Dalyvių dar nėra.',
  'Deze vergadering geeft geen deelnemerslijst.':
      'Šis susitikimas neteikia dalyvių sąrašo.',
  'gast': 'svečias',
  'deelnemer': 'dalyvis',
  'presentator': 'pranešėjas',
