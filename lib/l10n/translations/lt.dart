...
const _stringsLt = {
  ...
  'exportNeedsSave': 'Prieš eksportuodami įrašykite prezentaciją',
  'exportNeedsClean': 'Prieš eksportuodami įrašykite pakeitimus',
  'saved': 'Įrašyta',
  'unsaved': 'Neįrašyta',
  'unsavedChanges': 'Įrašyti pakeitimus (Ctrl/Cmd+S)',
  'noUnsavedChanges': 'Neįrašytų pakeitimų nėra',
  'notSavedYet': 'Dar neįrašyta',
  'noFileYet': 'Ši prezentacija dar neturi failo',
  'slides': 'skaidrės',
  'skipped': 'praleista',
  'allSlidesIncluded': 'Visos skaidrės bus pristatytos ir eksportuotos',
  'skippedSlidesExcluded': 'skaidrė (-ės) nebus pristatytos ar eksportuotos',
  'styleProfile': 'Stiliaus profilis',
  'classification': 'Klasifikacija',
  'exportNextToDeck': 'Eksportuoti šalia rinkinio',
  'exportsNextToDeck': 'Eksportai įrašomi šalia rinkinio',
  'exportFolder': 'Eksportas',
  'newPresentationTab': 'Nauja prezentacija (skirtukas)',
  'exportPackage': 'Eksportuoti paketą…',
  'importPackage': 'Importuoti paketą…',
...
const _dutchSourceLt = {
  ...
  'Mogelijke impact': 'Galimas poveikis',
  'Aanbeveling': 'Rekomendacija',
  'Bevinding-id': 'Radinio ID',
  'Controleer de CVSS-vector': 'Patikrinkite CVSS vektorių',
  'Notitie': 'Pastaba',
  'Status': 'Būsena',
  'getoetst': 'patikrinta',
  ...
  'Twee Bulletkolommen': 'Du ženklų stulpeliai',
  'Bullets + Afbeelding': 'Ženklai + paveikslėlis',
  ...
  'Niet meer overslaan': 'Nebeleisti praleisti',
  'Overslaan': 'Praleisti',
  'Titel': 'Pavadinimas',
  'Titel (optioneel)': 'Pavadinimas (nebūtinas)',
  'Slide titel': 'Skaidrės pavadinimas',
  'Ondertitel': 'Paantraštė',
  'Subtitel': 'Paantraštė',
  'Optionele subtitel': 'Nebūtina paantraštė',
  'Bullets': 'Ženklai',
  'Bullet toevoegen': 'Pridėti ženklą',
  'Verwijder': 'Pašalinti',
  'Citaat': 'Citata',
  'Citaat tekst...': 'Citatos tekstas...',
  'Auteur': 'Autorius',
  ...
  'Zoeken naar': 'Ieškoti',
  'Vervangen door': 'Pakeisti į',
  'Vervang': 'Pakeisti',
  'Vorige': 'Ankstesnis',
  'Volgende': 'Kitas',
  'Vet': 'Paryškintas',
  'Cursief': 'Kursyvas',
  'Doorhalen': 'Perbrauktas',
  'Code': 'Kodas',
  'Link': 'Nuoroda',
  'Kop': 'Antraštė',
  'Hoofdlettergevoelig': 'Skiriamos didžiosios raidės',
  'Vervang alles': 'Pakeisti viską',
  'Niets vervangen': 'Nieko nepakeista',
  'vervangen': 'pakeista',
  'Geen resultaten': 'Rezultatų nėra',
  'resultaat': 'rezultatas',
  'resultaten': 'rezultatai',
  'Nieuwe presentatie': 'Nauja pateiktis',
  'Bijv. Kwartaalupdate Q4': 'Pvz. Q4 atnaujinimas',
  'Vul een titel in': 'Įveskite pavadinimą',
  'Aanmaken': 'Sukurti',
  'Slide type kiezen': 'Pasirinkti skaidrės tipą',
  'Presentatie-eigenschappen': 'Pateikties savybės',
  'Versie': 'Versija',
  'Bijv. Jan Jansen': 'Pvz. Jonas Jonaitis',
  'Bijv. Vigilis': 'Pvz. Vigilis',
  'Bijv. 2026-05-30': 'Pvz. 2026-05-30',
  ...
  'Kaarten en dialogen': 'Kortelės ir dialogai',
  'Gedempte tekst': 'Prislopintas tekstas',
  'Zijpanelen': 'Šoniniai skydeliai',
  ...
  'Standaardprofiel laden': 'Įkelti numatytąjį profilį',
  ...
  'Tabel koptekst': 'Lentelės antraštės tekstas',
  'Titelachtergrond': 'Pavadinimo fonas',
  'Titeltekst': 'Pavadinimo tekstas',
  'Sectieachtergrond': 'Skyriaus fonas',
  'Geselecteerd': 'Pasirinkta',
  'Logo': 'Logotipas',
  'Geen logo ingesteld': 'Logotipas nenustatytas',
  'Verwijder logo': 'Pašalinti logotipą',
  'Logo positie': 'Logotipo padėtis',
  ...
  'Vorige slide': 'Ankstesnė skaidrė',
  'Volgende slide': 'Kita skaidrė',
  'paginering aan': 'puslapiavimas įjungtas',
  'Thema': 'Tema',
  'volledig deck': 'visas rinkinys',
  'Slide': 'Skaidrė',
  'TYPE': 'TIPAS',
  'STIJL': 'STILIUS',
  ...
  'fout(en),': 'klaida (-os),',
  'waarschuwing(en)': 'įspėjimas (-ai)',
  'Afbeelding kiezen': 'Pasirinkti paveikslėlį',
  'Afbeeldingen laden…': 'Įkeliami paveikslėliai…',
  'Sluiten (Esc)': 'Uždaryti (Esc)',
  'Zoek op naam of beschrijving…': 'Ieškoti pagal pavadinimą ar aprašymą…',
  'Raster': 'Tinklelis',
  'Coverflow': 'Coverflow',
  ...
  'Slide-overzicht (pijltjes + Enter)': 'Skaidrių apžvalga (rodyklės + Enter)',
  ...
  'VOLGENDE': 'KITA',
  'NOTITIES': 'PASTABOS',
  'Einde van de presentatie': 'Pristatymo pabaiga',
  'Verstreken': 'Praėjo',
  'Klok': 'Laikrodis',
  ...
  '1 slide geïmporteerd.': 'Importuota 1 skaidrė.',
  'slides geïmporteerd.': 'skaidrės importuotos.',
  'Export wordt voorbereid…': 'Ruošiamas eksportas…',
  'tip(s)': 'patarimas (-ai)',
  'fout(en)': 'klaida (-os)',
  'Kwaliteitsoverzicht': 'Kokybės apžvalga',
  'Bekijk meldingen…': 'Peržiūrėti pranešimus…',
  'Bekijk alle meldingen…': 'Peržiūrėti visus pranešimus…',
  'Tips': 'Patarimai',
  ...
  '1 slide overgeslagen': '1 skaidrė praleista',
  'slides overgeslagen': 'skaidrės praleistos',
  'Alles tonen': 'Rodyti viską',
  'geselecteerd': 'pažymėta',
  ...
  'Ingesloten inhoud': 'Įterptas turinys',
  'Onveilige URL': 'Nesaugus URL',
  'Zoekopdracht wissen': 'Išvalyti paiešką',
  'Bullet verwijderen': 'Pašalinti punktą',
  'Kolom verwijderen': 'Pašalinti stulpelį',
  'Rij omhoog': 'Eilutę aukštyn',
  'Rij omlaag': 'Eilutę žemyn',
  'Optie verwijderen': 'Pašalinti parinktį',
  'Optie toevoegen': 'Pridėti parinktį',
  'Duur verkorten': 'Sutrumpinti trukmę',
  'Duur verlengen': 'Pailginti trukmę',
  'Afspelen': 'Leisti',
  'Pauzeren': 'Pristabdyti',
  'Opsommingsteken': 'Punktas',
  'Stip': 'Taškas',
  'Pootje': 'Letenėlė',
  ...
  'Markering': 'Žymeklis',
  'bijv. 2024': 'pvz., 2024',
  'Titel van gebeurtenis': 'Įvykio pavadinimas',
  'Omschrijving (optioneel)': 'Aprašymas (nebūtina)',
  'Soort vraag': 'Klausimo tipas',
  'Meerkeuze': 'Pasirenkamasis',
  'Vraag': 'Klausimas',
  ...
  'Goed!': 'Teisingai!',
  'Helaas, fout': 'Deja, neteisingai',
  'van': 'iš',
  'opties worden willekeurig getoond': 'parinktys rodomos atsitiktinai',
  'antwoordtijd': 'atsakymo laikas',
  'bij fout: opnieuw proberen': 'jei neteisingai: bandyti dar kartą',
  'bij fout: door, niet opnieuw': 'jei neteisingai: tęsti, be kartojimo',
  'Beantwoord eerst de vraag.': 'Pirmiausia atsakykite į klausimą.',
  'Klik om opnieuw te proberen': 'Spustelėkite, kad bandytumėte dar kartą',
  ...
  'Cockpitmeters': 'Kabinos matuokliai',
  'Meter toevoegen': 'Pridėti matuoklį',
  'Animeren bij binnenkomst': 'Animuoti įėjus',
  ...
  'Werkelijk': 'Faktinis',
  'Doel': 'Tikslas',
  'Markeringslabel': 'Žymeklio etiketė',
  'Min': 'Min',
  'Max': 'Maks',
  'Neutraal van': 'Neutralus nuo',
  'Neutraal tot': 'Neutralus iki',
  'Groen van': 'Žalias nuo',
  'Groen tot': 'Žalias iki',
  'Rood van': 'Raudonas nuo',
  'Snelheidsmeter': 'Spidometras',
  'Voltmeter': 'Voltmetras',
  'Thermometer': 'Termometras',
  'Hoogtemeter': 'Aukščiamatis',
  'Stijgen/dalen': 'Kilimas/leidimasis',
  'Kunstmatige horizon': 'Horizontas',
  'Koers': 'Kursas',
  ...
  'Volgende slide of pagina': 'Kita skaidrė arba puslapis',
  'Vorige pagina': 'Ankstesnis puslapis',
  'Vorige slide of pagina': 'Ankstesnė skaidrė arba puslapis',
  'Toegankelijkheid': 'Prieinamumas',
  'Presentatie': 'Prezentacija',
  'Tabel kopachtergrond': 'Lentelės antraštės fonas',
  ...
  'Binnen de tijd': 'Neviršyta',
  'Deze slide': 'Ši skaidrė',
  'Oefenrun': 'Repeticija',
  'Totaal': 'Iš viso',
  'Totale tijd': 'Bendras laikas',
  ...
  'Varianten': 'Variantai',
  'Grafiekvarianten maken': 'Kurti diagramų variantus',
  'Slides toevoegen': 'Pridėti skaidres',
  'Omhoog': 'Aukštyn',
  'Omlaag': 'Žemyn',
  ...
  'Stoppen (Esc)': 'Stabdyti (Esc)',
  'Pen · markeerstift · gum': 'Rašiklis · žymeklis · trintukas',
  'Laser · annotaties wissen': 'Lazeris · išvalyti anotacijas',
  'Grafiek': 'Diagrama',
  'Type grafiek': 'Diagramos tipas',
  'Staaf': 'Stulpelinė',
  'Lijn': 'Linijinė',
  'Cirkel': 'Skritulinė',
  'Spider': 'Voratinklinė',
  ...
  'Rij': 'Eilutė',
  'Reeks': 'Serija',
  'Kleur van reeks': 'Serijos spalva',
  'Kleur van rij': 'Eilutės spalva',
  'Hexkleur': 'Šešioliktainė spalva',
  'Sorteren': 'Rūšiuoti',
  ...
  'Schaalmaximum (optioneel)': 'Skalės maksimumas (nebūtina)',
  'geen': 'nėra',
  ...
  'niet geopend': 'neatidaryta',
  '1 dubbele afbeelding verwijderd.': 'Pašalintas 1 dublikuotas paveikslėlis.',
  ...
  'Thema tabelkop': 'Temos lentelės antraštė',
  'Thema code': 'Temos kodas',
  'Thema accent': 'Temos akcentas',
  'Eerste afbeelding': 'Pirmasis paveikslėlis',
...
const _dutchSourceAddLt = <String, String>{
  ...
  'Aangemaakt op': 'Sukurta',
  'Aanmeldprovider': 'Prisijungimo teikėjas',
  'Aanmeldsessies': 'Registracijos seansai',
  'Aantal controles': 'Patikrinimų skaičius',
  ...
  'Activiteitnummer': 'Veiklos numeris',
  'Afgerond op': 'Suapvalinta iki',
  'Afgewezen': 'Atmesta',
  'Afspeelsessienummer': 'Atkūrimo seanso numeris',
  'Afwezig': 'Nėra',
  'Antwoordgegevens': 'Atsakymo detalės',
  'Antwoordstatus': 'Atsakymo būsena',
  'Begint op': 'Prasideda',
  'Begrippen uitgelegd': 'Paaiškintos sąvokos',
  'Beheer van de installatie': 'Montavimo valdymas',
  'Beheerpogingen': 'Valdymo pastangos',
  'Bekeken lessen': 'Pamokos peržiūrėtos',
  'Beleidsversie': 'Politikos versija',
  'Beoordeeld': 'Įvertintas',
  'Beoordeeld op': 'Įvertino',
  'Beperking': 'Apribojimas',
  'Berekend op': 'Apskaičiuota',
  'Bericht': 'Pranešimas',
  'Bestandsnaam': 'Failo pavadinimas',
  'Beveiligingsvraagnummer': 'Saugos klausimo numeris',
  'Bevestigd': 'Patvirtinta',
  'Bevestigd op': 'Patvirtinta',
  'Bewaarregels': 'Laikymo taisyklės',
  'Bewaartermijn': 'Laikymo laikotarpis',
  'Bewaren wegens een juridische verplichting':
      'Išlaikoma dėl teisinės prievolės',
  'Bewerkingnummer bij aanmeldprovider':
      'Operacijos numeris pas registracijos teikėją',
  'Bewijsstukken': 'Įrodymai',
  'Bezwaar': 'Prieštaravimas',
  'Beëindigd op': 'Baigėsi',
  'Bijeenkomstnummer': 'Susitikimo numeris',
  'Certificaatnummer': 'Sertifikato numeris',
  'Certificaten': 'Sertifikatai',
  'Controlecode van de PDF': 'PDF valdymo kodas',
  'Controlecode van profielfoto': 'Profilio nuotraukos patvirtinimo kodas',
  'Controlecodes van bewijsstukken': 'Patvirtinamųjų dokumentų kontrolės kodai',
  'Correctie': 'Pataisymas',
  'Cursistnummer waarop de actie gericht was':
      'Studento numeris, kuriam buvo skirtas veiksmas',
  'Cursusaanbodnummer': 'Kurso pasiūlymo numeris',
  'Cursusversienummer': 'Kurso versijos numeris',
  'Datums en tijden worden in uw lokale tijd getoond. Technische namen blijven zichtbaar wanneer de server een nog onbekend veld aanlevert.':
      'Datos ir laikai rodomi jūsų vietos laiku. Techniniai pavadinimai lieka matomi, kai serveris pateikia nežinomą lauką.',
  'De antwoorden die u bij toetsvragen heeft gegeven.':
      'Atsakymai, kuriuos pateikėte į testo klausimus.',
  'Deelnamenummer': 'Dalyvavimo numeris',
  'Deelnames': 'Dalyvavimas',
  'Details': 'Detalės',
  'Deze categorie is door de server aangeleverd. De technische namen blijven zichtbaar voor navraag bij uw organisatie.':
      'Šią kategoriją pateikė serveris. Techniniai pavadinimai lieka matomi jūsų organizacijos užklausoms.',
  'Door uzelf aangevraagd': 'Prašė pats',
  'E-mailadres': 'El. pašto adresas',
  'E-mailberichten': 'El. pašto žinutės',
  'Een ID is een uniek technisch nummer waarmee eLearning gegevens aan elkaar koppelt. Het is geen beoordeling of status.':
      'ID yra unikalus techninis numeris, kurį „eLearning“ naudoja duomenims susieti. Tai nėra įvertinimas ar statusas.',
  'Een categorie groepeert gegevens over hetzelfde onderwerp. Een registratie is één bewaard gegeven of één gebeurtenis.':
      'Kategorija grupuoja duomenis ta pačia tema. Registracija yra vienas išsaugotas duomenų elementas arba vienas įvykis.',
  'Eindigt op': 'Baigiasi',
  'Geaccepteerd op': 'Priimta',
  'Geannuleerd': 'Atšaukta',
  'Gecontroleerd': 'Patikrinta',
  'Gecontroleerd op': 'Patikrintas',
  'Geen gegevens gevonden': 'Duomenų nerasta',
  'Gegevens over bewaartermijnen en het verwijderen van uw gegevens.':
      'Informacija apie jūsų duomenų saugojimo terminus ir ištrynimą.',
  'Gegevens over bewijsstukken, behaalde resultaten en certificaten.':
      'Informacija apie patvirtinamuosius dokumentus, pasiektus rezultatus ir sertifikatus.',
  'Gegevens over privacyverzoeken en wie uw gegevens bekeek of wijzigde.':
      'Informacija apie privatumo užklausas ir tai, kas peržiūrėjo ar pakeitė jūsų informaciją.',
  'Gegevens over uw accountbewerking': 'Informacija apie jūsų paskyros veiklą',
  'Gegevens over uw inschrijving, deelname en voortgang in lessen.':
      'Informacija apie jūsų registraciją, dalyvavimą ir pažangą pamokose.',
  'Gegevens over uw profiel, account en plaats binnen de organisatie.':
      'Informacija apie jūsų profilį, paskyrą ir pareigas organizacijoje.',
  'Gegevens over uw toetsmomenten en de vragen die daarbij zijn aangeboden.':
      'Informacija apie jūsų testo akimirkas ir pateiktus klausimus.',
  'Gegevens over willekeurige volgorde': 'Atsitiktinių užsakymų duomenys',
  'Gegevenscategorie': 'Duomenų kategorija',
  'Gekoppeld accountnummer': 'Susietos sąskaitos numeris',
  'Gekozen antwoorden': 'Pasirinkti atsakymai',
  'Gelukt': 'Sėkmės',
  'Geprobeerd op': 'Išbandyta',
  'Gerechtvaardigd belang': 'Teisėtas interesas',
  'Gereserveerd': 'Rezervuota',
  'Gereserveerd op': 'Rezervuota',
  'Geslaagd': 'Praėjo',
  'Gestart op': 'Prasidėjo',
  'Getoonde tijd per dia in milliseconden':
      'Laikas, rodomas vienoje skaidrėje milisekundėmis',
  'Herkomst van inschrijving': 'Registracijos kilmė',
  'Hoogst haalbare score': 'Aukščiausias galimas balas',
  'Identificatienummer bij aanmeldprovider':
      'Registracijos teikėjo identifikavimo numeris',
  'Identiteitsbewerkingnummer': 'Tapatybės operacijos numeris',
  'In afwachting': 'Laukiama',
  'In behandeling': 'Vykdoma',
  'In behandeling genomen op': 'Apdorota toliau',
  'In quarantaine': 'Karantine',
  'Ingeleverd': 'Pateikta',
  'Ingeleverd op': 'Pateikta',
  'Ingericht op': 'Dekoruota ant',
  'Ingeschreven op': 'Užsiregistravo',
  'Ingetrokken': 'Atšauktas',
  'Ingetrokken op': 'Atsitraukė toliau',
  'Inschrijvingen': 'Registracijos',
  'Inschrijvingsnummer': 'Registracijos numeris',
  'Installatiebeveiligingslogboek': 'Montavimo saugos žurnalas',
  'Installatienummer': 'Montavimo numeris',
  'Installatieverzoeken': 'Diegimo prašymai',
  'Inzage': 'Apžiūra',
  'Ja': 'Taip',
  'Kwalificatienummer': 'Kvalifikacijos numeris',
  'Kwalificaties': 'Kvalifikacijos',
  'Laatst actief op': 'Paskutinis aktyvus',
  'Laatst bekeken dia': 'Paskutinį kartą žiūrėta skaidrė',
  'Laatst gewijzigd op': 'Paskutinį kartą modifikuotas',
  'Laatste fout': 'Paskutinė klaida',
  'Lesnummer': 'Pamokos numeris',
  'Lesreserveringen': 'Pamokų rezervacijos',
  'Lesvoortgang': 'Pamokos eiga',
  'Lidmaatschappen': 'Narystės',
  'Locatie': 'Vieta',
  'Manier van afronden': 'Apvalinimo būdas',
  'Maximaal aantal controles': 'Maksimalus patikrinimų skaičius',
  'Maximaal aantal pogingen': 'Didžiausias bandymų skaičius',
  'Maximale leeftijd van de aanmelding': 'Maksimalus registracijos amžius',
  'Mislukt': 'Nepavyko',
  'Naam van de activiteit': 'Veiklos pavadinimas',
  'Naam van de bijeenkomst': 'Susitikimo pavadinimas',
  'Nee': 'Nr',
  'Netwerkadres': 'Tinklo adresas',
  'Niet actief': 'Neaktyvus',
  'Niet geregistreerd': 'Neregistruotas',
  'Niet ingevuld': 'Neužpildytas',
  'Niet verschenen': 'Nepaskelbta',
  'Niveau van extra aanmeldcontrole':
      'Papildomos registracijos kontrolės lygis',
  'Nummer van de toetsopzet': 'Bandymų plano numeris',
  'Nummer van het brongegeven': 'Pradinių duomenų numeris',
  'Nummer van uw verwijderde gegeven': 'Jūsų ištrintų duomenų skaičius',
  'Onderdeel {nummer}': 'Dalis {nummer}',
  'Onderwerp van de actie': 'Veiksmo objektas',
  'Ontvanger': 'Gavėjas',
  'Opgegeven bestandsgrootte': 'Nurodytas failo dydis',
  'Opgegeven bestandstype': 'Nurodytas failo tipas',
  'Opgegeven controlecode': 'Nurodytas valdymo kodas',
  'Opgeslagen bestandsgrootte': 'Išsaugoto failo dydis',
  'Opgeslagen controlecode': 'Išsaugotas valdymo kodas',
  'Organisatienummer': 'Organizacijos numeris',
  'Overdraagbaarheid': 'Perkeliamumas',
  'PE-toekenningnummer': 'PE apdovanojimo numeris',
  'Poging': 'Bandymas',
  'Positie': 'Padėtis',
  'Privacyverzoeken': 'Privatumo prašymai',
  'Probeer een andere zoekterm.': 'Išbandykite kitą paieškos terminą.',
  'Reden': 'Priežastis',
  'Reden of grondslag': 'Priežastis arba pagrindas',
  'Reden van afwijzing': 'Atmetimo priežastis',
  'Reden van bevestiging': 'Patvirtinimo priežastis',
  'Reden van intrekking': 'Atsitraukimo priežastis',
  'Reden voor langer bewaren': 'Priežastis ilgiau laikyti',
  'Regels voor de cursusversie': 'Kurso versijos taisyklės',
  'Resultaat bij de aanmeldprovider': 'Rezultatas pas registracijos teikėją',
  'Rol': 'Roll',
  'Score': 'Rezultatas',
  'Soort aanwezigheid': 'Savotiškas buvimas',
  'Soort accountbewerking': 'Sąskaitos operacijos tipas',
  'Soort gebeurtenis': 'Renginio tipas',
  'Soort privacyverzoek': 'Privatumo užklausos tipas',
  'Status van de bijeenkomst': 'Susitikimo būsena',
  'Strenge beveiligingsmodus': 'Aukšto saugumo režimas',
  'Technisch toegangslogboek': 'Techninės prieigos žurnalas',
  'Technische gegevens die nodig zijn voor aanmelden, beveiligen en betrouwbaar verwerken.':
      'Registracijai, saugumui ir patikimam apdorojimui reikalingi techniniai duomenys.',
  'Technische naam: {naam}': 'Techninis pavadinimas: {naam}',
  'Technische opslagcategorie': 'Techninės saugojimo kategorija',
  'Technische opslaglocatie van de PDF': 'Techninė PDF saugojimo vieta',
  'Tijdstip van aanmelding': 'Registracijos laikas',
  'Tijdzone': 'Laiko juosta',
  'Toestand': 'Būklė',
  'Toetspogingen': 'Bandymai',
  'Toetspogingnummer': 'Bandymo numeris',
  'Uiterste inlevermoment': 'Galutinis pateikimo terminas',
  'Uitgegeven op': 'Paskelbta',
  'Uitgenodigd e-mailadres': 'Pakviestas el. pašto adresas',
  'Uitnodigingen': 'Kvietimai',
  'Uniek nummer (ID)': 'Unikalus numeris (ID)',
  'Uniek verwerkingskenmerk': 'Unikali apdorojimo funkcija',
  'Uw accountnummer': 'Jūsų sąskaitos numeris',
  'Uw accountnummer als uitvoerder': 'Jūsų, kaip vykdytojo, sąskaitos numeris',
  'Uzelf als uploader': 'Save kaip įkėlėjas',
  'Vaardigheidsversienummer': 'Įgūdžio versijos numeris',
  'Vast internetadres van de installatie':
      'Fiksuotas įrenginio interneto adresas',
  'Vastgelegde beslisgegevens': 'Įrašyti sprendimo duomenys',
  'Vastgelegde gegevens': 'Įrašyti duomenys',
  'Vereist niveau van aanmeldzekerheid':
      'Reikalingas registracijos tikrumo lygis',
  'Vereiste aanmeldmethoden': 'Reikalingi prisijungimo būdai',
  'Verloopt bij inactiviteit op': 'Nustoja galioti, kai neaktyvus',
  'Verloopt definitief op': 'Nustoja galioti visam laikui',
  'Verloopt op': 'Baigia galioti',
  'Versienummer van de PE-regel': 'PE taisyklės versijos numeris',
  'Verwerkte verzoeken': 'Apdorotos užklausos',
  'Verwijderd op': 'Pašalinta įjungta',
  'Verwijdering': 'Pašalinimas',
  'Verwijderingsregister': 'Pašalinimo registras',
  'Verwijzing naar het antwoord': 'Nuoroda į atsakymą',
  'Verzoeknummer': 'Prašyti numerio',
  'Verzoeknummer van de app': 'Programos užklausos numeris',
  'Verzonden op': 'Išsiųsta toliau',
  'Volgende controle op': 'Kitas patikrinimas',
  'Volgnummer': 'Eilės numeris',
  'Volgorde van antwoordopties': 'Atsakymų variantų tvarka',
  'Vraagnummer binnen de toetspoging': 'Klausimo numeris bandymo metu',
  'Vraagversienummer': 'Klausimo versijos numeris',
  'Vragen in toetspogingen': 'Klausimai bandymų metu',
  'Vrijgegeven': 'Išleistas',
  'Vrijgegeven op': 'Išleistas',
  'Wat gebeurt na de bewaartermijn':
      'Kas atsitiks pasibaigus saugojimo laikotarpiui',
  'Wettelijke verplichting': 'Teisinė prievolė',
  'Wijzigingen aan PE-punten': 'PE taškų pakeitimai',
  'Wijzigingen aan kwalificaties': 'Kvalifikacijų pokyčiai',
  'Wijzigingen in aanmeldbeveiliging': 'Prisijungimo saugumo pakeitimai',
  'Zekerheid': 'tikrumas',
  'Zoek bijvoorbeeld op cursus, datum of status':
      'Pavyzdžiui, ieškokite pagal kursą, datą arba būseną',
  'Zoeken in uw gegevens': 'Ieškokite savo duomenų',
  '{aantal} categorieën gevonden': 'Rastos kategorijos {aantal}',
  'Aanwezigheid': 'Dalyvavimas',
  'Lidmaatschap': 'Narystė',
  'Inzage en wijzigingen': 'Prieiga ir pakeitimai',
  'Beschikbaarheid van het inzagespoor': 'Prieigos žurnalo prieinamumas',
  'Beschikbaar vanaf': 'Galima nuo',
  'Historie vóór deze datum': 'Istorija iki šios datos',
  'Tijdstip': 'Data ir laikas',
  'Handeling': 'Veiksmas',
  'Gegevensonderdeel': 'Duomenų kategorija',
  'Handelde als': 'Elgėsi kaip',
  'Organisatorische rol': 'Organizacinis vaidmuo',
  'Bekeken': 'Peržiūrėta',
  'Gewijzigd': 'Pasikeitė',
  'Uzelf': 'Jūs',
  ...
  'Systeem': 'Sistema',
  'Onbekend': 'Nežinoma',
  'Docent': 'Instruktorius',
  'Beoordelaar': 'Vertintojas',
  'Organisatiebeheerder': 'Organizacijos administratorius',
  'Niet beschikbaar': 'Nėra',
  'Uitoefening van privacyrechten': 'Privatumo teisių įgyvendinimas',
  'Beoordeling en certificering': 'Įvertinimas ir sertifikavimas',
  'Uitvoering van het leertraject': 'Mokymosi programos pristatymas',
  'Cursistenadministratie': 'Mokinio administravimas',
  'Cursistprofiel': 'Mokinio profilis',
  'Leerstatistieken': 'Statistikos mokymasis',
  'Inschrijving': 'Registracija',
  'Toetspoging': 'Bandymas įvertinti',
  'Beoordeling': 'Įvertinimas',
  'Bewijsstuk': 'Įrodymai',
  'Kwalificatie': 'Kvalifikacija',
  'Deelname': 'Dalyvavimas',
  'PE-punten': 'Tęstinio mokymosi taškai',
  'Certificaat': 'Sertifikatas',
  'Privacyverzoek': 'Privatumo prašymas',
  'Bewaard tot': 'Išsaugotas iki',
  'Bekijk mijn gegevens': 'Peržiūrėti mano duomenis',
  'Bekijk welke gegevens eLearning voor u heeft geregistreerd.':
      'Peržiūrėkite, kokius duomenis apie jus užregistravo eLearning.',
  'Dit overzicht is op {datum} rechtstreeks opgehaald bij eLearning en wordt niet door OciDeck bewaard.':
      'Ši apžvalga gauta tiesiogiai iš eLearning {datum}, o OciDeck jos nesaugo.',
  'Geen gegevens geregistreerd': 'Duomenų neužregistruota',
  'Het bevat alle categorieën die de server voor deze organisatie heeft aangeleverd. Voor informatie over doelen, ontvangers, herkomst, bewaartermijnen of uw andere privacyrechten kunt u terecht bij {organisatie}.':
      'Joje pateikiamos visos serverio šiai organizacijai pateikti duomenų tipai. Dėl informacijos apie tikslus, gavėjus, kilmę, saugojimo laikotarpius ar kitas savo privatumo teises kreipkitės į {organisatie}.',
  'Kon uw gegevens niet laden. Probeer het opnieuw.':
      'Nepavyko įkelti jūsų duomenų. Bandykite dar kartą.',
  'Meer tonen ({aantal} resterend)': 'Rodyti daugiau (liko {aantal})',
  'Mijn gegevens': 'Mano duomenys',
  'Privacy-inzage': 'Prieiga prie asmens duomenų',
  'Uw geregistreerde gegevens': 'Jūsų užregistruoti duomenys',
  'uw organisatie': 'jūsų organizacija',
  '{aantal} registraties': 'Įrašų: {aantal}',
  'Volg opleidingen uit uw eLearning-omgeving. Cursusbestanden openen alleen in afspeelmodus; voortgang wordt alleen na aanmelden gesynchroniseerd.':
      'Lankykite kursus iš savo eLearning aplinkos. Kursų failai atidaromi tik atkūrimo režimu; pažanga sinchronizuojama tik prisijungus.',
  'eLearning-aanmelding is alleen beschikbaar in de desktop-app, omdat de webversie geen veilige sleutelbos heeft.':
      'Prisijungti prie eLearning galima tik darbalaukio programoje, nes žiniatinklio versija neturi saugios raktinės.',
  ...
  'Bij het volgen van een cursus stuurt OciDeck uw laatste dia, voltooiing en getoonde tijd per dia naar de gekozen eLearning-organisatie. Antwoorden, notities en cursusinhoud worden niet als voortgang verstuurd.':
      'Lankant kursą, OciDeck pasirinktai eLearning organizacijai siunčia paskutinę skaidrę, užbaigimą ir rodomą laiką kiekvienai skaidrei. Atsakymai, pastabos ir kurso turinys nesiunčiami kaip pažanga.',
  'Ingelogd bij eLearning': 'Prisijungta prie eLearning',
  'Deze eLearning-server gebruikt {host} voor het aanmelden. Er worden pas gegevens met die identiteitsprovider uitgewisseld nadat u dit toestaat.':
      'Šis eLearning serveris prisijungimui naudoja {host}. Duomenimis su tuo tapatybės teikėju keičiamasi tik jums leidus.',
  'Gebruik een HTTPS-adres voor eLearning.':
      'eLearning naudokite HTTPS adresą.',
  'Vul een geldig eLearning-adres in.': 'Įveskite galiojantį eLearning adresą.',
  ...
  '{n} tabellen passen niet op de bladbreedte, ook niet op de kleinste letter.':
      '{n} lentelės netelpa į puslapio plotį net ir mažiausiu šriftu.',
  'Lange woorden en waarden zoals hashes of IP-adressen zijn daardoor middenin afgebroken.':
      'Todėl ilgi žodžiai ir reikšmės, tokios kaip maišos ar IP adresai, nulaužti per vidurį.',
  ...
  'Het bestand is gewijzigd door een ander programma.':
      'Failą modifikavo kita programa.',
  'Herladen': 'Perkrauti',
  ...
  'Thema documentband': 'Temos antraštė/poraštė',
  ...
  'Basislettergrootte: {pt} pt': 'Bazinis šrifto dydis: {pt} pt',
  ...
  'De waarden lijken niet allemaal van hetzelfde type. Kies hoe OciDeck ze moet lezen; niet-herkende waarden blijven onderaan in hun oorspronkelijke volgorde staan.':
      'Atrodo, kad ne visos vertės yra to paties tipo. Pasirinkite, kaip OciDeck turėtų juos skaityti; neatpažintos vertybės lieka apačioje pradine tvarka.',
  ...
  'Gebeurtenissen bewerken': 'Redaguoti įvykius',
  'Hoe wil je deze kolom sorteren?': 'Kaip norite rūšiuoti šį stulpelį?',
  'Kolom aflopend sorteren': 'Rūšiuoti stulpelį mažėjimo tvarka',
  'Kolom oplopend sorteren': 'Rūšiuoti stulpelį didėjančia tvarka',
  ...
  'Toch importeren': 'Importuoti vis tiek',
  'Koptekst': 'Antraštė',
  ...
  'De eigenaar is weg — jij houdt de samenwerking nu gaande; jouw wijzigingen worden pas bewaard als de eigenaar terugkomt.':
      'Savininkas išėjo — dabar bendradarbiavimą palaikote jūs; jūsų pakeitimai išsaugomi tik tada, kai savininkas grįžta.',
  'De eigenaar is terug en neemt de samenwerking weer over.':
      'Savininkas grįžo ir vėl perima bendradarbiavimą.',
  ...
  'Dit bestand bestaat niet meer op deze plek.':
      'Šio failo šioje vietoje nebėra.',
  'Dit bestand is te groot om te openen.':
      'Šis failas per didelis, kad būtų atvertas.',
  ...
  'Export geblokkeerd door classificatiebeleid: dit deck is {deck}, lager dan het vereiste minimum {limit}.':
      'Eksportas užblokuotas klasifikacijos politikos: šis pristatymas yra {deck}, žemiau reikalaujamo minimumo {limit}.',
  'Export geblokkeerd door classificatiebeleid: dit deck is {deck}, hoger dan het toegestane vrijgaveniveau {limit}.':
      'Eksportas užblokuotas klasifikacijos politikos: šis pristatymas yra {deck}, aukščiau leidžiamos išleidimo ribos {limit}.',
  'niet geclassificeerd': 'be klasifikacijos',
  ...
  'Deze tijdstempel hoort niet bij het laatste verzoek':
      'Ši laiko žyma nepriklauso paskutinei užklausai',
  ...
  'Het token heeft de repo-scope nodig (of fijnmazig: Contents lezen en schrijven).':
      'Prieigos raktui reikia repo srities (arba detaliai: Contents skaityti ir rašyti).',
  ...
  'werkgeversnummer (EIN)': 'darbdavio numeris (EIN)',
  'laatste vier cijfers van een SSN': 'paskutiniai keturi SSN skaitmenys',
  ...
  'IMSI van een abonnee': 'abonento IMSI',
  'sociale-mediaprofiel': 'socialinio tinklo profilis',
  'advertentie- of apparaat-ID': 'reklamos arba įrenginio ID',
  'IP-adres': 'IP adresas',
  ...
  'Nog geen uitgebrachte versies van dit deck.':
      'Šiam rinkiniui dar nėra išleistų versijų.',
  'Horizontale gestapelde staaf': 'Horizontali sukrauta stulpelinė',
  'Git-geschiedenis…': 'Git istorija…',
  'Git-geschiedenis:': 'Git istorija:',
  'Nog geen commits voor dit deck.': 'Šiam rinkiniui dar nėra commit\'ų.',
  'Gepusht': 'Nusiųsta',
  'Nog niet gepusht': 'Dar nenusiųsta',
  ...
  'Native git: niet gevonden — het REST-pad wordt gebruikt':
      'Savasis git: nerastas — naudojamas REST kelias',
  'echte offline-historie mogelijk': 'galima tikra istorija be ryšio',
  'Nu synchroniseren': 'Sinchronizuoti dabar',
  'Gesynchroniseerd:': 'Sinchronizuota:',
  'nog in de wachtrij:': 'vis dar eilėje:',
  'Niets in de wachtrij.': 'Eilėje nieko.',
  'Opgeslagen — gaat mee zodra er weer verbinding is.':
      'Įrašyta — bus sinchronizuota, kai tik grįš ryšys.',
  ...
  'Eén per regel: je naam, e-mailadres, telefoonnummer of het domein van je organisatie. Wat hier staat wordt niet gemeld en niet geredigeerd — het is de afzender, geen bevinding. Een domein (example.org) dekt elk adres eronder.':
      'Po vieną eilutėje: tavo vardas, el. pašto adresas, telefono numeris ar organizacijos domenas. Tai, kas čia įrašyta, nepranešama ir neredaguojama — tai siuntėjas, o ne radinys. Domenas (example.org) apima visus po juo esančius adresus.',
  ...
  'Zwakheden (CWE)': 'Silpnybės (CWE)',
  'Testgevallen (WSTG)': 'Testavimo atvejai (WSTG)',
  'MIAUW-eisen': 'MIAUW reikalavimai',
  'CVSS-scoretabel': 'CVSS balų lentelė',
  'Bevindingsjablonen': 'Radinių šablonai',
  'Zoek een instelling': 'Ieškoti nustatymo',
  'Geen instelling gevonden': 'Nustatymų nerasta',
  ...
  'Alle scope-objecten hebben al een checklist':
      'Visi apimties objektai jau turi kontrolinį sąrašą',
  'Maakt per scope-object een checklist (WSTG voor web/API); bestaande blijven staan.':
      'Sukuria kontrolinį sąrašą kiekvienam apimties objektui (WSTG žiniatinkliui/API); esami išlieka.',
  ...
  'Voegt ontbrekende WSTG-testen toe; bestaande blijven staan.':
      'Prideda trūkstamus WSTG testus; esami lieka.',
  'Bewijs': 'Įrodymai',
  ...
  'LibrePlan importeren': 'Importuoti iš LibrePlan',
  ...
  'Gantt-planning': 'Ganto planas',
  'WBS (hiërarchie)': 'WBS (hierarchija)',
  'Projectstatus (cockpit)': 'Projekto būsena (kokpitas)',
  'Milestones (tijdlijn)': 'Etapai (laiko juosta)',
  'Kritieke pad (flow)': 'Kritinis kelias (srautas)',
  'Resources (tabel)': 'Ištekliai (lentelė)',
  'Timesheet (tabel)': 'Darbo laiko apskaita (lentelė)',
  'Resourcebelasting (grafiek)': 'Išteklių apkrova (diagrama)',
