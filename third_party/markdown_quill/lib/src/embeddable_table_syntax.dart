...
// Code units formerly provided by package:charcode (removed to drop the
// transitive dependency — these are trivial ASCII constants).
const int _pipe = 0x7c; // |
const int _space = 0x20; // space
const int _tab = 0x09; // tab
