...
the right weakness without falsifying the pinned MASTG data. MASWE published its
first official release, v1.0.0, on 17 August 2026; OciDeck now records that
citeable release. The moving `main` branch is validated separately as
development input and never silently promoted into the stable bundle.
