...
This is **ocideck 0.6.4+30** (licence EUPL-1.2) and every third-party component it ships (219 in total), direct and transitive — the inventory the EU Cyber Resilience Act (Reg. (EU) 2024/2847, Annex I Part II §1) requires.

The JSON documents carry **776 dependency relations** between these components: each package declares its own dependencies, so the graph can be walked from a leaf back to what pulls it in. 7 component(s) name no supplier — no local source of truth states one, and the field is left empty rather than guessed.
...
| flutter_quill _(direct main)_ | 11.6.0 | MIT | singerdmx | `pkg:pub/flutter_quill@11.6.0` |
...
| flutter_secure_storage _(direct main)_ | 11.2.0 | BSD-3-Clause | mogol | `pkg:pub/flutter_secure_storage@11.2.0` |
| flutter_secure_storage_darwin _(transitive)_ | 0.4.3 | BSD-3-Clause | juliansteenbakker | `pkg:pub/flutter_secure_storage_darwin@0.4.3` |
| flutter_secure_storage_linux _(transitive)_ | 3.0.3 | BSD-3-Clause | mogol | `pkg:pub/flutter_secure_storage_linux@3.0.3` |
| flutter_secure_storage_platform_interface _(transitive)_ | 2.1.1 | BSD-3-Clause | mogol | `pkg:pub/flutter_secure_storage_platform_interface@2.1.1` |
...
| webdriver _(transitive)_ | 3.2.0 | Apache-2.0 | google | `pkg:pub/webdriver@3.2.0` |
...
| flutter | 3.47.4 | BSD-3-Clause | flutter | https://github.com/flutter/flutter |
