...
This is **ocideck 0.6.12+38** (licence EUPL-1.2) and every third-party component it ships (220 in total), direct and transitive — the inventory the EU Cyber Resilience Act (Reg. (EU) 2024/2847, Annex I Part II §1) requires.
...
| pdf _(direct main)_ | 3.13.1 | Apache-2.0 | DavBfr | `pkg:pub/pdf@3.13.1` |
| pdfium_dart _(transitive)_ | 0.3.1 | MIT | espresso3389 | `pkg:pub/pdfium_dart@0.3.1` |
