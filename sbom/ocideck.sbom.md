...
This is **ocideck 0.5.0+25** (licence EUPL-1.2) and every third-party component it ships (213 in total), direct and transitive — the inventory the EU Cyber Resilience Act (Reg. (EU) 2024/2847, Annex I Part II §1) requires.
...
| cross_file _(transitive)_ | 0.3.5+5 | BSD-3-Clause | flutter | `pkg:pub/cross_file@0.3.5+5` |
...
| cupertino_ui _(transitive)_ | 1.0.2 | BSD-3-Clause | flutter | `pkg:pub/cupertino_ui@1.0.2` |
...
| file_picker _(direct main)_ | 12.2.0 | MIT | vicajilau | `pkg:pub/file_picker@12.2.0` |
| file_picker_darwin _(transitive)_ | 1.1.0 | MIT | vicajilau | `pkg:pub/file_picker_darwin@1.1.0` |
| file_picker_linux _(transitive)_ | 1.1.0 | MIT | vicajilau | `pkg:pub/file_picker_linux@1.1.0` |
| file_picker_platform_interface _(transitive)_ | 3.3.0 | MIT | vicajilau | `pkg:pub/file_picker_platform_interface@3.3.0` |
| file_picker_web _(transitive)_ | 3.1.0 | MIT | vicajilau | `pkg:pub/file_picker_web@3.1.0` |
| file_selector _(direct main)_ | 1.1.0 | BSD-3-Clause | flutter | `pkg:pub/file_selector@1.1.0` |
| file_selector_android _(transitive)_ | 0.5.2+10 | Apache-2.0 | flutter | `pkg:pub/file_selector_android@0.5.2+10` |
| file_selector_ios _(transitive)_ | 0.5.3+6 | BSD-3-Clause | flutter | `pkg:pub/file_selector_ios@0.5.3+6` |
| file_selector_linux _(transitive)_ | 0.9.4+1 | BSD-3-Clause | flutter | `pkg:pub/file_selector_linux@0.9.4+1` |
| file_selector_macos _(transitive)_ | 0.9.5+1 | BSD-3-Clause | flutter | `pkg:pub/file_selector_macos@0.9.5+1` |
...
| file_selector_windows _(transitive)_ | 0.9.3+6 | BSD-3-Clause | flutter | `pkg:pub/file_selector_windows@0.9.3+6` |
...
| flutter_riverpod _(direct main)_ | 3.4.3 | MIT | rrousselGit | `pkg:pub/flutter_riverpod@3.4.3` |
| flutter_secure_storage _(direct main)_ | 11.0.0 | BSD-3-Clause | mogol | `pkg:pub/flutter_secure_storage@11.0.0` |
| flutter_secure_storage_darwin _(transitive)_ | 0.4.1 | BSD-3-Clause | juliansteenbakker | `pkg:pub/flutter_secure_storage_darwin@0.4.1` |
...
| flutter_webrtc _(direct main)_ | 1.6.2+hotfix.1 | MIT | cloudwebrtc | `pkg:pub/flutter_webrtc@1.6.2+hotfix.1` |
...
| logger _(transitive)_ | 2.8.0 | MIT | SourceHorizon | `pkg:pub/logger@2.8.0` |
...
| material_ui _(direct main)_ | 1.2.0 | BSD-3-Clause | flutter | `pkg:pub/material_ui@1.2.0` |
...
| stack_trace _(transitive)_ | 1.12.2 | BSD-3-Clause | dart-lang | `pkg:pub/stack_trace@1.12.2` |
...
| url_launcher_macos _(transitive)_ | 3.2.6 | BSD-3-Clause | flutter | `pkg:pub/url_launcher_macos@3.2.6` |
...
| url_launcher_windows _(transitive)_ | 3.1.6 | BSD-3-Clause | flutter | `pkg:pub/url_launcher_windows@3.1.6` |
...
| wakelock_plus _(direct main)_ | 1.8.0 | BSD-3-Clause | fluttercommunity | `pkg:pub/wakelock_plus@1.8.0` |
| wakelock_plus_platform_interface _(transitive)_ | 1.7.0 | BSD-3-Clause | fluttercommunity | `pkg:pub/wakelock_plus_platform_interface@1.7.0` |
...
| windows_file_picker _(transitive)_ | 1.2.0 | MIT | vicajilau | `pkg:pub/windows_file_picker@1.2.0` |
