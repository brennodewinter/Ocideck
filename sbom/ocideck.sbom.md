...
| flutter_riverpod _(direct main)_ | 3.3.2 | MIT | rrousselGit | `pkg:pub/flutter_riverpod@3.3.2` |
...
| flutter_secure_storage_platform_interface _(transitive)_ | 2.0.1 | BSD-3-Clause | mogol | `pkg:pub/flutter_secure_storage_platform_interface@2.0.1` |
...
| quill_native_bridge _(transitive)_ | 11.1.0 | MIT | FlutterQuill | `pkg:pub/quill_native_bridge@11.1.0` |
| quill_native_bridge_android _(transitive)_ | 0.0.1+2 | MIT | FlutterQuill | `pkg:pub/quill_native_bridge_android@0.0.1+2` |
| quill_native_bridge_ios _(transitive)_ | 0.0.1 | MIT | FlutterQuill | `pkg:pub/quill_native_bridge_ios@0.0.1` |
...
| riverpod _(transitive)_ | 3.3.2 | MIT | rrousselGit | `pkg:pub/riverpod@3.3.2` |
...
| shared_preferences_android _(transitive)_ | 2.4.26 | BSD-3-Clause | flutter | `pkg:pub/shared_preferences_android@2.4.26` |
...
| uuid _(direct main)_ | 4.5.3 | MIT | Daegalus | `pkg:pub/uuid@4.5.3` |
...
| video_player _(direct main)_ | 2.12.0 | BSD-3-Clause | flutter | `pkg:pub/video_player@2.12.0` |
| video_player_android _(transitive)_ | 2.11.0 | BSD-3-Clause | flutter | `pkg:pub/video_player_android@2.11.0` |
...
| vm_service _(transitive)_ | 15.2.0 | BSD-3-Clause | dart-lang | `pkg:pub/vm_service@15.2.0` |
| wakelock_plus _(direct main)_ | 1.5.2 | BSD-3-Clause | fluttercommunity | `pkg:pub/wakelock_plus@1.5.2` |
| wakelock_plus_platform_interface _(transitive)_ | 1.5.1 | BSD-3-Clause | fluttercommunity | `pkg:pub/wakelock_plus_platform_interface@1.5.1` |
...
| win32 _(transitive)_ | 5.15.0 | BSD-3-Clause | halildurmus | `pkg:pub/win32@5.15.0` |
...
| flutter | 3.44.8 | BSD-3-Clause | flutter | https://github.com/flutter/flutter |
