...
void main() {
  ...
  test(
    'een los bestand gaat met zijn sidecars de prullenbak in',
    () async {
  ...
  test(
    'een deck in zijn eigen map verhuist als hele map',
    () async {
  ...
  test(
    'naamgelijke items in de prullenbak worden uniek gehouden',
    () async {
      for (var i = 0; i < 2; i++) {
        final md = File(p.join(temp.path, 'Demo.md'))
