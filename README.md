...
> The optional **eLearning integration** (technically OciServe) is an explicit
> exception: after you enable it
...
- Flutter **3.47.2** (stable) — the pinned toolchain (see `.tool-versions`),
  bundling Dart 3.13.2. The `pubspec.yaml` Dart SDK constraint is `^3.12.0`;
