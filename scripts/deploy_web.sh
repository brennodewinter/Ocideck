...
#   OCIDECK_DEPLOY_HOST   ssh-doel                     ubuntu@vps-40edd80f.vps.ovh.net
...
# De DAST-scan (OWASP ZAP) hoort hier bewust NIET. Na de wissel staat de site al
# live: een bevinding is dan te laat om een release nog tegen te houden. De scan
# hoort vóór de tag, in de kwaliteitsslag `make check-release` — daar kan een
# ontdekking als #849 (host stuurt geen beveiligingsheaders) nog een tag
# uitstellen in plaats van al gepubliceerd te zijn.
