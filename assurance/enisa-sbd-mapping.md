...
- **O1 — artefactondertekening: gedicht via een getekende release-manifest.**
  ...
  punt* hieronder). Residu, apart en later: **provenance/SLSA** (reproduceerbare
