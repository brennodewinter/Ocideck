...
- **O1 — artefactondertekening: gedicht via een getekende release-manifest.**
  ...
  **#1027**) is onderzocht en gewogen in
  ...
  off-runner getekende manifest. Aangewezen sluitstuk: het pinnen van de
  native-assetslaag voor reproduceerbaarheid over machines heen. Alles onder de
