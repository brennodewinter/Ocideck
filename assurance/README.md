...
| [`enisa-sbd-mapping.md`](enisa-sbd-mapping.md) | De 22 release gates van de ENISA Secure-by-Design-playbook afgebeeld op de poorten en tests die ze hier al afdwingen — mét de vier echte open punten. De fijnmazige laag onder de CRA-map. |
