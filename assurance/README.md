...
| [`soevereiniteit-ecsf.md`](soevereiniteit-ecsf.md) | OciDeck langs de acht doelen van het European Cloud Sovereignty Framework (ECSF, boek *November*). Consultancy-niveau zelfpositionering: soevereiniteit is meerdimensionaal, niet zwart-wit. Zet de kern hoog (lokaal-eerst, open formaat) en benoemt de echte begrenzers (toolchain/keten). Weegt distributiekanalen per as en levert twee sturende inzichten voor #1227: kanalen zijn additief (verlagen de bodem niet) en méér routes verhógen de operationele soevereiniteit — waarmee Snap als één-van-velen alsnog verdedigbaar is. |
