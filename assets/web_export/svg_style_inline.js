// OciDeck — SVG-stijl-inliner + tekst-normalisatie (#862, #868).
//
...
// op desktop, de app-pagina op web) en doet twee dingen terwijl de SVG in de DOM
...
(function () {
  ...
  window.__ocideckInlineSvgStyles = function (svg) {
    try {
      ...
      // `style`-attribuut staat), dan het `<style>`-blok weg (geen class-regel
      // die `text-anchor` terugzet), en pas dán tekst bakken — meten gebeurt met
      // het inline-font, dus zonder `<style>` nog even correct.
      inlineStyles(root);
