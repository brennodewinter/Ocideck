...
| Kategorija | Tifsira |
| --- | --- |
| Spoofing | Jippretendu li huwa utent jew servizz ieħor |
| Tbagħbis | Modifika mhux awtorizzata ta' data jew kodiċi |
| Ripudju | Jiċħad li qatt seħħet azzjoni |
| Żvelar ta' informazzjoni | Informazzjoni tasal lil dawk li m'għandhomx permess jarawha |
| Ċaħda ta' servizz | Li tagħmel is-sistema ma tistax tintuża jew ma tistax tintlaħaq |
| Elevazzjoni ta' privileġġ | Jakkwistaw aktar privileġġi milli mogħtija |
...
| Theddida | Kategorija STRIDE | Komponent | Riskju |
| --- | --- | --- | --- |
| … | … | … | … |
| … | … | … | … |
| … | … | … | … |
